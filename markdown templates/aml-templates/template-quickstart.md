...
---
# <a name="the-h1-heading-is-the-article-title-that-shows-on-the-web"></a>The H1 heading is the article title that shows on the web
...
## <a name="create-an-azure-machine-learning-server"></a>Create an Azure Machine Learning Server
...
## <a name="example-command-using-a-bash-shell-comment"></a>Example command using a bash shell comment
