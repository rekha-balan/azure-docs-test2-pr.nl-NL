...
---
# <a name="retain-a-constant-virtual-ip-address-for-an-azure-cloud-service"></a>Retain a constant virtual IP address for an Azure cloud service
...
## <a name="publish-a-cloud-service-without-changing-its-vip"></a>Publish a cloud service without changing its VIP
...
## <a name="update-a-cloud-service-without-changing-its-vip"></a>Update a cloud service without changing its VIP
