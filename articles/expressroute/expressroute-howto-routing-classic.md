...
---
# <a name="create-and-modify-peering-for-an-expressroute-circuit-classic"></a>Create and modify peering for an ExpressRoute circuit (classic)
...
### <a name="log-in-to-your-azure-account-and-select-a-subscription"></a>Log in to your Azure account and select a subscription
