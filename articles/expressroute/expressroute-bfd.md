...
---
# <a name="configure-bfd-over-expressroute"></a>Configure BFD over ExpressRoute
...
## <a name="need-for-bfd"></a>Need for BFD

The following diagram shows the benefit of enabling BFD over ExpressRoute circuit: [![1]][1]
...
## <a name="enabling-bfd"></a>Enabling BFD
...
## <a name="bfd-timer-negotiation"></a>BFD Timer Negotiation
