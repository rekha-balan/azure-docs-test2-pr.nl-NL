...
---
# <a name="verifying-expressroute-connectivity"></a>Verifying ExpressRoute connectivity
...
##<a name="validate-circuit-provisioning-and-state"></a>Validate circuit provisioning and state
...
###<a name="verification-via-the-azure-portal"></a>Verification via the Azure portal
...
###<a name="verification-via-powershell"></a>Verification via PowerShell
...
###<a name="verification-via-powershell-classic"></a>Verification via PowerShell (Classic)
...
To confirm if an ExpressRoute circuit is operational, pay particular attention to the following fields: ServiceProviderProvisioningState : Provisioned Status                           : Enabled
...
##<a name="validate-peering-configuration"></a>Validate Peering Configuration
...
## <a name="validate-arp-between-microsoft-and-the-service-provider"></a>Validate ARP between Microsoft and the service provider
...
##<a name="validate-bgp-and-routes-on-the-msee"></a>Validate BGP and routes on the MSEE
This section uses PowerShell (Classic) commands. If you have been using PowerShell Azure Resource Manager commands, ensure that you have admin/co-admin access to the subscription via [Azure classic portal][OldPortal]
...
##<a name="check-the-traffic-statistics"></a>Check the Traffic Statistics
