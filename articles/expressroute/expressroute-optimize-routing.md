...
## <a name="suboptimal-routing-from-customer-to-microsoft"></a>Suboptimal routing from customer to Microsoft
...
## <a name="suboptimal-routing-from-microsoft-to-customer"></a>Suboptimal routing from Microsoft to customer
...
## <a name="suboptimal-routing-between-virtual-networks"></a>Suboptimal routing between virtual networks
...
### <a name="solution-assign-a-high-weight-to-local-connection"></a>Solution: assign a high weight to local connection
