...
---
# <a name="troubleshooting-network-performance"></a>Troubleshooting network performance
...
## <a name="network-components"></a>Network components
...
### <a name="azurect---the-azure-connectivity-toolkit"></a>AzureCT - the Azure Connectivity Toolkit
...
## <a name="advanced-expressroute-troubleshooting"></a>Advanced ExpressRoute troubleshooting
...
## <a name="the-problem-is-isolated-now-what"></a>The problem is isolated, now what?
...
### <a name="latencybandwidth-expectations"></a>Latency/bandwidth expectations
>[!TIP]
...
### <a name="latencybandwidth-results"></a>Latency/bandwidth results
>[!IMPORTANT]
