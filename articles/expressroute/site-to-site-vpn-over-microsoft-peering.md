...
---
# <a name="configure-a-site-to-site-vpn-over-expressroute-microsoft-peering"></a>Configure a site-to-site VPN over ExpressRoute Microsoft peering
...
#### <a name="cisco-examples"></a>Cisco examples
...
### <a name="about-the-azure-resource-manager-template-examples"></a>About the Azure Resource Manager template examples
