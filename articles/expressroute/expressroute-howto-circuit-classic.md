...
---
# <a name="modify-an-expressroute-circuit-using-powershell-classic"></a>Modify an ExpressRoute circuit using PowerShell (classic)
...
## <a name="get-the-status-of-a-circuit"></a>Get the status of a circuit
...
## <a name="modify-a-circuit"></a>Modify a circuit
...
### <a name="enable-the-expressroute-premium-add-on"></a>Enable the ExpressRoute premium add-on
...
### <a name="disable-the-expressroute-premium-add-on"></a>Disable the ExpressRoute premium add-on
...
#### <a name="to-disable-the-premium-add-on"></a>To disable the premium add-on
...
### <a name="update-the-expressroute-circuit-bandwidth"></a>Update the ExpressRoute circuit bandwidth
...
## <a name="deprovision-and-delete-a-circuit"></a>Deprovision and delete a circuit
