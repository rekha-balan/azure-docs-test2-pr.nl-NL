...
---
# <a name="create-and-modify-an-expressroute-circuit-using-powershell-classic"></a>Create and modify an ExpressRoute circuit using PowerShell (classic)
...
### <a name="step-1-review-the-prerequisites-and-workflow-articles"></a>Step 1. Review the prerequisites and workflow articles
...
### <a name="step-2-install-the-latest-versions-of-the-azure-service-management-sm-powershell-modules"></a>Step 2. Install the latest versions of the Azure Service Management (SM) PowerShell modules
...
### <a name="step-3-log-in-to-your-azure-account-and-select-a-subscription"></a>Step 3. Log in to your Azure account and select a subscription
...
### <a name="step-1-import-the-powershell-modules-for-expressroute"></a>Step 1. Import the PowerShell modules for ExpressRoute
...
### <a name="step-2-get-the-list-of-supported-providers-locations-and-bandwidths"></a>Step 2. Get the list of supported providers, locations, and bandwidths
...
### <a name="step-3-create-an-expressroute-circuit"></a>Step 3. Create an ExpressRoute circuit
...
### <a name="step-4-list-all-the-expressroute-circuits"></a>Step 4. List all the ExpressRoute circuits
...
### <a name="step-5-send-the-service-key-to-your-connectivity-provider-for-provisioning"></a>Step 5. Send the service key to your connectivity provider for provisioning
...
### <a name="step-6-periodically-check-the-status-and-the-state-of-the-circuit-key"></a>Step 6. Periodically check the status and the state of the circuit key
...
### <a name="step-7-create-your-routing-configuration"></a>Step 7. Create your routing configuration
...
### <a name="step-8-link-a-virtual-network-to-an-expressroute-circuit"></a>Step 8. Link a virtual network to an ExpressRoute circuit
...
#### <a name="disable-the-premium-add-on"></a>Disable the premium add-on
...
#### <a name="resize-a-circuit"></a>Resize a circuit
...
#### <a name="delete-a-circuit"></a>Delete a circuit
