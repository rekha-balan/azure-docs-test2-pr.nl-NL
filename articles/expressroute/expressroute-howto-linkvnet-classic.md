...
---
# <a name="connect-a-virtual-network-to-an-expressroute-circuit-using-powershell-classic"></a>Connect a virtual network to an ExpressRoute circuit using PowerShell (classic)
...
### <a name="download-the-latest-powershell-cmdlets"></a>Download the latest PowerShell cmdlets
...
## <a name="remove-a-virtual-network-link-to-a-circuit"></a>Remove a virtual network link to a circuit
