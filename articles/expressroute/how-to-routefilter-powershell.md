...
---
# <a name="configure-route-filters-for-microsoft-peering-powershell"></a>Configure route filters for Microsoft peering: PowerShell
...
### <a name="3-add-the-rule-to-the-route-filter"></a>3. Add the rule to the route filter
