...
## <a name="guidelines-for-azure-marketplace"></a>Guidelines for Azure Marketplace  

### <a name="guidelines-for-creating-a-microsoft-id-to-manage-a-marketplace-account"></a>Guidelines for creating a Microsoft ID to manage a marketplace account  
...
#### <a name="issue-microsoft-id-in-an-azure-ad-federated-domain"></a>Issue: Microsoft ID in an Azure AD federated domain  
