...
---
# <a name="azure-partner-customer-usage-attribution"></a>Azure partner customer usage attribution
...
## <a name="use-resource-manager-templates"></a>Use Resource Manager templates
...
## <a name="add-a-guid-to-your-template"></a>Add a GUID to your template
...
### <a name="sample-template-code"></a>Sample template code

![Sample template code](media/marketplace-publishers-guide/tracking-sample-code-for-lu-1.PNG)

## <a name="use-the-resource-manager-apis"></a>Use the Resource Manager APIs
...
### <a name="tag-a-deployment-with-the-resource-manager-apis"></a>Tag a deployment with the Resource Manager APIs
...
### <a name="example-the-python-sdk"></a>Example: The Python SDK
...
#### <a name="tag-a-deployment-by-using-the-azure-powershell"></a>Tag a deployment by using the Azure PowerShell
...
#### <a name="tag-a-deployment-by-using-the-azure-cli"></a>Tag a deployment by using the Azure CLI
...
## <a name="register-guids-and-offers"></a>Register GUIDs and offers
...
## <a name="verify-the-guid-deployment"></a>Verify the GUID deployment 
...
## <a name="notify-your-customers"></a>Notify your customers
...
### <a name="notification-for-resource-manager-template-deployments"></a>Notification for Resource Manager template deployments
...
### <a name="notification-for-sdk-or-api-deployments"></a>Notification for SDK or API deployments
