...
3. Create the "Demand by Timestamp" tile:
   ...
   * Click **"Line Chart"** icon ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/media/cortana-analytics-technical-guide-demand-forecast/PowerBIpic8.png).
   ...
   * Click **“Pin Visual”**![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/https://docstestmedia1.blob.core.windows.net/azure-media/articles/media/cortana-analytics-technical-guide-demand-forecast/PowerBIpic6.png) icon on top right corner of this line chart, a "Pin to Dashboard" window may show up for you to choose a dashboard. Please select "EnergyStreamDataReport", then click "Pin".
...
4. (Optional) Schedule refresh of the data source.
   ...
   * To schedule refresh of the data, hover your mouse over the **EnergyBPI-Final** dataset, click ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/media/cortana-analytics-technical-guide-demand-forecast/PowerBIpic3.png) and then choose **Schedule Refresh**.
