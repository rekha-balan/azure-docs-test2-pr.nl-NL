...
## <a name="scenario-and-use-case-overview"></a>Scenario and use case overview
...
> [!TIP]
> For a high-level video about this project, see [Integration User Group](http://www.integrationusergroup.com/logic-apps-support-error-handling/ "Integration User Group").
...
The first step is to create the logic app and open the app in Logic App Designer. In this example, we are using parent-child logic apps. Let's assume that we have already created the parent and are going to create one child logic app.
...
### <a name="return-the-response-back-to-parent-logic-app"></a>Return the response back to parent logic app

After you get the response, you can pass the response back to the parent logic app.

#### <a name="return-success-response-to-parent-logic-app"></a>Return success response to parent logic app
...
#### <a name="return-error-response-to-parent-logic-app"></a>Return error response to parent logic app
