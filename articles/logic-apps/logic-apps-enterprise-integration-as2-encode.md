...
---
# <a name="encode-as2-messages-for-azure-logic-apps-with-the-enterprise-integration-pack"></a>Encode AS2 messages for Azure Logic Apps with the Enterprise Integration Pack
...
* An [integration account](logic-apps-enterprise-integration-create-integration-account.md) that's already defined and associated with your Azure subscription. You must have an integration account to use the Encode AS2 message connector.
...
## <a name="encode-as2-messages"></a>Encode AS2 messages
