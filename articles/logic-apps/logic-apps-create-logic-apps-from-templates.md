...
---
# <a name="create-logic-app-workflows-from-prebuilt-templates"></a>Create logic app workflows from prebuilt templates
...
If you don't have an Azure subscription, [sign up for a free Azure account](https://azure.microsoft.com/free/) before you begin. For more information about building a logic app, see [Create a logic app](../logic-apps/quickstart-create-first-logic-app-workflow.md).

## <a name="create-logic-apps-from-templates"></a>Create logic apps from templates

1. If you haven't already, sign in to the [Azure portal](https://portal.azure.com "Azure portal").

2. From the main Azure menu, choose **Create a resource** > **Enterprise Integration** > **Logic App**.
...
4. When you're ready, select **Pin to dashboard**. That way, your logic app automatically appears on your Azure dashboard and opens after deployment. Choose **Create**.
   ...
   After Azure deploys your logic app, the Logic Apps Designer opens and shows a page with an introduction video. 
...
## <a name="update-logic-apps-with-templates"></a>Update logic apps with templates

1. In the [Azure portal](https://portal.azure.com "Azure portal"), find and open your logic app in th Logic App Designer.
...
## <a name="deploy-logic-apps-built-from-templates"></a>Deploy logic apps built from templates
...
Learn about building logic apps through examples, scenarios, customer stories, and walkthroughs.
