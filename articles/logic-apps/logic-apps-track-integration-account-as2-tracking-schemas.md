...
---
# <a name="start-or-enable-tracking-of-as2-messages-and-mdns-to-monitor-success-errors-and-message-properties"></a>Start or enable tracking of AS2 messages and MDNs to monitor success, errors, and message properties
...
## <a name="as2-message-tracking-schema"></a>AS2 message tracking schema
````java
...
## <a name="as2-mdn-tracking-schema"></a>AS2 MDN tracking schema
````java
