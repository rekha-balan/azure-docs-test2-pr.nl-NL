...
## <a name="publish-custom-connectors-to-azure"></a>Publish custom connectors to Azure

To make your custom API Apps public and available to use in Azure, submit your nominations to the [Microsoft Azure Certified program](https://azure.microsoft.com/marketplace/programs/certified/logic-apps/).
