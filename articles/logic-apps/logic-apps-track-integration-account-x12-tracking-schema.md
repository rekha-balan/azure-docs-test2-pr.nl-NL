...
---
# <a name="start-or-enable-tracking-of-x12-messages-to-monitor-success-errors-and-message-properties"></a>Start or enable tracking of X12 messages to monitor success, errors, and message properties
...
## <a name="x12-transaction-set-tracking-schema"></a>X12 transaction set tracking schema
````java
...
## <a name="x12-transaction-set-acknowledgement-tracking-schema"></a>X12 transaction set acknowledgement tracking schema
````java
...
## <a name="x12-interchange-acknowledgement-tracking-schema"></a>X12 interchange acknowledgement tracking schema
````java
    {
            "agreementProperties": {
                "senderPartnerName": "",
...
## <a name="x12-functional-group-tracking-schema"></a>X12 functional group tracking schema
````java
...
## <a name="x12-functional-group-acknowledgement-tracking-schema"></a>X12 functional group acknowledgement tracking schema
````java
    {
            "agreementProperties": {
                "senderPartnerName": "",
