...
---
# <a name="add-maps-for-xml-transformation-in-azure-logic-apps-with-enterprise-integration-pack"></a>Add maps for XML transformation in Azure Logic Apps with Enterprise Integration Pack
...
## <a name="how-do-i-add-an-assembly"></a>How do I add an assembly?
...
2. After the Assemblies page opens, choose **Add**. Enter a **Name** for your assembly. To upload the assembly file, choose the folder icon on the right side of the **Assembly** text box. After the upload process completes, choose **OK**.
