...
### <a name="debuggingenabled-do-not-enable-on-live-production-site"></a>debuggingEnabled (do not enable on live production site)
...
### <a name="my-node-application-is-making-excessive-outbound-calls"></a>My node application is making excessive outbound calls
...
#### <a name="profiling-your-node-application-on-azure-web-apps-with-v8-profiler"></a>Profiling your node application on Azure Web Apps with V8-Profiler
...
#### <a name="leak-detection-and-heap-diff-for-nodejs"></a>Leak detection and Heap Diff for node.js
...
### <a name="my-node-application-takes-too-much-time-to-start-cold-start"></a>My node application takes too much time to start (Cold Start)
