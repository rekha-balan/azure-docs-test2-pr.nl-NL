...
---
# <a name="networking-considerations-for-an-app-service-environment"></a>Networking considerations for an App Service Environment #
...
## <a name="ase-subnet-size"></a>ASE subnet size ##
...
## <a name="ase-dependencies"></a>ASE dependencies ##
...
## <a name="portal-dependencies"></a>Portal dependencies ##
...
## <a name="functions-and-web-jobs"></a>Functions and Web jobs ##
