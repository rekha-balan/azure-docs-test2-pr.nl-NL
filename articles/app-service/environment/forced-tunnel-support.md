...
---
# <a name="configure-your-app-service-environment-with-forced-tunneling"></a>Configure your App Service Environment with forced tunneling
...
## <a name="enable-your-app-service-environment-to-have-direct-internet-access"></a>Enable your App Service Environment to have direct internet access
...
## <a name="configure-your-ase-subnet-to-ignore-bgp-routes"></a>Configure your ASE subnet to ignore BGP routes ## 
...
## <a name="configure-your-ase-with-service-endpoints"></a>Configure your ASE with Service Endpoints ##
...
## <a name="add-your-own-ips-to-the-ase-azure-sql-firewall"></a>Add your own IPs to the ASE Azure SQL firewall ##
...
## <a name="preventing-issues"></a>Preventing issues ##
