...
---
# <a name="introduction-to-the-app-service-environments"></a>Introduction to the App Service Environments #
...
## <a name="dedicated-environment"></a>Dedicated environment ##
