...
---
# <a name="create-an-ase-by-using-an-azure-resource-manager-template"></a>Create an ASE by using an Azure Resource Manager template
...
## <a name="create-the-ase"></a>Create the ASE
...
## <a name="upload-and-configure-the-default-ssl-certificate"></a>Upload and configure the "default" SSL certificate
