...
---
# <a name="create-an-external-app-service-environment"></a>Create an External App Service environment #
...
## <a name="three-ways-to-create-an-ase"></a>Three ways to create an ASE ##
...
## <a name="create-an-ase-and-an-app-service-plan-together"></a>Create an ASE and an App Service plan together ##
...
## <a name="create-an-ase-and-a-linux-web-app-using-a-custom-docker-image-together"></a>Create an ASE and a Linux web app using a custom Docker image together
...
## <a name="create-an-ase-by-itself"></a>Create an ASE by itself ##
