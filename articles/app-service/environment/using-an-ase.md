...
---
# <a name="use-an-app-service-environment"></a>Use an App Service environment #
...
## <a name="create-a-web-app-in-an-ase"></a>Create a web app in an ASE ##
...
## <a name="how-scale-works"></a>How scale works ##
...
## <a name="front-end-scaling"></a>Front-end scaling ##
...
## <a name="app-access"></a>App access ##
...
## <a name="delete-an-ase"></a>Delete an ASE ##
