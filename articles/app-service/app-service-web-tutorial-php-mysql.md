...
---
# <a name="tutorial-build-a-php-and-mysql-web-app-in-azure"></a>Tutorial: Build a PHP and MySQL web app in Azure
...
## <a name="prepare-local-mysql"></a>Prepare local MySQL

In this step, you create a database in your local MySQL server for your use in this tutorial.

### <a name="connect-to-local-mysql-server"></a>Connect to local MySQL server
...
### <a name="create-a-database-locally"></a>Create a database locally
...
### <a name="configure-mysql-connection"></a>Configure MySQL connection
...
### <a name="run-the-sample-locally"></a>Run the sample locally
...
## <a name="create-mysql-in-azure"></a>Create MySQL in Azure
...
### <a name="create-a-mysql-server"></a>Create a MySQL server
...
### <a name="configure-server-firewall"></a>Configure server firewall
...
### <a name="connect-to-production-mysql-server-locally"></a>Connect to production MySQL server locally
...
### <a name="create-a-production-database"></a>Create a production database
...
### <a name="create-a-user-with-permissions"></a>Create a user with permissions
...
## <a name="connect-app-to-azure-mysql"></a>Connect app to Azure MySQL

In this step, you connect the PHP application to the MySQL database you created in Azure Database for MySQL.

<a name="devconfig"></a>

### <a name="configure-the-database-connection"></a>Configure the database connection
...
### <a name="configure-ssl-certificate"></a>Configure SSL certificate
...
### <a name="commit-your-changes"></a>Commit your changes
...
### <a name="configure-database-settings"></a>Configure database settings
...
### <a name="configure-laravel-environment-variables"></a>Configure Laravel environment variables
...
### <a name="set-the-virtual-application-path"></a>Set the virtual application path
...
## <a name="update-model-locally-and-redeploy"></a>Update model locally and redeploy
...
### <a name="add-a-column"></a>Add a column
...
### <a name="update-application-logic"></a>Update application logic
...
### <a name="update-the-view"></a>Update the view
...
### <a name="test-the-changes-locally"></a>Test the changes locally
...
### <a name="publish-changes-to-azure"></a>Publish changes to Azure
...
## <a name="stream-diagnostic-logs"></a>Stream diagnostic logs
...
## <a name="manage-the-azure-web-app"></a>Manage the Azure web app
