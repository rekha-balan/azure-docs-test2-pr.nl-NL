...
#### <a name="enable-web-server-diagnostics"></a>Enable web server diagnostics
...
#### <a name="enable-application-diagnostics"></a>Enable application diagnostics
...
##### <a name="set-up-diagnostic-traces-manually"></a>Set up diagnostic traces manually
...
For more information on features available in Kudu, see [Azure DevOps tools you should know about](https://azure.microsoft.com/blog/windows-azure-websites-online-tools-you-should-know-about/).
