...
---
# <a name="configuration-and-management-faqs-for-web-apps-in-azure"></a>Configuration and management FAQs for Web Apps in Azure
...
## <a name="are-there-limitations-i-should-be-aware-of-if-i-want-to-move-app-service-resources"></a>Are there limitations I should be aware of if I want to move App Service resources?
...
## <a name="how-do-i-use-a-custom-domain-name-for-my-web-app"></a>How do I use a custom domain name for my web app?
...
## <a name="how-do-i-purchase-a-new-custom-domain-for-my-web-app"></a>How do I purchase a new custom domain for my web app?
...
## <a name="how-do-i-upload-and-configure-an-existing-ssl-certificate-for-my-web-app"></a>How do I upload and configure an existing SSL certificate for my web app?
...
## <a name="how-do-i-purchase-and-configure-a-new-ssl-certificate-in-azure-for-my-web-app"></a>How do I purchase and configure a new SSL certificate in Azure for my web app?
...
## <a name="how-do-i-move-application-insights-resources"></a>How do I move Application Insights resources?
...
## <a name="where-can-i-find-a-guidance-checklist-and-learn-more-about-resource-move-operations"></a>Where can I find a guidance checklist and learn more about resource move operations?
...
## <a name="how-do-i-set-the-server-time-zone-for-my-web-app"></a>How do I set the server time zone for my web app?
...
## <a name="why-do-my-continuous-webjobs-sometimes-fail"></a>Why do my continuous WebJobs sometimes fail?
...
## <a name="how-do-i-get-the-outbound-ip-address-for-my-web-app"></a>How do I get the outbound IP address for my web app?
...
## <a name="how-do-i-get-a-reserved-or-dedicated-inbound-ip-address-for-my-web-app"></a>How do I get a reserved or dedicated inbound IP address for my web app?
...
## <a name="can-i-export-my-app-service-certificate-to-use-outside-azure-such-as-for-a-website-hosted-elsewhere"></a>Can I export my App Service certificate to use outside Azure, such as for a website hosted elsewhere? 
...
## <a name="can-i-export-my-app-service-certificate-to-use-with-other-azure-cloud-services"></a>Can I export my App Service certificate to use with other Azure cloud services?
...
## <a name="why-do-i-see-the-message-partially-succeeded-when-i-try-to-back-up-my-web-app"></a>Why do I see the message "Partially Succeeded" when I try to back up my web app?
...
## <a name="how-do-i-remove-a-header-from-the-http-response"></a>How do I remove a header from the HTTP response?
...
## <a name="is-app-service-compliant-with-pci-standard-30-and-31"></a>Is App Service compliant with PCI Standard 3.0 and 3.1?
...
## <a name="how-do-i-use-the-staging-environment-and-deployment-slots"></a>How do I use the staging environment and deployment slots?
...
## <a name="how-do-i-access-and-review-webjob-logs"></a>How do I access and review WebJob logs?
...
## <a name="how-do-i-add-or-edit-a-url-rewrite-rule"></a>How do I add or edit a URL rewrite rule?
...
## <a name="how-do-i-control-inbound-traffic-to-app-service"></a>How do I control inbound traffic to App Service?
...
## <a name="how-do-i-block-ports-in-an-app-service-web-app"></a>How do I block ports in an App Service web app?
...
## <a name="how-do-i-capture-an-f12-trace"></a>How do I capture an F12 trace?
...
### <a name="f12-console-output"></a>F12 console output
...
## <a name="why-do-i-get-an-error-when-i-try-to-connect-an-app-service-web-app-to-a-virtual-network-that-is-connected-to-expressroute"></a>Why do I get an error when I try to connect an App Service web app to a virtual network that is connected to ExpressRoute?
...
## <a name="how-do-i-connect-an-app-service-web-app-to-a-virtual-network-that-has-a-static-routing-policy-based-gateway"></a>How do I connect an App Service web app to a virtual network that has a static routing (policy-based) gateway?
...
## <a name="in-my-app-service-environment-why-can-i-create-only-one-app-service-plan-even-though-i-have-two-workers-available"></a>In my App Service Environment, why can I create only one App Service plan, even though I have two workers available?
...
## <a name="why-do-i-see-timeouts-when-i-try-to-create-an-app-service-environment"></a>Why do I see timeouts when I try to create an App Service Environment?
...
## <a name="why-cant-i-delete-my-app-service-plan"></a>Why can't I delete my App Service plan?
...
## <a name="how-do-i-schedule-a-webjob"></a>How do I schedule a WebJob?
...
## <a name="how-do-i-perform-penetration-testing-for-my-app-service-app"></a>How do I perform penetration testing for my App Service app?

To perform penetration testing, [submit a request](https://portal.msrc.microsoft.com/en-us/engage/pentest).

## <a name="how-do-i-configure-a-custom-domain-name-for-an-app-service-web-app-that-uses-traffic-manager"></a>How do I configure a custom domain name for an App Service web app that uses Traffic Manager?
...
## <a name="my-app-service-certificate-is-flagged-for-fraud-how-do-i-resolve-this"></a>My App Service certificate is flagged for fraud. How do I resolve this?
...
## <a name="how-do-authentication-and-authorization-work-in-app-service"></a>How do authentication and authorization work in App Service?
...
## <a name="how-do-i-redirect-the-default-azurewebsitesnet-domain-to-my-azure-web-apps-custom-domain"></a>How do I redirect the default *.azurewebsites.net domain to my Azure web app's custom domain?
...
## <a name="how-do-i-determine-which-version-of-net-version-is-installed-in-app-service"></a>How do I determine which version of .NET version is installed in App Service?
...
## <a name="why-isnt-autoscale-working-as-expected"></a>Why isn't Autoscale working as expected?
...
## <a name="why-does-autoscale-sometimes-scale-only-partially"></a>Why does Autoscale sometimes scale only partially?
...
## <a name="how-do-i-turn-on-http-compression-for-my-content"></a>How do I turn on HTTP compression for my content?
...
## <a name="how-do-i-migrate-from-an-on-premises-environment-to-app-service"></a>How do I migrate from an on-premises environment to App Service?
