...
---
# <a name="tutorial-build-a-nodejs-and-mongodb-web-app-in-azure"></a>Tutorial: Build a Node.js and MongoDB web app in Azure
...
## <a name="test-local-mongodb"></a>Test local MongoDB
...
## <a name="create-local-nodejs-app"></a>Create local Node.js app
...
## <a name="create-production-mongodb"></a>Create production MongoDB
...
### <a name="create-a-cosmos-db-account"></a>Create a Cosmos DB account
...
## <a name="connect-app-to-production-mongodb"></a>Connect app to production MongoDB
...
## <a name="deploy-app-to-azure"></a>Deploy app to Azure
