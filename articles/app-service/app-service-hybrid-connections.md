...
### <a name="app-service-hybrid-connection-benefits"></a>App Service Hybrid Connection benefits ###
...
### <a name="things-you-cannot-do-with-hybrid-connections"></a>Things you cannot do with Hybrid Connections ###
...
## <a name="add-and-create-hybrid-connections-in-your-app"></a>Add and Create Hybrid Connections in your app ##
...
### <a name="create-a-hybrid-connection-in-the-azure-relay-portal"></a>Create a Hybrid Connection in the Azure Relay portal ###
...
## <a name="hybrid-connections-and-app-service-plans"></a>Hybrid Connections and App Service plans ##
...
### <a name="manually-add-a-hybrid-connection"></a>Manually add a Hybrid Connection ###
...
## <a name="adding-a-hybrid-connection-to-your-app-programmatically"></a>Adding a Hybrid Connection to your app programmatically ##
...
One way to use this information is with the armclient, which you can get from the [ARMClient][armclient] github project. Here is an example on attaching a pre-existing Hybrid Connection to your web app. Create a JSON file per the above schema like:
...
## <a name="biztalk-hybrid-connections"></a>BizTalk Hybrid Connections ##
