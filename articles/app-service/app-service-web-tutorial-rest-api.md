...
---
# <a name="tutorial-host-a-restful-api-with-cors-in-azure-app-service"></a>Tutorial: Host a RESTful API with CORS in Azure App Service
...
## <a name="create-local-aspnet-core-app"></a>Create local ASP.NET Core app
...
## <a name="add-cors-functionality"></a>Add CORS functionality

Next, you enable the built-in CORS support in App Service for your API.

### <a name="test-cors-in-sample-app"></a>Test CORS in sample app
...
### <a name="test-cors-again"></a>Test CORS again
...
## <a name="app-service-cors-vs-your-cors"></a>App Service CORS vs. your CORS
