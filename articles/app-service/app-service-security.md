...
---
# <a name="security-in-azure-app-service-and-azure-functions"></a>Security in Azure App Service and Azure Functions
...
## <a name="https-and-certificates"></a>HTTPS and Certificates
...
## <a name="insecure-protocols-http-tls-10-ftp"></a>Insecure protocols (HTTP, TLS 1.0, FTP)
...
## <a name="static-ip-restrictions"></a>Static IP restrictions
...
## <a name="client-authentication-and-authorization"></a>Client authentication and authorization
...
## <a name="connectivity-to-remote-resources"></a>Connectivity to remote resources
...
### <a name="resources-inside-an-azure-virtual-network"></a>Resources inside an Azure Virtual Network
