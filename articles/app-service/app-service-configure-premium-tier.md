...
---
# <a name="configure-premiumv2-tier-for-azure-app-service"></a>Configure PremiumV2 tier for Azure App Service
...
## <a name="premiumv2-availability"></a>PremiumV2 availability
...
## <a name="create-an-app-in-premiumv2-tier"></a>Create an app in PremiumV2 tier
...
## <a name="scale-up-an-existing-app-to-premiumv2-tier"></a>Scale up an existing app to PremiumV2 tier
...
### <a name="if-you-get-an-error"></a>If you get an error
...
## <a name="scale-up-from-an-unsupported-resource-group-and-region-combination"></a>Scale up from an unsupported resource group and region combination
