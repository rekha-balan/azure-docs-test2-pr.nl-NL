...
---
# <a name="open-source-technologies-faqs-for-web-apps-in-azure"></a>Open-source technologies FAQs for Web Apps in Azure
...
## <a name="how-do-i-turn-on-php-logging-to-troubleshoot-php-issues"></a>How do I turn on PHP logging to troubleshoot PHP issues?
...
## <a name="how-do-i-log-python-application-errors-in-apps-that-are-hosted-in-app-service"></a>How do I log Python application errors in apps that are hosted in App Service?
[!INCLUDE [web-sites-python-troubleshooting-wsgi-error-log](../../includes/web-sites-python-troubleshooting-wsgi-error-log.md)]

## <a name="how-do-i-change-the-version-of-the-nodejs-application-that-is-hosted-in-app-service"></a>How do I change the version of the Node.js application that is hosted in App Service?
...
## <a name="i-see-the-message-error-establishing-a-database-connection-in-my-wordpress-app-thats-hosted-in-app-service-how-do-i-troubleshoot-this"></a>I see the message "Error establishing a database connection" in my WordPress app that's hosted in App Service. How do I troubleshoot this?
...
## <a name="how-do-i-debug-a-nodejs-app-thats-hosted-in-app-service"></a>How do I debug a Node.js app that's hosted in App Service?
...
## <a name="how-do-i-install-native-python-modules-in-an-app-service-web-app-or-api-app"></a>How do I install native Python modules in an App Service web app or API app?
...
## <a name="how-do-i-deploy-a-django-app-to-app-service-by-using-git-and-the-new-version-of-python"></a>How do I deploy a Django app to App Service by using Git and the new version of Python?
...
## <a name="where-are-the-tomcat-log-files-located"></a>Where are the Tomcat log files located?
...
## <a name="how-do-i-troubleshoot-jdbc-driver-connection-errors"></a>How do I troubleshoot JDBC driver connection errors?
...
## <a name="why-do-i-see-errors-when-i-attempt-to-copy-live-log-files"></a>Why do I see errors when I attempt to copy live log files?
...
## <a name="where-do-i-find-the-log-files-for-jetty"></a>Where do I find the log files for Jetty?
...
## <a name="can-i-send-email-from-my-azure-web-app"></a>Can I send email from my Azure web app?
...
## <a name="why-does-my-wordpress-site-redirect-to-another-url"></a>Why does my WordPress site redirect to another URL?
...
## <a name="how-do-i-change-my-wordpress-sign-in-password"></a>How do I change my WordPress sign-in password?
...
## <a name="i-cant-sign-in-to-wordpress-how-do-i-resolve-this"></a>I can't sign in to WordPress. How do I resolve this?
...
## <a name="how-do-i-migrate-my-wordpress-database"></a>How do I migrate my WordPress database?
...
## <a name="how-do-i-help-make-wordpress-more-secure"></a>How do I help make WordPress more secure?
...
## <a name="i-am-trying-to-use-phpmyadmin-and-i-see-the-message-access-denied-how-do-i-resolve-this"></a>I am trying to use PHPMyAdmin, and I see the message “Access denied.” How do I resolve this?
...
## <a name="i-get-an-http-403-error-when-i-try-to-import-or-export-my-mysql-in-app-database-by-using-phpmyadmin-how-do-i-resolve-this"></a>I get an HTTP 403 error when I try to import or export my MySQL in-app database by using PHPMyadmin. How do I resolve this?
