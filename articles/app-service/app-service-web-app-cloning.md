...
## <a name="configuring-traffic-manager-while-cloning-an-app"></a>Configuring Traffic Manager while cloning an app
...
### <a name="creating-a-new-traffic-manager-profile-while-cloning-an-app"></a>Creating a new Traffic Manager profile while cloning an app
