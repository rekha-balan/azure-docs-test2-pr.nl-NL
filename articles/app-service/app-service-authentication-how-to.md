...
---
# <a name="customize-authentication-and-authorization-in-azure-app-service"></a>Customize authentication and authorization in Azure App Service
...
## <a name="use-multiple-sign-in-providers"></a>Use multiple sign-in providers
...
## <a name="sign-out-of-a-session"></a>Sign out of a session
...
## <a name="preserve-url-fragments"></a>Preserve URL fragments
...
## <a name="access-user-claims"></a>Access user claims
...
## <a name="retrieve-tokens-in-app-code"></a>Retrieve tokens in app code
...
## <a name="refresh-access-tokens"></a>Refresh access tokens
...
## <a name="extend-session-expiration-grace-period"></a>Extend session expiration grace period
...
## <a name="limit-the-domain-of-sign-in-accounts"></a>Limit the domain of sign-in accounts
