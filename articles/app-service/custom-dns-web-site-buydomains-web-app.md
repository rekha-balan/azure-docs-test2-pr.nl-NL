...
---
# <a name="buy-a-custom-domain-name-for-azure-web-apps"></a>Buy a custom domain name for Azure Web Apps
...
This article is for Azure App Service (Web Apps, API Apps, Mobile Apps, Logic Apps). For Azure VM or Azure Storage, see [Assign App Service domain to Azure VM or Azure Storage](https://blogs.msdn.microsoft.com/appserviceteam/2017/07/31/assign-app-service-domain-to-azure-vm-or-azure-storage/). For Cloud Services, see [Configuring a custom domain name for an Azure cloud service](../cloud-services/cloud-services-custom-domain-name-portal.md).
...
## <a name="buy-the-domain"></a>Buy the domain
...
### <a name="launch-buy-domains"></a>Launch Buy domains
...
### <a name="configure-the-domain-purchase"></a>Configure the domain purchase
...
### <a name="accept-terms-and-purchase"></a>Accept terms and purchase
...
### <a name="test-the-hostnames"></a>Test the hostnames
...
## <a name="assign-hostnames-to-web-app"></a>Assign hostnames to web app
...
### <a name="launch-add-hostname"></a>Launch add hostname
...
### <a name="configure-hostname"></a>Configure hostname
...
### <a name="close-add-hostname"></a>Close add hostname
...
## <a name="renew-the-domain"></a>Renew the domain
...
## <a name="cancel-purchase-delete-domain"></a>Cancel purchase (delete domain)
...
### <a name="cancel-or-delete"></a>Cancel or delete
...
## <a name="direct-default-url-to-a-custom-directory"></a>Direct default URL to a custom directory
