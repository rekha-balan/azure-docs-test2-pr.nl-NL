...
## <a name="how-the-local-cache-changes-the-behavior-of-app-service"></a>How the local cache changes the behavior of App Service
...
### <a name="does-local-cache-exclude-any-directories-from-being-copied-to-the-faster-local-drive"></a>Does Local Cache exclude any directories from being copied to the faster local drive?
