...
---
# <a name="how-to-use-the-azure-webjobs-sdk-for-event-driven-background-processing"></a>How to use the Azure WebJobs SDK for event-driven background processing
...
### <a name="jobhost-connection-strings"></a>JobHost connection strings
...
### <a name="jobhost-development-settings"></a>JobHost development settings
...
### <a name="jobhost-servicepointmanager-settings"></a>JobHost ServicePointManager settings
...
### <a name="automatic-trigger"></a>Automatic trigger
...
### <a name="manual-trigger"></a>Manual trigger
...
## <a name="input-and-output-bindings"></a>Input and output bindings
...
## <a name="binding-types"></a>Binding types
...
## <a name="binding-configuration"></a>Binding configuration
...
### <a name="queue-trigger-configuration"></a>Queue trigger configuration
...
### <a name="configuration-for-other-bindings"></a>Configuration for other bindings
...
## <a name="binding-expressions"></a>Binding expressions
...
### <a name="custom-binding-expressions"></a>Custom binding expressions
...
## <a name="binding-reference-information"></a>Binding reference information
...
## <a name="disable-attribute"></a>Disable attribute 
...
## <a name="timeout-attribute"></a>Timeout attribute
...
## <a name="singleton-attribute"></a>Singleton attribute
...
### <a name="scope-values"></a>Scope Values
...
### <a name="viewing-lease-blobs"></a>Viewing lease blobs
...
### <a name="log-filtering"></a>Log filtering
...
### <a name="custom-telemetry-for-application-insights"></a>Custom telemetry for Application Insights
