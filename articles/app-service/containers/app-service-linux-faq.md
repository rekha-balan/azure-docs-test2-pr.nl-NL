...
---
# <a name="azure-app-service-on-linux-faq"></a>Azure App Service on Linux FAQ
...
## <a name="continuous-integration-and-deployment"></a>Continuous integration and deployment
...
## <a name="multi-container-with-docker-compose-and-kubernetes"></a>Multi-container with Docker Compose and Kubernetes
