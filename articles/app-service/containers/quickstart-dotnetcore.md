...
---
# <a name="create-a-net-core-web-app-in-app-service-on-linux"></a>Create a .NET Core web app in App Service on Linux
...
## <a name="create-the-app-locally"></a>Create the app locally
