...
---
# <a name="tutorial-authenticate-and-authorize-users-end-to-end-in-azure-app-service-on-linux"></a>Tutorial: Authenticate and authorize users end-to-end in Azure App Service on Linux
