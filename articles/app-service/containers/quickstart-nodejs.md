...
---
# <a name="create-a-nodejs-web-app-in-azure-app-service-on-linux"></a>Create a Node.js web app in Azure App Service on Linux
...
## <a name="install-web-app-extension-for-cloud-shell"></a>Install web app extension for Cloud Shell
...
## <a name="update-and-redeploy-the-code"></a>Update and redeploy the code
