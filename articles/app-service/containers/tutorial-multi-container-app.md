...
---
# <a name="tutorial-create-a-multi-container-preview-app-in-web-app-for-containers"></a>Tutorial: Create a multi-container (preview) app in Web App for Containers
...
## <a name="docker-compose-configuration-options"></a>Docker Compose configuration options
...
### <a name="supported-options"></a>Supported options
...
### <a name="unsupported-options"></a>Unsupported options
...
### <a name="docker-compose-with-wordpress-and-mysql-containers"></a>Docker Compose with WordPress and MySQL containers
...
## <a name="connect-to-production-database"></a>Connect to production database
...
### <a name="create-the-wordpress-database"></a>Create the WordPress database
...
### <a name="configure-database-variables-in-wordpress"></a>Configure database variables in WordPress
...
### <a name="use-a-custom-image-for-mysql-ssl-and-other-configurations"></a>Use a custom image for MySQL SSL and other configurations
...
### <a name="update-app-with-new-configuration"></a>Update app with new configuration
...
## <a name="add-persistent-storage"></a>Add persistent storage
...
### <a name="modify-configuration-file"></a>Modify configuration file
...
## <a name="add-redis-container"></a>Add Redis container
...
### <a name="connect-wordpress-to-redis"></a>Connect WordPress to Redis
...
## <a name="use-a-kubernetes-configuration-optional"></a>Use a Kubernetes configuration (optional)
...
### <a name="kubernetes-configuration-file"></a>Kubernetes configuration file
...
### <a name="create-a-multi-container-app-kubernetes"></a>Create a multi-container app (Kubernetes)
...
## <a name="find-docker-container-logs"></a>Find Docker Container logs
