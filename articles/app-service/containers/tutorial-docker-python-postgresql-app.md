...
---
# <a name="build-a-docker-python-and-postgresql-web-app-in-azure"></a>Build a Docker Python and PostgreSQL web app in Azure
...
## <a name="test-local-postgresql-installation-and-create-a-database"></a>Test local PostgreSQL installation and create a database
...
## <a name="create-local-python-app"></a>Create local Python app

In this step, you set up the local Python Flask project.

### <a name="clone-the-sample-app"></a>Clone the sample app
...
## <a name="create-a-production-postgresql-database"></a>Create a production PostgreSQL database
...
### <a name="create-an-azure-database-for-postgresql-server"></a>Create an Azure Database for PostgreSQL server
...
### <a name="create-a-firewall-rule-for-the-postgresql-server"></a>Create a firewall rule for the PostgreSQL server
...
## <a name="connect-python-app-to-production-database"></a>Connect Python app to production database

In this step, you connect your Flask sample app to the Azure Database for PostgreSQL server you created.

### <a name="create-empty-database-and-user-access"></a>Create empty database and user access
...
### <a name="test-app-connectivity-to-production-database"></a>Test app connectivity to production database
...
## <a name="upload-app-to-a-container-registry"></a>Upload app to a container registry
...
### <a name="build-the-docker-image-and-test-it"></a>Build the Docker image and test it
...
### <a name="retrieve-registry-credentials"></a>Retrieve registry credentials
...
### <a name="upload-docker-image-to-registry"></a>Upload Docker image to registry
...
## <a name="create-web-app-with-uploaded-image"></a>Create web app with uploaded image
...
### <a name="configure-custom-container-deployment"></a>Configure custom container deployment
...
## <a name="update-data-model-and-redeploy"></a>Update data model and redeploy
...
### <a name="test-your-changes-locally"></a>Test your changes locally
...
## <a name="manage-your-azure-web-app"></a>Manage your Azure web app
