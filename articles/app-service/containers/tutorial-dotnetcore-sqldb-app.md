...
---
# <a name="build-a-net-core-and-sql-database-web-app-in-azure-app-service-on-linux"></a>Build a .NET Core and SQL Database web app in Azure App Service on Linux
...
## <a name="create-production-sql-database"></a>Create production SQL Database
...
### <a name="create-a-sql-database-logical-server"></a>Create a SQL Database logical server
...
### <a name="create-connection-string"></a>Create connection string
...
### <a name="connect-to-sql-database-in-production"></a>Connect to SQL Database in production
...
## <a name="update-locally-and-redeploy"></a>Update locally and redeploy
