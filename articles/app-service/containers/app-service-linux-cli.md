...
---
# <a name="manage-web-app-for-containers-using-azure-cli"></a>Manage Web App for Containers using Azure CLI
...
## <a name="create-a-custom-docker-container-web-app"></a>Create a custom Docker container Web App
...
## <a name="activate-the-docker-container-logging"></a>Activate the Docker container logging
...
## <a name="change-the-custom-docker-container-for-an-existing-web-app-for-containers-app"></a>Change the custom Docker container for an existing Web App for Containers App
...
## <a name="using-docker-images-from-a-private-registry"></a>Using Docker images from a private registry
...
## <a name="enable-continuous-deployments-for-custom-docker-images"></a>Enable continuous deployments for custom Docker images
...
## <a name="create-a-web-app-for-containers-app-using-one-of-our-built-in-runtime-frameworks"></a>Create a Web App for Containers App using one of our built-in runtime frameworks
...
## <a name="change-framework-version-for-an-existing-web-app-for-containers-app"></a>Change framework version for an existing Web App for Containers App
...
## <a name="set-up-git-deployments-for-your-web-app"></a>Set up Git deployments for your Web App
