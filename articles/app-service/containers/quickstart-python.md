...
---
# <a name="create-a-python-web-app-in-azure-app-service-on-linux-preview"></a>Create a Python web app in Azure App Service on Linux (Preview)
...
## <a name="update-locally-and-redeploy-the-code"></a>Update locally and redeploy the code
