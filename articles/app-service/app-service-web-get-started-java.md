...
---
# <a name="create-your-first-java-web-app-in-azure"></a>Create your first Java web app in Azure
...
## <a name="create-a-dynamic-web-project-in-eclipse"></a>Create a dynamic web project in Eclipse
...
### <a name="add-a-jsp-page"></a>Add a JSP page
...
## <a name="publish-the-web-app-to-azure"></a>Publish the web app to Azure
...
### <a name="deploy-web-app-dialog-box"></a>Deploy Web App dialog box
...
### <a name="create-app-service-dialog-box"></a>Create App Service dialog box
...
### <a name="resource-group-tab"></a>Resource group tab
...
## <a name="update-the-web-app"></a>Update the web app
...
## <a name="manage-the-web-app"></a>Manage the web app
