...
---
# <a name="use-an-ssl-certificate-in-your-application-code-in-azure-app-service"></a>Use an SSL certificate in your application code in Azure App Service
...
## <a name="load-your-certificates"></a>Load your certificates
...
## <a name="use-certificate-in-c-code"></a>Use certificate in C# code
...
<a name="file"></a>
## <a name="alternative-load-certificate-as-a-file"></a>Alternative: load certificate as a file
