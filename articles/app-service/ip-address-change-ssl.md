...
---
# <a name="how-to-prepare-for-an-ssl-ip-address-change"></a>How to prepare for an SSL IP address change
...
## <a name="release-ssl-ip-addresses-and-assign-new-ones"></a>Release SSL IP addresses and assign new ones
...
## <a name="find-the-new-ssl-ip-address-in-the-azure-portal"></a>Find the new SSL IP address in the Azure Portal
