...
---
# <a name="manage-an-app-service-plan-in-azure"></a>Manage an App Service plan in Azure
...
## <a name="move-an-app-to-another-app-service-plan"></a>Move an app to another App Service plan
...
## <a name="move-an-app-to-a-different-region"></a>Move an app to a different region
...
## <a name="delete-an-app-service-plan"></a>Delete an App Service plan
