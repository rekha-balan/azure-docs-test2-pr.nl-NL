...
## <a name="step-1---sign-in-to-azure"></a>Step 1 - Sign in to Azure

Sign in to the Azure portal at http://portal.azure.com

## <a name="step-2---place-an-ssl-certificate-order"></a>Step 2 - Place an SSL Certificate order
...
## <a name="step-3---store-the-certificate-in-azure-key-vault"></a>Step 3 - Store the certificate in Azure Key Vault
...
## <a name="step-4---verify-the-domain-ownership"></a>Step 4 - Verify the Domain Ownership
...
## <a name="step-5---assign-certificate-to-app-service-app"></a>Step 5 - Assign Certificate to App Service App
...
### <a name="verifying-domain-ownership"></a>Verifying Domain Ownership
...
#### <a name="domain-verification"></a>Domain Verification
...
#### <a name="manual-verification"></a>Manual Verification
...
### <a name="assign-certificate-to-app-service-app"></a>Assign Certificate to App Service App
...
## <a name="rekey-and-sync-the-certificate"></a>Rekey and Sync the Certificate
...
## <a name="renew-the-certificate"></a>Renew the certificate
...
<a name="notrenewed"></a>
## <a name="why-is-my-certificate-not-auto-renewed"></a>Why is my certificate not auto-renewed?
