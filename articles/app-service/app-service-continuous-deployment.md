...
## <a name="deploy-continuously-from-github"></a>Deploy continuously from GitHub
...
### <a name="option-1-use-app-service-kudu-build-server"></a>Option 1: use App Service Kudu build server
...
### <a name="option-2-use-azure-devops-services-continuous-delivery"></a>Option 2: use Azure DevOps Services continuous delivery
...
### <a name="finish-configuration"></a>Finish configuration
...
## <a name="deploy-continuously-from-bitbucket"></a>Deploy continuously from BitBucket
...
## <a name="deploy-continuously-from-azure-devops-services"></a>Deploy continuously from Azure DevOps Services
...
## <a name="disable-continuous-deployment"></a>Disable continuous deployment
