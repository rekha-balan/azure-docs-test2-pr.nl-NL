...
---
# <a name="guidance-on-deploying-web-apps-by-using-azure-resource-manager-templates"></a>Guidance on deploying web apps by using Azure Resource Manager templates
...
## <a name="define-dependencies"></a>Define dependencies
...
## <a name="find-information-about-msdeploy-errors"></a>Find information about MSDeploy errors
...
## <a name="choose-a-unique-web-app-name"></a>Choose a unique web app name
...
## <a name="deploy-web-app-certificate-from-key-vault"></a>Deploy web app certificate from Key Vault
