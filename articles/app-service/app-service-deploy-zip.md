...
---
# <a name="deploy-your-app-to-azure-app-service-with-a-zip-or-war-file"></a>Deploy your app to Azure App Service with a ZIP or WAR file
...
## <a name="create-a-project-zip-file"></a>Create a project ZIP file
...
## <a name="deploy-zip-file-with-azure-cli"></a>Deploy ZIP file with Azure CLI
...
## <a name="deploy-war-file"></a>Deploy WAR file
...
### <a name="with-powershell"></a>With PowerShell
