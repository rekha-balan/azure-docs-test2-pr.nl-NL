...
---
# <a name="tutorial-secure-azure-sql-database-connection-from-app-service-using-a-managed-identity"></a>Tutorial: Secure Azure SQL Database connection from App Service using a managed identity
...
## <a name="enable-managed-identities"></a>Enable managed identities
...
## <a name="grant-database-access-to-identity"></a>Grant database access to identity
...
## <a name="modify-connection-string"></a>Modify connection string
...
## <a name="modify-aspnet-code"></a>Modify ASP.NET code
...
## <a name="grant-minimal-privileges-to-identity"></a>Grant minimal privileges to identity
...
### <a name="add-managed-identity-to-an-azure-active-directory-group"></a>Add managed identity to an Azure Active Directory group
...
### <a name="reconfigure-azure-ad-administrator"></a>Reconfigure Azure AD administrator
...
### <a name="grant-permissions-to-azure-active-directory-group"></a>Grant permissions to Azure Active Directory group
