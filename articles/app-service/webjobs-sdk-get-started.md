...
---
# <a name="get-started-with-the-azure-webjobs-sdk-for-event-driven-background-processing"></a>Get started with the Azure WebJobs SDK for event-driven background processing
...
### <a name="functions-triggers-and-bindings"></a>Functions, triggers and bindings
...
### <a name="versions-2x-and-3x"></a>Versions 2.x and 3.x
...
## <a name="add-webjobs-nuget-package"></a>Add WebJobs NuGet package
...
## <a name="create-the-jobhost"></a>Create the JobHost
...
## <a name="enable-console-logging"></a>Enable console logging
...
## <a name="configure-storage-for-running-locally"></a>Configure storage for running locally
...
## <a name="test-locally"></a>Test locally
...
## <a name="add-application-insights-logging"></a>Add Application Insights logging
...
### <a name="create-app-service-app-and-application-insights-instance"></a>Create App Service app and Application Insights instance
...
### <a name="add-application-insights-logging-provider"></a>Add Application Insights logging provider
...
## <a name="test-application-insights-logging"></a>Test Application Insights logging
...
## <a name="deploy-as-a-webjob"></a>Deploy as a WebJob
...
## <a name="trigger-the-function-in-azure"></a>Trigger the function in Azure
...
### <a name="view-logs-in-application-insights"></a>View logs in Application Insights
...
## <a name="add-an-input-binding"></a>Add an input binding
