...
## <a name="roll-back-a-production-app-after-swap"></a>Roll back a production app after swap
...
## <a name="monitor-swap-progress"></a>Monitor swap progress
...
## <a name="delete-a-deployment-slot"></a>Delete a deployment slot
...
## <a name="automate-with-azure-powershell"></a>Automate with Azure PowerShell
...
- - -
### <a name="initiate-a-swap-with-preview-multi-phase-swap-and-apply-destination-slot-configuration-to-source-slot"></a>Initiate a swap with preview (multi-phase swap) and apply destination slot configuration to source slot
```PowerShell
...
## <a name="automate-with-azure-cli"></a>Automate with Azure CLI
