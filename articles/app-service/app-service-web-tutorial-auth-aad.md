...
---
# <a name="tutorial-authenticate-and-authorize-users-end-to-end-in-azure-app-service"></a>Tutorial: Authenticate and authorize users end-to-end in Azure App Service
...
## <a name="create-local-net-core-app"></a>Create local .NET Core app
...
### <a name="clone-and-run-the-sample-application"></a>Clone and run the sample application
...
### <a name="browse-to-the-azure-web-apps"></a>Browse to the Azure web apps
...
## <a name="call-back-end-api-from-front-end"></a>Call back-end API from front end
...
### <a name="modify-front-end-code"></a>Modify front-end code
...
### <a name="check-your-changes"></a>Check your changes
...
## <a name="configure-auth"></a>Configure auth
...
### <a name="enable-authentication-and-authorization-for-back-end-app"></a>Enable authentication and authorization for back-end app
...
### <a name="enable-authentication-and-authorization-for-front-end-app"></a>Enable authentication and authorization for front-end app
...
### <a name="grant-front-end-app-access-to-back-end"></a>Grant front-end app access to back end
...
### <a name="configure-app-service-to-return-a-usable-access-token"></a>Configure App Service to return a usable access token
...
## <a name="call-api-securely-from-server-code"></a>Call API securely from server code
...
## <a name="call-api-securely-from-browser-code"></a>Call API securely from browser code
...
### <a name="configure-cors"></a>Configure CORS
...
### <a name="point-angularjs-app-to-back-end-api"></a>Point Angular.js app to back-end API
...
### <a name="add-access-token-to-api-calls"></a>Add access token to API calls
...
### <a name="deploy-updates-and-test"></a>Deploy updates and test
...
## <a name="when-access-tokens-expire"></a>When access tokens expire
