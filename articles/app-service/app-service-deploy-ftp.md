...
## <a name="deploy-files-to-azure"></a>Deploy files to Azure

1. From your FTP client (for example, [Visual Studio](https://www.visualstudio.com/vs/community/) or [FileZilla](https://filezilla-project.org/download.php?type=client)), use the connection information you gathered to connect to your app.
...
## <a name="troubleshoot-ftp-deployment"></a>Troubleshoot FTP deployment
...
### <a name="how-can-i-troubleshoot-ftp-deployment"></a>How can I troubleshoot FTP deployment?
...
### <a name="im-not-able-to-ftp-and-publish-my-code-how-can-i-resolve-the-issue"></a>I'm not able to FTP and publish my code. How can I resolve the issue?
...
### <a name="how-can-i-connect-to-ftp-in-azure-app-service-via-passive-mode"></a>How can I connect to FTP in Azure App Service via passive mode?
