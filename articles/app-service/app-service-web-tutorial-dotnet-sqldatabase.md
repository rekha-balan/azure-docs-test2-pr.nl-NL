...
---
# <a name="tutorial-build-an-aspnet-app-in-azure-with-sql-database"></a>Tutorial: Build an ASP.NET app in Azure with SQL Database
...
## <a name="publish-to-azure-with-sql-database"></a>Publish to Azure with SQL Database
...
## <a name="access-the-sql-database-locally"></a>Access the SQL Database locally
...
## <a name="update-app-with-code-first-migrations"></a>Update app with Code First Migrations
...
## <a name="stream-application-logs"></a>Stream application logs
