...
---
# <a name="migrate-an-active-dns-name-to-azure-app-service"></a>Migrate an active DNS name to Azure App Service
...
### <a name="enable-the-domain-for-your-app"></a>Enable the domain for your app
...
## <a name="remap-the-active-dns-name"></a>Remap the active DNS name
...
### <a name="copy-the-apps-ip-address-a-record-only"></a>Copy the app's IP address (A record only)
...
### <a name="update-the-dns-record"></a>Update the DNS record
