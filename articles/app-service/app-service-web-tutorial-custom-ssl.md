...
---
# <a name="tutorial-bind-an-existing-custom-ssl-certificate-to-azure-web-apps"></a>Tutorial: Bind an existing custom SSL certificate to Azure Web Apps
...
### <a name="requirements-for-your-ssl-certificate"></a>Requirements for your SSL certificate
...
## <a name="prepare-your-web-app"></a>Prepare your web app
...
### <a name="navigate-to-your-web-app"></a>Navigate to your web app
...
## <a name="bind-your-ssl-certificate"></a>Bind your SSL certificate

You are ready to upload your SSL certificate to your web app.

### <a name="merge-intermediate-certificates"></a>Merge intermediate certificates
...
### <a name="export-certificate-to-pfx"></a>Export certificate to PFX
...
### <a name="upload-your-ssl-certificate"></a>Upload your SSL certificate
...
## <a name="remap-a-record-for-ip-ssl"></a>Remap A record for IP SSL
...
## <a name="renew-certificates"></a>Renew certificates
...
## <a name="enforce-https"></a>Enforce HTTPS
...
## <a name="enforce-tls-versions"></a>Enforce TLS versions
...
New-AzureRmWebAppSSLBinding `
    ...
    -SslState SniEnabled
```
## <a name="public-certificates-optional"></a>Public certificates (optional)
