...
---
# <a name="use-virtual-network-service-endpoints-with-azure-event-hubs"></a>Use Virtual Network service endpoints with Azure Event Hubs
...
## <a name="advanced-security-scenarios-enabled-by-vnet-integration"></a>Advanced security scenarios enabled by VNet integration 
...
## <a name="bind-event-hubs-to-virtual-networks"></a>Bind Event Hubs to Virtual Networks
...
### <a name="create-a-virtual-network-rule-with-azure-resource-manager-templates"></a>Create a virtual network rule with Azure Resource Manager templates
