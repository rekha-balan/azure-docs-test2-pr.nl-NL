...
---
# <a name="create-an-event-hubs-namespace-with-an-event-hub-and-consumer-group-using-an-azure-resource-manager-template"></a>Create an Event Hubs namespace with an event hub and consumer group using an Azure Resource Manager template
