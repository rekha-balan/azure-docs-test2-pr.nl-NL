...
---
# <a name="use-apache-flink-with-azure-event-hubs-for-apache-kafka"></a>Use Apache Flink with Azure Event Hubs for Apache Kafka
...
## <a name="run-flink-producer"></a>Run Flink producer
...
## <a name="run-flink-consumer"></a>Run Flink consumer
