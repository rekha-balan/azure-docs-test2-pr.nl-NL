...
---
# <a name="azure-event-hubs-event-processor-host-overview"></a>Azure Event Hubs Event Processor Host overview
...
## <a name="write-the-consumer-application"></a>Write the consumer application
...
## <a name="partition-ownership-tracking"></a>Partition ownership tracking
...
## <a name="thread-safety-and-processor-instances"></a>Thread safety and processor instances
...
## <a name="shut-down-gracefully"></a>Shut down gracefully
...
## <a name="control-event-processor-host-options"></a>Control Event Processor Host options
