...
---
# <a name="receive-events-from-event-hubs-using-python"></a>Receive events from Event Hubs using Python
...
Code in this tutorial is taken from [these GitHub samples](https://github.com/Azure/azure-event-hubs-python/tree/master/examples), which you can examine to see the full working application, including import statements and variable declarations. Other examples are available in the same GitHub folder.
...
## <a name="install-python-package"></a>Install Python package
...
## <a name="create-a-python-script-to-receive-events"></a>Create a Python script to receive events
