...
---
# <a name="quickstart-create-an-event-hub-using-azure-powershell"></a>Quickstart: Create an event hub using Azure PowerShell
...
## <a name="provision-resources"></a>Provision resources
...
### <a name="create-a-storage-account-for-event-processor-host"></a>Create a storage account for Event Processor Host
...
## <a name="stream-into-event-hubs"></a>Stream into Event Hubs
...
### <a name="ingest-events"></a>Ingest events
...
### <a name="receive-and-process-events"></a>Receive and process events
