...
---
# <a name="process-apache-kafka-for-event-hubs-events-using-stream-analytics"></a>Process Apache Kafka for Event Hubs events using Stream analytics 
...
## <a name="create-a-kafka-enabled-event-hubs-namespace"></a>Create a Kafka enabled Event Hubs namespace
...
## <a name="send-messages-with-kafka-in-event-hubs"></a>Send messages with Kafka in Event Hubs
...
## <a name="verify-that-event-hub-receives-the-data"></a>Verify that event hub receives the data
...
## <a name="process-event-data-using-a-stream-analytics-job"></a>Process event data using a Stream Analytics job
...
### <a name="configure-job-input"></a>Configure job input
...
### <a name="configure-job-output"></a>Configure job output 
...
### <a name="define-a-query"></a>Define a query
