...
---
# <a name="active-directory-role-based-access-control-preview"></a>Active Directory Role-Based Access Control (preview)
...
## <a name="use-event-hubs-with-an-azure-ad-domain-user-account"></a>Use Event Hubs with an Azure AD domain user account
...
### <a name="create-an-active-directory-user-account"></a>Create an Active Directory user account
