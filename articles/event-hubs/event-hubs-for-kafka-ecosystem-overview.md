...
---
# <a name="azure-event-hubs-for-apache-kafka-preview"></a>Azure Event Hubs for Apache Kafka (preview)
...
## <a name="what-does-event-hubs-for-kafka-provide"></a>What does Event Hubs for Kafka provide?
...
### <a name="kafka-and-event-hub-conceptual-mapping"></a>Kafka and Event Hub conceptual mapping
...
### <a name="key-differences-between-kafka-and-event-hubs"></a>Key differences between Kafka and Event Hubs
...
## <a name="other-event-hubs-features-available-for-kafka"></a>Other Event Hubs features available for Kafka
...
## <a name="features-that-are-not-supported-in-the-preview"></a>Features that are not supported in the preview
