...
---
# <a name="get-started-receiving-messages-with-the-event-processor-host-in-net-standard"></a>Get started receiving messages with the Event Processor Host in .NET Standard
...
## <a name="create-an-event-hubs-namespace-and-an-event-hub"></a>Create an Event Hubs namespace and an event hub  
...
## <a name="add-the-event-hubs-nuget-package"></a>Add the Event Hubs NuGet package

Add the following NuGet packages to the project:
* [`Microsoft.Azure.EventHubs`](https://www.nuget.org/packages/Microsoft.Azure.EventHubs/)
* [`Microsoft.Azure.EventHubs.Processor`](https://www.nuget.org/packages/Microsoft.Azure.EventHubs.Processor/)

## <a name="implement-the-ieventprocessor-interface"></a>Implement the IEventProcessor interface
...
## <a name="write-a-main-console-method-that-uses-the-simpleeventprocessor-class-to-receive-messages"></a>Write a main console method that uses the SimpleEventProcessor class to receive messages
