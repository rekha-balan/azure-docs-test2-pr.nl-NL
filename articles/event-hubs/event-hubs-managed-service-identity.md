...
---
# <a name="managed-service-identity-preview"></a>Managed Service Identity (preview)
...
## <a name="event-hubs-roles-and-permissions"></a>Event Hubs roles and permissions
...
## <a name="use-event-hubs-with-a-managed-service-identity"></a>Use Event Hubs with a Managed Service Identity
...
### <a name="create-an-app-service-web-application"></a>Create an App Service web application
...
### <a name="set-up-the-managed-service-identity"></a>Set up the managed service identity
...
### <a name="create-a-new-event-hubs-namespace"></a>Create a new Event Hubs namespace
