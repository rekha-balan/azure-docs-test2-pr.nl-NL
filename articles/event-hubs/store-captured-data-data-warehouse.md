...
---
# <a name="process-and-migrate-captured-event-hubs-data-to-a-sql-data-warehouse-using-event-grid-and-azure-functions"></a>Process and migrate captured Event Hubs data to a SQL Data Warehouse using Event Grid and Azure Functions
...
## <a name="publish-code-to-the-functions-app"></a>Publish code to the Functions App
...
## <a name="create-an-event-grid-subscription-from-the-functions-app"></a>Create an Event Grid subscription from the Functions app
...
## <a name="generate-sample-data"></a>Generate sample data  
...
## <a name="verify-captured-data-in-data-warehouse"></a>Verify captured data in data warehouse
