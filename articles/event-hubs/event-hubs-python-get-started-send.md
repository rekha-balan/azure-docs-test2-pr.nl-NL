...
---
# <a name="send-events-to-event-hubs-using-python"></a>Send events to Event Hubs using Python
...
## <a name="create-a-python-script-to-send-events"></a>Create a Python script to send events
