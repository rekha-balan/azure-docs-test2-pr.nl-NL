...
---
# <a name="enable-event-hubs-capture-using-the-azure-portal"></a>Enable Event Hubs Capture using the Azure portal
...
## <a name="capture-data-to-an-azure-storage-account"></a>Capture data to an Azure Storage account  
...
## <a name="capture-data-to-an-azure-data-lake-store-account"></a>Capture data to an Azure Data Lake Store account

To capture data to Azure Data Lake Store, you create a Data Lake Store account, and an event hub:

### <a name="create-an-azure-data-lake-store-account-and-folders"></a>Create an Azure Data Lake Store account and folders
...
## <a name="add-or-configure-capture-on-an-existing-event-hub"></a>Add or configure Capture on an existing event hub
