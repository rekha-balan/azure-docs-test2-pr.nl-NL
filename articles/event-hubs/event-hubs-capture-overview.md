...
## <a name="how-event-hubs-capture-works"></a>How Event Hubs Capture works
...
### <a name="capture-windowing"></a>Capture windowing
...
## <a name="setting-up-event-hubs-capture"></a>Setting up Event Hubs Capture
...
## <a name="exploring-the-captured-files-and-working-with-avro"></a>Exploring the captured files and working with Avro
...
## <a name="how-event-hubs-capture-is-charged"></a>How Event Hubs Capture is charged
