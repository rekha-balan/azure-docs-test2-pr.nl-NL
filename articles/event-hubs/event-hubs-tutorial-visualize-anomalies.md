...
---
# <a name="tutorial-visualize-data-anomalies-in-real-time-events-sent-to-azure-event-hubs"></a>Tutorial: Visualize data anomalies in real-time events sent to Azure Event Hubs
...
### <a name="set-up-your-resources-using-azure-cli"></a>Set up your resources using Azure CLI
...
### <a name="set-up-your-resources-using-azure-powershell"></a>Set up your resources using Azure PowerShell
...
## <a name="run-app-to-produce-test-event-data"></a>Run app to produce test event data
...
### <a name="test-the-query-for-the-stream-analytics-job"></a>Test the query for the Stream Analytics job 
