...
---
# <a name="quickstart-create-an-event-hub-using-azure-cli"></a>Quickstart: Create an event hub using Azure CLI
...
## <a name="log-on-to-azure"></a>Log on to Azure
...
### <a name="build-the-receiver"></a>Build the receiver 
...
## <a name="understand-the-sample-code"></a>Understand the sample code
