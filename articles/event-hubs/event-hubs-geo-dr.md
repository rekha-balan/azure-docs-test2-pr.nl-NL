...
---
# <a name="azure-event-hubs-geo-disaster-recovery"></a>Azure Event Hubs Geo-disaster recovery
...
## <a name="outages-and-disasters"></a>Outages and disasters
...
## <a name="basic-concepts-and-terms"></a>Basic concepts and terms
...
## <a name="setup-and-failover-flow"></a>Setup and failover flow
...
### <a name="failover-flow"></a>Failover flow
...
## <a name="availability-zones-preview"></a>Availability Zones (preview)
