...
## <a name="what-youll-accomplish"></a>What you'll accomplish
...
## <a name="create-a-python-script-to-read-your-capture-files"></a>Create a Python script to read your Capture files
