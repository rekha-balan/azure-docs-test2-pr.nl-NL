...
---
# <a name="send-events-to-event-hubs-using-go"></a>Send events to Event Hubs using Go
...
## <a name="install-go-package"></a>Install Go package
...
## <a name="create-event-hubs-client"></a>Create Event Hubs client
...
## <a name="send-messages"></a>Send messages
