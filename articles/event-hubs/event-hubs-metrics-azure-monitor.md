...
---
# <a name="azure-event-hubs-metrics-in-azure-monitor-preview"></a>Azure Event Hubs metrics in Azure Monitor (preview)
...
## <a name="access-metrics"></a>Access metrics
...
## <a name="access-metrics-in-the-portal"></a>Access metrics in the portal
...
## <a name="throughput-metrics"></a>Throughput metrics

| Metric Name | Description |
| ------------------- | ----------------- |
|Throttled Requests (preview)|The number of requests that were throttled because the throughput unit usage was exceeded.<br/><br/> Unit: Count <br/> Aggregation Type: Total <br/> Dimension: EntityName|

## <a name="message-metrics"></a>Message metrics
...
## <a name="connection-metrics"></a>Connection metrics
...
## <a name="event-hubs-capture-metrics"></a>Event Hubs Capture metrics
...
## <a name="metrics-dimensions"></a>Metrics dimensions
