...
---
# <a name="stream-into-event-hubs-for-the-apache-kafka"></a>Stream into Event Hubs for the Apache Kafka
...
## <a name="send-and-receive-messages-with-kafka-in-event-hubs"></a>Send and receive messages with Kafka in Event Hubs
