...
---
# <a name="automatically-scale-up-azure-event-hubs-throughput-units"></a>Automatically scale up Azure Event Hubs throughput units
...
## <a name="how-auto-inflate-works"></a>How Auto-inflate works
...
## <a name="enable-auto-inflate-on-a-namespace"></a>Enable Auto-inflate on a namespace
...
### <a name="enable-auto-inflate-through-the-portal"></a>Enable Auto-inflate through the portal
...
### <a name="enable-auto-inflate-using-an-azure-resource-manager-template"></a>Enable Auto-Inflate using an Azure Resource Manager template
