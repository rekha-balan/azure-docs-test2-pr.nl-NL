...
---
# <a name="create-a-namespace-with-event-hub-and-enable-capture-using-a-template"></a>Create a namespace with event hub and enable Capture using a template
...
## <a name="resources-to-deploy-for-azure-storage-as-destination-to-captured-events"></a>Resources to deploy for Azure Storage as destination to captured events
...
## <a name="resources-to-deploy-for-azure-data-lake-store-as-destination"></a>Resources to deploy for Azure Data Lake Store as destination
