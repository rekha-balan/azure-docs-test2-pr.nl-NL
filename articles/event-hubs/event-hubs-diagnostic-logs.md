...
---
# <a name="event-hubs-diagnostic-logs"></a>Event Hubs diagnostic logs
...
### <a name="archive-logs-schema"></a>Archive logs schema
...
### <a name="operation-logs-schema"></a>Operation logs schema
