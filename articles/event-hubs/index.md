...
ms.date: 01/23/2017
ms.author: carolz
ms.openlocfilehash: 1a5d81367749be78b88d8903aa659806e972ea17
ms.sourcegitcommit: 5b9d839c0c0a94b293fdafe1d6e5429506c07e05
ms.translationtype: MT
ms.contentlocale: nl-NL
ms.lasthandoff: 08/02/2018
ms.locfileid: "44556700"
---
...
<ul class="panelContent cardsFTitle">
     <li>
        <a href="/azure-nomedia/event-hubs/event-hubs-what-is-event-hubs">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/event-hubs/media/index/event-hubs.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/event-hubs/media/index/video-library.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
     ...
     <li>
        <a href="/azure-nomedia/event-hubs/event-hubs-programming-guide">
        <div class="cardSize">
            <div class="cardPadding">
               <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/event-hubs/media/index/get-started.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
    ...
    <li>
        <a href="/azure-nomedia/event-hubs/event-hubs-csharp-ephcs-getstarted">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/event-hubs/media/index/tutorial.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
