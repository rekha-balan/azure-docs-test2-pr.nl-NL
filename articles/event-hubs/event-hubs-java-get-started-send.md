...
---
# <a name="send-events-to-azure-event-hubs-using-java"></a>Send events to Azure Event Hubs using Java
...
## <a name="send-events-to-event-hubs"></a>Send events to Event Hubs
...
### <a name="declare-the-send-class"></a>Declare the Send class
...
### <a name="construct-connection-string"></a>Construct connection string
...
### <a name="how-messages-are-routed-to-eventhub-partitions"></a>How messages are routed to EventHub partitions
