...
---
# <a name="get-started-sending-messages-to-azure-event-hubs-in-net-standard"></a>Get started sending messages to Azure Event Hubs in .NET Standard
...
## <a name="write-some-code-to-send-messages-to-the-event-hub"></a>Write some code to send messages to the event hub
