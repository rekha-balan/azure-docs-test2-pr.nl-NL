...
---
# <a name="event-hubs-programming-guide"></a>Event Hubs programming guide
...
## <a name="send-events-to-an-event-hub"></a>Send events to an event hub
...
## <a name="event-serialization"></a>Event serialization
...
## <a name="batch-event-send-operations"></a>Batch event send operations
...
## <a name="send-asynchronously-and-send-at-scale"></a>Send asynchronously and send at scale
...
## <a name="create-a-partition-sender"></a>Create a partition sender
...
### <a name="direct-consumer"></a>Direct consumer
...
## <a name="publisher-revocation"></a>Publisher revocation
