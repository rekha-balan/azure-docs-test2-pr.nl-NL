...
## <a name="fully-managed-paas"></a>Fully managed PaaS 
...
## <a name="support-for-real-time-and-batch-processing"></a>Support for real-time and batch processing
...
## <a name="rich-ecosystem"></a>Rich ecosystem
...
## <a name="key-architecture-components"></a>Key architecture components
