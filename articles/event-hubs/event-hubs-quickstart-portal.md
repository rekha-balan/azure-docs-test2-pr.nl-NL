...
---
# <a name="quickstart-create-an-event-hub-using-azure-portal"></a>Quickstart: Create an event hub using Azure portal
...
## <a name="download-and-run-the-samples"></a>Download and run the samples
