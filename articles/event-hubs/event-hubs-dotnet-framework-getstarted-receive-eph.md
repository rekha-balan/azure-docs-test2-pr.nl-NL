...
---
# <a name="receive-events-from-azure-event-hubs-using-the-net-framework"></a>Receive events from Azure Event Hubs using the .NET Framework
...
## <a name="create-a-receiver-console-application"></a>Create a receiver console application
