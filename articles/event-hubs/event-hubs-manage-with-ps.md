...
---
# <a name="use-powershell-to-manage-event-hubs-resources"></a>Use PowerShell to manage Event Hubs resources
...
## <a name="provision-an-event-hubs-namespace"></a>Provision an Event Hubs namespace
...
#### <a name="set-user-metadata"></a>Set user metadata
...
## <a name="remove-event-hub"></a>Remove Event Hub
