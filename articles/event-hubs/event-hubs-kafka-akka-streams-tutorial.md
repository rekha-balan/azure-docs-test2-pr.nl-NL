...
---
# <a name="using-akka-streams-with-event-hubs-for-apache-kafka"></a>Using Akka Streams with Event Hubs for Apache Kafka
...
## <a name="clone-the-example-project"></a>Clone the example project
...
## <a name="run-akka-streams-producer"></a>Run Akka Streams producer

Using the provided Akka Streams producer example, send messages to the Event Hubs service.

### <a name="provide-an-event-hubs-kafka-endpoint"></a>Provide an Event Hubs Kafka endpoint
...
### <a name="run-producer-from-the-command-line"></a>Run producer from the command line
...
## <a name="run-akka-streams-consumer"></a>Run Akka Streams consumer
...
### <a name="run-consumer-from-the-command-line"></a>Run consumer from the command line
