...
---
# <a name="deploy-the-remote-monitoring-solution-accelerator-using-the-cli"></a>Deploy the Remote Monitoring solution accelerator using the CLI
...
## <a name="sign-in-to-the-cli"></a>Sign in to the CLI
...
## <a name="basic-vs-standard-deployments"></a>Basic vs. Standard Deployments
...
> Pricing information for these services can be found [here](https://azure.microsoft.com/pricing). Usage amounts and billing details for your subscription can be found in the [Azure Portal](https://portal.azure.com/).

## <a name="deploy-the-solution-accelerator"></a>Deploy the solution accelerator

### <a name="example-deploy-net-version"></a>Example: deploy .NET version
...
### <a name="example-deploy-java-version"></a>Example: deploy Java version
...
### <a name="pcs-command-options"></a>pcs command options
