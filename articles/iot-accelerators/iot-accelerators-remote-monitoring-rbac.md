...
---
# <a name="configure-role-based-access-controls-in-the-remote-monitoring-solution-accelerator"></a>Configure role-based access controls in the Remote Monitoring solution accelerator
...
## <a name="add-or-remove-users"></a>Add or remove users
...
### <a name="define-a-custom-role-in-the-azure-portal"></a>Define a custom role in the Azure portal
...
### <a name="define-a-policy-for-the-new-role"></a>Define a policy for the new role
...
### <a name="how-the-web-ui-enforces-permissions"></a>How the web UI enforces permissions
...
### <a name="how-the-microservices-enforce-permissions"></a>How the microservices enforce permissions
