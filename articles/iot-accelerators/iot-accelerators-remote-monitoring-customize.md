...
---
# <a name="customize-the-remote-monitoring-solution-accelerator"></a>Customize the Remote Monitoring solution accelerator
...
## <a name="prepare-a-local-development-environment-for-the-ui"></a>Prepare a local development environment for the UI
...
## <a name="customize-the-layout"></a>Customize the layout
...
## <a name="duplicate-and-customize-an-existing-control"></a>Duplicate and customize an existing control
...
## <a name="customize-the-telemetry-chart"></a>Customize the telemetry chart
...
## <a name="add-a-new-kpi"></a>Add a new KPI
...
## <a name="customize-the-map"></a>Customize the map
...
## <a name="other-customization-options"></a>Other customization options
