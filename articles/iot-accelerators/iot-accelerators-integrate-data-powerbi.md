...
---
# <a name="visualize-remote-monitoring-data-using-power-bi"></a>Visualize Remote Monitoring data using Power BI
...
## <a name="information-needed-from-azure-portal"></a>Information Needed from Azure Portal
...
## <a name="setting-up-the-stream-in-power-bi"></a>Setting up the Stream in Power BI
...
## <a name="creating-a-dashboard"></a>Creating a dashboard
...
## <a name="publishing-the-dashboard-and-refreshing-the-data"></a>Publishing the dashboard and refreshing the data
