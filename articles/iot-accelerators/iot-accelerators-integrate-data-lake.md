...
---
# <a name="integrate-the-remote-monitoring-solution-with-azure-data-lake-store"></a>Integrate the Remote Monitoring solution with Azure Data Lake Store
...
## <a name="create-a-consumer-group"></a>Create a consumer group
...
## <a name="configure-the-stream-analytics-job"></a>Configure the Stream Analytics job
...
## <a name="edit-the-stream-analytics-query"></a>Edit the Stream Analytics query
...
## <a name="explore-the-streaming-data"></a>Explore the streaming data
