...
---
# <a name="tutorial-monitor-your-iot-devices"></a>Tutorial: Monitor your IoT devices
...
## <a name="choose-the-devices-to-display"></a>Choose the devices to display
...
## <a name="view-real-time-telemetry"></a>View real-time telemetry
...
## <a name="view-the-map"></a>View the map
...
## <a name="view-the-system-kpis"></a>View the system KPIs
