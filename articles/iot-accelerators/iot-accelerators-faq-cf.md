...
---
# <a name="frequently-asked-questions-for-connected-factory-solution-accelerator"></a>Frequently asked questions for Connected Factory solution accelerator

See also, the general [FAQ](iot-accelerators-faq.md) for IoT solution accelerators.

### <a name="where-can-i-find-the-source-code-for-the-solution-accelerator"></a>Where can I find the source code for the solution accelerator?
...
### <a name="what-is-opc-ua"></a>What is OPC UA?
...
### <a name="why-did-microsoft-choose-opc-ua-for-the-connected-factory-solution-accelerator"></a>Why did Microsoft choose OPC UA for the Connected Factory solution accelerator?
...
### <a name="how-do-i-add-a-public-ip-address-to-the-simulation-vm"></a>How do I add a public IP address to the simulation VM?
...
### <a name="how-do-i-remove-the-public-ip-address-to-the-simulation-vm"></a>How do I remove the public IP address to the simulation VM?
...
### <a name="how-do-i-sign-in-to-the-simulation-vm"></a>How do I sign in to the simulation VM?
...
### <a name="how-do-i-stop-and-start-all-docker-processes-in-the-simulation-vm"></a>How do I stop and start all docker processes in the simulation VM?
...
### <a name="how-do-i-update-the-simulation-in-the-vm"></a>How do I update the simulation in the VM?
...
### <a name="how-do-i-find-out-the-connection-string-of-the-iot-hub-used-by-my-solution"></a>How do I find out the connection string of the IoT hub used by my solution?
...
### <a name="which-iot-hub-devices-does-the-connected-factory-simulation-use"></a>Which IoT Hub devices does the Connected Factory simulation use?
...
### <a name="how-can-i-get-log-data-from-the-simulation-components"></a>How can I get log data from the simulation components?
...
### <a name="how-can-i-check-if-the-simulation-is-sending-data-to-the-cloud"></a>How can I check if the simulation is sending data to the cloud?
...
### <a name="how-do-i-enable-an-interactive-map-in-my-connected-factory-solution"></a>How do I enable an interactive map in my Connected Factory solution?
...
### <a name="how-do-i-create-a-bing-maps-api-for-enterprise-account"></a>How do I create a Bing Maps API for Enterprise account
...
### <a name="how-to-obtain-your-bing-maps-api-for-enterprise-querykey"></a>How to obtain your Bing Maps API for Enterprise QueryKey
...
### <a name="how-do-enable-the-interactive-map-while-debugging-locally"></a>How do enable the interactive map while debugging locally?
...
### <a name="how-do-i-use-a-different-image-at-the-home-page-of-my-dashboard"></a>How do I use a different image at the home page of my dashboard?
...
### <a name="how-do-i-use-non-opc-ua-devices-with-connected-factory"></a>How do I use non OPC UA devices with Connected Factory?
