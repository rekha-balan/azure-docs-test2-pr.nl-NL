...
---
# <a name="use-features-in-the-connected-factory-solution-accelerator-dashboard"></a>Use features in the Connected Factory solution accelerator dashboard
...
## <a name="apply-filters"></a>Apply filters
...
## <a name="browse-an-opc-ua-server"></a>Browse an OPC UA server
...
## <a name="publish-a-node"></a>Publish a node
...
## <a name="command-and-control"></a>Command and control
