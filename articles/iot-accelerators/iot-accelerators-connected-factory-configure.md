...
---
# <a name="configure-the-connected-factory-solution-accelerator"></a>Configure the Connected Factory solution accelerator
...
## <a name="simulated-factories-configuration"></a>Simulated factories configuration
...
## <a name="connected-factory-topology"></a>Connected Factory topology
...
## <a name="topology-configuration-file"></a>Topology configuration file
...
## <a name="how-the-configuration-data-is-used-at-runtime"></a>How the configuration data is used at runtime
...
### <a name="visual-appearance"></a>Visual appearance
...
### <a name="internal-topology-tree-addressing"></a>Internal topology tree addressing
...
### <a name="oeekpi-computation"></a>OEE/KPI computation
...
### <a name="alert-handling"></a>Alert handling
...
## <a name="correlating-to-telemetry-data"></a>Correlating to telemetry data
...
## <a name="example-how-kpi1-is-calculated"></a>Example: How KPI1 is calculated
