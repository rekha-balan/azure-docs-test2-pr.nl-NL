...
---
# <a name="quickstart-try-a-cloud-based-solution-to-manage-my-industrial-iot-devices"></a>Quickstart: Try a cloud-based solution to manage my industrial IoT devices
...
You can view information about your Connected Factory solution accelerator in the panel that appears. Choose **Solution dashboard** to view your Connected Factory solution accelerator:
...
## <a name="view-the-dashboard"></a>View the dashboard
...
### <a name="factory-locations"></a>Factory Locations
