...
---
# <a name="connect-your-device-to-the-remote-monitoring-solution-accelerator-nodejs"></a>Connect your device to the Remote Monitoring solution accelerator (Node.js)
