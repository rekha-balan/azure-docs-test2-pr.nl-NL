...
---
# <a name="tutorial-configure-and-manage-devices-connected-to-your-monitoring-solution"></a>Tutorial: Configure and manage devices connected to your monitoring solution
...
## <a name="add-a-simulated-device"></a>Add a simulated device
...
## <a name="test-the-simulated-device"></a>Test the simulated device
...
## <a name="act-on-a-device"></a>Act on a device
...
## <a name="reconfigure-a-device"></a>Reconfigure a device
...
## <a name="organize-your-devices"></a>Organize your devices
