...
---
# <a name="connect-your-raspberry-pi-device-to-the-remote-monitoring-solution-accelerator-nodejs"></a>Connect your Raspberry Pi device to the Remote Monitoring solution accelerator (Node.js)
...
### <a name="required-desktop-software"></a>Required desktop software
...
### <a name="required-raspberry-pi-software"></a>Required Raspberry Pi software
...
## <a name="create-a-nodejs-solution"></a>Create a Node.js solution
