...
---
# <a name="quickstart-deploy-and-run-a-cloud-based-device-simulation-solution"></a>Quickstart: Deploy and run a cloud-based device simulation solution
...
## <a name="configure-the-simulation"></a>Configure the simulation
...
## <a name="run-the-simulation"></a>Run the simulation
