...
---
# <a name="quickstart-try-a-cloud-based-remote-monitoring-solution"></a>Quickstart: Try a cloud-based remote monitoring solution
...
## <a name="view-your-devices"></a>View your devices
...
## <a name="respond-to-an-alert"></a>Respond to an alert
...
### <a name="identify-the-issue"></a>Identify the issue
...
### <a name="fix-the-issue"></a>Fix the issue
...
### <a name="check-the-pressure-is-back-to-normal"></a>Check the pressure is back to normal
