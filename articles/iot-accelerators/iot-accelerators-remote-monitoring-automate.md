...
---
# <a name="tutorial-detect-issues-with-devices-connected-to-your-monitoring-solution"></a>Tutorial: Detect issues with devices connected to your monitoring solution
...
## <a name="review-the-existing-rules"></a>Review the existing rules
...
## <a name="create-a-rule"></a>Create a rule
...
## <a name="create-an-advanced-rule"></a>Create an advanced rule
...
## <a name="edit-an-existing-rule"></a>Edit an existing rule
...
## <a name="disable-a-rule"></a>Disable a rule
