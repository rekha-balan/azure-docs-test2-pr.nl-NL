...
---
# <a name="customize-how-the-connected-factory-solution-displays-data-from-your-opc-ua-servers"></a>Customize how the Connected Factory solution displays data from your OPC UA servers
...
## <a name="map-the-data"></a>Map the data
...
For more information about mapping and aggregating the data to meet your specific requirements, see [How to configure the Connected Factory solution accelerator ](iot-accelerators-connected-factory-configure.md).

## <a name="deploy-the-changes"></a>Deploy the changes
