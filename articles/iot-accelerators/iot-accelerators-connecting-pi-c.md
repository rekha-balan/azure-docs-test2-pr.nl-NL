...
---
# <a name="connect-your-raspberry-pi-device-to-the-remote-monitoring-solution-accelerator-c"></a>Connect your Raspberry Pi device to the Remote Monitoring solution accelerator (C)
