...
---
# <a name="customize-and-redeploy-a-microservice"></a>Customize and redeploy a microservice
...
## <a name="call-the-api-and-view-response-status"></a>Call the API and view response status
...
## <a name="change-the-status-and-build-the-image"></a>Change the status and build the image
...
5. Go back to your terminal but now change to the following directory: "...azure-iot-pcs-remote-monitoring-dotnet/iothub-manager/scripts/docker".
...
## <a name="update-your-remote-monitoring-solution"></a>Update your Remote Monitoring solution
...
1. Go back to the terminal and change to the following directory: "..azure-iot-pcs-remote-monitoring-dotnet/scripts/local".
...
## <a name="view-the-new-response-status"></a>View the new response status
