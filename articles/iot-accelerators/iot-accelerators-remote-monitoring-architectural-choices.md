...
---
# <a name="remote-monitoring-architectural-choices"></a>Remote Monitoring architectural choices
...
## <a name="architectural-choices"></a>Architectural choices

### <a name="microservices-serverless-and-cloud-native"></a>Microservices, serverless, and cloud native
...
## <a name="core-subsystem-technology-choices"></a>Core subsystem technology choices
...
### <a name="stream-processing"></a>Stream processing
...
### <a name="business-integration"></a>Business integration
...
### <a name="runtime-and-orchestration"></a>Runtime and orchestration
