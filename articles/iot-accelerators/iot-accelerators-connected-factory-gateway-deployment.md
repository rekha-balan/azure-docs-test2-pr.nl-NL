...
---
# <a name="deploy-an-edge-gateway-for-the-connected-factory-solution-accelerator-on-windows-or-linux"></a>Deploy an edge gateway for the Connected Factory solution accelerator on Windows or Linux
...
## <a name="choose-a-gateway-device"></a>Choose a gateway device
...
## <a name="install-and-configure-docker"></a>Install and configure Docker
...
## <a name="configure-the-opc-components"></a>Configure the OPC components
...
## <a name="enable-your-gateway"></a>Enable your gateway
...
## <a name="add-your-own-opc-ua-servers"></a>Add your own OPC UA servers
