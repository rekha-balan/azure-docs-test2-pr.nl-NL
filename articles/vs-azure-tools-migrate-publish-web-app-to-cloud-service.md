...
## <a name="migrate-a-project-to-cloud-services"></a>Migrate a project to cloud services
...
### <a name="errors-and-warnings"></a>Errors and warnings
...
### <a name="test-the-migration-locally"></a>Test the migration locally
...
## <a name="publish-the-application-to-azure-cloud-service"></a>Publish the application to Azure Cloud Service
...
## <a name="using-the-compute-emulator-and-starting-application-in-azure"></a>Using the compute emulator and starting application in Azure
