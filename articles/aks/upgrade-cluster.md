...
---
# <a name="upgrade-an-azure-kubernetes-service-aks-cluster"></a>Upgrade an Azure Kubernetes Service (AKS) cluster

Azure Kubernetes Service (AKS) makes it easy to perform common management tasks including upgrading Kubernetes clusters.

## <a name="upgrade-an-aks-cluster"></a>Upgrade an AKS cluster
