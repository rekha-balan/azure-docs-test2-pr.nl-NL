...
---
# <a name="use-virtual-kubelet-with-azure-kubernetes-service-aks"></a>Use Virtual Kubelet with Azure Kubernetes Service (AKS)
...
### <a name="for-rbac-enabled-clusters"></a>For RBAC-enabled clusters
...
## <a name="validate-virtual-kubelet"></a>Validate Virtual Kubelet
...
## <a name="run-linux-container"></a>Run Linux container
...
## <a name="run-windows-container"></a>Run Windows container
...
## <a name="remove-virtual-kubelet"></a>Remove Virtual Kubelet
