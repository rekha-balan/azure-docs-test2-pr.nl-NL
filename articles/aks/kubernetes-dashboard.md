...
---
# <a name="access-the-kubernetes-dashboard-with-azure-kubernetes-service-aks"></a>Access the Kubernetes dashboard with Azure Kubernetes Service (AKS)
...
## <a name="edit-the-application"></a>Edit the application
