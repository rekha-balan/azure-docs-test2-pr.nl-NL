...
---
# <a name="frequently-asked-questions-about-azure-kubernetes-service-aks"></a>Frequently asked questions about Azure Kubernetes Service (AKS)

This article addresses frequent questions about Azure Kubernetes Service (AKS).

## <a name="which-azure-regions-provide-the-azure-kubernetes-service-aks-today"></a>Which Azure regions provide the Azure Kubernetes Service (AKS) today?

For a complete list of available regions, see [AKS Regions and availability][aks-regions].

## <a name="does-aks-support-node-autoscaling"></a>Does AKS support node autoscaling?
...
## <a name="does-aks-support-kubernetes-role-based-access-control-rbac"></a>Does AKS support Kubernetes role-based access control (RBAC)?
...
## <a name="can-i-deploy-aks-into-my-existing-virtual-network"></a>Can I deploy AKS into my existing virtual network?
...
## <a name="can-i-restrict-the-kubernetes-api-server-to-only-be-accessible-within-my-virtual-network"></a>Can I restrict the Kubernetes API server to only be accessible within my virtual network?
...
## <a name="are-security-updates-applied-to-aks-agent-nodes"></a>Are security updates applied to AKS agent nodes?
...
## <a name="why-are-two-resource-groups-created-with-aks"></a>Why are two resource groups created with AKS?
...
## <a name="can-i-modify-tags-and-other-properties-of-the-aks-resources-in-the-mc-resource-group"></a>Can I modify tags and other properties of the AKS resources in the MC_* resource group?
...
## <a name="what-kubernetes-admission-controllers-does-aks-support-can-admission-controllers-be-added-or-removed"></a>What Kubernetes admission controllers does AKS support? Can admission controllers be added or removed?
...
## <a name="is-azure-key-vault-integrated-with-aks"></a>Is Azure Key Vault integrated with AKS?
...
## <a name="can-i-run-windows-server-containers-on-aks"></a>Can I run Windows Server containers on AKS?
...
## <a name="does-aks-offer-a-service-level-agreement"></a>Does AKS offer a service level agreement?
