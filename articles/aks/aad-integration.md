...
---
# <a name="integrate-azure-active-directory-with-aks"></a>Integrate Azure Active Directory with AKS
...
## <a name="authentication-details"></a>Authentication details
...
## <a name="create-server-application"></a>Create server application
...
## <a name="create-client-application"></a>Create client application
...
## <a name="create-rbac-binding"></a>Create RBAC binding
...
## <a name="access-cluster-with-azure-ad"></a>Access cluster with Azure AD
