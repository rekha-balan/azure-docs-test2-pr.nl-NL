...
---
# <a name="using-gpus-on-aks"></a>Using GPUs on AKS
...
## <a name="confirm-gpus-are-schedulable"></a>Confirm GPUs are schedulable
...
## <a name="run-a-gpu-enabled-workload"></a>Run a GPU enabled workload
