...
---
# <a name="integrate-with-azure-managed-services-using-open-service-broker-for-azure-osba"></a>Integrate with Azure-managed services using Open Service Broker for Azure (OSBA)
...
## <a name="install-service-catalog"></a>Install Service Catalog
...
## <a name="install-open-service-broker-for-azure"></a>Install Open Service Broker for Azure
...
## <a name="install-wordpress-from-helm-chart-using-azure-database-for-mysql"></a>Install WordPress from Helm chart using Azure Database for MySQL
