...
---
# <a name="quickstart-deploy-an-azure-kubernetes-service-aks-cluster"></a>Quickstart: Deploy an Azure Kubernetes Service (AKS) cluster
...
## <a name="monitor-health-and-logs"></a>Monitor health and logs
