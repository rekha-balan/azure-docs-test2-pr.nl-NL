...
---
# <a name="running-apache-spark-jobs-on-aks"></a>Running Apache Spark jobs on AKS
...
## <a name="create-an-aks-cluster"></a>Create an AKS cluster
...
## <a name="build-the-spark-source"></a>Build the Spark source
...
## <a name="prepare-a-spark-job"></a>Prepare a Spark job
...
## <a name="copy-job-to-storage"></a>Copy job to storage
...
## <a name="submit-a-spark-job"></a>Submit a Spark job
...
## <a name="get-job-results-and-logs"></a>Get job results and logs
...
## <a name="package-jar-with-container-image"></a>Package jar with container image
