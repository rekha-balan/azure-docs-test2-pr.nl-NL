...
---
# <a name="persistent-volumes-with-azure-files"></a>Persistent volumes with Azure files
...
## <a name="create-a-cluster-role-and-binding"></a>Create a cluster role and binding
