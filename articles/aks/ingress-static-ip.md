...
---
# <a name="create-an-ingress-controller-with-a-static-public-ip-address-in-azure-kubernetes-service-aks"></a>Create an ingress controller with a static public IP address in Azure Kubernetes Service (AKS)
...
## <a name="create-an-ingress-controller"></a>Create an ingress controller
...
## <a name="configure-a-dns-name"></a>Configure a DNS name
...
## <a name="install-cert-manager"></a>Install cert-manager
...
## <a name="create-a-ca-cluster-issuer"></a>Create a CA cluster issuer
...
## <a name="create-a-certificate-object"></a>Create a certificate object
...
## <a name="run-demo-applications"></a>Run demo applications
...
## <a name="create-an-ingress-route"></a>Create an ingress route
...
## <a name="test-the-ingress-configuration"></a>Test the ingress configuration
