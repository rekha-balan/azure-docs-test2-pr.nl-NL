...
---
# <a name="use-an-internal-load-balancer-with-azure-kubernetes-service-aks"></a>Use an internal load balancer with Azure Kubernetes Service (AKS)
...
## <a name="create-an-internal-load-balancer"></a>Create an internal load balancer
...
## <a name="specify-an-ip-address"></a>Specify an IP address
...
## <a name="use-private-networks"></a>Use private networks
...
## <a name="specify-a-different-subnet"></a>Specify a different subnet
...
## <a name="delete-the-load-balancer"></a>Delete the load balancer
