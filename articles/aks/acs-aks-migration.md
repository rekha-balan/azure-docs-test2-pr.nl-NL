...
---
# <a name="migrating-from-azure-container-service-acs-to-azure-kubernetes-service-aks"></a>Migrating from Azure Container Service (ACS) to Azure Kubernetes Service (AKS)
...
## <a name="differences-between-acs-and-aks"></a>Differences between ACS and AKS
...
### <a name="differences-between-kubernetes-versions"></a>Differences between Kubernetes versions
...
### <a name="agent-pools"></a>Agent Pools
...
### <a name="stateless-applications"></a>Stateless Applications
...
### <a name="stateful-applications"></a>Stateful Applications

Migrating stateful applications requires careful planning to avoid data loss or unexpected downtime.

#### <a name="highly-available-applications"></a>Highly Available Applications
...
#### <a name="migrating-persistent-volumes"></a>Migrating Persistent Volumes
...
### <a name="1-create-an-aks-cluster"></a>1. Create an AKS cluster
...
### <a name="2-modify-applications"></a>2. Modify applications

Make any necessary modifications to your YAML definitions. Ex: replacing `apps/v1beta1` with `apps/v1` for `Deployments`

### <a name="3-optional-migrate-volumes"></a>3. (Optional) Migrate volumes
