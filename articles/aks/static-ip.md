...
---
# <a name="use-a-static-ip-address-with-the-azure-kubernetes-service-aks-load-balancer"></a>Use a static IP address with the Azure Kubernetes Service (AKS) load balancer
...
## <a name="create-static-ip-address"></a>Create static IP address
...
## <a name="create-service-with-ip-address"></a>Create service with IP address
