...
---
# <a name="tutorial-deploy-an-azure-kubernetes-service-aks-cluster"></a>Tutorial: Deploy an Azure Kubernetes Service (AKS) cluster
...
## <a name="configure-acr-authentication"></a>Configure ACR authentication
...
## <a name="create-a-kubernetes-cluster"></a>Create a Kubernetes cluster
...
## <a name="install-the-kubernetes-cli"></a>Install the Kubernetes CLI
...
## <a name="connect-to-cluster-using-kubectl"></a>Connect to cluster using kubectl
