...
---
# <a name="network-configuration-in-azure-kubernetes-service-aks"></a>Network configuration in Azure Kubernetes Service (AKS)

When you create an Azure Kubernetes Service (AKS) cluster, you can select from two networking options: **Basic** or **Advanced**.

## <a name="basic-networking"></a>Basic networking
...
## <a name="advanced-networking"></a>Advanced networking
...
## <a name="advanced-networking-features"></a>Advanced networking features
...
## <a name="advanced-networking-prerequisites"></a>Advanced networking prerequisites
...
## <a name="plan-ip-addressing-for-your-cluster"></a>Plan IP addressing for your cluster
...
## <a name="maximum-pods-per-node"></a>Maximum pods per node
...
### <a name="default-maximum"></a>Default maximum
...
### <a name="configure-maximum---new-clusters"></a>Configure maximum - new clusters
...
### <a name="configure-maximum---existing-clusters"></a>Configure maximum - existing clusters
...
## <a name="deployment-parameters"></a>Deployment parameters
...
## <a name="configure-networking---cli"></a>Configure networking - CLI
...
## <a name="configure-networking---portal"></a>Configure networking - portal
...
### <a name="networking-in-aks"></a>Networking in AKS
