...
---
# <a name="tutorial-upgrade-kubernetes-in-azure-kubernetes-service-aks"></a>Tutorial: Upgrade Kubernetes in Azure Kubernetes Service (AKS)
...
## <a name="get-available-cluster-versions"></a>Get available cluster versions
...
## <a name="upgrade-a-cluster"></a>Upgrade a cluster
...
## <a name="validate-an-upgrade"></a>Validate an upgrade
