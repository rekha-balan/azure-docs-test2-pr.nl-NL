...
---
# <a name="azure-kubernetes-service-aks-egress"></a>Azure Kubernetes Service (AKS) egress
...
## <a name="egress-overview"></a>Egress overview
...
## <a name="create-a-static-public-ip"></a>Create a static public IP
...
## <a name="create-a-service-with-the-static-ip"></a>Create a service with the static IP
...
## <a name="verify-egress-address"></a>Verify egress address
