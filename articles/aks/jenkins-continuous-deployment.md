...
---
# <a name="continuous-deployment-with-jenkins-and-azure-kubernetes-service"></a>Continuous deployment with Jenkins and Azure Kubernetes Service
...
## <a name="prepare-application"></a>Prepare application
...
## <a name="deploy-application-to-kubernetes"></a>Deploy application to Kubernetes
...
## <a name="deploy-jenkins-to-vm"></a>Deploy Jenkins to VM
...
## <a name="jenkins-environment-variables"></a>Jenkins environment variables
...
## <a name="test-the-jenkins-build"></a>Test the Jenkins build
...
## <a name="create-github-webhook"></a>Create GitHub webhook
...
## <a name="test-cicd-process-end-to-end"></a>Test CI/CD process end to end
