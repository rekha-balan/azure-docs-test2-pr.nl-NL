...
---
# <a name="tutorial-scale-applications-in-azure-kubernetes-service-aks"></a>Tutorial: Scale applications in Azure Kubernetes Service (AKS)
...
## <a name="manually-scale-pods"></a>Manually scale pods
...
## <a name="autoscale-pods"></a>Autoscale pods
...
## <a name="manually-scale-aks-nodes"></a>Manually scale AKS nodes
