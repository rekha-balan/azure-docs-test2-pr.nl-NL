...
---
# <a name="use-draft-with-azure-kubernetes-service-aks"></a>Use Draft with Azure Kubernetes Service (AKS)
...
## <a name="install-draft"></a>Install Draft
...
## <a name="configure-draft"></a>Configure Draft
...
### <a name="create-trust-between-aks-cluster-and-acr"></a>Create trust between AKS cluster and ACR
...
### <a name="configure-draft-to-push-to-and-deploy-from-acr"></a>Configure Draft to push to and deploy from ACR
...
## <a name="run-an-application"></a>Run an application
...
## <a name="access-the-application-on-the-internet"></a>Access the application on the internet
...
## <a name="iterate-on-the-application"></a>Iterate on the application
