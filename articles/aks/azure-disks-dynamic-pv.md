...
---
# <a name="create-persistent-volumes-with-azure-disks-for-azure-kubernetes-service-aks"></a>Create persistent volumes with Azure disks for Azure Kubernetes Service (AKS)
...
## <a name="built-in-storage-classes"></a>Built in storage classes
...
## <a name="back-up-a-persistent-volume"></a>Back up a persistent volume
...
## <a name="restore-and-use-a-snapshot"></a>Restore and use a snapshot
