...
---
# <a name="get-kubelet-logs-from-azure-kubernetes-service-aks-cluster-nodes"></a>Get kubelet logs from Azure Kubernetes Service (AKS) cluster nodes
...
## <a name="create-an-ssh-connection"></a>Create an SSH connection
...
## <a name="get-kubelet-logs"></a>Get kubelet logs
