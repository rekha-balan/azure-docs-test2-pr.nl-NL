...
---
# <a name="scale-an-azure-kubernetes-service-aks-cluster"></a>Scale an Azure Kubernetes Service (AKS) cluster
...
## <a name="scale-the-cluster-nodes"></a>Scale the cluster nodes
