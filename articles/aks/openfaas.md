...
---
# <a name="using-openfaas-on-aks"></a>Using OpenFaaS on AKS
...
## <a name="create-first-function"></a>Create first function
...
## <a name="create-second-function"></a>Create second function
