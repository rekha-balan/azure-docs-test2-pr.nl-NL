...
---
# <a name="tutorial-prepare-an-application-for-azure-kubernetes-service-aks"></a>Tutorial: Prepare an application for Azure Kubernetes Service (AKS)
...
## <a name="create-container-images"></a>Create container images
