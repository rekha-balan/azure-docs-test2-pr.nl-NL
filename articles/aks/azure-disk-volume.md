...
---
# <a name="volumes-with-azure-disks"></a>Volumes with Azure disks
...
## <a name="create-an-azure-disk"></a>Create an Azure disk
...
## <a name="mount-disk-as-volume"></a>Mount disk as volume
