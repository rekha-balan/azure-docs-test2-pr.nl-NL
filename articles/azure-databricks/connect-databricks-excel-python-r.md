...
---
# <a name="connect-to-azure-databricks-from-excel-python-or-r"></a>Connect to Azure Databricks from Excel, Python, or R
...
## <a name="set-up-a-dsn"></a>Set up a DSN
...
## <a name="connect-from-microsoft-excel"></a>Connect from Microsoft Excel
...
## <a name="connect-from-r"></a>Connect from R
...
## <a name="connect-from-python"></a>Connect from Python
