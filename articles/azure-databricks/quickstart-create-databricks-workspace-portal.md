...
---
# <a name="quickstart-run-a-spark-job-on-azure-databricks-using-the-azure-portal"></a>Quickstart: Run a Spark job on Azure Databricks using the Azure portal
...
## <a name="download-a-sample-data-file"></a>Download a sample data file
