...
---
# <a name="tutorial-sentiment-analysis-on-streaming-data-using-azure-databricks"></a>Tutorial: Sentiment analysis on streaming data using Azure Databricks
...
## <a name="attach-libraries-to-spark-cluster"></a>Attach libraries to Spark cluster
...
## <a name="get-a-cognitive-services-access-key"></a>Get a Cognitive Services access key
...
## <a name="create-notebooks-in-databricks"></a>Create notebooks in Databricks
...
## <a name="send-tweets-to-event-hubs"></a>Send tweets to Event Hubs
...
## <a name="read-tweets-from-event-hubs"></a>Read tweets from Event Hubs
...
## <a name="run-sentiment-analysis-on-tweets"></a>Run sentiment analysis on tweets
