...
## <a name="apache-spark-based-analytics-platform"></a>Apache Spark-based analytics platform
...
### <a name="fully-managed-apache-spark-clusters-in-the-cloud"></a>Fully managed Apache Spark clusters in the cloud
...
### <a name="workspace-for-collaboration"></a>Workspace for collaboration
...
## <a name="enterprise-security"></a>Enterprise security
...
## <a name="integration-with-azure-services"></a>Integration with Azure services
...
## <a name="integration-with-power-bi"></a>Integration with Power BI
