...
---
# <a name="tutorial-extract-transform-and-load-data-using-azure-databricks"></a>Tutorial: Extract, transform, and load data using Azure Databricks
...
### <a name="create-an-azure-active-directory-service-principal"></a>Create an Azure Active Directory service principal
...
### <a name="get-application-id-and-authentication-key-for-the-service-principal"></a>Get application ID and authentication key for the service principal
...
## <a name="associate-service-principal-with-azure-data-lake-store"></a>Associate service principal with Azure Data Lake Store
...
## <a name="extract-data-from-data-lake-store"></a>Extract data from Data Lake Store
...
## <a name="transform-data-in-azure-databricks"></a>Transform data in Azure Databricks
