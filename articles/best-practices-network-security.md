...
### <a name="example-3-build-a-perimeter-network-to-help-protect-networks-with-a-firewall-and-udr-and-nsg"></a>Example 3 Build a perimeter network to help protect networks with a firewall and UDR and NSG
...
### <a name="example-4-add-a-hybrid-connection-with-a-site-to-site-virtual-appliance-vpn"></a>Example 4 Add a hybrid connection with a site-to-site, virtual appliance VPN
...
### <a name="example-5-add-a-hybrid-connection-with-a-site-to-site-azure-vpn-gateway"></a>Example 5 Add a hybrid connection with a site-to-site, Azure VPN gateway
[Back to Fast start](#fast-start) | Detailed build instructions available soon
