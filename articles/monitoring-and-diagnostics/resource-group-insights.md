...
---
# <a name="monitor-resource-groups-with-azure-monitor-preview"></a>Monitor resource groups with Azure Monitor (preview)
...
## <a name="access-insights-for-resource-groups"></a>Access insights for resource groups
...
## <a name="resources-with-active-alerts-and-health-issues"></a>Resources with active alerts and health issues
...
## <a name="diagnose-issues-in-your-resource-group"></a>Diagnose issues in your resource group
...
## <a name="failures-and-performance"></a>Failures and performance
...
### <a name="investigate-failures"></a>Investigate failures
...
### <a name="investigate-performance"></a>Investigate performance
