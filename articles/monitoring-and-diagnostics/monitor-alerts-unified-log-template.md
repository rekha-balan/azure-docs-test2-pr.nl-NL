...
---
# <a name="create-a-log-alert-with-a-resource-manager-template"></a>Create a log alert with a Resource Manager template
...
## <a name="managing-log-alert-on-log-analytics"></a>Managing log alert on Log Analytics
...
### <a name="using-resource-template-via-apipowershell"></a>Using Resource Template via API/Powershell
...
## <a name="managing-log-alert-on-application-insights"></a>Managing log alert on Application Insights
...
### <a name="using-resource-template-via-clipowershell"></a>Using Resource Template via CLI/Powershell
