...
---
# <a name="collect-and-consume-diagnostic-data-from-your-azure-resources"></a>Collect and consume diagnostic data from your Azure resources

## <a name="what-are-azure-diagnostic-logs"></a>What are Azure Diagnostic Logs
...
![Diagnostics Logs vs other types of logs ](https://docstestmedia1.blob.core.windows.net/azure-media/articles/monitoring-and-diagnostics/media/monitoring-overview-of-diagnostic-logs/Diagnostics_Logs_vs_other_logs_v5.png)
