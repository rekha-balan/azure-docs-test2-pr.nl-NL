...
---
# <a name="create-an-autoscale-setting-for--azure-resources-based-on-performance-data-or-a-schedule"></a>Create an Autoscale Setting for  Azure resources based on performance data or a schedule
...
## <a name="create-a-web-app-and-app-service-plan"></a>Create a Web App and App Service Plan
...
## <a name="navigate-to-autoscale-settings"></a>Navigate to Autoscale settings
...
The next few steps help you fill the autoscale screen to look like following picture:
 ...
 ## <a name="configure-default-profile"></a>Configure default profile
...
## <a name="create-recurrance-profile"></a>Create recurrance profile
...
## <a name="create-a-scale-out-rule"></a>Create a scale-out rule
...
## <a name="create-a-scale-in-rule"></a>Create a scale-in rule
...
## <a name="trigger-scale-out-action"></a>Trigger scale-out action
...
## <a name="trigger-scale-in-action"></a>Trigger scale-in action
