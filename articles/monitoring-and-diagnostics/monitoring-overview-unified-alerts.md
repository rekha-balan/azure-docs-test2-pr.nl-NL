...
---
# <a name="unified-alerts-in-azure-monitor"></a>Unified alerts in Azure Monitor
...
## <a name="features-of-the-unified-alert-experience"></a>Features of the unified alert experience
...
## <a name="alert-pages"></a>Alert pages
...
### <a name="alerts-overview-page"></a>Alerts overview page
...
### <a name="alert-rules-management"></a>Alert rules management
...
## <a name="enhanced-unified-alerts-public-preview"></a>Enhanced unified alerts (public preview)
...
### <a name="enhanced-unified-alerts"></a>Enhanced unified alerts
...
### <a name="enable-enhanced-unified-alerts"></a>Enable enhanced unified alerts
...
### <a name="smart-groups"></a>Smart groups
...
### <a name="alert-states"></a>Alert states
...
#### <a name="change-the-state-of-an-alert-or-smart-group"></a>Change the state of an alert or smart group
...
### <a name="all-alerts-page"></a>All Alerts page 
...
### <a name="alert-detail-page"></a>Alert detail page
...
### <a name="smart-group-detail-page"></a>Smart group detail page
