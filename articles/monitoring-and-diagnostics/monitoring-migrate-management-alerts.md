...
---
# <a name="migrate-azure-alerts-on-management-events-to-activity-log-alerts"></a>Migrate Azure alerts on management events to Activity Log alerts
...
## <a name="how-to-migrate"></a>How to migrate
