...
---
# <a name="get-started-with-auto-scale-by-custom-metric-in-azure"></a>Get started with auto scale by custom metric in Azure
...
- Click on Autoscale setting to view all the resources for which auto scale is applicable, along with its current autoscale status ![Discover auto scale in Azure monitor][4]
