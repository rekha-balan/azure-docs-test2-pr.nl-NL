...
---
# <a name="supported-services-schemas-and-categories-for-azure-diagnostic-logs"></a>Supported services, schemas, and categories for Azure Diagnostic Logs
...
## <a name="top-level-diagnostic-logs-schema"></a>Top-level diagnostic logs schema
...
## <a name="service-specific-schemas-for-resource-diagnostic-logs"></a>Service-specific schemas for resource diagnostic logs
