...
---
# <a name="archive-azure-monitoring-data"></a>Archive Azure monitoring data
...
## <a name="route-subscription-logs-to-the-storage-account"></a>Route subscription logs to the storage account
...
## <a name="route-resource-data-to-the-storage-account"></a>Route resource data to the storage account
...
## <a name="route-virtual-machine-guest-os-data-to-the-storage-account"></a>Route virtual machine (guest OS) data to the storage account
...
## <a name="view-the-monitoring-data-in-the-storage-account"></a>View the monitoring data in the storage account
