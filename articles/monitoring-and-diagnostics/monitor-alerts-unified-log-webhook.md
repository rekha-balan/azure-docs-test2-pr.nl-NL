...
---
# <a name="webhook-actions-for-log-alert-rules"></a>Webhook actions for log alert rules
...
## <a name="sample-payloads"></a>Sample payloads
...
### <a name="standard-webhook-for-log-alerts"></a>Standard Webhook for Log Alerts 
Both of these examples have stated a dummy payload with only two columns and two rows.

#### <a name="log-alert-for-azure-log-analytics"></a>Log Alert for Azure Log-Analytics
...
#### <a name="log-alert-for-azure-application-insights"></a>Log Alert for Azure Application Insights
...
#### <a name="log-alert-with-custom-json-payload"></a>Log Alert with custom JSON Payload
