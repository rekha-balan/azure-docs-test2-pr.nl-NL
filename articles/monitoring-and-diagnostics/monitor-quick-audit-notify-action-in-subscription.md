...
---
# <a name="audit-and-receive-notifications-about-important-actions-in-your-azure-subscription"></a>Audit and receive notifications about important actions in your Azure subscription
...
## <a name="browse-the-activity-log-in-the-portal"></a>Browse the Activity Log in the portal
...
## <a name="browse-an-event-in-the-activity-log"></a>Browse an event in the Activity Log
...
## <a name="create-an-activity-log-alert"></a>Create an Activity Log alert
...
## <a name="test-the-activity-log-alert"></a>Test the Activity Log alert
