...
---
# <a name="stream-azure-monitoring-data-to-an-event-hub-for-consumption-by-an-external-tool"></a>Stream Azure monitoring data to an event hub for consumption by an external tool
...
## <a name="what-data-can-i-send-into-an-event-hub"></a>What data can I send into an event hub? 
...
## <a name="set-up-an-event-hubs-namespace"></a>Set up an Event Hubs namespace
...
## <a name="azure-tenant-monitoring-data"></a>Azure tenant monitoring data
...
## <a name="azure-subscription-monitoring-data"></a>Azure subscription monitoring data
...
### <a name="activity-log-data"></a>Activity log data
...
## <a name="azure-resource-metrics-and-diagnostics-logs"></a>Azure resource metrics and diagnostics logs
...
## <a name="guest-os-data"></a>Guest OS data
...
## <a name="application-monitoring-data"></a>Application monitoring data
...
## <a name="what-can-i-do-with-the-monitoring-data-being-sent-to-my-event-hub"></a>What can I do with the monitoring data being sent to my event hub?
