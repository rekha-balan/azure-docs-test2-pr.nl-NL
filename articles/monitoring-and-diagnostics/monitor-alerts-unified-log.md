...
---
# <a name="log-alerts-in-azure-monitor---alerts"></a>Log alerts in Azure Monitor - Alerts 
...
## <a name="log-search-alert-rule---definition-and-types"></a>Log search alert rule - definition and types
...
## <a name="log-search-alert-rule---creation-and-modification"></a>Log search alert rule - creation and modification
...
Then when [creating a log alert in Alerts ](monitor-alerts-unified-usage.md), you see the saved query listed as signal type **Log (Saved Query)**; as illustrated in below example: ![Saved Query imported to Alerts](./media/monitor-alerts-unified/AlertsPreviewResourceSelectionLog-new.png)
