...
---
# <a name="how-to-trigger-complex-actions-with-azure-monitor-alerts"></a>How to trigger complex actions with Azure Monitor alerts
...
## <a name="create-an-activity-log-alert-administrative"></a>Create an activity log alert: Administrative
...
## <a name="create-a-service-health-alert"></a>Create a service health alert
...
## <a name="create-a-metric-alert"></a>Create a metric alert
...
## <a name="calling-other-applications-besides-microsoft-teams"></a>Calling other applications besides Microsoft Teams
