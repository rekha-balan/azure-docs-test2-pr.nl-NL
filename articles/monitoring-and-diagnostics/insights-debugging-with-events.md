...
---
# <a name="view-events-and-activity-logs"></a>View events and activity logs
...
2. Click on the **Browse** and select **Audit logs**.  
    ![Browse Hub](https://docstestmedia1.blob.core.windows.net/azure-media/articles/monitoring-and-diagnostics/media/insights-debugging-with-events/Insights_Browse.png)
3. This will open up a blade showing all of the events that have impacted any of your subscriptions for the past 7 days. At the top is a chart showing data by level, and below that is the full list of logs: ![All events](https://docstestmedia1.blob.core.windows.net/azure-media/articles/monitoring-and-diagnostics/media/insights-debugging-with-events/Insights_AllEvents.png)
...
2. On the resource's blade, scroll down until you find the **Events** tile.  
    ![Events tile](https://docstestmedia1.blob.core.windows.net/azure-media/articles/monitoring-and-diagnostics/media/insights-debugging-with-events/Insights_EventsTile.png)
