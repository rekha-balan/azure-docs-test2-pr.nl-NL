...
---
# <a name="use-the-azure-portal-to-create-classic-metric-alerts-in-azure-monitor-for-azure-services"></a>Use the Azure portal to create classic metric alerts in Azure Monitor for Azure services 
