...
## <a name="azure-monitor-and-microsofts-other-monitoring-products"></a>Azure Monitor and Microsoft's other monitoring products
...
## <a name="portal-overview-page"></a>Portal overview page
...
## <a name="azure-monitor-sources---compute-subset"></a>Azure Monitor Sources - Compute subset
...
### <a name="host-and-guest-vm-metrics"></a>Host and Guest VM metrics
...
## <a name="azure-monitor-sources---everything-else"></a>Azure Monitor Sources - everything else
...
### <a name="store-and-archive"></a>Store and Archive
...
## <a name="methods-of-accessing-azure-monitor"></a>Methods of accessing Azure Monitor
