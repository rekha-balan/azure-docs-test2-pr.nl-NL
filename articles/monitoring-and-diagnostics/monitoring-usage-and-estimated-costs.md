...
---
# <a name="monitoring-usage-and-estimated-costs"></a>Monitoring usage and estimated costs
...
## <a name="new-pricing-model"></a>New pricing model
...
## <a name="assessing-the-impact-of-the-new-pricing-model"></a>Assessing the impact of the new pricing model
...
## <a name="new-pricing-model-and-operations-management-suite-subscription-entitlements"></a>New pricing model and Operations Management Suite subscription entitlements
...
## <a name="changes-when-youre-moving-to-the-new-pricing-model"></a>Changes when you're moving to the new pricing model
...
## <a name="moving-to-the-new-pricing-model"></a>Moving to the new pricing model
...
## <a name="automate-moving-to-the-new-pricing-model"></a>Automate moving to the new pricing model
