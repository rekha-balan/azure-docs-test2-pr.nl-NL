...
---
# <a name="stream-azure-diagnostic-logs-to-log-analytics"></a>Stream Azure Diagnostic Logs to Log Analytics
...
## <a name="what-you-can-do-with-diagnostics-logs-in-log-analytics"></a>What you can do with diagnostics logs in Log Analytics
...
## <a name="enable-streaming-of-diagnostic-logs-to-log-analytics"></a>Enable streaming of diagnostic logs to Log Analytics
...
## <a name="how-do-i-query-the-data-in-log-analytics"></a>How do I query the data in Log Analytics?
