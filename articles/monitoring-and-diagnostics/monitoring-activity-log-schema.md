...
---
# <a name="azure-activity-log-event-schema"></a>Azure Activity Log event schema
...
### <a name="sample-event"></a>Sample event
```json
{
    "authorization": {
...
### <a name="property-descriptions"></a>Property descriptions
...
### <a name="properties-field-per-alert-type"></a>Properties field per alert type
...
#### <a name="properties-for-activity-log-alerts"></a>Properties for Activity Log alerts
| Element Name | Description |
| --- | --- |
...
#### <a name="properties-for-metric-alerts"></a>Properties for metric alerts
| Element Name | Description |
| --- | --- |
...
## <a name="mapping-to-diagnostic-logs-schema"></a>Mapping to diagnostic logs schema
