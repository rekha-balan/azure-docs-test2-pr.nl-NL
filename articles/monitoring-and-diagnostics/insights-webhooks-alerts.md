...
---
# <a name="have-a-classic-metric-alert-notify-a-non-azure-system-using-a-webhook"></a>Have a classic metric alert notify a non-Azure system using a webhook
...
## <a name="configure-webhooks-via-the-azure-portal"></a>Configure webhooks via the Azure portal
...
## <a name="authenticate-the-webhook"></a>Authenticate the webhook
