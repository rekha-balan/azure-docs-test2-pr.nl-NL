...
---
# <a name="prepare-for-format-change-to-azure-monitor-diagnostic-logs-archived-to-a-storage-account"></a>Prepare for format change to Azure Monitor diagnostic logs archived to a storage account
...
### <a name="how-to-see-if-you-are-impacted"></a>How to see if you are impacted
...
### <a name="details-of-the-format-change"></a>Details of the format change
...
## <a name="how-to-update"></a>How to update
