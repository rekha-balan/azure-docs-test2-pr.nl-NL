...
## <a name="what-is-azure-monitor-metrics-explorer"></a>What is Azure Monitor Metrics Explorer?
...
## <a name="what-are-metrics-in-azure"></a>What are metrics in Azure?
...
## <a name="what-are-multi-dimensional-metrics"></a>What are multi-dimensional metrics?
...
### <a name="network-throughput--two-dimensions-ip-and-direction"></a>Network Throughput + two dimensions ("IP" and "Direction")
...
## <a name="how-do-i-create-a-new-chart"></a>How do I create a new chart?
...
## <a name="how-do-i-apply-filters-to-the-charts"></a>How do I apply filters to the charts?
...
### <a name="to-add-a-filter"></a>To add a filter:
...
## <a name="how-do-i-segment-a-chart"></a>How do I segment a chart?
...
### <a name="to-segment-a-chart"></a>To segment a chart:
...
## <a name="how-do-i-pin-charts-to-dashboards"></a>How do I pin charts to dashboards?
