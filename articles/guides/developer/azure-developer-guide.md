...
---
# <a name="get-started-guide-for-azure-developers"></a>Get started guide for Azure developers

## <a name="what-is-azure"></a>What is Azure?
...
## <a name="azure-regions"></a>Azure regions
...
### <a name="manage-your-subscriptions"></a>Manage your subscriptions
...
When you allow access to Azure resources, it’s always a best practice to provide users with the least privilege that’s required to perform a given task.
