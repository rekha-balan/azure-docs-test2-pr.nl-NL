...
---
# <a name="get-started-for-azure-it-operators"></a>Get started for Azure IT operators
...
## <a name="cloud-computing-overview"></a>Cloud computing overview
...
## <a name="azure-key-concepts"></a>Azure key concepts

### <a name="datacenters-and-regions"></a>Datacenters and regions
...
### <a name="select-and-enable-an-azure-subscription"></a>Select and enable an Azure subscription
...
### <a name="grant-administrative-access-to-an-azure-subscription"></a>Grant administrative access to an Azure subscription
...
### <a name="view-billing-information-in-the-azure-portal"></a>View billing information in the Azure portal
...
### <a name="get-billing-information-from-billing-apis"></a>Get billing information from billing APIs
...
### <a name="forecast-cost-with-the-pricing-calculator"></a>Forecast cost with the pricing calculator
...
### <a name="set-up-billing-alerts"></a>Set up billing alerts
...
### <a name="tips-for-creating-resource-groups"></a>Tips for creating resource groups
...
### <a name="building-resource-manager-templates"></a>Building Resource Manager templates
...
## <a name="security-of-azure-resources-rbac"></a>Security of Azure resources (RBAC)
...
### <a name="deployment-of-virtual-machines"></a>Deployment of virtual machines
...
#### <a name="command-line-interface-cli"></a>Command-line interface (CLI)
...
### <a name="access-and-security-for-virtual-machines"></a>Access and security for virtual machines
...
### <a name="deploying-a-storage-account"></a>Deploying a storage account
...
### <a name="access-and-security-for-azure-storage"></a>Access and security for Azure Storage
...
#### <a name="storage-tools"></a>Storage tools
...
#### <a name="storage-access-keys"></a>Storage access keys
...
### <a name="hybrid-virtual-networks"></a>Hybrid virtual networks
...
### <a name="access-and-security-for-virtual-networks"></a>Access and security for virtual networks
