...
---
# <a name="how-to-use-the-azure-mobile-apps-sdk-for-android"></a>How to use the Azure Mobile Apps SDK for Android
...
## <a name="create-a-client-connection"></a>Create a Client Connection
...
## <a name="data-operations"></a>Data Operations
...
### <a name="define-client-data-classes"></a>Define client data classes
...
### <a name="create-a-table-reference"></a>Create a Table Reference
...
### <a name="initialize-offline-sync"></a>Initialize Offline Sync
...
### <a name="obtain-a-reference-to-the-offline-cache-table"></a>Obtain a reference to the Offline Cache Table
...
### <a name="synchronize-the-local-offline-cache"></a>Synchronize the Local Offline Cache
...
### <a name="handle-conflicts-during-offline-synchronization"></a>Handle Conflicts during Offline Synchronization
...
## <a name="log-in-with-client-flow-authentication"></a>Log in with Client-flow Authentication
...
### <a name="using-an-alternate-http-library"></a>Using an alternate HTTP Library
...
### <a name="implement-a-progress-filter"></a>Implement a Progress Filter
...
### <a name="customize-request-headers"></a>Customize Request Headers
