...
## <a name="configure-and-run-the-android-project-optional"></a>Configure and run the Android project (optional)
...
### <a name="configure-the-mobile-apps-back-end-to-send-push-requests-by-using-fcm"></a>Configure the Mobile Apps back end to send push requests by using FCM
...
## <a name="configure-and-run-the-ios-project-optional"></a>Configure and run the iOS project (optional)
...
## <a name="configure-and-run-windows-projects-optional"></a>Configure and run Windows projects (optional)
...
#### <a name="register-your-windows-app-for-push-notifications-with-windows-notification-service-wns"></a>Register your Windows app for push notifications with Windows Notification Service (WNS)
