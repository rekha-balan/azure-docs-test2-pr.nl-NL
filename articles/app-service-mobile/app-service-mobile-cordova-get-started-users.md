...
2. Locate the `Content-Security-Policy` meta tag in the head section.  Add the OAuth host to the list of allowed sources.
   ...
   | Twitter | twitter | https://api.twitter.com |
    ...
    Replace `https://login.windows.net` with the OAuth host from the preceding table.  For more information about the content-security-policy meta tag, see the [Content-Security-Policy documentation].
