...
---
# <a name="scale-your-jenkins-deployments-to-meet-demand-with-azure-vm-agents"></a>Scale your Jenkins deployments to meet demand with Azure VM agents
...
## <a name="install-azure-vm-agents-plugin"></a>Install Azure VM Agents plugin
...
## <a name="configure-the-azure-vm-agents-plugin"></a>Configure the Azure VM Agents plugin
...
## <a name="configure-agent-resources"></a>Configure agent resources
...
## <a name="configure-agent-operating-system-and-tools"></a>Configure agent operating system and tools
...
## <a name="create-a-job-in-jenkins"></a>Create a job in Jenkins
...
## <a name="build-the-new-job-on-an-azure-vm-agent"></a>Build the new job on an Azure VM agent
