...
---
# <a name="deploy-to-azure-app-service-with-jenkins-and-the-azure-cli"></a>Deploy to Azure App Service with Jenkins and the Azure CLI
...
## <a name="create-and-configure-jenkins-instance"></a>Create and Configure Jenkins instance
...
## <a name="add-azure-service-principal-to-jenkins-credential"></a>Add Azure service principal to Jenkins credential
...
## <a name="create-an-azure-app-service-for-deploying-the-java-web-app"></a>Create an Azure App Service for deploying the Java web app
...
## <a name="prepare-a-github-repository"></a>Prepare a GitHub Repository
...
## <a name="create-jenkins-pipeline"></a>Create Jenkins pipeline
...
## <a name="test-your-pipeline"></a>Test your pipeline
...
## <a name="deploy-to-azure-web-app-on-linux"></a>Deploy to Azure Web App on Linux
