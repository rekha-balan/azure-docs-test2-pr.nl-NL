...
---
# <a name="deploy-to-azure-kubernetes-service-aks-by-using-jenkins-and-the-bluegreen-deployment-pattern"></a>Deploy to Azure Kubernetes Service (AKS) by using Jenkins and the blue/green deployment pattern
...
## <a name="clone-the-sample-app-from-github"></a>Clone the sample app from GitHub
...
## <a name="create-and-configure-a-managed-kubernetes-cluster"></a>Create and configure a managed Kubernetes cluster
...
### <a name="use-the-azure-cli-20-to-create-a-managed-kubernetes-cluster"></a>Use the Azure CLI 2.0 to create a managed Kubernetes cluster
...
### <a name="set-up-the-kubernetes-cluster"></a>Set up the Kubernetes cluster
...
#### <a name="set-up-the-kubernetes-cluster-via-the-sample-setup-script"></a>Set up the Kubernetes cluster via the sample setup script
...
#### <a name="set-up-a-kubernetes-cluster-manually"></a>Set up a Kubernetes cluster manually 
...
### <a name="create-an-instance-of-container-registry"></a>Create an instance of Container Registry
...
## <a name="prepare-the-jenkins-server"></a>Prepare the Jenkins server
...
## <a name="edit-the-jenkinsfile"></a>Edit the Jenkinsfile
...
## <a name="create-the-job"></a>Create the job
