...
---
# <a name="set-up-continuous-integration-and-deployment-to-azure-app-service-with-jenkins"></a>Set up continuous integration and deployment to Azure App Service with Jenkins
...
## <a name="install-jenkins-plug-ins"></a>Install Jenkins plug-ins
...
## <a name="configure-github-and-jenkins"></a>Configure GitHub and Jenkins
...
## <a name="fork-the-sample-repo-and-create-a-jenkins-job"></a>Fork the sample repo and create a Jenkins job 
...
## <a name="configure-azure-app-service"></a>Configure Azure App Service 
...
## <a name="configure-the-azure-app-service-jenkins-plug-in"></a>Configure the Azure App Service Jenkins plug-in
...
## <a name="deploy-the-app-from-github"></a>Deploy the app from GitHub
...
## <a name="push-changes-and-redeploy"></a>Push changes and redeploy
