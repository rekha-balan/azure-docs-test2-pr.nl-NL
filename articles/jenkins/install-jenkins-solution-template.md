...
---
# <a name="create-a-jenkins-server-on-an-azure-linux-vm-from-the-azure-portal"></a>Create a Jenkins server on an Azure Linux VM from the Azure portal
...
## <a name="create-the-jenkins-vm-from-the-solution-template"></a>Create the Jenkins VM from the solution template
...
## <a name="connect-to-jenkins"></a>Connect to Jenkins
...
## <a name="create-your-first-job"></a>Create your first job
...
## <a name="build-the-code"></a>Build the code
...
## <a name="troubleshooting-the-jenkins-solution-template"></a>Troubleshooting the Jenkins solution template
