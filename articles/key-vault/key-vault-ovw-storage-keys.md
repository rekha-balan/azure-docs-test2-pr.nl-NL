...
---
# <a name="azure-key-vault-storage-account-keys"></a>Azure Key Vault Storage Account Keys
...
## <a name="supporting-interfaces"></a>Supporting interfaces
...
## <a name="what-key-vault-manages"></a>What Key Vault manages
...
## <a name="naming-guidance"></a>Naming guidance
...
### <a name="before-azure-key-vault-storage-keys"></a>Before Azure Key Vault Storage Keys
...
### <a name="after-azure-key-vault-storage-keys"></a>After Azure Key Vault Storage Keys

Developers create a [KeyVaultClient](https://docs.microsoft.com/dotnet/api/microsoft.azure.keyvault.keyvaultclient) and leverage that to get the SAS token for their storage. Afterwards, they create [CloudStorageAccount](https://docs.microsoft.com/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount) with that token.
...
### <a name="give-key-vault-access-to-your-storage-account"></a>Give Key Vault access to your Storage Account 
...
## <a name="working-example"></a>Working example
...
Now, create a Managed Storage Account in Azure Key Vault and use an access key from your storage account to create the SAS tokens.
...
### <a name="key-regeneration"></a>Key regeneration
...
### <a name="set-sas-definitions"></a>Set SAS definitions
...
### <a name="get-sas-tokens"></a>Get SAS tokens

Get the corresponding SAS tokens and make calls to storage. `-SecretName` is constructed using the input from the `AccountName` and `Name` parameters when you executed [Set-AzureKeyVaultManagedStorageSasDefinition](https://docs.microsoft.com/powershell/module/AzureRM.KeyVault/Set-AzureKeyVaultManagedStorageSasDefinition).
...
Notice that trying to access with *$readSasToken* fails, but that we are able to access with *$writeSasToken*.
...
### <a name="relevant-powershell-cmdlets"></a>Relevant Powershell cmdlets
...
## <a name="storage-account-onboarding"></a>Storage account onboarding
...
## <a name="other-applications"></a>Other applications
