...
---
# <a name="tutorial-configure-an-azure-web-application-to-read-a-secret-from-key-vault"></a>Tutorial: Configure an Azure web application to read a secret from Key Vault
...
## <a name="modify-the-web-app"></a>Modify the web app
...
## <a name="grant-rights-to-the-application-identity"></a>Grant rights to the application identity
