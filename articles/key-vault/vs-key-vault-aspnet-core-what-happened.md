...
---
# <a name="what-happened-to-my-aspnet-core-project-visual-studio-key-vault-connected-service"></a>What happened to my ASP.NET Core project (Visual Studio Key Vault connected service)?
...
## <a name="added-references"></a>Added references
...
## <a name="added-files"></a>Added files
...
## <a name="project-file-changes"></a>Project file changes
...
## <a name="changes-on-azure"></a>Changes on Azure
