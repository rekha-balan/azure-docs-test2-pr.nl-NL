...
---
# <a name="service-to-service-authentication-to-azure-key-vault-using-net"></a>Service-to-service authentication to Azure Key Vault using .NET
...
<a name="asal"></a>
## <a name="using-the-library"></a>Using the library
...
<a name="local"></a>
## <a name="local-development-authentication"></a>Local development authentication
...
### <a name="authenticating-to-azure-services"></a>Authenticating to Azure Services
...
### <a name="authenticating-with-visual-studio"></a>Authenticating with Visual Studio
...
### <a name="authenticating-with-azure-cli"></a>Authenticating with Azure CLI
...
### <a name="authenticating-with-azure-ad-integrate-authentication"></a>Authenticating with Azure AD Integrate authentication
...
### <a name="authenticating-to-custom-services"></a>Authenticating to custom services
...
<a name="msi"></a>
## <a name="running-the-application-using-managed-identity"></a>Running the application using managed identity 
...
<a name="sp"></a>
## <a name="running-the-application-using-a-service-principal"></a>Running the application using a Service Principal 
...
## <a name="connection-string-support"></a>Connection String Support
