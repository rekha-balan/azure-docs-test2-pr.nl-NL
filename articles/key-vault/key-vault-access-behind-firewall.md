...
---
# <a name="access-azure-key-vault-behind-a-firewall"></a>Access Azure Key Vault behind a firewall
### <a name="q-my-key-vault-client-application-needs-to-be-behind-a-firewall-what-ports-hosts-or-ip-addresses-should-i-open-to-enable-access-to-a-key-vault"></a>Q: My key vault client application needs to be behind a firewall. What ports, hosts, or IP addresses should I open to enable access to a key vault?
