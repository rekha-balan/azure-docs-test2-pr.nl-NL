...
## <a name="why-use-azure-key-vault"></a>Why use Azure Key Vault?

### <a name="centralize-application-secrets"></a>Centralize application secrets
...
### <a name="securely-store-secrets-and-keys"></a>Securely store secrets and keys
...
### <a name="monitor-access-and-use"></a>Monitor access and use
...
### <a name="simplified-administration-of-application-secrets"></a>Simplified administration of application secrets
...
### <a name="integrate-with-other-azure-services"></a>Integrate with other Azure services
