...
---
# <a name="virtual-network-service-endpoints-for-azure-key-vault"></a>Virtual Network Service Endpoints for Azure Key Vault
...
## <a name="configure-key-vault-firewalls-and-virtual-networks"></a>Configure Key Vault firewalls and virtual networks
...
## <a name="trusted-services"></a>Trusted services
