...
---
# <a name="get-started-with-key-vault-connected-service-in-visual-studio-aspnet-core-projects"></a>Get started with Key Vault Connected Service in Visual Studio (ASP.NET Core Projects)
...
## <a name="after-you-connect"></a>After you connect
