...
---
# <a name="get-started-with-key-vault-certificates"></a>Get started with Key Vault certificates
...
## <a name="certificates-are-complex-objects"></a>Certificates are complex objects
...
## <a name="creating-your-first-key-vault-certificate"></a>Creating your first Key Vault certificate  
...
## <a name="creating-a-certificate-with-a-ca-partnered-with-key-vault"></a>Creating a certificate with a CA partnered with Key Vault
...
## <a name="import-a-certificate"></a>Import a certificate  
...
## <a name="creating-a-certificate-with-a-ca-not-partnered-with-key-vault"></a>Creating a certificate with a CA not partnered with Key Vault  
