...
---
# <a name="azure-key-vault-throttling-guidance"></a>Azure Key Vault throttling guidance
...
## <a name="how-does-key-vault-handle-its-limits"></a>How does Key Vault handle its limits?
...
## <a name="how-to-throttle-your-app-in-response-to-service-limits"></a>How to throttle your app in response to service limits
...
### <a name="recommended-client-side-throttling-method"></a>Recommended client-side throttling method
