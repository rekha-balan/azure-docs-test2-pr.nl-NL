...
---
# <a name="get-started-with-key-vault-connected-service-in-visual-studio-aspnet-projects"></a>Get started with Key Vault Connected Service in Visual Studio (ASP.NET Projects)
