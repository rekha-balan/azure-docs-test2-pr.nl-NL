...
---
# <a name="quickstart-set-and-retrieve-a-secret-from-azure-key-vault-using-a-node-web-app"></a>Quickstart: Set and retrieve a secret from Azure Key Vault using a Node Web App 
...
## <a name="login-to-azure"></a>Login to Azure
...
## <a name="create-an-azure-key-vault"></a>Create an Azure Key Vault
...
## <a name="clone-the-repo"></a>Clone the Repo
...
## <a name="publish-the-web-application-to-azure"></a>Publish the web application to Azure
...
- Create a deployment user After the previous command is completed you can add add an Azure remote to your local Git repository. Replace <url> with the URL of the Git remote that you got from Enable Git for your app.

    ```
    git remote add azure <url>
    ```

## <a name="enable-a-managed-identity-for-the-web-app"></a>Enable a managed identity for the web app
...
### <a name="assign-permissions-to-your-application-to-read-secrets-from-key-vault"></a>Assign permissions to your application to read secrets from Key Vault
...
## <a name="deploy-the-node-app-to-azure-and-retrieve-the-secret-value"></a>Deploy the Node App to Azure and retrieve the secret value
