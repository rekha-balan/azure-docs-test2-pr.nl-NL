...
---
# <a name="how-to-use-key-vault-soft-delete-with-powershell"></a>How to use Key Vault soft-delete with PowerShell
...
## <a name="enabling-soft-delete"></a>Enabling soft-delete
...
### <a name="existing-key-vault"></a>Existing key vault
...
### <a name="new-key-vault"></a>New key vault
...
### <a name="verify-soft-delete-enablement"></a>Verify soft-delete enablement
...
## <a name="deleting-a-key-vault-protected-by-soft-delete"></a>Deleting a key vault protected by soft-delete
...
### <a name="how-soft-delete-protects-your-key-vaults"></a>How soft-delete protects your key vaults
...
## <a name="recovering-a-key-vault"></a>Recovering a key vault
...
## <a name="key-vault-objects-and-soft-delete"></a>Key Vault objects and soft-delete
...
### <a name="transition-state"></a>Transition state 
...
### <a name="using-soft-delete-with-key-vault-objects"></a>Using soft-delete with key vault objects
...
#### <a name="set-a-key-vault-access-policy"></a>Set a key vault access policy
...
## <a name="purging-and-key-vaults"></a>Purging and key vaults

### <a name="key-vault-objects"></a>Key vault objects
...
### <a name="key-vaults-as-containers"></a>Key vaults as containers
...
### <a name="purge-permissions-required"></a>Purge permissions required
...
### <a name="scheduled-purge"></a>Scheduled purge
