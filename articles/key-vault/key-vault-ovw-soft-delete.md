...
---
# <a name="azure-key-vault-soft-delete-overview"></a>Azure Key Vault soft-delete overview
...
### <a name="key-vault-recovery"></a>Key vault recovery
...
### <a name="key-vault-object-recovery"></a>Key vault object recovery
...
### <a name="soft-delete-retention-period"></a>Soft-delete retention period
...
### <a name="permitted-purge"></a>Permitted purge
