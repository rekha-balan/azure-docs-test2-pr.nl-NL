...
---
# <a name="quickstart-set-and-retrieve-a-secret-from-azure-key-vault-by-using-a-net-web-app"></a>Quickstart: Set and retrieve a secret from Azure Key Vault by using a .NET web app
...
## <a name="add-a-secret-to-the-key-vault"></a>Add a secret to the key vault
...
## <a name="open-and-edit-the-solution"></a>Open and edit the solution
