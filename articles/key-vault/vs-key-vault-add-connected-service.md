...
## <a name="access-your-secrets-in-code-aspnet-core-projects"></a>Access your secrets in code (ASP.NET Core projects)
...
## <a name="access-your-secrets-in-code-aspnet-471-projects"></a>Access your secrets in code (ASP.NET 4.7.1 projects)
