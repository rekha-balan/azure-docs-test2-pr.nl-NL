...
### <a name="azure-key-vault-generates-a-software-protected-key"></a>Azure Key Vault generates a software protected key
...
### <a name="importing-an-existing-pfx-file-into-azure-key-vault"></a>Importing an existing PFX file into Azure Key Vault
...
### <a name="to-add-a-secret-to-azure-key-vault"></a>To add a secret to Azure Key Vault
...
$secret.Id
```
To view your secret, type: `Get-AzureKeyVaultSecret –VaultName 'ContosoKeyVault'` Or alternatively you may view the secret on the portal.
