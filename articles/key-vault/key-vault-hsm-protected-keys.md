...
### <a name="step-31-change-the-hsm-mode-to-i"></a>Step 3.1: Change the HSM mode to 'I'
...
### <a name="step-32-create-a-security-world"></a>Step 3.2: Create a security world
...
### <a name="step-33-change-the-hsm-mode-to-o"></a>Step 3.3: Change the HSM mode to 'O'

If you are using Thales nShield Edge, to change the mode: 1. Use the Mode button to highlight the required mode. 2. Within a few seconds, press and hold the Clear button for a couple of seconds. If the mode changes, the new mode’s LED stops flashing and remains lit. The Status LED might flash irregularly for a few seconds and then flashes regularly when the device is ready. Otherwise, the device remains in the current mode, with the appropriate mode LED lit.

### <a name="step-34-validate-the-downloaded-package"></a>Step 3.4: Validate the downloaded package
...
### <a name="step-35-create-a-new-key"></a>Step 3.5: Create a new key
...
### <a name="step-42-encrypt-your-key-by-using-microsofts-key-exchange-key"></a>Step 4.2: Encrypt your key by using Microsoft’s Key Exchange Key
...
### <a name="step-43-copy-your-key-transfer-package-to-the-internet-connected-workstation"></a>Step 4.3: Copy your key transfer package to the Internet-connected workstation
