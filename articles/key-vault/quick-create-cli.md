...
---
# <a name="quickstart-set-and-retrieve-a-secret-from-azure-key-vault-using-azure-cli"></a>Quickstart: Set and retrieve a secret from Azure Key Vault using Azure CLI
