...
---
# <a name="browse-and-manage-storage-resources-by-using-server-explorer"></a>Browse and manage storage resources by using Server Explorer
...
### <a name="to-display-a-list-of-the-items-in-a-blob-container"></a>To display a list of the items in a blob container
...
### <a name="to-create-a-storage-account-by-using-server-explorer"></a>To create a storage account by using Server Explorer
