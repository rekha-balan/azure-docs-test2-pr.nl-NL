...
---
# <a name="azure-policy-definition-structure"></a>Azure Policy definition structure
...
## <a name="definition-location"></a>Definition location
...
## <a name="display-name-and-description"></a>Display name and description
...
### <a name="policy-functions"></a>Policy functions
...
Additionally, the `field` function is available to policy rules. This function is primarily for use with **AuditIfNotExists** and **DeployIfNotExists** to reference fields on the resource that is being evaluated. An example of this can be seen on the [DeployIfNotExists example](policy-effects.md#deployifnotexists-example).

#### <a name="policy-function-examples"></a>Policy function examples
