...
---
# <a name="create-and-manage-policies-to-enforce-compliance"></a>Create and manage policies to enforce compliance
...
## <a name="implement-a-new-custom-policy"></a>Implement a new custom policy
...
## <a name="create-a-policy-definition-with-rest-api"></a>Create a policy definition with REST API
...
## <a name="create-a-policy-definition-with-powershell"></a>Create a policy definition with PowerShell
...
### <a name="view-policy-definitions-with-powershell"></a>View policy definitions with PowerShell
...
## <a name="create-a-policy-definition-with-azure-cli"></a>Create a policy definition with Azure CLI
...
### <a name="view-policy-definitions-with-azure-cli"></a>View policy definitions with Azure CLI
...
## <a name="create-and-assign-an-initiative-definition"></a>Create and assign an initiative definition
...
### <a name="create-an-initiative-definition"></a>Create an initiative definition
...
## <a name="exempt-a-non-compliant-or-denied-resource-using-exclusion"></a>Exempt a non-compliant or denied resource using Exclusion
...
### <a name="update-assignment-with-exclusion"></a>Update assignment with exclusion
