...
---
# <a name="create-a-policy-assignment-to-identify-non-compliant-resources-in-your-azure-environment"></a>Create a policy assignment to identify non-compliant resources in your Azure environment
