...
---
# <a name="manage-excel-online-data-with-azure-logic-apps"></a>Manage Excel Online data with Azure Logic Apps

With Azure Logic Apps and the Excel Online connector, you can create automated tasks and workflows based on your data in Excel Online for Business or OneDrive. This connector provides actions that help you work with your data and manage spreadsheets, for example: 
...
> [!NOTE]
> The [Excel Online for Business](/connectors/excelonlinebusiness/) and [Excel Online for OneDrive](/connectors/excelonline/) connectors work with Azure Logic Apps and differ from the [Excel connector for PowerApps](/connectors/excel/).
...
* An [Office 365 account](https://www.office.com/) for your work account or personal Microsoft account 

  Your Excel data can exist as a comma-separated value (CSV) file in a storage folder, for example, in OneDrive. 
  You can also use the same CSV file with the [flat-file connector](../logic-apps/logic-apps-enterprise-integration-flatfile.md).
...
## <a name="add-excel-action"></a>Add Excel action
...
1. In the search box, enter "excel" as your filter. Under the actions list, select the action you want.
...
1. Continue providing the necessary details for the selected action and building your logic app's workflow.

## <a name="connector-reference"></a>Connector reference

For technical details, such as actions and limits, described by the connectors' Swagger files, see these connector reference pages:
