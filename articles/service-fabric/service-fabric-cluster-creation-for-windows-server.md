...
---
# <a name="create-a-standalone-cluster-running-on-windows-server"></a>Create a standalone cluster running on Windows Server
...
## <a name="get-support-for-the-service-fabric-for-windows-server-package"></a>Get support for the Service Fabric for Windows Server package
...
## <a name="download-the-service-fabric-for-windows-server-package"></a>Download the Service Fabric for Windows Server package
...
### <a name="step-1a-create-an-unsecured-local-development-cluster"></a>Step 1A: Create an unsecured local development cluster
...
### <a name="step-1b-create-a-multi-machine-cluster"></a>Step 1B: Create a multi-machine cluster
...
### <a name="step-1c-create-an-offline-internet-disconnected-cluster"></a>Step 1C: Create an offline (internet-disconnected) cluster
...
### <a name="step-2-connect-to-the-cluster"></a>Step 2: Connect to the cluster
...
### <a name="step-3-visualize-the-cluster-using-service-fabric-explorer"></a>Step 3: Visualize the cluster using Service Fabric explorer
...
## <a name="add-and-remove-nodes"></a>Add and remove nodes
...
## <a name="remove-a-cluster"></a>Remove a cluster
...
## <a name="telemetry-data-collected-and-how-to-opt-out-of-it"></a>Telemetry data collected and how to opt out of it
...
## <a name="preview-features-included-in-this-package"></a>Preview features included in this package
None.
