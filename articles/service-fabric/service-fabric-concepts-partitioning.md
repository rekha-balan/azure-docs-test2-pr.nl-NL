...
11. In the **Create a Service** dialog box, choose **Stateless** service and call it "Alphabet.Web" as shown below.
    ...
    ![Stateless service screenshot](https://docstestmedia1.blob.core.windows.net/azure-media/articles/service-fabric/media/service-fabric-concepts-partitioning/createnewstateless.png).
