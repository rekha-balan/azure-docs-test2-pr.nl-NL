...
---
# <a name="service-movement-cost"></a>Service movement cost
...
## <a name="setting-move-costs"></a>Setting Move Costs 
...
## <a name="dynamically-specifying-move-cost-on-a-per-replica-basis"></a>Dynamically specifying move cost on a per-replica basis
...
## <a name="impact-of-move-cost"></a>Impact of move cost
...
## <a name="enabling-move-cost-in-your-cluster"></a>Enabling move cost in your cluster
