...
---
# <a name="read-before-you-scale"></a>Read before you scale
...
# <a name="scale-a-service-fabric-cluster-in-or-out-using-auto-scale-rules-or-manually"></a>Scale a Service Fabric cluster in or out using auto-scale rules or manually
...
## <a name="choose-the-node-typevirtual-machine-scale-set-to-scale"></a>Choose the node type/Virtual Machine scale set to scale
...
## <a name="set-auto-scale-rules-for-the-node-typevirtual-machine-scale-set"></a>Set auto-scale rules for the node type/Virtual Machine scale set
...
## <a name="manually-add-vms-to-a-node-typevirtual-machine-scale-set"></a>Manually add VMs to a node type/Virtual Machine scale set
...
## <a name="manually-remove-vms-from-the-primary-node-typevirtual-machine-scale-set"></a>Manually remove VMs from the primary node type/Virtual Machine scale set
> [!NOTE]
...
## <a name="manually-remove-vms-from-the-non-primary-node-typevirtual-machine-scale-set"></a>Manually remove VMs from the non-primary node type/Virtual Machine scale set
> [!NOTE]
