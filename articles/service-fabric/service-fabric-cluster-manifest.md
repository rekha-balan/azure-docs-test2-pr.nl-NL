...
---
# <a name="configuration-settings-for-a-standalone-windows-cluster"></a>Configuration settings for a standalone Windows cluster
...
### <a name="log-settings"></a>Log settings
...
### <a name="stateful-reliable-services-settings"></a>Stateful Reliable Services settings
...
### <a name="add-on-features"></a>Add-on features
...
### <a name="container-support"></a>Container support
