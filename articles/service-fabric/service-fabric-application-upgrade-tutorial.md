...
---
# <a name="service-fabric-application-upgrade-tutorial-using-visual-studio"></a>Service Fabric application upgrade tutorial using Visual Studio
...
## <a name="step-1-build-and-publish-the-visual-objects-sample"></a>Step 1: Build and publish the Visual Objects sample
...
## <a name="step-3--upgrade-your-application"></a>Step 3:  Upgrade your application
