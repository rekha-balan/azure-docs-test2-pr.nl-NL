...
## <a name="add-a-secondary-cluster-certificate-using-the-portal"></a>Add a secondary cluster certificate using the portal
...
## <a name="swap-the-cluster-certificates-using-the-portal"></a>Swap the cluster certificates using the portal
...
## <a name="remove-a-cluster-certificate-using-the-portal"></a>Remove a cluster certificate using the portal
...
## <a name="add-a-secondary-certificate-using-resource-manager-powershell"></a>Add a secondary certificate using Resource Manager Powershell
...
## <a name="deploying-application-certificates-to-the-cluster"></a>Deploying Application certificates to the cluster.
...
## <a name="adding-or-removing-client-certificates"></a>Adding or removing Client certificates
...
### <a name="adding-client-certificates---admin-or-read-only-via-portal"></a>Adding client certificates - Admin or Read-Only via portal
...
### <a name="deletion-of-client-certificates---admin-or-read-only-using-the-portal"></a>Deletion of Client Certificates - Admin or Read-Only using the portal
