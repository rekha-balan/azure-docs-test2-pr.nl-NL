...
### <a name="client-to-node-azure-active-directory-security-on-azure"></a>Client-to-node Azure Active Directory security on Azure
...
### <a name="client-authentication-certificates-optional"></a>Client authentication certificates (optional)
