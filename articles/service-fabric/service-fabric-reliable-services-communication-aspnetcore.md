...
### <a name="weblistener-in-a-stateless-service"></a>WebListener in a stateless service
...
### <a name="weblistener-in-a-stateful-service"></a>WebListener in a stateful service
...
#### <a name="use-weblistener-with-a-static-port"></a>Use WebListener with a static port
...
#### <a name="use-weblistener-with-a-dynamic-port"></a>Use WebListener with a dynamic port
