...
## <a name="aspnet-core-in-the-service-fabric-environment"></a>ASP.NET Core in the Service Fabric environment
...
## <a name="service-fabric-service-hosting"></a>Service Fabric service hosting
...
## <a name="hosting-aspnet-core-in-a-reliable-service"></a>Hosting ASP.NET Core in a Reliable Service
...
### <a name="a-case-of-mistaken-identity"></a>A case of mistaken identity
...
### <a name="using-unique-service-urls"></a>Using unique service URLs
...
### <a name="httpsys-in-a-stateless-service"></a>HttpSys in a stateless service
...
### <a name="httpsys-in-a-stateful-service"></a>HttpSys in a stateful service
...
### <a name="endpoint-configuration"></a>Endpoint configuration
...
#### <a name="use-httpsys-with-a-static-port"></a>Use HttpSys with a static port
...
#### <a name="use-httpsys-with-a-dynamic-port"></a>Use HttpSys with a dynamic port
...
### <a name="kestrel-in-a-stateless-service"></a>Kestrel in a stateless service
...
### <a name="kestrel-in-a-stateful-service"></a>Kestrel in a stateful service
...
#### <a name="use-kestrel-with-a-static-port"></a>Use Kestrel with a static port
...
#### <a name="use-kestrel-with-a-dynamic-port"></a>Use Kestrel with a dynamic port
...
## <a name="scenarios-and-configurations"></a>Scenarios and configurations
...
### <a name="externally-exposed-aspnet-core-stateless-services"></a>Externally exposed ASP.NET Core stateless services
...
### <a name="internal-only-stateless-aspnet-core-service"></a>Internal-only stateless ASP.NET Core service
...
### <a name="internal-only-stateful-aspnet-core-service"></a>Internal-only stateful ASP.NET Core service
