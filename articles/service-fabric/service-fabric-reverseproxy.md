...
### <a name="communicating-by-using-the-reverse-proxy"></a>Communicating by using the reverse proxy
...
### <a name="reaching-microservices-via-the-reverse-proxy-from-outside-the-cluster"></a>Reaching microservices via the reverse proxy from outside the cluster
...
## <a name="uri-format-for-addressing-services-by-using-the-reverse-proxy"></a>URI format for addressing services by using the reverse proxy
...
## <a name="special-handling-for-services-running-in-containers"></a>Special handling for services running in containers
