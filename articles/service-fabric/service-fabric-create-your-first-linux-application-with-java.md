...
---
# <a name="create-your-first-java-service-fabric-reliable-actors-application-on-linux"></a>Create your first Java Service Fabric Reliable Actors application on Linux
...
### <a name="install-and-set-up-the-generators-for-java"></a>Install and set up the generators for Java
...
Deploying the built application is the same as any other Service Fabric application. See the documentation on [managing a Service Fabric application with the Service Fabric CLI](service-fabric-application-lifecycle-sfctl.md) for detailed instructions.
...
Then, expand the **Applications** node and note that there is now an entry for your application type and another for the first instance of that type.
...
## <a name="remove-the-application"></a>Remove the application
...
## <a name="service-fabric-java-libraries-on-maven"></a>Service Fabric Java libraries on Maven
...
#### <a name="fabric-support"></a>Fabric support
