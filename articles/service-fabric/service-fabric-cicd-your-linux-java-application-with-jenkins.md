...
---
# <a name="use-jenkins-to-build-and-deploy-your-linux-java-application"></a>Use Jenkins to build and deploy your Linux Java application
...
## <a name="set-up-jenkins-inside-a-service-fabric-cluster"></a>Set up Jenkins inside a Service Fabric cluster
...
## <a name="set-up-jenkins-outside-a-service-fabric-cluster"></a>Set up Jenkins outside a Service Fabric cluster
...
## <a name="install-the-service-fabric-jenkins-plug-in-from-the-portal"></a>Install the Service Fabric Jenkins plug-in from the portal
...
## <a name="create-and-configure-a-jenkins-job"></a>Create and configure a Jenkins job
