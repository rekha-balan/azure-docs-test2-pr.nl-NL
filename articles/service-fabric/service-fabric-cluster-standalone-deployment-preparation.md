...
## <a name="plan-your-cluster-infrastructure"></a>Plan your cluster infrastructure
...
## <a name="determine-the-number-of-fault-domains-and-upgrade-domains"></a>Determine the number of fault domains and upgrade domains
...
## <a name="determine-the-initial-cluster-size"></a>Determine the initial cluster size
...
## <a name="prepare-the-machines-that-will-serve-as-nodes"></a>Prepare the machines that will serve as nodes
...
## <a name="download-the-service-fabric-standalone-package-for-windows-server"></a>Download the Service Fabric standalone package for Windows Server
...
## <a name="modify-cluster-configuration"></a>Modify cluster configuration
...
## <a name="validate-environment-using-testconfiguration-script"></a>Validate environment using TestConfiguration script
