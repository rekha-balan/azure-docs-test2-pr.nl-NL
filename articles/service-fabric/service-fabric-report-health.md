...
---
# <a name="add-custom-service-fabric-health-reports"></a>Add custom Service Fabric health reports
...
## <a name="report-from-within-low-privilege-services"></a>Report from within low privilege services
...
## <a name="design-health-reporting"></a>Design health reporting
...
## <a name="report-periodically-vs-on-transition"></a>Report periodically vs. on transition
...
## <a name="implement-health-reporting"></a>Implement health reporting
