...
## <a name="customizing-service-fabric-cluster-settings-using-azure-resource-manager-templates"></a>Customizing Service Fabric cluster settings using Azure Resource Manager templates
...
### <a name="section-name-diagnostics"></a>Section Name: Diagnostics
...
### <a name="section-name-traceetw"></a>Section Name: Trace/Etw
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
| Level |Int, default is 4 |Trace etw level can take values 1, 2, 3, 4. To be supported you must keep the trace level at 4 |

### <a name="section-name-performancecounterlocalstore"></a>Section Name: PerformanceCounterLocalStore
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-setup"></a>Section Name: Setup
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-transactionalreplicator"></a>Section Name: TransactionalReplicator
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-fabricclient"></a>Section Name: FabricClient
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-common"></a>Section Name: Common
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-healthmanager"></a>Section Name: HealthManager
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-fabricnode"></a>Section Name: FabricNode
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-nodeproperties"></a>Section Name: NodeProperties
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
| PropertyGroup |NodePropertyCollectionMap |A collection of string key-value pairs for node properties. |

### <a name="section-name-nodecapacities"></a>Section Name: NodeCapacities
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-paas"></a>Section Name: Paas
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
| ClusterId |string, default is "" |X509 certificate store used by fabric for configuration protection. |

### <a name="section-name-fabrichost"></a>Section Name: FabricHost
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-namingservice"></a>Section Name: NamingService
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-runas"></a>Section Name: RunAs
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-runasfabric"></a>Section Name: RunAs_Fabric
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
| RunAsAccountName |string, default is "" |Indicates the RunAs account name. This is only needed for "DomainUser" or "ManagedServiceAccount" account type. Valid values are "domain\user" or "user@domain". |
...
### <a name="section-name-runasdca"></a>Section Name: RunAs_DCA
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
| RunAsAccountName |string, default is "" |Indicates the RunAs account name. This is only needed for "DomainUser" or "ManagedServiceAccount" account type. Valid values are "domain\user" or "user@domain". |
|RunAsAccountType|string, default is "" |Indicates the RunAs account type. This is needed for any RunAs section Valid values are "LocalUser/DomainUser/NetworkService/ManagedServiceAccount/LocalSystem". |
...
### <a name="section-name-httpgateway"></a>Section Name: HttpGateway
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-applicationgatewayhttp"></a>Section Name: ApplicationGateway/Http
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-management"></a>Section Name: Management
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-healthmanagerclusterhealthpolicy"></a>Section Name: HealthManager/ClusterHealthPolicy
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-tokenvalidationservice"></a>Section Name: TokenValidationService
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-upgradeservice"></a>Section Name: UpgradeService
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
...
### <a name="section-name-placementandloadbalancing"></a>Section Name: PlacementAndLoadBalancing
| **Parameter** | **Allowed Values** | **Guidance or short Description** |
| --- | --- | --- |
