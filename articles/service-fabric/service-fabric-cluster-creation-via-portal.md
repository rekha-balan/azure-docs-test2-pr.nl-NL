...
---
# <a name="create-a-service-fabric-cluster-in-azure-using-the-azure-portal"></a>Create a Service Fabric cluster in Azure using the Azure portal
...
### <a name="client-authentication-certificates"></a>Client authentication certificates
...
## <a name="create-cluster-in-the-azure-portal"></a>Create cluster in the Azure portal
### <a name="search-for-the-service-fabric-cluster-resource"></a>Search for the Service Fabric cluster resource
...
#### <a name="2-cluster-configuration"></a>2. Cluster configuration
...
### <a name="view-your-cluster-status"></a>View your cluster status
...
## <a name="remote-connect-to-a-virtual-machine-scale-set-instance-or-a-cluster-node"></a>Remote connect to a Virtual Machine Scale Set instance or a cluster node
