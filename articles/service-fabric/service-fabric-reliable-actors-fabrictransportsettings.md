...
---
# <a name="configure-fabrictransport-settings-for-reliable-actors"></a>Configure FabricTransport settings for Reliable Actors
...
## <a name="assembly-attribute"></a>Assembly attribute
...
## <a name="config-package"></a>Config package

You can use a [config package](service-fabric-application-model.md) to modify the default configuration.

### <a name="configure-fabrictransport-settings-for-the-actor-service"></a>Configure FabricTransport settings for the actor service
...
### <a name="configure-fabrictransport-settings-for-the-actor-client-assembly"></a>Configure FabricTransport settings for the actor client assembly
