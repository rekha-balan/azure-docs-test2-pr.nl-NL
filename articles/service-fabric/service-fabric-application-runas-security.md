...
---
# <a name="run-a-service-as-a-local-user-account-or-local-system-account"></a>Run a service as a local user account or local system account
...
## <a name="run-a-service-as-a-local-user"></a>Run a service as a local user
...
## <a name="create-a-local-user-group"></a>Create a local user group
...
## <a name="debug-a-code-package-locally-using-console-redirection"></a>Debug a code package locally using console redirection
