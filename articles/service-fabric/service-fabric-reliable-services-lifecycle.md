...
---
# <a name="reliable-services-lifecycle-overview"></a>Reliable Services lifecycle overview
...
## <a name="stateless-service-startup"></a>Stateless service startup
...
## <a name="stateless-service-shutdown"></a>Stateless service shutdown
...
## <a name="stateful-service-startup"></a>Stateful service startup
...
## <a name="stateful-service-primary-swaps"></a>Stateful service Primary swaps
...
### <a name="for-the-primary-thats-demoted"></a>For the Primary that's demoted
...
### <a name="for-the-secondary-thats-promoted"></a>For the Secondary that's promoted
...
### <a name="common-issues-during-stateful-service-shutdown-and-primary-demotion"></a>Common issues during stateful service shutdown and Primary demotion
...
## <a name="notes-on-the-service-lifecycle"></a>Notes on the service lifecycle
