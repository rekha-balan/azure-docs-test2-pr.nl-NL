...
## <a name="avoiding-disaster"></a>Avoiding disaster
...
### <a name="hardware-and-software-faults"></a>Hardware and software faults
...
### <a name="operational-faults"></a>Operational faults
...
## <a name="managing-failures"></a>Managing failures
...
### <a name="handling-single-failures"></a>Handling single failures
...
### <a name="handling-coordinated-failures"></a>Handling coordinated failures
...
### <a name="handling-simultaneous-hardware-or-software-failures"></a>Handling simultaneous hardware or software failures
...
### <a name="random-failures-leading-to-service-failures"></a>Random failures leading to service failures
...
## <a name="availability-of-the-service-fabric-cluster"></a>Availability of the Service Fabric cluster
...
### <a name="failures-of-a-datacenter-or-azure-region"></a>Failures of a datacenter or Azure region
...
### <a name="random-failures-leading-to-cluster-failures"></a>Random failures leading to cluster failures
