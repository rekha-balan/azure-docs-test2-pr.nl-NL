...
## <a name="what-do-the-stop-node-and-start-node-apis-do"></a>What do the Stop Node and Start Node APIs do?
...
## <a name="introducing-the-node-transition-apis"></a>Introducing the Node Transition APIs
