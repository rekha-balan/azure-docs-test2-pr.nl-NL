...
## <a name="package-an-existing-executable"></a>Package an existing executable
...
## <a name="use-visual-studio-to-package-an-existing-executable"></a>Use Visual Studio to package an existing executable
...
## <a name="manually-package-and-deploy-an-existing-executable"></a>Manually package and deploy an existing executable
...
#### <a name="optional-update-setupentrypoint"></a>Optional: Update SetupEntrypoint
```xml
<SetupEntryPoint>
   <ExeHost>
       <Program>scripts\launchConfig.cmd</Program>
...
#### <a name="update-endpoints-and-register-with-naming-service-for-communication"></a>Update Endpoints and register with Naming Service for communication
```xml
<Endpoints>
   <Endpoint Name="NodeAppTypeEndpoint" Protocol="http" Port="3000" Type="Input" />
</Endpoints>
...
## <a name="creating-a-guest-executable-using-yeoman-for-service-fabric-on-linux"></a>Creating a guest executable using Yeoman for Service Fabric on Linux
