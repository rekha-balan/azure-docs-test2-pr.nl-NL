...
### <a name="make-the-actor-state-as-granular-as-possible"></a>Make the actor state as granular as possible
...
### <a name="correctly-manage-the-actors-life-cycle"></a>Correctly manage the actor's life-cycle
