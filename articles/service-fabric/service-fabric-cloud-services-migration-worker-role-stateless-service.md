...
---
# <a name="guide-to-converting-web-and-worker-roles-to-service-fabric-stateless-services"></a>Guide to converting Web and Worker Roles to Service Fabric stateless services
...
## <a name="worker-role-to-stateless-service"></a>Worker Role to stateless service
...
## <a name="web-role-to-stateless-service"></a>Web Role to stateless service
...
## <a name="entry-point-api-and-lifecycle"></a>Entry point API and lifecycle
...
### <a name="worker-role"></a>Worker Role
```C#
...
## <a name="application-api-and-environment"></a>Application API and environment
...
### <a name="accessing-configuration"></a>Accessing configuration
...
### <a name="configuration-update-events"></a>Configuration update events
#### <a name="cloud-services"></a>Cloud Services
...
## <a name="startup-tasks"></a>Startup tasks
...
## <a name="a-note-about-development-environment"></a>A note about development environment
