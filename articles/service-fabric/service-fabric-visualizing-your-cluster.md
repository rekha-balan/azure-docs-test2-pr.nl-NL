...
---
# <a name="visualize-your-cluster-with-service-fabric-explorer"></a>Visualize your cluster with Service Fabric Explorer
...
## <a name="connect-to-service-fabric-explorer"></a>Connect to Service Fabric Explorer
...
## <a name="understand-the-service-fabric-explorer-layout"></a>Understand the Service Fabric Explorer layout
...
### <a name="view-the-clusters-layout"></a>View the cluster's layout
...
### <a name="view-applications-and-services"></a>View applications and services
...
### <a name="view-the-clusters-nodes"></a>View the cluster's nodes
...
## <a name="connect-to-a-remote-service-fabric-cluster"></a>Connect to a remote Service Fabric cluster
...
### <a name="discover-the-service-fabric-explorer-endpoint-for-a-remote-cluster"></a>Discover the Service Fabric Explorer endpoint for a remote cluster
