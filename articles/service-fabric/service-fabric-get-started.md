...
---
# <a name="prepare-your-development-environment-on-windows"></a>Prepare your development environment on Windows
...
```
## <a name="install-docker-optional"></a>Install Docker (optional)
