...
### <a name="defining-metrics-for-your-service---an-example"></a>Defining metrics for your service - an example
...
### <a name="updating-a-services-metric-configuration"></a>Updating a service's metric configuration
