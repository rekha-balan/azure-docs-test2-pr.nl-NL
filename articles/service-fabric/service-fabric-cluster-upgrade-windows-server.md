...
3. Start a cluster upgrade to an available version by using the [Start-ServiceFabricClusterUpgrade](https://docs.microsoft.com/powershell/module/servicefabric/start-servicefabricclusterupgrade) Windows PowerShell command.
...
### <a name="upgrade-clusters-that-have-no-connectivity-to-download-the-latest-code-and-configuration"></a>Upgrade clusters that have *no connectivity* to download the latest code and configuration
...
#### <a name="auto-provisioning-vs-manual-provisioning"></a>Auto provisioning vs. manual provisioning
