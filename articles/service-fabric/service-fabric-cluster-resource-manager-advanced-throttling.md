...
---
# <a name="throttling-the-service-fabric-cluster-resource-manager"></a>Throttling the Service Fabric Cluster Resource Manager
...
### <a name="default-count-based-throttles"></a>Default count based throttles
