...
---
# <a name="service-fabric-networking-patterns"></a>Service Fabric networking patterns
...
### <a name="existing-virtual-network"></a>Existing virtual network
...
### <a name="static-public-ip-address"></a>Static public IP address
...
### <a name="service-fabric-template"></a>Service Fabric template
...
<a id="existingvnet"></a>
## <a name="existing-virtual-network-or-subnet"></a>Existing virtual network or subnet
...
<a id="internallb"></a>
## <a name="internal-only-load-balancer"></a>Internal-only load balancer
...
## <a name="internal-and-external-load-balancer"></a>Internal and external load balancer
