...
---
# <a name="microsoft-authenticator-app-faq"></a>Microsoft Authenticator app FAQ
...
### <a name="what-are-the-codes-in-the-app-for-why-does-the-number-keep-counting-down"></a>What are the codes in the app for? Why does the number keep counting down?
...
### <a name="i-only-get-notifications-when-i-have-the-app-open-if-the-app-isnt-open-i-dont-get-any-notifications"></a>I only get notifications when I have the app open. If the app isn't open, I don't get any notifications.
...
### <a name="im-already-using-the-microsoft-authenticator-application-for-verification-codes-how-do-i-switch-to-one-click-push-notifications"></a>I'm already using the Microsoft Authenticator application for verification codes. How do I switch to one-click push notifications?
...
### <a name="do-one-click-push-notifications-work-for-non-microsoft-accounts"></a>Do one-click push notifications work for non-Microsoft accounts?
...
### <a name="i-restored-my-device-from-a-backup-and-my-account-codes-are-missing-or-not-working-what-happened"></a>I restored my device from a backup, and my account codes are missing or not working. What happened?
...
### <a name="i-got-a-new-device-how-do-i-remove-the-microsoft-authenticator-app-from-my-old-device-and-move-to-the-new-one"></a>I got a new device. How do I remove the Microsoft Authenticator app from my old device and move to the new one?
...
### <a name="how-do-i-remove-an-account-from-the-app"></a>How do I remove an account from the app?
...
### <a name="why-does-the-app-request-so-many-permissions"></a>Why does the app request so many permissions?
...
### <a name="why-does-the-microsoft-authenticator-app-allow-you-to-approve-a-request-without-unlocking-the-device"></a>Why does the Microsoft Authenticator App allow you to approve a request without unlocking the device?
...
### <a name="what-does-the-lock-icon-in-the-account-list-mean"></a>What does the lock icon in the account list mean?
