...
### <a name="option-1---mfa-licenses"></a>Option 1 - MFA licenses
...
### <a name="option-2---bundled-licenses-that-include-mfa"></a>Option 2 - Bundled licenses that include MFA
...
### <a name="option-3---mfa-consumption-based-model"></a>Option 3 - MFA consumption-based model
