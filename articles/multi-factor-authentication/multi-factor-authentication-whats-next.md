...
---
# <a name="configure-azure-multi-factor-authentication-settings"></a>Configure Azure Multi-Factor Authentication settings
...
## <a name="access-the-azure-mfa-management-portal"></a>Access the Azure MFA Management Portal
...
### <a name="use-an-auth-provider"></a>Use an Auth Provider
...
### <a name="use-the-mfa-service-settings-page"></a>Use the MFA Service Settings page 
...
### <a name="set-up-fraud-alert"></a>Set up fraud alert
...
### <a name="how-users-report-fraud"></a>How users report fraud 
Fraud alert can be reported two ways.  Either through the mobile app or through the phone.  

#### <a name="report-fraud-with-the-mobile-app"></a>Report fraud with the mobile app
...
#### <a name="report-fraud-with-a-phone"></a>Report fraud with a phone
...
### <a name="view-fraud-reports"></a>View fraud reports
...
### <a name="create-a-one-time-bypass"></a>Create a one-time bypass
1. Sign in to the [Azure classic portal](https://portal.azure.com/).
...
### <a name="view-the-one-time-bypass-report"></a>View the one-time bypass report
1. Sign in to the [Azure classic portal](https://portal.azure.com/).
2. On the left, select Active Directory.
3. At the top select **Multi-Factor Auth Providers**. This brings up a list of your Multi-Factor Auth Providers.
4. Select your Multi-Factor Auth Provider and click **Manage** at the bottom of the page. The Azure Multi-Factor Authentication Management Portal opens.
...
### <a name="set-up-a-custom-message"></a>Set up a custom message
...
5. On the Configure: Voice Messages page, click **New Voice Message**.
   ![Cloud](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/custom1.png)
6. On the Configure: New Voice Messages page, click **Manage Sound Files**.
   ![Cloud](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/custom2.png)
7. On the Configure: Sound Files page, click **Upload Sound File**.
   ![Cloud](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/custom3.png)
...
7. Click **Create**. A message confirms that you have successfully created a voice message.
    ![Cloud](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/custom5.png)</center>
...
### <a name="set-up-caching"></a>Set up caching 
1. Sign in to the [Azure classic portal](https://portal.azure.com/).
2. Navigate to the MFA Management Portal per the instructions at the top of this page.
...
<center>![Cloud](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/cache.png)</center>
...
### <a name="allow-app-password-creation"></a>Allow app password creation
...
### <a name="create-app-passwords"></a>Create app passwords
...
## <a name="remember-multi-factor-authentication-for-devices-that-users-trust"></a>Remember Multi-Factor Authentication for devices that users trust
...
### <a name="enable-remember-multi-factor-authentication"></a>Enable Remember multi-factor authentication
1. Sign in to the [Azure classic portal](https://portal.azure.com/).
2. Navigate to the MFA Service Settings page per the instructions at the beginning of this article.
3. On the Service Settings page, under manage user device settings, check the **Allow users to remember multi-factor authentication on devices they trust** box.
   ![Remember devices](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/remember.png)
...
### <a name="mark-a-device-as-trusted"></a>Mark a device as trusted
...
3. On the Service Settings page, under verification options, select/unselect the options you wish to use.
   ![Verification options](https://docstestmedia1.blob.core.windows.net/azure-media/articles/multi-factor-authentication/media/multi-factor-authentication-whats-next/authmethods.png)
4. Click **Save**.
5. Click **Close**.
