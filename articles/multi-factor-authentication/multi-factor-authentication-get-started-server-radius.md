...
---
# <a name="integrate-radius-authentication-with-azure-multi-factor-authentication-server"></a>Integrate RADIUS authentication with Azure Multi-Factor Authentication Server
...
## <a name="add-a-radius-client"></a>Add a RADIUS client
...
## <a name="configure-your-radius-client"></a>Configure your RADIUS client
