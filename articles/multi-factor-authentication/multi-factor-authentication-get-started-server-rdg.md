...
## <a name="configure-the-remote-desktop-gateway"></a>Configure the Remote Desktop Gateway
...
### <a name="modify-the-timeout-policy"></a>Modify the timeout policy
...
### <a name="prepare-nps-to-receive-authentications-from-the-mfa-server"></a>Prepare NPS to receive authentications from the MFA Server
