...
---
# <a name="manage-endpoint-protection-issues-with-azure-security-center"></a>Manage endpoint protection issues with Azure Security Center
...
## <a name="install-antimalware-on-azure-vms"></a>Install antimalware on Azure VMs
...
## <a name="install-antimalware-on-non-azure-computers"></a>Install antimalware on non-Azure computers
