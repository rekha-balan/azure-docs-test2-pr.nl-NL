...
## <a name="centralized-policy-management"></a>Centralized policy management
...
### <a name="subscription-coverage"></a>Subscription coverage
...
### <a name="policy-compliance"></a>Policy compliance
...
### <a name="manage-and-govern-your-security-posture"></a>Manage and govern your security posture
...
## <a name="continuous-security-assessment"></a>Continuous security assessment
...
## <a name="actionable-recommendations"></a>Actionable recommendations
...
### <a name="most-prevalent-recommendations"></a>Most prevalent recommendations
...
### <a name="prioritized-alerts-and-incidents"></a>Prioritized alerts and incidents
...
## <a name="just-in-time-vm-access"></a>Just in time VM access
...
## <a name="adaptive-application-controls"></a>Adaptive application controls
...
## <a name="integrate-your-security-solutions"></a>Integrate your security solutions
