...
---
# <a name="performing-sentiment-analysis-by-using-azure-stream-analytics-and-azure-machine-learning"></a>Performing sentiment analysis by using Azure Stream Analytics and Azure Machine Learning
...
## <a name="create-a-storage-container-and-upload-the-csv-input-file"></a>Create a storage container and upload the CSV input file
...
### <a name="configure-the-job-input"></a>Configure the job input
...
### <a name="configure-the-job-output"></a>Configure the job output
...
### <a name="add-the-machine-learning-function"></a>Add the Machine Learning function 
...
### <a name="create-a-query-to-transform-the-data"></a>Create a query to transform the data
...
## <a name="start-the-stream-analytics-job-and-check-the-output"></a>Start the Stream Analytics job and check the output

You can now start the Stream Analytics job.

### <a name="start-the-job"></a>Start the job
1. Return to the job overview blade.
...
### <a name="check-the-output"></a>Check the output
...
### <a name="view-metrics"></a>View metrics
