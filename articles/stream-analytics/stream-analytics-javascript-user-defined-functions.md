...
---
# <a name="azure-stream-analytics-javascript-user-defined-functions"></a>Azure Stream Analytics JavaScript user-defined functions
...
## <a name="javascript-user-defined-functions"></a>JavaScript user-defined functions
...
## <a name="add-a-javascript-user-defined-function-in-the-azure-portal"></a>Add a JavaScript user-defined function in the Azure portal
...
## <a name="call-a-javascript-user-defined-function-in-a-query"></a>Call a JavaScript user-defined function in a query
...
## <a name="supported-javascript-objects"></a>Supported JavaScript objects
...
### <a name="stream-analytics-and-javascript-type-conversion"></a>Stream Analytics and JavaScript type conversion
...
## <a name="other-javascript-user-defined-function-patterns"></a>Other JavaScript user-defined function patterns

### <a name="write-nested-json-to-output"></a>Write nested JSON to output
