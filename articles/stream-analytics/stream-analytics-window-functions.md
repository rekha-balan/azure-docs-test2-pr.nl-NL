...
---
# <a name="introduction-to-stream-analytics-windowing-functions"></a>Introduction to Stream Analytics windowing functions
...
## <a name="session-window-preview"></a>Session window (Preview)
