...
---
# <a name="deploy-azure-log-analytics-nozzle-for-cloud-foundry-system-monitoring"></a>Deploy Azure Log Analytics Nozzle for Cloud Foundry system monitoring
...
### <a name="1-deploy-a-cf-or-pivotal-cloud-foundry-environment-in-azure"></a>1. Deploy a CF or Pivotal Cloud Foundry environment in Azure
...
### <a name="2-install-the-cf-command-line-tools-for-deploying-the-nozzle"></a>2. Install the CF command-line tools for deploying the Nozzle
...
### <a name="3-create-a-log-analytics-workspace-in-azure"></a>3. Create a Log Analytics workspace in Azure
...
#### <a name="to-create-the-workspace-manually"></a>To create the workspace manually:
...
#### <a name="to-create-the-oms-workspace-through-the-oms-monitoring-template-from-azure-market-place"></a>To create the OMS workspace through the OMS monitoring template from Azure market place:
...
## <a name="deploy-the-nozzle"></a>Deploy the Nozzle

There are a couple of different ways to deploy the Nozzle: as a PCF tile or as a CF application.

### <a name="deploy-the-nozzle-as-a-pcf-ops-manager-tile"></a>Deploy the Nozzle as a PCF Ops Manager tile
...
### <a name="deploy-the-nozzle-manually-as-a-cf-application"></a>Deploy the Nozzle manually as a CF application

If you are not using PCF Ops Manager, deploy the Nozzle as an application. The following sections describe this process.

#### <a name="sign-in-to-your-cf-deployment-as-an-admin-through-cf-cli"></a>Sign in to your CF deployment as an admin through CF CLI
...
#### <a name="create-a-cf-user-and-grant-required-privileges"></a>Create a CF user and grant required privileges
...
#### <a name="download-the-latest-log-analytics-nozzle-release"></a>Download the latest Log Analytics Nozzle release
...
### <a name="push-the-application-from-your-development-computer"></a>Push the application from your development computer
...
## <a name="validate-the-nozzle-installation"></a>Validate the Nozzle installation

### <a name="from-apps-manager-for-pcf"></a>From Apps Manager (for PCF)
...
### <a name="from-your-development-computer"></a>From your development computer
...
## <a name="view-the-data-in-the-oms-portal"></a>View the data in the OMS portal
...
### <a name="1-import-the-oms-view"></a>1. Import the OMS view
...
### <a name="2-create-alert-rules"></a>2. Create alert rules
...
### <a name="scale-the-nozzle"></a>Scale the Nozzle
...
### <a name="scale-the-loggregator"></a>Scale the loggregator
...
### <a name="remove-the-nozzle-from-ops-manager"></a>Remove the Nozzle from Ops Manager
...
### <a name="remove-the-nozzle-from-your-development-computer"></a>Remove the Nozzle from your development computer
...
Azure Log Analytics Nozzle is open sourced. Send your questions and feedback to the [GitHub section](https://github.com/Azure/oms-log-analytics-firehose-nozzle/issues). To open an Azure support request, choose "Virtual Machine running Cloud Foundry" as the service category. 

## <a name="next-step"></a>Next step

From PCF2.0, VM performance metrics are transferred to Azure log analytics nozzle by System Metrics Forwarder, and integrated into the OMS workspace. You no longer need the OMS agent for the VM performance metrics. However you can still use the OMS agent to collect Syslog information. The OMS agent is installed as a Bosh add-on to your CF VMs. 
