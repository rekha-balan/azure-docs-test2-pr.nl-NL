...
---
# <a name="provision-the-azure-ssis-integration-runtime-in-azure-data-factory-with-powershell"></a>Provision the Azure-SSIS Integration Runtime in Azure Data Factory with PowerShell
...
## <a name="launch-windows-powershell-ise"></a>Launch Windows PowerShell ISE
...
## <a name="join-azure-ssis-ir-to-a-virtual-network"></a>Join Azure-SSIS IR to a virtual network
...
## <a name="monitor-and-manage-azure-ssis-ir"></a>Monitor and manage Azure-SSIS IR
