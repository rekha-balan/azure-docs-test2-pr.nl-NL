...
A high-level overview of the scenario: ![Overview](media/tutorial-control-flow-portal/overview.png)
...
## <a name="trigger-a-pipeline-run-that-succeeds"></a>Trigger a pipeline run that succeeds
...
## <a name="monitor-the-successful-pipeline-run"></a>Monitor the successful pipeline run
...
## <a name="trigger-a-pipeline-run-that-fails"></a>Trigger a pipeline run that fails
...
## <a name="monitor-the-failed-pipeline-run"></a>Monitor the failed pipeline run
