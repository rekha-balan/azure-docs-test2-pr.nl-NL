...
---
# <a name="store-credential-in-azure-key-vault"></a>Store credential in Azure Key Vault
...
## <a name="azure-key-vault-linked-service"></a>Azure Key Vault linked service
...
## <a name="reference-secret-stored-in-key-vault"></a>Reference secret stored in key vault
