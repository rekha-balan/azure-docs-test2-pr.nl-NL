...
---
# <a name="monitor-and-manage-azure-data-factory-pipelines-by-using-the-azure-portal-and-powershell"></a>Monitor and manage Azure Data Factory pipelines by using the Azure portal and PowerShell
...
### <a name="view-the-state-of-each-activity-inside-a-pipeline"></a>View the state of each activity inside a pipeline
...
#### <a name="use-the-azure-portal-to-debug-an-error"></a>Use the Azure portal to debug an error
...
#### <a name="use-powershell-to-debug-an-error"></a>Use PowerShell to debug an error
...
![Fix errors and validate](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-factory/media/data-factory-monitor-manage-pipelines/fix-error-and-validate.png)
...
#### <a name="specify-an-alert-definition"></a>Specify an alert definition
...
#### <a name="deploy-the-alert"></a>Deploy the alert
...
#### <a name="retrieve-the-list-of-azure-resource-group-deployments"></a>Retrieve the list of Azure resource group deployments
...
#### <a name="troubleshoot-user-events"></a>Troubleshoot user events
...
#### <a name="enable-metrics"></a>Enable metrics
...
### <a name="set-up-an-alert-on-metrics"></a>Set up an alert on metrics
...
![Data factory metric blade > Add alert](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-factory/media/data-factory-monitor-manage-pipelines/add-alert.png)
...
### <a name="deploy-alerts-by-using-powershell"></a>Deploy alerts by using PowerShell
...
## <a name="move-a-data-factory-to-a-different-resource-group-or-subscription"></a>Move a data factory to a different resource group or subscription
