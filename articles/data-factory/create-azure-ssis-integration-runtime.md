...
---
# <a name="create-the-azure-ssis-integration-runtime-in-azure-data-factory"></a>Create the Azure-SSIS integration runtime in Azure Data Factory
...
### <a name="provision-an-azure-ssis-integration-runtime"></a>Provision an Azure SSIS integration runtime 
...
### <a name="azure-ssis-integration-runtimes-in-the-portal"></a>Azure SSIS integration runtimes in the portal
...
### <a name="log-in-and-select-subscription"></a>Log in and select subscription
...
### <a name="validate-the-connection-to-database"></a>Validate the connection to database
...
### <a name="create-an-integration-runtime"></a>Create an integration runtime
...
### <a name="start-integration-runtime"></a>Start integration runtime
...
## <a name="azure-resource-manager-template"></a>Azure Resource Manager template
...
## <a name="deploy-ssis-packages"></a>Deploy SSIS packages
