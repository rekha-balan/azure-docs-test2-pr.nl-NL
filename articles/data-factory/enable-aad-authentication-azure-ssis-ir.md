...
---
# <a name="enable-azure-active-directory-authentication-for-the-azure-ssis-integration-runtime"></a>Enable Azure Active Directory authentication for the Azure-SSIS integration runtime
...
## <a name="create-a-group-in-azure-ad-and-make-the-data-factory-msi-a-member-of-the-group"></a>Create a group in Azure AD and make the Data Factory MSI a member of the group
...
### <a name="enable-azure-ad-authentication-for-the-azure-sql-database"></a>Enable Azure AD authentication for the Azure SQL Database

You can [configure Azure AD authentication for the SQL Database](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-aad-authentication-configure) using the following steps:
...
### <a name="create-a-contained-user-in-the-database-that-represents-the-azure-ad-group"></a>Create a contained user in the database that represents the Azure AD group
...
## <a name="provision-the-azure-ssis-ir-in-the-portal"></a>Provision the Azure-SSIS IR in the portal
...
## <a name="provision-the-azure-ssis-ir-with-powershell"></a>Provision the Azure-SSIS IR with PowerShell
