...
---
# <a name="copy-data-from-sftp-server-using-azure-data-factory"></a>Copy data from SFTP server using Azure Data Factory
...
### <a name="sftp-as-source"></a>SFTP as source
