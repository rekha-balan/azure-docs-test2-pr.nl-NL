...
---
# <a name="tutorial-create-an-azure-data-factory-using-azure-resource-manager-template"></a>Tutorial: Create an Azure data factory using Azure Resource Manager template
...
## <a name="deploy-data-factory-entities"></a>Deploy Data Factory entities 
...
## <a name="start-the-trigger"></a>Start the trigger
