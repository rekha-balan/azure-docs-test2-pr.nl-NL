...
---
# <a name="incrementally-load-data-from-azure-sql-database-to-azure-blob-storage-using-change-tracking-information"></a>Incrementally load data from Azure SQL Database to Azure Blob Storage using change tracking information 
...
### <a name="create-a-data-source-table-in-your-azure-sql-database"></a>Create a data source table in your Azure SQL database
...
### <a name="create-azure-sql-database-linked-service"></a>Create Azure SQL Database linked service.
...
### <a name="create-a-dataset-to-represent-source-data"></a>Create a dataset to represent source data 
...
### <a name="create-a-dataset-to-represent-data-copied-to-sink-data-store"></a>Create a dataset to represent data copied to sink data store. 
...
### <a name="create-a-dataset-to-represent-change-tracking-data"></a>Create a dataset to represent change tracking data 
...
## <a name="create-a-pipeline-for-the-full-copy"></a>Create a pipeline for the full copy
...
### <a name="run-the-full-copy-pipeline"></a>Run the full copy pipeline
...
### <a name="monitor-the-full-copy-pipeline"></a>Monitor the full copy pipeline
...
## <a name="add-more-data-to-the-source-table"></a>Add more data to the source table
...
## <a name="create-a-pipeline-for-the-delta-copy"></a>Create a pipeline for the delta copy
...
### <a name="run-the-incremental-copy-pipeline"></a>Run the incremental copy pipeline
...
### <a name="monitor-the-incremental-copy-pipeline"></a>Monitor the incremental copy pipeline
1. Click the **Monitor** tab on the left. You see the pipeline run in the list and its status. To refresh the list, click **Refresh**. The links in the **Actions** column let you view activity runs associated with the pipeline run and to rerun the pipeline. 
