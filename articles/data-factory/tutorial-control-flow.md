...
---
# <a name="branching-and-chaining-activities-in-a-data-factory-pipeline"></a>Branching and chaining activities in a Data Factory pipeline
...
A high-level overview of the scenario: ![Overview](media/tutorial-control-flow/overview.png)
...
### <a name="create-blob-table"></a>Create blob table
...
## <a name="create-a-data-factory-client"></a>Create a data factory client
...
### <a name="create-a-dataset-for-source-azure-blob"></a>Create a dataset for source Azure Blob
...
### <a name="create-a-dataset-for-sink-azure-blob"></a>Create a dataset for sink Azure Blob
...
## <a name="create-a-c-class-emailrequest"></a>Create a C# class: EmailRequest
...
```
## <a name="create-email-workflow-endpoints"></a>Create email workflow endpoints
...
### <a name="success-email-workflow"></a>Success email workflow 
...
## <a name="fail-email-workflow"></a>Fail email workflow 
...
## <a name="main-class"></a>Main class 
...
## <a name="monitor-a-pipeline-run"></a>Monitor a pipeline run
