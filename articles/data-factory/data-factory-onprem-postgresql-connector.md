...
---
# <a name="move-data-from-postgresql-using-azure-data-factory"></a>Move data from PostgreSQL using Azure Data Factory
...
## <a name="json-example-copy-data-from-postgresql-to-azure-blob"></a>JSON example: Copy data from PostgreSQL to Azure Blob
...
```
## <a name="type-mapping-for-postgresql"></a>Type mapping for PostgreSQL
