...
---
# <a name="copy-data-from-paypal-using-azure-data-factory"></a>Copy data from PayPal using Azure Data Factory
...
### <a name="paypalsource-as-source"></a>PayPalSource as source
