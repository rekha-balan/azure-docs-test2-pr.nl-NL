...
---
# <a name="pipeline-execution-and-triggers-in-azure-data-factory"></a>Pipeline execution and triggers in Azure Data Factory
...
## <a name="manual-execution-on-demand"></a>Manual execution (on-demand)
...
### <a name="basic-trigger-definition"></a>Basic trigger definition
...
## <a name="schedule-trigger"></a>Schedule trigger
...
## <a name="schedule-trigger-definition"></a>Schedule trigger definition
...
### <a name="schema-overview"></a>Schema overview
...
### <a name="schedule-trigger-example"></a>Schedule trigger example
...
### <a name="schema-defaults-limits-and-examples"></a>Schema defaults, limits, and examples
...
### <a name="starttime-property"></a>startTime property
...
### <a name="schedule-property"></a>schedule property
...
## <a name="tumbling-window-trigger"></a>Tumbling window trigger
...
## <a name="event-based-trigger"></a>Event-based trigger
...
## <a name="examples-of-trigger-recurrence-schedules"></a>Examples of trigger recurrence schedules
...
## <a name="trigger-type-comparison"></a>Trigger type comparison
