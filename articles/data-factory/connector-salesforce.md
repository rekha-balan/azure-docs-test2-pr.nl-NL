...
---
# <a name="copy-data-from-and-to-salesforce-by-using-azure-data-factory"></a>Copy data from and to Salesforce by using Azure Data Factory
...
### <a name="salesforce-as-a-source-type"></a>Salesforce as a source type
...
### <a name="salesforce-as-a-sink-type"></a>Salesforce as a sink type
...
### <a name="retrieve-data-from-a-salesforce-report"></a>Retrieve data from a Salesforce report
...
### <a name="retrieve-deleted-records-from-the-salesforce-recycle-bin"></a>Retrieve deleted records from the Salesforce Recycle Bin

To query the soft deleted records from the Salesforce Recycle Bin, you can specify `readBehavior` as `queryAll`. 

### <a name="difference-between-soql-and-sql-query-syntax"></a>Difference between SOQL and SQL query syntax
...
### <a name="retrieve-data-by-using-a-where-clause-on-the-datetime-column"></a>Retrieve data by using a where clause on the DateTime column
...
## <a name="data-type-mapping-for-salesforce"></a>Data type mapping for Salesforce
