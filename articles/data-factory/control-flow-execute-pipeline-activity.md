...
---
# <a name="execute-pipeline-activity-in-azure-data-factory"></a>Execute Pipeline activity in Azure Data Factory
...
### <a name="invoked-pipeline-definition"></a>Invoked pipeline definition
