...
---
# <a name="move-data-from-an-ftp-server-by-using-azure-data-factory"></a>Move data from an FTP server by using Azure Data Factory
...
## <a name="enable-connectivity"></a>Enable connectivity
...
### <a name="use-anonymous-authentication"></a>Use Anonymous authentication
...
### <a name="use-username-and-password-in-plain-text-for-basic-authentication"></a>Use username and password in plain text for basic authentication
...
### <a name="use-encryptedcredential-for-authentication-and-gateway"></a>Use encryptedCredential for authentication and gateway
...
### <a name="use-the-partionedby-property"></a>Use the partionedBy property
...
## <a name="json-example-copy-data-from-ftp-server-to-azure-blob-storage"></a>JSON example: Copy data from FTP server to Azure Blob storage
...
### <a name="ftp-linked-service"></a>FTP linked service
...
```
### <a name="ftp-input-dataset"></a>FTP input dataset
...
### <a name="a-copy-activity-in-a-pipeline-with-file-system-source-and-blob-sink"></a>A copy activity in a pipeline with file system source and blob sink
