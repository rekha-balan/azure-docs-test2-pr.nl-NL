...
### <a name="using-service-principal-authentication-recommended"></a>Using service principal authentication (recommended)
...
### <a name="using-user-credential-authentication"></a>Using user credential authentication
...
## <a name="example-copy-data-from-azure-blob-to-azure-data-lake-store"></a>Example: Copy data from Azure Blob to Azure Data Lake Store
...
## <a name="example-copy-data-from-azure-data-lake-store-to-azure-blob"></a>Example: Copy data from Azure Data Lake Store to Azure Blob
The following sample shows:
