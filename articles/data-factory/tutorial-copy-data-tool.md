...
---
# <a name="copy-data-from-azure-blob-storage-to-a-sql-database-by-using-the-copy-data-tool"></a>Copy data from Azure Blob storage to a SQL database by using the Copy Data tool
