...
---
# <a name="troubleshoot-issues-with-using-data-management-gateway"></a>Troubleshoot issues with using Data Management Gateway
...
## <a name="failed-to-install-or-register-gateway"></a>Failed to install or register gateway
...
## <a name="failed-to-author-linked-service"></a>Failed to author linked service
...
## <a name="copy-activity-fails"></a>Copy activity fails
### <a name="problem"></a>Problem
...
## <a name="data-store-connection-or-driver-related-errors"></a>Data store connection or driver-related errors
...
## <a name="gateway-logs"></a>Gateway logs
...
### <a name="locate-gateway-logs"></a>Locate gateway logs
