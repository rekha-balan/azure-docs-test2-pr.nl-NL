...
---
# <a name="how-to-start-and-stop-the-azure-ssis-integration-runtime-on-a-schedule"></a>How to start and stop the Azure SSIS integration runtime on a schedule
...
## <a name="create-and-test-an-azure-automation-runbook"></a>Create and test an Azure Automation runbook
...
### <a name="create-an-azure-automation-account"></a>Create an Azure Automation account
...
### <a name="import-data-factory-modules"></a>Import Data Factory modules
...
### <a name="create-a-powershell-runbook"></a>Create a PowerShell runbook
...
## <a name="create-schedules-for-the-runbook-to-startstop-the-azure-ssis-ir"></a>Create schedules for the runbook to start/stop the Azure SSIS IR
...
## <a name="create-webhooks-to-start-and-stop-the-azure-ssis-ir"></a>Create webhooks to start and stop the Azure SSIS IR
...
## <a name="create-and-schedule-a-data-factory-pipeline-that-startsstops-the-ir"></a>Create and schedule a Data Factory pipeline that starts/stops the IR
...
### <a name="test-run-the-pipeline"></a>Test run the pipeline
...
### <a name="schedule-the-pipeline"></a>Schedule the pipeline 
...
### <a name="monitor-the-pipeline-and-trigger-in-the-azure-portal"></a>Monitor the pipeline and trigger in the Azure portal
...
### <a name="monitor-the-pipeline-and-trigger-with-powershell"></a>Monitor the pipeline and trigger with PowerShell
