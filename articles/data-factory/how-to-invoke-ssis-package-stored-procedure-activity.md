...
---
# <a name="run-an-ssis-package-with-the-stored-procedure-activity-in-azure-data-factory"></a>Run an SSIS package with the Stored Procedure activity in Azure Data Factory
...
### <a name="create-a-pipeline-with-stored-procedure-activity"></a>Create a pipeline with stored procedure activity
...
### <a name="run-and-monitor-the-pipeline"></a>Run and monitor the pipeline
...
### <a name="create-a-trigger"></a>Create a trigger
