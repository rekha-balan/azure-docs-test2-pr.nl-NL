...
---
# <a name="copy-data-to-an-azure-search-index-using-azure-data-factory"></a>Copy data to an Azure Search index using Azure Data Factory
...
### <a name="azure-search-as-sink"></a>Azure Search as sink
