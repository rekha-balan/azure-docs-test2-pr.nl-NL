...
---
# <a name="copy-data-from-odata-source-using-azure-data-factory"></a>Copy data from OData source using Azure Data Factory
...
## <a name="data-type-mapping-for-odata"></a>Data type mapping for OData
