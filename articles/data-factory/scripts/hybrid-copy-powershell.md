...
---
# <a name="use-powershell-to-create-a-data-factory-pipeline-to-copy-data-from-on-premises-to-azure"></a>Use PowerShell to create a data factory pipeline to copy data from on-premises to Azure
...
### <a name="create-sample-database-in-sql-server"></a>Create sample database in SQL Server
