...
---
# <a name="copy-data-from-postgresql-by-using-azure-data-factory"></a>Copy data from PostgreSQL by using Azure Data Factory
...
## <a name="data-type-mapping-for-postgresql"></a>Data type mapping for PostgreSQL
