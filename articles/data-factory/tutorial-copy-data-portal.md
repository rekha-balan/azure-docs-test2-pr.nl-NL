...
---
# <a name="copy-data-from-azure-blob-storage-to-a-sql-database-by-using-azure-data-factory"></a>Copy data from Azure Blob storage to a SQL database by using Azure Data Factory
...
### <a name="configure-source"></a>Configure source
...
### <a name="configure-sink"></a>Configure sink
...
### <a name="confugure-mapping"></a>Confugure mapping
...
## <a name="validate-the-pipeline"></a>Validate the pipeline
...
## <a name="debug-and-publish-the-pipeline"></a>Debug and publish the pipeline
...
## <a name="trigger-the-pipeline-manually"></a>Trigger the pipeline manually
...
## <a name="trigger-the-pipeline-on-a-schedule"></a>Trigger the pipeline on a schedule
