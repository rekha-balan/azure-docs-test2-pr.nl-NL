...
---
# <a name="copy-multiple-tables-in-bulk-by-using-azure-data-factory"></a>Copy multiple tables in bulk by using Azure Data Factory
...
### <a name="prepare-sql-database-and-sql-data-warehouse"></a>Prepare SQL Database and SQL Data Warehouse
...
## <a name="azure-services-to-access-sql-server"></a>Azure services to access SQL server
...
### <a name="create-the-source-azure-sql-database-linked-service"></a>Create the source Azure SQL Database linked service
...
### <a name="create-the-sink-azure-sql-data-warehouse-linked-service"></a>Create the sink Azure SQL Data Warehouse linked service
...
### <a name="create-the-staging-azure-storage-linked-service"></a>Create the staging Azure Storage linked service
...
### <a name="create-a-dataset-for-source-sql-database"></a>Create a dataset for source SQL Database
...
### <a name="create-a-dataset-for-sink-sql-data-warehouse"></a>Create a dataset for sink SQL Data Warehouse
...
### <a name="create-the-pipeline-iterateandcopysqltables"></a>Create the pipeline "IterateAndCopySQLTables"
...
## <a name="start-and-monitor-pipeline-run"></a>Start and monitor pipeline run
