...
## <a name="control-activities"></a>Control activities
...
## <a name="activity-json"></a>Activity JSON
...
### <a name="execution-activities"></a>Execution activities
...
### <a name="activity-policy"></a>Activity policy
...
### <a name="activity-policy-json-definition"></a>Activity policy JSON definition
...
### <a name="control-activity"></a>Control activity
...
### <a name="activity-dependency"></a>Activity dependency
...
#### <a name="example-activity-2-depends-on-the-activity-1-succeeding"></a>Example: Activity 2 depends on the Activity 1 succeeding
...
## <a name="multiple-activities-in-a-pipeline"></a>Multiple activities in a pipeline
...
## <a name="scheduling-pipelines"></a>Scheduling pipelines
...
### <a name="trigger-a-definition"></a>Trigger A definition
