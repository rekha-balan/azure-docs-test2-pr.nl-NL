...
---
# <a name="move-data-from-sap-business-warehouse-using-azure-data-factory"></a>Move data From SAP Business Warehouse using Azure Data Factory
...
## <a name="supported-versions-and-installation"></a>Supported versions and installation
...
## <a name="json-example-copy-data-from-sap-business-warehouse-to-azure-blob"></a>JSON example: Copy data from SAP Business Warehouse to Azure Blob
...
### <a name="sap-business-warehouse-linked-service"></a>SAP Business Warehouse linked service
...
### <a name="sap-bw-input-dataset"></a>SAP BW input dataset
...
### <a name="type-mapping-for-sap-bw"></a>Type mapping for SAP BW
