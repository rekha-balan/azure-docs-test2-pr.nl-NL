...
---
# <a name="if-condition-activity-in-azure-data-factory"></a>If Condition activity in Azure Data Factory
...
### <a name="pipeline-with-if-condition-activity-adfv2quickstartpipelinejson"></a>Pipeline with IF-Condition activity (Adfv2QuickStartPipeline.json)
