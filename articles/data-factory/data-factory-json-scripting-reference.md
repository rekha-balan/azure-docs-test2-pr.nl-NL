...
### <a name="typeproperties-section"></a>typeProperties section
...
## <a name="linked-service"></a>Linked service
...
### <a name="blobsource-in-copy-activity"></a>BlobSource in Copy Activity
...
#### <a name="example-blobsource"></a>Example: BlobSource**
```json
{
    "name": "SamplePipeline",
    "properties": {
...
```
### <a name="blobsink-in-copy-activity"></a>BlobSink in Copy Activity
...
#### <a name="example-blobsink"></a>Example: BlobSink
...
#### <a name="example-using-service-principal-authentication"></a>Example: using service principal authentication
```json
{
...
#### <a name="example-using-user-credential-authentication"></a>Example: using user credential authentication
```json
{
    "name": "AzureDataLakeStoreLinkedService",
    "properties": {
...
### <a name="azure-data-lake-store-source-in-copy-activity"></a>Azure Data Lake Store Source in Copy Activity
...
#### <a name="example-azuredatalakestoresource"></a>Example: AzureDataLakeStoreSource
...
### <a name="documentdb-collection-source-in-copy-activity"></a>DocumentDB Collection Source in Copy Activity
...
### <a name="documentdb-collection-sink-in-copy-activity"></a>DocumentDB Collection Sink in Copy Activity
...
### <a name="sql-source-in-copy-activity"></a>SQL Source in Copy Activity
...
### <a name="sql-sink-in-copy-activity"></a>SQL Sink in Copy Activity
...
### <a name="sql-dw-source-in-copy-activity"></a>SQL DW Source in Copy Activity
...
### <a name="sql-dw-sink-in-copy-activity"></a>SQL DW Sink in Copy Activity
...
### <a name="azure-search-index-sink-in-copy-activity"></a>Azure Search Index Sink in Copy Activity
...
### <a name="azure-table-source-in-copy-activity"></a>Azure Table Source in Copy Activity
...
### <a name="azure-table-sink-in-copy-activity"></a>Azure Table Sink in Copy Activity
...
### <a name="relational-source-in-copy-activity"></a>Relational Source in Copy Activity 
...
### <a name="oracle-source-in-copy-activity"></a>Oracle Source in Copy Activity
...
### <a name="oracle-sink-in-copy-activity"></a>Oracle Sink in Copy Activity
...
#### <a name="example-json-for-using-sql-authentication"></a>Example: JSON for using SQL Authentication
...
```
#### <a name="example-json-for-using-windows-authentication"></a>Example: JSON for using Windows Authentication
...
### <a name="cassandra-source-in-copy-activity"></a>Cassandra Source in Copy Activity
...
#### <a name="mongodb-source-in-copy-activity"></a>MongoDB Source in Copy Activity
...
#### <a name="example-sample-dataset-with-prefix"></a>Example: Sample dataset with prefix
...
```
#### <a name="example-sample-data-set-with-version"></a>Example: Sample data set (with version)
...
#### <a name="example-dynamic-paths-for-s3"></a>Example: Dynamic paths for S3
...
### <a name="file-system-source-in-copy-activity"></a>File System Source in Copy Activity
...
#### <a name="sample-folder-path-definitions"></a>Sample folder path definitions 
...
#### <a name="example-using-username-and-password-in-plain-text"></a>Example: Using username and password in plain text
...
#### <a name="example-using-encryptedcredential"></a>Example: Using encryptedcredential
...
### <a name="file-system-sink-in-copy-activity"></a>File System Sink in Copy Activity
...
#### <a name="example-using-anonymous-authentication"></a>Example: Using Anonymous authentication
...
#### <a name="example-using-username-and-password-in-plain-text-for-basic-authentication"></a>Example: Using username and password in plain text for basic authentication
...
#### <a name="example-using-port-enablessl-enableservercertificatevalidation"></a>Example: Using port, enableSsl, enableServerCertificateValidation
...
#### <a name="example-using-encryptedcredential-for-authentication-and-gateway"></a>Example: Using encryptedCredential for authentication and gateway
...
#### <a name="example-using-windows-authentication"></a>Example: Using Windows authentication
...
#### <a name="example-using-basic-authentication"></a>Example: Using basic authentication
...
#### <a name="example-using-basic-digest-or-windows-authentication"></a>Example: Using Basic, Digest, or Windows authentication
...
#### <a name="example-using-clientcertificate-authentication"></a>Example: Using ClientCertificate authentication
...
**Example: using client certificate:** This linked service links your data factory to an on-premises HTTP web server. It uses a client certificate that is installed on the machine with Data Management Gateway installed.
...
#### <a name="example-using-client-certificate-in-a-file"></a>Example: using client certificate in a file
...
#### <a name="example-using-the-get-default-method"></a>Example: using the GET (default) method
...
#### <a name="example-using-the-post-method"></a>Example: using the POST method
...
### <a name="http-source-in-copy-activity"></a>HTTP Source in Copy Activity
...
#### <a name="example---using-windows-authentication-accessing-on-premises-odata-source"></a>Example - Using Windows authentication accessing on-premises OData source
...
#### <a name="example---using-oauth-authentication-accessing-cloud-odata-source"></a>Example - Using OAuth authentication accessing cloud OData source
```json
{
    "name": "inputLinkedService",
    "properties":
...
```
#### <a name="example---using-basic-authentication-with-encrypted-credentials"></a>Example - Using Basic authentication with encrypted credentials
...
### <a name="web-source-in-copy-activity"></a>Web Source in Copy Activity
...
## <a name="existing-azure-hdinsight-cluster"></a>Existing Azure HDInsight cluster
...
## <a name="transformation-activites"></a>TRANSFORMATION ACTIVITES
...
## <a name="hdinsight-spark-activity"></a>HDInsight Spark Activity
...
## <a name="machine-learning-batch-execution-activity"></a>Machine Learning Batch Execution Activity
...
## <a name="machine-learning-update-resource-activity"></a>Machine Learning Update Resource Activity
