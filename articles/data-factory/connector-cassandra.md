...
---
# <a name="copy-data-from-cassandra-using-azure-data-factory"></a>Copy data from Cassandra using Azure Data Factory
...
## <a name="data-type-mapping-for-cassandra"></a>Data type mapping for Cassandra
