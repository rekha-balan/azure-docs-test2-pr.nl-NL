...
---
# <a name="schema-mapping-in-copy-activity"></a>Schema mapping in copy activity
...
## <a name="column-mapping"></a>Column mapping
...
### <a name="explicit-column-mapping"></a>Explicit column mapping
...
#### <a name="explicit-column-mapping-example"></a>Explicit column mapping example
...
## <a name="data-type-mapping"></a>Data type mapping
...
### <a name="explicit-data-type-conversion"></a>Explicit data type conversion
...
## <a name="when-to-specify-dataset-structure"></a>When to specify dataset "structure"
