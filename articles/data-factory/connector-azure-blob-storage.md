...
---
# <a name="copy-data-to-or-from-azure-blob-storage-by-using-azure-data-factory"></a>Copy data to or from Azure Blob storage by using Azure Data Factory
...
### <a name="account-key-authentication"></a>Account key authentication
...
### <a name="blob-storage-as-a-source-type"></a>Blob storage as a source type
...
### <a name="blob-storage-as-a-sink-type"></a>Blob storage as a sink type
...
### <a name="some-recursive-and-copybehavior-examples"></a>Some recursive and copyBehavior examples
