...
---
# <a name="copy-data-from-an-on-premises-sql-server-database-to-azure-blob-storage"></a>Copy data from an on-premises SQL Server database to Azure Blob storage
