...
---
# <a name="copy-data-from-hdfs-using-azure-data-factory"></a>Copy data from HDFS using Azure Data Factory
...
### <a name="hdfs-as-source"></a>HDFS as source
...
## <a name="use-distcp-to-copy-data-from-hdfs"></a>Use DistCp to copy data from HDFS
