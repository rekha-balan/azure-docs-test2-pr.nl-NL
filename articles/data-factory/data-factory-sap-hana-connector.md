...
---
# <a name="move-data-from-sap-hana-using-azure-data-factory"></a>Move data From SAP HANA using Azure Data Factory
...
## <a name="json-example-copy-data-from-sap-hana-to-azure-blob"></a>JSON example: Copy data from SAP HANA to Azure Blob
...
### <a name="sap-hana-linked-service"></a>SAP HANA linked service
...
### <a name="sap-hana-input-dataset"></a>SAP HANA input dataset
...
### <a name="type-mapping-for-sap-hana"></a>Type mapping for SAP HANA
