...
### <a name="custom-net-activities"></a>Custom .NET activities 
...
### <a name="json-example-for-chaining-two-copy-activity-in-a-pipeline"></a>JSON example for chaining two copy activity in a pipeline
...
## <a name="create-and-monitor-pipelines"></a>Create and monitor pipelines
