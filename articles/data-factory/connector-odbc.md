...
---
# <a name="copy-data-from-and-to-odbc-data-stores-using-azure-data-factory"></a>Copy data from and to ODBC data stores using Azure Data Factory
...
### <a name="odbc-as-source"></a>ODBC as source
...
### <a name="odbc-as-sink"></a>ODBC as sink
...
## <a name="microsoft-access-source"></a>Microsoft Access source
...
## <a name="ge-historian-source"></a>GE Historian source
