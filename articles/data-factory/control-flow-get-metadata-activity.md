...
---
# <a name="get-metadata-activity-in-azure-data-factory"></a>Get metadata activity in Azure Data Factory
...
### <a name="supported-connectors"></a>Supported connectors
...
### <a name="metadata-options"></a>Metadata options
...
### <a name="get-a-files-metadata"></a>Get a file's metadata
...
### <a name="get-a-folders-metadata"></a>Get a folder's metadata
