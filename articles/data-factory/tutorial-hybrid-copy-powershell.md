...
---
# <a name="tutorial-copy-data-from-an-on-premises-sql-server-database-to-azure-blob-storage"></a>Tutorial: Copy data from an on-premises SQL Server database to Azure Blob storage
...
### <a name="azure-roles"></a>Azure roles
...
### <a name="sql-server-2014-2016-and-2017"></a>SQL Server 2014, 2016, and 2017
...
#### <a name="get-storage-account-name-and-account-key"></a>Get storage account name and account key
...
#### <a name="create-the-adftutorial-container"></a>Create the adftutorial container 
...
#### <a name="log-in-to-powershell"></a>Log in to PowerShell
...
## <a name="create-a-self-hosted-integration-runtime"></a>Create a self-hosted integration runtime
...
## <a name="install-the-integration-runtime"></a>Install the integration runtime
...
### <a name="create-an-azure-storage-linked-service-destinationsink"></a>Create an Azure Storage linked service (destination/sink)
...
### <a name="create-and-encrypt-a-sql-server-linked-service-source"></a>Create and encrypt a SQL Server linked service (source)
...
### <a name="create-a-dataset-for-the-source-sql-server-database"></a>Create a dataset for the source SQL Server database
...
### <a name="create-a-dataset-for-azure-blob-storage-sink"></a>Create a dataset for Azure Blob storage (sink)
...
## <a name="create-a-pipeline-run"></a>Create a pipeline run
