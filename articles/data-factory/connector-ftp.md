...
---
# <a name="copy-data-from-ftp-server-by-using-azure-data-factory"></a>Copy data from FTP server by using Azure Data Factory
...
### <a name="ftp-as-source"></a>FTP as source
