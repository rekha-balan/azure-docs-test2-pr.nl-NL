...
---
# <a name="move-data-from-odbc-data-stores-using-azure-data-factory"></a>Move data From ODBC data stores using Azure Data Factory
...
```
### <a name="using-basic-authentication-with-encrypted-credentials"></a>Using Basic authentication with encrypted credentials
...
## <a name="json-example-copy-data-from-odbc-data-store-to-azure-blob"></a>JSON example: Copy data from ODBC data store to Azure Blob
...
**ODBC linked service** This example uses the Basic authentication. See [ODBC linked service](#linked-service-properties) section for different types of authentication you can use.
...
```
### <a name="type-mapping-for-odbc"></a>Type mapping for ODBC
...
## <a name="repeatable-read-from-relational-sources"></a>Repeatable read from relational sources
...
## <a name="troubleshoot-connectivity-issues"></a>Troubleshoot connectivity issues
