...
---
# <a name="create-a-trigger-that-runs-a-pipeline-in-response-to-an-event"></a>Create a trigger that runs a pipeline in response to an event
...
### <a name="create-a-new-event-trigger"></a>Create a new event trigger
...
### <a name="configure-the-event-trigger"></a>Configure the event trigger
...
### <a name="select-the-event-trigger-type"></a>Select the event trigger type
...
### <a name="map-trigger-properties-to-pipeline-parameters"></a>Map trigger properties to pipeline parameters
...
## <a name="examples-of-event-based-triggers"></a>Examples of event-based triggers
