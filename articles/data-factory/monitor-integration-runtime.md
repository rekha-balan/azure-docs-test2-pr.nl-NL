...
---
# <a name="monitor-an-integration-runtime-in-azure-data-factory"></a>Monitor an integration runtime in Azure Data Factory  
...
#### <a name="concurrent-jobs-limit"></a>Concurrent jobs limit
...
### <a name="status-per-node"></a>Status (per node)
...
### <a name="status-overall-self-hosted-integration-runtime"></a>Status (overall self-hosted integration runtime)
...
### <a name="status-overall-azure-ssis-integration-runtime"></a>Status (overall Azure-SSIS integration runtime)
...
### <a name="monitor-the-azure-ssis-integration-runtime-in-the-azure-portal"></a>Monitor the Azure-SSIS integration runtime in the Azure portal
...
### <a name="monitor-the-azure-ssis-integration-runtime-with-powershell"></a>Monitor the Azure-SSIS integration runtime with PowerShell
...
### <a name="more-info-about-the-azure-ssis-integration-runtime"></a>More info about the Azure-SSIS integration runtime
