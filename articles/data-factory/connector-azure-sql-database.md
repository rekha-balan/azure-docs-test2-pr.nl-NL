...
---
# <a name="copy-data-to-or-from-azure-sql-database-by-using-azure-data-factory"></a>Copy data to or from Azure SQL Database by using Azure Data Factory
...
### <a name="azure-sql-database-as-the-source"></a>Azure SQL Database as the source
...
### <a name="azure-sql-database-as-the-sink"></a>Azure SQL Database as the sink
...
#### <a name="append-data-example"></a>Append data example
...
#### <a name="invoke-a-stored-procedure-during-copy-for-upsert-example"></a>Invoke a stored procedure during copy for upsert example
...
#### <a name="source-table"></a>Source table
...
#### <a name="destination-table"></a>Destination table
...
#### <a name="source-dataset-json-definition"></a>Source dataset JSON definition
...
#### <a name="destination-dataset-json-definition"></a>Destination dataset JSON definition
...
## <a name="data-type-mapping-for-azure-sql-database"></a>Data type mapping for Azure SQL Database
