...
---
# <a name="transform-data-by-running-a-python-activity-in-azure-databricks"></a>Transform data by running a Python activity in Azure Databricks
...
## <a name="databricks-python-activity-definition"></a>Databricks Python activity definition
...
## <a name="databricks-python-activity-properties"></a>Databricks Python activity properties
