...
---
# <a name="foreach-activity-in-azure-data-factory"></a>ForEach activity in Azure Data Factory
...
## <a name="iteration-expression-language"></a>Iteration expression language
...
## <a name="iterating-over-a-single-activity"></a>Iterating over a single activity
...
### <a name="blob-dataset-definition"></a>Blob dataset definition
...
### <a name="run-parameter-values"></a>Run parameter values
...
## <a name="iterate-over-multiple-activities"></a>Iterate over multiple activities
...
#### <a name="inner-pipeline-definition"></a>Inner pipeline definition
...
#### <a name="source-dataset-definition"></a>Source dataset definition
...
#### <a name="sink-dataset-definition"></a>Sink dataset definition
...
```
## <a name="aggregating-metric-output"></a>Aggregating metric output
