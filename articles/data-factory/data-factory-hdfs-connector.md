...
**HDFS linked service:** This example uses the Windows authentication. See [HDFS linked service](#linked-service) section for different types of authentication you can use.
