...
---
# <a name="tutorial-create-a-data-factory-pipeline-that-moves-data-by-using-azure-powershell"></a>Tutorial: Create a Data Factory pipeline that moves data by using Azure PowerShell
...
### <a name="create-a-linked-service-for-an-azure-storage-account"></a>Create a linked service for an Azure storage account
...
### <a name="create-a-linked-service-for-an-azure-sql-database"></a>Create a linked service for an Azure SQL database
...
### <a name="prepare-azure-blob-storage-and-azure-sql-database-for-the-tutorial"></a>Prepare Azure Blob storage and Azure SQL Database for the tutorial
...
### <a name="create-an-input-dataset"></a>Create an input dataset
