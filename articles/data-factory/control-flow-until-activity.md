...
---
# <a name="until-activity-in-azure-data-factory"></a>Until activity in Azure Data Factory
...
### <a name="pipeline-with-until-activity"></a>Pipeline with Until activity
...
### <a name="pipeline-with-until-activity-adfv2quickstartpipelinejson"></a>Pipeline with Until activity (Adfv2QuickStartPipeline.json)
...
### <a name="parameterized-azure-blob-dataset-blobdatasetjson"></a>Parameterized Azure Blob dataset (BlobDataset.json)
...
### <a name="powershell-commands"></a>PowerShell commands
