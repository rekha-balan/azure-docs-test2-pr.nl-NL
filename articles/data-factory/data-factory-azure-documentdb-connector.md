...
## <a name="example-copy-data-from-documentdb-to-azure-blob"></a>Example: Copy data from DocumentDB to Azure Blob
...
```
## <a name="example-copy-data-from-azure-blob-to-azure-documentdb"></a>Example: Copy data from Azure Blob to Azure DocumentDB
The sample below shows:
...
3. **Question:** Does Data Factory support [range or hash-based data partitioning](https://azure.microsoft.com/documentation/articles/documentdb-partition-data/)?
