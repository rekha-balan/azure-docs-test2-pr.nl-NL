...
---
# <a name="copy-data-from-azure-blob-to-azure-sql-database-using-azure-data-factory"></a>Copy data from Azure Blob to Azure SQL Database using Azure Data Factory
...
### <a name="create-a-blob-and-a-sql-table"></a>Create a blob and a SQL table

Now, prepare your Azure Blob and Azure SQL Database for the tutorial by performing the following steps:

#### <a name="create-a-source-blob"></a>Create a source blob
...
#### <a name="create-a-sink-sql-table"></a>Create a sink SQL table
...
### <a name="create-an-azure-sql-database-linked-service"></a>Create an Azure SQL Database linked service
...
### <a name="create-a-dataset-for-sink-azure-sql-database"></a>Create a dataset for sink Azure SQL Database
