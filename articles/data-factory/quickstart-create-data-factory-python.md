...
---
# <a name="create-a-data-factory-and-pipeline-using-python"></a>Create a data factory and pipeline using Python
...
### <a name="create-and-upload-an-input-file"></a>Create and upload an input file
...
## <a name="install-the-python-package"></a>Install the Python package
...
## <a name="create-a-linked-service"></a>Create a linked service
