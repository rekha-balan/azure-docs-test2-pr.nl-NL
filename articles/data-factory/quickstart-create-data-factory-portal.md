...
---
# <a name="create-a-data-factory-by-using-the-azure-data-factory-ui"></a>Create a data factory by using the Azure Data Factory UI
...
1. Switch to the **Connection** tab and complete the following steps: 
    ...
    !["Connection" tab and "Browse" button](./media/quickstart-create-data-factory-portal/file-path-browse-button.png) c. In the **Choose a file or folder** window, browse to the **input** folder in the **adftutorial** container, select the **emp.txt** file, and then select **Finish**.
