...
---
# <a name="copy-data-from-db2-by-using-azure-data-factory"></a>Copy data from DB2 by using Azure Data Factory
...
### <a name="db2-as-source"></a>DB2 as source
...
## <a name="data-type-mapping-for-db2"></a>Data type mapping for DB2
