...
---
# <a name="create-a-trigger-that-runs-a-pipeline-on-a-tumbling-window"></a>Create a trigger that runs a pipeline on a tumbling window
...
## <a name="tumbling-window-trigger-type-properties"></a>Tumbling window trigger type properties
...
### <a name="windowstart-and-windowend-system-variables"></a>WindowStart and WindowEnd system variables
...
### <a name="execution-order-of-windows-in-a-backfill-scenario"></a>Execution order of windows in a backfill scenario
...
### <a name="existing-triggerresource-elements"></a>Existing TriggerResource elements
...
## <a name="sample-for-azure-powershell"></a>Sample for Azure PowerShell
