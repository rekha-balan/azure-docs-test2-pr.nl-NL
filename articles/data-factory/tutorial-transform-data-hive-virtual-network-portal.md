...
### <a name="install-ir-on-a-virtual-machine"></a>Install IR on a virtual machine
...
### <a name="self-hosted-ir-in-the-azure-data-factory-ui"></a>Self-hosted IR in the Azure Data Factory UI
...
### <a name="create-hdinsight-linked-service"></a>Create HDInsight linked service
