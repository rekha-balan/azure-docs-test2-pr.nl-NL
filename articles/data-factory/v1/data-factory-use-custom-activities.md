...
## <a name="walkthrough-create-a-custom-activity"></a>Walkthrough: create a custom activity
...
### <a name="create-a-custom-activity"></a>Create a custom activity
...
## <a name="create-a-pipeline-with-custom-activity"></a>Create a pipeline with custom activity
...
## <a name="troubleshoot-failures"></a>Troubleshoot failures
...
## <a name="update-custom-activity"></a>Update custom activity
...
## <a name="auto-scaling-of-azure-batch"></a>Auto-scaling of Azure Batch
...
## <a name="create-a-custom-activity-by-using-net-sdk"></a>Create a custom activity by using .NET SDK
...
## <a name="debug-custom-activity-in-visual-studio"></a>Debug custom activity in Visual Studio
...
## <a name="sample-custom-activities-on-github"></a>Sample custom activities on GitHub
