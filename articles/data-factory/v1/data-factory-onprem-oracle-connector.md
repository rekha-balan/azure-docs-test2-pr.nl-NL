...
---
# <a name="copy-data-to-or-from-on-premises-oracle-using-azure-data-factory"></a>Copy data to or from on-premises Oracle using Azure Data Factory
...
## <a name="json-examples-for-copying-data-to-and-from-oracle-database"></a>JSON examples for copying data to and from Oracle database
...
## <a name="example-copy-data-from-oracle-to-azure-blob"></a>Example: Copy data from Oracle to Azure Blob
...
## <a name="example-copy-data-from-azure-blob-to-oracle"></a>Example: Copy data from Azure Blob to Oracle
...
### <a name="problem-2-datetime-formatting"></a>Problem 2: datetime formatting
