...
---
# <a name="move-data-from-mongodb-using-azure-data-factory"></a>Move data From MongoDB using Azure Data Factory
...
## <a name="json-example-copy-data-from-mongodb-to-azure-blob"></a>JSON example: Copy data from MongoDB to Azure Blob
...
**MongoDB input dataset:** Setting “external”: ”true” informs the Data Factory service that the table is external to the data factory and is not produced by an activity in the data factory.
...
## <a name="type-mapping-for-mongodb"></a>Type mapping for MongoDB
