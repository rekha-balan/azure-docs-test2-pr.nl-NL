...
---
# <a name="tutorial-use-rest-api-to-create-an-azure-data-factory-pipeline-to-copy-data"></a>Tutorial: Use REST API to create an Azure Data Factory pipeline to copy data 
