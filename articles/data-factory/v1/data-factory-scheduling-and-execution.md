...
## <a name="start-and-end-times-of-pipeline"></a>Start and end times of pipeline
...
## <a name="specify-schedule-for-an-activity"></a>Specify schedule for an activity
...
## <a name="specify-schedule-for-a-dataset"></a>Specify schedule for a dataset
...
## <a name="dataset-availability-and-policies"></a>Dataset availability and policies
...
### <a name="dataset-policy"></a>Dataset policy
...
## <a name="activity-policies"></a>Activity policies
...
### <a name="example-copy-sequentially"></a>Example: copy sequentially
