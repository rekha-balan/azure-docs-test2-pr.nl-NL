...
---
# <a name="move-data-to-and-from-azure-cosmos-db-using-azure-data-factory"></a>Move data to and from Azure Cosmos DB using Azure Data Factory
...
## <a name="importexport-json-documents"></a>Import/Export JSON documents
...
## <a name="example-copy-data-from-azure-cosmos-db-to-azure-blob"></a>Example: Copy data from Azure Cosmos DB to Azure Blob
...
```
## <a name="example-copy-data-from-azure-blob-to-azure-cosmos-db"></a>Example: Copy data from Azure Blob to Azure Cosmos DB 
The sample below shows:
...
3. **Question:** Does Data Factory support [range or hash-based data partitioning](../../cosmos-db/sql-api-partition-data.md)?
