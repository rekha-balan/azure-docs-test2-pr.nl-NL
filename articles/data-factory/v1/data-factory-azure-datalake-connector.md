...
---
# <a name="copy-data-to-and-from-data-lake-storage-gen1-by-using-data-factory"></a>Copy data to and from Data Lake Storage Gen1 by using Data Factory
...
## <a name="supported-authentication-types"></a>Supported authentication types
...
### <a name="service-principal-authentication-recommended"></a>Service principal authentication (recommended)
...
### <a name="user-credential-authentication"></a>User credential authentication
...
### <a name="the-partitionedby-property"></a>The partitionedBy property
...
## <a name="json-examples-for-copying-data-to-and-from-data-lake-store"></a>JSON examples for copying data to and from Data Lake Store
...
### <a name="example-copy-data-from-azure-blob-storage-to-azure-data-lake-store"></a>Example: Copy data from Azure Blob Storage to Azure Data Lake Store
...
### <a name="example-copy-data-from-azure-data-lake-store-to-an-azure-blob"></a>Example: Copy data from Azure Data Lake Store to an Azure blob
The example code in this section shows:
