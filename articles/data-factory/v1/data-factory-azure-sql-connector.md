...
---
# <a name="copy-data-to-and-from-azure-sql-database-using-azure-data-factory"></a>Copy data to and from Azure SQL Database using Azure Data Factory
...
## <a name="json-examples-for-copying-data-to-and-from-sql-database"></a>JSON examples for copying data to and from SQL Database
...
### <a name="example-copy-data-from-azure-sql-database-to-azure-blob"></a>Example: Copy data from Azure SQL Database to Azure Blob
...
### <a name="example-copy-data-from-azure-blob-to-azure-sql-database"></a>Example: Copy data from Azure Blob to Azure SQL Database
...
## <a name="type-mapping-for-azure-sql-database"></a>Type mapping for Azure SQL Database
