...
## <a name="use-unload-to-copy-data-from-amazon-redshift"></a>Use UNLOAD to copy data from Amazon Redshift
...
## <a name="json-example-copy-data-from-amazon-redshift-to-azure-blob-storage"></a>JSON example: Copy data from Amazon Redshift to Azure Blob storage
