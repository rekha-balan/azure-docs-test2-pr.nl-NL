...
---
# <a name="azure-data-factory---security-considerations-for-data-movement"></a>Azure Data Factory - Security considerations for data movement
...
## <a name="cloud-scenarios"></a>Cloud scenarios
### <a name="securing-data-store-credentials"></a>Securing data store credentials
...
### <a name="data-encryption-in-transit"></a>Data encryption in transit
...
### <a name="data-encryption-at-rest"></a>Data encryption at rest
...
#### <a name="azure-blob-storage-and-azure-table-storage"></a>Azure Blob Storage and Azure Table Storage
...
## <a name="hybrid-scenarios-using-data-management-gateway"></a>Hybrid Scenarios (using Data Management Gateway)
...
### <a name="on-premises-data-store-credentials"></a>On-premises data store credentials
...
#### <a name="javascript-cryptography-library-based-encryption"></a>JavaScript cryptography library-based encryption
...
#### <a name="click-once-credentials-manager-app"></a>Click-once credentials manager app
...
### <a name="firewall-configurations-and-whitelisting-ip-address-of-gateway"></a>Firewall configurations and whitelisting IP address of gateway

#### <a name="firewall-requirements-for-on-premisesprivate-network"></a>Firewall requirements for on-premises/private network  
...
#### <a name="ip-configurations-whitelisting-in-data-store"></a>IP configurations/ whitelisting in data store
