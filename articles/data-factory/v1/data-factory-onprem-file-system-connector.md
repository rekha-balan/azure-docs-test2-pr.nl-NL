...
---
# <a name="copy-data-to-and-from-an-on-premises-file-system-by-using-azure-data-factory"></a>Copy data to and from an on-premises file system by using Azure Data Factory
...
### <a name="sample-linked-service-and-dataset-definitions"></a>Sample linked service and dataset definitions
...
## <a name="json-examples-for-copying-data-to-and-from-file-system"></a>JSON examples for copying data to and from file system
...
### <a name="example-copy-data-from-an-on-premises-file-system-to-azure-blob-storage"></a>Example: Copy data from an on-premises file system to Azure Blob storage
...
### <a name="example-copy-data-from-azure-sql-database-to-an-on-premises-file-system"></a>Example: Copy data from Azure SQL Database to an on-premises file system
