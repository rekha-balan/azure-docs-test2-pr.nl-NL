...
---
# <a name="invoke-an-ssis-package-using-stored-procedure-activity-in-azure-data-factory"></a>Invoke an SSIS package using stored procedure activity in Azure Data Factory
...
### <a name="create-a-dummy-dataset-for-output"></a>Create a dummy dataset for output
