...
---
# <a name="move-data-from-db2-by-using-azure-data-factory-copy-activity"></a>Move data from DB2 by using Azure Data Factory Copy Activity
...
## <a name="json-example-copy-data-from-db2-to-azure-blob-storage"></a>JSON example: Copy data from DB2 to Azure Blob storage
...
## <a name="repeatable-reads-from-relational-sources"></a>Repeatable reads from relational sources
