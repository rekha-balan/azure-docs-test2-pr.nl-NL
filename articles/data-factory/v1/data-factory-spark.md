...
---
# <a name="invoke-spark-programs-from-azure-data-factory-pipelines"></a>Invoke Spark programs from Azure Data Factory pipelines
...
## <a name="walkthrough-create-a-pipeline-with-a-spark-activity"></a>Walkthrough: Create a pipeline with a Spark activity
...
#### <a name="create-an-hdinsight-linked-service"></a>Create an HDInsight linked service
...
### <a name="monitor-a-pipeline"></a>Monitor a pipeline
...
<!-- Removed bookmark #run-a-hive-query-using-spark-sql since it doesn't exist in the target article --> For detailed instructions, see the section [Run a Spark SQL query](../../hdinsight/spark/apache-spark-jupyter-spark-sql.md). 
