...
## <a name="json-example-copy-data-from-on-premises-hdfs-to-azure-blob"></a>JSON example: Copy data from on-premises HDFS to Azure Blob
...
**HDFS linked service:** This example uses the Windows authentication. See [HDFS linked service](#linked-service-properties) section for different types of authentication you can use.
...
## <a name="use-kerberos-authentication-for-hdfs-connector"></a>Use Kerberos authentication for HDFS connector
