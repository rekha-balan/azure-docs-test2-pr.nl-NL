...
---
# <a name="move-data-from-an-http-source-using-azure-data-factory"></a>Move data from an HTTP source using Azure Data Factory
...
### <a name="using-basic-digest-or-windows-authentication"></a>Using Basic, Digest, or Windows authentication
...
### <a name="using-clientcertificate-authentication"></a>Using ClientCertificate authentication
...
#### <a name="example-using-client-certificate"></a>Example: using client certificate
...
### <a name="example-copy-data-from-http-source-to-azure-blob-storage"></a>Example: Copy data from HTTP source to Azure Blob Storage
...
### <a name="http-linked-service"></a>HTTP linked service
...
### <a name="http-input-dataset"></a>HTTP input dataset
...
### <a name="pipeline-with-copy-activity"></a>Pipeline with Copy activity
