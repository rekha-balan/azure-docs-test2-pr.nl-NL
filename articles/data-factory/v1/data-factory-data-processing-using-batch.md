...
---
# <a name="process-large-scale-datasets-by-using-data-factory-and-batch"></a>Process large-scale datasets by using Data Factory and Batch
> [!NOTE]
...
## <a name="architecture-of-a-sample-solution"></a>Architecture of a sample solution
...
## <a name="implementation-of-the-sample-solution"></a>Implementation of the sample solution
...
#### <a name="azure-batch-pool-of-virtual-machines"></a>Azure Batch pool of virtual machines
...
#### <a name="create-an-azure-storage-linked-service"></a>Create an Azure Storage linked service
...
#### <a name="create-an-azure-batch-linked-service"></a>Create an Azure Batch linked service
...
1. In the JSON script:
   ...
   d. Enter the batch URI for the **batchUri** JSON property.
      ...
      > [!IMPORTANT]
      > The URL from the **Batch Account** blade is in the following format: \<accountname\>.\<region\>.batch.azure.com. For the **batchUri** property in the JSON script, you need to remove a88"accountname."** from the URL. An example is `"batchUri": "https://eastus.batch.azure.com"`.
      >
      >
...
#### <a name="create-the-input-dataset"></a>Create the input dataset
...
#### <a name="create-the-output-dataset"></a>Create the output dataset
...
#### <a name="step-4-create-and-run-the-pipeline-with-a-custom-activity"></a>Step 4: Create and run the pipeline with a custom activity
