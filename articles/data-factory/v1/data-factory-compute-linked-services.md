...
### <a name="after-the-retirement-date"></a>After the retirement date 
...
### <a name="recommended-actions"></a>Recommended actions 
...
#### <a name="specify-node-sizes"></a>Specify node sizes
