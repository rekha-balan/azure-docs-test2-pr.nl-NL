...
## <a name="json-examples-for-copying-data-from-and-to-sql-server"></a>JSON examples for copying data from and to SQL Server
...
## <a name="type-mapping-for-sql-server"></a>Type mapping for SQL server
