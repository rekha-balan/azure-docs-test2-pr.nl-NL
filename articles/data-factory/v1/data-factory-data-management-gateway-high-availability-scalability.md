...
---
# <a name="data-management-gateway---high-availability-and-scalability-preview"></a>Data Management Gateway - high availability and scalability (Preview)
> [!NOTE]
...
## <a name="set-up-a-multi-node-gateway"></a>Set up a multi-node gateway
...
## <a name="upgrade-an-existing-gateway"></a>Upgrade an existing gateway
...
#### <a name="faq-when-would-i-not-enable-this-encryption"></a>FAQ: When would I not enable this encryption?
...
## <a name="monitor-a-multi-node-gateway"></a>Monitor a multi-node gateway
### <a name="multi-node-gateway-monitoring"></a>Multi-node gateway monitoring
...
### <a name="pipeline-activities-monitoring"></a>Pipeline/ activities monitoring
...
## <a name="known-issuesbreaking-changes"></a>Known issues/breaking changes
...
## <a name="rolling-back-from-the-preview"></a>Rolling back from the preview 
