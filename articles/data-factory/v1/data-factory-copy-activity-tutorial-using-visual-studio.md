...
## <a name="view-all-data-factories-in-server-explorer"></a>View all data factories in Server Explorer
...
## <a name="create-a-visual-studio-project-for-an-existing-data-factory"></a>Create a Visual Studio project for an existing data factory
