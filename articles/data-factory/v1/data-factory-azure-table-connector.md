...
## <a name="example-copy-data-from-azure-table-to-azure-blob"></a>Example: Copy data from Azure Table to Azure Blob
...
## <a name="example-copy-data-from-azure-blob-to-azure-table"></a>Example: Copy data from Azure Blob to Azure Table
The following sample shows:
