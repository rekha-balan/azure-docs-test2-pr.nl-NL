...
---
# <a name="tutorial-use-azure-resource-manager-template-to-create-a-data-factory-pipeline-to-copy-data"></a>Tutorial: Use Azure Resource Manager template to create a Data Factory pipeline to copy data 
