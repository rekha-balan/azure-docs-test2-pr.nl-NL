...
---
# <a name="azure-data-factory-service-identity"></a>Azure Data Factory service identity
...
## <a name="generate-service-identity"></a>Generate service identity
...
### <a name="generate-service-identity-using-powershell"></a>Generate service identity using PowerShell
...
### <a name="generate-service-identity-using-rest-api"></a>Generate service identity using REST API
...
### <a name="generate-service-identity-using-sdk"></a>Generate service identity using SDK
...
## <a name="retrieve-service-identity"></a>Retrieve service identity
...
### <a name="retrieve-service-identity-using-azure-portal"></a>Retrieve service identity using Azure portal
...
### <a name="retrieve-service-identity-using-powershell"></a>Retrieve service identity using PowerShell
