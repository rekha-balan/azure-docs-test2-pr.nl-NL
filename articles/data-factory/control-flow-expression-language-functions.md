...
---
# <a name="expressions-and-functions-in-azure-data-factory"></a>Expressions and functions in Azure Data Factory
...
#### <a name="a-dataset-with-a-parameter"></a>A dataset with a parameter
...
#### <a name="a-pipeline-with-a-parameter"></a>A pipeline with a parameter
