...
---
# <a name="incrementally-load-data-from-an-azure-sql-database-to-azure-blob-storage"></a>Incrementally load data from an Azure SQL database to Azure Blob storage
...
### <a name="create-a-data-source-table-in-your-sql-database"></a>Create a data source table in your SQL database
...
### <a name="create-another-table-in-your-sql-database-to-store-the-high-watermark-value"></a>Create another table in your SQL database to store the high watermark value
...
### <a name="create-a-stored-procedure-in-your-sql-database"></a>Create a stored procedure in your SQL database 
...
### <a name="create-a-storage-linked-service"></a>Create a Storage linked service
...
### <a name="create-a-sql-database-linked-service"></a>Create a SQL Database linked service
...
### <a name="insert-data-into-the-data-source-store-to-verify-delta-data-loading"></a>Insert data into the data source store to verify delta data loading
