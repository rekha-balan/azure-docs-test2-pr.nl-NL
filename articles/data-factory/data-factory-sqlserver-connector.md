...
---
# <a name="move-data-to-and-from-sql-server-on-premises-or-on-iaas-azure-vm-using-azure-data-factory"></a>Move data to and from SQL Server on-premises or on IaaS (Azure VM) using Azure Data Factory
...
## <a name="example-copy-data-from-sql-server-to-azure-blob"></a>Example: Copy data from SQL Server to Azure Blob
...
## <a name="example-copy-data-from-azure-blob-to-sql-server"></a>Example: Copy data from Azure Blob to SQL Server
The following sample shows:
...
## <a name="troubleshooting-connection-issues"></a>Troubleshooting connection issues
...
## <a name="map-source-to-sink-columns"></a>Map source to sink columns
...
## <a name="repeatable-copy"></a>Repeatable copy
...
## <a name="invoke-stored-procedure-from-sql-sink"></a>Invoke stored procedure from SQL sink
...
## <a name="type-mapping-for-sql-server--azure-sql"></a>Type mapping for SQL server & Azure SQL
...
## <a name="mapping-source-to-sink-columns"></a>Mapping source to sink columns
