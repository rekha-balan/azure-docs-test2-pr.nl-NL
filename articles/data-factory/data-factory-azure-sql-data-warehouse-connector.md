...
---
# <a name="move-data-to-and-from-azure-sql-data-warehouse-using-azure-data-factory"></a>Move data to and from Azure SQL Data Warehouse using Azure Data Factory
...
You can copy data from any supported source data store to Azure SQL Data Warehouse or from Azure SQL Warehouse to any supported sink data store. For a list of data stores supported as sources or sinks by the copy activity, see the [Supported data stores](data-factory-data-movement-activities.md#supported-data-stores-and-formats) table.
...
## <a name="supported-authentication-type"></a>Supported authentication type
...
### <a name="direct-copy-using-polybase"></a>Direct copy using PolyBase
...
### <a name="staged-copy-using-polybase"></a>Staged Copy using PolyBase
...
## <a name="best-practices-when-using-polybase"></a>Best practices when using PolyBase
Below is supplementary to the generic [Best practices for Azure SQL Data Warehouse](../sql-data-warehouse/sql-data-warehouse-best-practices.md).
...
### <a name="row-size-and-data-type-limitation"></a>Row size and data type limitation
...
## <a name="auto-table-creation"></a>Auto table creation
...
### <a name="type-mapping-for-azure-sql-data-warehouse"></a>Type mapping for Azure SQL Data Warehouse
...
## <a name="json-examples"></a>JSON examples
...
## <a name="example-copy-data-from-azure-sql-data-warehouse-to-azure-blob"></a>Example: Copy data from Azure SQL Data Warehouse to Azure Blob
...
## <a name="example-copy-data-from-azure-blob-to-azure-sql-data-warehouse"></a>Example: Copy data from Azure Blob to Azure SQL Data Warehouse
The sample defines the following Data Factory entities:
