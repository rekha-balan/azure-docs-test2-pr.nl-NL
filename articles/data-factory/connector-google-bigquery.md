...
---
# <a name="copy-data-from-google-bigquery-by-using-azure-data-factory"></a>Copy data from Google BigQuery by using Azure Data Factory
...
### <a name="using-user-authentication"></a>Using user authentication
...
### <a name="using-service-authentication"></a>Using service authentication
...
### <a name="googlebigquerysource-as-a-source-type"></a>GoogleBigQuerySource as a source type
