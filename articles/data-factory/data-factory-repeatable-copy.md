...
---
# <a name="repeatable-copy-in-azure-data-factory"></a>Repeatable copy in Azure Data Factory
...
## <a name="repeatable-write-to-sqlsink"></a>Repeatable write to SqlSink
...
### <a name="mechanism-1-using-sqlwritercleanupscript"></a>Mechanism 1: using sqlWriterCleanupScript
...
### <a name="mechanism-2-using-sliceidentifiercolumnname"></a>Mechanism 2: using sliceIdentifierColumnName
> [!IMPORTANT]
