...
---
#  <a name="copy-data-to-or-from-azure-sql-data-warehouse-by-using-azure-data-factory"></a>Copy data to or from Azure SQL Data Warehouse by using Azure Data Factory 
...
#### <a name="linked-service-example-that-uses-sql-authentication"></a>Linked service example that uses SQL authentication
...
#### <a name="linked-service-example-that-uses-service-principal-authentication"></a>Linked service example that uses service principal authentication
...
### <a name="managed-service-identity-authentication"></a>Managed Service Identity authentication
...
#### <a name="linked-service-example-that-uses-msi-authentication"></a>Linked service example that uses MSI authentication
...
#### <a name="dataset-properties-example"></a>Dataset properties example
...
### <a name="azure-sql-data-warehouse-as-the-source"></a>Azure SQL Data Warehouse as the source
...
### <a name="points-to-note"></a>Points to note
...
#### <a name="sql-query-example"></a>SQL query example
...
#### <a name="sql-data-warehouse-sink-example"></a>SQL Data Warehouse sink example
...
### <a name="direct-copy-by-using-polybase"></a>Direct copy by using PolyBase
...
### <a name="staged-copy-by-using-polybase"></a>Staged copy by using PolyBase
...
## <a name="best-practices-for-using-polybase"></a>Best practices for using PolyBase
...
### <a name="required-database-permission"></a>Required database permission
...
### <a name="row-size-and-data-type-limits"></a>Row size and data type limits
...
### <a name="sql-data-warehouse-resource-class"></a>SQL Data Warehouse resource class
...
### <a name="columns-with-default-values"></a>Columns with default values
...
## <a name="data-type-mapping-for-azure-sql-data-warehouse"></a>Data type mapping for Azure SQL Data Warehouse
