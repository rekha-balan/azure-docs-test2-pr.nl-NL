...
---
# <a name="lookup-activity-in-azure-data-factory"></a>Lookup activity in Azure Data Factory
...
## <a name="use-the-lookup-activity-result-in-a-subsequent-activity"></a>Use the Lookup activity result in a subsequent activity
...
### <a name="copy-activity-example"></a>Copy Activity example
...
### <a name="lookup-dataset"></a>Lookup dataset
...
### <a name="source-dataset-for-copy-activity"></a>**Source** dataset for Copy Activity
...
### <a name="sink-dataset-for-copy-activity"></a>**Sink** dataset for Copy Activity
...
#### <a name="set-of-objects"></a>Set of objects
...
#### <a name="array-of-objects"></a>Array of objects
