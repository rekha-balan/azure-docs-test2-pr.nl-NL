...
---
# <a name="copy-data-from-couchbase-using-azure-data-factory"></a>Copy data from Couchbase using Azure Data Factory
...
### <a name="couchbasesource-as-source"></a>CouchbaseSource as source
