...
## <a name="azure-databricks-linked-service"></a>Azure Databricks linked service
...
### <a name="example---using-new-job-cluster-in-databricks"></a>Example - Using new job cluster in Databricks
...
### <a name="example---using-existing-interactive-cluster-in-databricks"></a>Example - Using existing Interactive cluster in Databricks
