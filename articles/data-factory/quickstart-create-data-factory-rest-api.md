...
---
# <a name="create-an-azure-data-factory-and-pipeline-by-using-the-rest-api"></a>Create an Azure data factory and pipeline by using the REST API
...
## <a name="authenticate-with-azure-ad"></a>Authenticate with Azure AD
...
## <a name="create-pipeline-run"></a>Create pipeline run
