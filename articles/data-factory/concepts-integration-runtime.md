...
## <a name="integration-runtime-types"></a>Integration runtime types
...
### <a name="azure-ir-network-environment"></a>Azure IR network environment
...
### <a name="azure-ir-compute-resource-and-scaling"></a>Azure IR compute resource and scaling
...
## <a name="self-hosted-integration-runtime"></a>Self-hosted integration runtime
...
### <a name="self-hosted-ir-network-environment"></a>Self-hosted IR network environment
...
### <a name="self-hosted-ir-compute-resource-and-scaling"></a>Self-hosted IR compute resource and scaling
...
### <a name="azure-ssis-ir-network-environment"></a>Azure-SSIS IR network environment
...
### <a name="azure-ssis-ir-compute-resource-and-scaling"></a>Azure-SSIS IR compute resource and scaling
...
## <a name="integration-runtime-location"></a>Integration runtime location
...
### <a name="azure-ir-location"></a>Azure IR location
...
### <a name="self-hosted-ir-location"></a>Self-hosted IR location
...
### <a name="azure-ssis-ir-location"></a>Azure-SSIS IR location
...
## <a name="determining-which-ir-to-use"></a>Determining which IR to use

### <a name="copy-activity"></a>Copy activity
...
### <a name="lookup-and-getmetadata-activity"></a>Lookup and GetMetadata activity

The Lookup and GetMetadata activity is executed on the integration runtime associated to the data store linked service.

### <a name="transformation-activity"></a>Transformation activity
