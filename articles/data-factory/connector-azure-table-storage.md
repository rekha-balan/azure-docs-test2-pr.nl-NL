...
---
# <a name="copy-data-to-and-from-azure-table-storage-by-using-azure-data-factory"></a>Copy data to and from Azure Table storage by using Azure Data Factory
...
### <a name="use-an-account-key"></a>Use an account key
...
### <a name="use-shared-access-signature-authentication"></a>Use shared access signature authentication
...
### <a name="azure-table-as-a-source-type"></a>Azure Table as a source type
...
### <a name="azure-table-as-a-sink-type"></a>Azure Table as a sink type
...
## <a name="data-type-mapping-for-azure-table"></a>Data type mapping for Azure Table
