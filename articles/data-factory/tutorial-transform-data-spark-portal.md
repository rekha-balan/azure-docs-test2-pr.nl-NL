...
---
# <a name="transform-data-in-the-cloud-by-using-a-spark-activity-in-azure-data-factory"></a>Transform data in the cloud by using a Spark activity in Azure Data Factory
...
### <a name="upload-the-python-script-to-your-blob-storage-account"></a>Upload the Python script to your Blob storage account
...
### <a name="create-an-on-demand-hdinsight-linked-service"></a>Create an on-demand HDInsight linked service
