...
---
# <a name="create-predictive-pipelines-using-azure-machine-learning-and-azure-data-factory"></a>Create predictive pipelines using Azure Machine Learning and Azure Data Factory
...
### <a name="data-factory-and-machine-learning-together"></a>Data Factory and Machine Learning together
...
## <a name="azure-machine-learning-batch-execution-activity"></a>Azure Machine Learning Batch Execution activity
...
### <a name="scenario-1-experiments-using-web-service-inputsoutputs-that-refer-to-data-in-azure-blob-storage"></a>Scenario 1: Experiments using Web service inputs/outputs that refer to data in Azure Blob Storage
...
```
### <a name="scenario-2-experiments-using-readerwriter-modules-to-refer-to-data-in-various-storages"></a>Scenario 2: Experiments using Reader/Writer Modules to refer to data in various storages
