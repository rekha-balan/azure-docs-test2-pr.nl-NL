...
## <a name="example-copy-data-from-blob-storage-to-sql-database"></a>Example: Copy data from Blob Storage to SQL Database
...
```
## <a name="example-copy-data-from-azure-sql-to-azure-blob"></a>Example: Copy data from Azure SQL to Azure Blob
The following sample shows:
