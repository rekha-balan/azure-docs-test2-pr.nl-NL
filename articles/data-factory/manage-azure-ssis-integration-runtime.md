...
---
# <a name="reconfigure-the-azure-ssis-integration-runtime"></a>Reconfigure the Azure-SSIS integration runtime
...
### <a name="to-reconfigure-an-azure-ssis-ir"></a>To reconfigure an Azure-SSIS IR
...
### <a name="reconfigure-an-azure-ssis-ir"></a>Reconfigure an Azure-SSIS IR
...
### <a name="delete-an-azure-ssis-ir"></a>Delete an Azure-SSIS IR
