...
---
# <a name="copy-data-from-mysql-using-azure-data-factory"></a>Copy data from MySQL using Azure Data Factory
...
### <a name="mysql-as-source"></a>MySQL as source
...
## <a name="data-type-mapping-for-mysql"></a>Data type mapping for MySQL
