...
---
# <a name="copy-data-from-marketo-using-azure-data-factory"></a>Copy data from Marketo using Azure Data Factory
...
### <a name="marketosource-as-source"></a>MarketoSource as source
