...
---
# <a name="copy-data-from-an-on-premises-sql-server-database-to-azure-blob-storage-by-using-the-copy-data-tool"></a>Copy data from an on-premises SQL Server database to Azure Blob storage by using the Copy Data tool
...
#### <a name="get-the-storage-account-name-and-account-key"></a>Get the storage account name and account key
...
## <a name="use-the-copy-data-tool-to-create-a-pipeline"></a>Use the Copy Data tool to create a pipeline
