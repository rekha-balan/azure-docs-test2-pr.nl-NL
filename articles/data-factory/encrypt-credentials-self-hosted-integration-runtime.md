...
---
# <a name="encrypt-credentials-for-on-premises-data-stores-in-azure-data-factory"></a>Encrypt credentials for on-premises data stores in Azure Data Factory
...
## <a name="author-sql-server-linked-service"></a>Author SQL Server linked service
...
## <a name="encrypt-credentials"></a>Encrypt credentials
...
## <a name="use-the-json-with-encrypted-credentials"></a>Use the JSON with encrypted credentials
