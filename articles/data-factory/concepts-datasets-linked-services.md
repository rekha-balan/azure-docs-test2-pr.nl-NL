...
---
# <a name="datasets-and-linked-services-in-azure-data-factory"></a>Datasets and linked services in Azure Data Factory 
...
## <a name="linked-service-json"></a>Linked service JSON
...
## <a name="linked-service-example"></a>Linked service example
...
## <a name="dataset-type"></a>Dataset type
...
## <a name="current-version-vs-version-1-datasets"></a>Current version vs. version 1 datasets
