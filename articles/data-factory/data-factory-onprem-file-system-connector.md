...
---
# <a name="move-data-to-and-from-an-on-premises-file-system-by-using-azure-data-factory"></a>Move data to and from an on-premises file system by using Azure Data Factory
