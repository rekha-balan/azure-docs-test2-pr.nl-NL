...
---
# <a name="copy-data-tool-in-azure-data-factory"></a>Copy Data tool in Azure Data Factory
...
## <a name="intuitive-flow-for-loading-data-into-a-data-lake"></a>Intuitive flow for loading data into a data lake
...
## <a name="schema-capture-and-automatic-mapping"></a>Schema capture and automatic mapping
...
## <a name="filter-data"></a>Filter data
...
### <a name="filter-data-in-a-database"></a>Filter data in a database
...
### <a name="filter-data-in-an-azure-blob-folder"></a>Filter data in an Azure blob folder
