...
---
# <a name="copy-data-from-square-using-azure-data-factory"></a>Copy data from Square using Azure Data Factory
...
### <a name="squaresource-as-source"></a>SquareSource as source
