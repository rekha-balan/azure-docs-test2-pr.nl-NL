...
---
# <a name="copy-data-to-or-from-azure-data-lake-storage-gen1-by-using-azure-data-factory"></a>Copy data to or from Azure Data Lake Storage Gen1 by using Azure Data Factory
...
### <a name="using-service-principal-authentication"></a>Using service principal authentication
...
### <a name="using-managed-service-identity-authentication"></a>Using managed service identity authentication
...
### <a name="azure-data-lake-store-as-source"></a>Azure Data Lake Store as source
...
### <a name="azure-data-lake-store-as-sink"></a>Azure Data Lake Store as sink
