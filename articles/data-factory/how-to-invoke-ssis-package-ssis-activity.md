...
---
# <a name="run-an-ssis-package-with-the-execute-ssis-package-activity-in-azure-data-factory"></a>Run an SSIS package with the Execute SSIS Package Activity in Azure Data Factory
...
## <a name="create-an-azure-ssis-integration-runtime"></a>Create an Azure-SSIS integration runtime
...
## <a name="run-a-package-in-the-azure-portal"></a>Run a package in the Azure portal
...
### <a name="create-a-pipeline-with-an-execute-ssis-package-activity"></a>Create a pipeline with an Execute SSIS Package activity
...
### <a name="optionally-parameterize-the-activity"></a>Optionally, parameterize the activity
...
### <a name="schedule-the-pipeline-with-a-trigger"></a>Schedule the pipeline with a trigger
...
## <a name="run-a-package-with-powershell"></a>Run a package with PowerShell
