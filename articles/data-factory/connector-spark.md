...
---
# <a name="copy-data-from-spark-using-azure-data-factory"></a>Copy data from Spark using Azure Data Factory 
...
### <a name="sparksource-as-source"></a>SparkSource as source
