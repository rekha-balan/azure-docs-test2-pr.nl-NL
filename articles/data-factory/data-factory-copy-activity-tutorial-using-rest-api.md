...
---
# <a name="tutorial-create-a-pipeline-with-copy-activity-using-rest-api"></a>Tutorial: Create a pipeline with Copy Activity using REST API
...
### <a name="create-azure-sql-linked-service"></a>Create Azure SQL linked service
