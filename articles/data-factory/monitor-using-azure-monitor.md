...
---
# <a name="alert-and-monitor-data-factories-using-azure-monitor"></a>Alert and Monitor data factories using Azure Monitor
...
## <a name="persist-data-factory-data"></a>Persist Data Factory Data
...
## <a name="set-up-diagnostic-logs"></a>Set up diagnostic logs
...
### <a name="enable-diagnostic-logs-via-rest-apis"></a>Enable diagnostic logs via REST APIs
...
## <a name="schema-of-logs--events"></a>Schema of Logs & Events

### <a name="activity-run-logs-attributes"></a>Activity Run Logs Attributes
...
### <a name="pipeline-run-logs-attributes"></a>Pipeline Run Logs Attributes
...
### <a name="trigger-run-logs-attributes"></a>Trigger Run Logs Attributes
...
### <a name="configure-diagnostic-settings-and-workspace"></a>Configure Diagnostic Settings and Workspace
...
### <a name="install-azure-data-factory-analytics-from-azure-marketplace"></a>Install Azure Data Factory Analytics from Azure Marketplace
...
### <a name="monitor-data-factory-metrics"></a>Monitor Data Factory Metrics
...
You can raise alerts on supported metrics in Data Factory. Click the **Alerts** button on the Data Factory **Monitor** page.
...
You can also log in to the Azure portal and click **Monitor -&gt; Alerts** to reach the **Alerts** page directly.
