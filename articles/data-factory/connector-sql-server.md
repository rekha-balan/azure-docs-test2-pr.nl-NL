...
---
# <a name="copy-data-to-and-from-sql-server-using-azure-data-factory"></a>Copy data to and from SQL Server using Azure Data Factory
...
### <a name="sql-server-as-source"></a>SQL Server as source
...
## <a name="data-type-mapping-for-sql-server"></a>Data type mapping for SQL server
