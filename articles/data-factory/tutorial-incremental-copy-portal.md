...
## <a name="add-more-data-to-source"></a>Add more data to source
...
## <a name="trigger-another-pipeline-run"></a>Trigger another pipeline run
...
## <a name="monitor-the-second-pipeline-run"></a>Monitor the second pipeline run
...
## <a name="verify-the-second-output"></a>Verify the second output
