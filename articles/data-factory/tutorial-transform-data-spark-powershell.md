...
---
# <a name="transform-data-in-the-cloud-by-using-spark-activity-in-azure-data-factory"></a>Transform data in the cloud by using Spark activity in Azure Data Factory
...
### <a name="upload-python-script-to-your-blob-storage-account"></a>Upload python script to your Blob Storage account
...
### <a name="on-demand-hdinsight-linked-service"></a>On-demand HDInsight linked service
...
## <a name="start-and-monitor-a-pipeline-run"></a>Start and monitor a pipeline run  
