...
---
#  <a name="security-considerations-for-data-movement-in-azure-data-factory"></a>Security considerations for data movement in Azure Data Factory
...
## <a name="hybrid-scenarios"></a>Hybrid scenarios
...
#### <a name="ports-used-when-encrypting-linked-service-on-self-hosted-integration-runtime"></a>Ports used when encrypting linked service on self-hosted integration runtime
...
#### <a name="ip-configurations-and-whitelisting-in-data-stores"></a>IP configurations and whitelisting in data stores
