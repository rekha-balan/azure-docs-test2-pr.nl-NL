...
---
# <a name="copy-data-to-or-from-azure-cosmos-db-using-azure-data-factory"></a>Copy data to or from Azure Cosmos DB using Azure Data Factory
...
### <a name="azure-cosmos-db-as-source"></a>Azure Cosmos DB as source
...
### <a name="azure-cosmos-db-as-sink"></a>Azure Cosmos DB as sink
