...
### <a name="create-data-types-and-additional-stored-procedures-in-the-azure-sql-database"></a>Create data types and additional stored procedures in the Azure SQL database
...
### <a name="create-the-sql-database-linked-service"></a>Create the SQL database linked service
