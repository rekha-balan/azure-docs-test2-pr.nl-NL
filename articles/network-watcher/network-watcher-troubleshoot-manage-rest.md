...
---
# <a name="troubleshoot-virtual-network-gateway-and-connections-using-azure-network-watcher"></a>Troubleshoot Virtual Network gateway and Connections using Azure Network Watcher
...
## <a name="troubleshoot-a-virtual-network-gateway"></a>Troubleshoot a Virtual Network gateway


### <a name="post-the-troubleshoot-request"></a>POST the troubleshoot request
...
### <a name="query-the-async-operation-for-completion"></a>Query the async operation for completion
...
## <a name="troubleshoot-connections"></a>Troubleshoot Connections
