...
---
# <a name="introduction-to-connection-troubleshoot-in-azure-network-watcher"></a>Introduction to connection troubleshoot in Azure Network Watcher
...
```
## <a name="fault-types"></a>Fault types
