...
---
# <a name="troubleshoot-virtual-network-gateway-and-connections-using-azure-network-watcher-powershell"></a>Troubleshoot Virtual Network Gateway and Connections using Azure Network Watcher PowerShell
...
## <a name="retrieve-a-virtual-network-gateway-connection"></a>Retrieve a Virtual Network Gateway Connection
...
## <a name="run-network-watcher-resource-troubleshooting"></a>Run Network Watcher resource troubleshooting
