...
## <a name="why-traffic-analytics"></a>Why traffic analytics?
...
## <a name="how-traffic-analytics-works"></a>How traffic analytics works
...
### <a name="re-register-the-network-resource-provider"></a>Re-register the network resource provider
...
### <a name="select-a-network-security-group"></a>Select a network security group
...
## <a name="enable-flow-log-settings"></a>Enable flow log settings
...
## <a name="view-traffic-analytics"></a>View traffic analytics
...
### <a name="find-traffic-hotspots"></a>Find traffic hotspots
...
### <a name="visualize-traffic-distribution-by-geography"></a>Visualize traffic distribution by geography
...
### <a name="visualize-traffic-distribution-by-virtual-networks"></a>Visualize traffic distribution by virtual networks
...
### <a name="view-ports-and-virtual-machines-receiving-traffic-from-the-internet"></a>View ports and virtual machines receiving traffic from the internet
...
### <a name="visualize-the-trends-in-nsgnsg-rules-hits"></a>Visualize the trends in NSG/NSG rules hits
