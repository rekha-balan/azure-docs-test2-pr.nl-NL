...
---
# <a name="traffic-analytics-frequently-asked-questions"></a>Traffic analytics frequently asked questions
...
## <a name="what-are-the-prerequisites-to-use-traffic-analytics"></a>What are the prerequisites to use traffic analytics?
...
3. To list all the roles that are assigned to a specified user, use  **Get-AzureRmRoleAssignment -SignInName [user email] -IncludeClassicAdministrators**. 
...
## <a name="in-which-azure-regions-are-traffic-analytics-available"></a>In which Azure regions are traffic analytics available?
...
## <a name="can-the-nsgs-i-enable-flow-logs-for-be-in-different-regions-than-my-workspace"></a>Can the NSGs I enable flow logs for be in different regions than my workspace?

Yes, these NSGs can be in different regions than your Log Analytics workspace.

## <a name="can-multiple-nsgs-be-configured-within-a-single-workspace"></a>Can multiple NSGs be configured within a single workspace?

Yes.

## <a name="can-i-use-an-existing-workspace"></a>Can I use an existing workspace?
...
## <a name="can-my-azure-storage-account-be-in-one-subscription-and-my-operations-management-suite-workspace-be-in-a-different-subscription"></a>Can my Azure Storage Account be in one subscription and my Operations Management Suite workspace be in a different subscription?
...
## <a name="can-i-store-raw-logs-in-a-different-subscription"></a>Can I store raw logs in a different subscription?
...
## <a name="what-if-i-cant-configure-an-nsg-for-traffic-analytics-due-to-a-not-found-error"></a>What if I can't configure an NSG for traffic analytics due to a "Not found" error?
...
## <a name="what-if-i-am-getting-the-status-failed-to-load-under-the-nsg-flow-logs-page"></a>What if I am getting the status, “Failed to load,” under the NSG flow logs page?
...
## <a name="i-have-configured-the-solution-why-am-i-not-seeing-anything-on-the-dashboard"></a>I have configured the solution. Why am I not seeing anything on the dashboard?
...
## <a name="what-if-i-get-this-message-we-could-not-find-any-data-in-this-workspace-for-selected-time-interval-try-changing-the-time-interval-or-select-a-different-workspace"></a>What if I get this message: “We could not find any data in this workspace for selected time interval. Try changing the time interval or select a different workspace.”?
...
## <a name="what-if-i-get-this-message-analyzing-your-nsg-flow-logs-for-the-first-time-this-process-may-take-20-30-minutes-to-complete-check-back-after-some-time-2-if-the-above-step-doesnt-work-and-your-workspace-is-under-the-free-sku-then-check-your-workspace-usage-here-to-validate-over-quota-else-refer-to-faqs-for-further-information"></a>What if I get this message: “Analyzing your NSG flow logs for the first time. This process may take 20-30 minutes to complete. Check back after some time. 2) If the above step doesn’t work and your workspace is under the free SKU, then check your workspace usage here to validate over quota, else refer to FAQs for further information.”?
...
## <a name="what-if-i-get-this-message-looks-like-we-have-resources-data-topology-and-no-flows-information-meanwhile-click-here-to-see-resources-data-and-refer-to-faqs-for-further-information"></a>What if I get this message: “Looks like we have resources data (Topology) and no flows information. Meanwhile, click here to see resources data and refer to FAQs for further information.”?
...
## <a name="can-i-configure-traffic-analytics-using-powershell-or-an-azure-resource-manager-template-or-client"></a>Can I configure traffic analytics using PowerShell or an Azure Resource Manager template or client?
...
## <a name="how-is-traffic-analytics-priced"></a>How is traffic analytics priced?
...
## <a name="how-can-i-navigate-by-using-the-keyboard-in-the-geo-map-view"></a>How can I navigate by using the keyboard in the geo map view?
...
### <a name="keyboard-navigation-on-the-banner"></a>Keyboard navigation on the banner
...
### <a name="keyboard-navigation-on-the-map"></a>Keyboard navigation on the map
...
### <a name="keyboard-navigation-at-any-stage"></a>Keyboard navigation at any stage
...
## <a name="how-can-i-navigate-by-using-the-keyboard-in-the-virtual-network-topology-view"></a>How can I navigate by using the keyboard in the virtual network topology view?
...
### <a name="keyboard-navigation-on-the-topology"></a>Keyboard navigation on the topology
...
## <a name="how-can-i-navigate-by-using-the-keyboard-in-the-subnet-topology-view"></a>How can I navigate by using the keyboard in the subnet topology view?
