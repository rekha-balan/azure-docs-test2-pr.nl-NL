...
---
# <a name="manage-packet-captures-with-azure-network-watcher-using-azure-rest-api"></a>Manage packet captures with Azure Network Watcher using Azure REST API
...
## <a name="list-all-packet-captures"></a>List all packet captures
...
## <a name="query-packet-capture-status"></a>Query packet capture status
...
## <a name="start-packet-capture"></a>Start packet capture
...
## <a name="stop-packet-capture"></a>Stop packet capture
...
## <a name="delete-packet-capture"></a>Delete packet capture
