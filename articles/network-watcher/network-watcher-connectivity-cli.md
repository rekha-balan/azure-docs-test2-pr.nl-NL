...
---
# <a name="troubleshoot-connections-with-azure-network-watcher-using-the-azure-cli-20"></a>Troubleshoot connections with Azure Network Watcher using the Azure CLI 2.0
