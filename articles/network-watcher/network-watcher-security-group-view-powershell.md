...
---
# <a name="analyze-your-virtual-machine-security-with-security-group-view-using-powershell"></a>Analyze your Virtual Machine security with Security Group View using PowerShell
