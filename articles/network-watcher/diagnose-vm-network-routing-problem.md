...
---
# <a name="tutorial-diagnose-a-virtual-machine-network-routing-problem-using-the-azure-portal"></a>Tutorial: Diagnose a virtual machine network routing problem using the Azure portal
...
### <a name="use-next-hop"></a>Use next hop
...
## <a name="view-details-of-a-route"></a>View details of a route
