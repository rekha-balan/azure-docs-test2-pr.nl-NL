...
---
# <a name="find-out-what-the-next-hop-type-is-using-the-next-hop-capability-in-azure-network-watcher-using-powershell"></a>Find out what the next hop type is using the Next Hop capability in Azure Network Watcher using PowerShell
...
## <a name="get-a-virtual-machine"></a>Get a virtual machine
...
## <a name="get-the-network-interfaces"></a>Get the network interfaces
