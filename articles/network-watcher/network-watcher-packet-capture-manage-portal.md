...
---
# <a name="manage-packet-captures-with-azure-network-watcher-using-the-portal"></a>Manage packet captures with Azure Network Watcher using the portal
...
### <a name="packet-capture-agent-extension-through-the-portal"></a>Packet Capture agent extension through the portal
...
## <a name="packet-capture-overview"></a>Packet Capture overview
