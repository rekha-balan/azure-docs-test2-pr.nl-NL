...
---
# <a name="manage-and-analyze-network-security-group-flow-logs-in-azure-using-network-watcher-and-graylog"></a>Manage and analyze network security group flow logs in Azure using Network Watcher and Graylog
...
### <a name="setting-up-graylog"></a>Setting up Graylog
...
Graylog can be installed in many ways, depending on your platform and preferences. For a full list of possible installation methods, refer to Graylog's official [documentation](http://docs.graylog.org/en/2.2/pages/installation.html). The Graylog server application runs on Linux distributions and has the following prerequisites:
...
### <a name="install-the-logstash-input-plug-in-for-azure-blob-storage"></a>Install the Logstash input plug-in for Azure blob storage
...
### <a name="set-up-connection-from-logstash-to-graylog"></a>Set up connection from Logstash to Graylog
...
### <a name="search-through-graylog-messages"></a>Search through Graylog messages
...
## <a name="analyze-network-security-group-flow-logs-using-graylog"></a>Analyze network security group flow logs using Graylog
...
### <a name="add-widgets"></a>Add widgets
...
Learn how to visualize your network security group flow logs with Power BI by visiting [Visualize network security group flows logs with Power BI](network-watcher-visualize-nsg-flow-logs-power-bi.md).
