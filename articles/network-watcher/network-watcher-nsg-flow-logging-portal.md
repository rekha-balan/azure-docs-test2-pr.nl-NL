...
---
# <a name="tutorial-log-network-traffic-to-and-from-a-virtual-machine-using-the-azure-portal"></a>Tutorial: Log network traffic to and from a virtual machine using the Azure portal
...
## <a name="register-insights-provider"></a>Register Insights provider
...
## <a name="enable-nsg-flow-log"></a>Enable NSG flow log
...
## <a name="download-flow-log"></a>Download flow log
