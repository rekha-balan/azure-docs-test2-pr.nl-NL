...
---
# <a name="tutorial-monitor-network-communication-between-two-virtual-machines-using-the-azure-portal"></a>Tutorial: Monitor network communication between two virtual machines using the Azure portal
...
### <a name="create-the-first-vm"></a>Create the first VM
...
### <a name="create-the-second-vm"></a>Create the second VM
...
## <a name="create-a-connection-monitor"></a>Create a connection monitor
...
## <a name="view-a-connection-monitor"></a>View a connection monitor
...
## <a name="view-a-problem"></a>View a problem
