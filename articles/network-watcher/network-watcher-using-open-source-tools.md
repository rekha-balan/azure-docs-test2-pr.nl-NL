...
---
# <a name="visualize-network-traffic-patterns-to-and-from-your-vms-using-open-source-tools"></a>Visualize network traffic patterns to and from your VMs using open source tools
...
### <a name="install-capanalysis"></a>Install CapAnalysis
...
### <a name="use-azure-network-watcher-to-start-a-packet-capture-session"></a>Use Azure Network Watcher to start a packet capture session
...
### <a name="upload-a-packet-capture-to-capanalysis"></a>Upload a packet capture to CapAnalysis
...
### <a name="analyzing-packet-captures"></a>Analyzing packet captures
