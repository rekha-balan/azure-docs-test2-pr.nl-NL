...
---
# <a name="tutorial-diagnose-a-communication-problem-between-networks-using-the-azure-portal"></a>Tutorial: Diagnose a communication problem between networks using the Azure portal
...
## <a name="diagnose-a-gateway"></a>Diagnose a gateway
...
## <a name="diagnose-a-gateway-connection"></a>Diagnose a gateway connection
