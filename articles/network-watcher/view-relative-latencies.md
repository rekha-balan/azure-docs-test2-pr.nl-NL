...
---
# <a name="view-relative-latency-to-azure-regions-from-specific-locations"></a>View relative latency to Azure regions from specific locations
...
## <a name="create-a-network-watcher"></a>Create a network watcher
...
## <a name="compare-relative-network-latencies-to-a-single-azure-region-from-a-specific-location"></a>Compare relative network latencies to a single Azure region from a specific location
...
## <a name="compare-relative-network-latencies-across-azure-regions-from-a-specific-location"></a>Compare relative network latencies across Azure regions from a specific location
