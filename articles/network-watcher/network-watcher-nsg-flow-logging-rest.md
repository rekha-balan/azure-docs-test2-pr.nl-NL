...
---
# <a name="configuring-network-security-group-flow-logs-using-rest-api"></a>Configuring Network Security Group flow logs using REST API
...
## <a name="query-flow-logs"></a>Query flow logs
