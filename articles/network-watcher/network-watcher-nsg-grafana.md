...
---
# <a name="manage-and-analyze-network-security-group-flow-logs-using-network-watcher-and-grafana"></a>Manage and analyze Network Security Group flow logs using Network Watcher and Grafana
...
### <a name="install-grafana"></a>Install Grafana
...
#### <a name="add-the-elasticsearch-server-as-a-data-source"></a>Add the ElasticSearch server as a data source
