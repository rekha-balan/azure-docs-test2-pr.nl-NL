...
---
# <a name="read-nsg-flow-logs"></a>Read NSG flow logs
...
## <a name="retrieve-the-block-list"></a>Retrieve the block list
...
## <a name="read-the-block-blob"></a>Read the block blob
