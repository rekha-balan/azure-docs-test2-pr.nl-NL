...
### <a name="install-suricata"></a>Install Suricata
...
### <a name="download-the-emerging-threats-ruleset"></a>Download the Emerging Threats ruleset
...
### <a name="process-packet-captures-with-suricata"></a>Process packet captures with Suricata
...
### <a name="visualize-ids-alert-logs"></a>Visualize IDS alert logs
