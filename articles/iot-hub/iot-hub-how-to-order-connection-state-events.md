...
---
# <a name="order-device-connection-events-from-azure-iot-hub-using-azure-cosmos-db"></a>Order device connection events from Azure IoT Hub using Azure Cosmos DB
...
## <a name="create-a-stored-procedure"></a>Create a stored procedure
...
### <a name="create-a-logic-app-resource"></a>Create a logic app resource
...
### <a name="select-a-trigger"></a>Select a trigger
...
### <a name="create-a-condition"></a>Create a condition
...
### <a name="copy-the-http-url"></a>Copy the HTTP URL
...
## <a name="configure-subscription-for-iot-hub-events"></a>Configure subscription for IoT Hub events
...
4. Create the event subscription with the following values: 
   ...
   * **Event Subscription Details**: Provide a descriptive name and select **Event Grid Schema** When you're done, the form should look like the following example: 
...
## <a name="observe-events"></a>Observe events
Now that your event subscription is set up, let's test by connecting a device.

### <a name="register-a-device-in-iot-hub"></a>Register a device in IoT Hub
...
### <a name="start-raspberry-pi-simulator"></a>Start Raspberry Pi simulator
...
### <a name="run-a-sample-applciation-on-the-raspberry-pi-web-simulator"></a>Run a sample applciation on the Raspberry Pi web simulator
...
### <a name="observe-events-in-cosmos-db"></a>Observe events in Cosmos DB
...
## <a name="use-the-azure-cli"></a>Use the Azure CLI
