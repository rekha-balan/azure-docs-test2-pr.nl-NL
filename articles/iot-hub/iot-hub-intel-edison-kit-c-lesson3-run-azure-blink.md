...
---
# <a name="run-a-sample-application-to-send-device-to-cloud-messages"></a>Run a sample application to send device-to-cloud messages
...
## <a name="verify-that-the-sample-application-works"></a>Verify that the sample application works
