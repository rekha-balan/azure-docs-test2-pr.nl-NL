...
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-nodejs-back-end-and-nodejs-device"></a>Get started with IoT Hub module identity and module twin using Node.js back end and Node.js device
...
## <a name="update-the-module-twin-using-nodejs-device-sdk"></a>Update the module twin using Node.js device SDK
