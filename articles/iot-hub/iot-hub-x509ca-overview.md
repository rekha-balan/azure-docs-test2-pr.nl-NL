...
---
# <a name="device-authentication-using-x509-ca-certificates"></a>Device Authentication using X.509 CA Certificates
...
## <a name="how-to-get-an-x509-ca-certificate"></a>How to get an X.509 CA certificate
...
## <a name="sign-devices-into-the-certificate-chain-of-trust"></a>Sign devices into the certificate chain of trust
...
## <a name="how-to-register-the-x509-ca-certificate-to-iot-hub"></a>How to register the X.509 CA certificate to IoT Hub
...
## <a name="how-to-create-a-device-on-iot-hub"></a>How to create a device on IoT Hub
...
## <a name="authenticating-devices-signed-with-x509-ca-certificates"></a>Authenticating devices signed with X.509 CA certificates
