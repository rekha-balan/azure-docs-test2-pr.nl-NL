...
---
# <a name="how-to-manage-connectivity-and-reliable-messaging-using-azure-iot-hub-device-sdks"></a>How to manage connectivity and reliable messaging using Azure IoT Hub device SDKs
...
## <a name="connection-and-retry"></a>Connection and retry
...
### <a name="error-patterns"></a>Error patterns
...
### <a name="retry-patterns"></a>Retry patterns
...
### <a name="retry-policy-apis"></a>Retry policy APIs
...
#### <a name="net-implementation-guidance"></a>.NET implementation guidance
...
#### <a name="other-languages-implementation-guidance"></a>Other languages implementation guidance
