...
## <a name="deploy-function-app"></a>Deploy Function App
...
## <a name="configure-iot-hub-device-connection-string-in-devkit"></a>Configure IoT Hub Device Connection String in DevKit
...
## <a name="upload-arduino-code-to-devkit"></a>Upload Arduino Code to DevKit
...
## <a name="control-the-devkits-user-led"></a>Control the DevKit's User LED
...
## <a name="example-operation"></a>Example operation

![Example test procedure](media/iot-hub-arduino-iot-devkit-az3166-devkit-state/devkit-state.gif)

> [!NOTE]
> You can see raw data of device twin in Azure portal: IoT Hub -\> IoT devices -\> *\<your device\>* -\> Device Twin.
