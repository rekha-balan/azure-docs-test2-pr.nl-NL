...
---
# <a name="how-to-upgrade-your-iot-hub"></a>How to upgrade your IoT hub
...
## <a name="upgrade-your-existing-iot-hub"></a>Upgrade your existing IoT hub 
...
Your IoT hub is now adjusted, and your configurations are unchanged. Note that the maximum partition limit for basic tier IoT Hub is 8 and for standard tier is 32. Most IoT Hubs only need 4 partitions. The partition limit is chosen when IoT Hub is created, and relates the device-to-cloud messages to the number of simultaneous readers of these messages. This value remains unchanged when you migrate from basic tier to standard tier. 
