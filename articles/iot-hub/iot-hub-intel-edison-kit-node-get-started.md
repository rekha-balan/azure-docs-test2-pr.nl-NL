...
---
# <a name="connect-intel-edison-to-azure-iot-hub-nodejs"></a>Connect Intel Edison to Azure IoT Hub (Node.js)
...
### <a name="assemble-your-board"></a>Assemble your board
...
### <a name="connect-edison-to-your-computer"></a>Connect Edison to your computer
...
## <a name="download-and-run-the-configuration-tool"></a>Download and run the configuration tool
...
### <a name="set-password"></a>Set password
...
### <a name="connect-wi-fi"></a>Connect Wi-Fi
...
## <a name="run-a-sample-application-on-intel-edison"></a>Run a sample application on Intel Edison

### <a name="prepare-the-azure-iot-device-sdk"></a>Prepare the Azure IoT Device SDK
...
### <a name="configure-and-run-the-sample-application"></a>Configure and run the sample application
