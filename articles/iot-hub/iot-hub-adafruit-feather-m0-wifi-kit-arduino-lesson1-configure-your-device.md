...
## <a name="connect-your-arduino-board-to-your-computer"></a>Connect your Arduino board to your computer
...
## <a name="add-serial-port-permissions-on-ubuntu"></a>Add serial port permissions on Ubuntu
