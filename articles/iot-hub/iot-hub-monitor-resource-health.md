...
---
# <a name="monitor-the-health-of-azure-iot-hub-and-diagnose-problems-quickly"></a>Monitor the health of Azure IoT Hub and diagnose problems quickly
...
## <a name="use-azure-monitor"></a>Use Azure Monitor
...
### <a name="understand-the-logs"></a>Understand the logs
...
#### <a name="file-upload-operations"></a>File upload operations
...
#### <a name="device-to-cloud-twin-operations"></a>Device-to-cloud twin operations
...
#### <a name="twin-queries"></a>Twin queries
...
#### <a name="jobs-operations"></a>Jobs operations
...
#### <a name="direct-methods"></a>Direct Methods
...
### <a name="read-logs-from-azure-event-hubs"></a>Read logs from Azure Event Hubs
...
## <a name="use-azure-resource-health"></a>Use Azure Resource Health
