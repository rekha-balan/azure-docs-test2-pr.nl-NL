...
---
# <a name="query-avro-data-by-using-azure-data-lake-analytics"></a>Query Avro data by using Azure Data Lake Analytics
...
## <a name="query-and-export-avro-data-to-a-csv-file"></a>Query and export Avro data to a CSV file
