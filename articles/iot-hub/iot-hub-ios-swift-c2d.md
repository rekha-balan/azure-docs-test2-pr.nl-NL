...
---
# <a name="send-cloud-to-device-messages-with-iot-hub-ios"></a>Send cloud-to-device messages with IoT Hub (iOS)
...
## <a name="simulate-an-iot-device"></a>Simulate an IoT device
...
### <a name="install-cocoapods"></a>Install CocoaPods
...
### <a name="run-the-sample-device-application"></a>Run the sample device application 
...
## <a name="simulate-a-service-device"></a>Simulate a service device
...
### <a name="run-the-sample-service-application"></a>Run the sample service application
