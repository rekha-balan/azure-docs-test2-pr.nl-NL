...
---
# <a name="tutorial-implement-a-device-firmware-update-process"></a>Tutorial: Implement a device firmware update process
...
## <a name="start-the-firmware-update"></a>Start the firmware update
...
### <a name="use-desired-properties-to-start-the-firmware-upgrade-from-the-back-end-application"></a>Use desired properties to start the firmware upgrade from the back-end application
...
### <a name="respond-to-the-firmware-upgrade-request-on-the-device"></a>Respond to the firmware upgrade request on the device
...
## <a name="update-the-firmware"></a>Update the firmware
