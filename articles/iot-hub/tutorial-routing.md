...
---
# <a name="tutorial-configure-message-routing-with-iot-hub"></a>Tutorial: Configure message routing with IoT Hub
...
### <a name="using-azure-cli-locally"></a>Using Azure CLI locally
...
### <a name="using-powershell-locally"></a>Using PowerShell locally
...
### <a name="azure-cli-instructions"></a>Azure CLI instructions
...
### <a name="powershell-instructions"></a>PowerShell instructions
...
## <a name="set-up-message-routing"></a>Set up message routing
...
### <a name="routing-to-a-storage-account"></a>Routing to a storage account 
...
### <a name="routing-to-a-service-bus-queue"></a>Routing to a Service Bus queue 
...
## <a name="set-up-azure-stream-analytics"></a>Set up Azure Stream Analytics
...
### <a name="create-the-stream-analytics-job"></a>Create the Stream Analytics job
...
## <a name="run-simulated-device-app"></a>Run Simulated Device app
...
## <a name="run-and-test"></a>Run and test 
...
## <a name="set-up-the-power-bi-visualizations"></a>Set up the Power BI Visualizations
...
### <a name="clean-up-resources-in-the-power-bi-visualization"></a>Clean up resources in the Power BI visualization
...
### <a name="clean-up-resources-using-azure-cli"></a>Clean up resources using Azure CLI
...
```
### <a name="clean-up-resources-using-powershell"></a>Clean up resources using PowerShell
