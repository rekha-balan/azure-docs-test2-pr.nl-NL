...
---
# <a name="set-up-x509-security-in-your-azure-iot-hub"></a>Set up X.509 security in your Azure IoT hub
...
## <a name="get-x509-ca-certificates"></a>Get X.509 CA certificates
...
## <a name="register-x509-ca-certificates-to-your-iot-hub"></a>Register X.509 CA certificates to your IoT hub
...
## <a name="create-an-x509-device-for-your-iot-hub"></a>Create an X.509 device for your IoT hub
...
## <a name="authenticate-your-x509-device-with-the-x509-certificates"></a>Authenticate your X.509 device with the X.509 certificates
