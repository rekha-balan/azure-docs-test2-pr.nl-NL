...
---
# <a name="conceptual-understanding-of-x509-ca-certificates-in-the-iot-industry"></a>Conceptual understanding of X.509 CA certificates in the IoT industry
...
## <a name="acquire-the-x509-ca-certificate"></a>Acquire the X.509 CA certificate
...
### <a name="purchasing-an-x509-ca-certificate"></a>Purchasing an X.509 CA certificate
...
### <a name="creating-a-self-signed-x509-ca-certificate"></a>Creating a Self-Signed X.509 CA certificate
...
## <a name="register-the-x509-certificate-to-iot-hub"></a>Register the X.509 certificate to IoT Hub
...
### <a name="x509-ca-certificate-upload"></a>X.509 CA Certificate Upload
...
### <a name="proof-of-possession-of-the-certificate"></a>Proof-of-Possession of the Certificate
...
## <a name="sign-devices-into-a-certificate-chain-of-trust"></a>Sign Devices into a Certificate Chain of Trust
...
## <a name="device-connection"></a>Device Connection
