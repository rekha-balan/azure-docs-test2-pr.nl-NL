...
---
# <a name="send-device-to-cloud-messages-to-iot-hub"></a>Send device-to-cloud messages to IoT Hub
...
## <a name="send-non-telemetry-traffic"></a>Send non-telemetry traffic
...
## <a name="route-device-to-cloud-messages"></a>Route device-to-cloud messages
