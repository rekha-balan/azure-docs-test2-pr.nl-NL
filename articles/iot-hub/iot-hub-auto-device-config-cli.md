...
---
# <a name="configure-and-monitor-iot-devices-at-scale-using-the-azure-cli"></a>Configure and monitor IoT devices at scale using the Azure CLI
...
## <a name="define-the-target-content-and-metrics"></a>Define the target content and metrics
