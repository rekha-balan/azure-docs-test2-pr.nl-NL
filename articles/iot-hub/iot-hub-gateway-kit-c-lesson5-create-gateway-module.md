...
---
# <a name="lesson-5-create-your-first-azure-iot-gateway-module"></a>Lesson 5: Create your first Azure IoT Gateway module
...
## <a name="compile-and-run-the-helloworld-sample-app-on-intel-nuc"></a>Compile and run the hello_world sample app on Intel NUC
...
## <a name="create-a-new-module-and-compile-it-on-intel-nuc"></a>Create a new module and compile it on Intel NUC
...
## <a name="add-the-module-to-the-helloworld-sample-app-and-run-the-app-on-intel-nuc"></a>Add the module to the hello_world sample app and run the app on Intel NUC
