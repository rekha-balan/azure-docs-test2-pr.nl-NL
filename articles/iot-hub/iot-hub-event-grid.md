...
---
# <a name="react-to-iot-hub-events-by-using-event-grid-to-trigger-actions"></a>React to IoT Hub events by using Event Grid to trigger actions
...
### <a name="device-connected-schema"></a>Device connected schema
...
### <a name="device-created-schema"></a>Device created schema
...
## <a name="filter-events"></a>Filter events
...
devices/{deviceId}
```
## <a name="limitations-for-device-connected-and-device-disconnected-events"></a>Limitations for device connected and device disconnected events
...
## <a name="tips-for-consuming-events"></a>Tips for consuming events
