...
---
# <a name="schedule-and-broadcast-jobs-python"></a>Schedule and broadcast jobs (Python)
...
## <a name="schedule-jobs-for-calling-a-direct-method-and-updating-a-device-twins-properties"></a>Schedule jobs for calling a direct method and updating a device twin's properties
