...
---
# <a name="detect-and-troubleshoot-disconnects-with-azure-iot-hub"></a>Detect and troubleshoot disconnects with Azure IoT Hub
...
## <a name="get-alerts-and-error-logs"></a>Get alerts and error logs
...
### <a name="set-up-alerts-for-the-connected-devices-count-metric"></a>Set up alerts for the connected devices count metric
...
## <a name="resolve-connectivity-errors"></a>Resolve connectivity errors
...
## <a name="other-steps-to-try"></a>Other steps to try
