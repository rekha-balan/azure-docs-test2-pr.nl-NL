...
## <a name="install-raspbian-on-the-microsd-card"></a>Install Raspbian on the microSD card
...
## <a name="turn-on-pi"></a>Turn on Pi
...
## <a name="enable-ssh"></a>Enable SSH
...
## <a name="connect-raspberry-pi-3-to-the-network"></a>Connect Raspberry Pi 3 to the network
...
### <a name="connect-to-a-wired-network"></a>Connect to a wired network
...
### <a name="connect-to-a-wireless-network"></a>Connect to a wireless network
...
## <a name="connect-the-led-to-pi"></a>Connect the LED to Pi
