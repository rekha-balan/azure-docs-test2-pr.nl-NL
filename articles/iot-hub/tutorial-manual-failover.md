...
---
# <a name="tutorial-perform-manual-failover-for-an-iot-hub-public-preview"></a>Tutorial: Perform manual failover for an IoT hub (public preview)
...
## <a name="perform-a-manual-failover"></a>Perform a manual failover
