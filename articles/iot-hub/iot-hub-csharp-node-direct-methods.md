...
---
# <a name="use-direct-methods-netnode"></a>Use direct methods (.NET/Node)
...
## <a name="call-a-direct-method-on-a-device"></a>Call a direct method on a device
...
2. At a command prompt in the **simulateddevice** folder, run the following command to start listening for method calls from your IoT Hub:
    ...
    ```
   Wait for the simulated device to open:  ![][7]
