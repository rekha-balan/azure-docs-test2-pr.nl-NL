...
## <a name="built-in-endpoints"></a>Built-in endpoints
...
## <a name="custom-endpoints"></a>Custom endpoints
...
## <a name="custom-gateway"></a>Custom gateway
...
## <a name="desired-configuration"></a>Desired configuration
...
## <a name="device-app"></a>Device app
...
## <a name="device-condition"></a>Device condition
...
## <a name="device-data"></a>Device data
...
## <a name="device-identities-rest-api"></a>Device Identities REST API
...
## <a name="device-identity"></a>Device identity
...
## <a name="device-management-patterns"></a>Device management patterns
...
## <a name="device-twin-queries"></a>Device twin queries
...
## <a name="device-twin-rest-api"></a>Device Twin REST API
...
## <a name="device-twin-synchronization"></a>Device twin synchronization
...
## <a name="identity-registry"></a>Identity registry
...
## <a name="iot-hub-query-language"></a>IoT Hub query language
...
## <a name="iot-hub-resource-provider-rest-api"></a>IoT Hub Resource Provider REST API
...
## <a name="operations-monitoring"></a>Operations monitoring
...
## <a name="physical-device"></a>Physical device
...
## <a name="primary-and-secondary-keys"></a>Primary and secondary keys
...
## <a name="reported-configuration"></a>Reported configuration
...
## <a name="x509-client-certificate"></a>X.509 client certificate
