...
---
# <a name="use-message-routes-and-custom-endpoints-for-device-to-cloud-messages"></a>Use message routes and custom endpoints for device-to-cloud messages
...
## <a name="endpoints-and-routing"></a>Endpoints and routing
