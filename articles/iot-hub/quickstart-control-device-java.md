...
---
# <a name="quickstart-control-a-device-connected-to-an-iot-hub-java"></a>Quickstart: Control a device connected to an IoT hub (Java)
...
## <a name="retrieve-the-service-connection-string"></a>Retrieve the service connection string
