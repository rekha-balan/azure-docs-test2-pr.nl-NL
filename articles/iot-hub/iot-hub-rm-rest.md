...
---
# <a name="create-an-iot-hub-using-the-resource-provider-rest-api-net"></a>Create an IoT hub using the resource provider REST API (.NET)
...
## <a name="use-the-resource-provider-rest-api-to-create-an-iot-hub"></a>Use the resource provider REST API to create an IoT hub
