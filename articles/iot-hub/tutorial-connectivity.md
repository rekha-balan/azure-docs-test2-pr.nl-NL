...
---
# <a name="tutorial-use-a-simulated-device-to-test-connectivity-with-your-iot-hub"></a>Tutorial: Use a simulated device to test connectivity with your IoT hub
...
## <a name="check-device-authentication"></a>Check device authentication
...
### <a name="reset-keys"></a>Reset keys
...
### <a name="generate-shared-access-signature-sas-token"></a>Generate shared access signature (SAS) token
...
## <a name="check-device-to-cloud-connectivity"></a>Check device-to-cloud connectivity
...
## <a name="check-cloud-to-device-connectivity"></a>Check cloud-to-device connectivity
...
## <a name="check-twin-synchronization"></a>Check twin synchronization
