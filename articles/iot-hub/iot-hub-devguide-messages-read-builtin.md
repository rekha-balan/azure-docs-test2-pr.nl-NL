...
---
# <a name="read-device-to-cloud-messages-from-the-built-in-endpoint"></a>Read device-to-cloud messages from the built-in endpoint
...
## <a name="read-from-the-built-in-endpoint"></a>Read from the built-in endpoint
