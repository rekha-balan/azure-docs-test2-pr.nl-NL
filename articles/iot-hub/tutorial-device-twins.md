...
# <a name="tutorial-configure-your-devices-from-a-back-end-service"></a>Tutorial: Configure your devices from a back-end service
...
## <a name="send-state-information"></a>Send state information
...
### <a name="retrieve-the-device-twin-object"></a>Retrieve the device twin object
...
### <a name="sample-desired-properties"></a>Sample desired properties
...
### <a name="create-handlers"></a>Create handlers
...
### <a name="handlers-for-multiple-properties"></a>Handlers for multiple properties
...
### <a name="handle-insert-update-and-delete-operations"></a>Handle insert, update, and delete operations
...
### <a name="send-desired-properties-to-a-device-from-the-back-end"></a>Send desired properties to a device from the back end
...
## <a name="receive-state-information"></a>Receive state information
...
### <a name="send-reported-properties-from-a-device"></a>Send reported properties from a device
...
### <a name="process-reported-properties"></a>Process reported properties
