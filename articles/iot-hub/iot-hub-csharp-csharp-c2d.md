...
---
# <a name="send-messages-from-the-cloud-to-your-simulated-device-with-iot-hub-net"></a>Send messages from the cloud to your simulated device with IoT Hub (.NET)
...
## <a name="receive-messages-in-the-simulated-device-app"></a>Receive messages in the simulated device app
