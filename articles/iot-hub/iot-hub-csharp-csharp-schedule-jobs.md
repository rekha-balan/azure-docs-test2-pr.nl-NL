...
---
# <a name="schedule-and-broadcast-jobs-netnet"></a>Schedule and broadcast jobs (.NET/.NET)
...
## <a name="schedule-jobs-for-calling-a-direct-method-and-sending-device-twin-updates"></a>Schedule jobs for calling a direct method and sending device twin updates
