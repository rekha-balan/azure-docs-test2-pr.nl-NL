...
---
# <a name="connect-raspberry-pi-to-azure-iot-hub-nodejs"></a>Connect Raspberry Pi to Azure IoT Hub (Node.js)
...
Don't have a kit yet? Try the [Raspberry Pi 3 emulator](https://blogs.msdn.microsoft.com/iliast/2016/11/10/how-to-emulate-raspberry-pi/). Or buy a new kit [here](https://azure.microsoft.com/develop/iot/starter-kits).
...
### <a name="enable-ssh-and-i2c"></a>Enable SSH and I2C
...
### <a name="clone-sample-application-and-install-the-prerequisite-packages"></a>Clone sample application and install the prerequisite packages
