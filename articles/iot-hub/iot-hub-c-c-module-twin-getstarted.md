...
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-c-backend-and-c-device"></a>Get started with IoT Hub module identity and module twin using C backend and C device
...
## <a name="update-the-module-twin-using-c-device-sdk"></a>Update the module twin using C device SDK
