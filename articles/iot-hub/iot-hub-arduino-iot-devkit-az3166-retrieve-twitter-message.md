...
---
# <a name="shake-shake-for-a-tweet----retrieve-a-twitter-message-with-azure-functions"></a>Shake, Shake for a Tweet -- Retrieve a Twitter message with Azure Functions
...
### <a name="open-the-arduino-examples-folder"></a>Open the Arduino Examples folder
...
the ![mini-solution-examples](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/vscode_examples.png)
...
## <a name="provision-azure-services"></a>Provision Azure services
...
## <a name="modify-the-hashtag"></a>Modify the #hashtag
...
## <a name="deploy-azure-functions"></a>Deploy Azure Functions
...
### <a name="verify-upload-and-run"></a>Verify, upload, and run
...
### <a name="press-b-to-read"></a>Press B to read...

![Press-B-to-read](media/iot-hub-arduino-iot-devkit-az3166-retrieve-twitter-message/result-5.png)

### <a name="display-a-random-tweet"></a>Display a random tweet...
...
## <a name="optional-use-your-own-twitter-bearer-token"></a>Optional: Use your own Twitter bearer token
