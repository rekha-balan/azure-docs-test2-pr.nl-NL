...
---
# <a name="use-azure-iot-toolkit-extension-for-visual-studio-code-for-azure-iot-hub-device-management"></a>Use Azure IoT Toolkit extension for Visual Studio Code for Azure IoT Hub device management
...
## <a name="read-device-twin"></a>Read device twin
...
## <a name="update-device-twin"></a>Update device twin
