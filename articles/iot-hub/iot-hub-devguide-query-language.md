...
---
# <a name="iot-hub-query-language-for-device-and-module-twins-jobs-and-message-routing"></a>IoT Hub query language for device and module twins, jobs, and message routing
...
## <a name="device-and-module-twin-queries"></a>Device and module twin queries
...
### <a name="module-twin-queries"></a>Module twin queries
...
### <a name="nodejs-example"></a>Node.js example
...
## <a name="get-started-with-jobs-queries"></a>Get started with jobs queries
...
## <a name="device-to-cloud-message-routes-query-expressions"></a>Device-to-cloud message routes query expressions
...
### <a name="routing-on-message-headers"></a>Routing on message headers
...
### <a name="routing-on-message-bodies"></a>Routing on message bodies
