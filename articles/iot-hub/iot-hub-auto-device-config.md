...
---
# <a name="configure-and-monitor-iot-devices-at-scale-using-the-azure-portal"></a>Configure and monitor IoT devices at scale using the Azure portal
...
## <a name="implement-device-twins-to-configure-devices"></a>Implement device twins to configure devices
...
### <a name="name-and-label"></a>Name and Label
...
### <a name="specify-settings"></a>Specify Settings
...
### <a name="specify-metrics-optional"></a>Specify Metrics (optional)
...
### <a name="target-devices"></a>Target Devices
...
### <a name="review-configuration"></a>Review Configuration

Review your configuration information, then select **Submit**.

## <a name="monitor-a-configuration"></a>Monitor a configuration
...
## <a name="modify-a-configuration"></a>Modify a configuration
...
## <a name="delete-a-configuration"></a>Delete a configuration
