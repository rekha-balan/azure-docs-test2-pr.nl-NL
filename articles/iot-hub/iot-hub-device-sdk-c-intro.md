...
## <a name="before-you-run-the-samples"></a>Before you run the samples
...
### <a name="obtain-the-device-credentials"></a>Obtain the device credentials
...
## <a name="use-the-iothubclient-library"></a>Use the IoTHubClient library
...
### <a name="initialize-the-library"></a>Initialize the library
...
### <a name="uninitialize-the-library"></a>Uninitialize the library
...
## <a name="use-the-serializer-library"></a>Use the serializer library
...
### <a name="define-the-model"></a>Define the model
