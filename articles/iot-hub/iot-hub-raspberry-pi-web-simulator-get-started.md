...
---
# <a name="connect-raspberry-pi-online-simulator-to-azure-iot-hub-nodejs"></a>Connect Raspberry Pi online simulator to Azure IoT Hub (Node.js)
...
## <a name="overview-of-raspberry-pi-web-simulator"></a>Overview of Raspberry Pi web simulator
...
## <a name="run-a-sample-application-on-pi-web-simulator"></a>Run a sample application on Pi web simulator
...
You should see the following output that shows the sensor data and the messages that are sent to your IoT hub ![Output - sensor data sent from Raspberry Pi to your IoT hub](media/iot-hub-raspberry-pi-web-simulator/2_run_application.png)
