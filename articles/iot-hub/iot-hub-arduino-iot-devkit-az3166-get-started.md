...
---
# <a name="connect-iot-devkit-az3166-to-azure-iot-hub"></a>Connect IoT DevKit AZ3166 to Azure IoT Hub
...
### <a name="connect-to-devkit-ap"></a>Connect to DevKit AP
...
### <a name="configure-wi-fi-for-the-devkit"></a>Configure Wi-Fi for the DevKit
...
## <a name="start-using-the-devkit"></a>Start using the DevKit
...
### <a name="upgrade-to-the-latest-firmware"></a>Upgrade to the latest firmware
...
### <a name="test-various-sensors"></a>Test various sensors
...
### <a name="install-azure-iot-workbench"></a>Install Azure IoT Workbench
...
1. Look for **Azure IoT Workbench** in the extension marketplace and install it.
    ![Install Azure IoT Workbench](media/iot-hub-arduino-devkit-az3166-get-started/getting-started/install-workbench.png) Together with the IoT Workbench, other dependent extensions will be installed.
...
### <a name="install-st-link-drivers"></a>Install ST-Link drivers
...
## <a name="build-your-first-project"></a>Build your first project
...
### <a name="view-the-telemetry-sent-to-azure-iot-hub"></a>View the telemetry sent to Azure IoT Hub

Click the power plug icon on the status bar to open the Serial Monitor: ![Serial monitor](media/iot-hub-arduino-devkit-az3166-get-started/getting-started/serial-monitor.png)
...
### <a name="view-the-telemetry-received-by-azure-iot-hub"></a>View the telemetry received by Azure IoT Hub
