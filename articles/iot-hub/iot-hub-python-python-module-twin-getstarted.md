...
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-python-back-end-and-python-device"></a>Get started with IoT Hub module identity and module twin using Python back end and Python device
...
## <a name="create-a-device-identity-and-a-module-identity-in-iot-hub"></a>Create a device identity and a module identity in IoT Hub
...
## <a name="update-the-module-twin-using-python-device-sdk"></a>Update the module twin using Python device SDK
...
## <a name="get-updates-on-the-device-side"></a>Get updates on the device side
