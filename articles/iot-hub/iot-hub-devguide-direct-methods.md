...
---
# <a name="understand-and-invoke-direct-methods-from-iot-hub"></a>Understand and invoke direct methods from IoT Hub
...
## <a name="handle-a-direct-method-on-a-device"></a>Handle a direct method on a device
### <a name="method-invocation"></a>Method invocation
