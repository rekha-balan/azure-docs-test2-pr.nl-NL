...
---
# <a name="develop-for-constrained-devices-using-azure-iot-sdks"></a>Develop for constrained devices using Azure IoT SDKs

## <a name="develop-using-azure-iot-hub-c-sdk"></a>Develop using Azure IoT Hub C SDK
...
### <a name="building-the-c-sdk-for-constrained-devices"></a>Building the C SDK for constrained devices
...
#### <a name="remove-additional-protocol-libraries"></a>Remove additional protocol libraries
...
#### <a name="remove-sdk-logging-capability"></a>Remove SDK logging capability
...
#### <a name="remove-upload-to-blob-capability"></a>Remove upload to blob capability
...
```
#### <a name="running-strip-on-linux-environment"></a>Running strip on Linux environment
...
### <a name="programming-models-for-constrained-devices"></a>Programming models for constrained devices
#### <a name="avoid-using-the-serializer"></a>Avoid using the Serializer
...
#### <a name="use-the-lower-layer-ll"></a>Use the lower layer (_LL_)
