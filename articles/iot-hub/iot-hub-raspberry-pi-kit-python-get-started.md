...
---
# <a name="connect-raspberry-pi-to-azure-iot-hub-python"></a>Connect Raspberry Pi to Azure IoT Hub (Python)
...
## <a name="set-up-raspberry-pi"></a>Set up Raspberry Pi
...
### <a name="connect-pi-to-the-network"></a>Connect Pi to the network
