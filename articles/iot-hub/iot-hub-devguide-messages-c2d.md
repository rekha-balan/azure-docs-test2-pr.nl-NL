...
---
# <a name="send-cloud-to-device-messages-from-iot-hub"></a>Send cloud-to-device messages from IoT Hub
...
## <a name="the-cloud-to-device-message-lifecycle"></a>The cloud-to-device message lifecycle
