...
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-the-portal-and-net-device"></a>Get started with IoT Hub module identity and module twin using the portal and .NET device
...
## <a name="create-a-device-identity-in-the-portal"></a>Create a device identity in the portal
...
## <a name="create-a-module-identity-in-the-portal"></a>Create a module identity in the portal
...
## <a name="update-the-module-twin-using-net-device-sdk"></a>Update the module twin using .NET device SDK
...
4. **Create UpdateModuleTwinReportedProperties console app** Add the following `using` statements at the top of the **Program.cs** file:
