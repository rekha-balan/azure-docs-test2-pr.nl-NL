...
---
# <a name="best-practices-for-device-configuration-within-an-iot-solution"></a>Best practices for device configuration within an IoT solution
...
## <a name="understand-automatic-device-management-for-configuring-iot-devices-at-scale"></a>Understand automatic device management for configuring IoT devices at scale
