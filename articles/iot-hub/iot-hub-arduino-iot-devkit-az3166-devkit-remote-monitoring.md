...
---
# <a name="connect-mxchip-iot-devkit-to-azure-iot-remote-monitoring-solution-accelerator"></a>Connect MXChip IoT DevKit to Azure IoT Remote Monitoring solution accelerator
...
## <a name="open-the-remotemonitoring-sample"></a>Open the RemoteMonitoring sample
...
## <a name="provision-required-azure-services"></a>Provision required Azure services
...
## <a name="change-device-id"></a>Change device ID
