...
## <a name="scope-iot-hub-level-credentials"></a>Scope IoT hub-level credentials
...
### <a name="use-sas-tokens-in-a-device-app"></a>Use SAS tokens in a device app
...
### <a name="register-an-x509-certificate-for-a-device"></a>Register an X.509 certificate for a device
...
### <a name="use-an-x509-certificate-during-run-time-operations"></a>Use an X.509 certificate during run-time operations
...
## <a name="custom-device-and-module-authentication"></a>Custom device and module authentication
