...
---
# <a name="use-ansible-to-manage-your-azure-dynamic-inventories"></a>Use Ansible to manage your Azure dynamic inventories
...
## <a name="tag-a-virtual-machine"></a>Tag a virtual machine
...
## <a name="generate-a-dynamic-inventory"></a>Generate a dynamic inventory
...
## <a name="enable-the-virtual-machine-tag"></a>Enable the virtual machine tag
...
## <a name="set-up-nginx-on-the-tagged-vm"></a>Set up Nginx on the tagged VM
...
## <a name="test-nginx-installation"></a>Test Nginx installation
