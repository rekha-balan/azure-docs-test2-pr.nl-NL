...
---
# <a name="deploy-applications-to-virtual-machine-scale-sets-in-azure-using-ansible"></a>Deploy applications to virtual machine scale sets in Azure using Ansible
...
## <a name="get-host-information"></a>Get host information
...
## <a name="prepare-an-application-for-deployment"></a>Prepare an application for deployment  
...
## <a name="deploy-the-application-to-vmss"></a>Deploy the application to VMSS
