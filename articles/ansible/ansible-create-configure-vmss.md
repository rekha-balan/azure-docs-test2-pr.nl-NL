...
---
# <a name="create-virtual-machine-scale-sets-in-azure-using-ansible"></a>Create virtual machine scale sets in Azure using Ansible
...
## <a name="create-a-vmss"></a>Create a VMSS
...
## <a name="scale-out-a-vmss"></a>Scale out a VMSS
