...
---
# <a name="create-and-configure-azure-kubernetes-service-clusters-in-azure-using-ansible"></a>Create and configure Azure Kubernetes Service clusters in Azure using Ansible
...
## <a name="create-a-managed-aks-cluster"></a>Create a managed AKS cluster
...
## <a name="scale-aks-nodes"></a>Scale AKS nodes
...
The following output shows that the AKS cluster has been successfully created:
  ...
  ```
## <a name="delete-a-managed-aks-cluster"></a>Delete a managed AKS cluster
