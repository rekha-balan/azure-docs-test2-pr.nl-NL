...
---
# <a name="troubleshooting--limitations-of-azure-cloud-shell"></a>Troubleshooting & Limitations of Azure Cloud Shell
...
### <a name="early-timeouts-in-firefox"></a>Early timeouts in FireFox
...
### <a name="disabling-cloud-shell-in-a-locked-down-network-environment"></a>Disabling Cloud Shell in a locked down network environment
...
### <a name="storage-dialog---error-403-requestdisallowedbypolicy"></a>Storage Dialog - Error: 403 RequestDisallowedByPolicy
...
### <a name="storage-dialog---error-400-disallowedoperation"></a>Storage Dialog - Error: 400 DisallowedOperation
...
### <a name="terminal-output---error-failed-to-connect-terminal-websocket-cannot-be-established-press-enter-to-reconnect"></a>Terminal output - Error: Failed to connect terminal: websocket cannot be established. Press `Enter` to reconnect.
...
### <a name="set-your-cloud-shell-connection-to-support-using-tls-12"></a>Set your Cloud Shell connection to support using TLS 1.2
...
## <a name="bash-troubleshooting"></a>Bash troubleshooting

### <a name="cannot-run-the-docker-daemon"></a>Cannot run the docker daemon
...
## <a name="powershell-troubleshooting"></a>PowerShell troubleshooting
...
### <a name="troubleshooting-remote-management-of-azure-vms"></a>Troubleshooting remote management of Azure VMs
...
### <a name="dir-does-not-update-the-result-in-azure-drive"></a>`dir` does not update the result in Azure drive
...
### <a name="preview-version-of-azuread-module"></a>Preview version of AzureAD module
...
### <a name="commands-that-create-gui-pop-ups-are-not-supported"></a>Commands that create GUI pop-ups are not supported
...
### <a name="tab-completion-can-throw-psreadline-exception"></a>Tab completion can throw PSReadline exception
...
## <a name="personal-data-in-cloud-shell"></a>Personal data in Cloud Shell
