...
---
# <a name="quickstart-for-powershell-in-azure-cloud-shell-preview"></a>Quickstart for PowerShell in Azure Cloud Shell (Preview)
...
## <a name="run-powershell-commands"></a>Run PowerShell commands
...
## <a name="navigate-azure-resources"></a>Navigate Azure resources
...
### <a name="allresources-view"></a>AllResources view
...
### <a name="explore-resource-groups"></a>Explore resource groups
...
### <a name="navigate-storage-resources"></a>Navigate storage resources
...
### <a name="interact-with-virtual-machines"></a>Interact with virtual machines
...
#### <a name="invoke-powershell-script-across-remote-vms"></a>Invoke PowerShell script across remote VMs
...
#### <a name="interactively-log-on-to-a-remote-vm"></a>Interactively log on to a remote VM
...
## <a name="list-available-commands"></a>List available commands
...
## <a name="install-custom-modules"></a>Install custom modules
...
## <a name="use-azure-files-to-store-your-data"></a>Use Azure Files to store your data
...
## <a name="use-custom-profile"></a>Use custom profile
...
## <a name="exit-the-shell"></a>Exit the shell
