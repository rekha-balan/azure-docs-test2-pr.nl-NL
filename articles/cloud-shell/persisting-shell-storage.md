...
## <a name="how-cloud-shell-storage-works"></a>How Cloud Shell storage works 
...
## <a name="bash-specific-commands"></a>Bash-specific commands

### <a name="use-the-clouddrive-command"></a>Use the `clouddrive` command
...
### <a name="mount-a-new-clouddrive"></a>Mount a new clouddrive

#### <a name="prerequisites-for-manual-mounting"></a>Prerequisites for manual mounting
...
#### <a name="the-clouddrive-mount-command"></a>The `clouddrive mount` command
...
### <a name="list-clouddrive"></a>List `clouddrive`
...
justin@Azure:~$
```
## <a name="powershell-specific-commands"></a>PowerShell-specific commands

### <a name="list-clouddrive-azure-file-shares"></a>List `clouddrive` Azure file shares
