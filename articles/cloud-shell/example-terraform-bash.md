...
---
# <a name="deploy-with-terraform-from-bash-in-azure-cloud-shell"></a>Deploy with Terraform from Bash in Azure Cloud Shell
...
## <a name="automatic-authentication"></a>Automatic authentication
...
### <a name="launch-bash-in-cloud-shell"></a>Launch Bash in Cloud Shell
...
### <a name="create-a-terraform-template"></a>Create a Terraform template
...
### <a name="verify-deployment-with-azure-cli-20"></a>Verify deployment with Azure CLI 2.0
...
### <a name="clean-up-with-terraform-destroy"></a>Clean up with terraform destroy
