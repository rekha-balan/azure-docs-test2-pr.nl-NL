...
---
# <a name="deploy-an-umbraco-web-app-in-the-azure-portal-in-five-minutes"></a>Deploy an Umbraco web app in the Azure portal in five minutes
...
## <a name="deploy-the-aspnet-app"></a>Deploy the ASP.NET app
...
## <a name="launch-and-manage-your-umrbaco-web-app"></a>Launch and manage your Umrbaco web app
...
1. Click the notification. If you missed it, you can always access it by clicking the notification bell (![Notification bellow - first Umbraco in Azure App Service](https://docstestmedia1.blob.core.windows.net/azure-media/articles/app-service-web/media/app-service-web-get-started-dotnet-portal/notification.png)).
...
* [Deploy an ASP.NET web app to Azure App Service, using Visual Studio](app-service-web-get-started-dotnet.md) - Learn how to create a new Azure web app from Visual Studio, using any one of the included application templates.
