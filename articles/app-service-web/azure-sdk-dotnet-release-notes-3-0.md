...
---
# <a name="azure-sdk-for-net-30-release-notes"></a>Azure SDK for .NET 3.0 release notes

This topic includes release notes for version 3.0 of the Azure SDK for .NET.

##<a name="azure-sdk-for-net-30-release-summary"></a>Azure SDK for .NET 3.0 release summary
