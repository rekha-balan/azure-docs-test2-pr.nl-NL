...
---
# <a name="configure-php-in-azure-app-service-web-apps"></a>Configure PHP in Azure App Service Web Apps
...
## <a name="how-to-change-the-built-in-php-version"></a>How to: Change the built-in PHP version
...
### <a name="azure-command-line-interface-linux-mac-windows"></a>Azure Command-Line Interface (Linux, Mac, Windows)
...
## <a name="how-to-change-the-built-in-php-configurations"></a>How to: Change the built-in PHP configurations
...
### <a name="changing-phpiniuser-phpiniperdir-phpiniall-configuration-settings"></a>Changing PHP\_INI\_USER, PHP\_INI\_PERDIR, PHP\_INI\_ALL configuration settings
...
### <a name="changing-phpinisystem-configuration-settings"></a>Changing PHP\_INI\_SYSTEM configuration settings
...
## <a name="how-to-enable-extensions-in-the-default-php-runtime"></a>How to: Enable extensions in the default PHP runtime
...
### <a name="configure-via-ini-settings"></a>Configure via ini settings
...
### <a name="configure-via-app-setting"></a>Configure via App Setting
...
## <a name="how-to-use-a-custom-php-runtime"></a>How to: Use a custom PHP runtime
...
## <a name="how-to-enable-composer-automation-in-azure"></a>How to: Enable Composer automation in Azure
By default, App Service doesn't do anything with composer.json, if you have one in your PHP project. If you use [Git deployment](app-service-deploy-local-git.md), you can enable composer.json processing during `git push` by enabling the Composer extension.
...
3. Click **OK** to accept legal terms. Click **OK** again to add the extension.
    ...
    ![Accept legal terms to enable Composer automation in Azure](https://docstestmedia1.blob.core.windows.net/azure-media/articles/app-service-web/media/web-sites-php-configure/composer-extension-view.png)
