...
---
# <a name="create-a-basic-azure-web-app-using-eclipse"></a>Create a basic Azure web app using Eclipse
...
## <a name="starting-stopping-or-restarting-an-existing-web-app"></a>Starting, stopping, or restarting an existing web app
