...
---
# <a name="add-custom-domain-and-ssl-to-an-azure-web-app"></a>Add custom domain and SSL to an Azure web app
...
## <a name="step-1---create-an-azure-web-app"></a>Step 1 - Create an Azure web app
...
## <a name="step-2---configure-dns-mapping"></a>Step 2 - Configure DNS mapping
...
### <a name="navigate-to-to-dns-management-page"></a>Navigate to to DNS management page
...
## <a name="step-3---configure-the-custom-domain-on-your-web-app"></a>Step 3 - Configure the custom domain on your web app
...
## <a name="step-4---bind-a-custom-ssl-certificate-to-your-web-app"></a>Step 4 - Bind a custom SSL certificate to your web app
...
### <a name="upload-the-ssl-certificate"></a>Upload the SSL certificate
...
### <a name="bind-the-uploaded-ssl-certificate-to-the-web-app"></a>Bind the uploaded SSL certificate to the web app
