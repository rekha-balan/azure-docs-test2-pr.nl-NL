...
---
# <a name="build-a-hyper-scale-web-app-in-azure"></a>Build a hyper-scale web app in Azure
...
## <a name="step-1---get-sample-application"></a>Step 1 - Get sample application
In this step, you set up the local ASP.NET project.

### <a name="clone-the-application-repository"></a>Clone the application repository
...
### <a name="run-the-sample-application-in-visual-studio"></a>Run the sample application in Visual Studio
...
## <a name="step-2---deploy-to-azure"></a>Step 2 - Deploy to Azure
...
### <a name="set-deployment-credentials"></a>Set deployment credentials
...
### <a name="deploy-the-sample-application"></a>Deploy the sample application
...
### <a name="browse-to-azure-web-app"></a>Browse to Azure web app
...
## <a name="step-3---connect-to-redis"></a>Step 3 - Connect to Redis
...
### <a name="configure-the-application-to-use-redis"></a>Configure the application to use Redis
...
### <a name="configure-the-connection-string-in-azure"></a>Configure the connection string in Azure
...
### <a name="redeploy-the-application-to-azure"></a>Redeploy the application to Azure
...
### <a name="browse-to-the-azure-web-app"></a>Browse to the Azure web app
...
## <a name="step-4---scale-to-multiple-instances"></a>Step 4 - Scale to multiple instances
...
## <a name="step-5---scale-geographically"></a>Step 5 - Scale geographically
...
### <a name="scale-up-the-europe-app-to-standard-tier"></a>Scale up the Europe app to Standard tier
...
### <a name="get-the-resource-id-of-the-europe-app"></a>Get the resource ID of the Europe app
...
### <a name="add-a-traffic-manager-endpoint-for-the-europe-app"></a>Add a Traffic Manager endpoint for the Europe app
...
### <a name="get-the-traffic-manager-endpoint-url"></a>Get the Traffic Manager endpoint URL
...
### <a name="create-an-azure-redis-cache-in-asia"></a>Create an Azure Redis Cache in Asia
...
### <a name="create-an-app-service-plan-in-asia"></a>Create an App Service plan in Asia
...
### <a name="create-a-web-app-in-asia"></a>Create a web app in Asia
...
### <a name="configure-the-connection-string-for-redis"></a>Configure the connection string for Redis
...
### <a name="configure-git-deployment-for-the-asia-app"></a>Configure Git deployment for the Asia app.
...
### <a name="deploy-your-sample-application"></a>Deploy your sample application
...
### <a name="browse-to-the-asia-app"></a>Browse to the Asia app
...
### <a name="get-the-resource-id-of-the-asia-app"></a>Get the resource ID of the Asia app
...
### <a name="add-a-traffic-manager-endpoint-for-the-asia-app"></a>Add a Traffic Manager endpoint for the Asia app
...
### <a name="add-region-identifier-to-web-apps"></a>Add region identifier to web apps
