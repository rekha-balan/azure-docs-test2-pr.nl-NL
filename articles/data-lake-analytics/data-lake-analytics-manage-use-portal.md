...
---
# <a name="manage-azure-data-lake-analytics-using-the-azure-portal"></a>Manage Azure Data Lake Analytics using the Azure portal
...
## <a name="manage-data-lake-analytics-accounts"></a>Manage Data Lake Analytics accounts
...
### <a name="delete-a-data-lake-analytics-account"></a>Delete a Data Lake Analytics account
...
### <a name="add-a-data-source"></a>Add a data source
...
## <a name="set-up-firewall-rules"></a>Set up firewall rules
...
### <a name="set-up-a-firewall-rule"></a>Set up a firewall rule
...
### <a name="add-users-or-security-groups-to-a-data-lake-analytics-account"></a>Add users or security groups to a Data Lake Analytics account
...
### <a name="monitoring-pipeline-jobs"></a>Monitoring pipeline jobs
...
### <a name="monitoring-recurring-jobs"></a>Monitoring recurring jobs
