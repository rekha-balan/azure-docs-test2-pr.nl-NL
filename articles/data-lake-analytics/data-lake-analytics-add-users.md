...
---
# <a name="adding-a-user-in-the-azure-portal"></a>Adding a user in the Azure portal

## <a name="start-the-add-user-wizard"></a>Start the Add User Wizard
...
## <a name="configure-acls-for-data-folders"></a>Configure ACLs for data folders
Grant "R-X" or "RWX", as needed, on folders containing input data and output data.


## <a name="optionally-add-the-user-to-the-azure-data-lake-store-role-reader-role"></a>Optionally, add the user to the Azure Data Lake Store role **Reader** role.
...
## <a name="adding-a-user-using-powershell"></a>Adding a user using PowerShell
