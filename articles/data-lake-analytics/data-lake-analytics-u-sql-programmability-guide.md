...
---
# <a name="u-sql-programmability-guide"></a>U-SQL programmability guide
...
## <a name="get-started-with-u-sql"></a>Get started with U-SQL  
...
## <a name="c-types-and-expressions-in-u-sql-script"></a>C# types and expressions in U-SQL script
...
### <a name="use-c-expressions-for-data-type-conversions"></a>Use C# expressions for data type conversions
...
### <a name="use-c-expressions-for-todays-date"></a>Use C# expressions for today’s date
...
## <a name="use-inline-c-function-expressions"></a>Use inline C# function expressions
...
## <a name="verify-data-type-values"></a>Verify data type values
...
### <a name="use-inline-function-expressions"></a>Use inline function expressions
...
### <a name="use-code-behind"></a>Use code-behind
...
## <a name="register-u-sql-assemblies"></a>Register U-SQL assemblies
...
### <a name="learn-the-difference-between-code-behind-and-assembly-registration-through-azure-data-lake-tools-in-visual-studio"></a>Learn the difference between code-behind and assembly registration through Azure Data Lake Tools in Visual Studio
...
![Code-behind example](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-lake-analytics/media/data-lake-analytics-u-sql-programmability-guide/code-behind-example.jpg)
...
![Creating project](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-lake-analytics/media/data-lake-analytics-u-sql-programmability-guide/creating-project.png)
**Figure 3**: Creating a U-SQL C# code project  
<br />

![Class library](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-lake-analytics/media/data-lake-analytics-u-sql-programmability-guide/class-library.png)
**Figure 4**: The U-SQL C# class library next to the code-behind file
<br />

![Register code](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-lake-analytics/media/data-lake-analytics-u-sql-programmability-guide/register-code.png)
...
### <a name="register-assemblies-via-azure-data-lake-tools-in-visual-studio-and-in-u-sql-scripts"></a>Register assemblies via Azure Data Lake Tools in Visual Studio and in U-SQL scripts
...
### <a name="register-assemblies-that-use-other-net-assemblies-based-on-the-json-and-xml-sample-library"></a>Register assemblies that use other .NET assemblies (based on the JSON and XML sample library)
...
### <a name="register-assemblies-that-use-native-c-assemblies-using-the-sql-server-2016-spatial-type-assembly-from-the-feature-pack"></a>Register assemblies that use native C++ assemblies (using the SQL Server 2016 spatial type assembly from the feature pack)
...
### <a name="use-assembly-versioning"></a>Use assembly versioning
...
## <a name="use-user-defined-functions-udf"></a>Use user-defined functions: UDF
...
### <a name="keep-state-between-udf-invocations"></a>Keep state between UDF invocations
...
## <a name="use-user-defined-types-udt"></a>Use user-defined types: UDT
...
## <a name="use-user-defined-aggregates-udagg"></a>Use user-defined aggregates: UDAGG
...
### <a name="use-udagg-in-u-sql"></a>Use UDAGG in U-SQL
...
## <a name="use-user-defined-objects-udo"></a>Use user-defined objects: UDO
...
## <a name="use-user-defined-extractors"></a>Use user-defined extractors
...
## <a name="use-user-defined-outputters"></a>Use user-defined outputters
...
### <a name="set-headers-and-footers-for-user-defined-outputter"></a>Set headers and footers for user-defined outputter
...
### <a name="call-outputter-from-u-sql-base-script"></a>Call outputter from U-SQL base script
...
## <a name="use-user-defined-processors"></a>Use user-defined processors
...
## <a name="use-user-defined-appliers"></a>Use user-defined appliers
...
## <a name="use-user-defined-combiners"></a>Use user-defined combiners
...
* Right (2)     Every output row depends on a single input row from the right (and potentially all rows       from the left with the same key value).
...
## <a name="use-user-defined-reducers"></a>Use user-defined reducers
