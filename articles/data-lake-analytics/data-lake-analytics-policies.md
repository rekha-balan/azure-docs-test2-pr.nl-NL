...
---
# <a name="manage-azure-data-lake-analytics-using-policies"></a>Manage Azure Data Lake Analytics using policies
...
## <a name="account-level-policies"></a>Account-level policies

These policies apply to all jobs in a Data Lake Analytics account.

### <a name="maximum-number-of-aus-in-a-data-lake-analytics-account"></a>Maximum number of AUs in a Data Lake Analytics account
...
### <a name="maximum-number-of-jobs-that-can-run-simultaneously"></a>Maximum number of jobs that can run simultaneously
...
### <a name="how-long-to-keep-job-metadata-and-resources"></a>How long to keep job metadata and resources 
...
## <a name="job-level-policies"></a>Job-level policies
...
### <a name="add-a-policy-for-a-specific-user-or-group"></a>Add a policy for a specific user or group
...
### <a name="delete-or-edit-an-existing-policy"></a>Delete or edit an existing policy
...
## <a name="additional-resources-for-job-policies"></a>Additional resources for job policies
