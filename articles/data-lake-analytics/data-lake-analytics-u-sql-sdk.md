...
---
# <a name="scale-u-sql-local-run-and-test-with-azure-data-lake-u-sql-sdk"></a>Scale U-SQL local run and test with Azure Data Lake U-SQL SDK
...
## <a name="install-azure-data-lake-u-sql-sdk"></a>Install Azure Data Lake U-SQL SDK
...
### <a name="file-path-in-u-sql"></a>File path in U-SQL
...
## <a name="use-the-sdk-from-the-command-line"></a>Use the SDK from the command line

### <a name="command-line-interface-of-the-helper-application"></a>Command-line interface of the helper application
...
### <a name="return-value-and-logging"></a>Return value and logging
...
### <a name="environment-variable-configuring"></a>Environment variable configuring
...
### <a name="sdk-command-line-usage-samples"></a>SDK command line usage samples

#### <a name="compile-and-run"></a>Compile and run
...
#### <a name="compile-a-u-sql-script"></a>Compile a U-SQL script
...
#### <a name="execute-compiled-results"></a>Execute compiled results
...
## <a name="use-the-sdk-with-programming-interfaces"></a>Use the SDK with programming interfaces
...
### <a name="step-1-create-c-unit-test-project-and-configuration"></a>Step 1: Create C# unit test project and configuration
...
### <a name="step-2-create-u-sql-script-test-case"></a>Step 2: Create U-SQL script test case
...
## <a name="faq-about-common-issue"></a>FAQ about common issue
