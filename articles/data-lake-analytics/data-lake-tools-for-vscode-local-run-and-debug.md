...
---
# <a name="run-u-sql-and-debug-locally-in-visual-studio-code"></a>Run U-SQL and debug locally in Visual Studio Code
...
## <a name="set-up-the-u-sql-local-run-environment"></a>Set up the U-SQL local run environment
...
## <a name="start-the-local-run-service-and-submit-the-u-sql-job-to-a-local-account"></a>Start the local run service and submit the U-SQL job to a local account 
...
## <a name="start-a-local-debug-for-the-u-sql-job"></a>Start a local debug for the U-SQL job  
