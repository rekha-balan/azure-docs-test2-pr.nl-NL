...
---
# <a name="tutorial-get-started-with-azure-data-lake-analytics-using-python"></a>Tutorial: get started with Azure Data Lake Analytics using Python
...
The azure-mgmt-datalake-store module includes the Azure Data Lake Store account management operations. The azure-mgmt-resource module includes other Azure modules for Active Directory, etc. The azure-datalake-store module includes the Azure Data Lake Store filesystem operations. The azure-datalake-analytics module includes the Azure Data Lake Analytics operations. Use the following commands to install the modules.
...
## <a name="create-a-python-application"></a>Create a Python application
...
## <a name="create-resource-management-group"></a>Create Resource Management group
...
## <a name="create-data-lake-store-account"></a>Create Data Lake Store account
