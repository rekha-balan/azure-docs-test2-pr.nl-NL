...
---
# <a name="tutorial-get-started-with-the-cognitive-capabilities-of-u-sql"></a>Tutorial: Get started with the Cognitive capabilities of U-SQL
...
## <a name="imaging-scenarios"></a>Imaging Scenarios

### <a name="a-simple-example-image-tagging"></a>A Simple Example: Image Tagging
...
### <a name="extract-emotions-from-human-faces"></a>Extract emotions from human faces 
...
### <a name="estimate-age-and-gender-for-human-faces"></a>Estimate age and gender for human faces
...
### <a name="detect-text-in-images-ocr"></a>Detect text in Images (OCR)
...
## <a name="text-scenarios"></a>Text Scenarios
...
### <a name="extract-key-phrases-for-each-paragraph"></a>Extract key phrases for each paragraph.
...
### <a name="perform-sentiment-analysis-on-each-paragraph"></a>Perform sentiment analysis on each paragraph
