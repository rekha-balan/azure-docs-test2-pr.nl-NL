...
---
# <a name="troubleshoot-an-abnormal-recurring-job"></a>Troubleshoot an abnormal recurring job
...
## <a name="step-1-find-recurring-jobs-and-open-related-job-view"></a>Step 1: Find recurring jobs and open Related Job View
...
### <a name="case-1-you-have-the-url-for-the-recurring-job"></a>Case 1: You have the URL for the recurring job
...
### <a name="case-2-you-have-the-pipeline-for-the-recurring-job-but-not-the-url"></a>Case 2: You have the pipeline for the recurring job, but not the URL
...
## <a name="step-2-analyze-a-statistics-report"></a>Step 2: Analyze a statistics report
...
## <a name="step-3-compare-the-abnormal-job-to-a-normal-job"></a>Step 3: Compare the abnormal job to a normal job
