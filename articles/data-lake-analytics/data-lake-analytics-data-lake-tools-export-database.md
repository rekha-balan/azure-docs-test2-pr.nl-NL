...
---
# <a name="export-a-u-sql-database"></a>Export a U-SQL database
...
### <a name="step-1-export-the-database-in-server-explorer"></a>Step 1: Export the database in Server Explorer
...
### <a name="step-2-configure-the-objects-that-you-want-to-export"></a>Step 2: Configure the objects that you want to export
...
### <a name="step-3-check-the-objects-list-and-other-configurations"></a>Step 3: Check the objects list and other configurations
...
### <a name="step-4-check-the-export-results"></a>Step 4: Check the export results
...
## <a name="import-the-exported-database-to-a-local-account"></a>Import the exported database to a local account
...
## <a name="import-the-exported-database-to-a-data-lake-analytics-account"></a>Import the exported database to a Data Lake Analytics account
