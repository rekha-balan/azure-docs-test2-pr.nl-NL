...
---
# <a name="schedule-u-sql-jobs-using-sql-server-integration-services-ssis"></a>Schedule U-SQL jobs using SQL Server Integration Services (SSIS)
...
## <a name="scenario-1-use-inline-script-call-tvfs-and-stored-procs"></a>Scenario 1-Use inline script call tvfs and stored procs
...
## <a name="scenario-2-use-u-sql-files-in-azure-data-lake-store"></a>Scenario 2-Use U-SQL files in Azure Data Lake Store
...
### <a name="set-task-control-flow"></a>Set task control flow
...
### <a name="configure-foreach-loop-container"></a>Configure Foreach Loop Container
...
## <a name="scenario-3-use-u-sql-files-in-azure-blob-storage"></a>Scenario 3-Use U-SQL files in Azure Blob Storage
...
## <a name="scenario-4-use-u-sql-files-on-the-local-machine"></a>Scenario 4-Use U-SQL files on the local machine
...
## <a name="scenario-5-use-u-sql-statement-in-ssis-variable"></a>Scenario 5-Use U-SQL statement in SSIS variable
...
## <a name="scenario-6-pass-parameters-to-u-sql-script"></a>Scenario 6-Pass parameters to U-SQL script
