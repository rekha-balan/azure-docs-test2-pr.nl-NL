...
## <a name="client-management-objects"></a>Client management objects
...
### <a name="data-lake-store-management-client-objects"></a>Data Lake Store management client objects:
...
### <a name="data-lake-analytics-management-client-objects"></a>Data Lake Analytics management client objects:
...
## <a name="authenticate-and-connect-to-azure-data-lake-analytics"></a>Authenticate and connect to Azure Data Lake Analytics
You have multiple options for logging on to Azure Data Lake Analytics.

### <a name="interactive-with-provided-credentials"></a>Interactive with provided credentials
...
### <a name="non-interactive-with-a-client-secret"></a>Non-interactive with a client secret
...
### <a name="non-interactive-with-a-service-principal"></a>Non-interactive with a service principal
...
### <a name="list-data-lake-store-and-data-lake-analytics-accounts"></a>List Data Lake Store and Data Lake Analytics accounts
...
### <a name="get-an-account"></a>Get an account
...
### <a name="get-the-default-data-lake-store-account"></a>Get the default Data Lake Store account
...
When you create an Analytics account, you must designate an Azure Data Lake Store account to be the default Data Lake Store account. The default Data Lake Store account is used to store job metadata and job audit logs. After you have created an Analytics account, you can add additional Data Lake Store and links to Azure Storage (blobs) accounts.

### <a name="link-to-an-azure-storage-account-from-a-data-lake-analytics-account"></a>Link to an Azure Storage account from a Data Lake Analytics account
...
### <a name="list-data-lake-store-data-sources"></a>List Data Lake Store data sources
...
### <a name="upload-and-download-folders-and-files"></a>Upload and download folders and files
...
### <a name="create-a-file-in-a-data-lake-store-account"></a>Create a file in a Data Lake Store account
...
### <a name="list-blob-containers-of-an-azure-storage-account"></a>List blob containers of an Azure Storage account
...
### <a name="verify-azure-storage-account-paths"></a>Verify Azure Storage account paths
...
## <a name="manage-catalog-and-jobs"></a>Manage catalog and jobs
...
### <a name="list-databases-and-schemas"></a>List databases and schemas
...
### <a name="list-table-columns"></a>List table columns
...
### <a name="list-failed-jobs"></a>List failed jobs
