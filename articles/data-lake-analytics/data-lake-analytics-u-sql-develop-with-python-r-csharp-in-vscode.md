...
---
# <a name="develop-u-sql-with-python-r-and-c-for-azure-data-lake-analytics-in-visual-studio-code"></a>Develop U-SQL with Python, R, and C# for Azure Data Lake Analytics in Visual Studio Code
...
## <a name="prerequisites-for-python-and-r"></a>Prerequisites for Python and R
...
## <a name="develop-python-file"></a>Develop Python file
...
## <a name="develop-r-file"></a>Develop R file
1. Click the **New File** in your workspace.
...
## <a name="develop-c-file"></a>Develop C# file
