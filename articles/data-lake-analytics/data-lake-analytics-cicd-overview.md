...
---
# <a name="how-to-set-up-a-cicd-pipeline-for-azure-data-lake-analytics"></a>How to set up a CI/CD pipeline for Azure Data Lake Analytics  
...
## <a name="use-cicd-for-u-sql-jobs"></a>Use CI/CD for U-SQL jobs
...
## <a name="build-a-u-sql-project"></a>Build a U-SQL project
...
### <a name="project-migration"></a>Project migration
...
### <a name="manage-u-sql-database-references"></a>Manage U-SQL database references
...
### <a name="build-a-u-sql-project-with-the-msbuild-command-line"></a>Build a U-SQL project with the MSBuild command line
...
### <a name="continuous-integration-with-azure-devops"></a>Continuous integration with Azure DevOps
...
### <a name="u-sql-project-build-output"></a>U-SQL project build output
...
## <a name="test-u-sql-scripts"></a>Test U-SQL scripts
...
## <a name="deploy-a-u-sql-job"></a>Deploy a U-SQL job
...
### <a name="submit-u-sql-jobs-through-azure-devops"></a>Submit U-SQL jobs through Azure DevOps
...
### <a name="deploy-u-sql-jobs-through-azure-data-factory"></a>Deploy U-SQL jobs through Azure Data Factory
...
## <a name="cicd-for-a-u-sql-database"></a>CI/CD for a U-SQL database
...
## <a name="build-u-sql-database-project"></a>Build U-SQL database project

### <a name="get-the-nuget-package"></a>Get the NuGet package
...
### <a name="build-u-sql-a-database-project-with-the-msbuild-command-line"></a>Build U-SQL a database project with the MSBuild command line
...
### <a name="u-sql-database-project-build-output"></a>U-SQL database project build output
...
## <a name="test-table-valued-functions-and-stored-procedures"></a>Test table-valued functions and stored procedures
...
## <a name="deploy-u-sql-database-through-azure-devops"></a>Deploy U-SQL database through Azure DevOps
...
### <a name="packagedeploymenttoolexe-parameter-descriptions"></a>PackageDeploymentTool.exe parameter descriptions
...
#### <a name="parameter-for-local-deployment"></a>Parameter for local deployment

|Parameter|Description|Default Value|Required|
|---------|-----------|-------------|--------|
|DataRoot|The path of the local data root folder.|null|true|

#### <a name="parameters-for-azure-data-lake-analytics-deployment"></a>Parameters for Azure Data Lake Analytics deployment
