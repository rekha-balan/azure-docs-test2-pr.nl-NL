...
---
# <a name="configure-user-access-to-job-information-to-job-information-in-azure-data-lake-analytics"></a>Configure user access to job information to job information in Azure Data Lake Analytics 
...
## <a name="configure-user-access-to-job-information"></a>Configure user access to job information
