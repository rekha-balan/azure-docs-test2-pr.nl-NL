...
---
# <a name="access-key-vault-secret-when-deploying-azure-managed-applications"></a>Access Key Vault secret when deploying Azure Managed Applications
...
## <a name="enable-template-deployment"></a>Enable template deployment
...
## <a name="add-service-as-contributor"></a>Add service as contributor
...
## <a name="reference-key-vault-secret"></a>Reference Key Vault secret
