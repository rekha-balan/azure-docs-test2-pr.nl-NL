...
---
# <a name="azure-managed-applications-in-the-marketplace"></a>Azure managed applications in the Marketplace
...
## <a name="prerequisites-for-publishing-a-managed-application"></a>Prerequisites for publishing a managed application
...
## <a name="become-a-publisher"></a>Become a publisher
...
## <a name="create-a-new-azure-application-offer"></a>Create a new Azure application offer

After creating your partner portal account, you're ready to create your managed application offer.

### <a name="set-up-an-offer"></a>Set up an offer
...
## <a name="offer-settings-form"></a>Offer Settings form
...
## <a name="marketplace-form"></a>Marketplace form
...
### <a name="preview-subscription-ids"></a>Preview subscription IDs
...
### <a name="suggested-categories"></a>Suggested categories
...
#### <a name="logo-guidelines"></a>Logo guidelines
...
## <a name="support-form"></a>Support form
...
## <a name="publish-an-offer"></a>Publish an offer
