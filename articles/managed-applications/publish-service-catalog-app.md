...
---
# <a name="publish-a-managed-application-for-internal-consumption"></a>Publish a managed application for internal consumption
...
## <a name="create-the-resource-template"></a>Create the resource template
...
## <a name="create-the-user-interface-definition"></a>Create the user interface definition
...
## <a name="package-the-files"></a>Package the files
...
### <a name="create-an-azure-active-directory-user-group-or-application"></a>Create an Azure Active Directory user group or application
...
### <a name="get-the-role-definition-id"></a>Get the role definition ID
...
### <a name="make-sure-users-can-see-your-definition"></a>Make sure users can see your definition
...
## <a name="create-the-managed-application"></a>Create the managed application
