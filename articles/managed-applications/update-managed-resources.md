...
---
# <a name="work-with-resources-in-the-managed-resource-group-for-azure-managed-application"></a>Work with resources in the managed resource group for Azure managed application
...
## <a name="get-managed-application-and-managed-resource-group"></a>Get managed application and managed resource group
...
## <a name="resize-vms-in-managed-resource-group"></a>Resize VMs in managed resource group
...
## <a name="apply-policy-to-managed-resource-group"></a>Apply policy to managed resource group
