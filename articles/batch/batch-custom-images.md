...
---
# <a name="use-a-managed-custom-image-to-create-a-pool-of-virtual-machines"></a>Use a managed custom image to create a pool of virtual machines 
...
## <a name="why-use-a-custom-image"></a>Why use a custom image?
...
## <a name="prepare-a-custom-image"></a>Prepare a custom image
...
### <a name="to-create-a-managed-image"></a>To create a managed image
...
## <a name="create-a-pool-from-a-custom-image-in-the-portal"></a>Create a pool from a custom image in the portal
