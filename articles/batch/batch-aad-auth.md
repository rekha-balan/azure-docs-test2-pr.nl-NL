...
---
# <a name="authenticate-from-batch-solutions-with-active-directory"></a>Authenticate from Batch solutions with Active Directory
...
## <a name="use-azure-ad-with-batch-management-solutions"></a>Use Azure AD with Batch management solutions
...
### <a name="register-your-application-with-azure-ad"></a>Register your application with Azure AD
...
### <a name="update-your-code-to-reference-your-application-id"></a>Update your code to reference your application ID 
...
### <a name="grant-the-azure-resource-manager-api-access-to-your-application"></a>Grant the Azure Resource Manager API access to your application
...
### <a name="acquire-an-azure-ad-authentication-token"></a>Acquire an Azure AD authentication token
...
## <a name="use-azure-ad-with-batch-service-solutions"></a>Use Azure AD with Batch service solutions
...
### <a name="batch-service-endpoints"></a>Batch service endpoints
...
### <a name="grant-the-batch-service-api-access-to-your-application"></a>Grant the Batch service API access to your application
...
### <a name="authentication-for-batch-accounts-in-a-user-subscription"></a>Authentication for Batch accounts in a user subscription
...
### <a name="best-practices-for-using-azure-ad-with-batch"></a>Best practices for using Azure AD with Batch
...
### <a name="code-example-using-azure-ad-with-batch-net"></a>Code example: Using Azure AD with Batch .NET
