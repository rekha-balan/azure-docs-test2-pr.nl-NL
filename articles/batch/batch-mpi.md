...
---
# <a name="use-multi-instance-tasks-to-run-message-passing-interface-mpi-applications-in-batch"></a>Use multi-instance tasks to run Message Passing Interface (MPI) applications in Batch
