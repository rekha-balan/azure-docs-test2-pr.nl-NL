...
---
# <a name="using-azure-batch-rendering"></a>Using Azure Batch rendering
...
## <a name="using-batch-explorer"></a>Using Batch Explorer
...
### <a name="using-templates-to-create-pools-and-run-jobs"></a>Using templates to create pools and run jobs
...
### <a name="file-system-and-data-movement"></a>File system and data movement

The ‘Data’ section in Batch Explorer allows files to be copied between a local file system and Azure Storage accounts.

## <a name="client-application-plug-ins"></a>Client application plug-ins
