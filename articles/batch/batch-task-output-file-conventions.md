...
---
# <a name="persist-job-and-task-data-to-azure-storage-with-the-batch-file-conventions-library-for-net"></a>Persist job and task data to Azure Storage with the Batch File Conventions library for .NET 
...
## <a name="when-do-i-use-the-file-conventions-library-to-persist-task-output"></a>When do I use the File Conventions library to persist task output?
...
## <a name="what-is-the-batch-file-conventions-standard"></a>What is the Batch File Conventions standard?
...
## <a name="link-an-azure-storage-account-to-your-batch-account"></a>Link an Azure Storage account to your Batch account
...
## <a name="persist-output-data"></a>Persist output data
...
## <a name="retrieve-output-data"></a>Retrieve output data
...
## <a name="view-output-files-in-the-azure-portal"></a>View output files in the Azure portal
...
### <a name="get-the-batch-file-conventions-library-for-net"></a>Get the Batch File Conventions library for .NET
...
### <a name="explore-other-approaches-for-persisting-output-data"></a>Explore other approaches for persisting output data
