...
---
# <a name="provision-linux-compute-nodes-in-batch-pools"></a>Provision Linux compute nodes in Batch pools
...
## <a name="connect-to-linux-nodes-using-ssh"></a>Connect to Linux nodes using SSH
