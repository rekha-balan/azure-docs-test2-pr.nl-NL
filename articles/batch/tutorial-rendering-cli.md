...
---
# <a name="tutorial-render-a-scene-with-azure-batch"></a>Tutorial: Render a scene with Azure Batch 
...
az batch account login \
    ...
    --shared-key-auth
```
## <a name="upload-a-scene-to-storage"></a>Upload a scene to storage
...
## <a name="create-a-rendering-pool"></a>Create a rendering pool
...
## <a name="create-a-blob-container-for-output"></a>Create a blob container for output
...
## <a name="render-a-single-frame-scene"></a>Render a single-frame scene
...
### <a name="create-a-task"></a>Create a task
...
## <a name="scale-the-pool"></a>Scale the pool
...
## <a name="render-a-multiframe-scene"></a>Render a multiframe scene
