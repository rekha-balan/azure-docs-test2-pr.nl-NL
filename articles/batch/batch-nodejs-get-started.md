...
---
# <a name="get-started-with-batch-sdk-for-nodejs"></a>Get started with Batch SDK for Node.js
...
## <a name="the-tutorial-scenario"></a>The tutorial scenario
...
## <a name="azure-batch-architecture"></a>Azure Batch Architecture
...
### <a name="step-1-install-azure-batch-sdk"></a>Step 1: Install Azure Batch SDK
...
### <a name="step-2-create-an-azure-batch-account"></a>Step 2: Create an Azure Batch account
...
### <a name="step-3-create-an-azure-batch-service-client"></a>Step 3: Create an Azure Batch service client
...
### <a name="step-4-create-an-azure-batch-pool"></a>Step 4: Create an Azure Batch pool
...
### <a name="step-4-submit-an-azure-batch-job"></a>Step 4: Submit an Azure Batch job
...
#### <a name="preparation-task"></a>Preparation task
...
### <a name="step-5-submit-azure-batch-tasks-for-a-job"></a>Step 5: Submit Azure Batch tasks for a job
