...
---
# <a name="choose-a-vm-size-for-compute-nodes-in-an-azure-batch-pool"></a>Choose a VM size for compute nodes in an Azure Batch pool
...
## <a name="supported-vm-families-and-sizes"></a>Supported VM families and sizes

### <a name="pools-in-virtual-machine-configuration"></a>Pools in Virtual Machine configuration
...
### <a name="pools-in-cloud-service-configuration"></a>Pools in Cloud Service configuration
...
## <a name="restricted-vm-families"></a>Restricted VM families
...
## <a name="size-considerations"></a>Size considerations
