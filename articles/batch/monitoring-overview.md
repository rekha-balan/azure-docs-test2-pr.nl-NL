...
---
# <a name="monitor-batch-solutions"></a>Monitor Batch solutions
...
## <a name="subscription-level-monitoring"></a>Subscription-level monitoring
...
## <a name="batch-account-level-monitoring"></a>Batch account-level monitoring
...
## <a name="batch-resource-monitoring"></a>Batch resource monitoring
...
## <a name="vm-performance-counters-and-application-monitoring"></a>VM performance counters and application monitoring
