...
---
# <a name="create-an-automatic-scaling-formula-for-scaling-compute-nodes-in-a-batch-pool"></a>Create an automatic scaling formula for scaling compute nodes in a Batch pool
...
### <a name="sample-autoscale-formula"></a>Sample autoscale formula
...
## <a name="create-an-autoscale-enabled-pool-with-net"></a>Create an autoscale-enabled pool with .NET
