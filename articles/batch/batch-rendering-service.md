...
---
# <a name="rendering-using-azure"></a>Rendering using Azure
...
## <a name="why-use-azure-for-rendering"></a>Why use Azure for rendering?
...
## <a name="options-for-rendering-on-azure"></a>Options for rendering on Azure
...
### <a name="existing-on-premises-rendering-environment-using-a-render-management-application"></a>Existing on-premises rendering environment using a render management application
...
### <a name="custom-rendering-workflow"></a>Custom rendering workflow
...
### <a name="no-existing-render-farm"></a>No existing render farm
...
## <a name="getting-started-with-azure-batch-rendering"></a>Getting started with Azure Batch rendering
