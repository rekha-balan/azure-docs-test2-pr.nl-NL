...
---
# <a name="use-rdma-capable-or-gpu-enabled-instances-in-batch-pools"></a>Use RDMA-capable or GPU-enabled instances in Batch pools
...
## <a name="subscription-and-account-limits"></a>Subscription and account limits
...
### <a name="linux-pools---virtual-machine-configuration"></a>Linux pools - Virtual machine configuration
...
### <a name="windows-pools---virtual-machine-configuration"></a>Windows pools - Virtual machine configuration
...
### <a name="windows-pools---cloud-services-configuration"></a>Windows pools - Cloud services configuration
...
## <a name="pool-configuration-options"></a>Pool configuration options
...
## <a name="example-microsoft-mpi-on-an-a8-vm-pool"></a>Example: Microsoft MPI on an A8 VM pool
...
## <a name="example-nvidia-tesla-drivers-on-nc-vm-pool"></a>Example: NVIDIA Tesla drivers on NC VM pool
