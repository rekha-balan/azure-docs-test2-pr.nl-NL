...
---
# <a name="run-container-applications-on-azure-batch"></a>Run container applications on Azure Batch
...
## <a name="why-use-containers"></a>Why use containers?
...
## <a name="supported-virtual-machine-images"></a>Supported virtual machine images
...
## <a name="container-configuration-for-batch-pool"></a>Container configuration for Batch pool
...
### <a name="pool-without-prefetched-container-images"></a>Pool without prefetched container images
...
### <a name="prefetch-images-for-container-configuration"></a>Prefetch images for container configuration
...
### <a name="prefetch-images-from-a-private-container-registry"></a>Prefetch images from a private container registry
...
## <a name="container-settings-for-the-task"></a>Container settings for the task
