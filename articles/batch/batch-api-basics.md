...
---
# <a name="develop-large-scale-parallel-compute-solutions-with-batch"></a>Develop large-scale parallel compute solutions with Batch
...
## <a name="pool-network-configuration"></a>Pool network configuration
...
### <a name="vnets-for-pools-provisioned-in-the-batch-service"></a>VNets for pools provisioned in the Batch service
...
### <a name="vnets-for-pools-provisioned-in-a-user-subscription"></a>VNets for pools provisioned in a user subscription
...
### <a name="troubleshooting-problematic-compute-nodes"></a>Troubleshooting problematic compute nodes
