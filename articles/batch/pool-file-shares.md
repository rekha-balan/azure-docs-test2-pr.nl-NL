...
---
# <a name="use-an-azure-file-share-with-a-batch-pool"></a>Use an Azure file share with a Batch pool
...
## <a name="considerations-for-use-with-batch"></a>Considerations for use with Batch
...
## <a name="mount-a-share-on-a-windows-pool"></a>Mount a share on a Windows pool
...
## <a name="mount-a-share-on-a-linux-pool"></a>Mount a share on a Linux pool
