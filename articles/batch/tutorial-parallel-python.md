...
---
# <a name="tutorial-run-a-parallel-workload-with-azure-batch-using-the-python-api"></a>Tutorial: Run a parallel workload with Azure Batch using the Python API
