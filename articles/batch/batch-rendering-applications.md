...
---
# <a name="pre-installed-applications-on-rendering-vm-images"></a>Pre-installed applications on rendering VM images
...
## <a name="applications-on-centos-7-rendering-nodes"></a>Applications on CentOS 7 rendering nodes
...
## <a name="applications-on-windows-server-2016-rendering-nodes"></a>Applications on Windows Server 2016 rendering nodes
