...
---
# <a name="submit-a-large-number-of-tasks-to-a-batch-job"></a>Submit a large number of tasks to a Batch job
...
## <a name="use-task-collections"></a>Use task collections
...
## <a name="increase-throughput-of-task-submission"></a>Increase throughput of task submission
...
## <a name="example-batch-net"></a>Example: Batch .NET
...
## <a name="example-batch-cli-extension"></a>Example: Batch CLI extension
...
## <a name="example-batch-python-sdk-extension"></a>Example: Batch Python SDK extension
