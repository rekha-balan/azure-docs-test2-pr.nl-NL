...
---
# <a name="tutorial-run-a-parallel-workload-with-azure-batch-using-the-net-api"></a>Tutorial: Run a parallel workload with Azure Batch using the .NET API
...
## <a name="add-an-application-package"></a>Add an application package
...
## <a name="download-and-run-the-sample"></a>Download and run the sample
...
### <a name="build-and-run-the-sample-project"></a>Build and run the sample project
...
### <a name="authenticate-blob-and-batch-clients"></a>Authenticate Blob and Batch clients
...
### <a name="upload-input-files"></a>Upload input files
...
### <a name="monitor-tasks"></a>Monitor tasks
