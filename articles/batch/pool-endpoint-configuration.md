...
---
# <a name="configure-or-disable-remote-access-to-compute-nodes-in-an-azure-batch-pool"></a>Configure or disable remote access to compute nodes in an Azure Batch pool
...
## <a name="about-the-pool-endpoint-configuration"></a>About the pool endpoint configuration
...
## <a name="example-deny-all-rdp-traffic"></a>Example: Deny all RDP traffic
...
## <a name="example-deny-all-ssh-traffic-from-the-internet"></a>Example: Deny all SSH traffic from the internet
...
## <a name="example-allow-rdp-traffic-from-a-specific-ip-address"></a>Example: Allow RDP traffic from a specific IP address
...
## <a name="example-allow-ssh-traffic-from-a-specific-subnet"></a>Example: Allow SSH traffic from a specific subnet
