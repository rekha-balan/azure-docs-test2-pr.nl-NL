...
---
# <a name="monitor-batch-solutions-by-counting-tasks-and-nodes-by-state"></a>Monitor Batch solutions by counting tasks and nodes by state
...
## <a name="task-state-counts"></a>Task state counts
...
## <a name="node-state-counts"></a>Node state counts
