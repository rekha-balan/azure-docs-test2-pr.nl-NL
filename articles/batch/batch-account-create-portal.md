...
---
# <a name="create-a-batch-account-with-the-azure-portal"></a>Create a Batch account with the Azure portal
...
## <a name="additional-configuration-for-user-subscription-mode"></a>Additional configuration for user subscription mode
...
### <a name="allow-azure-batch-to-access-the-subscription-one-time-operation"></a>Allow Azure Batch to access the subscription (one-time operation)
