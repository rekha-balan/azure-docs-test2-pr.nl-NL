...
---
# <a name="quickstart-run-your-first-batch-job-with-the-azure-cli"></a>Quickstart: Run your first Batch job with the Azure CLI
...
## <a name="view-task-status"></a>View task status
