...
---
# <a name="use-azure-batch-cli-templates-and-file-transfer"></a>Use Azure Batch CLI templates and file transfer
...
Batch templates build on the [existing Batch support in the Azure CLI](batch-cli-get-started.md#json-files-for-resource-creation) for JSON files to specify property values when creating pools, jobs, tasks, and other items. Batch templates add the following capabilities:
...
For example, [ffmpeg](http://ffmpeg.org/) is a popular application that processes audio and video files. Here are steps with the Azure Batch CLI to invoke ffmpeg to transcode source video files to different resolutions.
...
### <a name="pool-templates"></a>Pool templates
...
### <a name="job-templates"></a>Job templates
...
### <a name="use-templates-in-batch-explorer"></a>Use templates in Batch Explorer
...
## <a name="file-groups-and-file-transfer"></a>File groups and file transfer
...
- Detailed installation and usage documentation, samples, and source code are available in the [Azure GitHub repo](https://github.com/Azure/azure-batch-cli-extensions).
