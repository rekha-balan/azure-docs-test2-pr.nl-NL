...
---
# <a name="run-tasks-under-user-accounts-in-batch"></a>Run tasks under user accounts in Batch
...
## <a name="types-of-user-accounts"></a>Types of user accounts
...
## <a name="user-account-access-to-files-and-directories"></a>User account access to files and directories
...
## <a name="elevated-access-for-tasks"></a>Elevated access for tasks 
...
## <a name="auto-user-accounts"></a>Auto-user accounts
...
### <a name="run-a-task-as-an-auto-user-with-elevated-access"></a>Run a task as an auto-user with elevated access
...
### <a name="run-a-task-as-an-auto-user-with-pool-scope"></a>Run a task as an auto-user with pool scope
...
## <a name="named-user-accounts"></a>Named user accounts
...
### <a name="create-named-user-accounts"></a>Create named user accounts
...
#### <a name="batch-java-example"></a>Batch Java example
...
#### <a name="batch-python-example"></a>Batch Python example
...
### <a name="run-a-task-under-a-named-user-account-with-elevated-access"></a>Run a task under a named user account with elevated access
...
## <a name="update-your-code-to-the-latest-batch-client-library"></a>Update your code to the latest Batch client library
