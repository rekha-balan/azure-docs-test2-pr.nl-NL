...
---
# <a name="tutorial-run-a-parallel-r-simulation-with-azure-batch"></a>Tutorial: Run a parallel R simulation with Azure Batch 
...
## <a name="install-doazureparallel"></a>Install doAzureParallel
...
## <a name="run-a-parallel-simulation"></a>Run a parallel simulation
