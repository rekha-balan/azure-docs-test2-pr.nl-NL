...
---
# <a name="create-an-azure-batch-pool-in-a-virtual-network"></a>Create an Azure Batch pool in a virtual network
...
## <a name="why-use-a-vnet"></a>Why use a VNet?
...
### <a name="vnet-requirements"></a>VNet requirements
[!INCLUDE [batch-virtual-network-ports](../../includes/batch-virtual-network-ports.md)]
    
## <a name="create-a-pool-with-a-vnet-in-the-portal"></a>Create a pool with a VNet in the portal
...
## <a name="user-defined-routes-for-forced-tunneling"></a>User-defined routes for forced tunneling
