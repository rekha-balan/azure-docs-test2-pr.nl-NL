...
---
# <a name="using-the-visual-studio-publish-azure-application-wizard"></a>Using the Visual Studio Publish Azure Application Wizard
...
## <a name="accessing-the-publish-azure-application-wizard"></a>Accessing the Publish Azure Application wizard
...
## <a name="sign-in-page"></a>Sign-in page
...
## <a name="settings-page---common-settings-tab"></a>Settings page - Common Settings tab
...
## <a name="settings-page---advanced-settings-tab"></a>Settings page - Advanced Settings tab
...
## <a name="diagnostics-settings-page"></a>Diagnostics Settings page
...
## <a name="summary-page"></a>Summary page
