...
---
# <a name="quickstart-create-a-public-basic-load-balancer-by-using-the-azure-portal"></a>Quickstart: Create a public Basic load balancer by using the Azure portal
...
## <a name="create-resources-for-the-basic-load-balancer"></a>Create resources for the Basic load balancer
