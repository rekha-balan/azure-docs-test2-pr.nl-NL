...
---
# <a name="tutorial-load-balance-vms-within-an-availability-zone-with-standard-load-balancer-by-using-the-azure-portal"></a>Tutorial: Load balance VMs within an availability zone with Standard Load Balancer by using the Azure portal
...
## <a name="create-a-public-standard-load-balancer-instance"></a>Create a public Standard Load Balancer instance
