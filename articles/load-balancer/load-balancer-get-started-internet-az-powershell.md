...
---
#  <a name="create-a-public-load-balancer-standard-with-zone-redundant-public-ip-address-frontend-using-powershell"></a>Create a public Load Balancer Standard with zone-redundant Public IP address frontend using PowerShell
