...
---
# <a name="quickstart-create-a-standard-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>Quickstart: Create a Standard Load Balancer to load balance VMS using Azure CLI 2.0
...
### <a name="create-a-network-security-group-rule"></a>Create a network security group rule
