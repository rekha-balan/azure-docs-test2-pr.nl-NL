...
```
## <a name="create-standard-load-balancer"></a>Create Standard Load Balancer
...
### <a name="create-frontend-ip"></a>Create frontend IP
...
### <a name="configure-backend-address-pool"></a>Configure backend address pool
...
### <a name="create-the-nat-rules"></a>Create the NAT rules
...
#### <a name="create-a-network-security-group-rule-for-port-3389"></a>Create a network security group rule for port 3389
...
#### <a name="create-a-network-security-group-rule-for-port-80"></a>Create a network security group rule for port 80
...
### <a name="install-iis-with-custom-web-page"></a>Install IIS with Custom web page
