...
---
# <a name="tutorial-create-and-manage-standard-load-balancer-using-the-azure-portal"></a>Tutorial: Create and manage Standard Load Balancer using the Azure portal
...
### <a name="create-network-security-group-rule"></a>Create network security group rule
...
## <a name="remove-or-add-vms-from-the-backend-pool"></a>Remove or add VMs from the backend pool
