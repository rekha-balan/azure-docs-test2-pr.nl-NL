...
---
# <a name="tutorial-configure-port-fowarding-in-load-balancer-using-the-azure-portal"></a>Tutorial: Configure port fowarding in Load Balancer using the Azure portal
...
## <a name="create-a-standard-load-balancer"></a>Create a Standard Load Balancer
...
### <a name="create-nsg-rules"></a>Create NSG rules
...
### <a name="install-iis-on-vms"></a>Install IIS on VMs
...
## <a name="add-vms-to-the-backend-address-pool"></a>Add VMs to the backend address pool
...
## <a name="create-inbound-nat-rules"></a>Create inbound NAT rules
...
## <a name="test-port-forwarding"></a>Test port forwarding
