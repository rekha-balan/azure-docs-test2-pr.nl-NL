...
---
#  <a name="create-a-public-load-balancer-standard-with-zonal-public-ip-address-frontend-using-azure-portal"></a>Create a public Load Balancer Standard with zonal Public IP address frontend using Azure portal
