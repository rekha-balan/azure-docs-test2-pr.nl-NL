...
---
# <a name="azure-load-balancer-overview"></a>Azure Load Balancer overview
...
### <a name="azure-classic-deployment-model"></a>Azure classic deployment model
...
### <a name="azure-resource-manager-deployment-model"></a>Azure Resource Manager deployment model
...
### <a name="support-for-multiple-load-balanced-ip-addresses-for-virtual-machines"></a>Support for multiple load-balanced IP addresses for virtual machines
