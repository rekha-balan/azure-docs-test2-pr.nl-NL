...
---
# <a name="azure-cli-script-example-load-balance-traffic-to-vms-for-high-availability"></a>Azure CLI script example: Load balance traffic to VMs for high availability
