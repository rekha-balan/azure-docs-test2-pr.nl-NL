...
---
# <a name="standard-load-balancer-and-availability-zones"></a>Standard Load Balancer and Availability Zones
...
#### <a name="zone-redundant-by-default"></a>Zone redundant by default
...
#### <a name="optional-zone-guarantee"></a>Optional zone guarantee
...
### <a name="outbound-connections"></a>Outbound connections
...
### <a name="health-probes"></a>Health probes
