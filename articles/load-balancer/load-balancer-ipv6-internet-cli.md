...
---
# <a name="create-a-public-load-balancer-with-ipv6-using-azure-cli"></a>Create a public load balancer with IPv6 using Azure CLI
...
## <a name="deploy-the-solution-by-using-azure-cli"></a>Deploy the solution by using Azure CLI
...
## <a name="set-up-azure-cli"></a>Set up Azure CLI
...
## <a name="create-the-probe-nat-rules-and-load-balancer-rules"></a>Create the probe, NAT rules, and load balancer rules
