...
### <a name="configure-a-high-availability-ports-load-balancer-rule-with-azure-cli-20"></a>Configure a High Availability Ports load balancer rule with Azure CLI 2.0
