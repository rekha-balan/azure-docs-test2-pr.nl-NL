...
---
# <a name="metrics-and-health-diagnostics-for-standard-load-balancer"></a>Metrics and health diagnostics for Standard Load Balancer
...
### <a name="view-your-load-balancer-metrics-in-the-azure-portal"></a>View your load balancer metrics in the Azure portal
...
### <a name="retrieve-multi-dimensional-metrics-programmatically-via-apis"></a>Retrieve multi-dimensional metrics programmatically via APIs
...
#### <a name="is-the-data-path-up-and-available-for-my-load-balancer-vip"></a>Is the data path up and available for my load balancer VIP?
...
#### <a name="are-the-back-end-instances-for-my-vip-responding-to-probes"></a>Are the back-end instances for my VIP responding to probes?
...
#### <a name="how-do-i-check-my-outbound-connection-statistics"></a>How do I check my outbound connection statistics? 
...
#### <a name="how-do-i-check-inboundoutbound-connection-attempts-for-my-service"></a>How do I check inbound/outbound connection attempts for my service?
...
#### <a name="how-do-i-check-my-network-bandwidth-consumption"></a>How do I check my network bandwidth consumption? 
