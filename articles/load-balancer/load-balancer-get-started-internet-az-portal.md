...
---
#  <a name="create-a-public-load-balancer-standard-with-zone-redundant-public-ip-address-frontend-using-azure-portal"></a>Create a public Load Balancer Standard with zone-redundant Public IP address frontend using Azure portal
...
## <a name="create-a-zone-redundant-load-balancer"></a>Create a zone redundant load balancer
