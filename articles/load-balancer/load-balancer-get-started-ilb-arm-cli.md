...
---
# <a name="create-an-internal-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>Create an internal load balancer to load balance VMs using Azure CLI 2.0
...
```
## <a name="create-basic-load-balancer"></a>Create Basic Load Balancer
...
```azurecli-interactive
  az network lb create \
    ...
    --subnet mySubnet      
  ```
### <a name="create-the-health-probe"></a>Create the health probe
...
### <a name="create-the-load-balancer-rule"></a>Create the load balancer rule
...
## <a name="create-servers-for-the-backend-address-pool"></a>Create servers for the backend address pool
...
### <a name="create-a-vm-for-testing-the-load-balancer"></a>Create a VM for testing the load balancer
...
## <a name="test-the-internal-load-balancer"></a>Test the internal load balancer
