...
---
# <a name="quickstart-create-a-standard-load-balancer-to-load-balance-vms-using-the-azure-portal"></a>Quickstart: Create a Standard Load Balancer to load balance VMs using the Azure portal
...
## <a name="create-a-public-load-balancer"></a>Create a public load balancer
