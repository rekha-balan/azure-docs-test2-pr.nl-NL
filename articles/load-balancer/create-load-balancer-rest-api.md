...
---
# <a name="create-an-azure-basic-load-balancer-using-rest-api"></a>Create an Azure Basic Load Balancer using REST API
...
## <a name="example-create-and-update-a-basic-load-balancer"></a>Example: Create and update a Basic Load Balancer
...
### <a name="step-1-create-a-basic-load-balancer"></a>STEP 1. Create a Basic Load Balancer
...
#### <a name="request-body"></a>Request body
  ...
  ```
### <a name="step-2-configure-load-balancer-resources"></a>STEP 2. Configure load balancer resources
