...
---
# <a name="create-a-blockchain-application-in-azure-blockchain-workbench"></a>Create a blockchain application in Azure Blockchain Workbench
...
### <a name="base-class"></a>Base class
