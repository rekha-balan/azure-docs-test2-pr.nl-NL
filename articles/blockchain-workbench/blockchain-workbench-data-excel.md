...
---
# <a name="view-azure-blockchain-workbench-data-with-microsoft-excel"></a>View Azure Blockchain Workbench data with Microsoft Excel
...
## <a name="look-at-database-tables-and-views"></a>Look at database tables and views
...
## <a name="load-view-data-into-an-excel-workbook"></a>Load view data into an Excel workbook
