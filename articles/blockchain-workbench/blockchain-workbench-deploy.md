...
---
# <a name="deploy-azure-blockchain-workbench"></a>Deploy Azure Blockchain Workbench
...
### <a name="blockchain-workbench-api-app-registration"></a>Blockchain Workbench API app registration
...
### <a name="modify-application-manifest"></a>Modify application manifest
...
### <a name="add-graph-api-key-to-application"></a>Add Graph API key to application
