...
---
# <a name="using-the-azure-blockchain-workbench-rest-api"></a>Using the Azure Blockchain Workbench REST API 
...
## <a name="list-workflows-for-an-application"></a>List workflows for an application
...
## <a name="list-smart-contract-instances-for-a-workflow"></a>List smart contract instances for a workflow
...
## <a name="list-available-actions-for-a-contract"></a>List available actions for a contract
...
## <a name="execute-an-action-for-a-contract"></a>Execute an action for a contract
