...
---
# <a name="automate-documentdb-account-creation-using-azure-cli-10-and-azure-resource-manager-templates"></a>Automate DocumentDB account creation using Azure CLI 1.0 and Azure Resource Manager templates
