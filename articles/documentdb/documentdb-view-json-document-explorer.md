...
---
# <a name="view-edit-create-and-upload-json-documents"></a>View, edit, create, and upload JSON documents 
...
## <a name="launch-document-explorer-in-the-azure-portal"></a>Launch Document Explorer in the Azure portal
...
## <a name="create-a-json-document"></a>Create a JSON document
...
## <a name="edit-a-json-document"></a>Edit a JSON document
1. [Launch Document Explorer](#launch-document-explorer).
...
## <a name="delete-a-document-from-documentdb"></a>Delete a document from DocumentDB
1. [Launch Document Explorer](#launch-document-explorer).
