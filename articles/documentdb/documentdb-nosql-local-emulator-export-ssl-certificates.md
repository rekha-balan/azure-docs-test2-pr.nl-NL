...
---
# <a name="export-the-documentdb-emulator-certificates-for-use-with-java-python-and-nodejs"></a>Export the DocumentDB Emulator certificates for use with Java, Python, and Node.js
...
## <a name="how-to-export-the-documentdb-ssl-certificate"></a>How to export the DocumentDB SSL certificate
