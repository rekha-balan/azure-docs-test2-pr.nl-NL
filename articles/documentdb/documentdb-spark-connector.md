...
---
# <a name="accelerate-real-time-big-data-analytics-with-the-spark-to-documentdb-connector"></a>Accelerate real-time big-data analytics with the Spark to DocumentDB connector
...
## <a name="connector-components"></a>Connector components
...
## <a name="pydocumentdb-implementation"></a>pyDocumentDB implementation 
...
### <a name="data-flow-of-the-pydocumentdb-implementation"></a>Data flow of the pyDocumentDB implementation
...
### <a name="installing-pydocumentdb"></a>Installing pyDocumentDB
...
### <a name="connecting-spark-to-documentdb-via-pydocumentdb"></a>Connecting Spark to DocumentDB via pyDocumentDB 
...
### <a name="executing-spark-queries-via-pydocumentdb"></a>Executing Spark Queries via pyDocumentDB
...
### <a name="why-use-the-pydocumentdb-to-connect-spark-to-documentdb"></a>Why use the pyDocumentDB to connect Spark to DocumentDB?
...
## <a name="spark-to-documentdb-connector"></a>Spark to DocumentDB connector
...
### <a name="building-the-spark-to-documentdb-connector"></a>Building the Spark to DocumentDB connector
...
### <a name="including-the-azure-documentdb-spark-jar"></a>Including the Azure DocumentDB Spark JAR
...
### <a name="connecting-spark-to-documentdb-using-the-connector"></a>Connecting Spark to DocumentDB using the connector
...
### <a name="executing-spark-queries-via-the-connector"></a>Executing Spark queries via the connector
...
### <a name="why-use-the-spark-to-documentdb-connector-implementation"></a>Why use the Spark to DocumentDB connector implementation?
...
## <a name="distributed-aggregation-example"></a>Distributed aggregation example
...
### <a name="connecting-to-flights-sample-data"></a>Connecting to flights sample data
...
### <a name="running-limit-and-count-queries"></a>Running LIMIT and COUNT queries
...
### <a name="distinct-order-by-query"></a>DISTINCT, ORDER BY query
...
### <a name="continue-the-flight-data-analysis"></a>Continue the flight data analysis
You can use the following example queries to continue analysis of the flight data:

#### <a name="top-5-delayed-destinations-cities-departing-from-seattle"></a>Top 5 delayed destinations (cities) departing from Seattle
```
...
#### <a name="calculate-median-delays-by-destination-cities-departing-from-seattle"></a>Calculate median delays by destination cities departing from Seattle
```
