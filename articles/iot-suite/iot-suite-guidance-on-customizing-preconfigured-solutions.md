...
## <a name="find-the-source-code"></a>Find the source code
...
## <a name="change-the-preconfigured-rules"></a>Change the preconfigured rules
...
## <a name="add-your-own-rules"></a>Add your own rules
...
## <a name="customize-devices"></a>Customize devices
...
### <a name="create-your-own-simulated-device"></a>Create your own simulated device
...
### <a name="add-a-desired-property-update-handler-to-the-simulator"></a>Add a desired property update handler to the simulator
...
### <a name="add-support-for-a-new-method-to-the-simulator"></a>Add support for a new method to the simulator
...
### <a name="build-and-use-your-own-physical-device"></a>Build and use your own (physical) device
...
## <a name="modify-dashboard-limits"></a>Modify dashboard limits
...
## <a name="manually-set-up-application-roles"></a>Manually set up application roles
