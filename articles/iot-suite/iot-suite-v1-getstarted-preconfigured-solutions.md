...
---
# <a name="get-started-with-the-preconfigured-solutions"></a>Get started with the preconfigured solutions
...
## <a name="view-alarms"></a>View alarms
...
## <a name="view-devices"></a>View devices
...
## <a name="filter-the-device-list"></a>Filter the device list
...
## <a name="update-desired-properties"></a>Update desired properties
...
## <a name="invoke-methods"></a>Invoke methods
...
## <a name="scenario-review"></a>Scenario review
...
### <a name="customize-columns"></a>Customize columns
...
### <a name="customize-the-device-icon"></a>Customize the device icon
...
### <a name="disable-and-delete-a-device"></a>Disable and delete a device
...
### <a name="manage-filters"></a>Manage filters
