...
---
# <a name="create-a-custom-rule-in-the-remote-monitoring-preconfigured-solution"></a>Create a custom rule in the remote monitoring preconfigured solution
...
## <a name="rule-storage-locations"></a>Rule storage locations
...
## <a name="update-the-remotemonitoring-visual-studio-solution"></a>Update the RemoteMonitoring Visual Studio solution
...
## <a name="rebuild-and-redeploy-the-solution"></a>Rebuild and redeploy the solution.
...
## <a name="update-the-stream-analytics-job"></a>Update the Stream Analytics job
...
## <a name="add-your-new-rule-in-the-dashboard"></a>Add your new rule in the dashboard
