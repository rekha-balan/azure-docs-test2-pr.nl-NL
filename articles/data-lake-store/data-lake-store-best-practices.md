...
---
# <a name="best-practices-for-using-azure-data-lake-storage-gen1"></a>Best practices for using Azure Data Lake Storage Gen1
...
### <a name="use-security-groups-versus-individual-users"></a>Use security groups versus individual users 
...
### <a name="security-for-groups"></a>Security for groups 
...
### <a name="security-for-service-principals"></a>Security for service principals 
...
### <a name="enable-the-data-lake-storage-gen1-firewall-with-azure-service-access"></a>Enable the Data Lake Storage Gen1 firewall with Azure service access 
...
## <a name="performance-and-scale-considerations"></a>Performance and scale considerations
...
### <a name="improve-throughput-with-parallelism"></a>Improve throughput with parallelism 
...
### <a name="avoid-small-file-sizes"></a>Avoid small file sizes
...
### <a name="large-file-sizes-and-potential-performance-impact"></a>Large file sizes and potential performance impact
...
### <a name="capacity-plan-for-your-workload"></a>Capacity plan for your workload 
...
### <a name="optimize-writes-with-the-data-lake-storage-gen1-driver-buffer"></a>Optimize “writes” with the Data Lake Storage Gen1 driver buffer 
...
### <a name="use-distcp-for-data-movement-between-two-locations"></a>Use Distcp for data movement between two locations 
...
### <a name="use-azure-data-factory-to-schedule-copy-jobs"></a>Use Azure Data Factory to schedule copy jobs 
...
### <a name="export-data-lake-storage-gen1-diagnostics"></a>Export Data Lake Storage Gen1 diagnostics 
...
### <a name="turn-on-debug-level-logging-in-hdinsight"></a>Turn on debug-level logging in HDInsight 
...
### <a name="run-synthetic-transactions"></a>Run synthetic transactions 
...
## <a name="directory-layout-considerations"></a>Directory layout considerations
...
### <a name="iot-structure"></a>IoT structure 
...
### <a name="batch-jobs-structure"></a>Batch jobs structure 
