...
---
# <a name="manage-azure-data-lake-store-resources-by-using-storage-explorer"></a>Manage Azure Data Lake Store resources by using Storage Explorer
...
## <a name="install-storage-explorer"></a>Install Storage Explorer
...
## <a name="connect-to-data-lake-store"></a>Connect to Data Lake Store
...
## <a name="view-an-azure-data-lake-store-accounts-contents"></a>View an Azure Data Lake Store account's contents
...
## <a name="manage-resources-in-azure-data-lake-store"></a>Manage resources in Azure Data Lake Store
...
## <a name="manage-resources-in-azure-storage-explorer"></a>Manage resources in Azure Storage Explorer
...
### <a name="upload-a-folder"></a>Upload a folder
...
### <a name="download-folders-or-files-to-your-local-computer"></a>Download folders or files to your local computer
...
### <a name="open-a-folder-or-file-from-your-local-computer"></a>Open a folder or file from your local computer
...
### <a name="copy-folders-or-files-to-the-clipboard"></a>Copy folders or files to the clipboard
...
### <a name="delete-folders-or-files"></a>Delete folders or files
...
### <a name="pin-to-quick-access"></a>Pin to Quick Access
...
### <a name="use-deep-links"></a>Use deep links
