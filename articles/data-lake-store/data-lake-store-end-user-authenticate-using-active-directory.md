...
### <a name="what-do-i-need-for-this-approach"></a>What do I need for this approach?
...
## <a name="step-1-create-an-active-directory-native-application"></a>Step 1: Create an Active Directory native application
...
## <a name="step-2-get-application-id-and-redirect-uri"></a>Step 2: Get application ID and redirect URI
...
## <a name="step-3-set-permissions"></a>Step 3: Set permissions
