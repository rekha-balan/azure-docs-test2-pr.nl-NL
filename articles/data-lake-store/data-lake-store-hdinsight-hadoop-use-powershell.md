...
---
# <a name="use-azure-powershell-to-create-an-hdinsight-cluster-with-data-lake-store-as-additional-storage"></a>Use Azure PowerShell to create an HDInsight cluster with Data Lake Store (as additional storage)
...
## <a name="using-data-lake-store-for-hdinsight-cluster-storage"></a>Using Data Lake Store for HDInsight cluster storage
...
## <a name="create-an-hdinsight-linux-cluster-with-data-lake-store-as-additional-storage"></a>Create an HDInsight Linux cluster with Data Lake Store as additional storage
