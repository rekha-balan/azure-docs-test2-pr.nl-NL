...
---
# <a name="filesystem-operations-on-azure-data-lake-storage-gen1-using-net-sdk"></a>Filesystem operations on Azure Data Lake Storage Gen1 using .NET SDK
...
## <a name="create-client-object"></a>Create client object
...
## <a name="create-a-file-and-directory"></a>Create a file and directory
...
## <a name="read-a-file"></a>Read a file
...
## <a name="enumerate-a-directory"></a>Enumerate a directory
...
## <a name="delete-directories-recursively"></a>Delete directories recursively
