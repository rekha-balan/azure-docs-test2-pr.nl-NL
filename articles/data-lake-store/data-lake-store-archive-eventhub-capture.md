...
---
# <a name="use-azure-data-lake-storage-gen1-to-capture-data-from-event-hubs"></a>Use Azure Data Lake Storage Gen1 to capture data from Event Hubs
...
## <a name="assign-permissions-to-event-hubs"></a>Assign permissions to Event Hubs
...
## <a name="configure-event-hubs-to-capture-data-to-data-lake-storage-gen1"></a>Configure Event Hubs to capture data to Data Lake Storage Gen1
...
## <a name="test-the-setup"></a>Test the setup
...
## <a name="analyze-data-in-data-lake-storage-gen1"></a>Analyze data in Data Lake Storage Gen1
