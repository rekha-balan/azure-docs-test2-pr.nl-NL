...
---
# <a name="tuning-azure-data-lake-store-for-performance"></a>Tuning Azure Data Lake Store for performance
...
### <a name="network-connectivity-to-azure-data-lake-store"></a>Network Connectivity to Azure Data Lake Store
