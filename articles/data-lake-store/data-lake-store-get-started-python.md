...
---
# <a name="account-management-operations-on-azure-data-lake-store-using-python"></a>Account management operations on Azure Data Lake Store using Python
...
## <a name="create-client-and-data-lake-store-account"></a>Create client and Data Lake Store account
...
## <a name="delete-the-data-lake-store-account"></a>Delete the Data Lake Store account
