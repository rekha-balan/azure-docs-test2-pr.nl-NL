...
---
# <a name="get-started-with-azure-data-lake-store-using-python"></a>Get started with Azure Data Lake Store using Python
...
### <a name="end-user-authentication-for-account-management"></a>End-user authentication for account management
...
### <a name="end-user-authentication-for-filesystem-operations"></a>End-user authentication for filesystem operations
...
### <a name="service-to-service-authentication-with-client-secret-for-account-management"></a>Service-to-service authentication with client secret for account management
...
### <a name="service-to-service-authentication-with-client-secret-for-filesystem-operations"></a>Service-to-service authentication with client secret for filesystem operations
...
### <a name="multi-factor-authentication-for-account-management"></a>Multi-factor authentication for account management
...
### <a name="multi-factor-authentication-for-filesystem-management"></a>Multi-factor authentication for filesystem management
...
## <a name="create-clients-and-data-lake-store-account"></a>Create clients and Data Lake Store account
...
## <a name="list-the-data-lake-store-accounts"></a>List the Data Lake Store accounts
