...
---
# <a name="get-started-with-azure-data-lake-store-using-azure-cli-20-preview"></a>Get started with Azure Data Lake Store using Azure CLI 2.0 (Preview)
...
## <a name="enable-data-lake-store-preview-in-azure-cli-20"></a>Enable Data Lake Store (Preview) in Azure CLI 2.0
...
## <a name="upload-data-to-a-data-lake-store-account"></a>Upload data to a Data Lake Store account
...
## <a name="list-files-in-a-data-lake-store-account"></a>List files in a Data Lake Store account
...
## <a name="rename-download-and-delete-data-from-a-data-lake-store-account"></a>Rename, download, and delete data from a Data Lake Store account 
...
## <a name="work-with-permissions-and-acls-for-a-data-lake-store-account"></a>Work with permissions and ACLs for a Data Lake Store account
