...
5. Add the Nuget packages to your project.
   ...
   3. Search for and install the following NuGet packages:
      ...
      * `Microsoft.Rest.ClientRuntime.Azure.Authentication` - This tutorial uses v2.2.11.
        ...
        ![Add a Nuget source](https://docstestmedia1.blob.core.windows.net/azure-media/articles/data-lake-store/media/data-lake-store-get-started-net-sdk/ADL.Install.Nuget.Package.png "Create a new Azure Data Lake account")
