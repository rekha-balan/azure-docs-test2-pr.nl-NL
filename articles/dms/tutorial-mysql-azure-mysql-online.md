...
---
# <a name="migrate-mysql-to-azure-database-for-mysql-online-using-dms"></a>Migrate MySQL to Azure Database for MySQL online using DMS
...
## <a name="create-a-dms-instance"></a>Create a DMS instance
