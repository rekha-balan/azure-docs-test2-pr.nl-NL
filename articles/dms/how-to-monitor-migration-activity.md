...
---
# <a name="monitor-migration-activity"></a>Monitor migration activity
In this article, you learn how to monitor the progress of a migration at both a database level and a table level.

## <a name="monitor-at-the-database-level"></a>Monitor at the database level
...
## <a name="monitor-at-table-level--quick-summary"></a>Monitor at table level – Quick Summary
...
## <a name="monitor-at-table-level--detailed-summary"></a>Monitor at table level – Detailed Summary
