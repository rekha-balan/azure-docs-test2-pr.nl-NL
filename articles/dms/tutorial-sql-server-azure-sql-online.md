...
---
# <a name="migrate-sql-server-to-azure-sql-database-online-using-dms"></a>Migrate SQL Server to Azure SQL Database online using DMS
...
## <a name="assess-your-on-premises-database"></a>Assess your on-premises database
...
## <a name="migrate-the-sample-schema"></a>Migrate the sample schema
...
## <a name="create-an-instance"></a>Create an instance
...
## <a name="perform-migration-cutover"></a>Perform migration cutover
