...
---
# <a name="known-issuesmigration-limitations-with-online-migrations-to-azure-db-for-mysql"></a>Known issues/migration limitations with online migrations to Azure DB for MySQL
...
## <a name="online-migration-configuration"></a>Online migration configuration
...
## <a name="datatype-limitations"></a>Datatype limitations
...
## <a name="lob-limitations"></a>LOB limitations
...
## <a name="other-limitations"></a>Other limitations
