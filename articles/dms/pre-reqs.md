...
---
# <a name="overview-of-prerequisites-for-using-the-azure-database-migration-service"></a>Overview of prerequisites for using the Azure Database Migration Service
...
## <a name="prerequisites-common-across-migration-scenarios"></a>Prerequisites common across migration scenarios
...
## <a name="prerequisites-for-migrating-sql-server-to-azure-sql-database"></a>Prerequisites for migrating SQL Server to Azure SQL Database 
...
## <a name="prerequisites-for-migrating-sql-server-to-azure-sql-database-managed-instance"></a>Prerequisites for migrating SQL Server to Azure SQL Database Managed Instance
