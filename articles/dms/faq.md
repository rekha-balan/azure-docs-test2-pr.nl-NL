...
---
# <a name="faq-about-using-the-azure-database-migration-service"></a>FAQ about using the Azure Database Migration Service
...
### <a name="q-what-is-azure-database-migration-service"></a>Q. What is Azure Database Migration Service?
...
### <a name="q-what-source-target-pairs-does-the-azure-database-migration-service-currently-support"></a>Q. What source-target pairs does the Azure Database Migration Service currently support?
...
### <a name="q-how-does-the-azure-database-migration-service-compare-to-other-microsoft-database-migration-tools-such-as-the-database-migration-assistant-dma-or-sql-server-migration-assistant-ssma"></a>Q. How does the Azure Database Migration Service compare to other Microsoft database migration tools such as the Database Migration Assistant (DMA) or SQL Server Migration Assistant (SSMA)?
...
### <a name="q-how-does-the-azure-database-migration-service-compare-to-the-azure-migrate-offering"></a>Q. How does the Azure Database Migration Service compare to the Azure Migrate offering?
...
### <a name="q-what-versions-of-sql-server-does-the-azure-database-migration-service-support-as-a-source"></a>Q. What versions of SQL Server does the Azure Database Migration Service support as a source?
When migrating from SQL Server, the Azure Database Migration Service supports SQL Server 2005 through SQL Server 2017.

### <a name="q-what-is-a-summary-of-the-steps-required-to-use-the-azure-database-migration-service-to-perform-a-database-migration"></a>Q. What is a summary of the steps required to use the Azure Database Migration Service to perform a database migration?
...
### <a name="q-what-are-the-prerequisites-for-using-the-azure-database-migration-service"></a>Q. What are the prerequisites for using the Azure Database Migration Service?
...
### <a name="q-how-do-i-find-the-ip-address-for-the-azure-database-migration-service-so-that-i-can-create-an-allow-list-for-the-firewall-rules-used-to-access-my-source-database-for-migration"></a>Q. How do I find the IP address for the Azure Database Migration Service so that I can create an allow list for the firewall rules used to access my source database for migration?
...
### <a name="q-are-there-any-recommendations-for-optimizing-the-performance-of-the-azure-database-migration-service"></a>Q. Are there any recommendations for optimizing the performance of the Azure Database Migration Service?
...
### <a name="q-how-do-i-set-up-an-azure-virtual-network"></a>Q. How do I set up an Azure Virtual Network?
...
### <a name="q-why-is-my-azure-database-migration-service-unavailable-or-stopped"></a>Q. Why is my Azure Database Migration Service unavailable or stopped?
...
### <a name="q-where-can-i-leave-feedback-about-the-azure-database-migration-service"></a>Q. Where can I leave feedback about the Azure Database Migration Service?
