...
---
# <a name="migrate-sql-server-to-azure-sql-database-managed-instance-offline-using-dms"></a>Migrate SQL Server to Azure SQL Database Managed Instance offline using DMS
...
## <a name="register-the-microsoftdatamigration-resource-provider"></a>Register the Microsoft.DataMigration resource provider
...
## <a name="create-an-azure-database-migration-service-instance"></a>Create an Azure Database Migration Service instance
...
## <a name="specify-source-details"></a>Specify source details
...
## <a name="specify-target-details"></a>Specify target details
...
## <a name="select-source-databases"></a>Select source databases
...
## <a name="select-logins"></a>Select logins
...
## <a name="configure-migration-settings"></a>Configure migration settings
...
## <a name="review-the-migration-summary"></a>Review the migration summary
...
## <a name="run-the-migration"></a>Run the migration
