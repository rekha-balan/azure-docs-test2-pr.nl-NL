...
---
# <a name="use-tags-to-organize-your-azure-resources"></a>Use tags to organize your Azure resources
...
## <a name="ensure-tag-consistency-with-policies"></a>Ensure tag consistency with policies
