...
---
# <a name="tutorial-create-azure-resource-manager-templates-with-dependent-resources"></a>Tutorial: create Azure Resource Manager templates with dependent resources
...
## <a name="explore-the-template"></a>Explore the template
