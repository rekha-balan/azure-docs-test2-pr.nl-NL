...
---
# <a name="azure-resource-manager-deployment-modes"></a>Azure Resource Manager deployment modes
...
## <a name="example-result"></a>Example result
...
## <a name="set-deployment-mode"></a>Set deployment mode
