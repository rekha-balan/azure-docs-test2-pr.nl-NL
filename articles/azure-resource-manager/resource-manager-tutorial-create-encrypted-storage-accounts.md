...
---
# <a name="tutorial-create-an-azure-resource-manager-template-for-deploying-an-encrypted-storage-account"></a>Tutorial: create an Azure Resource Manager template for deploying an encrypted storage account
...
## <a name="understand-the-format"></a>Understand the format
...
## <a name="use-parameters-in-template"></a>Use parameters in template
...
## <a name="use-variables-in-template"></a>Use variables in template
