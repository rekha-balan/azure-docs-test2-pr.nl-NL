...
---
# <a name="resource-functions-for-azure-resource-manager-templates"></a>Resource functions for Azure Resource Manager templates
...
## <a name="listaccountsas-listkeys-listsecrets-and-list"></a>listAccountSas, listKeys, listSecrets, and list*
...
* Use the [Get-AzureRmProviderOperation](/powershell/module/azurerm.resources/get-azurermprovideroperation) PowerShell cmdlet. The following example gets all list operations for storage accounts:
