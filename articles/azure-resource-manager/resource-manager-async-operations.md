...
---
# <a name="track-asynchronous-azure-operations"></a>Track asynchronous Azure operations
...
## <a name="status-codes-for-asynchronous-operations"></a>Status codes for asynchronous operations
...
## <a name="monitor-status-of-operation"></a>Monitor status of operation
...
## <a name="azure-asyncoperation-request-and-response"></a>Azure-AsyncOperation request and response
...
## <a name="provisioningstate-values"></a>provisioningState values
...
## <a name="example-requests-and-responses"></a>Example requests and responses

### <a name="start-virtual-machine-202-with-azure-asyncoperation"></a>Start virtual machine (202 with Azure-AsyncOperation)
...
### <a name="deploy-resources-201-with-azure-asyncoperation"></a>Deploy resources (201 with Azure-AsyncOperation)
...
### <a name="create-storage-account-202-with-location-and-retry-after"></a>Create storage account (202 with Location and Retry-After)
