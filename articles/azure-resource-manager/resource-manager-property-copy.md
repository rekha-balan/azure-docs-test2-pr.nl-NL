...
---
# <a name="create-multiple-instances-of-property-on-resource-type"></a>Create multiple instances of property on resource type
...
## <a name="define-template-with-variable-for-the-property"></a>Define template with variable for the property
...
## <a name="create-multiple-virtual-machines-with-multiple-data-disks"></a>Create multiple virtual machines with multiple data disks
