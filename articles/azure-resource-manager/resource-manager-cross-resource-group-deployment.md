...
---
# <a name="deploy-azure-resources-to-more-than-one-subscription-or-resource-group"></a>Deploy Azure resources to more than one subscription or resource group
...
## <a name="specify-a-subscription-and-resource-group"></a>Specify a subscription and resource group
...
## <a name="use-the-resourcegroup-and-subscription-functions"></a>Use the resourceGroup() and subscription() functions
