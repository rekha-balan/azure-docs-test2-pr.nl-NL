...
---
# <a name="deploy-resources-to-azure"></a>Deploy resources to Azure
...
## <a name="steps-for-deployment"></a>Steps for deployment
...
## <a name="example-storage-template"></a>Example storage template
