...
---
# <a name="deploy-resources-to-an-azure-subscription"></a>Deploy resources to an Azure subscription
...
## <a name="name-and-location-for-deployment"></a>Name and location for deployment
...
## <a name="using-template-functions"></a>Using template functions
...
## <a name="define-and-assign-policy"></a>Define and assign policy
...
## <a name="assign-role"></a>Assign role
