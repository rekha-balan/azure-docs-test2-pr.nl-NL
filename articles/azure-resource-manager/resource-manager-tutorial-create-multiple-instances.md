...
---
# <a name="tutorial-create-multiple-resource-instances-using-resource-manager-templates"></a>Tutorial: create multiple resource instances using Resource Manager templates
