...
---
# <a name="create-resource-groups-in-azure-resource-manager-templates"></a>Create resource groups in Azure Resource Manager templates
...
## <a name="create-empty-resource-group"></a>Create empty resource group
...
## <a name="create-several-resource-groups"></a>Create several resource groups
...
## <a name="create-resource-group-and-deploy-resource"></a>Create resource group and deploy resource
