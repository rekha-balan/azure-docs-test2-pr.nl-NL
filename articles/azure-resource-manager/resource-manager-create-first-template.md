...
---
# <a name="create-your-first-azure-resource-manager-template"></a>Create your first Azure Resource Manager template
...
## <a name="get-vs-code-and-extension"></a>Get VS Code and extension
...
## <a name="create-blank-template"></a>Create blank template
...
## <a name="add-storage-account"></a>Add storage account
...
## <a name="set-values-for-storage-account"></a>Set values for storage account
...
## <a name="add-template-function"></a>Add template function
...
## <a name="add-parameters-and-variables"></a>Add parameters and variables
...
## <a name="final-template"></a>Final template
