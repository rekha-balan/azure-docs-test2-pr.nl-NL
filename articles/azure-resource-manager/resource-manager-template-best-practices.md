...
## <a name="single-template-vs-nested-templates"></a>Single template vs. nested templates
...
## <a name="conditionally-link-to-nested-templates"></a>Conditionally link to nested templates
