...
---
# <a name="quickstart-create-and-deploy-azure-resource-manager-templates-by-using-the-azure-portal"></a>Quickstart: Create and deploy Azure Resource Manager templates by using the Azure portal
...
## <a name="generate-a-template-using-the-portal"></a>Generate a template using the portal
...
## <a name="edit-and-deploy-the-template"></a>Edit and deploy the template
