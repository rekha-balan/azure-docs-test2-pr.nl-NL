...
---
# <a name="resolve-not-found-errors-for-azure-resources"></a>Resolve not found errors for Azure resources
...
## <a name="solution-1---set-dependencies"></a>Solution 1 - set dependencies
...
## <a name="solution-2---get-resource-from-different-resource-group"></a>Solution 2 - get resource from different resource group
...
## <a name="solution-3---check-reference-function"></a>Solution 3 - check reference function
