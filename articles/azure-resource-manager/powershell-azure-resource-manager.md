...
---
# <a name="manage-resources-with-azure-powershell-and-resource-manager"></a>Manage resources with Azure PowerShell and Resource Manager
...
## <a name="get-started-with-azure-powershell"></a>Get started with Azure PowerShell
...
## <a name="add-resources-to-a-resource-group"></a>Add resources to a resource group
...
## <a name="search-for-resources"></a>Search for resources
...
## <a name="lock-a-resource"></a>Lock a resource
...
## <a name="export-resource-manager-template"></a>Export Resource Manager template
...
## <a name="remove-resources-or-resource-group"></a>Remove resources or resource group
...
## <a name="run-resource-manager-scripts-with-azure-automation"></a>Run Resource Manager scripts with Azure Automation
