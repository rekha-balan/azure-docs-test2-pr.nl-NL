...
---
# <a name="manage-resources-with-azure-powershell"></a>Manage resources with Azure PowerShell
...
## <a name="understand-scope"></a>Understand scope
...
## <a name="deploy-the-virtual-machine"></a>Deploy the virtual machine
...
### <a name="find-resources-by-tag"></a>Find resources by tag
...
### <a name="view-costs-by-tag-values"></a>View costs by tag values
