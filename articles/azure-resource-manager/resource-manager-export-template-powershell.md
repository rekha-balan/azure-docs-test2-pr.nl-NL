...
---
# <a name="export-azure-resource-manager-templates-with-powershell"></a>Export Azure Resource Manager templates with PowerShell
...
## <a name="deploy-a-solution"></a>Deploy a solution
...
## <a name="save-template-from-deployment-history"></a>Save template from deployment history

You can retrieve a template from your deployment history by using the [Save-AzureRmResourceGroupDeploymentTemplate](/powershell/module/azurerm.resources/save-azurermresourcegroupdeploymenttemplate) command. The following example saves the template that you previously deploy:
...
## <a name="export-resource-group-as-template"></a>Export resource group as template
...
## <a name="customize-exported-template"></a>Customize exported template
