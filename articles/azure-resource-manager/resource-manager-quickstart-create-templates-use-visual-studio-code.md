...
---
# <a name="quickstart-create-azure-resource-manager-templates-by-using-visual-studio-code"></a>Quickstart: create Azure Resource Manager templates by using Visual Studio Code
