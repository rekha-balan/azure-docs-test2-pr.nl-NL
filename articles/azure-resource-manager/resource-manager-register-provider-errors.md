...
---
# <a name="resolve-errors-for-resource-provider-registration"></a>Resolve errors for resource provider registration
...
## <a name="solution-3---azure-portal"></a>Solution 3 - Azure portal
