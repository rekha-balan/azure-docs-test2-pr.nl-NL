...
---
# <a name="outputs-section-in-azure-resource-manager-templates"></a>Outputs section in Azure Resource Manager templates
...
## <a name="define-and-use-output-values"></a>Define and use output values
