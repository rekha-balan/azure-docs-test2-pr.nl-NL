...
### <a name="is-a-vpn-gateway-a-virtual-network-gateway"></a>Is a VPN gateway a virtual network gateway?
...
### <a name="do-i-need-a-gatewaysubnet"></a>Do I need a 'GatewaySubnet'?
...
####<a name="resource-manager-deployment-model"></a>Resource Manager deployment model
...
####<a name="classic-deployment-model"></a>Classic deployment model
...
### <a name="where-can-i-find-configuration-settings-for-vpn-devices"></a>Where can I find configuration settings for VPN devices?
...
### <a name="how-do-i-edit-vpn-device-configuration-samples"></a>How do I edit VPN device configuration samples?

For information about editing device configuration samples, see [Editing samples](vpn-gateway-about-vpn-devices.md#editing).

### <a name="where-do-i-find-ipsec-and-ike-parameters"></a>Where do I find IPsec and IKE parameters?
