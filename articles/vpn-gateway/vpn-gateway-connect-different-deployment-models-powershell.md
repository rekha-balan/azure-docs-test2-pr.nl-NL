...
## <a name="section-3-modify-the-classic-vnet-local-site-settings"></a>Section 3: Modify the classic VNet local site settings
...
## <a name="section-5-verify-your-connections"></a>Section 5: Verify your connections
