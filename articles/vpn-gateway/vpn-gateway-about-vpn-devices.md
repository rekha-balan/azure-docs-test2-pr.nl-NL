...
---
# <a name="about-vpn-devices-and-ipsecike-parameters-for-site-to-site-vpn-gateway-connections"></a>About VPN devices and IPsec/IKE parameters for Site-to-Site VPN Gateway connections
...
> [!IMPORTANT]
> If you are experiencing connectivity issues between your on-premises VPN devices and Azure VPN gateways, refer to [Known device compatibility issues](#known). 


###<a name="items-to-note-when-viewing-the-tables"></a>Items to note when viewing the tables:
...
### <a name="to-edit-a-sample"></a>To edit a sample:
...
### <a name="ike-phase-1-main-mode-parameters"></a>IKE Phase 1 (Main Mode) parameters
...
### <a name="ike-phase-2-quick-mode-parameters"></a>IKE Phase 2 (Quick Mode) parameters
| **Property**                  |**PolicyBased**| **RouteBased**                              |
| ---                           | ---           | ---                                         |
| IKE Version                   |IKEv1          |IKEv2                                        |
...
#### <a name="azure-gateway-as-initiator"></a>Azure Gateway as initiator
...
#### <a name="azure-gateway-as-responder"></a>Azure Gateway as responder
|-  |**Encryption**|**Authentication**|**PFS Group**|
|---| ---          | ---              |---          |
| 1 |GCM AES256    |GCM (AES256)      |None         |
| 2 |AES256        |SHA1              |None         |
...
### <a name="feb-16-2017"></a>Feb. 16, 2017
