...
---
# <a name="configure-a-point-to-site-connection-to-a-vnet-using-native-azure-certificate-authentication-powershell"></a>Configure a Point-to-Site connection to a VNet using native Azure certificate authentication: PowerShell
...
### <a name="to-connect-from-a-windows-vpn-client"></a>To connect from a Windows VPN client
...
#### <a name="troubleshooting-windows-client-p2s-connections"></a>Troubleshooting Windows client P2S connections

[!INCLUDE [client certificates](../../includes/vpn-gateway-certificates-verify-client-cert-include.md)]

### <a name="to-connect-from-a-mac-vpn-client"></a>To connect from a Mac VPN client
