...
---
# <a name="how-to-validate-vpn-throughput-to-a-virtual-network"></a>How to validate VPN throughput to a virtual network
...
## <a name="calculate-the-maximum-expected-ingressegress"></a>Calculate the maximum expected ingress/egress
...
## <a name="validate-network-throughput-by-using-performance-tools"></a>Validate network throughput by using performance tools
...
### <a name="download-iperf"></a>Download iPerf
...
### <a name="run-iperf-iperf3exe"></a>Run iPerf (iperf3.exe)
...
## <a name="address-slow-file-copy-issues"></a>Address slow file copy issues
...
![Slow file copy issues](https://docstestmedia1.blob.core.windows.net/azure-media/articles/vpn-gateway/media/vpn-gateway-validate-throughput-to-vnet/RichCopy.png)<br>
...
## <a name="on-premises-device-external-facing-interface"></a>On-premises device external facing interface
...
## <a name="checking-latency"></a>Checking latency
...
![Checking Latency](https://docstestmedia1.blob.core.windows.net/azure-media/articles/vpn-gateway/media/vpn-gateway-validate-throughput-to-vnet/08checkinglatency.png)
