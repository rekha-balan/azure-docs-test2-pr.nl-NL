...
### <a name="change-an-active-standby-gateway-to-an-active-active-gateway"></a>Change an active-standby gateway to an active-active gateway
...
### <a name="change-an-active-active-gateway-to-an-active-standby-gateway"></a>Change an active-active gateway to an active-standby gateway
#### <a name="1-declare-your-variables"></a>1. Declare your variables
