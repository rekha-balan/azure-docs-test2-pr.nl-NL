...
---
# <a name="generate-and-export-certificates-for-point-to-site-using-powershell"></a>Generate and export certificates for Point-to-Site using PowerShell
...
### <a name="export-the-self-signed-root-certificate-and-private-key-to-store-it-optional"></a>Export the self-signed root certificate and private key to store it (optional)
