...
---
# <a name="configure-a-point-to-site-connection-to-a-vnet-using-certificate-authentication-classic-azure-portal"></a>Configure a Point-to-Site connection to a VNet using certificate authentication (classic): Azure portal
...
#### <a name="troubleshooting-p2s-connections"></a>Troubleshooting P2S connections
