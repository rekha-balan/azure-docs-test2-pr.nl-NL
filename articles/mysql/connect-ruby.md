...
---
# <a name="azure-database-for-mysql-use-ruby-to-connect-and-query-data"></a>Azure Database for MySQL: Use Ruby to connect and query data
...
## <a name="install-ruby"></a>Install Ruby
...
## <a name="run-ruby-code"></a>Run Ruby code 
