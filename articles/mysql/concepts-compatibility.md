...
---
# <a name="mysql-drivers-and-management-tools-compatible-with-azure-database-for-mysql"></a>MySQL drivers and management tools compatible with Azure Database for MySQL
