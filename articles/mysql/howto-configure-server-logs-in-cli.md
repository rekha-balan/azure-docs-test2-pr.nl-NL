...
---
# <a name="configure-and-access-server-logs-by-using-azure-cli"></a>Configure and access server logs by using Azure CLI
...
## <a name="configure-logging-for-azure-database-for-mysql"></a>Configure logging for Azure Database for MySQL
...
```
## <a name="download-logs-from-the-server"></a>Download logs from the server
