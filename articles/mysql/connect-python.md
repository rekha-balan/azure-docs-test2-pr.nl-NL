...
---
# <a name="azure-database-for-mysql-use-python-to-connect-and-query-data"></a>Azure Database for MySQL: Use Python to connect and query data
...
## <a name="install-python-and-the-mysql-connector"></a>Install Python and the MySQL connector
...
## <a name="run-python-code"></a>Run Python code
