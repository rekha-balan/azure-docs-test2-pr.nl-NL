...
---
# <a name="create-and-manage-azure-database-for-mysql-server-using-azure-portal"></a>Create and manage Azure Database for MySQL server using Azure portal
...
## <a name="update-an-azure-database-for-mysql-server"></a>Update an Azure Database for MySQL server
...
### <a name="change-the-administrator-user-password"></a>Change the administrator user password
...
### <a name="scale-vcores-updown"></a>Scale vCores up/down
...
### <a name="scale-storage-up"></a>Scale Storage up
...
## <a name="delete-an-azure-database-for-mysql-server"></a>Delete an Azure Database for MySQL server
...
## <a name="list-the-azure-database-for-mysql-databases"></a>List the Azure Database for MySQL databases
...
## <a name="show-details-of-an-azure-database-for-mysql-server"></a>Show details of an Azure Database for MySQL server
