...
---
# <a name="how-to-configure-azure-database-for-mysql-data-in-replication"></a>How to configure Azure Database for MySQL Data-in Replication
...
## <a name="create-a-mysql-server-to-be-used-as-replica"></a>Create a MySQL server to be used as replica
...
## <a name="configure-the-master-server"></a>Configure the master server
...
## <a name="dump-and-restore-master-server"></a>Dump and restore master server
...
## <a name="link-master-and-replica-servers-to-start-data-in-replication"></a>Link master and replica servers to start Data-in Replication
...
## <a name="other-stored-procedures"></a>Other stored procedures

### <a name="stop-replication"></a>Stop replication
...
### <a name="remove-replication-relationship"></a>Remove replication relationship
...
### <a name="skip-replication-error"></a>Skip replication error
