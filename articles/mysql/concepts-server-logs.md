...
---
# <a name="server-logs-in-azure-database-for-mysql"></a>Server Logs in Azure Database for MySQL
...
## <a name="access-server-logs"></a>Access server logs
...
## <a name="log-retention"></a>Log retention
