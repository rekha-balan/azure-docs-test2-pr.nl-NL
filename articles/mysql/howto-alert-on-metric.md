...
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-mysql"></a>Use the Azure portal to set up alerts on metrics for Azure Database for MySQL 
...
## <a name="create-an-alert-rule-on-a-metric-from-the-azure-portal"></a>Create an alert rule on a metric from the Azure portal
...
## <a name="manage-your-alerts"></a>Manage your alerts
