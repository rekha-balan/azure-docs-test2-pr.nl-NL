...
---
# <a name="azure-database-for-mysql-use-nodejs-to-connect-and-query-data"></a>Azure Database for MySQL: Use Node.js to connect and query data
...
## <a name="install-nodejs-and-the-mysql-connector"></a>Install Node.js and the MySQL connector
...
## <a name="running-the-javascript-code-in-nodejs"></a>Running the JavaScript code in Node.js
