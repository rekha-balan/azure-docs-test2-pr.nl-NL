...
---
# <a name="azure-database-for-mysql-use-net-c-to-connect-and-query-data"></a>Azure Database for MySQL: Use .NET (C#) to connect and query data
...
## <a name="create-a-c-project"></a>Create a C# project
