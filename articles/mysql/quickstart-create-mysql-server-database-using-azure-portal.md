...
---
# <a name="create-an-azure-database-for-mysql-server-by-using-the-azure-portal"></a>Create an Azure Database for MySQL server by using the Azure portal
...
## <a name="configure-a-server-level-firewall-rule"></a>Configure a server-level firewall rule
...
## <a name="connect-to-mysql-by-using-the-mysql-command-line-tool"></a>Connect to MySQL by using the mysql command-line tool
...
## <a name="connect-to-the-server-by-using-the-mysql-workbench-gui-tool"></a>Connect to the server by using the MySQL Workbench GUI tool
