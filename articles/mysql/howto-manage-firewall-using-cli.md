...
---
# <a name="create-and-manage-azure-database-for-mysql-firewall-rules-by-using-the-azure-cli"></a>Create and manage Azure Database for MySQL firewall rules by using the Azure CLI
...
## <a name="firewall-rule-commands"></a>Firewall rule commands:
...
## <a name="log-in-to-azure-and-list-your-azure-database-for-mysql-servers"></a>Log in to Azure and list your Azure Database for MySQL Servers
...
## <a name="list-firewall-rules-on-azure-database-for-mysql-server"></a>List firewall rules on Azure Database for MySQL Server 
...
```
## <a name="create-a-firewall-rule-on-azure-database-for-mysql-server"></a>Create a firewall rule on Azure Database for MySQL Server
...
## <a name="update-a-firewall-rule-on-azure-database-for-mysql-server"></a>Update a firewall rule on Azure Database for MySQL server 
...
## <a name="show-firewall-rule-details-on-azure-database-for-mysql-server"></a>Show firewall rule details on Azure Database for MySQL Server
...
## <a name="delete-a-firewall-rule-on-azure-database-for-mysql-server"></a>Delete a firewall rule on Azure Database for MySQL Server
