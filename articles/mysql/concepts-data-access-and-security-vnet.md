...
---
# <a name="use-virtual-network-service-endpoints-and-rules-for-azure-database-for-mysql"></a>Use Virtual Network service endpoints and rules for Azure Database for MySQL
...
## <a name="terminology-and-description"></a>Terminology and description
...
## <a name="benefits-of-a-virtual-network-rule"></a>Benefits of a virtual network rule
...
### <a name="a-allow-access-to-azure-services"></a>A. Allow access to Azure services
...
### <a name="b-ip-rules"></a>B. IP rules
...
### <a name="c-cannot-yet-have-azure-database-for-mysql-on-a-subnet-without-defining-a-service-endpoint"></a>C. Cannot yet have Azure Database for MySQL on a subnet without defining a service endpoint
