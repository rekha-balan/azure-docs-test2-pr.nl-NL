...
---
# <a name="configure-and-access-server-logs-in-the-azure-portal"></a>Configure and access server logs in the Azure portal
...
## <a name="view-list-and-download-logs"></a>View list and download logs
