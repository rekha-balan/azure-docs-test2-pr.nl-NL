...
---
# <a name="server-concepts-in-azure-database-for-mysql"></a>Server concepts in Azure Database for MySQL
This article provides considerations and guidelines for working with Azure Database for MySQL servers.

## <a name="what-is-an-azure-database-for-mysql-server"></a>What is an Azure Database for MySQL server?
...
## <a name="how-do-i-connect-and-authenticate-to-an-azure-database-for-mysql-server"></a>How do I connect and authenticate to an Azure Database for MySQL server?
...
## <a name="how-do-i-manage-a-server"></a>How do I manage a server?
