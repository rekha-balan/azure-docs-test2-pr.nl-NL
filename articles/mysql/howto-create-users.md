...
---
# <a name="create-users-in-azure-database-for-mysql-server"></a>Create users in Azure Database for MySQL server 
...
## <a name="how-to-create-additional-admin-users-in-azure-database-for-mysql"></a>How to create additional admin users in Azure Database for MySQL
...
## <a name="how-to-create-database-users-in-azure-database-for-mysql"></a>How to create database users in Azure Database for MySQL
...
Open the firewall for the IP addresses of the new users' machines to enable them to connect: [Create and manage Azure Database for MySQL firewall rules by using the Azure portal](howto-manage-firewall-using-portal.md) or [Azure CLI](howto-manage-firewall-using-cli.md).
