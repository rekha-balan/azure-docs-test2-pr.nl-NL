...
---
# <a name="configure-ssl-connectivity-in-your-application-to-securely-connect-to-azure-database-for-mysql"></a>Configure SSL connectivity in your application to securely connect to Azure Database for MySQL
Azure Database for MySQL supports connecting your Azure Database for MySQL server to client applications using Secure Sockets Layer (SSL). Enforcing SSL connections between your database server and your client applications helps protect against "man in the middle" attacks by encrypting the data stream between the server and your application.

## <a name="step-1-obtain-ssl-certificate"></a>Step 1: Obtain SSL certificate
...
## <a name="step-2-bind-ssl"></a>Step 2: Bind SSL
### <a name="connecting-to-server-using-the-mysql-workbench-over-ssl"></a>Connecting to server using the MySQL Workbench over SSL
...
![save customized tile](./media/howto-configure-ssl/mysql-workbench-ssl.png) For existing connections, you can bind SSL by right-clicking on the connection icon and choose edit. Then navigate to the **SSL** tab and bind the cert file.

### <a name="connecting-to-server-using-the-mysql-cli-over-ssl"></a>Connecting to server using the MySQL CLI over SSL
...
## <a name="step-3--enforcing-ssl-connections-in-azure"></a>Step 3:  Enforcing SSL connections in Azure 
...
## <a name="step-4-verify-the-ssl-connection"></a>Step 4: Verify the SSL connection
