...
---
# <a name="azure-database-for-mysql-use-go-language-to-connect-and-query-data"></a>Azure Database for MySQL: Use Go language to connect and query data
...
## <a name="install-go-and-mysql-connector"></a>Install Go and MySQL connector
...
## <a name="build-and-run-go-code"></a>Build and run Go code 
