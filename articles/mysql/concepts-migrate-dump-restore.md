...
---
# <a name="migrate-your-mysql-database-to-azure-database-for-mysql-using-dump-and-restore"></a>Migrate your MySQL database to Azure Database for MySQL using dump and restore
...
## <a name="common-uses-for-dump-and-restore"></a>Common uses for dump and restore
...
## <a name="create-a-backup-file-from-the-command-line-using-mysqldump"></a>Create a backup file from the command-line using mysqldump
...
## <a name="create-a-database-on-the-target-azure-database-for-mysql-server"></a>Create a database on the target Azure Database for MySQL server
...
## <a name="restore-your-mysql-database-using-command-line-or-mysql-workbench"></a>Restore your MySQL database using command-line or MySQL Workbench
...
## <a name="export-using-phpmyadmin"></a>Export using PHPMyAdmin
...
## <a name="import-using-phpmyadmin"></a>Import using PHPMyAdmin
