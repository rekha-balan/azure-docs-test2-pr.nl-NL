...
---
# <a name="migrate-your-mysql-database-by-using-import-and-export"></a>Migrate your MySQL database by using import and export
...
## <a name="use-common-tools"></a>Use common tools
...
## <a name="create-a-database-on-the-azure-database-for-mysql-server"></a>Create a database on the Azure Database for MySQL server
...
## <a name="determine-when-to-use-import-and-export-techniques-instead-of-a-dump-and-restore"></a>Determine when to use import and export techniques instead of a dump and restore
...
## <a name="performance-recommendations-for-import-and-export"></a>Performance recommendations for import and export
...
## <a name="import-and-export-by-using-mysql-workbench"></a>Import and export by using MySQL Workbench
There are two ways to export and import data in MySQL Workbench. Each serves a different purpose. 

### <a name="table-data-export-and-import-wizards-from-the-object-browsers-context-menu"></a>Table data export and import wizards from the object browser's context menu
...
#### <a name="table-data-export-wizard"></a>Table Data Export Wizard
...
#### <a name="table-data-import-wizard"></a>Table Data Import Wizard
