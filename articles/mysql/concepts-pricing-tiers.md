...
---
# <a name="azure-database-for-mysql-pricing-tiers"></a>Azure Database for MySQL pricing tiers
...
## <a name="compute-generations-and-vcores"></a>Compute generations and vCores
...
### <a name="reaching-the-storage-limit"></a>Reaching the storage limit
...
## <a name="scale-resources"></a>Scale resources
