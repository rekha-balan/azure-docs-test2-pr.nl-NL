...
---
# <a name="customize-server-configuration-parameters-by-using-azure-cli"></a>Customize server configuration parameters by using Azure CLI
...
## <a name="show-server-configuration-parameter-details"></a>Show server configuration parameter details
...
```
## <a name="modify-a-server-configuration-parameter-value"></a>Modify a server configuration parameter value
