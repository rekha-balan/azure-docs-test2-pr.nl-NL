...
---
# <a name="tutorial-design-an-azure-database-for-mysql-database-using-the-azure-portal"></a>Tutorial: Design an Azure Database for MySQL database using the Azure portal
...
## <a name="configure-firewall"></a>Configure firewall
...
## <a name="connect-to-the-server-using-mysql"></a>Connect to the server using mysql
...
## <a name="create-tables-in-the-database"></a>Create tables in the database
...
## <a name="load-data-into-the-tables"></a>Load data into the tables
...
## <a name="query-and-update-the-data-in-the-tables"></a>Query and update the data in the tables
...
## <a name="restore-a-database-to-a-previous-point-in-time"></a>Restore a database to a previous point in time
