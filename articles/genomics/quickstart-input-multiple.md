...
---
# <a name="submit-a-workflow-using-multiple-inputs-from-the-same-sample"></a>Submit a workflow using multiple inputs from the same sample
...
## <a name="multiple-bam-files"></a>Multiple BAM files

### <a name="upload-your-input-files-to-azure-storage"></a>Upload your input files to Azure storage
...
### <a name="submit-your-job-to-the-msgen-client"></a>Submit your job to the `msgen` client 
...
## <a name="multiple-paired-fastq-files"></a>Multiple paired FASTQ files
