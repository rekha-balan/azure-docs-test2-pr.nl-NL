...
---
# <a name="quickstart-run-a-workflow-through-the-microsoft-genomics-service"></a>Quickstart: Run a workflow through the Microsoft Genomics service

Microsoft Genomics is a scalable, secure service for secondary analysis that can rapidly process a genome, starting from raw reads and producing aligned reads and variant calls. Get started in just a few steps: 
...
## <a name="set-up-create-a-microsoft-genomics-account-in-the-azure-portal"></a>Set up: Create a Microsoft Genomics account in the Azure portal
...
## <a name="set-up-install-the-microsoft-genomics-python-client"></a>Set up: Install the Microsoft Genomics Python client
...
### <a name="install-the-microsoft-genomics-client"></a>Install the Microsoft Genomics client
...
### <a name="test-the-microsoft-genomics-client"></a>Test the Microsoft Genomics client
...
## <a name="create-a-microsoft-azure-storage-account"></a>Create a Microsoft Azure Storage Account 
...
## <a name="upload-input-data-to-your-storage-account"></a>Upload input data to your storage account
...
## <a name="run-a-workflow-through-the-microsoft-genomics-service-using-the-python-client"></a>Run a workflow through the Microsoft Genomics service using the Python client 
...
### <a name="submit-your-workflow-to-the-microsoft-genomics-service-the-microsoft-genomics-client"></a>Submit your workflow to the Microsoft Genomics service the Microsoft Genomics client
