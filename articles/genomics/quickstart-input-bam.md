...
---
# <a name="submit-a-workflow-using-a-bam-file-input"></a>Submit a workflow using a BAM file input
...
## <a name="set-up-upload-your-bam-file-to-azure-storage"></a>Set up: Upload your BAM file to Azure storage
