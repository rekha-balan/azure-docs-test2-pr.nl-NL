...
---
# <a name="submit-a-workflow-using-fastq-file-inputs"></a>Submit a workflow using FASTQ file inputs
...
## <a name="set-up-upload-your-fastq-files-to-azure-storage"></a>Set up: Upload your FASTQ files to Azure storage
