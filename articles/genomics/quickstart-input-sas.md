...
---
# <a name="submit-a-workflow-using-a-sas-instead-of-a-storage-account-key"></a>Submit a workflow using a SAS instead of a storage account key
...
## <a name="what-is-a-sas"></a>What is a SAS?
...
## <a name="sas-needed-for-submitting-a-workflow-to-the-microsoft-genomics-service"></a>SAS needed for submitting a workflow to the Microsoft Genomics service
...
## <a name="create-a-sas-for-the-input-files-and-the-output-container"></a>Create a SAS for the input files and the output container
...
### <a name="set-up-create-a-sas-using-azure-storage-explorer"></a>Set up: Create a SAS using Azure Storage Explorer
...
### <a name="set-up-create-a-sas-programattically"></a>Set up: Create a SAS programattically
...
## <a name="add-the-sas-to-the-configtxt-file"></a>Add the SAS to the config.txt file
...
### <a name="if-adding-the-input-file-names-to-the-configtxt-file"></a>If adding the input file names to the config.txt file
