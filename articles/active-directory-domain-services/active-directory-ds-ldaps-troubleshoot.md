...
---
# <a name="troubleshoot-secure-ldap-ldaps-for-an-azure-ad-domain-services-managed-domain"></a>Troubleshoot Secure LDAP (LDAPS) for an Azure AD Domain Services managed domain
