...
---
# <a name="troubleshoot-invalid-service-principal-configuration-for-your-managed-domain"></a>Troubleshoot invalid Service Principal configuration for your managed domain
...
## <a name="alert-aadds102-service-principal-not-found"></a>Alert AADDS102: Service Principal not found
...
## <a name="check-for-missing-service-principals"></a>Check for missing service principals
...
## <a name="recreate-a-missing-service-principal-with-powershell"></a>Recreate a missing Service Principal with PowerShell
...
**Resolution:** You need Azure AD PowerShell to complete these steps. For information on installing Azure AD PowerShell, see [this article](https://docs.microsoft.com/powershell/azure/active-directory/install-adv2?view=azureadps-2.0.).
...
## <a name="re-register-to-the-microsoft-aad-namespace-using-the-azure-portal"></a>Re-register to the Microsoft AAD namespace using the Azure portal
...
## <a name="service-principals-that-self-correct"></a>Service Principals that self correct
