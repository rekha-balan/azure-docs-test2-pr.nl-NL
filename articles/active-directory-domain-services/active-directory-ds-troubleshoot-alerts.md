...
---
# <a name="azure-ad-domain-services---troubleshoot-alerts"></a>Azure AD Domain Services - Troubleshoot alerts
...
## <a name="aadds100-missing-directory"></a>AADDS100: Missing directory
**Alert message:**
...
## <a name="aadds101-azure-ad-b2c-is-running-in-this-directory"></a>AADDS101: Azure AD B2C is running in this directory
**Alert message:**
...
## <a name="aadds103-address-is-in-a-public-ip-range"></a>AADDS103: Address is in a public IP range
...
## <a name="aadds500-synchronization-has-not-completed-in-a-while"></a>AADDS500: Synchronization has not completed in a while
...
## <a name="aadds501-a-backup-has-not-been-taken-in-a-while"></a>AADDS501: A backup has not been taken in a while
...
## <a name="aadds503-suspension-due-to-disabled-subscription"></a>AADDS503: Suspension due to disabled subscription
...
## <a name="aadds504-suspension-due-to-an-invalid-configuration"></a>AADDS504: Suspension due to an invalid configuration
