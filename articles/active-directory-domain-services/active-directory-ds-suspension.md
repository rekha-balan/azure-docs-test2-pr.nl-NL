...
---
# <a name="suspended-domains"></a>Suspended domains
...
## <a name="states-your-managed-domain-can-be-in"></a>States your managed domain can be in
...
### <a name="running-state"></a>"Running" state
...
### <a name="needs-attention-state"></a>"Needs Attention" state
...
### <a name="the-suspended-state"></a>The "Suspended" state
...
### <a name="deleted-state"></a>"Deleted" state
...
## <a name="how-do-you-know-if-your-managed-domain-is-suspended"></a>How do you know if your managed domain is suspended?
...
## <a name="restore-a-suspended-domain"></a>Restore a suspended domain
