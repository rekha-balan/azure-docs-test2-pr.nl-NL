...
## <a name="step-1-create-a-windows-server-virtual-machine"></a>Step 1: Create a Windows Server virtual machine
...
## <a name="step-2-connect-to-the-windows-server-virtual-machine-by-using-the-local-administrator-account"></a>Step 2: Connect to the Windows Server virtual machine by using the local administrator account
...
## <a name="step-3-join-the-windows-server-virtual-machine-to-the-azure-ad-ds-managed-domain"></a>Step 3: Join the Windows Server virtual machine to the Azure AD DS-managed domain
...
## <a name="troubleshoot-joining-a-domain"></a>Troubleshoot joining a domain
