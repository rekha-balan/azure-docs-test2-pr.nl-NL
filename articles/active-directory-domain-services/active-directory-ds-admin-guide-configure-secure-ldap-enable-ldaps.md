...
---
# <a name="enable-secure-ldap-ldaps-for-an-azure-ad-domain-services-managed-domain"></a>Enable secure LDAP (LDAPS) for an Azure AD Domain Services managed domain
...
## <a name="task-3-enable-secure-ldap-for-the-managed-domain-using-the-azure-portal"></a>Task 3: Enable secure LDAP for the managed domain using the Azure portal
