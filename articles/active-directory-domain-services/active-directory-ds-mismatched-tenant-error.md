...
---
# <a name="resolve-mismatched-directory-errors-for-existing-azure-ad-domain-services-managed-domains"></a>Resolve mismatched directory errors for existing Azure AD Domain Services managed domains
...
## <a name="whats-causing-this-error"></a>What's causing this error?
