...
---
# <a name="join-an-ubuntu-virtual-machine-in-azure-to-a-managed-domain"></a>Join an Ubuntu virtual machine in Azure to a managed domain
...
## <a name="provision-an-ubuntu-linux-virtual-machine"></a>Provision an Ubuntu Linux virtual machine
...
## <a name="connect-remotely-to-the-ubuntu-linux-virtual-machine"></a>Connect remotely to the Ubuntu Linux virtual machine
...
## <a name="configure-the-ntp-network-time-protocol-settings-on-the-linux-virtual-machine"></a>Configure the NTP (Network Time Protocol) settings on the Linux virtual machine
...
## <a name="update-the-sssd-configuration-and-restart-the-service"></a>Update the SSSD configuration and restart the service
...
## <a name="configure-automatic-home-directory-creation"></a>Configure automatic home directory creation
...
## <a name="grant-the-aad-dc-administrators-group-sudo-privileges"></a>Grant the 'AAD DC Administrators' group sudo privileges
