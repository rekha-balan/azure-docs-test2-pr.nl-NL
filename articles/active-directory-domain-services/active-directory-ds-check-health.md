...
---
# <a name="check-the-health-of-an-azure-ad-domain-services-managed-domain"></a>Check the health of an Azure AD Domain Services managed domain

## <a name="overview-of-the-health-page"></a>Overview of the health page
...
### <a name="how-to-view-the-health-of-your-managed-domain"></a>How to view the health of your managed domain
...
The following picture illustrates a sample health page: ![Example health page](.\media\active-directory-domain-services-alerts\health-page.png)
...
### <a name="status-of-your-managed-domain"></a>Status of your managed domain
...
### <a name="the-backup-monitor"></a>The 'backup' monitor
...
### <a name="the-synchronization-with-azure-ad-monitor"></a>The 'synchronization with Azure AD' monitor
...
### <a name="alert-severity"></a>Alert severity
