...
---
# <a name="enable-azure-active-directory-domain-services-using-the-azure-portal"></a>Enable Azure Active Directory Domain Services using the Azure portal


## <a name="task-3-configure-administrative-group"></a>Task 3: configure administrative group
...
## <a name="deploy-your-managed-domain"></a>Deploy your managed domain
...
## <a name="check-the-deployment-status-of-your-managed-domain"></a>Check the deployment status of your managed domain
