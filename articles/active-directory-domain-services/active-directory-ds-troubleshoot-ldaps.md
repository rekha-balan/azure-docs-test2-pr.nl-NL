...
---
# <a name="azure-ad-domain-services---troubleshooting-secure-ldap-configuration"></a>Azure AD Domain Services - Troubleshooting Secure LDAP configuration
...
## <a name="aadds101-secure-ldap-network-security-group-configuration"></a>AADDS101: Secure LDAP Network Security Group configuration
...
## <a name="aadds502-secure-ldap-certificate-expiring"></a>AADDS502: Secure LDAP certificate expiring
