...
---
# <a name="join-a-windows-server-virtual-machine-to-a-managed-domain-using-a-resource-manager-template"></a>Join a Windows Server virtual machine to a managed domain using a Resource Manager template
...
## <a name="install-and-configure-required-tools"></a>Install and configure required tools
...
## <a name="option-1-provision-a-new-windows-server-vm-and-join-it-to-a-managed-domain"></a>Option 1: Provision a new Windows Server VM and join it to a managed domain
...
## <a name="option-2-join-an-existing-windows-server-vm-to-a-managed-domain"></a>Option 2: Join an existing Windows Server VM to a managed domain
