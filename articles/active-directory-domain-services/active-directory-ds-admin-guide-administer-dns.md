...
## <a name="task-1---create-a-domain-joined-virtual-machine-to-remotely-administer-dns-for-the-managed-domain"></a>Task 1 - Create a domain-joined virtual machine to remotely administer DNS for the managed domain
