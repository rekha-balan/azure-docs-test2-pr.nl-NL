...
## <a name="considerations-when-exporting-an-azure-sql-database"></a>Considerations when exporting an Azure SQL database
...
## <a name="export-to-a-bacpac-file-using-the-azure-portal"></a>Export to a BACPAC file using the Azure portal
...
## <a name="export-to-a-bacpac-file-using-the-sqlpackage-utility"></a>Export to a BACPAC file using the SQLPackage utility
...
## <a name="export-to-a-bacpac-file-using-sql-server-management-studio-ssms"></a>Export to a BACPAC file using SQL Server Management Studio (SSMS)
...
## <a name="export-to-a-bacpac-file-using-powershell"></a>Export to a BACPAC file using PowerShell
