...
---
# <a name="create-and-manage-an-elastic-pool-with-cx23"></a>Create and manage an elastic pool with C&#x23;
...
## <a name="create-a-sql-elastic-pool---c-example"></a>Create a SQL elastic pool - C# example
