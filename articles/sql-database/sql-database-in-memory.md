...
---
# <a name="optimize-performance-by-using-in-memory-technologies-in-sql-database"></a>Optimize performance by using In-Memory technologies in SQL Database
...
## <a name="storage-and-data-size"></a>Storage and data size

### <a name="data-size-and-storage-cap-for-in-memory-oltp"></a>Data size and storage cap for In-Memory OLTP
...
#### <a name="about-elastic-pools"></a>About elastic pools
...
### <a name="data-size-and-storage-for-columnstore-indexes"></a>Data size and storage for columnstore indexes
...
## <a name="moving-databases-that-use-in-memory-technologies-between-pricing-tiers"></a>Moving databases that use In-Memory technologies between pricing tiers
...
### <a name="columnstore-indexes"></a>Columnstore indexes
...
## <a name="1-install-the-in-memory-oltp-sample"></a>1. Install the In-Memory OLTP sample
...
## <a name="2-install-the-in-memory-analytics-sample"></a>2. Install the In-Memory Analytics sample
...
#### <a name="key-tables-and-columnstore-indexes"></a>Key tables and columnstore indexes
...
#### <a name="key-queries-to-compare-the-columnstore-index"></a>Key queries to compare the columnstore index
