...
---
# <a name="monitor-and-manage-an-elastic-pool-with-transact-sql"></a>Monitor and manage an elastic pool with Transact-SQL
...
## <a name="get-resource-usage-for-a-pooled-database"></a>Get resource usage for a pooled database
