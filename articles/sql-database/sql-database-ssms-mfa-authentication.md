...
---
# <a name="universal-authentication-with-sql-database-and-sql-data-warehouse-ssms-support-for-mfa"></a>Universal Authentication with SQL Database and SQL Data Warehouse (SSMS support for MFA)
...
## <a name="the-five-authentication-options"></a>The five authentication options  
...
### <a name="azure-ad-domain-name-or-tenant-id-parameter"></a>Azure AD domain name or tenant ID parameter   
...
### <a name="azure-ad-business-to-business-support"></a>Azure AD business to business support   
