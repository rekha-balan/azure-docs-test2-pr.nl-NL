...
---
# <a name="feature-comparison-azure-sql-database-versus-sql-server"></a>Feature comparison: Azure SQL Database versus SQL Server 
...
## <a name="sql-server-feature-support-in-azure-sql-database"></a>SQL Server feature support in Azure SQL Database
