...
---
# <a name="use-in-memory-oltp-to-improve-your-application-performance-in-sql-database"></a>Use In-Memory OLTP to improve your application performance in SQL Database
...
## <a name="step-1-ensure-you-are-using-a-premium-database"></a>Step 1: Ensure you are using a Premium database
