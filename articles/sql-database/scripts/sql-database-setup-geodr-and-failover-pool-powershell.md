...
---
# <a name="configure-active-geo-replication-for-a-pooled-azure-sql-database-using-powershell"></a>Configure Active Geo-Replication for a pooled Azure SQL database using PowerShell
