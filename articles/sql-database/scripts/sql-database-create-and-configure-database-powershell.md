...
---
# <a name="use-powershell-to-create-a-single-azure-sql-database-and-configure-a-firewall-rule"></a>Use PowerShell to create a single Azure SQL database and configure a firewall rule
