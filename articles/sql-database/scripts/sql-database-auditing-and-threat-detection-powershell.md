...
---
# <a name="use-powershell-to-configure-sql-database-auditing-and-threat-detection"></a>Use PowerShell to configure SQL Database auditing and threat detection
