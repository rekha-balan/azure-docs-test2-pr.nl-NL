...
---
# <a name="configure-active-geo-replication-for-azure-sql-database-with-transact-sql"></a>Configure active geo-replication for Azure SQL Database with Transact-SQL
...
### <a name="add-non-readable-secondary-elastic-pool"></a>Add non-readable secondary (elastic pool)
...
### <a name="add-readable-secondary-elastic-pool"></a>Add readable secondary (elastic pool)
...
## <a name="monitor-active-geo-replication-configuration-and-health"></a>Monitor active geo-replication configuration and health
