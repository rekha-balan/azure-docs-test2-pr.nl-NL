...
---
# <a name="application-design-for-cloud-disaster-recovery-using-active-geo-replication-in-sql-database"></a>Application design for cloud disaster recovery using Active Geo-Replication in SQL Database
> [!NOTE]
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern1-1.png)
...
![Geo-Replication: Failover to secondary database. App data backup.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern1-2.png)
...
![Secondary database synchronized with primary. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern1-3.png)
...
![No outage: Performance routing to nearest application. Geo-Replication.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern2-1.png)
...
![Configuration after failover. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern2-2.png)
...
![Outage in secondary region. Cloud disaster recovery - Geo-Replication.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern2-3.png)
...
![Active-passive deployment before failover. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern3-1.png)
...
![Outage: Application in read-only mode. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern3-2.png)
...
![Outage: Secondary database. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-designing-cloud-solutions-for-disaster-recovery/pattern3-3.png)
