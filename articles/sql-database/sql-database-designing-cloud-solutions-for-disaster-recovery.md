...
---
# <a name="designing-globally-available-services-using-azure-sql-database"></a>Designing globally available services using Azure SQL Database
...
## <a name="scenario-1-using-two-azure-regions-for-business-continuity-with-minimal-downtime"></a>Scenario 1: Using two Azure regions for business continuity with minimal downtime
...
## <a name="scenario-2-azure-regions-for-business-continuity-with-maximum-data-preservation"></a>Scenario 2: Azure regions for business continuity with maximum data preservation
...
## <a name="scenario-3-application-relocation-to-a-different-geography-without-data-loss-and-near-zero-downtime"></a>Scenario 3: Application relocation to a different geography without data loss and near zero downtime 
