...
---
# <a name="azure-sql-database-connect-and-query-quickstarts"></a>Azure SQL Database Connect and Query Quickstarts
...
## <a name="tls-considerations-for-sql-database-connectivity"></a>TLS considerations for SQL Database connectivity
