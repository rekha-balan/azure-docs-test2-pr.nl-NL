...
ms.date: 01/23/2017
ms.author: carolz
ms.openlocfilehash: 3e05e8538efa7ecc214652d92673eb3a24b1fe3b
ms.sourcegitcommit: 5b9d839c0c0a94b293fdafe1d6e5429506c07e05
ms.translationtype: MT
ms.contentlocale: nl-NL
ms.lasthandoff: 08/02/2018
ms.locfileid: "44540645"
---
<div class="content">
...
<div class="ico48Case">
    <div class="ico48Link">
        <a href="/azure-nomedia/sql-database/sql-database-get-started-portal">
            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/index/portal.svg" alt="">
            <span>Azure Portal</span>
        </a>
    </div>
    <div class="ico48Link">
        <a href="/azure-nomedia/sql-database/sql-database-get-started-cli">
            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/index/cli.svg" alt="">
            <span>Azure CLI</span>
        </a>
    </div>
    <div class="ico48Link">
        <a href="/azure-nomedia/sql-database/sql-database-get-started-powershell">
            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/index/logo_powershell.svg" alt="">
...
<div class="columnHolder">
    <div class="column50">
        ...
        <ul class="spaced">
            <li><a href="/azure-nomedia/sql-database/sql-database-design-first-database">Design a database</a></li>
            <li><a href="/azure-nomedia/sql-database/sql-database-migrate-your-sql-server-database">Migrate a database</a></li>
        </ul>
        <h2>Samples</h2>
        <p>Find scripts to manage common tasks.</p>
        <ul class="spaced">
            <li><a href="/azure-nomedia/sql-database/sql-database-cli-samples">Azure CLI</a></li>
            <li><a href="/azure-nomedia/sql-database/sql-database-powershell-samples">Azure PowerShell</a></li>
        </ul>
    </div>
    <div class="column50" style="max-width: 400px">
        ...
        <a href="https://www.pluralsight.com/courses/developing-dotnet-microsoft-azure-getting-started?twoid=d6abac77-7dcc-4d33-9e03-f85e78989f02">
            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/index/video-training-dotnet.png" width="400" alt="">
