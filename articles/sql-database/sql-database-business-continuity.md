...
### <a name="use-active-geo-replication-and-auto-failover-groups-to-reduce-recovery-time-and-limit-data-loss-associated-with-a-recovery"></a>Use Active Geo-Replication and auto-failover groups to reduce recovery time and limit data loss associated with a recovery
...
### <a name="restore-from-azure-backup-vault"></a>Restore from Azure Backup Vault
