...
## <a name="what-is-the-current-version-of-sql-database"></a>What is the current version of SQL Database?
The current version of SQL Database is V12. Version V11 has been retired.

## <a name="what-is-the-sla-for-sql-database"></a>What is the SLA for SQL Database?
...
## <a name="can-i-control-when-patching-downtime-occurs"></a>Can I control when patching downtime occurs
...
## <a name="what-is-the-new-vcore-based-purchasing-model-for-azure-sql-database"></a>What is the new vCore-based purchasing model for Azure SQL Database?
...
## <a name="what-is-a-vcore"></a>What is a vCore? 
...
## <a name="is-moving-to-the-vcore-based-model-required"></a>Is moving to the vCore-based model required?
...
## <a name="how-should-i-choose-between-the-dtu-based-purchasing-model-vs-the-vcore-based-purchasing-model"></a>How should I choose between the DTU-based purchasing model vs the vCore-based purchasing model? 
...
## <a name="what-is-the-azure-hybrid-benefit-for-sql-server"></a>What is the Azure Hybrid Benefit for SQL Server? 
...
## <a name="are-there-dual-use-rights-with-azure-hybrid-benefit-for-sql-server"></a>Are there dual-use rights with Azure Hybrid Benefit for SQL Server?
...
## <a name="how-does-azure-hybrid-benefit-for-sql-server-differ-from-license-mobility"></a>How does Azure Hybrid Benefit for SQL Server differ from license mobility?
...
## <a name="what-are-the-specific-rights-of-the-azure-hybrid-benefit-for-sql-server"></a>What are the specific rights of the Azure Hybrid Benefit for SQL Server?
...
## <a name="is-the-vcore-based-model-available-to-sql-database-managed-instance"></a>Is the vCore-based model available to SQL Database Managed Instance?
...
## <a name="does-the-cost-of-compute-and-storage-depend-on-the-service-tier-that-i-choose"></a>Does the cost of compute and storage depend on the service tier that I choose?
...
## <a name="how-am-i-charged-for-storage---based-on-what-i-configure-upfront-or-on-what-the-database-uses"></a>How am I charged for storage - based on what I configure upfront or on what the database uses?
...
## <a name="how-do-i-select-the-right-sku-when-converting-an-existing-database-to-the-new-service-tiers"></a>How do I select the right SKU when converting an existing database to the new service tiers? 
...
## <a name="do-the-new-vcore-based-service-tiers-offer-the-performance-levels-compatible-with-all-existing-service-level-objectives-slos"></a>Do the new vCore-based service tiers offer the performance levels compatible with all existing service level objectives (SLOs)?
...
## <a name="are-there-any-database-feature-differences-between-the-existing-dtu-based-and-new-vcore-based-service-tiers"></a>Are there any database feature differences between the existing DTU-based and new vCore-based service tiers? 
...
## <a name="if-my-database-is-cpu-bound-and-does-not-use-much-storage-can-i-increase-the-compute-without-paying-for-extra-storage"></a>If my database is CPU-bound and does not use much storage, can I increase the compute without paying for extra storage?
...
## <a name="will-the-new-vcore-based-tiers-support-point-in-time-restore-pitr-for-35-days-as-today"></a>Will the new vCore-based tiers support point in time restore (PITR) for 35 days as today? 
...
## <a name="why-do-you-allow-selection-of-the-hardware-generation-for-compute"></a>Why do you allow selection of the hardware generation for compute?
...
## <a name="do-i-need-to-take-my-application-offline-to-convert-from-a-dtu-based-database-to-a-vcore-based-service-tier"></a>Do I need to take my application offline to convert from a DTU-based database to a vCore-based service tier? 
...
## <a name="can-i-convert-a-database-from-a-vcore-based-service-tier-to-a-dtu-based-one"></a>Can I convert a database from a vCore-based service tier to a DTU-based one? 
...
## <a name="can-i-upgrade-or-downgrade-between-the-general-purpose-and-business-critical-service-tiers"></a>Can I upgrade or downgrade between the General Purpose and Business Critical service tiers? 
...
## <a name="i-am-using-a-premium-rs-database-that-will-not-be-generally-available---can-i-upgrade-it-to-a-new-tier-and-achieve-a-similar-priceperformance-benefit"></a>I am using a Premium RS database that will not be Generally Available - can I upgrade it to a new tier and achieve a similar price/performance benefit?
...
## <a name="how-often-can-i-adjust-the-resources-per-pool"></a>How often can I adjust the resources per pool?
As often as you want. See [Manage elastic pools](sql-database-elastic-pool.md).

## <a name="how-long-does-it-take-to-change-the-service-tier-or-performance-level-of-a-single-database-or-move-a-database-in-and-out-of-an-elastic-pool"></a>How long does it take to change the service tier or performance level of a single database or move a database in and out of an elastic pool?
...
## <a name="how-does-the-usage-of-sql-database-using-the-dtu-based-purchasing-model-show-up-on-my-bill"></a>How does the usage of SQL Database using the DTU-based purchasing model show up on my bill?
...
## <a name="how-does-elastic-pool-usage-using-the-dtu-based-purchasing-model-show-up-on-my-bill"></a>How does elastic pool usage using the DTU-based purchasing model show up on my bill?
...
## <a name="how-are-elastic-pool-billed-for-the-dtu-based-purchasing-model"></a>How are elastic pool billed for the DTU-based purchasing model?
...
## <a name="how-does-the-vcore-based-usage-show-up-in-my-bill"></a>How does the vCore-based usage show up in my bill? 
...
## <a name="how-does-the-use-of-active-geo-replication-in-an-elastic-pool-show-up-on-my-bill"></a>How does the use of active geo-replication in an elastic pool show up on my bill?
...
## <a name="how-do-i-reset-the-password-for-the-server-admin"></a>How do I reset the password for the server admin?
...
## <a name="how-do-i-manage-databases-and-logins"></a>How do I manage databases and logins?
...
## <a name="how-do-i-make-sure-only-authorized-ip-addresses-are-allowed-to-access-a-server"></a>How do I make sure only authorized IP addresses are allowed to access a server?
