...
## <a name="how-does-elastic-pool-usage-show-up-on-my-bill-and-what-happens-when-i-change-edtus-per-pool"></a>How does elastic pool usage show up on my bill and what happens when I change eDTUs per pool?
...
## <a name="elastic-pool-billing-and-pricing-information"></a>Elastic pool billing and pricing information
...
## <a name="how-do-i-find-the-right-service-tier-and-performance-level-for-single-databases-and-elastic-pools"></a>How do I find the right service tier and performance level for single databases and elastic pools?
