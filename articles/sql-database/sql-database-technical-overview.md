...
---
# <a name="what-is-the-azure-sql-database-service"></a>What is the Azure SQL Database service? 
...
## <a name="scalable-performance-and-pools"></a>Scalable performance and pools
...
### <a name="elastic-pools-to-maximize-resource-utilization"></a>Elastic pools to maximize resource utilization
...
### <a name="blend-single-databases-with-pooled-databases"></a>Blend single databases with pooled databases
...
### <a name="extensive-monitoring-and-alerting-capabilities"></a>Extensive monitoring and alerting capabilities
...
## <a name="availability-capabilities"></a>Availability capabilities
...
## <a name="built-in-intelligence"></a>Built-in intelligence
...
### <a name="automatic-performance-monitoring-and-tuning"></a>Automatic performance monitoring and tuning
...
### <a name="adaptive-query-processing"></a>Adaptive query processing
...
## <a name="advanced-security-and-compliance"></a>Advanced security and compliance
...
### <a name="auditing-for-compliance-and-security"></a>Auditing for compliance and security
...
### <a name="azure-active-directory-integration-and-multi-factor-authentication"></a>Azure Active Directory integration and multi-factor authentication
...
### <a name="compliance-certification"></a>Compliance certification
...
## <a name="easy-to-use-tools"></a>Easy-to-use tools
...
## <a name="engage-with-the-sql-server-engineering-team"></a>Engage with the SQL Server engineering team
