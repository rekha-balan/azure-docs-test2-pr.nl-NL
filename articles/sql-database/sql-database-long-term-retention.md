...
---
# <a name="storing-azure-sql-database-backups-for-up-to-10-years"></a>Storing Azure SQL Database Backups for up to 10 years
...
## <a name="how-does-sql-database-long-term-backup-retention-work"></a>How does SQL Database long-term backup retention work?
...
## <a name="how-do-i-enable-long-term-backup-retention"></a>How do I enable long-term backup retention?
...
## <a name="how-do-i-restore-a-database-stored-with-the-long-term-backup-retention-feature"></a>How do I restore a database stored with the long-term backup retention feature?
...
## <a name="how-much-does-long-term-backup-retention-cost"></a>How much does long-term backup retention cost?
...
## <a name="view-available-backups-stored-in-long-term-backup-retention"></a>View available backups stored in long-term backup retention
...
## <a name="disabling-long-term-retention"></a>Disabling Long-term Retention
...
## <a name="removing-long-term-backup-retention-backups-from-the-azure-recovery-services-vault"></a>Removing long-term backup retention backups from the Azure Recovery Services vault
...
## <a name="long-term-backup-retention-faq"></a>Long-term backup retention FAQ:
