...
### <a name="optimizing-data-transfer-performance-during-migration"></a>Optimizing data transfer performance during migration 
...
### <a name="optimize-performance-after-the-migration-completes"></a>Optimize performance after the migration completes
...
### <a name="migration-to-sql-database-using-transaction-replication-workflow"></a>Migration to SQL Database using Transaction Replication workflow
...
### <a name="some-tips-and-differences-for-migrating-to-sql-database"></a>Some tips and differences for migrating to SQL Database
...
## <a name="resolving-database-migration-compatibility-issues"></a>Resolving database migration compatibility issues
