...
---
# <a name="configure-and-restore-from-azure-sql-database-long-term-backup-retention"></a>Configure and restore from Azure SQL Database long-term backup retention
...
### <a name="configure-the-vault-register-the-server-and-select-databases"></a>Configure the vault, register the server, and select databases
...
### <a name="view-backups-in-long-term-retention-using-azure-portal"></a>View backups in long-term retention using Azure portal
...
### <a name="restore-a-database-from-a-backup-in-long-term-backup-retention-using-the-azure-portal"></a>Restore a database from a backup in long-term backup retention using the Azure portal
...
### <a name="set-your-server-to-use-the-recovery-vault-for-its-long-term-retention-backups"></a>Set your server to use the recovery vault for its long-term retention backups
...
### <a name="create-a-retention-policy"></a>Create a retention policy
...
### <a name="configure-a-database-to-use-the-previously-defined-retention-policy"></a>Configure a database to use the previously defined retention policy
...
### <a name="view-backup-info-and-backups-in-long-term-retention"></a>View backup info, and backups in long-term retention
...
### <a name="restore-a-database-from-a-backup-in-long-term-backup-retention"></a>Restore a database from a backup in long-term backup retention
