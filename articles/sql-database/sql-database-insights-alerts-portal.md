...
---
# <a name="use-azure-portal-to-create-alerts-for-azure-sql-database"></a>Use Azure portal to create alerts for Azure SQL Database
...
## <a name="sql-database-alert-values-and-thresholds"></a>SQL Database alert values and thresholds
