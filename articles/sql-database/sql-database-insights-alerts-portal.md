...
---
# <a name="use-azure-portal-to-create-alerts-for-azure-sql-database-and-data-warehouse"></a>Use Azure portal to create alerts for Azure SQL Database and Data Warehouse
...
## <a name="sql-database-alert-values"></a>SQL Database alert values
