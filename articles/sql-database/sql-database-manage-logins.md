...
---
# <a name="controlling-and-granting-database-access-to-sql-database-and-sql-data-warehouse"></a>Controlling and granting database access to SQL Database and SQL Data Warehouse
...
## <a name="additional-server-level-administrative-roles"></a>Additional server-level administrative roles
...
### <a name="considerations-and-restrictions"></a>Considerations and restrictions
