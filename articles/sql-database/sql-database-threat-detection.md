...
---
# <a name="sql-database-threat-detection"></a>SQL Database Threat Detection
...
## <a name="set-up-threat-detection-for-your-database-in-the-azure-portal"></a>Set up threat detection for your database in the Azure portal
...
## <a name="set-up-threat-detection-using-powershell"></a>Set up threat detection using PowerShell
