...
---
# <a name="connect-excel-to-an-azure-sql-database-and-create-a-report"></a>Connect Excel to an Azure SQL database and create a report
...
> ![Open a connection from another workbook](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-connect-excel/open-from-another-workbook.png)
> 
> 
