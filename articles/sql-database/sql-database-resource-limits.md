...
---
# <a name="overview-azure-sql-database-resource-limits"></a>Overview Azure SQL Database resource limits 
...
## <a name="what-is-the-maximum-number-of-servers-and-databases"></a>What is the maximum number of servers and databases?
...
## <a name="what-happens-when-database-resource-limits-are-reached"></a>What happens when database resource limits are reached?

### <a name="compute-dtus-and-edtus--vcores"></a>Compute (DTUs and eDTUs / vCores)
...
### <a name="sessions-and-workers-requests"></a>Sessions and workers (requests) 
