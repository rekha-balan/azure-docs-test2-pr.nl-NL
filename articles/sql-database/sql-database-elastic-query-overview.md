...
### <a name="available-on-standard-tier"></a>Available on standard tier
...
### <a name="push-parameters-to-remote-databases"></a>Push parameters to remote databases

Elastic queries can now push SQL parameters to the remote databases for execution.

### <a name="stored-procedure-execution"></a>Stored procedure execution
...
### <a name="flexibility"></a>Flexibility
