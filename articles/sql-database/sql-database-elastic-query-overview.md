...
---
# <a name="azure-sql-database-elastic-query-overview-preview"></a>Azure SQL Database elastic query overview (preview)
...
## <a name="elastic-query-scenarios"></a>Elastic query scenarios
