...
---
# <a name="set-up-sql-data-sync"></a>Set up SQL Data Sync
...
## <a name="step-1---create-sync-group"></a>Step 1 - Create sync group

### <a name="locate-the-data-sync-settings"></a>Locate the Data Sync settings
...
### <a name="create-a-new-sync-group"></a>Create a new Sync Group
...
## <a name="step-2---add-sync-members"></a>Step 2 - Add sync members
...
### <a name="add-an-azure-sql-database"></a>Add an Azure SQL Database
...
## <a name="step-3---configure-sync-group"></a>Step 3 - Configure sync group
...
## <a name="faq-about-setup-and-configuration"></a>FAQ about setup and configuration

### <a name="how-frequently-can-data-sync-synchronize-my-data"></a>How frequently can Data Sync synchronize my data? 
The minimum frequency is every five minutes.

### <a name="does-sql-data-sync-fully-create-and-provision-tables"></a>Does SQL Data Sync fully create and provision tables?
...
### <a name="why-do-i-see-tables-that-i-did-not-create"></a>Why do I see tables that I did not create?  
Data Sync creates side tables in your database for change tracking. Don't delete them or Data Sync stops working.

### <a name="is-my-data-convergent-after-a-sync"></a>Is my data convergent after a sync?
...
### <a name="how-do-i-get-schema-changes-into-a-sync-group"></a>How do I get schema changes into a sync group?
...
### <a name="how-can-i-export-and-import-a-database-with-data-sync"></a>How can I export and import a database with Data Sync?
...
## <a name="faq-about-the-client-agent"></a>FAQ about the client agent

### <a name="why-do-i-need-a-client-agent"></a>Why do I need a client agent?
...
### <a name="how-many-instances-of-the-local-agent-ui-can-be-run"></a>How many instances of the local agent UI can be run?

Only one instance of the UI can be run.

### <a name="how-can-i-change-my-service-account"></a>How can I change my service account?
...
### <a name="how-do-i-change-my-agent-key"></a>How do I change my agent key?
...
### <a name="how-do-i-retire-a-client-agent"></a>How do I retire a client agent?
...
### <a name="how-do-i-move-a-client-agent-to-another-computer"></a>How do I move a client agent to another computer?
