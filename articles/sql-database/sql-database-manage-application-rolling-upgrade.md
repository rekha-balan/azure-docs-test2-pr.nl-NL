...
![SQL Database Go-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option1-1.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option1-2.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option1-3.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option1-4.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option2-1.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option2-2.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option2-3.png)
...
![SQL Database Geo-Replication configuration. Cloud disaster recovery.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-database/media/sql-database-manage-application-rolling-upgrade/Option2-4.png)
