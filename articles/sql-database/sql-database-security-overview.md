...
## <a name="protect-data"></a>Protect data
...
## <a name="control-access"></a>Control access
...
### <a name="firewall-and-firewall-rules"></a>Firewall and firewall rules
...
### <a name="data-masking"></a>Data masking 
