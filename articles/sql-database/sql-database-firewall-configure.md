...
---
# <a name="azure-sql-database-and-sql-data-warehouse-firewall-rules"></a>Azure SQL Database and SQL Data Warehouse firewall rules 
...
#### <a name="virtual-network-rules-as-alternatives-to-ip-rules"></a>Virtual network rules as alternatives to IP rules
...
## <a name="creating-and-managing-firewall-rules"></a>Creating and managing firewall rules
...
## <a name="manage-firewall-rules-using-the-azure-portal"></a>Manage firewall rules using the Azure portal
...
## <a name="manage-firewall-rules-using-transact-sql"></a>Manage firewall rules using Transact-SQL
...
## <a name="manage-firewall-rules-using-azure-powershell"></a>Manage firewall rules using Azure PowerShell
...
## <a name="manage-firewall-rules-using-azure-cli"></a>Manage firewall rules using Azure CLI
| Cmdlet | Level | Description |
| --- | --- | --- |
...
## <a name="manage-firewall-rules-using-rest-api"></a>Manage firewall rules using REST API
...
## <a name="server-level-firewall-rule-versus-a-database-level-firewall-rule"></a>Server-level firewall rule versus a database-level firewall rule
