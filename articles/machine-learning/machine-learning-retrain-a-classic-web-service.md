...
---
# <a name="retrain-a-classic-web-service"></a>Retrain a Classic web service
...
## <a name="add-a-new-endpoint"></a>Add a new Endpoint
...
### <a name="programmatically-add-an-endpoint"></a>Programmatically add an endpoint
...
### <a name="use-the-microsoft-azure-web-services-portal-to-add-an-endpoint"></a>Use the Microsoft Azure Web Services portal to add an endpoint
...
### <a name="use-the-azure-classic-portal-to-add-an-endpoint"></a>Use the Azure classic portal to add an endpoint
...
## <a name="update-the-added-endpoints-trained-model"></a>Update the added endpoint’s Trained Model
