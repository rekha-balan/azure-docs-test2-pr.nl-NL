...
3. Connect the left output of the left [Execute R Script][execute-r-script] module to the right input port of the [Train Model][train-model] module (we decided in [Step 3](walkthrough-3-create-new-experiment.md) of this walkthrough to use the data coming from the left side of the Split Data module for training).
...
### <a name="run-the-experiment-and-check-the-results"></a>Run the experiment and check the results
