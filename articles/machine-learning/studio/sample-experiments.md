...
---
# <a name="create-machine-learning-experiments-from-working-examples-in-azure-ai-gallery"></a>Create machine learning experiments from working examples in Azure AI Gallery
...
## <a name="find-an-experiment-to-copy-in-azure-ai-gallery"></a>Find an experiment to copy in Azure AI Gallery
...
## <a name="create-a-new-experiment-using-an-example-as-a-template"></a>Create a new experiment using an example as a template
