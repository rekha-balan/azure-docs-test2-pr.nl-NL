...
---
# <a name="azure-machine-learning-frequently-asked-questions-billing-capabilities-limitations-and-support"></a>Azure Machine Learning frequently asked questions: Billing, capabilities, limitations, and support
...
## <a name="azure-machine-learning-questions"></a>Azure Machine Learning questions
...
## <a name="machine-learning-studio-questions"></a>Machine Learning Studio questions
### <a name="import-and-export-data-for-machine-learning"></a>Import and export data for Machine Learning
...
## <a name="security-and-availability"></a>Security and availability
...
## <a name="support-and-training"></a>Support and training
...
## <a name="billing-questions"></a>Billing questions
...
### <a name="management-of-new-resource-manager-based-web-services"></a>Management of New (Resource Manager-based) web services
...
### <a name="sign-up-for-new-resource-manager-based-web-services-plans"></a>Sign up for New (Resource Manager-based) web services plans
...
### <a name="new-web-services-overages"></a>New web services: Overages
...
### <a name="azure-machine-learning-classic-web-services"></a>Azure Machine Learning Classic web services
**Is Pay As You Go still available?**

Yes, Classic web services are still available in Azure Machine Learning.  

### <a name="azure-machine-learning-free-and-standard-tier"></a>Azure Machine Learning Free and Standard tier
...
### <a name="studio-workspace"></a>Studio workspace
...
### <a name="guest-access"></a>Guest Access
