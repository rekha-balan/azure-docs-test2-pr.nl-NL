...
---
# <a name="machine-learning-rest-api-error-codes"></a>Machine Learning REST API Error Codes
...
## <a name="unauthorized-http-status-code-401"></a>Unauthorized (HTTP status code 401)
