...
## <a name="open-machine-learning-studio"></a>Open Machine Learning Studio
...
To create a flow of data through your experiment, you'll connect an output port of one module to an input port of another.
...
## <a name="step-2-prepare-the-data"></a>Step 2: Prepare the data
...
## <a name="final-experiment"></a>Final experiment
