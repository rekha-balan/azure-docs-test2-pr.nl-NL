...
---
# <a name="consume-an-azure-machine-learning-web-service-by-using-a-web-app-template"></a>Consume an Azure Machine Learning web service by using a web app template
...
## <a name="azure-machine-learning-web-app-templates"></a>Azure Machine Learning web app templates
...
## <a name="how-to-use-the-request-response-service-template"></a>How to use the Request-Response Service template
...
## <a name="how-to-use-the-batch-execution-service-template"></a>How to use the Batch Execution Service template
