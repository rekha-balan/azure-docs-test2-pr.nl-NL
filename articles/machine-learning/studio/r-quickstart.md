...
---
# <a name="quickstart-tutorial-for-the-r-programming-language-for-azure-machine-learning"></a>Quickstart tutorial for the R programming language for Azure Machine Learning
...
### <a name="forecasting-and-the-dataset"></a>Forecasting and the dataset
...
### <a name="the-execute-r-script-module"></a>The Execute R Script module
...
#### <a name="execute-r-code"></a>Execute R code
...
#### <a name="defensive-r-coding-for-azure-machine-learning"></a>Defensive R coding for Azure Machine Learning
...
#### <a name="debug-and-test-r-in-machine-learning-studio"></a>Debug and test R in Machine Learning Studio
...
#### <a name="packages-in-machine-learning-studio"></a>Packages in Machine Learning Studio
...
### <a name="introduction-to-rstudio"></a>Introduction to RStudio
...
### <a name="load-and-check-data-in-machine-learning-studio"></a>Load and check data in Machine Learning Studio
...
#### <a name="check-on-the-data"></a>Check on the data
...
### <a name="first-r-script"></a>First R script
...
### <a name="data-input-to-the-execute-r-script-module"></a>Data input to the Execute R Script module
...
### <a name="execute-r-script-outputs"></a>Execute R Script outputs
#### <a name="output-a-dataframe"></a>Output a dataframe
...
### <a name="r-device-output"></a>R Device output
...
### <a name="type-transformations"></a>Type transformations
...
### <a name="basic-data-frame-filtering"></a>Basic data frame filtering
...
### <a name="add-a-new-column"></a>Add a new column
...
### <a name="value-transformations"></a>Value transformations
...
### <a name="time-series-objects-in-r"></a>Time series objects in R
...
### <a name="time-series-object-example"></a>Time series object example
...
#### <a name="reading-the-dataframe"></a>Reading the dataframe
...
#### <a name="creating-a-time-series-object"></a>Creating a time series object
...
### <a name="exploring-and-transforming-the-data"></a>Exploring and transforming the data
...
### <a name="creating-the-dataframe-for-analysis"></a>Creating the dataframe for analysis
...
### <a name="create-a-training-dataset"></a>Create a training dataset
...
### <a name="a-trend-model"></a>A trend model
...
### <a name="seasonal-model"></a>Seasonal model
...
### <a name="forecasting-and-model-evaluation"></a>Forecasting and model evaluation
