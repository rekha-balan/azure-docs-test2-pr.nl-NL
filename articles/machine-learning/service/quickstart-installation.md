...
---
# <a name="quickstart-install-and-get-started-with-azure-machine-learning-services"></a>Quickstart: Install and get started with Azure Machine Learning services
...
## <a name="create-azure-machine-learning-services-accounts"></a>Create Azure Machine Learning services accounts
...
## <a name="install-and-log-in-to-workbench"></a>Install and log in to Workbench
...
## <a name="create-a-project-in-workbench"></a>Create a project in Workbench
...
## <a name="run-a-python-script"></a>Run a Python script
...
## <a name="start-the-cli"></a>Start the CLI
