...
---
# <a name="build-and-deploy-text-classification-models-with-azure-machine-learning"></a>Build and deploy text classification models with Azure Machine Learning
...
### <a name="download-and-explore-the-sample-data"></a>Download and Explore the sample data
...
### <a name="set-the-location-of-the-data"></a>Set the location of the data
...
### <a name="specify-scikit-learn-algorithm-and-define-the-text-classifier"></a>Specify scikit-learn algorithm and define the text classifier
...
### <a name="fit-the-model"></a>Fit the model
...
### <a name="examine-and-set-the-parameters-of-the-different-pipeline-steps"></a>Examine and set the parameters of the different pipeline steps
...
### <a name="export-the-parameters-to-a-file"></a>Export the parameters to a file
...
## <a name="apply-the-classifier"></a>Apply the classifier
...
## <a name="evaluate-model-performance"></a>Evaluate model performance
...
## <a name="save-the-pipeline"></a>Save the pipeline
...
## <a name="load-the-pipeline"></a>Load the pipeline
...
## <a name="test-the-pipeline"></a>Test the pipeline
