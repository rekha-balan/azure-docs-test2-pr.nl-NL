...
---
# <a name="build-and-deploy-forecasting-models-with-azure-machine-learning"></a>Build and deploy forecasting models with Azure Machine Learning
...
## <a name="sample-data-and-jupyter-notebook"></a>Sample data and Jupyter notebook
...
### <a name="get-the-jupyter-notebook"></a>Get the Jupyter notebook
...
### <a name="explore-the-sample-data"></a>Explore the sample data
...
### <a name="import-any-dependencies-for-this-sample"></a>Import any dependencies for this sample
...
## <a name="load-data-and-explore"></a>Load data and explore
...
## <a name="integrate-with-external-data"></a>Integrate with external data
...
## <a name="preprocess-data-and-impute-missing-values"></a>Preprocess data and impute missing values
...
## <a name="univariate-time-series-models"></a>Univariate time series models
...
### <a name="initialize-models"></a>Initialize Models
...
### <a name="combine-multiple-models"></a>Combine Multiple Models
...
### <a name="fit-and-predict"></a>Fit and Predict
...
### <a name="cross-validation-parameter-and-model-sweeping"></a>Cross Validation, Parameter, and Model Sweeping    
...
## <a name="additional-notebooks"></a>Additional Notebooks
...
### <a name="set-model-deployment-parameters"></a>Set model deployment parameters
...
### <a name="define-the-azure-machine-learning-environment-and-deployment"></a>Define the Azure Machine Learning environment and deployment
...
### <a name="create-the-web-service"></a>Create the web service
...
### <a name="score-the-web-service"></a>Score the web service
