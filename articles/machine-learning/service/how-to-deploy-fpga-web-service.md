...
---
# <a name="deploy-a-model-as-a-web-service-on-an-fpga-with-azure-machine-learning"></a>Deploy a model as a web service on an FPGA with Azure Machine Learning
...
## <a name="create-an-azure-machine-learning-model-management-account"></a>Create an Azure Machine Learning Model Management account
...
## <a name="get-model-management-account-information"></a>Get Model Management account information
...
## <a name="set-up-your-machine"></a>Set up your machine
...
## <a name="deploy-your-model"></a>Deploy your model
...
## <a name="ssltls-and-authentication"></a>SSL/TLS and authentication
...
### <a name="acquire-a-domain-name"></a>Acquire a domain name
...
### <a name="acquire-an-ssl-certificate"></a>Acquire an SSL certificate
...
### <a name="deploy-or-update-the-service-with-ssl-enabled"></a>Deploy or update the service with SSL enabled
...
### <a name="update-your-dns-to-point-to-the-service"></a>Update your DNS to point to the service
...
### <a name="consuming-authenticated-services"></a>Consuming authenticated services
