...
---
# <a name="build-and-deploy-object-detection-models-with-azure-machine-learning"></a>Build and deploy object detection models with Azure Machine Learning
...
## <a name="image-annotation"></a>Image Annotation
...
## <a name="define-a-model"></a>Define a model
...
## <a name="score-an-image"></a>Score an image
...
## <a name="load-the-saved-model-for-scoring"></a>Load the saved model for scoring
...
### <a name="parse-serialized-result-from-webservice"></a>Parse serialized result from webservice
