...
---
# <a name="build-and-deploy-image-classification-models-with-azure-machine-learning"></a>Build and deploy image classification models with Azure Machine Learning
...
## <a name="sample-data-and-notebook"></a>Sample data and notebook
...
### <a name="load-the-sample-data"></a>Load the sample data
...
## <a name="create-a-dataset"></a>Create a dataset
...
## <a name="visualize-and-annotate-images"></a>Visualize and annotate images
...
## <a name="augment-images"></a>Augment images
...
## <a name="define-dnn-models"></a>Define DNN models
...
## <a name="train-the-classifier"></a>Train the classifier
...
## <a name="evaluate-and-visualize-model-performance"></a>Evaluate and visualize model performance
...
## <a name="operationalization-deploy-and-consume"></a>Operationalization: deploy and consume
...
### <a name="manage-web-services-and-deployments"></a>Manage web services and deployments
...
### <a name="consume-the-web-service"></a>Consume the web service 
...
### <a name="score-with-existing-deployment-object"></a>Score with existing deployment object
...
### <a name="score-with-service-endpoint-url-and-service-key"></a>Score with service endpoint url and service key
...
### <a name="score-endpoint-with-http-request-directly"></a>Score endpoint with http request directly
...
### <a name="parse-serialized-result-from-web-service"></a>Parse serialized result from web service
