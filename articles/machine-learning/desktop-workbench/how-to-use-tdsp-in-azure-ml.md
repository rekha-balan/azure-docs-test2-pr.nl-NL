...
---
# <a name="structure-projects-with-the-team-data-science-process-template"></a>Structure projects with the Team Data Science Process template
...
## <a name="what-is-the-team-data-science-process"></a>What is the Team Data Science Process?
...
## <a name="why-should-you-use-the-tdsp-structure-and-templates"></a>Why should you use the TDSP structure and templates?
...
## <a name="things-to-note-before-creating-a-new-project"></a>Things to note before creating a new project
...
## <a name="instantiate-the-tdsp-structure-and-templates-from-the-machine-learning-template-gallery"></a>Instantiate the TDSP structure and templates from the Machine Learning template gallery
...
### <a name="create-a-new-tdsp-structured-project"></a>Create a new TDSP-structured project
...
## <a name="examine-the-tdsp-project-structure"></a>Examine the TDSP project structure
...
### <a name="project-folder-structure"></a>Project folder structure
...
## <a name="use-the-tdsp-structure-and-templates"></a>Use the TDSP structure and templates
...
## <a name="document-your-project"></a>Document your project
...
### <a name="example-project-report"></a>Example project report
