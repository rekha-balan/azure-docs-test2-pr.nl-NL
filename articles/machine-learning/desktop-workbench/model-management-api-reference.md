...
---
# <a name="azure-machine-learning-model-management-account-api-reference"></a>Azure Machine Learning Model Management Account API reference
...
##### <a name="acquire-the-azure-ad-token-manually"></a>Acquire the Azure AD token manually
You can use `az login` and get the latest token from the .azure file on your home directory.

##### <a name="acquire-the-azure-ad-token-programmatically"></a>Acquire the Azure AD token programmatically
```
...
## <a name="register-a-model"></a>Register a model
...
## <a name="query-the-list-of-models-in-an-account"></a>Query the list of models in an account
### <a name="request"></a>Request
| Method | Request URI |
|------------|------------|
...
## <a name="get-model-details"></a>Get model details
### <a name="request"></a>Request
| Method | Request URI |
|------------|------------|
...
## <a name="register-a-manifest-with-the-registered-model-and-all-dependencies"></a>Register a manifest with the registered model and all dependencies
...
## <a name="query-the-list-of-manifests-in-an-account"></a>Query the list of manifests in an account
...
## <a name="get-manifest-details"></a>Get manifest details
...
## <a name="create-an-image"></a>Create an image
...
## <a name="query-the-list-of-images-in-an-account"></a>Query the list of images in an account
...
## <a name="get-image-details"></a>Get image details
...
## <a name="query-the-list-of-services-in-an-account"></a>Query the list of services in an account
...
## <a name="get-service-details"></a>Get service details
...
## <a name="update-a-service"></a>Update a service
...
## <a name="get-service-keys"></a>Get service keys
...
## <a name="regenerate-service-keys"></a>Regenerate service keys
...
## <a name="query-the-list-of-deployments-in-an-account"></a>Query the list of deployments in an account
...
## <a name="get-deployment-details"></a>Get deployment details
...
## <a name="get-operation-details"></a>Get operation details
