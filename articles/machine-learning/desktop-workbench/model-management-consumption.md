...
---
# <a name="consuming-web-services"></a>Consuming web services
...
## <a name="service-deployment-options"></a>Service deployment options
...
## <a name="list-deployed-services-and-images"></a>List deployed services and images
...
## <a name="get-service-information"></a>Get service information
...
## <a name="get-the-service-api-key"></a>Get the service API key
...
## <a name="get-the-service-swagger-description"></a>Get the service Swagger description
...
## <a name="get-service-logs"></a>Get service logs
...
## <a name="call-the-service-using-c"></a>Call the service using C#
...
## <a name="call-the-web-service-using-python"></a>Call the web service using Python
