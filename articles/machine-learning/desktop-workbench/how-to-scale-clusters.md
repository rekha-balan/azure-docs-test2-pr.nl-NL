...
---
# <a name="scaling-the-cluster-to-manage-web-service-throughput"></a>Scaling the cluster to manage web service throughput

## <a name="why-scale-the-cluster"></a>Why scale the cluster?
...
## <a name="how-to-scale-web-services-on-your-acs-cluster"></a>How to scale web services on your ACS cluster
...
### <a name="scaling-the-number-of-nodes-in-the-cluster"></a>Scaling the number of nodes in the cluster
...
### <a name="scaling-the-number-of-kubernetes-pod-replicas-in-a-cluster"></a>Scaling the number of Kubernetes pod replicas in a cluster
...
#### <a name="scaling-a-cluster-with-the-azure-machine-learning-cli"></a>Scaling a cluster with the Azure Machine Learning CLI
...
##### <a name="static-scale"></a>Static scale
...
#### <a name="scaling-number-of-replicas-using-the-kubernetes-dashboard"></a>Scaling number of replicas using the Kubernetes dashboard
