...
---
# <a name="how-to-configure-azure-machine-learning-workbench-to-work-with-an-ide"></a>How to configure Azure Machine Learning Workbench to work with an IDE 
...
## <a name="configure-workbench"></a>Configure workbench
...
### <a name="default-install-path-for-visual-studio-code"></a>Default install path for Visual Studio Code  
...
### <a name="default-install-path-for-pycharm"></a>Default install path for PyCharm 
...
## <a name="open-project-in-ide"></a>Open project in IDE 
...
## <a name="configuring-the-integrated-terminal-in-visual-studio-code"></a>Configuring the integrated terminal in Visual Studio Code
