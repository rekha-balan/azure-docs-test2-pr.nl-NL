...
---
# <a name="logging-api-reference"></a>Logging API reference
...
## <a name="uploading-metrics"></a>Uploading metrics
...
## <a name="consuming-metrics"></a>Consuming metrics
...
## <a name="artifacts-files"></a>Artifacts (files)
...
## <a name="consuming-artifacts"></a>Consuming artifacts
