...
---
# <a name="document-collection-analysis"></a>Document Collection Analysis
...
### <a name="data-ingestion-and-transformation"></a>Data ingestion and transformation
...
#### <a name="preprocess-text-data"></a>Preprocess text data
...
#### <a name="phrase-learning"></a>Phrase learning
...
### <a name="topic-summarization-and-analysis"></a>Topic summarization and analysis
