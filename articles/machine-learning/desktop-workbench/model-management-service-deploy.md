...
---
# <a name="deploying-a-machine-learning-model-as-a-web-service"></a>Deploying a Machine Learning Model as a web service
...
## <a name="deploying-web-services"></a>Deploying web services
...
### <a name="1-save-your-model"></a>1. Save your model
...
### <a name="2-create-a-schemajson-file"></a>2. Create a schema.json file
...
### <a name="3-create-a-scorepy-file"></a>3. Create a score.py file
...
#### <a name="init-function"></a>Init function
...
#### <a name="run-function"></a>Run function
...
### <a name="4-register-a-model"></a>4. Register a model
...
### <a name="5-create-manifest"></a>5. Create manifest
...
### <a name="6-create-an-image"></a>6. Create an image 
...
### <a name="7-create-and-deploy-the-web-service"></a>7. Create and deploy the web service
...
### <a name="8-test-the-service"></a>8. Test the service
