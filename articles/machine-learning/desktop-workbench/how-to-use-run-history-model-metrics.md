...
---
# <a name="how-to-use-run-history-and-model-metrics-in-azure-machine-learning-workbench"></a>How to Use Run History and Model Metrics in Azure Machine Learning Workbench
...
## <a name="azure-ml-logging-api-overview"></a>Azure ML Logging API Overview
The [Azure ML Logging API](reference-logging-api.md) is available via the **azureml.logging** module in Python (which is installed with the Azure ML Workbench.) After importing this module, you can use the **get_azureml_logger** method to instantiate a **logger** object.
...
## <a name="create-a-project-in-azure-ml-workbench"></a>Create a Project in Azure ML Workbench
If you don't already have a project, you can create one from the [Create and Install Quickstart](../service/quickstart-installation.md) From the **Project Dashboard**, you can open the **iris_sklearn.py** script (as shown.)
...
## <a name="parameterize-and-log-model-metrics-from-script"></a>Parameterize and Log Model Metrics from Script
...
## <a name="launch-runs-from-project-dashboard"></a>Launch Runs from Project Dashboard
...
## <a name="view-results-in-run-history"></a>View Results in Run History
...
### <a name="run-history-dashboard"></a>Run History Dashboard
...
### <a name="run-history-details"></a>Run History Details
...
### <a name="run-history-comparison"></a>Run History Comparison
