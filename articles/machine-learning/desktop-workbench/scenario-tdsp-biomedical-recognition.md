...
---
# <a name="biomedical-entity-recognition-using-team-data-science-process-tdsp-template"></a>Biomedical entity recognition using Team Data Science Process (TDSP) Template
...
### <a name="1-word2vec-model-training-data"></a>1. Word2Vec model training data
...
### <a name="2-lstm-model-training-data"></a>2. LSTM model training data
...
## <a name="link-to-the-azure-gallery-github-repository"></a>Link to the Azure gallery GitHub repository
...
### <a name="basic-instructions-for-azure-machine-learning-aml-workbench"></a>Basic instructions for Azure Machine Learning (AML) workbench
...
### <a name="1-data-acquisition-and-understanding"></a>1. Data acquisition and understanding
...
### <a name="2-modeling"></a>2. Modeling
...
#### <a name="21-feature-generation"></a>2.1. Feature generation
...
#### <a name="22-train-the-neural-entity-extractor"></a>2.2. Train the neural entity extractor
...
#### <a name="23-model-evaluation"></a>2.3. Model evaluation
...
#### <a name="in-domain-versus-generic-word-embedding-models"></a>In-domain versus generic word embedding models
