...
---
# <a name="distributed-tuning-of-hyperparameters-using-azure-machine-learning-workbench"></a>Distributed tuning of hyperparameters using Azure Machine Learning Workbench
...
## <a name="link-of-the-gallery-github-repository"></a>Link of the Gallery GitHub repository
...
### <a name="configuration-of-execution-environments"></a>Configuration of execution environments
...
#### <a name="configuration-of-remote-docker-container"></a>Configuration of remote Docker container
...
#### <a name="configuration-of-spark-cluster"></a>Configuration of Spark cluster
...
### <a name="tuning-hyperparameters-using-remote-dsvm"></a>Tuning hyperparameters using remote DSVM
...
### <a name="tuning-hyperparameters-using-spark-cluster"></a>Tuning hyperparameters using Spark cluster
...
The following diagram shows the overall workflow: ![architecture](media/scenario-distributed-tuning-of-hyperparameters/architecture.png) 
