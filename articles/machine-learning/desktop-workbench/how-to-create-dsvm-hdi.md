...
---
# <a name="create-dsvm-and-hdi-spark-cluster-as-compute-targets"></a>Create DSVM and HDI Spark cluster as compute targets
...
## <a name="create-an-ubuntu-dsvm-in-azure-portal"></a>Create an Ubuntu DSVM in Azure portal
...
## <a name="create-an-ubuntu-dsvm-using-azure-cli"></a>Create an Ubuntu DSVM using azure-cli
...
```
## <a name="attach-a-dsvm-compute-target"></a>Attach a DSVM compute target
...
## <a name="deallocate-a-dsvm-and-restart-it-later"></a>Deallocate a DSVM and restart it later
...
## <a name="expand-the-dsvm-os-disk"></a>Expand the DSVM OS disk
...
## <a name="create-an-apache-spark-for-azure-hdinsight-cluster-in-azure-portal"></a>Create an Apache Spark for Azure HDInsight cluster in Azure portal
...
## <a name="attach-an-hdi-spark-cluster-compute-target"></a>Attach an HDI Spark cluster compute target
