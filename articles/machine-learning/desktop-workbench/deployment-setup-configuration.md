...
---
# <a name="model-management-setup"></a>Model management setup
...
### <a name="installing-or-updating-on-windows"></a>Installing (or updating) on Windows
...
### <a name="installing-or-updating-on-linux"></a>Installing (or updating) on Linux
...
### <a name="configuring-docker-on-linux"></a>Configuring Docker on Linux
...
## <a name="deploying-your-model"></a>Deploying your model
...
#### <a name="cluster-deployment"></a>Cluster deployment
...
### <a name="create-a-model-management-account"></a>Create a Model Management Account
