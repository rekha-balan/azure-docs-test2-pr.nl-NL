...
---
# <a name="tutorial-1-classify-iris---preparing-the-data"></a>Tutorial 1: Classify Iris - Preparing the data
...
## <a name="create-a-new-project-in-workbench"></a>Create a new project in Workbench
...
## <a name="create-a-data-preparation-package"></a>Create a data preparation package
...
## <a name="generate-pythonpyspark-code-to-invoke-a-data-preparation-package"></a>Generate Python/PySpark code to invoke a data preparation package
