...
---
# <a name="how-to-use-gpu-in-azure-machine-learning"></a>How to use GPU in Azure Machine Learning
...
## <a name="execute-in-local-environment-with-gpus"></a>Execute in _local_ Environment with GPUs
...
## <a name="execute-in-docker-environment-on-linux-vm-with-gpus"></a>Execute in _docker_ Environment on Linux VM with GPUs
...
### <a name="create-a-ubuntu-based-linux-data-science-virtual-machine-in-azure"></a>Create a Ubuntu-based Linux Data Science Virtual Machine in Azure
...
### <a name="create-a-new-project-in-azure-ml-workbench"></a>Create a New Project in Azure ML Workbench 
You can use the _Classifying MNIST using TensorFlow_ example, or the _Classifying MNIST dataset with CNTK_ example.

### <a name="create-a-new-compute-target"></a>Create a new Compute Target
...
### <a name="configure-azure-ml-workbench-to-access-gpu"></a>Configure Azure ML Workbench to Access GPU
...
"Framework": "Python"
```
### <a name="reference-deep-learning-framework"></a>Reference Deep Learning Framework 
