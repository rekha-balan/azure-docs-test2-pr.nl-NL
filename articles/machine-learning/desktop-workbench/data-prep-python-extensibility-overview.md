...
---
# <a name="data-preparations-python-extensions"></a>Data Preparations Python extensions
...
## <a name="custom-code-steps"></a>Custom code steps 
...
## <a name="code-block-types"></a>Code block types 
...
## <a name="default-imports"></a>Default imports
...
## <a name="install-new-packages"></a>Install new packages
...
## <a name="use-custom-modules"></a>Use custom modules
...
## <a name="column-data"></a>Column data 
...
### <a name="datapreperror-class-definition"></a>DataPrepError class definition
```python 
