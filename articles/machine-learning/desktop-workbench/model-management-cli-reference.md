...
---
# <a name="model-management-command-line-interface-reference"></a>Model management command-line interface reference

## <a name="base-cli-concepts"></a>Base CLI concepts:
...
## <a name="account-commands"></a>Account commands
...
## <a name="environment-commands"></a>Environment commands
...
```
## <a name="model-commands"></a>Model commands
...
## <a name="manifest-commands"></a>Manifest commands
...
## <a name="image-commands"></a>Image commands
...
Arguments --id -i    : [Required] The service id to score against.
