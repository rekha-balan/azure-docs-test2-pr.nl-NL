...
---
# <a name="find-runs-with-the-best-accuracy-and-lowest-duration"></a>Find runs with the best accuracy and lowest duration
...
## <a name="query-the-run-history"></a>Query the run history
