...
---
# <a name="persisting-changes-and-working-with-large-files"></a>Persisting changes and working with large files
...
## <a name="execution-isolation-portability-and-reproducibility"></a>Execution isolation, portability, and reproducibility
...
### <a name="persisting-state-changes"></a>Persisting state changes
...
### <a name="working-with-large-files-in-the-project-folder"></a>Working with large files in the project folder
...
## <a name="option-1-use-the-outputs-folder"></a>Option 1: Use the *outputs* folder
...
## <a name="option-2-use-the-shared-folder"></a>Option 2: Use the shared folder
...
### <a name="configure-local-compute-context"></a>Configure local compute context
...
### <a name="configure-the-docker-compute-context-local-or-remote"></a>Configure the Docker compute context (local or remote)
...
## <a name="option-3-use-external-durable-storage"></a>Option 3: Use external durable storage
