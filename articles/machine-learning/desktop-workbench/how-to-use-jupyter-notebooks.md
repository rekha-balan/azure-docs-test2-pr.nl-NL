...
---
# <a name="use-jupyter-notebooks-in-azure-machine-learning-workbench"></a>Use Jupyter Notebooks in Azure Machine Learning Workbench
...
## <a name="jupyter-notebook-architecture"></a>Jupyter Notebook architecture
...
## <a name="kernels-in-azure-machine-learning-workbench-notebooks"></a>Kernels in Azure Machine Learning Workbench notebooks
...
### <a name="kernel-naming-convention"></a>Kernel naming convention
...
### <a name="python-kernel-in-docker-local-or-remote"></a>Python kernel in Docker (local or remote)
...
### <a name="pyspark-kernel-in-docker-local-or-remote"></a>PySpark kernel in Docker (local or remote)
...
### <a name="pyspark-kernel-in-an-azure-hdinsight-cluster"></a>PySpark kernel in an Azure HDInsight cluster
...
## <a name="start-a-jupyter-server-from-azure-machine-learning-workbench"></a>Start a Jupyter server from Azure Machine Learning Workbench
...
## <a name="start-a-jupyter-server-from-the-command-line"></a>Start a Jupyter server from the command line
...
## <a name="use-magic-commands-to-manage-experiments"></a>Use magic commands to manage experiments
