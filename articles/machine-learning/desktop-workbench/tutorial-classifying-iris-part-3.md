...
---
# <a name="tutorial-3-classify-iris-deploy-a-model"></a>Tutorial 3: Classify Iris: Deploy a model
...
## <a name="download-the-model-pickle-file"></a>Download the model pickle file
...
## <a name="get-the-scoring-script-and-schema-files"></a>Get the scoring script and schema files
...
## <a name="prepare-to-operationalize-locally-for-development-and-testing-your-service"></a>Prepare to operationalize locally [For development and testing your service]
...
## <a name="create-a-real-time-web-service-in-one-command"></a>Create a real-time web service in one command
...
## <a name="optional-alternative-create-a-real-time-web-service-by-using-separate-commands"></a>[Optional alternative] Create a real-time web service by using separate commands
...
## <a name="run-the-real-time-web-service"></a>Run the real-time web service
...
## <a name="view-the-collected-data-in-azure-blob-storage"></a>View the collected data in Azure Blob storage
