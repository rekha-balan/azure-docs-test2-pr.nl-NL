...
---
# <a name="use-data-transforms-for-data-preparation-in-azure-machine-learning"></a>Use data transforms for data preparation in Azure Machine Learning
...
## <a name="transforms-from-the-main-menu-or-the-grid-header"></a>Transforms from the main menu or the grid header 
...
## <a name="derive-column-by-example"></a>Derive Column by Example
...
For a more detailed explanation of the **Derived Column by Example** transform, along with more samples, see [Derive Column by Example reference](data-prep-derive-column-by-example.md).  

## <a name="split-column-by-example"></a>Split Column by Example
...
For a more detailed explanation of the **Split Column by Example** transform, along with more samples, see [Split Column by Example reference](data-prep-split-column-by-example.md).

## <a name="expand-json"></a>Expand JSON

This transform enables you to add multiple columns by expanding a column with valid JSON text.

For a more detailed explanation of the **Expand JSON** transform, along with more samples, see [Expand JSON reference](data-prep-expand-json.md).


## <a name="combine-columns-by-example"></a>Combine Columns by Example

This transform adds a new column by combining values from multiple columns. 

For a more detailed explanation of the **Combine Columns by Example** transform, along with more samples, see [Combine Columns by Example reference](data-prep-combine-columns-by-example.md).
...
## <a name="replace-values"></a>Replace Values
...
## <a name="replace-na-values"></a>Replace NA Values
...
## <a name="replace-error-values"></a>Replace Error Values
...
## <a name="convert-field-type-to-numeric"></a>Convert Field Type to Numeric
...
## <a name="convert-field-type-to-date"></a>Convert Field Type to Date
...
## <a name="convert-field-type-to-boolean"></a>Convert Field Type to Boolean
...
## <a name="convert-field-type-to-string"></a>Convert Field Type to String
This transform changes the column type to string, and it works on a single column or many.

## <a name="convert-unix-timestamp-to-datetime"></a>Convert Unix Timestamp to DateTime
...
## <a name="use-first-row-as-headers"></a>Use First Row as Headers
...
## <a name="append-rows"></a>Append Rows
...
## <a name="append-columns"></a>Append Columns
...
## <a name="remove-duplicates"></a>Remove Duplicates
...
## <a name="output-transforms"></a>Output transforms
...
### <a name="write-to-csv"></a>Write to CSV
...
### <a name="write-to-parquet"></a>Write to Parquet
...
## <a name="script-based-transforms"></a>Script-based transforms
...
### <a name="add-column-script"></a>Add Column (script)
...
### <a name="advanced-filter-script"></a>Advanced Filter (script)
