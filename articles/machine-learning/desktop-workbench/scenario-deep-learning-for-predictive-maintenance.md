...
---
# <a name="deep-learning-for-predictive-maintenance-real-world-scenarios"></a>Deep learning for predictive maintenance real-world scenarios
...
### <a name="cortana-intelligence-gallery-github-repository"></a>Cortana Intelligence Gallery GitHub repository
...
## <a name="prepare-the-notebook-server-computation-target"></a>Prepare the notebook server computation target
...
### <a name="task-1-data-ingestion-and-preparation"></a>Task 1: Data ingestion and preparation
...
### <a name="task-2-model-building-and-evaluation"></a>Task 2: Model building and evaluation
...
### <a name="task-3-operationalization"></a>Task 3: Operationalization
