...
---
# <a name="getting-started-with-data-preparation"></a>Getting started with data preparation
...
## <a name="building-blocks-of-data-preparation"></a>Building blocks of data preparation ##
### <a name="the-package"></a>The Package ###
...
### <a name="the-dataflow"></a>The dataflow ###
...
### <a name="the-source"></a>The source
...
### <a name="the-transform"></a>The transform ###
...
### <a name="the-inspector"></a>The inspector ###
...
### <a name="the-destination"></a>The destination
...
### <a name="using-data-preparation"></a>Using data preparation ###
Data Preparation assumes a basic five-step methodology/approach to data preparation.

#### <a name="step-1-ingestion"></a>Step 1: Ingestion ####
...
#### <a name="step-2-understandprofile-the-data"></a>Step 2: Understand/profile the data ####
...
#### <a name="step-3-transform-the-data"></a>Step 3: Transform the data ####
...
#### <a name="step-4-verify-the-impact-of-the-transformation"></a>Step 4: Verify the impact of the transformation. 
...
#### <a name="step-5-output"></a>Step 5: Output 
...
## <a name="list-of-appendices"></a>List of Appendices 
