...
---
# <a name="use-a-git-repo-with-a-machine-learning-workbench-project"></a>Use a Git repo with a Machine Learning Workbench project
...
## <a name="step-1-create-a-machine-learning-experimentation-account"></a>Step 1. Create a Machine Learning Experimentation account
...
## <a name="step-2-create-an-azure-devops-project-or-use-an-existing-project"></a>Step 2. Create an Azure DevOps project or use an existing project
...
## <a name="step-3-set-up-a-machine-learning-project-and-git-repo"></a>Step 3. Set up a Machine Learning project and Git repo
...
### <a name="create-a-machine-learning-project-that-has-a-remote-git-repo"></a>Create a Machine Learning project that has a remote Git repo
...
### <a name="associate-an-existing-machine-learning-project-with-an-azure-devops-git-repo"></a>Associate an existing Machine Learning project with an Azure DevOps Git repo
...
## <a name="step-4-capture-a-project-snapshot-in-the-git-repo"></a>Step 4. Capture a project snapshot in the Git repo
...
## <a name="step-5-restore-a-previous-project-snapshot"></a>Step 5. Restore a previous project snapshot 
...
## <a name="step-6-use-the-master-branch"></a>Step 6. Use the master branch
