...
---
# <a name="image-classification-using-azure-machine-learning-workbench"></a>Image classification using Azure Machine Learning Workbench
...
### <a name="troubleshooting--known-bugs"></a>Troubleshooting / Known bugs
...
## <a name="part-1---model-training-and-evaluation"></a>Part 1 - Model training and evaluation
...
### <a name="step-1-data-preparation"></a>Step 1: Data preparation
...
### <a name="step-2-refining-the-deep-neural-network"></a>Step 2: Refining the Deep Neural Network
...
### <a name="step-3-evaluate-dnn-for-all-images"></a>Step 3: Evaluate DNN for all images
`Script: 3_runDNN.py`
...
### <a name="step-4-support-vector-machine-training"></a>Step 4: Support Vector Machine training
...
### <a name="step-5-evaluation-and-visualization"></a>Step 5: Evaluation and visualization
...
### <a name="step-6-deployment"></a>Step 6: Deployment
...
## <a name="part-2---accuracy-improvements"></a>Part 2 - Accuracy improvements
...
### <a name="run-history-tracking"></a>Run history tracking
...
## <a name="part-3---custom-dataset"></a>Part 3 - Custom dataset
...
### <a name="using-a-custom-dataset"></a>Using a custom dataset
...
### <a name="image-scraping-and-annotation"></a>Image scraping and annotation
...
[1] Alex Krizhevsky, Ilya Sutskever, and Geoffrey E. Hinton, [_ImageNet Classification with Deep Convolutional Neural Networks_](https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf). NIPS 2012.  
