...
---
# <a name="derive-column-by-example-transformation"></a>Derive column by example transformation
...
## <a name="how-to-use-this-transformation"></a>How to use this transformation
...
### <a name="transform-editor-basic-mode"></a>Transform editor: basic mode
...
### <a name="transform-editor-advanced-mode"></a>Transform editor: advanced mode
...
### <a name="transform-editor-send-feedback"></a>Transform editor: Send Feedback
...
### <a name="editing-existing-transformation"></a>Editing existing transformation
...
## <a name="examples-of-string-transformations-by-example"></a>Examples of string transformations by example
...
### <a name="s1-extracting-file-names-from-file-paths"></a>S1. Extracting file names from file paths
...
### <a name="s2-case-manipulation-during-string-extraction"></a>S2. Case manipulation during string extraction
...
### <a name="s3-date-format-manipulation-during-string-extraction"></a>S3. Date-format manipulation during string extraction
...
### <a name="s4-concatenating-strings"></a>S4. Concatenating strings
...
### <a name="s6-mapping-constant-values"></a>S6. Mapping constant values
...
## <a name="examples-of-number-transformations-by-example"></a>Examples of number transformations by example

>[!NOTE] 
>Values in **bold** represent the examples that were provided in order to complete the transformation in the shown dataset.


### <a name="n1-rounding-to-nearest-10"></a>N1. Rounding to nearest 10
...
### <a name="n2-rounding-down-to-nearest-10"></a>N2. Rounding down to nearest 10
...
### <a name="n3-rounding-to-nearest-005"></a>N3. Rounding to nearest 0.05
...
### <a name="n5-scaling-by-1000"></a>N5. Scaling by 1000
...
### <a name="n6-padding"></a>N6. Padding
...
## <a name="examples-of-date-transformations-by-example"></a>Examples of date transformations by example

>[!NOTE] 
>Values in **bold** represent the examples that were provided in order to complete the transformation in the shown dataset.


### <a name="d1-extracting-date-parts"></a>D1. Extracting date parts
...
### <a name="d2-formatting-dates"></a>D2. Formatting dates
...
### <a name="d3-mapping-time-to-time-periods"></a>D3. Mapping time to time periods
...
## <a name="examples-of-composite-transformations-by-example"></a>Examples of composite transformations by example
...
## <a name="technical-notes"></a>Technical notes

### <a name="conditional-transformations"></a>Conditional transformations
