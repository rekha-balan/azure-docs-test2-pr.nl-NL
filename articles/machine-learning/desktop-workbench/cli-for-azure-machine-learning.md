...
---
# <a name="install-and-use-the-machine-learning-cli-for-top-tasks-in-azure-machine-learning"></a>Install and use the machine learning CLI for top tasks in Azure Machine Learning
...
## <a name="what-you-need-to-get-started"></a>What you need to get started
...
## <a name="get-and-start-cli"></a>Get and start CLI
...
## <a name="get-command-help"></a>Get command help 
...
## <a name="common-cli-tasks-for-azure-machine-learning"></a>Common CLI tasks for Azure Machine Learning 

Learn about the most common tasks you can perform with the CLI in this section, including:
+ [Setting up compute targets](#target)
...
### <a name="set-up-a-compute-target"></a>Set up a compute target
...
### <a name="submit-remote-jobs"></a>Submit remote jobs
...
### <a name="work-with-jupyter-notebooks"></a>Work with Jupyter notebooks
...
### <a name="interact-with-and-explore-the-run-history"></a>Interact with and explore the run history
...
### <a name="configure-your-environment-to-operationalize"></a>Configure your environment to operationalize
