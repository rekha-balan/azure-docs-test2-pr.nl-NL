...
---
# <a name="export-or-delete-your-experimentation-or-model-management-data-in-machine-learning"></a>Export or delete your experimentation or model management data in Machine Learning
...
## <a name="control-your-account-data"></a>Control your account data
...
## <a name="delete-account-data-with-the-rest-api"></a>Delete account data with the REST API 
...
## <a name="delete-from-a-hosting-account"></a>Delete from a hosting account
...
## <a name="delete-from-the-model-management-service"></a>Delete from the model management service

### <a name="model-document"></a>Model document
...
### <a name="manifest-document"></a>Manifest document
...
### <a name="service-documents"></a>Service documents
...
### <a name="image-document"></a>Image document
...
## <a name="delete-run-history-artifact-and-notification-data"></a>Delete run history, artifact, and notification data
...
## <a name="delete-from-experimentation-account-resource-provider"></a>Delete from experimentation account resource provider
...
## <a name="export-service-data-with-the-rest-api"></a>Export service data with the REST API
...
## <a name="export-hosting-account-data"></a>Export hosting account data
...
## <a name="export-model-management-service-data"></a>Export model management service data
### <a name="model-document"></a>Model document
...
## <a name="export-compute-data"></a>Export compute data
...
## <a name="export-run-history-data"></a>Export run history data
...
## <a name="export-artifacts"></a>Export artifacts
...
### <a name="artifact-contents"></a>Artifact contents
...
### <a name="artifact-documents"></a>Artifact documents
...
## <a name="export-notifications"></a>Export notifications
...
## <a name="export-experimentation-account-information"></a>Export experimentation account information
### <a name="experimentation-account-information"></a>Experimentation account information
...
### <a name="project-information"></a>Project information
