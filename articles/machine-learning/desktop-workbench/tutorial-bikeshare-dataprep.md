...
---
# <a name="tutorial-use-azure-machine-learning-workbench-for-advanced-data-preparation-bike-share-data"></a>Tutorial: Use Azure Machine Learning Workbench for advanced data preparation (Bike share data)
...
## <a name="upload-data-files-to-azure-blob-storage"></a>Upload data files to Azure Blob storage
...
## <a name="learn-about-the-datasets"></a>Learn about the datasets
...
## <a name="add-weather-data"></a>Add weather data
...
### <a name="view-data-source-metrics"></a>View data source metrics
...
## <a name="add-a-data-source-to-the-data-preparation-package"></a>Add a data source to the data preparation package
...
## <a name="filter-data-by-value"></a>Filter data by value
...
## <a name="remove-a-column"></a>Remove a column
...
## <a name="change-datatypes-and-remove-errors"></a>Change datatypes and remove errors
...
## <a name="use-by-example-transformations"></a>Use by example transformations
...
## <a name="summarize-data-mean"></a>Summarize data (mean)
...
## <a name="transform-dataflow-by-using-script"></a>Transform dataflow by using script
...
## <a name="load-trip-data"></a>Load trip data
...
## <a name="use-the-map-inspector"></a>Use the map inspector
...
## <a name="use-the-column-statistics-inspector"></a>Use the column statistics inspector
...
## <a name="use-the-histogram-inspector"></a>Use the histogram inspector
...
## <a name="add-a-column-by-using-script"></a>Add a column by using script
...
## <a name="use-an-advanced-filter"></a>Use an advanced filter
...
### <a name="remove-columns"></a>Remove columns
...
### <a name="summarize-data-count"></a>Summarize data (count)
...
## <a name="join-dataflows"></a>Join dataflows
...
## <a name="create-additional-features"></a>Create additional features
...
## <a name="read-data-from-python"></a>Read data from Python
...
## <a name="save-test-data-as-a-csv-file"></a>Save test data as a CSV file
...
## <a name="create-an-hdinsight-run-configuration"></a>Create an HDInsight run configuration
...
## <a name="run-in-an-hdinsight-cluster"></a>Run in an HDInsight cluster
...
## <a name="substitute-data-sources"></a>Substitute data sources
...
## <a name="save-training-data-as-a-csv-file"></a>Save training data as a CSV file
