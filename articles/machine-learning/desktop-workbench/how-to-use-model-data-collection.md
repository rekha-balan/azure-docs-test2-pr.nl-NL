...
---
# <a name="collect-model-data-by-using-data-collection"></a>Collect model data by using data collection
...
## <a name="install-the-data-collection-package"></a>Install the data collection package
...
## <a name="view-the-collected-data"></a>View the collected data
