...
---
# <a name="combine-columns-by-example-transformation"></a>Combine columns by example transformation
...
## <a name="example-using-separators"></a>Example using separators
...
## <a name="example-using-by-example"></a>Example using By example
