...
---
# <a name="azure-machine-learning-model-data-collection-api-reference"></a>Azure Machine Learning Model Data Collection API reference
...
## <a name="enable-model-data-collection-in-azure-ml-workbench-environment"></a>Enable model data collection in Azure ML Workbench environment
...
## <a name="enable-model-data-collection-in-the-scoring-file"></a>Enable model data collection in the scoring file
...
## <a name="model-data-collector-instantiation"></a>Model data collector instantiation
...
## <a name="collecting-the-model-data"></a>Collecting the model data
