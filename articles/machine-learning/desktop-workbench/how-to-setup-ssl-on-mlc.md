...
---
# <a name="enable-ssl-on-an-azure-machine-learning-compute-mlc-cluster"></a>Enable SSL on an Azure Machine Learning Compute (MLC) cluster 
...
## <a name="set-up-an-ssl-certificate-on-a-new-acs-cluster"></a>Set up an SSL certificate on a new ACS cluster
...
## <a name="set-up-an-ssl-certificate-on-an-existing-acs-cluster"></a>Set up an SSL certificate on an existing ACS cluster
...
## <a name="map-the-cname-and-the-ip-address"></a>Map the CNAME and the IP Address
...
## <a name="auto-detection-of-a-certificate"></a>Auto-detection of a certificate 
