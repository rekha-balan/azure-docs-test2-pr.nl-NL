...
---
# <a name="split-column-by-example-transformation"></a>Split column by example transformation
...
### <a name="editing-an-existing-transformation"></a>Editing an existing transformation
...
## <a name="examples-of-splitting-on-a-fixed-single-character-delimiter"></a>Examples of splitting on a fixed, single-character delimiter
...
### <a name="splitting-ip-addresses"></a>Splitting IP addresses
...
## <a name="examples-of-splitting-on-multiple-delimiters-within-particular-contexts"></a>Examples of splitting on multiple delimiters within particular contexts
...
### <a name="splitting-store-opening-timings"></a>Splitting store opening timings
...
### <a name="splitting-iis-log"></a>Splitting IIS log
...
## <a name="examples-of-splitting-without-delimiters"></a>Examples of splitting without delimiters
...
### <a name="splitting-amount-with-currency-symbol"></a>Splitting amount with currency symbol
...
### <a name="splitting-weights-with-units"></a>Splitting weights with units
