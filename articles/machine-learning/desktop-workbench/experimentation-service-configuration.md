...
---
# <a name="configuring-azure-machine-learning-experimentation-service"></a>Configuring Azure Machine Learning Experimentation Service
...
### <a name="key-concepts-in-experimentation-service"></a>Key concepts in Experimentation Service
...
### <a name="run-configuration"></a>Run configuration
...
## <a name="experiment-execution-scenarios"></a>Experiment execution scenarios
...
## <a name="launching-the-cli"></a>Launching the CLI
...
## <a name="running-scripts-and-experiments"></a>Running scripts and experiments
...
## <a name="running-a-script-locally-on-workbench-installed-runtime"></a>Running a script locally on Workbench-installed runtime
...
## <a name="running-a-script-on-local-docker"></a>Running a script on local Docker
...
## <a name="running-a-script-on-a-remote-docker"></a>Running a script on a remote Docker
...
## <a name="running-a-script-on-a-remote-vm-targeting-user-managed-environments"></a>Running a script on a remote VM targeting user-managed environments
...
## <a name="running-a-script-on-an-hdinsight-cluster"></a>Running a script on an HDInsight cluster
...
## <a name="running-a-script-on-gpu"></a>Running a script on GPU
...
## <a name="using-ssh-key-based-authentication-for-creating-and-using-compute-targets"></a>Using SSH Key-based authentication for creating and using compute targets
