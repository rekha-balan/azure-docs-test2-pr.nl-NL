...
---
# <a name="aerial-image-classification"></a>Aerial Image Classification
...
## <a name="link-to-the-gallery-github-repository"></a>Link to the Gallery GitHub repository
...
## <a name="use-case-description"></a>Use case description
...
## <a name="scenario-structure"></a>Scenario structure
...
## <a name="set-up-the-execution-environment"></a>Set up the execution environment
...
### <a name="set-up-azure-resources"></a>Set up Azure resources
...
#### <a name="create-a-new-workbench-project"></a>Create a new Workbench project
...
#### <a name="create-the-storage-account"></a>Create the storage account
...
#### <a name="create-the-hdinsight-spark-cluster"></a>Create the HDInsight Spark cluster
...
### <a name="set-up-batch-ai-resources"></a>Set up Batch AI resources
...
#### <a name="prepare-the-batch-ai-network-file-server"></a>Prepare the Batch AI Network File Server
...
#### <a name="create-a-batch-ai-cluster"></a>Create a Batch AI cluster
...
#### <a name="record-batch-ai-training-credentials"></a>Record Batch AI Training credentials
...
### <a name="prepare-the-azure-machine-learning-workbench-execution-environment"></a>Prepare the Azure Machine Learning Workbench execution environment

#### <a name="register-the-hdinsight-cluster-as-an-azure-machine-learning-workbench-compute-target"></a>Register the HDInsight cluster as an Azure Machine Learning Workbench compute target
...
#### <a name="install-local-dependencies"></a>Install local dependencies
...
## <a name="data-acquisition-and-understanding"></a>Data acquisition and understanding
...
### <a name="training-models-with-azure-batch-ai"></a>Training models with Azure Batch AI
...
### <a name="training-models-with-mmlspark"></a>Training models with MMLSpark
...
### <a name="comparing-model-performance-using-the-workbench-run-history-feature"></a>Comparing model performance using the Workbench Run History feature
