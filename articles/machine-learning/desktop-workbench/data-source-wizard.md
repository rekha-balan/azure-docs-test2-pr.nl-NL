...
---
# <a name="data-source-wizard"></a>Data Source Wizard #
...
## <a name="step-1-trigger-the-data-source-wizard"></a>Step 1: Trigger the Data Source Wizard ## 
...
## <a name="step-2-select-where-data-is-stored"></a>Step 2: Select where data is stored ##
...
## <a name="step-3-select-data-file"></a>Step 3: Select data file ##
...
## <a name="step-4-choose-file-parameters"></a>Step 4: Choose file parameters ##
...
## <a name="step-5-set-data-types-for-columns"></a>Step 5: Set data types for columns ##
...
## <a name="step-6-choose-sampling-strategy-for-data"></a>Step 6: Choose sampling strategy for data ##
...
## <a name="step-7-path-column-handling"></a>Step 7: Path column handling ##
