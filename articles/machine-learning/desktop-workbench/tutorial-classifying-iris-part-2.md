...
---
# <a name="tutorial-2-classify-iris---build-a-model"></a>Tutorial 2: Classify Iris - Build a model
...
## <a name="review-irissklearnpy-and-the-configuration-files"></a>Review iris_sklearn.py and the configuration files
...
## <a name="run-irissklearnpy-in-your-local-environment"></a>Run iris_sklearn.py in your local environment
...
## <a name="review-the-run-history-in-detail"></a>Review the run history in detail
...
## <a name="run-scripts-in-local-docker-environments"></a>Run scripts in local Docker environments
...
## <a name="run-scripts-in-the-cli-window"></a>Run scripts in the CLI window
...
## <a name="run-scripts-in-a-remote-docker-container"></a>Run scripts in a remote Docker container
...
## <a name="run-scripts-in-hdinsight-clusters"></a>Run scripts in HDInsight clusters
