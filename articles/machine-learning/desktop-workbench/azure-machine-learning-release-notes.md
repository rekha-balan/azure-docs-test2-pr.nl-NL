...
- Customizable Run History reports ![Image of new Run History Reports](media/azure-machine-learning-release-notes/new-run-history-reports.png)
...
- Customizable Run History reports
  - Improved chart configuration for Run History reports
    ...
    - Top-level filters can be added and modified ![Add Filters](media/azure-machine-learning-release-notes/add-filters.jpg)
...
- Environments Tab
  - Easily add new compute target and run configuration files to your project ![New Compute Target](media/azure-machine-learning-release-notes/add-new-environments.png)
...
### <a name="model-management"></a>Model Management
...
- Ability to send sample data and feedback while performing By Example transformations ![Image of send feedback link on derive column transform](media/azure-machine-learning-release-notes/SendFeedbackFromDeriveColumn.png)
...
### <a name="workbench-authentication"></a>Workbench Authentication
...
### <a name="job-execution"></a>Job execution
...
### <a name="model-management-and-operationalization"></a>Model Management and Operationalization
...
### <a name="sample-projects"></a>Sample projects
...
### <a name="notable-new-features"></a>Notable New Features
...
### <a name="detailed-updates"></a>Detailed Updates
...
#### <a name="workbench-experience"></a>Workbench experience
