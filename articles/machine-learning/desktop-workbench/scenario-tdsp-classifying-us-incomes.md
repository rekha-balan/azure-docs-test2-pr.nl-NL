...
---
# <a name="income-classification-with-team-data-science-process-tdsp-project"></a>Income classification with Team Data Science Process (TDSP) project
...
## <a name="link-to-github-repository"></a>Link to GitHub repository
...
## <a name="team-data-science-process-tdsp-lifecycle"></a>Team Data Science Process (TDSP) lifecycle
...
### <a name="required-subscription-hardware-software"></a>Required: subscription, hardware, software
...
### <a name="optional-version-control-repository"></a>Optional: Version control repository
...
### <a name="informational-about-azure-machine-learning"></a>Informational: about Azure Machine Learning
...
## <a name="project-structure-execution-and-reporting"></a>Project structure, execution, and reporting
...
### <a name="final-project-reporthttpsgithubcomazuremachinelearningsamples-tdspuciadultincomeblobmasterdocsdeliverabledocsprojectreportmd"></a>[Final project report](https://github.com/Azure/MachineLearningSamples-TDSPUCIAdultIncome/blob/master/docs/deliverable_docs/ProjectReport.md)
