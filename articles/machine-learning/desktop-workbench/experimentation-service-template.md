...
---
# <a name="configure-the-azure-machine-learning-experimentation-service"></a>Configure the Azure Machine Learning Experimentation Service
...
## <a name="deploy-a-template"></a>Deploy a template
Deploying a template requires only a couple of steps in the Azure Command Line Interface or in the Azure portal.

### <a name="deploy-a-template-from-the-command-line"></a>Deploy a template from the command line
...
### <a name="deploy-a-template-from-the-azure-portal"></a>Deploy a template from the Azure portal
...
## <a name="create-a-template-from-an-existing-azure-resource-in-the-azure-portal"></a>Create a template from an existing Azure resource in the Azure portal
...
### <a name="template-file-example"></a>Template file example
