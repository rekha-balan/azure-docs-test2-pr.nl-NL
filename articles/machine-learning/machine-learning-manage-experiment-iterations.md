...
---
# <a name="manage-experiment-iterations-in-azure-machine-learning-studio"></a>Manage experiment iterations in Azure Machine Learning Studio
...
## <a name="viewing-the-prior-run"></a>Viewing the Prior Run
...
## <a name="viewing-the-run-history"></a>Viewing the Run History
...
## <a name="iterating-on-a-previous-run"></a>Iterating on a Previous Run
