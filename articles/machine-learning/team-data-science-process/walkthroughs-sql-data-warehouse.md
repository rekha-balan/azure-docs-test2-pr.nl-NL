...
ms.locfileid: "44856814"
---
# <a name="sql-data-warehouse-data-science-walkthroughs-using-t-sql-and-python-on-azure"></a>SQL Data Warehouse data science walkthroughs using T-SQL and Python on Azure
...
## <a name="predict-taxi-tips-using-t-sql-and-ipython-notebooks-with-sql-data-warehouse"></a>Predict taxi tips using T-SQL and IPython notebooks with SQL Data Warehouse
