...
---
# <a name="individual-contributor-tasks"></a>Individual Contributor tasks
...
## <a name="step-0-prerequisites"></a>Step-0: Prerequisites
...
## <a name="step-1-3-clone-group-team-and-project-repositories-to-local-machine"></a>Step 1-3: Clone group, team, and project repositories to local machine
...
## <a name="step-4-5-mount-azure-file-storage-to-your-dsvm-optional"></a>Step 4-5: Mount Azure file storage to your DSVM (Optional)
