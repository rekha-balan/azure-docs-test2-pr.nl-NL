...
---
# <a name="team-lead-tasks"></a>Team Lead tasks
...
## <a name="repositories-and-directories"></a>Repositories and directories
...
## <a name="1-create-a-project-and-repositories"></a>1. Create a project and repositories
...
### <a name="create-the-myteam-project"></a>Create the MyTeam project
...
### <a name="create-the-myprojecttemplate-repository-r3-on-git"></a>Create the MyProjectTemplate repository (R3) on Git
...
### <a name="create-the-myteamutilities-repository-r4-on-git"></a>Create the MyTeamUtilities repository (R4) on Git
...
## <a name="2-seed-your-projecttemplate-and-teamutilities-repositories"></a>2. Seed your ProjectTemplate and TeamUtilities repositories
...
### <a name="initialize-the-team-repositories"></a>Initialize the team repositories
...
### <a name="clone-group-repositories-into-local-directories"></a>Clone group repositories into local directories
...
### <a name="clone-your-team-repositories-into-local-directories"></a>Clone your team repositories into local directories
...
### <a name="copy-the-group-project-template-content-to-the-local-project-template-directory"></a>Copy the group project template content to the local project template directory
...
#### <a name="from-the-powershell-command-line-for-windows"></a>From the PowerShell command-line for Windows       
...
#### <a name="from-the-linux-shell-for-the-linux-dsvm"></a>From the Linux shell for the **Linux DSVM**
...
### <a name="customize-your-project-template-or-team-utilities-optional"></a>Customize your project template or team utilities (optional)
...
### <a name="push-local-directory-content-to-team-repositories"></a>Push local directory content to team repositories
...
## <a name="3-create-team-data-and-analytics-resources-optional"></a>3. Create team data and analytics resources (Optional)
...
### <a name="create-azure-file-storage-with-powershell-from-windows"></a>Create Azure file storage with PowerShell from Windows
...
### <a name="create-azure-file-storage-with-a-linux-script"></a>Create Azure file storage with a Linux script
...
## <a name="4-mount-azure-file-storage-optional"></a>4. Mount Azure file storage (Optional)
...
### <a name="mount-azure-file-storage-with-powershell-from-windows"></a>Mount Azure file storage with PowerShell from Windows
...
### <a name="mount-azure-file-storage-with-a-linux-script"></a>Mount Azure file storage with a Linux script
...
## <a name="5-set-up-security-control-policy"></a>5. Set up security control policy 
