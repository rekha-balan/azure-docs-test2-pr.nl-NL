...
---
# <a name="devops-for-artificial-intelligence-ai-applications-creating-continuous-integration-pipeline-on-azure-using-docker-and-kubernetes"></a>DevOps for Artificial Intelligence (AI) applications: Creating continuous integration pipeline on Azure using Docker and Kubernetes
...
## <a name="github-repository-with-document-and-code"></a>GitHub repository with document and code
...
## <a name="description-of-the-cicd-pipeline"></a>Description of the CI/CD pipeline
...
## <a name="steps-of-the-cicd-pipeline"></a>Steps of the CI/CD pipeline
