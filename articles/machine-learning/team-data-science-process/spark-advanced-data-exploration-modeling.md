...
## <a name="setup-spark-clusters-and-notebooks"></a>Setup: Spark clusters and notebooks
...
### <a name="create-a-new-feature-by-partitioning-traffic-times-into-bins"></a>Create a new feature by partitioning traffic times into bins
