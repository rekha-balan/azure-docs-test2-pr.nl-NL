...
### <a name="set-up-the-power-bi-real-time-dashboard"></a>Set up the Power BI real-time dashboard

#### <a name="start-the-real-time-dashboard-application"></a>Start the real-time dashboard application
...
### <a name="vehicles-in-operation-report"></a>Vehicles in Operation report
...
### <a name="vehicles-requiring-maintenance-report"></a>Vehicles Requiring Maintenance report
...
### <a name="vehicle-health-statistics-report"></a>Vehicle Health Statistics report
...
## <a name="set-up-the-power-bi-batch-processing-dashboard"></a>Set up the Power BI batch processing dashboard
> [!NOTE]
...
### <a name="download-the-power-bi-designer-file"></a>Download the Power BI designer file
...
### <a name="organize-the-dashboard"></a>Organize the dashboard  
