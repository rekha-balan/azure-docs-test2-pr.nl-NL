...
---
# <a name="move-data-from-an-on-premises-sql-server-to-sql-azure-with-azure-data-factory"></a>Move data from an on-premises SQL server to SQL Azure with Azure Data Factory
...
> [!NOTE]
> The following procedures use Azure PowerShell to define and create the ADF pipeline. But this task can also be accomplished using the Azure portal. For details, see [Create pipeline](../../data-factory/tutorial-hybrid-copy-portal.md#create-a-pipeline).
>
>
