...
---
# <a name="platforms-and-tools-for-data-science-projects"></a>Platforms and tools for data science projects
...
### <a name="install-git-credential-manager-on-windows"></a>Install Git Credential Manager on Windows
...
### <a name="install-git-on-linux-centos-machines"></a>Install Git on Linux (CentOS) machines
...
### <a name="generate-public-ssh-key-on-linux-centos-machines"></a>Generate public SSH key on Linux (CentOS) machines
