...
## <a name="partition-the-data-set"></a>Partition the data set
...
#### <a name="maintenance-detection-model"></a>**Maintenance detection model**
...
#### <a name="recall-anomaly-detection-model"></a>**Recall anomaly detection model**
...
#### <a name="real-time-prediction"></a>**Real-time prediction**
...
#### <a name="execute-the-real-time-dashboard-application"></a>**Execute the real-time dashboard application**
...
#### <a name="aggressive-driving-behavior-patterns"></a>**Aggressive driving behavior patterns**
...
#### <a name="fuel-efficient-driving-behavior-patterns"></a>**Fuel-efficient driving behavior patterns**
