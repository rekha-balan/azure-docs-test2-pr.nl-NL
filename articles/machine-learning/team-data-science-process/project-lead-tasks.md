...
---
# <a name="project-lead-tasks"></a>Project Lead tasks
...
## <a name="1-create-a-project-repository-r5"></a>1. Create a project repository (R5)
...
## <a name="2-seed-the-dsproject1-project-repository"></a>2. Seed the DSProject1 project repository
...
### <a name="clone-your-project-template-repository-r3-to-a-directory-d3-on-your-local-machine"></a>Clone your project template repository (R3) to a directory (D3) on your local machine.
...
### <a name="clone-dsproject1-repository-r5-to-a-directory-d5-on-your-local-machine"></a>Clone DSProject1 repository (R5) to a directory (D5) on your local machine
...
### <a name="copy-contents-of-d3-to-d5"></a>Copy contents of D3 to D5 
...
### <a name="customize-d5-if-you-need-to-optional"></a>Customize D5 if you need to (Optional)
...
### <a name="add-contents-of-dsproject1-in-d5-to-r5-on-your-group-azure-devops-services"></a>Add contents of DSProject1 in D5 to R5 on your group Azure DevOps Services
...
## <a name="6-create-and-mount-azure-file-storage-as-project-resources-optional"></a>6. Create and mount Azure file storage as project resources (Optional)
