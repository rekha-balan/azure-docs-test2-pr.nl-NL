...
---
# <a name="group-manager-tasks"></a>Group Manager tasks
...
### <a name="abbreviations-for-repositories-and-directories"></a>Abbreviations for repositories and directories
...
### <a name="pre-requisites-for-cloning-repositories-and-checking-code-in-and-out"></a>Pre-requisites for cloning repositories and checking code in and out
...
## <a name="1-create-account-on-azure-devops-services"></a>1. Create Account on Azure DevOps Services
...
### <a name="setting-up-the-azure-devops-services-sign-into-your-microsoft-account"></a>Setting up the Azure DevOps Services Sign into your Microsoft account
...
## <a name="3-create-the-grouputilities-r2-repository"></a>3. Create the GroupUtilities (R2) repository
...
## <a name="4-create-the-groupprojecttemplate-r1-repository"></a>4. Create the GroupProjectTemplate (R1) repository
...
### <a name="rename-the-default-groupcommon-repository"></a>Rename the default GroupCommon repository
...
## <a name="5-seed-the-r1--r2-repositories-on-the-azure-devops-services"></a>5. Seed the R1 & R2 repositories on the Azure DevOps Services
...
### <a name="clone-g1--g2-repositories-to-your-local-dsvm"></a>Clone G1 & G2 repositories to your local DSVM
...
### <a name="clone-r1--r2-repositories-to-your-local-dsvm"></a>Clone R1 & R2 repositories to your local DSVM
...
### <a name="seed-your-groupprojecttemplate-lr1-and-grouputilities-lr2"></a>Seed your GroupProjectTemplate (LR1) and GroupUtilities (LR2)
...
### <a name="option-to-customize-the-contents-of-lr1--lr2"></a>Option to customize the contents of LR1 & LR2
...
### <a name="add-the-contents-in-lr1--lr2-to-r1--r2-on-group-server"></a>Add the contents in LR1 & LR2 to R1 & R2 on group server
...
## <a name="6-add-group-members-to-the-group-server"></a>6. Add group members to the group server
