...
---
# <a name="execute-data-science-tasks-exploration-modeling-and-deployment"></a>Execute data science tasks: exploration, modeling, and deployment
...
### <a name="interactive-data-exploration-analysis-and-reporting-using-the-idear-utility"></a>Interactive data exploration, analysis, and reporting using the IDEAR utility
...
### <a name="model-training-modeling-and-reporting-using-the-amar-utility"></a>Model training: modeling and reporting using the AMAR utility
