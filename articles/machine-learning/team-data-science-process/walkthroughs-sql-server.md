...
## <a name="predict-taxi-tips-using-python-and-sql-queries-with-sql-server"></a>Predict taxi tips using Python and SQL queries with SQL Server 
...
## <a name="predict-taxi-tips-using-microsoft-r-with-sql-server"></a>Predict taxi tips using Microsoft R with SQL Server 
...
## <a name="predict-taxi-tips-using-r-from-t-sql-or-stored-procedures-with-sql-server"></a>Predict taxi tips using R from T-SQL or stored procedures with SQL Server
...
## <a name="predict-taxi-tips-using-python-in-sql-server-stored-procedures"></a>Predict taxi tips using Python in SQL Server stored procedures
