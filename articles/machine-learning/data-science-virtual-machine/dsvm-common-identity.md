...
---
# <a name="set-up-a-common-identity-on-the-data-science-virtual-machine"></a>Set up a common identity on the Data Science Virtual Machine
...
## <a name="set-up-a-fully-managed-active-directory-domain-on-azure"></a>Set up a fully managed Active Directory domain on Azure
