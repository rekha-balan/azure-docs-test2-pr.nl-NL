...
---
# <a name="store-access-credentials-on-the-data-science-virtual-machine-securely"></a>Store access credentials on the Data Science Virtual Machine securely
...
The MSI and Key Vault documentation is a comprehensive resource for in-depth information on these services. The rest of this article walks through the basic use of MSI and Key Vault on the Data Science Virtual Machine (DSVM) to access Azure resources. 

## <a name="create-a-managed-identity-on-the-dsvm"></a>Create a managed identity on the DSVM 
...
## <a name="assign-key-vault-access-permission-to-a-vm-principal"></a>Assign Key Vault access permission to a VM principal
```
...
## <a name="access-a-secret-in-the-key-vault-from-the-dsvm"></a>Access a secret in the key vault from the DSVM
...
## <a name="access-storage-keys-from-the-dsvm"></a>Access storage keys from the DSVM
...
```
## <a name="access-the-key-vault-from-python"></a>Access the key vault from Python
...
## <a name="access-the-key-vault-from-azure-cli"></a>Access the key vault from Azure CLI
