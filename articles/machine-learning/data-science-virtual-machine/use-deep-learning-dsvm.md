...
---
# <a name="using-the-deep-learning-virtual-machine"></a>Using the Deep Learning Virtual Machine
...
## <a name="deep-learning-tutorials-and-walkthroughs"></a>Deep Learning tutorials and walkthroughs
...
- [Named entity extraction from PubMed abstracts](https://docs.microsoft.com/azure/machine-learning/preview/scenario-tdsp-biomedical-recognition) This tutorial shows how to extract named entities, like drug names or disease names, from unstructured text. It trains a custom word embedding on a text corpus of 18 million PubMed abstracts, uses that model to build a Long Short-Term Memory (LSTM) recurrent neural network model for entity extraction, and shows that the domain-specific word embedding model can outperform a generic word embedding for entity extraction.
