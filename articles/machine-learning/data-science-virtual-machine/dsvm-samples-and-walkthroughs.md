...
---
# <a name="samples-on-the-data-science-virtual-machines-dsvm"></a>Samples on the Data Science Virtual Machines (DSVM)
...
## <a name="quick-reference-of-samples"></a>Quick Reference of Samples
...
## <a name="access-jupyter"></a>Access Jupyter 

Visit Jupyter Home by going to **`https://localhost:9999`** on Windows or **`https://localhost:8000`** on Ubuntu.


### <a name="enabling-jupyter-access-from-browser"></a>Enabling Jupyter access from Browser
...
## <a name="r-language"></a>R Language 
...
## <a name="julia-language"></a>Julia Language 
