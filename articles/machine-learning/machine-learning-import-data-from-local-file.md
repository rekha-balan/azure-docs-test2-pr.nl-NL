...
---
# <a name="import-training-data-from-a-file-on-your-hard-drive-into-machine-learning-studio"></a>Import training data from a file on your hard drive into Machine Learning Studio
...
## <a name="steps-to-import-data-from-a-local-file"></a>Steps to import data from a local file
...
## <a name="dataset-module-is-ready-for-use"></a>Dataset module is ready for use
