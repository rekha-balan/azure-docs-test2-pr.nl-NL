...
---
# <a name="tutorial-push-notifications-to-specific-windows-phone-devices-by-using-azure-notification-hubs"></a>Tutorial: Push notifications to specific Windows Phone devices by using Azure Notification Hubs
...
## <a name="add-category-selection-to-the-mobile-app"></a>Add category selection to the mobile app
...
## <a name="send-tagged-notifications"></a>Send tagged notifications
