...
---
# <a name="azure-notification-hubs-notify-users-with-net-backend"></a>Azure Notification Hubs Notify Users with .NET backend
...
## <a name="update-the-code-for-the-client-project"></a>Update the code for the client project
