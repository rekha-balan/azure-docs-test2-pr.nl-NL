...
### <a name="what-is-the-resource-structure-of-notification-hubs"></a>What is the resource structure of Notification Hubs?
...
### <a name="what-is-the-price-model-for-notification-hubs"></a>What is the price model for Notification Hubs?
...
### <a name="what-is-the-notification-hubs-sla"></a>What is the Notification Hubs SLA?
...
### <a name="which-customers-are-using-notification-hubs"></a>Which customers are using Notification Hubs?
...
### <a name="how-do-i-upgrade-or-downgrade-my-hub-or-namespace-to-a-different-tier"></a>How do I upgrade or downgrade my hub or namespace to a different tier?
...
## <a name="design-and-development"></a>Design and development
### <a name="which-server-side-platforms-do-you-support"></a>Which server-side platforms do you support?
...
### <a name="which-client-platforms-do-you-support"></a>Which client platforms do you support?
...
### <a name="do-you-support-text-message-email-or-web-notifications"></a>Do you support text message, email, or web notifications?
...
### <a name="how-are-mobile-apps-and-azure-notification-hubs-related-and-when-do-i-use-them"></a>How are Mobile Apps and Azure Notification Hubs related and when do I use them?
...
### <a name="how-many-devices-can-i-support-if-i-send-push-notifications-via-notification-hubs"></a>How many devices can I support if I send push notifications via Notification Hubs?
...
### <a name="how-many-push-notifications-can-i-send-out"></a>How many push notifications can I send out?
...
### <a name="how-long-does-it-take-for-sent-push-notifications-to-reach-my-device"></a>How long does it take for sent push notifications to reach my device?
...
### <a name="is-there-any-latency-guarantee"></a>Is there any latency guarantee?
...
### <a name="what-do-i-need-to-consider-when-designing-a-solution-with-namespaces-and-notification-hubs"></a>What do I need to consider when designing a solution with namespaces and notification hubs?
...
### <a name="should-i-do-registrations-from-the-app-back-end-or-directly-through-client-devices"></a>Should I do registrations from the app back end or directly through client devices?
...
### <a name="what-is-the-push-notification-delivery-security-model"></a>What is the push notification delivery security model?
...
### <a name="how-should-i-handle-sensitive-payload-in-push-notifications"></a>How should I handle sensitive payload in push notifications?
...
### <a name="what-support-is-provided-for-disaster-recovery"></a>What support is provided for disaster recovery?
...
### <a name="is-there-audit-log-capability"></a>Is there audit log capability?
...
### <a name="what-troubleshooting-capabilities-are-available"></a>What troubleshooting capabilities are available?
...
### <a name="what-telemetry-features-are-available"></a>What telemetry features are available?
