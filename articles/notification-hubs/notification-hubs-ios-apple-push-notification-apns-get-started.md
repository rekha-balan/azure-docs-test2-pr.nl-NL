...
&emsp;&emsp;&emsp;&emsp;![Configure APNS in Azure Portal](https://docstestmedia1.blob.core.windows.net/azure-media/articles/notification-hubs/media/notification-hubs-ios-get-started/notification-hubs-apple-config.png)
