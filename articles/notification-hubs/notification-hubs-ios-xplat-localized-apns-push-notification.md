...
---
# <a name="tutorial-push-localized-notifications-to-ios-devices-using-azure-notification-hubs"></a>Tutorial: Push localized notifications to iOS devices using Azure Notification Hubs 
...
## <a name="update-the-app-user-interface"></a>Update the app user interface
...
## <a name="build-the-ios-app"></a>Build the iOS app
