...
---
# <a name="tutorial-push-notifications-to-xamarinandroid-apps-using-azure-notification-hubs"></a>Tutorial: Push notifications to Xamarin.Android apps using Azure Notification Hubs
...
## <a name="create-a-firebase-project-and-enable-firebase-cloud-messaging"></a>Create a Firebase project and enable Firebase Cloud Messaging
[!INCLUDE [notification-hubs-enable-firebase-cloud-messaging](../../includes/notification-hubs-enable-firebase-cloud-messaging.md)]

## <a name="create-a-notification-hub"></a>Create a notification hub
[!INCLUDE [notification-hubs-portal-create-new-hub](../../includes/notification-hubs-portal-create-new-hub.md)]

### <a name="configure-gcm-settings-for-the-notification-hub"></a>Configure GCM settings for the notification hub
...
## <a name="create-xamarinandroid-app-and-connect-it-to-notification-hub"></a>Create Xamarin.Android app and connect it to notification hub

### <a name="create-visual-studio-project-and-add-nuget-packages"></a>Create Visual Studio project and add NuGet packages
...
### <a name="add-the-google-services-json-file"></a>Add the Google Services JSON File
...
#### <a name="registering-with-firebase-cloud-messaging"></a>Registering with Firebase Cloud Messaging
...
## <a name="send-test-notification-from-the-azure-portal"></a>Send test notification from the Azure portal
