...
---
# <a name="build-complex-schedules-and-advanced-recurrence-with-azure-scheduler"></a>Build complex schedules and advanced recurrence with Azure Scheduler
...
## <a name="date-and-date-time"></a>Date and date-time
...
## <a name="use-json-and-the-rest-api-to-create-a-schedule"></a>Use JSON and the REST API to create a schedule
...
## <a name="job-schema-basics"></a>Job schema basics
...
## <a name="job-schema-defaults-limits-and-examples"></a>Job schema defaults, limits, and examples
...
## <a name="deep-dive-schedule"></a>Deep dive: schedule
