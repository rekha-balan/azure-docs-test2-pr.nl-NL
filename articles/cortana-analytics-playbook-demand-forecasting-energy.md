...
A basic formula for calculating the financial benefit of demand forecast solution would be: ![Basic formula for calculating the financial benefit of demand forecast solution](https://docstestmedia1.blob.core.windows.net/azure-media/articles/media/cortana-analytics-playbook-demand-forecasting-energy/financial-benefit-formula.png)
...
![MAPE Formula](https://docstestmedia1.blob.core.windows.net/azure-media/articles/media/cortana-analytics-playbook-demand-forecasting-energy/mape-formula.png)
