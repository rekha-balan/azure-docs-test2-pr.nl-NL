...
---
# <a name="advisor-high-availability-recommendations"></a>Advisor High Availability recommendations
...
## <a name="ensure-virtual-machine-fault-tolerance"></a>Ensure virtual machine fault tolerance
...
## <a name="ensure-availability-set-fault-tolerance"></a>Ensure availability set fault tolerance 
...
## <a name="ensure-application-gateway-fault-tolerance"></a>Ensure application gateway fault tolerance
...
## <a name="improve-the-performance-and-reliability-of-virtual-machine-disks"></a>Improve the performance and reliability of virtual machine disks
...
## <a name="protect-your-virtual-machine-data-from-accidental-deletion"></a>Protect your virtual machine data from accidental deletion
...
## <a name="ensure-you-have-access-to-azure-cloud-experts-when-you-need-it"></a>Ensure you have access to Azure cloud experts when you need it
...
## <a name="create-azure-service-health-alerts-to-be-notified-when-azure-issues-affect-you"></a>Create Azure Service Health alerts to be notified when Azure issues affect you
...
## <a name="configure-traffic-manager-endpoints-for-resiliency"></a>Configure Traffic Manager endpoints for resiliency
...
## <a name="use-soft-delete-on-your-azure-storage-account-to-save-and-recover-data-in-the-event-of-accidental-overwrite-or-deletion"></a>Use soft delete on your Azure Storage Account to save and recover data in the event of accidental overwrite or deletion
...
## <a name="how-to-access-high-availability-recommendations-in-advisor"></a>How to access High Availability recommendations in Advisor
