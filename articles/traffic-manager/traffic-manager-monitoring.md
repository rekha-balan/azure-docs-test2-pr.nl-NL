...
## <a name="configure-endpoint-monitoring"></a>Configure endpoint monitoring
...
## <a name="how-endpoint-monitoring-works"></a>How endpoint monitoring works
...
### <a name="endpoint-status"></a>Endpoint status
...
### <a name="endpoint-monitor-status"></a>Endpoint monitor status
...
### <a name="profile-monitor-status"></a>Profile monitor status
...
## <a name="endpoint-failover-and-recovery"></a>Endpoint failover and recovery
...
## <a name="traffic-routing-methods"></a>Traffic-routing methods
