...
---
# <a name="deploy-to-azure-container-instances-from-azure-container-registry"></a>Deploy to Azure Container Instances from Azure Container Registry
...
## <a name="deploy-with-azure-resource-manager-template"></a>Deploy with Azure Resource Manager template
...
## <a name="deploy-with-azure-portal"></a>Deploy with Azure portal
