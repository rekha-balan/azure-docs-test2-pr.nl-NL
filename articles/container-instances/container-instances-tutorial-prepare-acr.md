...
---
# <a name="tutorial-deploy-and-use-azure-container-registry"></a>Tutorial: Deploy and use Azure Container Registry
...
## <a name="create-azure-container-registry"></a>Create Azure container registry
...
## <a name="log-in-to-container-registry"></a>Log in to container registry
...
## <a name="tag-container-image"></a>Tag container image
...
## <a name="list-images-in-azure-container-registry"></a>List images in Azure Container Registry
