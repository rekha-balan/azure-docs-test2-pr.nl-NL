...
---
# <a name="tutorial-create-container-for-deployment-to-azure-container-instances"></a>Tutorial: Create container for deployment to Azure Container Instances
...
## <a name="build-the-container-image"></a>Build the container image
...
## <a name="run-the-container-locally"></a>Run the container locally
