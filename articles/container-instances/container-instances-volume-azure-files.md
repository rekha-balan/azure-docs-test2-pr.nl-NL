...
---
# <a name="mount-an-azure-file-share-in-azure-container-instances"></a>Mount an Azure file share in Azure Container Instances
...
## <a name="deploy-container-and-mount-volume"></a>Deploy container and mount volume
...
## <a name="manage-files-in-mounted-volume"></a>Manage files in mounted volume
...
## <a name="mount-multiple-volumes"></a>Mount multiple volumes
