...
---
# <a name="run-containerized-tasks-with-restart-policies"></a>Run containerized tasks with restart policies
...
## <a name="container-restart-policy"></a>Container restart policy
...
## <a name="specify-a-restart-policy"></a>Specify a restart policy
...
## <a name="run-to-completion-example"></a>Run to completion example
...
## <a name="configure-containers-at-runtime"></a>Configure containers at runtime
...
## <a name="command-line-override"></a>Command line override
...
### <a name="persist-task-output"></a>Persist task output
