...
---
# <a name="tutorial-deploy-a-container-to-azure-container-instances"></a>Tutorial: Deploy a container to Azure Container Instances
...
## <a name="deploy-the-container-using-the-azure-cli"></a>Deploy the container using the Azure CLI
...
### <a name="get-registry-credentials"></a>Get registry credentials
...
### <a name="deploy-container"></a>Deploy container
...
### <a name="verify-deployment-progress"></a>Verify deployment progress
...
## <a name="view-the-application-and-container-logs"></a>View the application and container logs
