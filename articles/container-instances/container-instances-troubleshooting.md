...
---
# <a name="troubleshoot-common-issues-in-azure-container-instances"></a>Troubleshoot common issues in Azure Container Instances
...
## <a name="os-version-of-image-not-supported"></a>OS version of image not supported
...
## <a name="unable-to-pull-image"></a>Unable to pull image
...
## <a name="container-continually-exits-and-restarts"></a>Container continually exits and restarts
...
## <a name="container-takes-a-long-time-to-start"></a>Container takes a long time to start
...
### <a name="image-size"></a>Image size
...
### <a name="image-location"></a>Image location
...
### <a name="cached-windows-images"></a>Cached Windows images
...
### <a name="windows-containers-slow-network-readiness"></a>Windows containers slow network readiness
...
## <a name="cannot-connect-to-underlying-docker-api-or-run-privileged-containers"></a>Cannot connect to underlying Docker API or run privileged containers
