...
---
# <a name="container-instance-logging-with-azure-log-analytics"></a>Container instance logging with Azure Log Analytics
...
## <a name="get-log-analytics-credentials"></a>Get Log Analytics credentials
...
## <a name="create-container-group"></a>Create container group
...
### <a name="deploy-with-yaml"></a>Deploy with YAML
...
## <a name="query-container-logs"></a>Query container logs
...
### <a name="monitor-container-cpu-and-memory"></a>Monitor container CPU and memory
