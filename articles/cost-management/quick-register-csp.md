...
---
# <a name="register-with-the-csp-partner-program-and-view-cost-data"></a>Register with the CSP Partner program and view cost data
...
## <a name="register-with-azure-cost-management"></a>Register with Azure Cost Management
...
## <a name="configure-indirect-csp-access-in-cloudyn"></a>Configure indirect CSP access in Cloudyn
