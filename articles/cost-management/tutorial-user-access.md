...
---
# <a name="tutorial-assign-access-to-cost-management-data"></a>Tutorial: Assign access to cost management data
...
## <a name="create-a-user-with-admin-access"></a>Create a user with admin access
...
## <a name="create-a-user-with-user-access"></a>Create a user with user access
...
## <a name="delete-or-export-personal-data"></a>Delete or export personal data
...
## <a name="create-and-manage-entities"></a>Create and manage entities
...
### <a name="entity-access-levels"></a>Entity access levels
...
### <a name="create-a-cost-entity-hierarchy"></a>Create a cost entity hierarchy
