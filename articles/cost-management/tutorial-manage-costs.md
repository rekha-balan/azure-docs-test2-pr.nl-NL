...
---
# <a name="tutorial-manage-costs-by-using-azure-cost-management"></a>Tutorial: Manage costs by using Azure Cost Management
...
## <a name="use-custom-tags-to-allocate-costs"></a>Use custom tags to allocate costs
...
### <a name="tag-sources-and-reports"></a>Tag sources and reports
...
## <a name="create-showback-and-chargeback-reports"></a>Create showback and chargeback reports
