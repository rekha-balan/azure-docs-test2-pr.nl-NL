...
---
# <a name="consumption-model"></a>Consumption model
...
## <a name="parameter-constraints-for-consumption-model"></a>Parameter constraints for consumption model
...
## <a name="combustion-consumption-model"></a>Combustion consumption model
...
## <a name="electric-consumption-model"></a>Electric consumption model
...
## <a name="sensible-values-of-consumption-parameters"></a>Sensible values of consumption parameters
