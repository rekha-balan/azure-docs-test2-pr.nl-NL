...
---
# <a name="add-map-controls-to-azure-maps"></a>Add Map Controls to Azure Maps
...
## <a name="add-zoom-control"></a>Add zoom control
...
## <a name="add-pitch-control"></a>Add pitch control
...
## <a name="add-compass-control"></a>Add compass control
...
## <a name="a-map-with-all-controls"></a>A Map with all controls
