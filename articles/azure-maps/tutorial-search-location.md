...
---
# <a name="search-nearby-points-of-interest-using-azure-maps"></a>Search nearby points of interest using Azure Maps
...
## <a name="create-an-account-with-azure-maps"></a>Create an account with Azure Maps
...
## <a name="get-the-primary-key-for-your-account"></a>Get the primary key for your account
...
## <a name="create-a-new-map"></a>Create a new map 
...
## <a name="add-search-capabilities"></a>Add search capabilities
...
### <a name="service-module"></a>Service Module
...
## <a name="add-interactive-data"></a>Add interactive data
