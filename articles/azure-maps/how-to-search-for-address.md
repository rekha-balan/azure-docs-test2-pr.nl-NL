...
---
# <a name="how-to-find-an-address-using-the-azure-maps-search-service"></a>How to find an address using the Azure Maps search service
...
## <a name="using-fuzzy-search"></a>Using fuzzy search
...
### <a name="search-for-an-address-using-fuzzy-search"></a>Search for an address using Fuzzy Search
...
## <a name="search-for-address-properties-and-coordinates"></a>Search for address properties and coordinates 
...
## <a name="search-for-a-street-address-using-reverse-address-search"></a>Search for a street address using Reverse Address Search
...
## <a name="search-for-the-cross-street-using-reverse-address-cross-street-search"></a>Search for the cross street using Reverse Address Cross Street Search
