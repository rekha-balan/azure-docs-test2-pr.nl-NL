...
---
# <a name="find-routes-for-different-modes-of-travel-using-azure-maps"></a>Find routes for different modes of travel using Azure Maps
...
## <a name="visualize-traffic-flow"></a>Visualize traffic flow
...
## <a name="set-start-and-end-points"></a>Set start and end points
...
## <a name="render-routes-prioritized-by-mode-of-travel"></a>Render routes prioritized by mode of travel
