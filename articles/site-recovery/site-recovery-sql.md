...
## <a name="integrate-with-sql-server-always-on-for-replication-to-azure"></a>Integrate with SQL Server Always On for replication to Azure
...
### <a name="steps-to-do-a-test-failover"></a>Steps to do a test failover
...
### <a name="steps-to-do-a-failover"></a>Steps to do a failover
...
## <a name="integrate-with-sql-server-always-on-for-replication-to-a-secondary-on-premises-site"></a>Integrate with SQL Server Always On for replication to a secondary on-premises site
