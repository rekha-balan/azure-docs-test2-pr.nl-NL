...
---
# <a name="automate-mobility-service-installation-by-using-software-deployment-tools"></a>Automate Mobility Service installation by using software deployment tools
...
## <a name="deploy-mobility-service-on-computers-running-windows"></a>Deploy Mobility Service on computers running Windows
> [!NOTE]
...
### <a name="step-1-prepare-for-deployment"></a>Step 1: Prepare for deployment
...
### <a name="step-2-create-a-package"></a>Step 2: Create a package
...
### <a name="step-3-deploy-the-package"></a>Step 3: Deploy the package
1. In the Configuration Manager console, right-click your package, and select **Distribute Content**.
  ![Screenshot of Configuration Manager console](https://docstestmedia1.blob.core.windows.net/azure-media/articles/site-recovery/media/site-recovery-install-mobility-service-using-sccm/sccm_distribute.png)
...
4. After the package distribution is done, right-click the package, and select **Deploy**.
  ![Screenshot of Configuration Manager console](https://docstestmedia1.blob.core.windows.net/azure-media/articles/site-recovery/media/site-recovery-install-mobility-service-using-sccm/sccm_deploy.png)
...
## <a name="deploy-mobility-service-on-computers-running-linux"></a>Deploy Mobility Service on computers running Linux
> [!NOTE]
> This article assumes that the IP address of the configuration server is 192.168.3.121, and that the secure network file share is \\\ContosoSecureFS\MobilityServiceInstallers.
...
9. On the next page, select **This program can run on any platform**.
  ![Screenshot of Create Package and Program wizard](https://docstestmedia1.blob.core.windows.net/azure-media/articles/site-recovery/media/site-recovery-install-mobility-service-using-sccm/sccm-program-properties-page2-linux.png)
...
## <a name="other-methods-to-install-mobility-service"></a>Other methods to install Mobility Service
...
## <a name="uninstall-mobility-service"></a>Uninstall Mobility Service
