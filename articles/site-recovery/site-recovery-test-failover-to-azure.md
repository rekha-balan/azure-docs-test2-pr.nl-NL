...
### <a name="failover-timing"></a>Failover timing
...
## <a name="create-a-network-for-test-failover"></a>Create a network for test failover
...
## <a name="test-failover-to-a-production-network-in-the-recovery-site"></a>Test failover to a production network in the recovery site
