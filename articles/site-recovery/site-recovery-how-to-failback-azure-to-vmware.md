...
---
# <a name="fail-back-from-azure-to-an-on-premises-site"></a>Fail back from Azure to an on-premises site
...
## <a name="overview-of-failback"></a>Overview of failback
...
### <a name="fail-back-to-the-original-or-alternate-location"></a>Fail back to the original or alternate location
...
#### <a name="original-location-recovery"></a>Original location recovery
...
#### <a name="alternate-location-recovery"></a>Alternate location recovery
...
## <a name="have-you-completed-reprotection"></a>Have you completed reprotection?
...
## <a name="steps-to-fail-back"></a>Steps to fail back
...
### <a name="to-what-recovery-point-can-i-fail-back-the-virtual-machines"></a>To what recovery point can I fail back the virtual machines?
...
### <a name="reprotect-from-on-premises-to-azure"></a>Reprotect from on-premises to Azure
