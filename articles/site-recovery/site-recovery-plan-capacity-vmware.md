...
---
# <a name="plan-capacity-and-scaling-for-vmware-replication-with-azure-site-recovery"></a>Plan capacity and scaling for VMware replication with Azure Site Recovery
...
## <a name="how-do-i-start-capacity-planning"></a>How do I start capacity planning?
...
## <a name="control-network-bandwidth"></a>Control network bandwidth
...
### <a name="influence-network-bandwidth-for-a-vm"></a>Influence network bandwidth for a VM
