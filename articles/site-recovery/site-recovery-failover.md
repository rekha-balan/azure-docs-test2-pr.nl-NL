...
## <a name="time-taken-for-failover-to-azure"></a>Time taken for failover to Azure
...
## <a name="post-failover-considerations"></a>Post failover considerations
Post failover you might want to consider the following recommendations:
### <a name="retaining-drive-letter-after-failover"></a>Retaining drive letter after failover
