...
---
# <a name="deploy-the-mobility-service-with-azure-automation-dsc-for-replication-of-vm"></a>Deploy the Mobility service with Azure Automation DSC for replication of VM
