...
---
# <a name="replicate-a-multi-tier-iis-based-web-application"></a>Replicate a multi-tier IIS-based web application
...
### <a name="add-virtual-machines-to-failover-groups"></a>Add virtual machines to failover groups
...
### <a name="add-a-script-to-the-recovery-plan"></a>Add a script to the recovery plan
...
#### <a name="update-the-load-balancer-ip-address"></a>Update the load balancer IP address
...
#### <a name="ssl-certificate-binding-for-an-https-connection"></a>SSL certificate binding for an HTTPS connection
...
#### <a name="update-the-dependency-between-the-web-tier-and-the-application-tier"></a>Update the dependency between the web tier and the application tier
