...
## <a name="customize-and-extend-recovery-plans"></a>Customize and extend recovery plans
...
## <a name="add-scripts"></a>Add scripts
...
## <a name="add-a-script-or-manual-action-to-a-plan"></a>Add a script or manual action to a plan
...
### <a name="vmm-script"></a>VMM script
