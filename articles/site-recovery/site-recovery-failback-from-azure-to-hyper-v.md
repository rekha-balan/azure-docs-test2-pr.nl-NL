...
---
# <a name="failback-in-site-recovery-for-hyper-v-virtual-machines"></a>Failback in Site Recovery for Hyper-V virtual machines
...
## <a name="why-is-there-no-button-called-failback"></a>Why is there no button called failback?
...
## <a name="why-is-there-only-a-planned-failover-gesture-to-failback"></a>Why is there only a planned failover gesture to failback?
...
## <a name="initiate-failback"></a>Initiate failback
