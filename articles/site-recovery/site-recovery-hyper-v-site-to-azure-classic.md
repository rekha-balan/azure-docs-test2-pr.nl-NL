...
---
# <a name="replicate-between-on-premises-hyper-v-virtual-machines-and-azure-without-vmm-with-azure-site-recovery"></a>Replicate between on-premises Hyper-V virtual machines and Azure (without VMM) with Azure Site Recovery
...
Azure has two different [deployment models](../resource-manager-deployment-model.md) for creating and working with resources – Azure Resource Manager and classic. Azure also has two portals – the Azure classic portal, and the Azure portal.
...
## <a name="site-recovery-in-your-business"></a>Site Recovery in your business
...
## <a name="virtual-machine-prerequisites"></a>Virtual machine prerequisites
...
## <a name="provider-and-agent-prerequisites"></a>Provider and agent prerequisites
...
## <a name="step-2-create-a-hyper-v-site"></a>Step 2: Create a Hyper-V site
...
## <a name="step-3-install-the-provider-and-agent"></a>Step 3: Install the Provider and agent
...
### <a name="install-the-provider-from-the-command-line"></a>Install the Provider from the command line
...
## <a name="step-5-create-and-configure-protection-groups"></a>Step 5: Create and configure protection groups
...
## <a name="step-6-enable-virtual-machine-protection"></a>Step 6: Enable virtual machine protection
...
## <a name="step-7-create-a-recovery-plan"></a>Step 7: Create a recovery plan
...
## <a name="step-8-test-the-deployment"></a>Step 8: Test the deployment
