...
---
# <a name="customizing-media-encoder-standard-presets"></a>Customizing Media Encoder Standard presets
...
### <a name="original-preset"></a>Original preset
...
### <a name="customized-preset"></a>Customized preset
