...
---
# <a name="live-streaming-with-on-premises-encoders-that-create-multi-bitrate-streams"></a>Live streaming with on-premises encoders that create multi-bitrate streams
...
### <a name="channel-managed-programs"></a>Channel-managed programs
