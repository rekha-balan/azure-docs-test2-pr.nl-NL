...
---
# <a name="creating-filters-with-azure-media-services-rest-api"></a>Creating Filters with Azure Media Services REST API
...
## <a name="create-filters"></a>Create filters
### <a name="create-global-filters"></a>Create global Filters
...
### <a name="create-local-assetfilters"></a>Create local AssetFilters
...
### <a name="get-all-global-filters-in-the-ams-account"></a>Get all global **Filter**s in the AMS account
...
### <a name="get-assetfilters-associated-with-an-asset"></a>Get **AssetFilter**s associated with an asset
#### <a name="http-request"></a>HTTP Request
...
### <a name="get-an-assetfilter-based-on-its-id"></a>Get an **AssetFilter** based on its Id
#### <a name="http-request"></a>HTTP Request
...
## <a name="update-filters"></a>Update filters
...
### <a name="update-global-filters"></a>Update global Filters
...
### <a name="update-local-assetfilters"></a>Update local AssetFilters
...
## <a name="delete-filters"></a>Delete filters
### <a name="delete-global-filters"></a>Delete global Filters
...
### <a name="delete-local-assetfilters"></a>Delete local AssetFilters
