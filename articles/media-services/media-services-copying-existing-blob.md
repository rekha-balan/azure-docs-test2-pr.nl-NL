...
### <a name="copy-blobs-from-some-storage-account-into-a-new-asset-in-a-ams-account"></a>Copy blobs from some storage account into a new asset in a AMS account
