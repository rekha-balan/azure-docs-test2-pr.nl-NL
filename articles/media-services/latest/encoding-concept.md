...
---
# <a name="encoding-with-azure-media-services"></a>Encoding with Azure Media Services
...
## <a name="built-in-presets"></a>Built-in presets
...
## <a name="custom-presets"></a>Custom presets
...
## <a name="scaling-encoding-in-v3"></a>Scaling encoding in v3
