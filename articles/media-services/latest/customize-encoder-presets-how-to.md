...
---
# <a name="how-to-encode-with-a-custom-transform"></a>How to encode with a custom Transform
...
## <a name="create-a-transform-with-a-custom-preset"></a>Create a transform with a custom preset 
