...
---
# <a name="quickstart-stream-video-files---net"></a>Quickstart: Stream video files - .NET
...
## <a name="test-with-azure-media-player"></a>Test with Azure Media Player
...
## <a name="examine-the-code"></a>Examine the code
