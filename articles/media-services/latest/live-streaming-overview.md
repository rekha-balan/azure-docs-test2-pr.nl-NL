...
---
# <a name="live-streaming-with-azure-media-services-v3"></a>Live streaming with Azure Media Services v3
...
## <a name="overview-of-main-components"></a>Overview of main components
...
## <a name="liveevent-types-comparison"></a>LiveEvent types comparison 
...
## <a name="liveevent-states"></a>LiveEvent states 
