...
---
# <a name="migrate-from-media-services-v2-to-v3"></a>Migrate from Media Services v2 to v3
...
## <a name="why-should-you-move-to-v3"></a>Why should you move to v3?

### <a name="api-is-more-approachable"></a>API is more approachable
...
## <a name="changes-from-v2"></a>Changes from v2
...
### <a name="create-an-asset-and-upload-a-file"></a>Create an asset and upload a file 
...
### <a name="publish-an-asset-with-aes-encryption"></a>Publish an asset with AES encryption 
