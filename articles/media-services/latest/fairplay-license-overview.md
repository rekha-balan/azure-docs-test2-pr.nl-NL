...
---
# <a name="apple-fairplay-license-requirements-and-configuration"></a>Apple FairPlay license requirements and configuration 
...
## <a name="fairplay-and-player-apps"></a>FairPlay and player apps
...
## <a name="fairplay-configuration-net-example"></a>FairPlay configuration .NET example
