...
## <a name="configure-your-widevine-license-with-net"></a>Configure your Widevine license with .NET 
...
### <a name="directly-construct-a-json-string"></a>Directly construct a JSON string
...
#### <a name="define-classes"></a>Define classes
...
#### <a name="configure-the-license"></a>Configure the license
