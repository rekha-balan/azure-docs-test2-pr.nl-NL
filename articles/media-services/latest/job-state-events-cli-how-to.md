...
---
# <a name="route-azure-media-services-events-to-a-custom-web-endpoint-using-cli"></a>Route Azure Media Services events to a custom web endpoint using CLI
...
## <a name="enable-event-grid-resource-provider"></a>Enable Event Grid resource provider
...
## <a name="create-a-generic-azure-function-webhook"></a>Create a generic Azure Function webhook 
...
### <a name="validate-the-webhook"></a>Validate the webhook
...
#### <a name="update-the-source-code"></a>Update the source code
...
#### <a name="update-test-request-body"></a>Update test request body
...
## <a name="register-for-the-event-grid-subscription"></a>Register for the Event Grid subscription 
...
## <a name="test-the-events"></a>Test the events
