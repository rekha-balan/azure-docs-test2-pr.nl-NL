...
---
# <a name="design-of-a-multi-drm-content-protection-system-with-access-control"></a>Design of a multi-DRM content protection system with access control 
...
### <a name="goals-of-the-article"></a>Goals of the article
...
## <a name="map-design-to-technology-for-implementation"></a>Map design to technology for implementation
...
### <a name="some-issues-in-implementation"></a>Some issues in implementation
...
### <a name="what-is-azure-active-directory-signing-key-rollover"></a>What is Azure Active Directory signing key rollover?
...
### <a name="what-about-license-servers-outside-media-services"></a>What about license servers outside Media Services?
...
### <a name="use-encrypted-media-extensions-for-playready"></a>Use Encrypted Media Extensions for PlayReady
...
#### <a name="use-eme-for-widevine"></a>Use EME for Widevine
...
#### <a name="use-eme-for-fairplay"></a>Use EME for FairPlay
...
### <a name="unentitled-users"></a>Unentitled users
...
### <a name="run-a-custom-security-token-service"></a>Run a custom security token service
