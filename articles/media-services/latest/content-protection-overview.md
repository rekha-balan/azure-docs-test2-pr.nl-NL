...
---
# <a name="content-protection-overview"></a>Content protection overview
...
## <a name="main-components-of-the-content-protection-system"></a>Main components of the content protection system
...
## <a name="streaming-protocols-and-encryption-types"></a>Streaming protocols and encryption types
...
## <a name="storage-side-encryption"></a>Storage side encryption
...
## <a name="control-content-access"></a>Control content access
...
## <a name="a-idfaqfrequently-asked-questions"></a><a id="faq"/>Frequently asked questions
