...
## <a name="basic-streaming-license-example"></a>Basic streaming license example
...
### <a name="configure-playready-license-template-with-net"></a>Configure PlayReady license template with .NET
