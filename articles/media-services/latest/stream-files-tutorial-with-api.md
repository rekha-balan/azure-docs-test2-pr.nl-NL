...
---
# <a name="tutorial-upload-encode-and-stream-videos-using-apis"></a>Tutorial: Upload, encode, and stream videos using APIs
...
## <a name="examine-the-code-that-uploads-encodes-and-streams"></a>Examine the code that uploads, encodes, and streams
...
### <a name="create-an-output-asset-to-store-the-result-of-a-job"></a>Create an output asset to store the result of a job 
...
### <a name="create-a-transform-and-a-job-that-encodes-the-uploaded-file"></a>Create a Transform and a Job that encodes the uploaded file
...
### <a name="get-a-streaminglocator"></a>Get a StreamingLocator
...
### <a name="get-streaming-urls"></a>Get streaming URLs
