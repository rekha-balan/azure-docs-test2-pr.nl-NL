...
---
# <a name="use-aes-128-dynamic-encryption-and-the-key-delivery-service"></a>Use AES-128 dynamic encryption and the key delivery service
...
## <a name="get-or-create-an-encoding-transform"></a>Get or create an encoding Transform
...
## <a name="submit-job"></a>Submit Job
...
## <a name="create-a-contentkeypolicy"></a>Create a ContentKeyPolicy
...
## <a name="build-a-dash-streaming-url"></a>Build a DASH streaming URL
