...
---
# <a name="tutorial-upload-encode-and-stream-videos-with-rest"></a>Tutorial: Upload, encode, and stream videos with REST
...
## <a name="download-postman-files"></a>Download Postman files
...
## <a name="configure-postman"></a>Configure Postman

This section configures the Postman.

### <a name="configure-the-environment"></a>Configure the environment 
...
### <a name="configure-the-collection"></a>Configure the collection
...
## <a name="send-requests-using-postman"></a>Send requests using Postman
...
### <a name="get-azure-ad-token"></a>Get Azure AD Token 
...
### <a name="create-an-output-asset"></a>Create an output asset
...
### <a name="create-a-transform"></a>Create a transform
...
### <a name="create-a-streaming-locator"></a>Create a streaming locator
...
### <a name="list-paths-and-build-streaming-urls"></a>List paths and build streaming URLs

#### <a name="list-paths"></a>List paths
...
#### <a name="build-the-streaming-urls"></a>Build the streaming URLs
...
## <a name="test-the-streaming-url"></a>Test the streaming URL
...
## <a name="clean-up-resources-in-your-media-services-account"></a>Clean up resources in your Media Services account
