...
---
# <a name="stream-live-with-azure-media-services-v3-using-net-core"></a>Stream live with Azure Media Services v3 using .NET Core
...
## <a name="examine-the-code-that-performs-live-streaming"></a>Examine the code that performs live streaming
...
### <a name="create-a-live-event"></a>Create a live event
...
### <a name="get-the-preview-url"></a>Get the preview URL
...
### <a name="create-and-manage-liveevents-and-liveoutputs"></a>Create and manage LiveEvents and LiveOutputs
...
#### <a name="create-a-liveoutput"></a>Create a LiveOutput
...
#### <a name="create-a-streaminglocator"></a>Create a StreamingLocator
...
### <a name="cleaning-up-resources-in-your-media-services-account"></a>Cleaning up resources in your Media Services account
