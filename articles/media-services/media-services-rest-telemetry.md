...
---
# <a name="configuring-azure-media-services-telemetry-with-rest"></a>Configuring Azure Media Services telemetry with REST
...
## <a name="get-the-storage-account-associated-with-a-media-services-account"></a>Get the storage account associated with a Media Services account
...
## <a name="get-the-notification-endpoints"></a>Get the Notification Endpoints
...
## <a name="create-a-notification-endpoint-for-monitoring"></a>Create a Notification Endpoint for monitoring
...
## <a name="get-the-monitoring-configurations"></a>Get the monitoring configurations
...
## <a name="add-a-monitoring-configuration"></a>Add a monitoring configuration
...
## <a name="stop-telemetry"></a>Stop telemetry
