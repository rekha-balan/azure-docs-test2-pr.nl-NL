...
---
# <a name="use-azure-webhooks-to-monitor-media-services-job-notifications-with-net"></a>Use Azure WebHooks to monitor Media Services job notifications with .NET
...
## <a name="setting-up-webhook-notification-azure-functions"></a>Setting up "webhook notification" Azure functions
...
### <a name="function-output"></a>Function output
...
## <a name="adding-webhook-to-your-encoding-task"></a>Adding Webhook to your encoding task
