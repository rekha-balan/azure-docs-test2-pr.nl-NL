...
---
# <a name="managing-media-services-entities-with-rest"></a>Managing Media Services entities with REST 
...
## <a name="considerations-when-working-with-ams-rest"></a>Considerations when working with AMS REST
