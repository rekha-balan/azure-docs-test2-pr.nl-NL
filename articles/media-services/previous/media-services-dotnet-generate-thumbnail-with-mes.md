...
## <a name="example-of-a-single-png-file-preset"></a>Example of a "single PNG file" preset
...
## <a name="example-of-a-series-of-jpeg-images-preset"></a>Example of a "series of JPEG images" preset
...
## <a name="example-of-a-one-image-at-a-specific-timestamp-preset"></a>Example of a "one image at a specific timestamp" preset
...
## <a name="example-of-a-thumbnails-at-different-resolutions-preset"></a>Example of a "thumbnails at different resolutions" preset
...
## <a name="example-of-generating-a-thumbnail-while-encoding"></a>Example of generating a thumbnail while encoding
