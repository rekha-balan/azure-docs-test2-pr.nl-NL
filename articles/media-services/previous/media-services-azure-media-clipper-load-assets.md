...
---
# <a name="loading-assets-into-azure-media-clipper"></a>Loading assets into Azure Media Clipper
...
## <a name="statically-load-videos-into-clipper"></a>Statically load videos into Clipper
...
## <a name="dynamically-load-videos-in-clipper"></a>Dynamically load videos in Clipper
