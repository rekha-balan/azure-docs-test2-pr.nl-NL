...
---
# <a name="use-azure-ad-authentication-to-access-azure-media-services-api-with-net"></a>Use Azure AD authentication to access Azure Media Services API with .NET
...
## <a name="get-an-azure-ad-access-token"></a>Get an Azure AD access token
...
## <a name="install-and-configure-azure-media-services-net-sdk"></a>Install and configure Azure Media Services .NET SDK
...
## <a name="use-user-authentication"></a>Use user authentication
...
## <a name="use-service-principal-authentication"></a>Use service principal authentication
