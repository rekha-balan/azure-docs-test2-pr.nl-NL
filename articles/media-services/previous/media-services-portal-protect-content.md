...
---
# <a name="configure-content-protection-policies-by-using-the-azure-portal"></a>Configure content protection policies by using the Azure portal
...
## <a name="start-to-configure-content-protection"></a>Start to configure content protection
...
### <a name="token-authorization"></a>Token authorization
...
## <a name="playready-license-template"></a>PlayReady license template
...
## <a name="widevine-license-template"></a>Widevine license template
