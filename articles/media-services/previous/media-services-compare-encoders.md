...
---
# <a name="comparison-of-azure-on-demand-media-encoders"></a>Comparison of Azure on demand media encoders

This topic compares the encoding capabilities of **Media Encoder Standard** and **Media Encoder Premium Workflow**.

## <a name="video-and-audio-processing-capabilities"></a>Video and audio processing capabilities
