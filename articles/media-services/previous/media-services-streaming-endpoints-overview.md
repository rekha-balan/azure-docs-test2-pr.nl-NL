...
---
# <a name="streaming-endpoints-overview"></a>Streaming endpoints overview 
...
## <a name="streaming-types-and-versions"></a>Streaming types and versions

### <a name="standardpremium-types-version-20"></a>Standard/Premium types (version 2.0)
...
### <a name="classic-type-version-10"></a>Classic type (version 1.0)
...
## <a name="comparing-streaming-types"></a>Comparing streaming types
...
## <a name="migration-between-types"></a>Migration between types
