...
---
# <a name="offline-fairplay-streaming-for-ios"></a>Offline FairPlay Streaming for iOS 
...
## <a name="configuration-in-media-services"></a>Configuration in Media Services
...
## <a name="code-change-in-the-fairplay-configuration"></a>Code change in the FairPlay configuration
...
## <a name="code-change-in-the-asset-delivery-policy-configuration"></a>Code change in the asset delivery policy configuration
...
## <a name="sample-ios-player"></a>Sample iOS Player
...
* Sample code: HLSCatalog sample for FPS offline mode in the \FairPlay Streaming Server SDK version 3.1\Development\Client\HLSCatalog_With_FPS\HLSCatalog\. In the HLSCatalog sample app, the following code files are used to implement offline-mode features:
...
## <a name="integrated-test"></a>Integrated test
