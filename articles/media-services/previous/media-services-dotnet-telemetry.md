...
---
# <a name="configuring-azure-media-services-telemetry-with-net"></a>Configuring Azure Media Services telemetry with .NET
...
## <a name="configuring-telemetry-for-a-media-services-account"></a>Configuring telemetry for a Media Services account
