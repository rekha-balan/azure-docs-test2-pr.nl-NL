...
---
# <a name="configure-a-content-key-authorization-policy"></a>Configure a content key authorization policy
...
## <a name="configure-the-key-authorization-policy"></a>Configure the key authorization policy
