...
## <a name="a-idassetsassets-and-storage"></a><a id="assets"/>Assets and Storage
...
### <a name="program-event"></a>Program (event)
...
### <a name="a-iddynamicpackagingdynamic-packaging"></a><a id="dynamic_packaging"/>Dynamic packaging
