...
---
# <a name="media-services-operations-rest-api-overview"></a>Media Services operations REST API overview
...
## <a name="discover-and-browse-the-media-services-entity-model"></a>Discover and browse the Media Services entity model
...
## <a name="authenticate-with-media-services-rest-using-azure-active-directory"></a>Authenticate with Media Services REST using Azure Active Directory
