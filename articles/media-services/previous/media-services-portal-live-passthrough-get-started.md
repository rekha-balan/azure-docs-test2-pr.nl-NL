...
---
# <a name="how-to-perform-live-streaming-with-on-premises-encoders-using-the-azure-portal"></a>How to perform live streaming with on-premises encoders using the Azure portal
