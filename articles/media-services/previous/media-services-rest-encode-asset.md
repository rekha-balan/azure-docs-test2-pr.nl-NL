...
---
# <a name="how-to-encode-an-asset-by-using-media-encoder-standard"></a>How to encode an asset by using Media Encoder Standard
...
## <a name="create-a-job-by-using-a-jobtemplate"></a>Create a job by using a JobTemplate
...
## <a name="advanced-encoding-features-to-explore"></a>Advanced Encoding Features to explore
