...
---
# <a name="copying-existing-blobs-into-a-media-services-asset"></a>Copying existing blobs into a Media Services Asset
...
## <a name="copy-blobs-between-two-ams-accounts"></a>Copy blobs between two AMS accounts  
...
### <a name="copy-blobs-from-an-asset-in-one-ams-account-into-an-asset-in-another-ams-account"></a>Copy blobs from an asset in one AMS account into an asset in another AMS account
...
## <a name="copy-blobs-from-a-storage-account-into-an-ams-account"></a>Copy blobs from a storage account into an AMS account 
...
### <a name="copy-blobs-from-some-storage-account-into-a-new-asset-in-an-ams-account"></a>Copy blobs from some storage account into a new asset in an AMS account
