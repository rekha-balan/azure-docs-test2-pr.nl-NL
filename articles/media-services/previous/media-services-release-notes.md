...
## <a name="a-idissuescurrently-known-issues"></a><a id="issues"/>Currently known issues
### <a name="a-idgeneralissuesmedia-services-general-issues"></a><a id="general_issues"/>Media Services general issues
...
## <a name="a-idrestversionhistoryrest-api-version-history"></a><a id="rest_version_history"/>REST API version history
...
## <a name="a-idjulychanges16july-2016-release"></a><a id="july_changes16"/>July 2016 release
