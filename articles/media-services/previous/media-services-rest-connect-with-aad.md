...
---
# <a name="use-azure-ad-authentication-to-access-the-azure-media-services-api-with-rest"></a>Use Azure AD authentication to access the Azure Media Services API with REST
...
## <a name="get-the-authentication-information-from-the-azure-portal"></a>Get the authentication information from the Azure portal
...
### <a name="get-aad-auth-info-from-the-azure-portal"></a>Get AAD auth info from the Azure portal
...
## <a name="get-the-access-token-using-postman"></a>Get the access token using Postman
...
## <a name="test-the-assets-api-using-the-access-token"></a>Test the **Assets** API using the access token
