...
---
# <a name="upload-files-into-an-azure-media-services-account-from-azure-storsimple"></a>Upload files into an Azure Media Services account from Azure StorSimple
