...
---
# <a name="use-the-haivision-kb-live-encoder-to-send-a-single-bitrate-live-stream"></a>Use the Haivision KB live encoder to send a single bitrate live stream
...
## <a name="configure-the-haivision-kb-encoder"></a>Configure the Haivision KB encoder
