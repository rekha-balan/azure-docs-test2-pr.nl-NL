...
---
# <a name="use-playready-andor-widevine-dynamic-common-encryption"></a>Use PlayReady and/or Widevine dynamic common encryption
...
## <a name="configure-dynamic-common-encryption-and-drm-license-delivery-services"></a>Configure dynamic common encryption and DRM license delivery services
...
## <a name="encode-the-asset-that-contains-the-file-to-the-adaptive-bitrate-mp4-set"></a>Encode the asset that contains the file to the adaptive bitrate MP4 set
