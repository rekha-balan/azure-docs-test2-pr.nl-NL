...
---
# <a name="use-azure-media-content-moderator-to-detect-possible-adult-and-racy-content"></a>Use Azure Media Content Moderator to detect possible adult and racy content
...
## <a name="content-moderator-input-files"></a>Content Moderator input files
Video files. Currently, the following formats are supported: MP4, MOV, and WMV.

## <a name="content-moderator-output-files"></a>Content Moderator output files
...
### <a name="root-json-elements"></a>Root JSON elements
...
### <a name="fragments-json-elements"></a>Fragments JSON elements
...
### <a name="events-json-elements"></a>Events JSON elements
...
## <a name="content-moderation-quickstart-and-sample-output"></a>Content Moderation quickstart and sample output
...
### <a name="net-code-sample"></a>.NET code sample
