...
---
# <a name="embedding-an-mpeg-dash-adaptive-streaming-video-in-an-html5-application-with-dashjs"></a>Embedding an MPEG-DASH Adaptive Streaming Video in an HTML5 Application with DASH.js
