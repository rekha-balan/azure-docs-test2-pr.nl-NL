...
---
# <a name="sample-presets-for-media-encoder-standard-mes"></a>Sample Presets for Media Encoder Standard (MES)
...
### <a name="creating-custom-presets-from-samples"></a>Creating Custom Presets from Samples
...
#### <a name="video-rotation-default-setting-in-presets"></a>Video Rotation Default Setting in Presets:
...
## <a name="available-presets"></a>Available presets: 
