...
---
# <a name="get-started-with-delivering-content-on-demand-by-using-the-azure-portal"></a>Get started with delivering content on demand by using the Azure portal
...
## <a name="start-the-streaming-endpoint"></a>Start the streaming endpoint
...
### <a name="encode-assets-in-the-portal"></a>Encode assets in the portal
