...
---
# <a name="manage-streaming-endpoints-with-net-sdk"></a>Manage streaming endpoints with .NET SDK
...
###<a name="set-up-the-visual-studio-project"></a>Set up the Visual Studio project
...
###<a name="add-code-that-manages-streaming-endpoints"></a>Add code that manages streaming endpoints
