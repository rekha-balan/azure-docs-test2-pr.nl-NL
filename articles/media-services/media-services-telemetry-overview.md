...
## <a name="configuring-telemetry"></a>Configuring telemetry
...
## <a name="consuming-telemetry-information"></a>Consuming telemetry information
...
### <a name="telemetry-table-storage-output-schema"></a>Telemetry table storage output schema
...
### <a name="entity-specific-schema"></a>Entity-specific schema
...
### <a name="how-to-consume-metrics-data"></a>How to consume metrics data?
...
### <a name="how-to-find-average-bandwidth-consumption"></a>How to find average bandwidth consumption?

The average bandwidth consumption is the average of BytesSent over a span of time.

### <a name="how-to-define-streaming-unit-count"></a>How to define streaming unit count?
...
### <a name="how-to-find-average-requestssecond"></a>How to find average requests/second?

To find the average number of requests/second, compute the average number of requests (RequestCount) over a span of time.

### <a name="how-to-define-channel-health"></a>How to define channel health?
...
### <a name="how-to-detect-discontinuities"></a>How to detect discontinuities?
...
### <a name="how-to-detect-timestamp-overlaps"></a>How to detect timestamp overlaps?
...
### <a name="how-to-find-streaming-request-failures-and-reasons"></a>How to find streaming request failures and reasons?
...
### <a name="how-to-consume-data-with-external-tools"></a>How to consume data with external tools?
...
### <a name="how-to-manage-data-retention"></a>How to manage data retention?
