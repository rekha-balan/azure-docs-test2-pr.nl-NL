...
---
# <a name="use-visual-studio-code-to-develop-and-debug-c-modules-for-azure-iot-edge"></a>Use Visual Studio Code to develop and debug C# modules for Azure IoT Edge
...
## <a name="create-a-new-solution-with-c-module"></a>Create a new solution with C# module
...
## <a name="launch-and-debug-module-code-without-container"></a>Launch and debug module code without container
...
### <a name="setup-iot-edge-simulator-for-single-module-app"></a>Setup IoT Edge simulator for single module app
...
### <a name="build-module-app-and-debug-in-launch-mode"></a>Build module app and debug in launch mode
...
## <a name="build-module-container-for-debugging-and-debug-in-attach-mode"></a>Build module container for debugging and debug in attach mode
...
### <a name="setup-iot-edge-simulator-for-iot-edge-solution"></a>Setup IoT Edge simulator for IoT Edge solution
