...
---
# <a name="use-visual-studio-code-to-debug-multiple-modules-with-azure-iot-edge"></a>Use Visual Studio Code to debug multiple modules with Azure IoT Edge
...
## <a name="multi-target-and-remote-debugging-in-vs-code"></a>Multi-target and remote debugging in VS Code
...
### <a name="build-your-iot-edge-modules-for-debugging-purpose"></a>Build your IoT Edge modules for debugging purpose
...
### <a name="start-debugging-c-function-in-vs-code"></a>Start debugging C# Function in VS Code
...
### <a name="start-debugging-c-module-at-the-same-time-in-vs-code"></a>Start debugging C# module at the same time in VS Code
...
### <a name="see-variables-in-multiple-debugging-windows"></a>See variables in multiple debugging windows
...
Once you have your module built, learn how to [Deploy Azure IoT Edge modules from Visual Studio Code](how-to-deploy-modules-vscode.md) 0
