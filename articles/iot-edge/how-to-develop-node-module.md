...
---
# <a name="use-visual-studio-code-to-develop-and-debug-nodejs-modules-for-azure-iot-edge"></a>Use Visual Studio Code to develop and debug Node.js modules for Azure IoT Edge
...
### <a name="debug-nodejs-module-in-launch-mode"></a>Debug Node.js module in launch mode
