...
---
# <a name="deploy-azure-iot-edge-modules-with-azure-cli-20"></a>Deploy Azure IoT Edge modules with Azure CLI 2.0
...
## <a name="deploy-to-your-device"></a>Deploy to your device
