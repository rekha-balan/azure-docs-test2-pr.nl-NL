...
## <a name="build-and-deploy-your-module-for-debugging"></a>Build and deploy your module for debugging
...
## <a name="start-debugging-c-module-in-vs-code"></a>Start debugging C module in VS Code
