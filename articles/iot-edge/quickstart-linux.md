...
---
# <a name="quickstart-deploy-your-first-iot-edge-module-to-a-linux-x64-device"></a>Quickstart: Deploy your first IoT Edge module to a Linux x64 device
...
## <a name="register-an-iot-edge-device"></a>Register an IoT Edge device
...
## <a name="install-and-start-the-iot-edge-runtime"></a>Install and start the IoT Edge runtime
...
### <a name="register-your-device-to-use-the-software-repository"></a>Register your device to use the software repository
...
### <a name="install-a-container-runtime"></a>Install a container runtime
...
### <a name="install-and-configure-the-iot-edge-security-daemon"></a>Install and configure the IoT Edge security daemon
...
### <a name="view-the-iot-edge-runtime-status"></a>View the IoT Edge runtime status
...
## <a name="deploy-a-module"></a>Deploy a module
...
### <a name="delete-azure-resources"></a>Delete Azure resources
...
### <a name="remove-the-iot-edge-runtime"></a>Remove the IoT Edge runtime
