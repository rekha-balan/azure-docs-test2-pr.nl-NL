...
---
# <a name="quickstart-deploy-your-first-iot-edge-module-from-the-azure-portal-to-a-windows-device---preview"></a>Quickstart: Deploy your first IoT Edge module from the Azure portal to a Windows device - preview
...
### <a name="download-and-install-the-iot-edge-service"></a>Download and install the IoT Edge service
...
### <a name="configure-the-iot-edge-runtime"></a>Configure the IoT Edge runtime 
