...
---
# <a name="install-azure-iot-edge-runtime-on-windows-to-use-with-windows-containers"></a>Install Azure IoT Edge runtime on Windows to use with Windows containers
...
### <a name="install-and-manually-provision"></a>Install and manually provision
...
### <a name="install-and-automatically-provision"></a>Install and automatically provision
