...
---
# <a name="use-visual-studio-code-to-develop-and-debug-azure-functions-for-azure-iot-edge"></a>Use Visual Studio Code to develop and debug Azure functions for Azure IoT Edge
...
## <a name="build-your-module-for-debugging"></a>Build your module for debugging
...
## <a name="start-debugging-c-functions-in-vs-code"></a>Start debugging C# functions in VS Code
