...
---
# <a name="tutorial-deploy-azure-functions-as-iot-edge-modules-preview"></a>Tutorial: Deploy Azure functions as IoT Edge modules (preview)
...
## <a name="view-your-container-image"></a>View your container image
