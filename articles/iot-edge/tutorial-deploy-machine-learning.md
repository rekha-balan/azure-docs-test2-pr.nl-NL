...
---
# <a name="tutorial-deploy-azure-machine-learning-as-an-iot-edge-module-preview"></a>Tutorial: Deploy Azure Machine Learning as an IoT Edge module (preview)
...
### <a name="disable-process-identification"></a>Disable process identification
...
## <a name="create-the-azure-ml-container"></a>Create the Azure ML container
...
### <a name="view-the-container-repository"></a>View the container repository
...
### <a name="view-data-on-your-iot-edge-device"></a>View data on your IoT Edge device
...
### <a name="view-data-arriving-at-your-iot-hub"></a>View data arriving at your IoT hub
