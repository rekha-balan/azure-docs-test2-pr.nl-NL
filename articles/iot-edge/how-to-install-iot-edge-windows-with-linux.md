...
---
# <a name="install-azure-iot-edge-runtime-on-windows-to-use-with-linux-containers"></a>Install Azure IoT Edge runtime on Windows to use with Linux containers
