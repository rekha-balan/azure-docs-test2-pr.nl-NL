...
---
# <a name="tutorial-deploy-azure-stream-analytics-as-an-iot-edge-module-preview"></a>Tutorial: Deploy Azure Stream Analytics as an IoT Edge module (preview)
...
## <a name="create-an-azure-stream-analytics-job"></a>Create an Azure Stream Analytics job
...
### <a name="create-a-new-job"></a>Create a new job
...
### <a name="configure-your-job"></a>Configure your job
...
### <a name="configure-iot-edge-settings"></a>Configure IoT Edge settings
...
## <a name="deploy-the-job"></a>Deploy the job
