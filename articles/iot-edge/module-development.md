...
---
# <a name="understand-the-requirements-and-tools-for-developing-iot-edge-modules"></a>Understand the requirements and tools for developing IoT Edge modules
...
## <a name="packaging-as-an-image"></a>Packaging as an image
