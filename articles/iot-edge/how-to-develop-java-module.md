...
---
# <a name="use-visual-studio-code-to-develop-and-debug-java-modules-for-azure-iot-edge"></a>Use Visual Studio Code to develop and debug Java modules for Azure IoT Edge
...
### <a name="debug-java-module-in-launch-mode"></a>Debug Java module in launch mode
