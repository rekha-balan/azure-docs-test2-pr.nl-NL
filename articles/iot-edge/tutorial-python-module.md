...
---
# <a name="tutorial-develop-and-deploy-a-python-iot-edge-module-to-your-simulated-device"></a>Tutorial: Develop and deploy a Python IoT Edge module to your simulated device
...
### <a name="delete-local-resources"></a>Delete local resources
