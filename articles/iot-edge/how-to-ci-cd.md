...
## <a name="create-a-sample-azure-iot-edge-solution-using-visual-studio-code"></a>Create a sample Azure IoT Edge solution using Visual Studio Code
...
## <a name="continuous-deployment-to-iot-edge-devices"></a>Continuous deployment to IoT Edge devices
