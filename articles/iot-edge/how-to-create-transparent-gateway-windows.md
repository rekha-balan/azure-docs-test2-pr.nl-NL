...
---
# <a name="create-a-windows-iot-edge-device-that-acts-as-a-transparent-gateway"></a>Create a Windows IoT Edge device that acts as a transparent gateway
...
1. Get OpenSSL for Windows. There are many ways you can install OpenSSL:
   ...
   >[!NOTE]
   >If you already have OpenSSL installed on your Windows device, you may skip this step but please ensure that  `openssl.exe` is available in your `%PATH%` environment variable.
...
## <a name="certificate-creation"></a>Certificate creation
...
## <a name="certificate-chain-creation"></a>Certificate chain creation
...
## <a name="installation-on-the-gateway"></a>Installation on the gateway
...
## <a name="installation-on-the-downstream-device"></a>Installation on the downstream device
...
### <a name="application-level"></a>Application level
...
## <a name="connect-the-downstream-device-to-the-gateway"></a>Connect the downstream device to the gateway
...
## <a name="routing-messages-from-downstream-devices"></a>Routing messages from downstream devices
