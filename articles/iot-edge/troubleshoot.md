...
---
# <a name="common-issues-and-resolutions-for-azure-iot-edge"></a>Common issues and resolutions for Azure IoT Edge
...
## <a name="standard-diagnostic-steps"></a>Standard diagnostic steps 
...
### <a name="view-the-messages-going-through-the-edge-hub"></a>View the messages going through the Edge hub
...
## <a name="edge-agent-stops-after-about-a-minute"></a>Edge Agent stops after about a minute
...
### <a name="root-cause"></a>Root cause
...
## <a name="edge-hub-fails-to-start"></a>Edge Hub fails to start
...
## <a name="edge-agent-cant-access-a-modules-image-403"></a>Edge Agent can't access a module's image (403)
