...
---
# <a name="learn-how-to-use-deployment-manifests-to-deploy-modules-and-establish-routes"></a>Learn how to use deployment manifests to deploy modules and establish routes
