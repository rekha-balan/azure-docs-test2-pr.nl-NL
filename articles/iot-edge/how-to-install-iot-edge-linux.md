...
---
# <a name="install-the-azure-iot-edge-runtime-on-linux-x64"></a>Install the Azure IoT Edge runtime on Linux (x64)
...
## <a name="configure-the-azure-iot-edge-security-daemon"></a>Configure the Azure IoT Edge Security Daemon
