...
---
# <a name="tutorial-store-data-at-the-edge-with-sql-server-databases"></a>Tutorial: Store data at the edge with SQL Server databases
...
## <a name="create-a-function-project"></a>Create a function project
...
## <a name="add-a-sql-server-container"></a>Add a SQL Server container
...
## <a name="deploy-the-solution-to-a-device"></a>Deploy the solution to a device
...
## <a name="create-the-sql-database"></a>Create the SQL database
...
## <a name="view-the-local-data"></a>View the local data
