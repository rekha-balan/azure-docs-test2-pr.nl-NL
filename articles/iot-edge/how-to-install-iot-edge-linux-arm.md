...
---
# <a name="install-azure-iot-edge-runtime-on-linux-arm32v7armhf"></a>Install Azure IoT Edge runtime on Linux (ARM32v7/armhf)
...
## <a name="install-the-iot-edge-security-daemon"></a>Install the IoT Edge Security Daemon
...
## <a name="connect-your-device-to-an-iot-hub"></a>Connect your device to an IoT hub 
...
## <a name="tips-and-suggestions"></a>Tips and suggestions
