...
2. Open the ToDoList solution in Visual Studio 2015 or 2013.
   ...
   1. You will need to trust each solution.
         ![Security Warning](https://docstestmedia1.blob.core.windows.net/azure-media/articles/app-service-api/media/app-service-api-dotnet-get-started/securitywarning.png)
