...
---
# <a name="tutorial-deploy-and-configure-azure-firewall-using-the-azure-portal"></a>Tutorial: Deploy and configure Azure Firewall using the Azure portal
...
## <a name="set-up-the-network-environment"></a>Set up the network environment
...
### <a name="create-a-vnet"></a>Create a VNet
...
### <a name="create-additional-subnets"></a>Create additional subnets
...
## <a name="deploy-the-firewall"></a>Deploy the firewall
...
## <a name="create-a-default-route"></a>Create a default route
...
## <a name="configure-application-rules"></a>Configure application rules
...
## <a name="configure-network-rules"></a>Configure network rules
...
### <a name="change-the-primary-and-secondary-dns-address-for-the-srv-work-network-interface"></a>Change the primary and secondary DNS address for the **Srv-Work** network interface
...
## <a name="test-the-firewall"></a>Test the firewall
