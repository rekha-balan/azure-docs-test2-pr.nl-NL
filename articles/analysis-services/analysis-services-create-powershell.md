...
---
# <a name="quickstart-create-a-server---powershell"></a>Quickstart: Create a server - PowerShell
...
## <a name="import-azurermanalysisservices-module"></a>Import AzureRm.AnalysisServices module
