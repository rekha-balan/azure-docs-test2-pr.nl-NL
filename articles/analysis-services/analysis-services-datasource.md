...
---
# <a name="data-sources-supported-in-azure-analysis-services"></a>Data sources supported in Azure Analysis Services
...
## <a name="azure-data-sources"></a>Azure data sources
...
### <a name="in-memory-and-directquery"></a>In-memory and DirectQuery
...
### <a name="in-memory-only"></a>In-memory only
...
## <a name="specifying-a-different-provider"></a>Specifying a different provider
