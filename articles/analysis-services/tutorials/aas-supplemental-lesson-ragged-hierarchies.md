...
---
# <a name="supplemental-lesson---ragged-hierarchies"></a>Supplemental lesson - Ragged hierarchies
...
## <a name="add-tables-and-objects"></a>Add tables and objects
  
### <a name="to-add-new-tables-to-your-model"></a>To add new tables to your model
...
## <a name="to-fix-the-ragged-hierarchy-by-setting-the-hide-members-property"></a>To fix the ragged hierarchy by setting the Hide members property
