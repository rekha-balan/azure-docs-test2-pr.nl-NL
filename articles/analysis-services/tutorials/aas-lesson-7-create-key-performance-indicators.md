...
---
# <a name="create-key-performance-indicators"></a>Create Key Performance Indicators
...
#### <a name="to-create-an-internetcurrentquartersalesperformance-kpi"></a>To create an InternetCurrentQuarterSalesPerformance KPI  
...
#### <a name="to-create-an-internetcurrentquartermarginperformance-kpi"></a>To create an InternetCurrentQuarterMarginPerformance KPI  
