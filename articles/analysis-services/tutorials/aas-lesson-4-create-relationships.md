...
---
# <a name="create-relationships"></a>Create relationships
...
## <a name="review-existing-relationships-and-add-new-relationships"></a>Review existing relationships and add new relationships  
...
#### <a name="to-review-existing-relationships"></a>To review existing relationships  
...
### <a name="take-a-closer-look"></a>Take a closer look
...
#### <a name="to-add-new-relationships-between-tables"></a>To add new relationships between tables  
