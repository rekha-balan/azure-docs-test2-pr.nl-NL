...
#### <a name="to-create-partitions-in-the-factinternetsales-table"></a>To create partitions in the FactInternetSales table  
...
#### <a name="to-create-a-partition-for-the-2011-year"></a>To create a partition for the 2011 year  
...
#### <a name="to-create-partitions-for-2012-2013-and-2014"></a>To create partitions for 2012, 2013, and 2014.  
...
## <a name="delete-the-factinternetsales-partition"></a>Delete the FactInternetSales partition
...
#### <a name="to-delete-the-factinternetsales-partition"></a>To delete the FactInternetSales partition
-  Click the FactInternetSales partition, and then click **Delete**.



## <a name="process-partitions"></a>Process partitions  
...
#### <a name="to-process-the-factinternetsales-partitions"></a>To process the FactInternetSales partitions  
