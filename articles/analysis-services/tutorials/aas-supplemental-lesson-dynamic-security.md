...
---
# <a name="supplemental-lesson---dynamic-security"></a>Supplemental lesson - Dynamic security
...
## <a name="add-the-dimsalesterritory-table-to-the-aw-internet-sales-tabular-model-project"></a>Add the DimSalesTerritory table to the AW Internet Sales Tabular Model Project  
...
#### <a name="to-add-the-dimsalesterritory-table"></a>To add the DimSalesTerritory table  
...
## <a name="add-a-table-with-user-name-data"></a>Add a table with user name data  
...
#### <a name="to-add-an-employeesecurity-table"></a>To add an EmployeeSecurity table  
...
## <a name="create-relationships-between-factinternetsales-dimgeography-and-dimsalesterritory-table"></a>Create relationships between FactInternetSales, DimGeography, and DimSalesTerritory table  
...
#### <a name="to-create-relationships-between-the-factinternetsales-dimgeography-and-the-dimsalesterritory-table"></a>To create relationships between the FactInternetSales, DimGeography, and the DimSalesTerritory table  
...
## <a name="hide-the-employeesecurity-table-from-client-applications"></a>Hide the EmployeeSecurity Table from client applications  
...
#### <a name="to-hide-the-employeesecurity-table-from-client-applications"></a>To hide the EmployeeSecurity table from client applications  
  
-   In the model designer, in Diagram View, right-click the **Employee** table heading, and then click **Hide from Client Tools**.  
  
## <a name="create-a-sales-employees-by-territory-user-role"></a>Create a Sales Employees by Territory user role  
...
#### <a name="to-create-a-sales-employees-by-territory-user-role"></a>To create a Sales Employees by Territory user role  
...
## <a name="test-the-sales-employees-by-territory-user-role"></a>Test the Sales Employees by Territory User Role  
...
#### <a name="to-test-the-sales-employees-by-territory-user-role"></a>To test the Sales Employees by Territory user role  
