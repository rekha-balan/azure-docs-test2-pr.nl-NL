...
---
# <a name="mark-as-date-table"></a>Mark as Date Table
...
### <a name="to-rename-the-fulldatealternatekey-column"></a>To rename the FullDateAlternateKey column
...
### <a name="to-set-mark-as-date-table"></a>To set Mark as Date Table  
