...
---
# <a name="create-measures"></a>Create measures
...
#### <a name="to-create-a-dayscurrentquartertodate-measure-in-the-dimdate-table"></a>To create a DaysCurrentQuarterToDate measure in the DimDate table  
...
#### <a name="to-create-a-daysincurrentquarter-measure-in-the-dimdate-table"></a>To create a DaysInCurrentQuarter measure in the DimDate table  
...
#### <a name="to-create-an-internetdistinctcountsalesorder-measure-in-the-factinternetsales-table"></a>To create an InternetDistinctCountSalesOrder measure in the FactInternetSales table  
...
#### <a name="to-create-additional-measures-in-the-factinternetsales-table"></a>To create additional measures in the FactInternetSales table  
