...
## <a name="create-a-connection"></a>Create a connection  
  
#### <a name="to-create-a-connection-to-the-adventureworksdw2014-database"></a>To create a connection to the AdventureWorksDW2014 database  
...
## <a name="filter-the-table-data"></a>Filter the table data  
...
#### <a name="to-filter-the-table-data-before-importing"></a>To filter the table data before importing  
...
#### <a name="to-import-the-selected-tables-and-column-data"></a>To import the selected tables and column data  
...
## <a name="save-your-model-project"></a>Save your model project  
It's important to frequently save your model project.  
  
#### <a name="to-save-the-model-project"></a>To save the model project  
