...
## <a name="deploy-the-model"></a>Deploy the model  
  
#### <a name="to-configure-deployment-properties"></a>To configure deployment properties  
...
#### <a name="to-deploy-the-adventure-works-internet-sales"></a>To deploy the Adventure Works Internet Sales
