...
---
# <a name="create-a-tabular-model-project"></a>Create a tabular model project
...
## <a name="create-a-new-tabular-model-project"></a>Create a new tabular model project  
  
#### <a name="to-create-a-new-tabular-model-project"></a>To create a new tabular model project  
...
## <a name="understanding-the-visual-studio-tabular-model-authoring-environment"></a>Understanding the Visual Studio tabular model authoring environment  
