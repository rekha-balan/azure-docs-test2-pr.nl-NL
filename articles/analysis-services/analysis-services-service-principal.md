...
---
# <a name="automation-with-service-principals"></a>Automation with service principals
...
## <a name="create-service-principals"></a>Create service principals
...
## <a name="store-credential-and-certificate-assets-in-azure-automation"></a>Store credential and certificate assets in Azure Automation
...
## <a name="add-service-principals-to-server-admin-role"></a>Add service principals to server admin role
...
## <a name="service-principals-in-connection-strings"></a>Service principals in connection strings
...
### <a name="amo-and-adomd"></a>AMO and ADOMD 
