...
---
# <a name="compatibility-level-for-analysis-services-tabular-models"></a>Compatibility level for Analysis Services tabular models
...
## <a name="set-compatibility-level"></a>Set compatibility level 
...
## <a name="check-compatibility-level-for-a-tabular-model-database-in-sql-server-management-studio"></a>Check compatibility level for a tabular model database in SQL Server Management Studio 
 In SSMS, right-click the database name > **Properties** > **Compatibility Level**.  
  
## <a name="check-supported-compatibility-level-for-a-server-in-ssms"></a>Check supported compatibility level for a server in SSMS  
