...
---
# <a name="use-gateway-for-data-sources-on-an-azure-virtual-network-vnet"></a>Use gateway for data sources on an Azure Virtual Network (VNet)
...
## <a name="server-access-to-vnet-data-sources"></a>Server access to VNet data sources
...
## <a name="configure-alwaysusegateway-property"></a>Configure AlwaysUseGateway property
