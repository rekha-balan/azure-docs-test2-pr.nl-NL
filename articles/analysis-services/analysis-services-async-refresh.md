...
---
# <a name="asynchronous-refresh-with-the-rest-api"></a>Asynchronous refresh with the REST API
...
### <a name="to-use-the-code-sample"></a>To use the code sample
...
#### <a name="interactive-login-or-usernamepassword"></a>Interactive login or username/password
