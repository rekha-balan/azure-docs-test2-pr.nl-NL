...
---
# <a name="setup-diagnostic-logging"></a>Setup diagnostic logging
...
## <a name="whats-logged"></a>What's logged?
...
## <a name="manage-your-logs"></a>Manage your logs
...
## <a name="view-logs-in-log-analytics"></a>View logs in Log Analytics
...
## <a name="tutorial---turn-on-logging-by-using-powershell"></a>Tutorial - Turn on logging by using PowerShell
...
### <a name="aconnect-to-your-subscriptions"></a></a>Connect to your subscriptions
...
### <a name="create-a-new-storage-account-for-your-logs"></a>Create a new storage account for your logs
...
### <a name="identify-the-server-account-for-your-logs"></a>Identify the server account for your logs
