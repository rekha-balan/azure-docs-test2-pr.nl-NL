...
---
# <a name="manage-database-roles-and-users"></a>Manage database roles and users
...
## <a name="to-add-or-manage-roles-and-users-in-ssdt"></a>To add or manage roles and users in SSDT  
...
## <a name="to-add-or-manage-roles-and-users-in-ssms"></a>To add or manage roles and users in SSMS
...
## <a name="to-add-roles-and-users-by-using-a-tmsl-script"></a>To add roles and users by using a TMSL script
...
## <a name="to-add-roles-and-users-by-using-powershell"></a>To add roles and users by using PowerShell
...
## <a name="row-filters"></a>Row filters  
