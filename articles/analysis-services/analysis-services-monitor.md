...
---
# <a name="monitor-server-metrics"></a>Monitor server metrics
...
## <a name="to-monitor-metrics-for-an-analysis-services-server"></a>To monitor metrics for an Analysis Services server
