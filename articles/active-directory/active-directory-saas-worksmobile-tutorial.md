...
---
# <a name="tutorial-azure-active-directory-integration-with-works-mobile"></a>Tutorial: Azure Active Directory integration with WORKS MOBILE
...
## <a name="add-works-mobile-from-the-gallery"></a>Add WORKS MOBILE from the gallery
...
10. To get SSO configured for your application, contact [WORKS MOBILE support team](mailto:dl_ssoinfo@worksmobile.com) and provide them with the following: •  The downloaded **Certificate file** •  The **SAML Single Sign-On Service URL** •  The **SAML Entity ID** •  The **Sign-Out URL**
...
### <a name="create-a-works-mobile-test-user"></a>Create a WORKS MOBILE test user
