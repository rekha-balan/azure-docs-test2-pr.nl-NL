...
---
# <a name="tutorial-azure-active-directory-integration-with-evernote"></a>Tutorial: Azure Active Directory integration with Evernote
...
## <a name="adding-evernote-from-the-gallery"></a>Adding Evernote from the gallery
...
### <a name="creating-an-evernote-test-user"></a>Creating an Evernote test user
