...
### <a name="azure-ad-connect-sync-service-account"></a>Azure AD Connect sync service account
...
#### <a name="group-managed-service-account"></a>Group managed service account
...
![VSA](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/connect/media/active-directory-aadconnect-accounts-permissions/serviceaccount.png)  
