...
---
# <a name="user-privacy-and-azure-active-directory-pass-through-authentication"></a>User Privacy and Azure Active Directory Pass-through Authentication
...
### <a name="delete-azure-ad-connect-trace-log-files"></a>Delete Azure AD Connect trace log files
...
### <a name="delete-authentication-agent-event-logs"></a>Delete Authentication Agent event logs
...
### <a name="delete-authentication-agent-trace-log-files"></a>Delete Authentication Agent trace log files
...
### <a name="note-about-domain-controller-logs"></a>Note about Domain controller logs
