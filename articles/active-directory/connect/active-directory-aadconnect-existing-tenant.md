...
---
# <a name="azure-ad-connect-when-you-have-an-existent-tenant"></a>Azure AD Connect: When you have an existent tenant
...
## <a name="sync-with-existing-users-in-azure-ad"></a>Sync with existing users in Azure AD
...
### <a name="other-objects-than-users"></a>Other objects than users
...
## <a name="create-a-new-on-premises-active-directory-from-data-in-azure-ad"></a>Create a new on-premises Active Directory from data in Azure AD
