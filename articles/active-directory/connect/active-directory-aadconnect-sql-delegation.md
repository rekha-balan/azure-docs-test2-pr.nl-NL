...
---
# <a name="install-azure-ad-connect-using-sql-delegated-administrator-permissions"></a>Install Azure AD Connect using SQL delegated administrator permissions
...
## <a name="steps-for-installing-azure-ad-connect-using-sql-delegated-permissions"></a>Steps for installing Azure AD Connect using SQL delegated permissions
