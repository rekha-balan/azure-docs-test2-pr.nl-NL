...
---
# <a name="azure-ad-connect-sync-service-shadow-attributes"></a>Azure AD Connect sync service shadow attributes
...
## <a name="introducing-shadow-attributes"></a>Introducing shadow attributes
...
### <a name="quarantined-attribute-values"></a>Quarantined attribute values
