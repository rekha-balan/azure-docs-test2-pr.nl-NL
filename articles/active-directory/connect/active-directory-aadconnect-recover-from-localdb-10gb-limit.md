...
---
# <a name="azure-ad-connect-how-to-recover-from-localdb-10-gb-limit"></a>Azure AD Connect: How to recover from LocalDB 10-GB limit
...
## <a name="short-term-recovery-steps"></a>Short-term recovery steps
...
### <a name="determine-the-synchronization-service-status"></a>Determine the Synchronization Service status
...
### <a name="shrink-the-database"></a>Shrink the database
...
### <a name="delete-run-history-data"></a>Delete run history data
...
### <a name="shorten-retention-period-for-run-history-data"></a>Shorten retention period for run history data
...
## <a name="long-term-solution--migrate-to-full-sql"></a>Long-term solution – Migrate to full SQL
