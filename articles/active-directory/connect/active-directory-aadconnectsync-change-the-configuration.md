...
---
# <a name="azure-ad-connect-sync-make-a-change-to-the-default-configuration"></a>Azure AD Connect sync: Make a change to the default configuration
...
### <a name="use-an-attribute-other-than-the-default"></a>Use an attribute other than the default
...
### <a name="convert-a-multi-value-attribute-to-single-value"></a>Convert a multi-value attribute to single value
...
## <a name="enable-synchronization-of-usertype"></a>Enable synchronization of UserType
...
### <a name="step-1-disable-the-sync-scheduler-and-verify-there-is-no-synchronization-in-progress"></a>Step 1: Disable the sync scheduler and verify there is no synchronization in progress
...
### <a name="step-2-add-the-source-attribute-to-the-on-premises-ad-connector-schema"></a>Step 2: Add the source attribute to the on-premises AD Connector schema
...
### <a name="step-3-add-the-usertype-to-the-azure-ad-connector-schema"></a>Step 3: Add the UserType to the Azure AD Connector schema
...
### <a name="step-4-create-an-inbound-synchronization-rule-to-flow-the-attribute-value-from-on-premises-active-directory"></a>Step 4: Create an inbound synchronization rule to flow the attribute value from on-premises Active Directory
...
### <a name="step-5-create-an-outbound-synchronization-rule-to-flow-the-attribute-value-to-azure-ad"></a>Step 5: Create an outbound synchronization rule to flow the attribute value to Azure AD
...
### <a name="step-6-run-a-full-synchronization-cycle"></a>Step 6: Run a full synchronization cycle
...
### <a name="step-7-re-enable-the-sync-scheduler"></a>Step 7: Re-enable the sync scheduler
