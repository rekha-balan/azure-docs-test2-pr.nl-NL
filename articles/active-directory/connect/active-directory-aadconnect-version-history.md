...
### <a name="fixed-issues"></a>Fixed issues  
...
### <a name="new-features-and-improvements"></a>New features and improvements
...
>[!NOTE]
>“AutoUpgrade functionality was incorrectly disabled for some tenants who deployed builds later than 1.1.524.0. To ensure that your Azure AD Connect instance is still eligible for AutoUpgrade, run the following PowerShell cmdlet: “Set-ADSyncAutoUpgrade -AutoupGradeState Enabled”
...
#### <a name="powershell-script-to-tighten-a-pre-existing-service-account"></a>PowerShell script to tighten a pre-existing service account
...
```
### <a name="was-this-vulnerability-used-to-gain-unauthorized-access"></a>Was this vulnerability used to gain unauthorized access?
...
### <a name="azure-ad-connect"></a>Azure AD Connect
#### <a name="fixed-issue"></a>Fixed issue
...
#### <a name="issues-fixed"></a>Issues fixed
