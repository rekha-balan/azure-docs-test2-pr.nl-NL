...
---
# <a name="what-is-azure-ad-pass-through-authentication"></a>What is Azure AD Pass-through Authentication
...
## <a name="supported-clients-in-the-preview"></a>Supported Clients in the preview
...
## <a name="how-azure-ad-pass-through-authentication-works"></a>How Azure AD Pass-through Authentication works
...
## <a name="azure-ad-pass-through-prerequisites"></a>Azure AD Pass-through prerequisites
...
## <a name="enabling-pass-through-authentication"></a>Enabling Pass-through authentication
...
### <a name="step-2-register-the-connector-with-azure-ad-for-pass-through-authentication"></a>Step 2: Register the Connector with Azure AD for pass-through authentication
...
## <a name="troubleshooting-pass-through-authentication"></a>Troubleshooting Pass-through authentication
