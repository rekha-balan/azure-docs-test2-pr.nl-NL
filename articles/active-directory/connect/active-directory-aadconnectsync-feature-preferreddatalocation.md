...
---
# <a name="azure-active-directory-connect-sync-configure-preferred-data-location-for-office-365-resources"></a>Azure Active Directory Connect sync: Configure preferred data location for Office 365 resources
...
## <a name="enable-synchronization-of-preferred-data-location"></a>Enable synchronization of preferred data location
...
### <a name="azure-ad-connect-support-for-synchronization"></a>Azure AD Connect support for synchronization
...
## <a name="step-2-add-the-source-attribute-to-the-on-premises-active-directory-connector-schema"></a>Step 2: Add the source attribute to the on-premises Active Directory Connector schema
...
## <a name="step-3-add-preferreddatalocation-to-the-azure-ad-connector-schema"></a>Step 3: Add **preferredDataLocation** to the Azure AD Connector schema
...
## <a name="step-4-create-an-inbound-synchronization-rule"></a>Step 4: Create an inbound synchronization rule
...
## <a name="step-5-create-an-outbound-synchronization-rule"></a>Step 5: Create an outbound synchronization rule
...
## <a name="step-6-run-full-synchronization-cycle"></a>Step 6: Run full synchronization cycle
...
## <a name="step-7-re-enable-sync-scheduler"></a>Step 7: Re-enable sync scheduler
...
## <a name="step-8-verify-the-result"></a>Step 8: Verify the result
