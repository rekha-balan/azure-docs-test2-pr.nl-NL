...
---
# <a name="user-privacy-and-azure-ad-connect"></a>User privacy and Azure AD Connect 
...
## <a name="delete-the-azure-ad-connect-installation-log-file-folder-contents"></a>Delete the Azure AD Connect installation log file folder contents
...
### <a name="schedule-this-script-to-run-every-48-hours"></a>Schedule this script to run every 48 hours
