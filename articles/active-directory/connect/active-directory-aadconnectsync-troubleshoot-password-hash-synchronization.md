...
---
# <a name="troubleshoot-password-hash-synchronization-with-azure-ad-connect-sync"></a>Troubleshoot password hash synchronization with Azure AD Connect sync
...
## <a name="no-passwords-are-synchronized-troubleshoot-by-using-the-troubleshooting-task"></a>No passwords are synchronized: troubleshoot by using the troubleshooting task
...
### <a name="run-the-troubleshooting-task"></a>Run the troubleshooting task
...
### <a name="understand-the-results-of-the-troubleshooting-task"></a>Understand the results of the troubleshooting task
...
#### <a name="password-hash-synchronization-feature-isnt-enabled"></a>password hash synchronization feature isn't enabled
...
#### <a name="azure-ad-connect-server-is-in-staging-mode"></a>Azure AD Connect server is in staging mode
...
#### <a name="no-password-hash-synchronization-heartbeat-events"></a>No password hash synchronization heartbeat events
...
#### <a name="ad-ds-account-does-not-have-correct-permissions"></a>AD DS account does not have correct permissions
...
#### <a name="incorrect-ad-ds-account-username-or-password"></a>Incorrect AD DS account username or password
...
## <a name="one-object-is-not-synchronizing-passwords-troubleshoot-by-using-the-troubleshooting-task"></a>One object is not synchronizing passwords: troubleshoot by using the troubleshooting task
...
### <a name="run-the-diagnostics-cmdlet"></a>Run the diagnostics cmdlet
...
#### <a name="the-active-directory-object-isnt-exported-to-azure-ad"></a>The Active Directory object isn't exported to Azure AD
...
#### <a name="user-has-a-temporary-password"></a>User has a temporary password
...
#### <a name="results-of-last-attempt-to-synchronize-password-arent-available"></a>Results of last attempt to synchronize password aren't available
...
## <a name="no-passwords-are-synchronized-troubleshoot-by-using-the-diagnostic-cmdlet"></a>No passwords are synchronized: troubleshoot by using the diagnostic cmdlet
...
## <a name="one-object-is-not-synchronizing-passwords-troubleshoot-by-using-the-diagnostic-cmdlet"></a>One object is not synchronizing passwords: troubleshoot by using the diagnostic cmdlet
...
## <a name="no-passwords-are-synchronized-manual-troubleshooting-steps"></a>No passwords are synchronized: manual troubleshooting steps
...
4. Look in the event log for errors. Look for the following events, which would indicate a problem:
    * Source: "Directory synchronization" ID: 0, 611, 652, 655 If you see these events, you have a connectivity problem. The event log message contains forest information where you have a problem. For more information, see [Connectivity problem](#connectivity problem).
...
### <a name="connectivity-problems"></a>Connectivity problems
...
## <a name="one-object-is-not-synchronizing-passwords-manual-troubleshooting-steps"></a>One object is not synchronizing passwords: manual troubleshooting steps
