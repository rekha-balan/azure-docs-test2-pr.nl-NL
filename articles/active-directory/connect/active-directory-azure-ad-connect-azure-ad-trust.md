...
---
# <a name="manage-ad-fs-trust-with-azure-ad-using-azure-ad-connect"></a>Manage AD FS trust with Azure AD using Azure AD Connect
...
## <a name="settings-controlled-by-azure-ad-connect"></a>Settings controlled by Azure AD Connect
...
## <a name="execution-flows-and-federation-settings-configured-by-azure-ad-connect"></a>Execution flows and federation settings configured by Azure AD Connect
...
## <a name="issuance-transform-rules-set-by-azure-ad-connect"></a>Issuance transform rules set by Azure AD Connect
...
## <a name="restore-issuance-transform-rules"></a>Restore issuance transform rules
