...
## <a name="abandoning-the-azure-ad-connect-sync-encryption-key"></a>Abandoning the Azure AD Connect Sync encryption key
>[!IMPORTANT]
...
### <a name="what-to-do-if-you-need-to-abandon-the-encryption-key"></a>What to do if you need to abandon the encryption key
...
#### <a name="abandon-the-existing-encryption-key"></a>Abandon the existing encryption key
