...
---
# <a name="integrate-your-on-premises-directories-with-azure-active-directory"></a>Integrate your on-premises directories with Azure Active Directory
...
## <a name="why-use-azure-ad-connect"></a>Why use Azure AD Connect
...
### <a name="how-azure-ad-connect-works"></a>How Azure AD Connect works
...
<center>![Azure AD Connect Stack](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/connect/media/active-directory-aadconnect-how-it-works/AADConnectStack2.png)
</center>
...
## <a name="install-azure-ad-connect"></a>Install Azure AD Connect
...
### <a name="next-steps-to-install-azure-ad-connect"></a>Next steps to Install Azure AD Connect
|Topic |Link|  
| --- | --- |
...
### <a name="learn-more-about-install-azure-ad-connect"></a>Learn more about Install Azure AD Connect
...
## <a name="configure-sync-features"></a>Configure sync features
...
### <a name="next-steps-to-configure-sync-features"></a>Next steps to configure sync features
|Topic |Link|  
| --- | --- |
...
## <a name="customize-azure-ad-connect-sync"></a>Customize Azure AD Connect sync
...
### <a name="next-steps-to-customize-azure-ad-connect-sync"></a>Next steps to customize Azure AD Connect sync
|Topic |Link|  
| --- | --- |
...
## <a name="configure-federation-features"></a>Configure federation features
...
### <a name="next-steps-to-configure-federation-features"></a>Next steps to configure federation features
|Topic |Link|  
| --- | --- |
...
## <a name="more-information-and-references"></a>More information and references
|Topic |Link|  
| --- | --- |
