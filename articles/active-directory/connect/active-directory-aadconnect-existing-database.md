...
---
# <a name="install-azure-ad-connect-using-an-existing-adsync-database"></a>Install Azure AD Connect using an existing ADSync database
...
## <a name="benefits-of-using-an-existing-adsync-database"></a>Benefits of using an existing ADSync database
...
## <a name="scenarios-where-using-an-existing-adsync-database-is-beneficial"></a>Scenarios where using an existing ADSync database is beneficial
...
## <a name="prerequisite-information"></a>Prerequisite information
...
## <a name="steps-to-install-azure-ad-connect-with-use-existing-database-mode"></a>Steps to install Azure AD Connect with “use existing database” mode
