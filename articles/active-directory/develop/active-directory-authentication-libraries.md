...
## <a name="microsoft-supported-server-libraries"></a>Microsoft-supported Server Libraries
...
### <a name="authenticating-users-of-a-native-client-application-running-on-a-device"></a>Authenticating users of a native client application running on a device
...
### <a name="authenticating-a-confidential-client-application-running-on-a-web-server"></a>Authenticating a confidential client application running on a web server
...
### <a name="authenticating-a-confidential-client-application-running-on-a-server-on-behalf-of-a-user"></a>Authenticating a confidential client application running on a server, on behalf of a user
