...
---
# <a name="azure-ad-ios-getting-started"></a>Azure AD iOS getting started
...
## <a name="1-determine-what-your-redirect-uri-is-for-ios"></a>1. Determine what your redirect URI is for iOS
...
## <a name="3-install-and-configure-adal"></a>3. Install and configure ADAL
...
## <a name="4-use-adal-to-get-tokens-from-azure-ad"></a>4. Use ADAL to get tokens from Azure AD
...
## <a name="5-build-and-run-the-application"></a>5. Build and run the application
