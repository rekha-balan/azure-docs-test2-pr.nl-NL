...
---
# <a name="azure-active-directory-v20-and-the-openid-connect-protocol"></a>Azure Active Directory v2.0 and the OpenID Connect protocol
...
## <a name="protocol-diagram-sign-in"></a>Protocol diagram: Sign-in
...
## <a name="fetch-the-openid-connect-metadata-document"></a>Fetch the OpenID Connect metadata document
...
## <a name="protocol-diagram-access-token-acquisition"></a>Protocol diagram: Access token acquisition
