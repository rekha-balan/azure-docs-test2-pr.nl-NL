...
---
# <a name="developer-guidance-for-azure-active-directory-conditional-access"></a>Developer guidance for Azure Active Directory conditional access
...
## <a name="how-does-conditional-access-impact-an-app"></a>How does conditional access impact an app?

### <a name="app-types-impacted"></a>App types impacted
...
### <a name="conditional-access-examples"></a>Conditional access examples
...
### <a name="complying-with-a-conditional-access-policy"></a>Complying with a conditional access policy
...
### <a name="considerations-for-specific-scenarios"></a>Considerations for specific scenarios
...
## <a name="scenario-app-accessing-microsoft-graph"></a>Scenario: App accessing Microsoft Graph
...
## <a name="scenario-app-performing-the-on-behalf-of-flow"></a>Scenario: App performing the on-behalf-of flow
...
## <a name="scenario-app-accessing-multiple-services"></a>Scenario: App accessing multiple services
...
## <a name="scenario-single-page-app-spa-using-adaljs"></a>Scenario: Single Page App (SPA) using ADAL.js
