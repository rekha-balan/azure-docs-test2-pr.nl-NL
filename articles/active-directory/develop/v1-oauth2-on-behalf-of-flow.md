...
---
# <a name="service-to-service-calls-using-delegated-user-identity-in-the-on-behalf-of-flow"></a>Service to service calls using delegated user identity in the On-Behalf-Of flow
...
## <a name="on-behalf-of-flow-diagram"></a>On-Behalf-Of flow diagram
...
## <a name="register-the-application-and-service-in-azure-ad"></a>Register the application and service in Azure AD
Register both the client application and the middle-tier service in Azure AD.
### <a name="register-the-middle-tier-service"></a>Register the middle-tier service
...
### <a name="register-the-client-application"></a>Register the client application
1. Sign in to the [Azure portal](https://portal.azure.com).
2. On the top bar, click on your account and under the **Directory** list, choose the Active Directory tenant where you wish to register your application.
3. Click on **More Services** in the left hand nav, and choose **Azure Active Directory**.
4. Click on **App registrations** and choose **New application registration**.
...
### <a name="configure-known-client-applications"></a>Configure known client applications
