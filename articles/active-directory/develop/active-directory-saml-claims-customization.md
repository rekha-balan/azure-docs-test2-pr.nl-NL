...
---
# <a name="customizing-claims-issued-in-the-saml-token-for-pre-integrated-apps-in-azure-active-directory"></a>Customizing claims issued in the SAML token for pre-integrated apps in Azure Active Directory
...
## <a name="editing-the-nameidentifier-claim"></a>Editing the NameIdentifier claim
...
## <a name="adding-claims"></a>Adding claims
