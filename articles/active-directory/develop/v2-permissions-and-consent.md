...
---
# <a name="scopes-permissions-and-consent-in-the-azure-active-directory-v20-endpoint"></a>Scopes, permissions, and consent in the Azure Active Directory v2.0 endpoint
...
## <a name="scopes-and-permissions"></a>Scopes and permissions
...
## <a name="accessing-v10-resources"></a>Accessing v1.0 resources
...
### <a name="v10-resources-and-tenancy"></a>v1.0 resources and tenancy
...
### <a name="recommended-sign-the-user-in-to-your-app"></a>Recommended: Sign the user in to your app
