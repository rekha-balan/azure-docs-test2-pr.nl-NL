...
---
# <a name="list-your-application-in-the-azure-active-directory-application-gallery"></a>List your application in the Azure Active Directory application gallery
...
## <a name="what-are-the-benefits-of-listing-an-application-in-the-gallery"></a>What are the benefits of listing an application in the gallery?
...
##  <a name="implementing-sso-using-federation-protocol"></a>Implementing SSO using federation protocol
...
## <a name="implementing-sso-using-password-sso"></a>Implementing SSO using Password SSO
...
##  <a name="updateremove-existing-listing"></a>Update/Remove existing listing
...
## <a name="submit-the-request-in-the-portal"></a>Submit the request in the portal
