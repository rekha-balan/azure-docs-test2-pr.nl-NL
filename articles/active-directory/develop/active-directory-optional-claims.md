...
---
# <a name="optional-claims-in-azure-ad-preview"></a>Optional claims in Azure AD (preview)
...
## <a name="standard-optional-claims-set"></a>Standard optional claims set
...
### <a name="v20-optional-claims"></a>V2.0 optional claims
...
### <a name="additional-properties-of-optional-claims"></a>Additional properties of optional claims
...
#### <a name="additional-properties-example"></a>Additional properties example:
...
## <a name="configuring-optional-claims"></a>Configuring optional claims
...
### <a name="optionalclaim-type"></a>OptionalClaim Type
...
## <a name="configuring-custom-claims-via-directory-extensions"></a>Configuring custom claims via directory extensions
...
### <a name="values-for-configuring-additional-optional-claims"></a>Values for configuring additional optional claims 
...
## <a name="optional-claims-example"></a>Optional claims example
