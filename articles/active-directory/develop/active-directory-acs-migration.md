...
---
# <a name="migrate-from-the-azure-access-control-service"></a>Migrate from the Azure Access Control service
...
## <a name="retirement-schedule"></a>Retirement schedule
...
## <a name="migration-strategies"></a>Migration strategies
...
### <a name="clients-of-microsoft-cloud-services"></a>Clients of Microsoft cloud services
...
### <a name="sharepoint-customers"></a>SharePoint customers
...
### <a name="web-applications-that-use-passive-authentication"></a>Web applications that use passive authentication
...
#### <a name="migrate-to-azure-active-directory"></a>Migrate to Azure Active Directory
...
#### <a name="migrate-to-azure-active-directory-b2c"></a>Migrate to Azure Active Directory B2C
...
#### <a name="migrate-to-ping-identity-or-auth0"></a>Migrate to Ping Identity or Auth0
...
### <a name="web-services-that-use-active-authentication"></a>Web services that use active authentication
...
## <a name="questions-concerns-and-feedback"></a>Questions, concerns, and feedback
