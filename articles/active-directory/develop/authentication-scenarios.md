...
### <a name="additional-considerations-when-developing-single-tenant-or-multi-tenant-apps"></a>Additional considerations when developing single tenant or multi-tenant apps
