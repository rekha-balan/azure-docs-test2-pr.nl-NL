...
---
# <a name="app-types-for-the-azure-active-directory-v20-endpoint"></a>App types for the Azure Active Directory v2.0 endpoint
...
## <a name="daemons-and-server-side-apps"></a>Daemons and server-side apps
