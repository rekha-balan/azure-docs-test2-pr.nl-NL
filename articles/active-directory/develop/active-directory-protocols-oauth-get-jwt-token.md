...
---
# <a name="request-an-access-token-using-oauth-20-to-access-web-apis-and-applications-secured-by-azure-active-directory"></a>Request an access token using OAuth 2.0 to access web APIs and applications secured by Azure Active Directory
