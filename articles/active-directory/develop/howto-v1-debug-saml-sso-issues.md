...
---
# <a name="debug-saml-based-single-sign-on-to-applications-in-azure-active-directory"></a>Debug SAML-based single sign-on to applications in Azure Active Directory
...
## <a name="test-saml-based-single-sign-on"></a>Test SAML-based single sign-on
...
## <a name="resolve-a-sign-in-error-on-your-company-sign-in-page"></a>Resolve a sign-in error on your company sign-in page
...
## <a name="resolve-a-sign-in-error-on-the-application-page"></a>Resolve a sign-in error on the application page
