...
---
# <a name="authorize-access-to-azure-active-directory-web-applications-using-the-oauth-20-code-grant-flow"></a>Authorize access to Azure Active Directory web applications using the OAuth 2.0 code grant flow
