...
---
# <a name="azure-ad-xamarin-getting-started"></a>Azure AD Xamarin getting started
...
## <a name="step-1-set-up-your-xamarin-development-environment"></a>Step 1: Set up your Xamarin development environment
...
## <a name="step-2-register-the-directorysearcher-app"></a>Step 2: Register the DirectorySearcher app
...
8. Select **Microsoft Graph** as the API. Under **Delegated Permissions**, add the **Read Directory Data** permission. This action enables the app to query the Graph API for users.

## <a name="step-3-install-and-configure-adal"></a>Step 3: Install and configure ADAL
...
## <a name="step-4-use-adal-to-get-tokens-from-azure-ad"></a>Step 4: Use ADAL to get tokens from Azure AD
...
2. Initialize `AuthenticationContext`, which is the primary class of ADAL. This action passes ADAL the coordinates it needs to communicate with Azure AD.
