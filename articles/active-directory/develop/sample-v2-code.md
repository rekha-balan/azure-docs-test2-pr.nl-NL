...
---
# <a name="azure-active-directory-code-samples-v2-endpoint"></a>Azure Active Directory code samples (V2 endpoint)
...
## <a name="desktop-and-mobile-public-client-apps"></a>Desktop and mobile public client apps
...
## <a name="daemon-applications"></a>Daemon applications
...
## <a name="single-page-applications-spa"></a>Single page applications (SPA)
...
### <a name="web-api-protected-by-azure-ad"></a>Web API protected by Azure AD
