...
> [!TIP]
> Try executing this request in Postman! (Don't forget to replace the `code`) [![Run in Postman](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/develop/media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Execute this request in Postman! (Replace the `Authorization` header first) [![Run in Postman](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/develop/media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
