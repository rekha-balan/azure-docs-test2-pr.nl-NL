...
---
# <a name="aspnet-web-app-sign-in-and-sign-out-with-azure-ad"></a>ASP.NET web app sign-in and sign-out with Azure AD
...
## <a name="step-3-use-owin-to-issue-sign-in-and-sign-out-requests-to-azure-ad"></a>Step 3: Use OWIN to issue sign-in and sign-out requests to Azure AD
...
## <a name="step-4-display-user-information"></a>Step 4: Display user information
