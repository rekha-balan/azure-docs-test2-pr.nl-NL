...
---
# <a name="how-to-fill-out-specific-fields-for-a-custom-developed-application"></a>How to fill out specific fields for a custom-developed application
...
## <a name="register-a-new-application"></a>Register a new application
...
## <a name="fields-in-the-application-registration-form"></a>Fields in the application registration form
