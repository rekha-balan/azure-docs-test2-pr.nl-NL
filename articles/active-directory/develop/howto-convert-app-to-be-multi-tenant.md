...
---
# <a name="how-to-sign-in-any-azure-active-directory-user-using-the-multi-tenant-application-pattern"></a>How to sign in any Azure Active Directory user using the multi-tenant application pattern
