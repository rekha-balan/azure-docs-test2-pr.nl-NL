...
---
<!--start-intro-->
# <a name="add-sign-in-with-microsoft-to-an-aspnet-web-app"></a>Add sign-in with Microsoft to an ASP.NET web app
...
## <a name="how-this-guide-works"></a>How this guide works
...
<!--start-collapse-->
> ### <a name="about-these-packages"></a>About these packages
...
## <a name="add-a-controller-to-handle-sign-in-and-sign-out-requests"></a>Add a controller to handle sign-in and sign-out requests
...
## <a name="create-the-apps-home-page-to-sign-in-users-via-a-sign-in-button"></a>Create the app's home page to sign in users via a sign-in button
...
## <a name="display-users-claims-by-adding-a-controller"></a>Display user's claims by adding a controller
...
## <a name="create-a-view-to-display-the-users-claims"></a>Create a view to display the user's claims
...
<!--start-configure-->
## <a name="configure-your-webconfig-and-register-an-application"></a>Configure your *web.config* and register an application
...
### <a name="register-your-application-in-the-azure-portal-then-add-its-information-to-webconfig"></a>Register your application in the Azure Portal, then add its information to *web.config*
...
## <a name="configure-sign-in-options"></a>Configure sign-in options
...
### <a name="configure-your-application-to-allow-sign-ins-of-work-and-school-accounts-from-any-company-or-organization-multi-tenant"></a>Configure your application to allow sign ins of work and school accounts from any company or organization (multi-tenant)
...
### <a name="restrict-users-from-only-one-organizations-active-directory-instance-to-sign-in-to-your-application-single-tenant"></a>Restrict users from only one organization's Active Directory instance to sign in to your application (single-tenant)
...
#### <a name="expected-results"></a>Expected results
...
### <a name="see-users-claims"></a>See user's claims
...
### <a name="test-accessing-a-method-that-has-an-authorize-attribute-optional"></a>Test accessing a method that has an *[Authorize]* attribute (Optional)
...
<!--start-collapse-->
### <a name="protect-your-entire-web-site"></a>Protect your entire web site
