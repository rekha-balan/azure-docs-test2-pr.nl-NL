...
---
# <a name="error-handling-best-practices-for-azure-active-directory-authentication-library-adal-clients"></a>Error handling best practices for Azure Active Directory Authentication Library (ADAL) clients
...
### <a name="application-scenarios"></a>Application scenarios
...
### <a name="error-cases-and-actionable-steps"></a>Error cases and actionable steps
...
### <a name="error-cases-and-actionable-steps-native-client-applications"></a>Error cases and actionable steps: Native client applications
...
### <a name="error-cases-and-actionable-steps-web-applications-that-call-a-resource-api-net"></a>Error cases and actionable steps: Web applications that call a resource API (.NET)
...
### <a name="error-cases-and-actionable-steps-single-page-applications-adaljs"></a>Error cases and actionable steps: Single Page Applications (adal.js)
...
### <a name="error-cases-and-actionable-steps-service-to-service-applications-net-only"></a>Error cases and actionable steps: service-to-service applications (.NET only)
...
#### <a name="all-scenarios"></a>All scenarios
...
#### <a name="on-behalf-of-scenarios"></a>On-behalf-of scenarios
...
## <a name="error-and-logging-reference"></a>Error and logging reference

### <a name="logging-personal-identifiable-information-pii--organizational-identifiable-information-oii"></a>Logging Personal Identifiable Information (PII) & Organizational Identifiable Information (OII)
...
#### <a name="adal-library-errors"></a>ADAL library errors
...
#### <a name="guidance-for-error-logging-code"></a>Guidance for error logging code
...
#### <a name="operating-system-errors"></a>Operating System errors
...
### <a name="guidance-for-error-logging-code---javascript"></a>Guidance for error logging code - JavaScript 
