...
---
# <a name="azure-ad-angularjs-getting-started"></a>Azure AD AngularJS getting started
...
### <a name="configure-the-javascript-client"></a>Configure the JavaScript client
...
### <a name="configure-the-back-end-server"></a>Configure the back end server
