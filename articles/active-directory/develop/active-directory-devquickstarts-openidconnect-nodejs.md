...
---
# <a name="nodejs-web-app-sign-in-and-sign-out-with-azure-ad"></a>Node.js web app sign-in and sign-out with Azure AD
...
## <a name="step-1-register-an-app"></a>Step 1: Register an app
...
## <a name="step-2-add-prerequisites-to-your-directory"></a>Step 2: Add prerequisites to your directory
...
## <a name="step-3-set-up-your-app-to-use-the-passport-node-js-strategy"></a>Step 3: Set up your app to use the passport-node-js strategy
...
## <a name="step-4-use-passport-to-issue-sign-in-and-sign-out-requests-to-azure-ad"></a>Step 4: Use Passport to issue sign-in and sign-out requests to Azure AD
...
## <a name="step-5-to-display-our-user-in-the-website-create-the-views-and-routes-in-express"></a>Step 5: To display our user in the website, create the views and routes in Express
