...
---
# <a name="azure-ad-android-getting-started"></a>Azure AD Android getting started
...
The Azure AD Authentication Library (ADAL) Android library gives your app the ability to begin using the [Microsoft Azure Cloud](https://cloud.microsoft.com) & [Microsoft Graph API](https://graph.microsoft.io) by supporting [Microsoft Azure Active Directory accounts](https://azure.microsoft.com/services/active-directory/) using industry standard OAuth2 and OpenID Connect. This sample demonstrates all the normal lifecycles your application should experience, including:
...
## <a name="scenario-sign-in-users-and-call-the-microsoft-graph"></a>Scenario: Sign in users and call the Microsoft Graph
...
## <a name="steps-to-run"></a>Steps to run

### <a name="register-and-configure-your-app"></a>Register and configure your app 
You will need to have a native client application registered with Microsoft using the [Azure portal](https://portal.azure.com). 
...
### <a name="configure-your-code"></a>Configure your code
...
## <a name="important-info"></a>Important info
