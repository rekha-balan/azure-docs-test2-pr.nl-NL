...
---
# <a name="call-microsoft-graph-api-from-a-universal-windows-platform-application-xaml"></a>Call Microsoft Graph API from a Universal Windows Platform application (XAML)
...
### <a name="create-your-application"></a>Create your application
...
## <a name="add-microsoft-authentication-library-to-your-project"></a>Add Microsoft Authentication Library to your project
...
## <a name="create-your-applications-ui"></a>Create your application’s UI
...
## <a name="use-msal-to-get-a-token-for-microsoft-graph-api"></a>Use MSAL to get a token for Microsoft Graph API
...
#### <a name="get-a-user-token-interactively"></a>Get a user token interactively
...
#### <a name="get-a-user-token-silently"></a>Get a user token silently
...
## <a name="call-microsoft-graph-api-by-using-the-token-you-just-obtained"></a>Call Microsoft Graph API by using the token you just obtained
...
### <a name="more-information-on-making-a-rest-call-against-a-protected-api"></a>More information on making a REST call against a protected API
...
## <a name="add-a-method-to-sign-out-the-user"></a>Add a method to sign out the user
...
### <a name="more-information-on-sign-out"></a>More information on sign-out
...
## <a name="display-basic-token-information"></a>Display basic token information
...
## <a name="enable-integrated-authentication-on-federated-domains-optional"></a>Enable integrated authentication on federated domains (optional)
...
#### <a name="see-whats-in-the-access-token-optional"></a>See what's in the access token (optional)
Optionally, copy the value in **Access Token** and paste it in https://jwt.ms to decode it and see the list of claims.

### <a name="more-information-about-scopes-and-delegated-permissions"></a>More information about scopes and delegated permissions
