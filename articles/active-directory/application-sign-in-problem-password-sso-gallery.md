...
---
# <a name="problems-signing-in-to-an-azure-ad-gallery-application-configured-for-federated-single-sign-on"></a>Problems signing in to an Azure AD Gallery application configured for federated single sign-on
...
## <a name="if-these-troubleshoot-steps-dont-resolve-the-issue"></a>If these troubleshoot steps don't resolve the issue 
