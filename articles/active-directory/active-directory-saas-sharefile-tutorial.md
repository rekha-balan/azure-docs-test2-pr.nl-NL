...
## <a name="adding-citrix-sharefile-from-the-gallery"></a>Adding Citrix ShareFile from the gallery
...
### <a name="creating-a-citrix-sharefile-test-user"></a>Creating a Citrix ShareFile test user
...
2. In the toolbar on the top, click **Manage Users**. Then go to **Manage Users Home** and click **Create Employee**.
    ...
    ![New User](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-sharefile-tutorial/tutorial_sharefile_010.png "New User")

3. On the **Basic Information** section, perform below steps:

    ![New User](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-sharefile-tutorial/tutorial_sharefile_011.png "New User")
