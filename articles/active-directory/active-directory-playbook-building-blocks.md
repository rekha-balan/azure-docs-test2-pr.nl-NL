...
---
# <a name="azure-active-directory-proof-of-concept-playbook-building-blocks"></a>Azure Active Directory Proof of Concept Playbook: Building Blocks

## <a name="catalog-of-actors"></a>Catalog of Actors
...
## <a name="common-prerequisites-for-all-building-blocks"></a>Common Prerequisites for all building blocks
...
## <a name="group-based-licensing"></a>Group based licensing
...
## <a name="saas-federated-sso-configuration"></a>SaaS Federated SSO Configuration
...
## <a name="saas-password-sso-configuration"></a>SaaS Password SSO Configuration
...
## <a name="saas-shared-accounts-configuration"></a>SaaS Shared Accounts Configuration
...
## <a name="app-proxy-configuration"></a>App Proxy Configuration
...
## <a name="generic-ldap-connector-configuration"></a>Generic LDAP Connector configuration
...
## <a name="groups---delegated-ownership"></a>Groups - Delegated Ownership
...
## <a name="saas-and-identity-lifecycle"></a>SaaS and Identity Lifecycle
...
## <a name="self-service-access-to-application-management"></a>Self Service Access to Application Management
...
## <a name="azure-multi-factor-authentication-with-phone-calls"></a>Azure Multi-Factor Authentication with Phone Calls
...
## <a name="mfa-conditional-access-for-saas-applications"></a>MFA Conditional Access for SaaS applications
...
## <a name="discovering-risk-events"></a>Discovering Risk Events
...
## <a name="deploying-sign-in-risk-policies"></a>Deploying Sign-in risk policies
...
## <a name="configuring-certificate-based-authentication"></a>Configuring certificate based authentication
