...
---
# <a name="you-cant-get-there-from-here-on-a-windows-device"></a>You can't get there from here on a Windows device
...
!["You can't get there from here" message for unsupported browsers](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-conditional-access-device-remediation/02.png "Scenario")
...
## <a name="supported-versions-of-windows"></a>Supported versions of Windows
...
## <a name="compliant-device"></a>Compliant device
...
!["You can't get there from here" messages for unregistered devices](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-conditional-access-device-remediation/01.png "Scenario")


### <a name="is-your-device-joined-to-an-on-premises-active-directory"></a>Is your device joined to an on-premises Active Directory?
...
### <a name="is-your-device-not-joined-to-an-on-premises-active-directory"></a>Is your device not joined to an on-premises Active Directory?
...
#### <a name="azure-ad-join-on-windows-10"></a>Azure AD Join on Windows 10
...
#### <a name="workplace-join-on-windows-81"></a>Workplace Join on Windows 8.1
...
#### <a name="add-your-work-or-school-account-to-windows"></a>Add your work or school account to Windows 
