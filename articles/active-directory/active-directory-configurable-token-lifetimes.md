...
## <a name="token-types"></a>Token types
...
#### <a name="token-lifetimes-with-confidential-client-refresh-tokens"></a>Token lifetimes with confidential client refresh tokens
...
#### <a name="token-lifetimes-with-public-client-refresh-tokens"></a>Token lifetimes with public client refresh tokens
...
### <a name="single-sign-on-session-tokens"></a>Single sign-on session tokens
...
### <a name="policy-evaluation-and-prioritization"></a>Policy evaluation and prioritization
...
## <a name="configurable-policy-property-details"></a>Configurable policy property details
...
## <a name="example-token-lifetime-policies"></a>Example token lifetime policies
...
### <a name="example-manage-an-organizations-default-policy"></a>Example: Manage an organization's default policy
...
### <a name="example-create-a-policy-for-web-sign-in"></a>Example: Create a policy for web sign-in
...
### <a name="example-create-a-policy-for-a-native-app-that-calls-a-web-api"></a>Example: Create a policy for a native app that calls a web API
...
### <a name="example-manage-an-advanced-policy"></a>Example: Manage an advanced policy
