...
---
# <a name="how-to-set-up-sharepoint-online-and-exchange-online-for-azure-active-directory-conditional-access"></a>How To: Set up SharePoint Online and Exchange Online for Azure Active Directory conditional access 
...
## <a name="control-access-to-sharepoint-online"></a>Control access to SharePoint Online
...
## <a name="control-access-to-exchange-online"></a>Control access to Exchange Online
...
### <a name="legacy-authentication-protocols"></a>Legacy authentication protocols
...
## <a name="set-up-ad-fs-rules"></a>Set up AD FS rules

You can use the following issuance authorization rules to enable or block traffic at the AD FS level. 

### <a name="block-legacy-traffic-from-the-extranet"></a>Block legacy traffic from the extranet
...
### <a name="block-legacy-traffic-from-anywhere"></a>Block legacy traffic from anywhere
