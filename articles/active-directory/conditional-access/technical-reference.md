...
---
# <a name="azure-active-directory-conditional-access-settings-reference"></a>Azure Active Directory conditional access settings reference
...
## <a name="cloud-apps-assignments"></a>Cloud apps assignments
...
### <a name="microsoft-cloud-applications"></a>Microsoft cloud applications
...
## <a name="device-platform-condition"></a>Device platform condition
...
## <a name="client-apps-condition"></a>Client apps condition 
...
### <a name="supported-mobile-applications-and-desktop-clients"></a>Supported mobile applications and desktop clients
...
## <a name="approved-client-app-requirement"></a>Approved client app requirement 
