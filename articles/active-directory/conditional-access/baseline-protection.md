...
---
# <a name="what-is-baseline-protection-preview"></a>What is baseline protection (preview)?  
...
## <a name="require-mfa-for-admins"></a>Require MFA for admins
...
## <a name="enable-a-baseline-policy"></a>Enable a baseline policy 
