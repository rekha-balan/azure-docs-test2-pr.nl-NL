...
## <a name="what-happens-when-my-organization-purchases-a-subscription-that-includes-azure-rights-management-after-using-roaming"></a>What happens when my organization purchases a subscription that includes Azure Rights Management after using roaming?
