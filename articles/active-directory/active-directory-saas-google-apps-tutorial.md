...
---
# <a name="tutorial-azure-active-directory-integration-with-google-apps"></a>Tutorial: Azure Active Directory integration with Google Apps
...
## <a name="step-1-add-google-apps-to-your-directory"></a>Step 1: Add Google Apps to your Directory
...
## <a name="optional-step-manually-configure-single-sign-on"></a>Optional Step: Manually Configure Single Sign-On
...
## <a name="step-4-assign-users-to-google-apps"></a>Step 4: Assign Users to Google Apps
