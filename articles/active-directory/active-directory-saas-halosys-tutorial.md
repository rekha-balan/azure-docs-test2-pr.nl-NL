...
---
# <a name="tutorial-azure-active-directory-integration-with-halosys"></a>Tutorial: Azure Active Directory integration with Halosys
...
## <a name="adding-halosys-from-the-gallery"></a>Adding Halosys from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-halosys-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps: ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-halosys-tutorial/create_aaduser_06.png) 
...
### <a name="creating-a-halosys-test-user"></a>Creating a Halosys test user
