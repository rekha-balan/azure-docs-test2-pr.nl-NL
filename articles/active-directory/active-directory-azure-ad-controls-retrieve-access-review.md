...
---
# <a name="retrieve-access-review-results"></a>Retrieve access review results
...
## <a name="locating-an-access-review"></a>Locating an access review
...
## <a name="retrieving-the-results-for-a-one-time-access-review"></a>Retrieving the results for a one-time access review
...
## <a name="retrieving-the-results-for-multiple-instances-of-a-recurring-access-review"></a>Retrieving the results for multiple instances of a recurring access review
...
## <a name="removing-users-from-an-access-review"></a>Removing users from an access review
