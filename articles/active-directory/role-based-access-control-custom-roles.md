...
---
# <a name="create-custom-roles-for-azure-role-based-access-control"></a>Create custom roles for Azure Role-Based Access Control
...
![Azure CLI screenshot - azure provider operations show "Microsoft.Compute/virtualMachines/\*/action" ](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/role-based-access-control-configure/1-azure-provider-operations-show.png)
