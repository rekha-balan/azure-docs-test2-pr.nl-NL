...
---
# <a name="azure-active-directory-risk-events"></a>Azure Active Directory risk events
...
## <a name="risk-event-types"></a>Risk event types
...
## <a name="detection-type"></a>Detection type
