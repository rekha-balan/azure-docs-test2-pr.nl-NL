...
## <a name="add-people-from-the-gallery"></a>Add People from the gallery
...
5. To get SSO configured for your application, you need to sign-on to your People tenant as an administrator.
   ...
   1. In the menu on the left side, click **Settings**.
    ![Configure Single Sign-On](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-people-tutorial/tutorial_people_001.png)    
   2. Click **“Company”**.
...
### <a name="create-a-people-test-user"></a>Create a People test user
