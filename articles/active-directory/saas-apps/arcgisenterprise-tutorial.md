...
---
# <a name="tutorial-azure-active-directory-integration-with-arcgis-enterprise"></a>Tutorial: Azure Active Directory integration with ArcGIS Enterprise
...
## <a name="adding-arcgis-enterprise-from-the-gallery"></a>Adding ArcGIS Enterprise from the gallery
...
### <a name="create-an-arcgis-enterprise-test-user"></a>Create an ArcGIS Enterprise test user
