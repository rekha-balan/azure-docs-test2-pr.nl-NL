...
---
# <a name="tutorial-azure-active-directory-integration-with-boxcryptor"></a>Tutorial: Azure Active Directory integration with Boxcryptor
...
## <a name="adding-boxcryptor-from-the-gallery"></a>Adding Boxcryptor from the gallery
...
### <a name="create-a-boxcryptor-test-user"></a>Create a Boxcryptor test user
