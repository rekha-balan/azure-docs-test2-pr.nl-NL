...
---
# <a name="tutorial-azure-active-directory-integration-with-liquidfiles"></a>Tutorial: Azure Active Directory integration with LiquidFiles
...
## <a name="adding-liquidfiles-from-the-gallery"></a>Adding LiquidFiles from the gallery
...
### <a name="creating-a-liquidfiles-test-user"></a>Creating a LiquidFiles test user
