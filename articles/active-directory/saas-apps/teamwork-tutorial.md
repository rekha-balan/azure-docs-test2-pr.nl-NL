...
---
# <a name="tutorial-azure-active-directory-integration-with-teamworkcom"></a>Tutorial: Azure Active Directory integration with Teamwork.com
...
## <a name="adding-teamworkcom-from-the-gallery"></a>Adding Teamwork.com from the gallery
...
### <a name="create-a-teamworkcom-test-user"></a>Create a Teamwork.com test user
