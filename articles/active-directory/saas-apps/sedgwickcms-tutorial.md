...
---
# <a name="tutorial-azure-active-directory-integration-with-sedgwick-cms"></a>Tutorial: Azure Active Directory integration with Sedgwick CMS
...
## <a name="adding-sedgwick-cms-from-the-gallery"></a>Adding Sedgwick CMS from the gallery
...
### <a name="create-a-sedgwick-cms-test-user"></a>Create a Sedgwick CMS test user
