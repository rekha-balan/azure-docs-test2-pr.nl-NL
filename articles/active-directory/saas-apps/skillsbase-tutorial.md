...
---
# <a name="tutorial-azure-active-directory-integration-with-skills-base"></a>Tutorial: Azure Active Directory integration with Skills Base
...
## <a name="adding-skills-base-from-the-gallery"></a>Adding Skills Base from the gallery
...
### <a name="create-a-skills-base-test-user"></a>Create a Skills Base test user
