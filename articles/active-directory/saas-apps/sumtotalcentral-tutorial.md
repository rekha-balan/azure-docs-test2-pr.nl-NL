...
---
# <a name="tutorial-azure-active-directory-integration-with-sumtotalcentral"></a>Tutorial: Azure Active Directory integration with SumTotalCentral
...
## <a name="adding-sumtotalcentral-from-the-gallery"></a>Adding SumTotalCentral from the gallery
...
### <a name="create-a-sumtotalcentral-test-user"></a>Create a SumTotalCentral test user
