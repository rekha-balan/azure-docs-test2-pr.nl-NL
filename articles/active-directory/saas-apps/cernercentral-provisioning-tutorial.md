...
---
# <a name="tutorial-configure-cerner-central-for-automatic-user-provisioning"></a>Tutorial: Configure Cerner Central for automatic user provisioning
...
## <a name="assigning-users-to-cerner-central"></a>Assigning users to Cerner Central
...
### <a name="important-tips-for-assigning-users-to-cerner-central"></a>Important tips for assigning users to Cerner Central
...
## <a name="configuring-user-provisioning-to-cerner-central"></a>Configuring user provisioning to Cerner Central
...
### <a name="to-configure-automatic-user-account-provisioning-to-cerner-central-in-azure-ad"></a>To configure automatic user account provisioning to Cerner Central in Azure AD:
