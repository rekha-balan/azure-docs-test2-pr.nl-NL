...
## <a name="add-citrix-sharefile-from-the-gallery"></a>Add Citrix ShareFile from the gallery
...
### <a name="create-a-citrix-sharefile-test-user"></a>Create a Citrix ShareFile test user
