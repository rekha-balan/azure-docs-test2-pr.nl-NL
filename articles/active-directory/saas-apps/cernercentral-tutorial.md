...
---
# <a name="tutorial-azure-active-directory-integration-with-cerner-central"></a>Tutorial: Azure Active Directory integration with Cerner Central
...
## <a name="adding-cerner-central-from-the-gallery"></a>Adding Cerner Central from the gallery
...
### <a name="creating-a-cerner-central-test-user"></a>Creating a Cerner Central test user
