...
## <a name="adding-appdynamics-from-the-gallery"></a>Adding AppDynamics from the gallery
...
### <a name="creating-an-appdynamics-test-user"></a>Creating an AppDynamics test user
