...
---
# <a name="tutorial-azure-active-directory-integration-with-lcvista"></a>Tutorial: Azure Active Directory integration with LCVista
...
## <a name="adding-lcvista-from-the-gallery"></a>Adding LCVista from the gallery
...
### <a name="creating-a-lcvista-test-user"></a>Creating a LCVista test user
