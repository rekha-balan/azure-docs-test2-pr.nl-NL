...
## <a name="add-questetra-bpm-suite-from-the-gallery"></a>Add Questetra BPM Suite from the gallery
...
### <a name="create-a-questetra-bpm-suite-test-user"></a>Create a Questetra BPM Suite test user
