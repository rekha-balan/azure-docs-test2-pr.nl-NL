...
---
# <a name="tutorial-azure-active-directory-integration-with-knowbe4-security-awareness-training"></a>Tutorial: Azure Active Directory integration with KnowBe4 Security Awareness Training
...
## <a name="adding-knowbe4-security-awareness-training-from-the-gallery"></a>Adding KnowBe4 Security Awareness Training from the gallery
...
### <a name="create-a-knowbe4-security-awareness-training-test-user"></a>Create a KnowBe4 Security Awareness Training test user
