...
---
# <a name="integrate-azure-active-directory-with-e-sales-manager-remix"></a>Integrate Azure Active Directory with E Sales Manager Remix
...
## <a name="add-e-sales-manager-remix-from-the-gallery"></a>Add E Sales Manager Remix from the gallery
...
### <a name="create-an-e-sales-manager-remix-test-user"></a>Create an E Sales Manager Remix test user
