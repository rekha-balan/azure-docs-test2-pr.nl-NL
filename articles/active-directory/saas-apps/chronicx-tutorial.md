...
---
# <a name="tutorial-azure-active-directory-integration-with-chronicx"></a>Tutorial: Azure Active Directory integration with ChronicX®
...
## <a name="adding-chronicx-from-the-gallery"></a>Adding ChronicX® from the gallery
...
1. In the search box, type **ChronicX®**, select **ChronicX®** from result panel then click **Add** button to add the application.
...
### <a name="create-a-chronicx-test-user"></a>Create a ChronicX® test user
