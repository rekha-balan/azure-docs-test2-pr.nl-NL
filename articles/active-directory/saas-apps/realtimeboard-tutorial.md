...
---
# <a name="tutorial-azure-active-directory-integration-with-realtimeboard"></a>Tutorial: Azure Active Directory integration with RealtimeBoard
...
## <a name="adding-realtimeboard-from-the-gallery"></a>Adding RealtimeBoard from the gallery
...
### <a name="create-a-realtimeboard-test-user"></a>Create a RealtimeBoard test user
