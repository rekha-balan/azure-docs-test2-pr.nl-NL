...
---
# <a name="tutorial-azure-active-directory-integration-with-safetynet"></a>Tutorial: Azure Active Directory integration with SafetyNet
...
## <a name="adding-safetynet-from-the-gallery"></a>Adding SafetyNet from the gallery
...
### <a name="create-a-safetynet-test-user"></a>Create a SafetyNet test user
