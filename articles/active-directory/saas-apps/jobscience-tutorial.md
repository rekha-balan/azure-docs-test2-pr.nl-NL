...
## <a name="adding-jobscience-from-the-gallery"></a>Adding Jobscience from the gallery
...
1. On the **Jobscience Domain and URLs** section, perform the following steps:
    ...
    In the **Sign-on URL** textbox, type a URL using the following pattern:  `http://<company name>.my.salesforce.com`
...
### <a name="creating-a-jobscience-test-user"></a>Creating a Jobscience test user
