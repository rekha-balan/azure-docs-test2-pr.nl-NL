...
---
# <a name="tutorial-azure-active-directory-integration-with-proxyclick"></a>Tutorial: Azure Active Directory integration with Proxyclick
...
## <a name="adding-proxyclick-from-the-gallery"></a>Adding Proxyclick from the gallery
...
### <a name="create-a-proxyclick-test-user"></a>Create a Proxyclick test user
