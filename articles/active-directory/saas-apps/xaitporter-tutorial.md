...
---
# <a name="tutorial-azure-active-directory-integration-with-xaitporter"></a>Tutorial: Azure Active Directory integration with XaitPorter
...
## <a name="adding-xaitporter-from-the-gallery"></a>Adding XaitPorter from the gallery
...
### <a name="create-a-xaitporter-test-user"></a>Create a XaitPorter test user
