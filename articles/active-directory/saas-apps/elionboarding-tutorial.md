...
---
# <a name="tutorial-azure-active-directory-integration-with-eli-onboarding"></a>Tutorial: Azure Active Directory integration with Eli Onboarding
...
## <a name="adding-eli-onboarding-from-the-gallery"></a>Adding Eli Onboarding from the gallery
...
### <a name="create-an-eli-onboarding-test-user"></a>Create an Eli Onboarding test user
