...
---
# <a name="tutorial-azure-active-directory-integration-with-innovation-hub"></a>Tutorial: Azure Active Directory integration with Innovation Hub
...
## <a name="adding-innovation-hub-from-the-gallery"></a>Adding Innovation Hub from the gallery
...
### <a name="create-an-innovation-hub-test-user"></a>Create an Innovation Hub test user
