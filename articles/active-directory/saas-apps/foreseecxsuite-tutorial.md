...
---
# <a name="tutorial-azure-active-directory-integration-with-foresee-cx-suite"></a>Tutorial: Azure Active Directory integration with ForeSee CX Suite
...
## <a name="adding-foresee-cx-suite-from-the-gallery"></a>Adding ForeSee CX Suite from the gallery
...
### <a name="create-a-foresee-cx-suite-test-user"></a>Create a ForeSee CX Suite test user
