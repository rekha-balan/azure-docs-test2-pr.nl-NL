...
---
# <a name="tutorial-azure-active-directory-integration-with-lecorpio"></a>Tutorial: Azure Active Directory integration with Lecorpio
...
## <a name="adding-lecorpio-from-the-gallery"></a>Adding Lecorpio from the gallery
...
### <a name="creating-a-lecorpio-test-user"></a>Creating a Lecorpio test user
