...
---
# <a name="tutorial-configure-jive-for-automatic-user-provisioning"></a>Tutorial: Configure Jive for automatic user provisioning
...
## <a name="assigning-users-to-jive"></a>Assigning users to Jive
...
### <a name="important-tips-for-assigning-users-to-jive"></a>Important tips for assigning users to Jive
