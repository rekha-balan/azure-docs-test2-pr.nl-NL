...
---
# <a name="tutorial-azure-active-directory-integration-with-iriusrisk"></a>Tutorial: Azure Active Directory integration with IriusRisk
...
## <a name="adding-iriusrisk-from-the-gallery"></a>Adding IriusRisk from the gallery
...
### <a name="create-a-iriusrisk-test-user"></a>Create a IriusRisk test user
