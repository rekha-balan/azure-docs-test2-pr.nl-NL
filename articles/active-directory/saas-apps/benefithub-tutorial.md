...
---
# <a name="tutorial-azure-active-directory-integration-with-benefithub"></a>Tutorial: Azure Active Directory integration with BenefitHub
...
## <a name="adding-benefithub-from-the-gallery"></a>Adding BenefitHub from the gallery
...
### <a name="creating-a-benefithub-test-user"></a>Creating a BenefitHub test user
