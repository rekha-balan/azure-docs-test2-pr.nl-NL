...
## <a name="adding-salesforce-sandbox-from-the-gallery"></a>Adding Salesforce Sandbox from the gallery
...
### <a name="create-a-salesforce-sandbox-test-user"></a>Create a Salesforce Sandbox test user
