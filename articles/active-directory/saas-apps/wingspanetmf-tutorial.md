...
---
# <a name="tutorial-azure-active-directory-integration-with-wingspan-etmf"></a>Tutorial: Azure Active Directory integration with Wingspan eTMF
...
## <a name="adding-wingspan-etmf-from-the-gallery"></a>Adding Wingspan eTMF from the gallery
...
### <a name="creating-a-wingspan-etmf-test-user"></a>Creating a Wingspan eTMF test user
