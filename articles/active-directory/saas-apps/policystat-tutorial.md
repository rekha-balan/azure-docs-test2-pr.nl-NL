...
## <a name="adding-policystat-from-the-gallery"></a>Adding PolicyStat from the gallery
...
### <a name="creating-a-policystat-test-user"></a>Creating a PolicyStat test user
