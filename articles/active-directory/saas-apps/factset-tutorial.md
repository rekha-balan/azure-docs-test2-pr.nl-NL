...
---
# <a name="tutorial-azure-active-directory-integration-with-factset"></a>Tutorial: Azure Active Directory integration with FactSet
...
## <a name="adding-factset-from-the-gallery"></a>Adding FactSet from the gallery
...
### <a name="create-a-factset-test-user"></a>Create a FactSet test user
