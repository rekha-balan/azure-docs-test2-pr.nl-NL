...
---
# <a name="tutorial-azure-active-directory-integration-with-workfront"></a>Tutorial: Azure Active Directory integration with Workfront
...
## <a name="adding-workfront-from-the-gallery"></a>Adding Workfront from the gallery
...
### <a name="creating-a-workfront-test-user"></a>Creating a Workfront test user
