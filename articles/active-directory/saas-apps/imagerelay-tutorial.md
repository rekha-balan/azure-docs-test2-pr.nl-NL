...
---
# <a name="tutorial-azure-active-directory-integration-with-image-relay"></a>Tutorial: Azure Active Directory integration with Image Relay
...
## <a name="adding-image-relay-from-the-gallery"></a>Adding Image Relay from the gallery
...
### <a name="creating-an-image-relay-test-user"></a>Creating an Image Relay test user
