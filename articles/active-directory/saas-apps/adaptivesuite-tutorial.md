...
---
# <a name="tutorial-azure-active-directory-integration-with-adaptive-insights"></a>Tutorial: Azure Active Directory integration with Adaptive Insights
...
### <a name="creating-an-adaptive-insights-test-user"></a>Creating an Adaptive Insights test user
