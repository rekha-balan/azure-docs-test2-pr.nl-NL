...
---
# <a name="tutorial-azure-active-directory-integration-with-yardione"></a>Tutorial: Azure Active Directory integration with YardiOne
...
## <a name="adding-yardione-from-the-gallery"></a>Adding YardiOne from the gallery
