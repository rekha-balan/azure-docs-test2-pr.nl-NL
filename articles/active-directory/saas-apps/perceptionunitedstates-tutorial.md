...
---
# <a name="tutorial-azure-active-directory-integration-with-perception-united-states-non-ultipro"></a>Tutorial: Azure Active Directory integration with Perception United States (Non-UltiPro)
...
## <a name="adding-perception-united-states-non-ultipro-from-the-gallery"></a>Adding Perception United States (Non-UltiPro) from the gallery
...
### <a name="create-a-perception-united-states-non-ultipro-test-user"></a>Create a Perception United States (Non-UltiPro) test user
