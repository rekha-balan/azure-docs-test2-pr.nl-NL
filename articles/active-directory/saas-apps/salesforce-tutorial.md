...
---
# <a name="tutorial-azure-active-directory-integration-with-salesforce"></a>Tutorial: Azure Active Directory integration with Salesforce
...
## <a name="adding-salesforce-from-the-gallery"></a>Adding Salesforce from the gallery
...
### <a name="create-a-salesforce-test-user"></a>Create a Salesforce test user
