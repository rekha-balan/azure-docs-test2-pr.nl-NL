...
---
# <a name="tutorial-azure-active-directory-integration-with-openathens"></a>Tutorial: Azure Active Directory integration with OpenAthens
...
## <a name="adding-openathens-from-the-gallery"></a>Adding OpenAthens from the gallery
...
### <a name="create-an-openathens-test-user"></a>Create an OpenAthens test user
