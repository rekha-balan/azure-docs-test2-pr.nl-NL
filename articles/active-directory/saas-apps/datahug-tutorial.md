...
---
# <a name="tutorial-azure-active-directory-integration-with-datahug"></a>Tutorial: Azure Active Directory integration with Datahug
...
## <a name="adding-datahug-from-the-gallery"></a>Adding Datahug from the gallery
...
### <a name="creating-a-datahug-test-user"></a>Creating a Datahug test user
