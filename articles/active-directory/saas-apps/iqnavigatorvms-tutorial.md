...
---
# <a name="tutorial-azure-active-directory-integration-with-iqnavigator-vms"></a>Tutorial: Azure Active Directory integration with IQNavigator VMS
...
## <a name="adding-iqnavigator-vms-from-the-gallery"></a>Adding IQNavigator VMS from the gallery
...
### <a name="creating-a-iqnavigator-vms-test-user"></a>Creating a IQNavigator VMS test user
