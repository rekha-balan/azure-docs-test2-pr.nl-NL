...
## <a name="adding-filecloud-from-the-gallery"></a>Adding FileCloud from the gallery
...
1. On the **FileCloud Domain and URLs** section, perform the following steps:
    ...
    a. In the **Sign-on URL** textbox, type a URL using the following pattern: `https://<subdomain>.filecloudonline.com`
