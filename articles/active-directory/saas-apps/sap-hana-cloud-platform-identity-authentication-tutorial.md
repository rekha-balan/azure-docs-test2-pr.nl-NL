...
---
# <a name="tutorial-azure-active-directory-integration-with-sap-cloud-platform-identity-authentication"></a>Tutorial: Azure Active Directory integration with SAP Cloud Platform Identity Authentication
...
## <a name="add-sap-cloud-platform-identity-authentication-from-the-gallery"></a>Add SAP Cloud Platform Identity Authentication from the gallery
...
### <a name="create-an-sap-cloud-platform-identity-authentication-test-user"></a>Create an SAP Cloud Platform Identity Authentication test user
