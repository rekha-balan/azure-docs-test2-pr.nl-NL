...
---
# <a name="tutorial-azure-active-directory-integration-with-floqast"></a>Tutorial: Azure Active Directory integration with FloQast
...
## <a name="adding-floqast-from-the-gallery"></a>Adding FloQast from the gallery
...
### <a name="create-a-floqast-test-user"></a>Create a FloQast test user
