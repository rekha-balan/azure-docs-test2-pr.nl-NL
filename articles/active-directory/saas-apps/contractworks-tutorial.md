...
---
# <a name="tutorial-azure-active-directory-integration-with-contractworks"></a>Tutorial: Azure Active Directory integration with ContractWorks
...
## <a name="adding-contractworks-from-the-gallery"></a>Adding ContractWorks from the gallery
...
### <a name="create-a-contractworks-test-user"></a>Create a ContractWorks test user
