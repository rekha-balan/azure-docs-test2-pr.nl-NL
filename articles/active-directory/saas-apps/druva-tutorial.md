...
---
# <a name="tutorial-azure-active-directory-integration-with-druva"></a>Tutorial: Azure Active Directory integration with Druva
...
## <a name="adding-druva-from-the-gallery"></a>Adding Druva from the gallery
...
### <a name="create-a-druva-test-user"></a>Create a Druva test user
