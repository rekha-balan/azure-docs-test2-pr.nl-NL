...
---
# <a name="tutorial-azure-active-directory-integration-with-securew2-joinnow-connector"></a>Tutorial: Azure Active Directory integration with SecureW2 JoinNow Connector
...
## <a name="adding-securew2-joinnow-connector-from-the-gallery"></a>Adding SecureW2 JoinNow Connector from the gallery
...
### <a name="create-a-securew2-joinnow-connector-test-user"></a>Create a SecureW2 JoinNow Connector test user
