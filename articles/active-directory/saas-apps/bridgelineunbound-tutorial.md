...
---
# <a name="tutorial-azure-active-directory-integration-with-bridgeline-unbound"></a>Tutorial: Azure Active Directory integration with Bridgeline Unbound
...
## <a name="adding-bridgeline-unbound-from-the-gallery"></a>Adding Bridgeline Unbound from the gallery
...
### <a name="create-a-bridgeline-unbound-test-user"></a>Create a Bridgeline Unbound test user
