...
---
# <a name="tutorial-azure-active-directory-integration-with-bomgar-remote-support"></a>Tutorial: Azure Active Directory integration with Bomgar Remote Support
...
## <a name="adding-bomgar-remote-support-from-the-gallery"></a>Adding Bomgar Remote Support from the gallery
...
### <a name="create-a-bomgar-remote-support-test-user"></a>Create a Bomgar Remote Support test user
