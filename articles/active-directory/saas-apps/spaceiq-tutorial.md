...
---
# <a name="tutorial-azure-active-directory-integration-with-spaceiq"></a>Tutorial: Azure Active Directory integration with SpaceIQ
...
## <a name="adding-spaceiq-from-the-gallery"></a>Adding SpaceIQ from the gallery
...
### <a name="create-a-spaceiq-test-user"></a>Create a SpaceIQ test user
