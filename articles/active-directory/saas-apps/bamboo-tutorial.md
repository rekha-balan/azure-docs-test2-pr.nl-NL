...
---
# <a name="tutorial-azure-active-directory-integration-with-saml-sso-for-bamboo-by-resolution-gmbh"></a>Tutorial: Azure Active Directory integration with SAML SSO for Bamboo by resolution GmbH
...
## <a name="adding-saml-sso-for-bamboo-by-resolution-gmbh-from-the-gallery"></a>Adding SAML SSO for Bamboo by resolution GmbH from the gallery
...
### <a name="create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user"></a>Create a SAML SSO for Bamboo by resolution GmbH test user
