...
---
# <a name="tutorial-azure-active-directory-integration-with-saml-11-token-enabled-lob-app"></a>Tutorial: Azure Active Directory integration with SAML 1.1 Token enabled LOB App
...
## <a name="adding-saml-11-token-enabled-lob-app-from-the-gallery"></a>Adding SAML 1.1 Token enabled LOB App from the gallery
...
### <a name="create-a-saml-11-token-enabled-lob-app-test-user"></a>Create a SAML 1.1 Token enabled LOB App test user
