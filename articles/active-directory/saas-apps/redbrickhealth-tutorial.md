...
---
# <a name="tutorial-azure-active-directory-integration-with-redbrick-health"></a>Tutorial: Azure Active Directory integration with RedBrick Health
...
## <a name="adding-redbrick-health-from-the-gallery"></a>Adding RedBrick Health from the gallery
...
### <a name="create-a-redbrick-health-test-user"></a>Create a RedBrick Health test user
