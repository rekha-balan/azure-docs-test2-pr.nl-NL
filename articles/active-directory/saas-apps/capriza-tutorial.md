...
---
# <a name="tutorial-azure-active-directory-integration-with-capriza-platform"></a>Tutorial: Azure Active Directory integration with Capriza Platform
...
## <a name="adding-capriza-platform-from-the-gallery"></a>Adding Capriza Platform from the gallery
...
### <a name="creating-a-capriza-platform-test-user"></a>Creating a Capriza Platform test user
