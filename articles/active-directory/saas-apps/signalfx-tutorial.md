...
---
# <a name="tutorial-azure-active-directory-integration-with-signalfx"></a>Tutorial: Azure Active Directory integration with SignalFx
...
## <a name="adding-signalfx-from-the-gallery"></a>Adding SignalFx from the gallery
...
### <a name="create-a-signalfx-test-user"></a>Create a SignalFx test user
