...
---
# <a name="tutorial-azure-active-directory-integration-with-clearcompany"></a>Tutorial: Azure Active Directory integration with ClearCompany
...
## <a name="adding-clearcompany-from-the-gallery"></a>Adding ClearCompany from the gallery
...
### <a name="create-a-clearcompany-test-user"></a>Create a ClearCompany test user
