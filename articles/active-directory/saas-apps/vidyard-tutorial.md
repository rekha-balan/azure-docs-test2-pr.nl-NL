...
---
# <a name="tutorial-azure-active-directory-integration-with-vidyard"></a>Tutorial: Azure Active Directory integration with Vidyard
...
## <a name="adding-vidyard-from-the-gallery"></a>Adding Vidyard from the gallery
...
### <a name="create-a-vidyard-test-user"></a>Create a Vidyard test user
