...
---
# <a name="tutorial-azure-active-directory-integration-with-merchlogix"></a>Tutorial: Azure Active Directory integration with Merchlogix
...
## <a name="adding-merchlogix-from-the-gallery"></a>Adding Merchlogix from the gallery
...
### <a name="create-a-merchlogix-test-user"></a>Create a Merchlogix test user
