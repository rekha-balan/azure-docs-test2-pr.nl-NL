...
---
# <a name="tutorial-azure-active-directory-integration-with-servicechannel"></a>Tutorial: Azure Active Directory integration with ServiceChannel
...
## <a name="adding-servicechannel-from-the-gallery"></a>Adding ServiceChannel from the gallery
...
### <a name="creating-a-servicechannel-test-user"></a>Creating a ServiceChannel test user
