...
---
# <a name="tutorial-azure-active-directory-integration-with-carlson-wagonlit-travel"></a>Tutorial: Azure Active Directory integration with Carlson Wagonlit Travel
...
## <a name="adding-carlson-wagonlit-travel-from-the-gallery"></a>Adding Carlson Wagonlit Travel from the gallery
...
### <a name="create-a-carlson-wagonlit-travel-test-user"></a>Create a Carlson Wagonlit Travel test user
