...
---
# <a name="tutorial-configure-github-for-automatic-user-provisioning"></a>Tutorial: Configure GitHub for automatic user provisioning
...
## <a name="assigning-users-to-github"></a>Assigning users to GitHub
...
### <a name="important-tips-for-assigning-users-to-github"></a>Important tips for assigning users to GitHub
...
## <a name="configuring-user-provisioning-to-github"></a>Configuring user provisioning to GitHub 
...
### <a name="configure-automatic-user-account-provisioning-to-github-in-azure-ad"></a>Configure automatic user account provisioning to GitHub in Azure AD
