...
---
# <a name="tutorial-azure-active-directory-integration-with-maxxpoint"></a>Tutorial: Azure Active Directory integration with MaxxPoint
...
## <a name="adding-maxxpoint-from-the-gallery"></a>Adding MaxxPoint from the gallery
...
### <a name="creating-a-maxxpoint-test-user"></a>Creating a MaxxPoint test user
