...
---
# <a name="tutorial-configure-dropbox-for-business-for-automatic-user-provisioning"></a>Tutorial: Configure Dropbox for Business for automatic user provisioning
...
## <a name="assigning-users-to-dropbox-for-business"></a>Assigning users to Dropbox for Business
...
### <a name="important-tips-for-assigning-users-to-dropbox-for-business"></a>Important tips for assigning users to Dropbox for Business
...
## <a name="enable-automated-user-provisioning"></a>Enable Automated User Provisioning
...
### <a name="to-configure-automatic-user-account-provisioning"></a>To configure automatic user account provisioning:
