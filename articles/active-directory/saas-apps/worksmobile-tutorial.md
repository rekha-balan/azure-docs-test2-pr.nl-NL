...
---
# <a name="tutorial-azure-active-directory-integration-with-line-works"></a>Tutorial: Azure Active Directory integration with LINE WORKS
...
## <a name="adding-line-works-from-the-gallery"></a>Adding LINE WORKS from the gallery
...
### <a name="create-a-line-works-test-user"></a>Create a LINE WORKS test user
