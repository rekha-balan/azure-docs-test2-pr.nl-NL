...
---
# <a name="tutorial-azure-active-directory-integration-with-hornbill"></a>Tutorial: Azure Active Directory integration with Hornbill
...
## <a name="adding-hornbill-from-the-gallery"></a>Adding Hornbill from the gallery
...
### <a name="create-a-hornbill-test-user"></a>Create a Hornbill test user
