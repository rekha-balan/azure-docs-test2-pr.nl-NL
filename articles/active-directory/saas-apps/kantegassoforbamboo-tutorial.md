...
---
# <a name="tutorial-azure-active-directory-integration-with-kantega-sso-for-bamboo"></a>Tutorial: Azure Active Directory integration with Kantega SSO for Bamboo
...
## <a name="adding-kantega-sso-for-bamboo-from-the-gallery"></a>Adding Kantega SSO for Bamboo from the gallery
...
### <a name="creating-a-kantega-sso-for-bamboo-test-user"></a>Creating a Kantega SSO for Bamboo test user
