...
---
# <a name="tutorial-azure-active-directory-integration-with-moconavi"></a>Tutorial: Azure Active Directory integration with moconavi
...
## <a name="adding-moconavi-from-the-gallery"></a>Adding moconavi from the gallery
...
### <a name="create-a-moconavi-test-user"></a>Create a moconavi test user
