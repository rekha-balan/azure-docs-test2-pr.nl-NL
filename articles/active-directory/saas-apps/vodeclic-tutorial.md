...
---
# <a name="tutorial-azure-active-directory-integration-with-vodeclic"></a>Tutorial: Azure Active Directory integration with Vodeclic
...
## <a name="add-vodeclic-from-the-gallery"></a>Add Vodeclic from the gallery
...
### <a name="create-a-vodeclic-test-user"></a>Create a Vodeclic test user
