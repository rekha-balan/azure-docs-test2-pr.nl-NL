...
---
# <a name="tutorial-azure-active-directory-integration-with-plangrid"></a>Tutorial: Azure Active Directory integration with PlanGrid
...
## <a name="adding-plangrid-from-the-gallery"></a>Adding PlanGrid from the gallery
...
### <a name="create-a-plangrid-test-user"></a>Create a PlanGrid test user
