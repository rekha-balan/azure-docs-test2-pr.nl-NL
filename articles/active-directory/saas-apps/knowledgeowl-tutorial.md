...
---
# <a name="tutorial-azure-active-directory-integration-with-knowledgeowl"></a>Tutorial: Azure Active Directory integration with KnowledgeOwl
...
## <a name="adding-knowledgeowl-from-the-gallery"></a>Adding KnowledgeOwl from the gallery
...
### <a name="create-a-knowledgeowl-test-user"></a>Create a KnowledgeOwl test user
