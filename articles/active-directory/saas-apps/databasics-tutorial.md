...
---
# <a name="tutorial-azure-active-directory-integration-with-databasics"></a>Tutorial: Azure Active Directory integration with DATABASICS
...
## <a name="adding-databasics-from-the-gallery"></a>Adding DATABASICS from the gallery
...
### <a name="create-a-databasics-test-user"></a>Create a DATABASICS test user
