...
---
# <a name="tutorial-azure-active-directory-integration-with-workpath"></a>Tutorial: Azure Active Directory integration with Workpath
...
## <a name="adding-workpath-from-the-gallery"></a>Adding Workpath from the gallery
...
### <a name="creating-a-workpath-test-user"></a>Creating a Workpath test user
