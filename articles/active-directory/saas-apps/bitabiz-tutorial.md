...
---
# <a name="tutorial-azure-active-directory-integration-with-bitabiz"></a>Tutorial: Azure Active Directory integration with BitaBIZ
...
## <a name="adding-bitabiz-from-the-gallery"></a>Adding BitaBIZ from the gallery
...
### <a name="create-a-bitabiz-test-user"></a>Create a BitaBIZ test user
