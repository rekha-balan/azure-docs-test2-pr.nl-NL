...
---
# <a name="tutorial-azure-active-directory-integration-with-rollbar"></a>Tutorial: Azure Active Directory integration with Rollbar
...
## <a name="adding-rollbar-from-the-gallery"></a>Adding Rollbar from the gallery
...
### <a name="create-a-rollbar-test-user"></a>Create a Rollbar test user
