...
---
# <a name="tutorial-azure-active-directory-integration-with-direct"></a>Tutorial: Azure Active Directory integration with direct
...
## <a name="adding-direct-from-the-gallery"></a>Adding direct from the gallery
...
### <a name="creating-a-direct-test-user"></a>Creating a direct test user
