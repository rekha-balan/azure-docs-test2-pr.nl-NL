...
## <a name="adding-picturepark-from-the-gallery"></a>Adding Picturepark from the gallery
...
### <a name="creating-a-picturepark-test-user"></a>Creating a Picturepark test user
