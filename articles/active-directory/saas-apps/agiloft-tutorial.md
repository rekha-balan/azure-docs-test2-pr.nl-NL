...
---
# <a name="tutorial-azure-active-directory-integration-with-agiloft"></a>Tutorial: Azure Active Directory integration with Agiloft
...
## <a name="adding-agiloft-from-the-gallery"></a>Adding Agiloft from the gallery
...
### <a name="create-an-agiloft-test-user"></a>Create an Agiloft test user
