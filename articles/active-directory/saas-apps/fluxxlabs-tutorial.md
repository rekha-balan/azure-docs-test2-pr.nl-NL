...
---
# <a name="tutorial-azure-active-directory-integration-with-fluxx-labs"></a>Tutorial: Azure Active Directory integration with Fluxx Labs
...
## <a name="adding-fluxx-labs-from-the-gallery"></a>Adding Fluxx Labs from the gallery
...
### <a name="create-a-fluxx-labs-test-user"></a>Create a Fluxx Labs test user
