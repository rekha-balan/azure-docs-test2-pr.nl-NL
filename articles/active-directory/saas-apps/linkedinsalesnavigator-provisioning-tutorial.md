...
---
# <a name="tutorial-configure-linkedin-sales-navigator-for-automatic-user-provisioning"></a>Tutorial: Configure LinkedIn Sales Navigator for automatic user provisioning
...
## <a name="assigning-users-to-linkedin-sales-navigator"></a>Assigning users to LinkedIn Sales Navigator
...
### <a name="important-tips-for-assigning-users-to-linkedin-sales-navigator"></a>Important tips for assigning users to LinkedIn Sales Navigator
...
## <a name="configuring-user-provisioning-to-linkedin-sales-navigator"></a>Configuring user provisioning to LinkedIn Sales Navigator
...
### <a name="to-configure-automatic-user-account-provisioning-to-linkedin-sales-navigator-in-azure-ad"></a>To configure automatic user account provisioning to LinkedIn Sales Navigator in Azure AD:
