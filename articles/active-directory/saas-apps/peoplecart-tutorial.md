...
---
# <a name="tutorial-azure-active-directory-integration-with-peoplecart"></a>Tutorial: Azure Active Directory integration with Peoplecart
...
## <a name="adding-peoplecart-from-the-gallery"></a>Adding Peoplecart from the gallery
...
### <a name="create-a-peoplecart-test-user"></a>Create a Peoplecart test user
