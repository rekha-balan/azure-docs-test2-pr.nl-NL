...
---
# <a name="tutorial-azure-active-directory-integration-with-firmplay---employee-advocacy-for-recruiting"></a>Tutorial: Azure Active Directory integration with FirmPlay - Employee Advocacy for Recruiting
...
## <a name="adding-firmplay---employee-advocacy-for-recruiting-from-the-gallery"></a>Adding FirmPlay - Employee Advocacy for Recruiting from the gallery
...
### <a name="creating-a-firmplay---employee-advocacy-for-recruiting-test-user"></a>Creating a FirmPlay - Employee Advocacy for Recruiting test user
