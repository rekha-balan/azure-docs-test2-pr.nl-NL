...
---
# <a name="tutorial-azure-active-directory-integration-with-turborater"></a>Tutorial: Azure Active Directory integration with TurboRater
...
## <a name="adding-turborater-from-the-gallery"></a>Adding TurboRater from the gallery
...
### <a name="create-a-turborater-test-user"></a>Create a TurboRater test user
