...
---
# <a name="tutorial-azure-active-directory-integration-with-safeconnect"></a>Tutorial: Azure Active Directory integration with SafeConnect
...
## <a name="adding-safeconnect-from-the-gallery"></a>Adding SafeConnect from the gallery
...
### <a name="create-a-safeconnect-test-user"></a>Create a SafeConnect test user
