...
---
# <a name="tutorial-azure-active-directory-integration-with-fidelity-netbenefits"></a>Tutorial: Azure Active Directory integration with Fidelity NetBenefits
...
## <a name="adding-fidelity-netbenefits-from-the-gallery"></a>Adding Fidelity NetBenefits from the gallery
...
### <a name="create-a-fidelity-netbenefits-test-user"></a>Create a Fidelity NetBenefits test user
