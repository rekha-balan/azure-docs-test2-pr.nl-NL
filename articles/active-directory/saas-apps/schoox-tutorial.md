...
---
# <a name="tutorial-azure-active-directory-integration-with-schoox"></a>Tutorial: Azure Active Directory integration with Schoox
...
## <a name="adding-schoox-from-the-gallery"></a>Adding Schoox from the gallery
...
### <a name="create-a-schoox-test-user"></a>Create a Schoox test user
