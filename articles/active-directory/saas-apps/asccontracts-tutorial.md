...
---
# <a name="tutorial-azure-active-directory-integration-with-asc-contracts"></a>Tutorial: Azure Active Directory integration with ASC Contracts
...
## <a name="adding-asc-contracts-from-the-gallery"></a>Adding ASC Contracts from the gallery
...
### <a name="creating-an-asc-contracts-test-user"></a>Creating an ASC Contracts test user
