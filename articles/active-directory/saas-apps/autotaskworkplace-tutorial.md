...
---
# <a name="tutorial-azure-active-directory-integration-with-autotask-workplace"></a>Tutorial: Azure Active Directory integration with Autotask Workplace
...
## <a name="adding-autotask-workplace-from-the-gallery"></a>Adding Autotask Workplace from the gallery
...
### <a name="create-an-autotask-workplace-test-user"></a>Create an Autotask Workplace test user
