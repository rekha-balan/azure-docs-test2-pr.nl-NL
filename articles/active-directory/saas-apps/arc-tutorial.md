...
---
# <a name="tutorial-azure-active-directory-integration-with-arc-publishing---sso"></a>Tutorial: Azure Active Directory integration with Arc Publishing - SSO
...
## <a name="adding-arc-publishing---sso-from-the-gallery"></a>Adding Arc Publishing - SSO from the gallery
...
### <a name="create-an-arc-publishing---sso-test-user"></a>Create an Arc Publishing - SSO test user
