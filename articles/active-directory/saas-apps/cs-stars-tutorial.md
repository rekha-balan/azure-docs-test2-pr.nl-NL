...
1. In the search box, type **CS Stars**.

    ![Creating an Azure AD test user](./media/cs-stars-tutorial/tutorial_csstars_search.png)

1. In the results panel, select **CS Stars**, and then click **Add** button to add the application.
...
1. **[Creating a CS Stars test user](#creating-a-cs-stars-test-user)** - to have a counterpart of Britta Simon in CS Stars that is linked to the Azure AD representation of user.
