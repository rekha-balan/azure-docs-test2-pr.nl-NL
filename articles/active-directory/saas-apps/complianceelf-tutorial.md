...
---
# <a name="tutorial-azure-active-directory-integration-with-compliance-elf"></a>Tutorial: Azure Active Directory integration with Compliance ELF
...
## <a name="adding-compliance-elf-from-the-gallery"></a>Adding Compliance ELF from the gallery
...
### <a name="create-a-compliance-elf-test-user"></a>Create a Compliance ELF test user
