...
---
# <a name="tutorial-azure-active-directory-integration-with-insignia-saml-sso"></a>Tutorial: Azure Active Directory integration with Insignia SAML SSO
...
## <a name="adding-insignia-saml-sso-from-the-gallery"></a>Adding Insignia SAML SSO from the gallery
...
### <a name="create-an-insignia-saml-sso-test-user"></a>Create an Insignia SAML SSO test user
