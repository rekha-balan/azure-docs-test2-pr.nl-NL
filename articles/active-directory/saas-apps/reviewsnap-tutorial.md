...
---
# <a name="tutorial-azure-active-directory-integration-with-reviewsnap"></a>Tutorial: Azure Active Directory integration with Reviewsnap
...
## <a name="adding-reviewsnap-from-the-gallery"></a>Adding Reviewsnap from the gallery
...
### <a name="create-a-reviewsnap-test-user"></a>Create a Reviewsnap test user
