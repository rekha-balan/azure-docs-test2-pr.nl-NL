...
---
# <a name="tutorial-azure-active-directory-integration-with-softeon-wms"></a>Tutorial: Azure Active Directory integration with Softeon WMS
...
## <a name="adding-softeon-wms-from-the-gallery"></a>Adding Softeon WMS from the gallery
...
### <a name="creating-a-softeon-wms-test-user"></a>Creating a Softeon WMS test user
