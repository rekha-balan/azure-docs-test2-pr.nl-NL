...
---
# <a name="tutorial-azure-active-directory-integration-with-imagineer-webvision"></a>Tutorial: Azure Active Directory integration with Imagineer WebVision
...
## <a name="adding-imagineer-webvision-from-the-gallery"></a>Adding Imagineer WebVision from the gallery
...
### <a name="create-an-imagineer-webvision-test-user"></a>Create an Imagineer WebVision test user
