...
---
# <a name="tutorial-azure-active-directory-integration-with-kanbanize"></a>Tutorial: Azure Active Directory integration with Kanbanize
...
## <a name="adding-kanbanize-from-the-gallery"></a>Adding Kanbanize from the gallery
...
### <a name="create-a-kanbanize-test-user"></a>Create a Kanbanize test user
