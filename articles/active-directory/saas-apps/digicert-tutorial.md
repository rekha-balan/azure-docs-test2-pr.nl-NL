...
---
# <a name="tutorial-azure-active-directory-integration-with-digicert"></a>Tutorial: Azure Active Directory integration with DigiCert
...
## <a name="adding-digicert-from-the-gallery"></a>Adding DigiCert from the gallery
...
### <a name="creating-a-digicert-test-user"></a>Creating a DigiCert test user
