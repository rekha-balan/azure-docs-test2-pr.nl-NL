...
---
# <a name="tutorial-azure-active-directory-integration-with-adobe-experience-manager"></a>Tutorial: Azure Active Directory integration with Adobe Experience Manager
...
## <a name="add-adobe-experience-manager-from-the-gallery"></a>Add Adobe Experience Manager from the gallery
...
### <a name="create-an-adobe-experience-manager-test-user"></a>Create an Adobe Experience Manager test user
