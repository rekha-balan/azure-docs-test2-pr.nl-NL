...
---
# <a name="tutorial-azure-active-directory-integration-with-secret-server-on-premises"></a>Tutorial: Azure Active Directory integration with Secret Server (On-Premises)
...
## <a name="adding-secret-server-on-premises-from-the-gallery"></a>Adding Secret Server (On-Premises) from the gallery
...
### <a name="create-a-secret-server-on-premises-test-user"></a>Create a Secret Server (On-Premises) test user
