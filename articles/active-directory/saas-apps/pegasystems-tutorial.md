...
---
# <a name="tutorial-azure-active-directory-integration-with-pega-systems"></a>Tutorial: Azure Active Directory integration with Pega Systems
...
## <a name="adding-pega-systems-from-the-gallery"></a>Adding Pega Systems from the gallery
...
### <a name="create-a-pega-systems-test-user"></a>Create a Pega Systems test user
