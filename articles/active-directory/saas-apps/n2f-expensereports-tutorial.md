...
---
# <a name="tutorial-azure-active-directory-integration-with-n2f---expense-reports"></a>Tutorial: Azure Active Directory integration with N2F - Expense reports
...
## <a name="adding-n2f---expense-reports-from-the-gallery"></a>Adding N2F - Expense reports from the gallery
...
### <a name="create-a-n2f---expense-reports-test-user"></a>Create a N2F - Expense reports test user
