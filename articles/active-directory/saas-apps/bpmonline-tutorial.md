...
---
# <a name="tutorial-azure-active-directory-integration-with-bpmonline"></a>Tutorial: Azure Active Directory integration with Bpm’online
...
## <a name="adding-bpmonline-from-the-gallery"></a>Adding Bpm’online from the gallery
...
### <a name="create-a-bpmonline-test-user"></a>Create a Bpm’online test user
