...
1. Check **Show advanced URL settings**, perform the following step:    
    ...
    In the **Relay state** textbox, type a URL using the following pattern: `https://webapp.lifesizecloud.com/?ent=<identifier>`
...
### <a name="creating-a-lifesize-cloud-test-user"></a>Creating a Lifesize Cloud test user
