...
---
# <a name="tutorial-azure-active-directory-integration-with-formcom"></a>Tutorial: Azure Active Directory integration with Form.com
...
## <a name="adding-formcom-from-the-gallery"></a>Adding Form.com from the gallery
...
### <a name="create-a-formcom-test-user"></a>Create a Form.com test user
