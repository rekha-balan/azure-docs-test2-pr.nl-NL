...
---
# <a name="tutorial-azure-active-directory-integration-with-competencyiq"></a>Tutorial: Azure Active Directory integration with CompetencyIQ
...
## <a name="adding-competencyiq-from-the-gallery"></a>Adding CompetencyIQ from the gallery
...
### <a name="creating-a-competencyiq-test-user"></a>Creating a CompetencyIQ test user
