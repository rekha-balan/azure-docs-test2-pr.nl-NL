...
---
# <a name="tutorial-azure-active-directory-integration-with-communifire"></a>Tutorial: Azure Active Directory integration with Communifire
...
## <a name="adding-communifire-from-the-gallery"></a>Adding Communifire from the gallery
...
### <a name="create-a-communifire-test-user"></a>Create a Communifire test user
