...
---
# <a name="tutorial-configure-workplace-by-facebook-for-automatic-user-provisioning"></a>Tutorial: Configure Workplace by Facebook for automatic user provisioning
...
### <a name="important-tips-for-assigning-users-to-workplace-by-facebook"></a>Important tips for assigning users to Workplace by Facebook
...
## <a name="enable-user-provisioning"></a>Enable User Provisioning
...
### <a name="to-configure-user-account-provisioning-to-workplace-by-facebook-in-azure-ad"></a>To configure user account provisioning to Workplace by Facebook in Azure AD:
