...
---
# <a name="tutorial-azure-active-directory-integration-with-neota-logic-studio"></a>Tutorial: Azure Active Directory integration with Neota Logic Studio
...
## <a name="adding-neota-logic-studio-from-the-gallery"></a>Adding Neota Logic Studio from the gallery
...
### <a name="creating-a-neota-logic-studio-test-user"></a>Creating a Neota Logic Studio test user
