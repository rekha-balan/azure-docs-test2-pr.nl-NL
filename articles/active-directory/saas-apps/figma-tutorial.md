...
---
# <a name="tutorial-azure-active-directory-integration-with-figma"></a>Tutorial: Azure Active Directory integration with Figma
...
> [!NOTE]
> To test the steps in this tutorial, we do not recommend using a production environment. New customers and active subscribers of Figma Professional Team may contact Figma to [upgrade their subscription](https://www.figma.com/pricing/) to the Figma Organization Tier.
...
## <a name="adding-figma-from-the-gallery"></a>Adding Figma from the gallery
...
### <a name="create-a-figma-test-user"></a>Create a Figma test user
