...
---
# <a name="tutorial-azure-active-directory-integration-with-palo-alto-networks---aperture"></a>Tutorial: Azure Active Directory integration with Palo Alto Networks - Aperture
...
## <a name="adding-palo-alto-networks---aperture-from-the-gallery"></a>Adding Palo Alto Networks - Aperture from the gallery
...
### <a name="create-a-palo-alto-networks---aperture-test-user"></a>Create a Palo Alto Networks - Aperture test user
