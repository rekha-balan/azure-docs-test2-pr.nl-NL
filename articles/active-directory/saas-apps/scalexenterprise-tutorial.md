...
---
# <a name="tutorial-azure-active-directory-integration-with-scalex-enterprise"></a>Tutorial: Azure Active Directory integration with ScaleX Enterprise
...
## <a name="adding-scalex-enterprise-from-the-gallery"></a>Adding ScaleX Enterprise from the gallery
...
### <a name="creating-a-scalex-enterprise-test-user"></a>Creating a ScaleX Enterprise test user
