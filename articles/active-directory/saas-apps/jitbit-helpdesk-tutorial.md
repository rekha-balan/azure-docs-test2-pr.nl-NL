...
## <a name="adding-jitbit-helpdesk-from-the-gallery"></a>Adding Jitbit Helpdesk from the gallery
...
1. In the search box, type **Jitbit Helpdesk**.

    ![Creating an Azure AD test user](./media/jitbit-helpdesk-tutorial/tutorial_jitbit-helpdesk_search.png)

1. In the results panel, select **Jitbit Helpdesk**, and then click **Add** button to add the application.
...
### <a name="creating-a-jitbit-helpdesk-test-user"></a>Creating a Jitbit Helpdesk test user
