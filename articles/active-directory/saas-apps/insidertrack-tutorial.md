...
---
# <a name="tutorial-azure-active-directory-integration-with-insider-track"></a>Tutorial: Azure Active Directory integration with Insider Track
...
## <a name="adding-insider-track-from-the-gallery"></a>Adding Insider Track from the gallery
...
### <a name="create-an-insider-track-test-user"></a>Create an Insider Track test user
