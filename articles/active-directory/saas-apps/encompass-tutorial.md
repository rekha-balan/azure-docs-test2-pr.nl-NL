...
---
# <a name="tutorial-azure-active-directory-integration-with-encompass"></a>Tutorial: Azure Active Directory integration with Encompass
...
## <a name="adding-encompass-from-the-gallery"></a>Adding Encompass from the gallery
...
1. In the search box, type **Encompass**, select **Encompass** from result panel then click **Add** button to add the application.
...
### <a name="create-a-encompass-test-user"></a>Create a Encompass test user
