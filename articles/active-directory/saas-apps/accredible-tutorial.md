...
---
# <a name="tutorial-azure-active-directory-integration-with-accredible"></a>Tutorial: Azure Active Directory integration with Accredible
...
## <a name="adding-accredible-from-the-gallery"></a>Adding Accredible from the gallery
...
### <a name="create-an-accredible-test-user"></a>Create an Accredible test user
