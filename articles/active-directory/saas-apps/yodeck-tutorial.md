...
---
# <a name="tutorial-azure-active-directory-integration-with-yodeck"></a>Tutorial: Azure Active Directory integration with Yodeck
...
## <a name="adding-yodeck-from-the-gallery"></a>Adding Yodeck from the gallery
...
### <a name="create-a-yodeck-test-user"></a>Create a Yodeck test user
