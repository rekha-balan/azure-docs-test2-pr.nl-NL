...
---
# <a name="tutorial-azure-active-directory-integration-with-grovo"></a>Tutorial: Azure Active Directory integration with Grovo
...
## <a name="adding-grovo-from-the-gallery"></a>Adding Grovo from the gallery
...
### <a name="create-a-grovo-test-user"></a>Create a Grovo test user
