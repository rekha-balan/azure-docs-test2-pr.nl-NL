...
---
# <a name="tutorial-azure-active-directory-integration-with-multiple-amazon-web-services-aws-accounts"></a>Tutorial: Azure Active Directory integration with multiple Amazon Web Services (AWS) accounts
...
## <a name="adding-amazon-web-services-aws-from-the-gallery"></a>Adding Amazon Web Services (AWS) from the gallery
...
24. Open [Azure AD Graph Explorer](https://developer.microsoft.com/graph/graph-explorer) in another window.
    ...
    If you are using multiple directories, then you can use following pattern, which has your primary domain in it `https://graph.microsoft.com/beta/contoso.com/servicePrincipals`
