...
---
# <a name="tutorial-azure-active-directory-integration-with-lessonlycom"></a>Tutorial: Azure Active Directory integration with Lessonly.com
...
## <a name="adding-lessonlycom-from-the-gallery"></a>Adding Lessonly.com from the gallery
...
### <a name="creating-a-lessonlycom-test-user"></a>Creating a Lessonly.com test user
