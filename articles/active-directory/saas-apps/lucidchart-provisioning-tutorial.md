...
---
# <a name="tutorial-configure-lucidchart-for-automatic-user-provisioning"></a>Tutorial: Configure LucidChart for automatic user provisioning
...
## <a name="assigning-users-to-lucidchart"></a>Assigning users to LucidChart
...
### <a name="important-tips-for-assigning-users-to-lucidchart"></a>Important tips for assigning users to LucidChart
...
## <a name="configuring-user-provisioning-to-lucidchart"></a>Configuring user provisioning to LucidChart 
...
### <a name="configure-automatic-user-account-provisioning-to-lucidchart-in-azure-ad"></a>Configure automatic user account provisioning to LucidChart in Azure AD
