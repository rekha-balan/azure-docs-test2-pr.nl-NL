...
---
# <a name="tutorial-azure-active-directory-integration-with-palo-alto-networks---captive-portal"></a>Tutorial: Azure Active Directory integration with Palo Alto Networks - Captive Portal
...
## <a name="adding-palo-alto-networks---captive-portal-from-the-gallery"></a>Adding Palo Alto Networks - Captive Portal from the gallery
...
### <a name="create-a-palo-alto-networks---captive-portal-test-user"></a>Create a Palo Alto Networks - Captive Portal test user
