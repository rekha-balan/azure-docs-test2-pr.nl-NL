...
---
# <a name="tutorial-azure-active-directory-integration-with-loginradius"></a>Tutorial: Azure Active Directory integration with LoginRadius
...
## <a name="adding-loginradius-from-the-gallery"></a>Adding LoginRadius from the gallery
...
### <a name="create-a-loginradius-test-user"></a>Create a LoginRadius test user
