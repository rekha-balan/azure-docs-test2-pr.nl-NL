...
---
# <a name="tutorial-azure-active-directory-integration-with-flock"></a>Tutorial: Azure Active Directory integration with Flock
...
## <a name="adding-flock-from-the-gallery"></a>Adding Flock from the gallery
...
### <a name="create-a-flock-test-user"></a>Create a Flock test user
