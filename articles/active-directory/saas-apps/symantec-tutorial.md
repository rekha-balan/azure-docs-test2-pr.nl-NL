...
---
# <a name="tutorial-azure-active-directory-integration-with-symantec-web-security-service-wss"></a>Tutorial: Azure Active Directory integration with Symantec Web Security Service (WSS)
...
## <a name="adding-symantec-web-security-service-wss-from-the-gallery"></a>Adding Symantec Web Security Service (WSS) from the gallery
...
### <a name="create-a-symantec-web-security-service-wss-test-user"></a>Create a Symantec Web Security Service (WSS) test user
