...
---
# <a name="tutorial-azure-active-directory-integration-with-trisotech-digital-enterprise-server"></a>Tutorial: Azure Active Directory integration with Trisotech Digital Enterprise Server
...
## <a name="adding-trisotech-digital-enterprise-server-from-the-gallery"></a>Adding Trisotech Digital Enterprise Server from the gallery
...
### <a name="create-a-trisotech-digital-enterprise-server-test-user"></a>Create a Trisotech Digital Enterprise Server test user
