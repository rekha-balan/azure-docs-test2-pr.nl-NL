...
---
# <a name="tutorial-azure-active-directory-integration-with-snowflake"></a>Tutorial: Azure Active Directory integration with Snowflake
...
## <a name="adding-snowflake-from-the-gallery"></a>Adding Snowflake from the gallery
...
### <a name="create-a-snowflake-test-user"></a>Create a Snowflake test user
