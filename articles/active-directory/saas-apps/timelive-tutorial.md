...
---
# <a name="tutorial-azure-active-directory-integration-with-timelive"></a>Tutorial: Azure Active Directory integration with TimeLive
...
## <a name="adding-timelive-from-the-gallery"></a>Adding TimeLive from the gallery
...
### <a name="create-a-timelive-test-user"></a>Create a TimeLive test user
