...
---
# <a name="tutorial-azure-active-directory-integration-with-riskware"></a>Tutorial: Azure Active Directory integration with Riskware
...
## <a name="adding-riskware-from-the-gallery"></a>Adding Riskware from the gallery
...
### <a name="create-a-riskware-test-user"></a>Create a Riskware test user
