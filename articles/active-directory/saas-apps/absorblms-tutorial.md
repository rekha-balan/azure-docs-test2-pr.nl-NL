...
---
# <a name="tutorial-azure-active-directory-integration-with-absorb-lms"></a>Tutorial: Azure Active Directory integration with Absorb LMS
...
## <a name="add-absorb-lms-from-the-gallery"></a>Add Absorb LMS from the gallery
...
### <a name="create-an-absorb-lms-test-user"></a>Create an Absorb LMS test user
