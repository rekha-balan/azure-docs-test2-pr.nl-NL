...
---
# <a name="tutorial-azure-active-directory-integration-with-iwellnessnow"></a>Tutorial: Azure Active Directory integration with iWellnessNow
...
## <a name="adding-iwellnessnow-from-the-gallery"></a>Adding iWellnessNow from the gallery
...
### <a name="create-an-iwellnessnow-test-user"></a>Create an iWellnessNow test user
