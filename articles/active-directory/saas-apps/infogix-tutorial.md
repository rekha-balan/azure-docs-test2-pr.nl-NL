...
---
# <a name="tutorial-azure-active-directory-integration-with-infogix-data3sixty-govern"></a>Tutorial: Azure Active Directory integration with Infogix Data3Sixty Govern
...
## <a name="adding-infogix-data3sixty-govern-from-the-gallery"></a>Adding Infogix Data3Sixty Govern from the gallery
...
### <a name="create-an-infogix-data3sixty-govern-test-user"></a>Create an Infogix Data3Sixty Govern test user
