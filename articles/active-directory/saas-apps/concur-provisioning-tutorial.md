...
---
# <a name="tutorial-configure-concur-for-automatic-user-provisioning"></a>Tutorial: Configure Concur for automatic user provisioning
...
## <a name="assigning-users-to-concur"></a>Assigning users to Concur
...
### <a name="important-tips-for-assigning-users-to-concur"></a>Important tips for assigning users to Concur
