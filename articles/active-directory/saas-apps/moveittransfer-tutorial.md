...
---
# <a name="tutorial-azure-active-directory-integration-with-moveit-transfer---azure-ad-integration"></a>Tutorial: Azure Active Directory integration with MOVEit Transfer - Azure AD integration
...
## <a name="adding-moveit-transfer---azure-ad-integration-from-the-gallery"></a>Adding MOVEit Transfer - Azure AD integration from the gallery
...
### <a name="create-a-moveit-transfer---azure-ad-integration-test-user"></a>Create a MOVEit Transfer - Azure AD integration test user
