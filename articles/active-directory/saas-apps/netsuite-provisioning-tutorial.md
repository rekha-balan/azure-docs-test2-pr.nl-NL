...
---
# <a name="tutorial-configuring-netsuite-for-automatic-user-provisioning"></a>Tutorial: Configuring Netsuite for automatic user provisioning
...
## <a name="assigning-users-to-netsuite"></a>Assigning users to Netsuite
...
### <a name="important-tips-for-assigning-users-to-netsuite"></a>Important tips for assigning users to Netsuite
...
### <a name="to-configure-user-account-provisioning"></a>To configure user account provisioning:
