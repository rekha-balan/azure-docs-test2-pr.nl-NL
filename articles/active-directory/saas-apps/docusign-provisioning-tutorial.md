...
---
# <a name="tutorial-configure-docusign-for-automatic-user-provisioning"></a>Tutorial: Configure DocuSign for automatic user provisioning
...
## <a name="assigning-users-to-docusign"></a>Assigning users to DocuSign
...
### <a name="important-tips-for-assigning-users-to-docusign"></a>Important tips for assigning users to DocuSign
