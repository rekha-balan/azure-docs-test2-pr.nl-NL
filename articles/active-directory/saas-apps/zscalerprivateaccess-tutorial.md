...
---
# <a name="tutorial-azure-active-directory-integration-with-zscaler-private-access-zpa"></a>Tutorial: Azure Active Directory integration with Zscaler Private Access (ZPA)
...
## <a name="adding-zscaler-private-access-zpa-from-the-gallery"></a>Adding Zscaler Private Access (ZPA) from the gallery
...
### <a name="creating-a-zscaler-private-access-zpa-test-user"></a>Creating a Zscaler Private Access (ZPA) test user
