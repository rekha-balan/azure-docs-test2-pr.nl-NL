...
---
# <a name="tutorial-azure-active-directory-integration-with-ziflow"></a>Tutorial: Azure Active Directory integration with Ziflow
...
## <a name="adding-ziflow-from-the-gallery"></a>Adding Ziflow from the gallery
...
### <a name="create-a-ziflow-test-user"></a>Create a Ziflow test user
