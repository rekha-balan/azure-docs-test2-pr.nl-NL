...
## <a name="adding-mimecast-personal-portal-from-the-gallery"></a>Adding Mimecast Personal Portal from the gallery
...
### <a name="create-a-mimecast-personal-portal-test-user"></a>Create a Mimecast Personal Portal test user
