...
---
# <a name="tutorial-azure-active-directory-integration-with-spacio"></a>Tutorial: Azure Active Directory integration with Spacio
...
## <a name="adding-spacio-from-the-gallery"></a>Adding Spacio from the gallery
...
### <a name="create-a-spacio-test-user"></a>Create a Spacio test user
