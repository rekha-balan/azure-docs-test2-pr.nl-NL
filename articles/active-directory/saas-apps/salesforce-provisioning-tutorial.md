...
---
# <a name="tutorial-configure-salesforce-for-automatic-user-provisioning"></a>Tutorial: Configure Salesforce for automatic user provisioning
...
## <a name="assigning-users-to-salesforce"></a>Assigning users to Salesforce
...
### <a name="important-tips-for-assigning-users-to-salesforce"></a>Important tips for assigning users to Salesforce
