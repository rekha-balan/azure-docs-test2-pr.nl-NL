...
---
# <a name="tutorial-azure-active-directory-integration-with-reflektive"></a>Tutorial: Azure Active Directory integration with Reflektive
...
## <a name="adding-reflektive-from-the-gallery"></a>Adding Reflektive from the gallery
...
### <a name="create-a-reflektive-test-user"></a>Create a Reflektive test user
