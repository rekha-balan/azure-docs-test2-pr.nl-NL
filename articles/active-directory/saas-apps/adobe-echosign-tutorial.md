...
---
# <a name="tutorial-azure-active-directory-integration-with-adobe-sign"></a>Tutorial: Azure Active Directory integration with Adobe Sign
...
## <a name="add-adobe-sign-from-the-gallery"></a>Add Adobe Sign from the gallery
...
### <a name="create-an-adobe-sign-test-user"></a>Create an Adobe Sign test user
