...
---
# <a name="tutorial-configure-gotomeeting-for-automatic-user-provisioning"></a>Tutorial: Configure GoToMeeting for automatic user provisioning
...
## <a name="assigning-users-to-gotomeeting"></a>Assigning users to GoToMeeting
...
### <a name="important-tips-for-assigning-users-to-gotomeeting"></a>Important tips for assigning users to GoToMeeting
