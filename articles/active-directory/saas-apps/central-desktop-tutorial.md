...
## <a name="add-central-desktop-from-the-gallery"></a>Add Central Desktop from the gallery
...
1. In the **Message Signature Verification Method** section, take the following steps:
    ...
    ![Message signature verification method](./media/central-desktop-tutorial/ic769565.png "Message Signature Verification Method") a. Select **Certificate**.
...
### <a name="create-a-central-desktop-test-user"></a>Create a Central Desktop test user
