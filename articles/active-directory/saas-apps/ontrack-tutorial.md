...
---
# <a name="tutorial-azure-active-directory-integration-with-ontrack"></a>Tutorial: Azure Active Directory integration with OnTrack
...
## <a name="adding-ontrack-from-the-gallery"></a>Adding OnTrack from the gallery
...
### <a name="create-an-ontrack-test-user"></a>Create an OnTrack test user
