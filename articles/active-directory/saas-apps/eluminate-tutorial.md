...
---
# <a name="tutorial-azure-active-directory-integration-with-eluminate"></a>Tutorial: Azure Active Directory integration with eLuminate
...
## <a name="adding-eluminate-from-the-gallery"></a>Adding eLuminate from the gallery
...
### <a name="create-a-eluminate-test-user"></a>Create a eLuminate test user
