...
---
# <a name="tutorial-azure-active-directory-integration-with-lockpath-keylight"></a>Tutorial: Azure Active Directory integration with LockPath Keylight
...
## <a name="adding-lockpath-keylight-from-the-gallery"></a>Adding LockPath Keylight from the gallery
...
### <a name="creating-a-lockpath-keylight-test-user"></a>Creating a LockPath Keylight test user
