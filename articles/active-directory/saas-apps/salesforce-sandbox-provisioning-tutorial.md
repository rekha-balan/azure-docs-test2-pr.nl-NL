...
---
# <a name="tutorial-configure-salesforce-sandbox-for-automatic-user-provisioning"></a>Tutorial: Configure Salesforce Sandbox for automatic user provisioning
...
## <a name="assigning-users-to-salesforce-sandbox"></a>Assigning users to Salesforce Sandbox
...
### <a name="important-tips-for-assigning-users-to-salesforce-sandbox"></a>Important tips for assigning users to Salesforce Sandbox
...
### <a name="configure-automatic-user-account-provisioning"></a>Configure automatic user account provisioning
