...
---
# <a name="tutorial-azure-active-directory-integration-with-nomadic"></a>Tutorial: Azure Active Directory integration with Nomadic
...
## <a name="add-nomadic-from-the-gallery"></a>Add Nomadic from the gallery
...
### <a name="create-a-nomadic-test-user"></a>Create a Nomadic test user
