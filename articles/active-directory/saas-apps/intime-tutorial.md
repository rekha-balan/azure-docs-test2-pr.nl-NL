...
---
# <a name="tutorial-azure-active-directory-integration-with-intime"></a>Tutorial: Azure Active Directory integration with InTime
...
## <a name="adding-intime-from-the-gallery"></a>Adding InTime from the gallery
...
### <a name="create-a-intime-test-user"></a>Create a InTime test user
