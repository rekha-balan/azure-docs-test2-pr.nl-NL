...
## <a name="adding-gigya-from-the-gallery"></a>Adding Gigya from the gallery
...
1. In the search box, type **Gigya**.

    ![Creating an Azure AD test user](./media/gigya-tutorial/tutorial_gigya_search.png)

1. In the results panel, select **Gigya**, and then click **Add** button to add the application.
...
1. In the **SAML Login** section, perform the following steps:
...
### <a name="creating-a-gigya-test-user"></a>Creating a Gigya test user
...
1. Go to **Admin \> Manage Users**, and then click **Invite Users**.
   
    ![Manage Users](./media/gigya-tutorial/ic789535.png "Manage Users")

1. On the Invite Users dialog, perform the following steps:
