...
---
# <a name="integrate-azure-active-directory-with-box"></a>Integrate Azure Active Directory with Box
...
## <a name="add-box-from-the-gallery"></a>Add Box from the gallery
...
### <a name="create-a-box-test-user"></a>Create a Box test user
