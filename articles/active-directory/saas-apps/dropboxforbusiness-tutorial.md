...
## <a name="adding-dropbox-for-business-from-the-gallery"></a>Adding Dropbox for Business from the gallery
...
### <a name="create-a-dropbox-for-business-test-user"></a>Create a Dropbox for Business test user
