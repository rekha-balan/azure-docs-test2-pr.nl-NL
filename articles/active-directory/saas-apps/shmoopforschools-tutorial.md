...
---
# <a name="tutorial-azure-active-directory-integration-with-shmoop-for-schools"></a>Tutorial: Azure Active Directory integration with Shmoop For Schools
...
## <a name="add-shmoop-for-schools-from-the-gallery"></a>Add Shmoop For Schools from the gallery
...
### <a name="create-a-shmoop-for-schools-test-user"></a>Create a Shmoop For Schools test user
