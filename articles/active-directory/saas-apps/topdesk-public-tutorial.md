...
---
# <a name="tutorial-azure-active-directory-integration-with-topdesk---public"></a>Tutorial: Azure Active Directory integration with TOPdesk - Public
...
## <a name="adding-topdesk---public-from-the-gallery"></a>Adding TOPdesk - Public from the gallery
...
### <a name="create-a-topdesk---public-test-user"></a>Create a TOPdesk - Public test user
