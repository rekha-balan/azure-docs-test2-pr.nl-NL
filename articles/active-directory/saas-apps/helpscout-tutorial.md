...
---
# <a name="tutorial-azure-active-directory-integration-with-help-scout"></a>Tutorial: Azure Active Directory integration with Help Scout
...
## <a name="adding-help-scout-from-the-gallery"></a>Adding Help Scout from the gallery
...
### <a name="create-a-help-scout-test-user"></a>Create a Help Scout test user
