...
---
# <a name="tutorial-azure-active-directory-integration-with-keeper-password-manager--digital-vault"></a>Tutorial: Azure Active Directory integration with Keeper Password Manager & Digital Vault
...
## <a name="adding-keeper-password-manager--digital-vault-from-the-gallery"></a>Adding Keeper Password Manager & Digital Vault from the gallery
...
### <a name="creating-a-keeper-password-manager--digital-vault-test-user"></a>Creating a Keeper Password Manager & Digital Vault test user
...
When you click the Keeper Password Manager & Digital Vault tile in the Access Panel, you should get login page of Keeper Password Manager & Digital Vault application. Upon successful authentication, you should get into the application. For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/active-directory-saas-access-panel-introduction.md). 
