...
---
# <a name="tutorial-azure-active-directory-integration-with-jamf-pro"></a>Tutorial: Azure Active Directory integration with Jamf Pro
...
## <a name="adding-jamf-pro-from-the-gallery"></a>Adding Jamf Pro from the gallery
...
### <a name="create-a-jamf-pro-test-user"></a>Create a Jamf Pro test user
