...
---
# <a name="tutorial-azure-active-directory-integration-with-bc-in-the-cloud"></a>Tutorial: Azure Active Directory integration with BC in the Cloud
...
## <a name="adding-bc-in-the-cloud-from-the-gallery"></a>Adding BC in the Cloud from the gallery
...
1. To add new application, click **Add** button on the top of dialog.

    ![Applications][3]

1. In the search box, type **BC in the Cloud**.

    ![Creating an Azure AD test user](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_search.png)

1. In the results panel, select **BC in the Cloud**, and then click **Add** button to add the application.
...
### <a name="creating-a-bc-in-the-cloud-test-user"></a>Creating a BC in the Cloud test user
