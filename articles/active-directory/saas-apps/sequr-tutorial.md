...
---
# <a name="tutorial-azure-active-directory-integration-with-sequr"></a>Tutorial: Azure Active Directory integration with Sequr
...
## <a name="adding-sequr-from-the-gallery"></a>Adding Sequr from the gallery
...
### <a name="create-a-sequr-test-user"></a>Create a Sequr test user
