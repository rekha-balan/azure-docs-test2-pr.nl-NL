...
---
# <a name="tutorial-azure-active-directory-integration-with-versal"></a>Tutorial: Azure Active Directory integration with Versal
...
## <a name="adding-versal-from-the-gallery"></a>Adding Versal from the gallery
...
Please see the [Embedding Organizational Courses](https://support.versal.com/hc/en-us/articles/203271866-Embedding-organizational-courses) **SAML Single Sign-On** support guide for instructions on how to embed a Versal course with support for Azure AD single sign-on. 
