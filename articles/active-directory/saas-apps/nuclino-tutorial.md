...
---
# <a name="tutorial-azure-active-directory-integration-with-nuclino"></a>Tutorial: Azure Active Directory integration with Nuclino
...
## <a name="adding-nuclino-from-the-gallery"></a>Adding Nuclino from the gallery
...
### <a name="create-a-nuclino-test-user"></a>Create a Nuclino test user
