...
---
# <a name="tutorial-configure-zendesk-for-automatic-user-provisioning"></a>Tutorial: Configure Zendesk for automatic user provisioning
...
## <a name="assigning-users-to-zendesk"></a>Assigning users to Zendesk
...
### <a name="important-tips-for-assigning-users-to-zendesk"></a>Important tips for assigning users to Zendesk
...
## <a name="configuring-automatic-user-provisioning-to-zendesk"></a>Configuring automatic user provisioning to Zendesk 
...
### <a name="to-configure-automatic-user-provisioning-for-zendesk-in-azure-ad"></a>To configure automatic user provisioning for Zendesk in Azure AD:
...
6. The **Secret Token** for your Zendesk account is located in **Admin > API > Settings**. 
    ...
    ![Zendesk Provisioning](./media/zendesk-provisioning-tutorial/ZenDesk4.png) ![Zendesk Provisioning](./media/zendesk-provisioning-tutorial/ZenDesk2.png)
