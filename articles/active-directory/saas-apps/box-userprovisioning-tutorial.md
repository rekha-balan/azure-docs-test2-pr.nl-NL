...
---
# <a name="tutorial-configure-box-for-automatic-user-provisioning"></a>Tutorial: Configure Box for automatic user provisioning
...
## <a name="assigning-users-to-box"></a>Assigning users to Box 
...
### <a name="important-tips-for-assigning-users-to-box"></a>Important tips for assigning users to Box 
