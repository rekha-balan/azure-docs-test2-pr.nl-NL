...
1. In the search box, type **Heroku**.

    ![Creating an Azure AD test user](./media/heroku-tutorial/tutorial_heroku_search.png)

1. In the results panel, select **Heroku**, and then click **Add** button to add the application.
...
1. **[Creating a Heroku test user](#creating-a-heroku-test-user)** - to have a counterpart of Britta Simon in Heroku that is linked to the Azure AD representation of user.
...
1. On the **Heroku Domain and URLs** section, perform the following steps:
...
### <a name="creating-a-heroku-test-user"></a>Creating a Heroku test user
