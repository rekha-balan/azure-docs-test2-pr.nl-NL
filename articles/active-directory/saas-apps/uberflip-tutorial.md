...
---
# <a name="tutorial-azure-active-directory-integration-with-uberflip"></a>Tutorial: Azure Active Directory integration with Uberflip
...
## <a name="adding-uberflip-from-the-gallery"></a>Adding Uberflip from the gallery
...
### <a name="create-an-uberflip-test-user"></a>Create an Uberflip test user
