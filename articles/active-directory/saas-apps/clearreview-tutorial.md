...
---
# <a name="tutorial-azure-active-directory-integration-with-clear-review"></a>Tutorial: Azure Active Directory integration with Clear Review
...
## <a name="adding-clear-review-from-the-gallery"></a>Adding Clear Review from the gallery
...
### <a name="create-a-clear-review-test-user"></a>Create a Clear Review test user
