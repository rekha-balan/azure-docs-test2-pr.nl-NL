...
---
# <a name="tutorial-azure-active-directory-integration-with-edcor"></a>Tutorial: Azure Active Directory integration with Edcor
...
## <a name="adding-edcor-from-the-gallery"></a>Adding Edcor from the gallery
...
### <a name="create-an-edcor-test-user"></a>Create an Edcor test user
