...
---
# <a name="tutorial-azure-active-directory-integration-with-mercell"></a>Tutorial: Azure Active Directory integration with Mercell
...
## <a name="adding-mercell-from-the-gallery"></a>Adding Mercell from the gallery
...
### <a name="create-a-mercell-test-user"></a>Create a Mercell test user
