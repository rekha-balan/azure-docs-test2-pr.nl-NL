...
---
# <a name="tutorial-azure-active-directory-integration-with-leapsome"></a>Tutorial: Azure Active Directory integration with Leapsome
...
## <a name="adding-leapsome-from-the-gallery"></a>Adding Leapsome from the gallery
...
### <a name="create-a-leapsome-test-user"></a>Create a Leapsome test user
