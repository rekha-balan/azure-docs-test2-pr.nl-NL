...
---
# <a name="tutorial-azure-active-directory-integration-with-mobi"></a>Tutorial: Azure Active Directory integration with MOBI
...
## <a name="adding-mobi-from-the-gallery"></a>Adding MOBI from the gallery
...
### <a name="create-a-mobi-test-user"></a>Create a MOBI test user
