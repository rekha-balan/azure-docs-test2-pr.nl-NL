...
---
# <a name="tutorial-azure-active-directory-integration-with-klue"></a>Tutorial: Azure Active Directory integration with Klue
...
## <a name="adding-klue-from-the-gallery"></a>Adding Klue from the gallery
...
### <a name="creating-a-klue-test-user"></a>Creating a Klue test user
