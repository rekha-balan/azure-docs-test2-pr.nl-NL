...
---
# <a name="tutorial-azure-active-directory-integration-with-jira-saml-sso-by-microsoft-v52"></a>Tutorial: Azure Active Directory integration with JIRA SAML SSO by Microsoft (V5.2)
...
## <a name="adding-jira-saml-sso-by-microsoft-v52-from-the-gallery"></a>Adding JIRA SAML SSO by Microsoft (V5.2) from the gallery
...
### <a name="create-a-jira-saml-sso-by-microsoft-v52-test-user"></a>Create a JIRA SAML SSO by Microsoft (V5.2) test user
