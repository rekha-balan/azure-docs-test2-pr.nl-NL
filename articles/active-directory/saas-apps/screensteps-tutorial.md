...
## <a name="adding-screensteps-from-the-gallery"></a>Adding ScreenSteps from the gallery
...
### <a name="create-a-screensteps-test-user"></a>Create a ScreenSteps test user
