...
---
# <a name="tutorial-azure-active-directory-integration-with-g-suite"></a>Tutorial: Azure Active Directory integration with G Suite
...
## <a name="adding-g-suite-from-the-gallery"></a>Adding G Suite from the gallery
...
### <a name="create-a-g-suite-test-user"></a>Create a G Suite test user
