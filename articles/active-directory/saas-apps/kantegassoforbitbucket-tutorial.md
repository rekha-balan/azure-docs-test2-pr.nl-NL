...
---
# <a name="tutorial-azure-active-directory-integration-with-kantega-sso-for-bitbucket"></a>Tutorial: Azure Active Directory integration with Kantega SSO for Bitbucket
...
## <a name="adding-kantega-sso-for-bitbucket-from-the-gallery"></a>Adding Kantega SSO for Bitbucket from the gallery
...
### <a name="creating-a-kantega-sso-for-bitbucket-test-user"></a>Creating a Kantega SSO for Bitbucket test user
