...
---
# <a name="tutorial-azure-active-directory-integration-with-purelyhr"></a>Tutorial: Azure Active Directory integration with PurelyHR
...
## <a name="adding-purelyhr-from-the-gallery"></a>Adding PurelyHR from the gallery
...
### <a name="creating-a-purelyhr-test-user"></a>Creating a PurelyHR test user
