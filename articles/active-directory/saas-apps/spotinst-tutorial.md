...
---
# <a name="tutorial-azure-active-directory-integration-with-spotinst"></a>Tutorial: Azure Active Directory integration with Spotinst
...
## <a name="adding-spotinst-from-the-gallery"></a>Adding Spotinst from the gallery
...
### <a name="create-a-spotinst-test-user"></a>Create a Spotinst test user
