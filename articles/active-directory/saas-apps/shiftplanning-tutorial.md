...
1. In the search box, type **Humanity**.

    ![Creating an Azure AD test user](./media/shiftplanning-tutorial/tutorial_humanity_search.png)

1. In the results panel, select **Humanity**, and then click **Add** button to add the application.
...
1. **[Creating a Humanity test user](#creating-a-humanity-test-user)** - to have a counterpart of Britta Simon in Humanity that is linked to the Azure AD representation of user.
...
1. On the **Humanity Domain and URLs** section, perform the following steps:
...
1. On the **Humanity Configuration** section, click **Configure Humanity** to open **Configure sign-on** window. Copy the **SAML Single Sign-On Service URL, and Sign-Out URL** from the **Quick Reference section.**
...
1. Under **Integration**, click **Single Sign-On**.
...
### <a name="creating-a-humanity-test-user"></a>Creating a Humanity test user
...
1. Under **Actions**, click **Add Employees**.
   
    ![Add Employees](./media/shiftplanning-tutorial/iC786624.png "Add Employees")

1. In the **Add Employees** section, perform the following steps:
