...
---
# <a name="tutorial-configure-pingboard-for-automatic-user-provisioning"></a>Tutorial: Configure Pingboard for automatic user provisioning
...
## <a name="assign-users-to-pingboard"></a>Assign users to Pingboard
...
### <a name="important-tips-for-assigning-users-to-pingboard"></a>Important tips for assigning users to Pingboard
...
## <a name="configure-user-provisioning-to-pingboard"></a>Configure user provisioning to Pingboard 
...
### <a name="to-configure-automatic-user-account-provisioning-to-pingboard-in-azure-ad"></a>To configure automatic user account provisioning to Pingboard in Azure AD
