...
---
# <a name="tutorial-azure-active-directory-integration-with-fuze"></a>Tutorial: Azure Active Directory integration with Fuze
...
## <a name="adding-fuze-from-the-gallery"></a>Adding Fuze from the gallery
...
### <a name="creating-a-fuze-test-user"></a>Creating a Fuze test user
