...
---
# <a name="tutorial-azure-active-directory-integration-with-impac-risk-manager"></a>Tutorial: Azure Active Directory integration with IMPAC Risk Manager
...
## <a name="adding-impac-risk-manager-from-the-gallery"></a>Adding IMPAC Risk Manager from the gallery
...
### <a name="create-a-impac-risk-manager-test-user"></a>Create a IMPAC Risk Manager test user
