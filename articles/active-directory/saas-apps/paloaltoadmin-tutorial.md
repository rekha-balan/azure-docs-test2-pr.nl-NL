...
---
# <a name="integrate-azure-active-directory-with-palo-alto-networks---admin-ui"></a>Integrate Azure Active Directory with Palo Alto Networks - Admin UI
...
## <a name="add-palo-alto-networks---admin-ui-from-the-gallery"></a>Add Palo Alto Networks - Admin UI from the gallery
...
### <a name="create-a-palo-alto-networks---admin-ui-test-user"></a>Create a Palo Alto Networks - Admin UI test user
