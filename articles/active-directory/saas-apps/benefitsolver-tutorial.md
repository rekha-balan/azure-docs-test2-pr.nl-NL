...
## <a name="adding-benefitsolver-from-the-gallery"></a>Adding Benefitsolver from the gallery
...
### <a name="create-a-benefitsolver-test-user"></a>Create a Benefitsolver test user
