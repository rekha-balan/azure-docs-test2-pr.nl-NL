...
---
# <a name="tutorial-azure-active-directory-integration-with-smartlpa"></a>Tutorial: Azure Active Directory integration with SmartLPA
...
## <a name="adding-smartlpa-from-the-gallery"></a>Adding SmartLPA from the gallery
...
### <a name="create-a-smartlpa-test-user"></a>Create a SmartLPA test user
