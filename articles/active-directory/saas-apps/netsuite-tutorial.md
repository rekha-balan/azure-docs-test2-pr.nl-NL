...
---
# <a name="tutorial-azure-active-directory-integration-with-netsuite"></a>Tutorial: Azure Active Directory integration with NetSuite
...
## <a name="adding-netsuite-from-the-gallery"></a>Adding NetSuite from the gallery
...
### <a name="creating-a-netsuite-test-user"></a>Creating a NetSuite test user
