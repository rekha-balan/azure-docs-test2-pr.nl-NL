...
---
# <a name="tutorial-configure-bluejeans-for-automatic-user-provisioning"></a>Tutorial: Configure BlueJeans for automatic user provisioning
...
## <a name="assigning-users-to-bluejeans"></a>Assigning users to BlueJeans
...
### <a name="important-tips-for-assigning-users-to-bluejeans"></a>Important tips for assigning users to BlueJeans
...
## <a name="configuring-automatic-user-provisioning-to-bluejeans"></a>Configuring automatic user provisioning to BlueJeans
...
### <a name="to-configure-automatic-user-provisioning-for-bluejeans-in-azure-ad"></a>To configure automatic user provisioning for BlueJeans in Azure AD:
