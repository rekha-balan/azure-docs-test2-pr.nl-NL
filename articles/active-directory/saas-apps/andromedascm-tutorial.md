...
---
# <a name="tutorial-azure-active-directory-integration-with-andromeda"></a>Tutorial: Azure Active Directory integration with Andromeda
...
## <a name="adding-andromeda-from-the-gallery"></a>Adding Andromeda from the gallery
...
### <a name="create-an-andromeda-test-user"></a>Create an Andromeda test user
