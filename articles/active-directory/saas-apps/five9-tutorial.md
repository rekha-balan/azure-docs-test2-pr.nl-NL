...
---
# <a name="tutorial-azure-active-directory-integration-with-five9-plus-adapter-cti-contact-center-agents"></a>Tutorial: Azure Active Directory integration with Five9 Plus Adapter (CTI, Contact Center Agents)
...
## <a name="adding-five9-plus-adapter-cti-contact-center-agents-from-the-gallery"></a>Adding Five9 Plus Adapter (CTI, Contact Center Agents) from the gallery
...
### <a name="creating-a-five9-plus-adapter-cti-contact-center-agents-test-user"></a>Creating a Five9 Plus Adapter (CTI, Contact Center Agents) test user
