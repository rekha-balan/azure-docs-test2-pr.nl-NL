...
---
# <a name="tutorial-azure-active-directory-integration-with-opal"></a>Tutorial: Azure Active Directory integration with Opal
...
## <a name="adding-opal-from-the-gallery"></a>Adding Opal from the gallery
...
### <a name="create-an-opal-test-user"></a>Create an Opal test user
