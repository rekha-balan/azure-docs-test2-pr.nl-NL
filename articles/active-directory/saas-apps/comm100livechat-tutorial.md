...
---
# <a name="tutorial-azure-active-directory-integration-with-comm100-live-chat"></a>Tutorial: Azure Active Directory integration with Comm100 Live Chat
...
## <a name="adding-comm100-live-chat-from-the-gallery"></a>Adding Comm100 Live Chat from the gallery
...
### <a name="create-a-comm100-live-chat-test-user"></a>Create a Comm100 Live Chat test user
