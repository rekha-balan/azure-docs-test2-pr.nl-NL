...
---
# <a name="tutorial-azure-active-directory-integration-with-trackvia"></a>Tutorial: Azure Active Directory integration with TrackVia
...
## <a name="adding-trackvia-from-the-gallery"></a>Adding TrackVia from the gallery
...
### <a name="create-a-trackvia-test-user"></a>Create a TrackVia test user
