...
1. In the search box, type **Asset Bank**.

    ![Creating an Azure AD test user](./media/assetbank-tutorial/tutorial_assetbank_search.png)

1. In the results panel, select **Asset Bank**, and then click **Add** button to add the application.
...
1. **[Creating an Asset Bank test user](#creating-an-asset-bank-test-user)** - to have a counterpart of Britta Simon in Asset Bank that is linked to the Azure AD representation of user.
...
1. On the **Asset Bank Domain and URLs** section, perform the following steps:
...
1. To configure single sign-on on **Asset Bank** side, you need to send the downloaded **Metadata XML** to [Asset Bank support team](mailto:support@assetbank.co.uk). 
...
### <a name="creating-an-asset-bank-test-user"></a>Creating an Asset Bank test user
