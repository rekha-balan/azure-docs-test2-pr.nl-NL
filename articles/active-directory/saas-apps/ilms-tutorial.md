...
---
# <a name="tutorial-azure-active-directory-integration-with-ilms"></a>Tutorial: Azure Active Directory integration with iLMS
...
## <a name="adding-ilms-from-the-gallery"></a>Adding iLMS from the gallery
...
### <a name="creating-an-ilms-test-user"></a>Creating an iLMS test user
