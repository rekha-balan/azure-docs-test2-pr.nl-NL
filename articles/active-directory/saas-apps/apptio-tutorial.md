...
---
# <a name="tutorial-azure-active-directory-integration-with-apptio"></a>Tutorial: Azure Active Directory integration with Apptio
...
## <a name="adding-apptio-from-the-gallery"></a>Adding Apptio from the gallery
...
### <a name="create-an-apptio-test-user"></a>Create an Apptio test user
