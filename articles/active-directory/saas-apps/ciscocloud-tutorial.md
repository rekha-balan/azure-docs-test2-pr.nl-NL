...
---
# <a name="tutorial-azure-active-directory-integration-with-cisco-cloud"></a>Tutorial: Azure Active Directory integration with Cisco Cloud
...
## <a name="adding-cisco-cloud-from-the-gallery"></a>Adding Cisco Cloud from the gallery
...
### <a name="create-a-cisco-cloud-test-user"></a>Create a Cisco Cloud test user
