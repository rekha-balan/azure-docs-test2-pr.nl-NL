...
## <a name="adding-lucidchart-from-the-gallery"></a>Adding Lucidchart from the gallery
...
### <a name="creating-a-lucidchart-test-user"></a>Creating a Lucidchart test user
