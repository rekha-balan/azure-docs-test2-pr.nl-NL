...
---
# <a name="tutorial-azure-active-directory-integration-with-efi-digital-storefront"></a>Tutorial: Azure Active Directory integration with EFI Digital StoreFront
...
## <a name="adding-efi-digital-storefront-from-the-gallery"></a>Adding EFI Digital StoreFront from the gallery
...
### <a name="create-a-efi-digital-storefront-test-user"></a>Create a EFI Digital StoreFront test user
