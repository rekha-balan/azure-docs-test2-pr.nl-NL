...
## <a name="add-hr2day-by-merces-from-the-gallery"></a>Add HR2day by Merces from the gallery
...
### <a name="create-an-hr2day-by-merces-test-user"></a>Create an HR2day by Merces test user
