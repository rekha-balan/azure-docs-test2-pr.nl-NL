...
---
# <a name="tutorial-azure-active-directory-integration-with-velpic-saml"></a>Tutorial: Azure Active Directory integration with Velpic SAML
...
## <a name="adding-velpic-saml-from-the-gallery"></a>Adding Velpic SAML from the gallery
...
### <a name="creating-a-velpic-saml-test-user"></a>Creating a Velpic SAML test user
