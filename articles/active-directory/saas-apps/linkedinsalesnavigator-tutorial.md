...
---
# <a name="tutorial-azure-active-directory-integration-with-linkedin-sales-navigator"></a>Tutorial: Azure Active Directory integration with LinkedIn Sales Navigator
...
## <a name="adding-linkedin-sales-navigator-from-the-gallery"></a>Adding LinkedIn Sales Navigator from the gallery
...
### <a name="creating-a-linkedin-sales-navigator-test-user"></a>Creating a LinkedIn Sales Navigator test user
