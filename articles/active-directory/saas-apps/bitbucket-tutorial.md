...
---
# <a name="tutorial-azure-active-directory-integration-with-saml-sso-for-bitbucket-by-resolution-gmbh"></a>Tutorial: Azure Active Directory integration with SAML SSO for Bitbucket by resolution GmbH
...
## <a name="adding-saml-sso-for-bitbucket-by-resolution-gmbh-from-the-gallery"></a>Adding SAML SSO for Bitbucket by resolution GmbH from the gallery
...
### <a name="create-a-saml-sso-for-bitbucket-by-resolution-gmbh-test-user"></a>Create a SAML SSO for Bitbucket by resolution GmbH test user
