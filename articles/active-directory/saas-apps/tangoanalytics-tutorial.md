...
---
# <a name="tutorial-azure-active-directory-integration-with-tango-analytics"></a>Tutorial: Azure Active Directory integration with Tango Analytics
...
## <a name="adding-tango-analytics-from-the-gallery"></a>Adding Tango Analytics from the gallery
...
### <a name="creating-a-tango-analytics-test-user"></a>Creating a Tango Analytics test user
