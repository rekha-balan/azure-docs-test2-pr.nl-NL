...
---
# <a name="tutorial-azure-active-directory-integration-with-skytap"></a>Tutorial: Azure Active Directory integration with Skytap
...
## <a name="adding-skytap-from-the-gallery"></a>Adding Skytap from the gallery
...
### <a name="create-a-skytap-test-user"></a>Create a Skytap test user
