...
1. **[Create a EasyTerritory test user](#create-a-easyterritory-test-user)** - to have a counterpart of Britta Simon in EasyTerritory that is linked to the Azure AD representation of user.
...
### <a name="create-a-easyterritory-test-user"></a>Create a EasyTerritory test user
