...
---
# <a name="tutorial-azure-active-directory-integration-with-dealpath"></a>Tutorial: Azure Active Directory integration with Dealpath
...
## <a name="adding-dealpath-from-the-gallery"></a>Adding Dealpath from the gallery
...
1. In the search box, type **Dealpath**, select **Dealpath** from result panel then click **Add** button to add the application.
...
1. In the **Set up SAML 2.0 authentication** page, perform the following steps:
...
### <a name="create-a-dealpath-test-user"></a>Create a Dealpath test user
