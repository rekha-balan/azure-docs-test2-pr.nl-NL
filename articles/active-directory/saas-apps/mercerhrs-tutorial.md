...
---
# <a name="tutorial-azure-active-directory-integration-with-mercer-benefitscentral-mbc"></a>Tutorial: Azure Active Directory integration with Mercer BenefitsCentral (MBC)
...
## <a name="adding-mercer-benefitscentral-mbc-from-the-gallery"></a>Adding Mercer BenefitsCentral (MBC) from the gallery
...
### <a name="create-a-mercer-benefitscentral-mbc-test-user"></a>Create a Mercer BenefitsCentral (MBC) test user
