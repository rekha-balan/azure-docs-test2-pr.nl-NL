...
---
# <a name="tutorial-azure-active-directory-integration-with-envi-mmis"></a>Tutorial: Azure Active Directory integration with Envi MMIS
...
## <a name="adding-envi-mmis-from-the-gallery"></a>Adding Envi MMIS from the gallery
...
### <a name="create-an-envi-mmis-test-user"></a>Create an Envi MMIS test user
