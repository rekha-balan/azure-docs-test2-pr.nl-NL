...
---
# <a name="tutorial-azure-active-directory-integration-with-insight4grc"></a>Tutorial: Azure Active Directory integration with Insight4GRC
...
## <a name="adding-insight4grc-from-the-gallery"></a>Adding Insight4GRC from the gallery
...
### <a name="create-an-insight4grc-test-user"></a>Create an Insight4GRC test user
