...
---
# <a name="tutorial-azure-active-directory-integration-with-awardspring"></a>Tutorial: Azure Active Directory integration with AwardSpring
...
## <a name="adding-awardspring-from-the-gallery"></a>Adding AwardSpring from the gallery
...
### <a name="create-an-awardspring-test-user"></a>Create an AwardSpring test user
