...
## <a name="adding-scc-lifecycle-from-the-gallery"></a>Adding SCC LifeCycle from the gallery
...
1. On the **SCC LifeCycle Domain and URLs** section, perform the following steps:
    ...
    a. In the **Sign-on URL** textbox, type a URL using the following pattern: `https://<sub-domain>.scc.com/ic7/welcome/customer/PICTtest.aspx`
...
### <a name="creating-an-scc-lifecycle-test-user"></a>Creating an SCC LifeCycle test user
