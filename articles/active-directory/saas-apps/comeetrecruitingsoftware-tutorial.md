...
---
# <a name="tutorial-azure-active-directory-integration-with-comeet-recruiting-software"></a>Tutorial: Azure Active Directory integration with Comeet Recruiting Software
...
## <a name="adding-comeet-recruiting-software-from-the-gallery"></a>Adding Comeet Recruiting Software from the gallery
...
### <a name="create-a-comeet-recruiting-software-test-user"></a>Create a Comeet Recruiting Software test user
