...
## <a name="adding-brightspace-by-desire2learn-from-the-gallery"></a>Adding Brightspace by Desire2Learn from the gallery
...
1. On the **Brightspace by Desire2Learn Domain and URLs** section, perform the following steps:
    ...
    b. In the **Reply URL** textbox, type a URL using the following pattern: `https://<companyname>.desire2learn.com/d2l/lp/auth/login/samlLogin.d2l`
...
### <a name="creating-a-brightspace-by-desire2learn-test-user"></a>Creating a Brightspace by Desire2Learn test user
