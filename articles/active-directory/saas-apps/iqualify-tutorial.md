...
---
# <a name="tutorial-azure-active-directory-integration-with-iqualify-lms"></a>Tutorial: Azure Active Directory integration with iQualify LMS
...
## <a name="adding-iqualify-lms-from-the-gallery"></a>Adding iQualify LMS from the gallery
...
### <a name="create-an-iqualify-lms-test-user"></a>Create an iQualify LMS test user
