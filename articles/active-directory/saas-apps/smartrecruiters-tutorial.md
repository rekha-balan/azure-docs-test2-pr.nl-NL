...
---
# <a name="tutorial-azure-active-directory-integration-with-smartrecruiters"></a>Tutorial: Azure Active Directory integration with SmartRecruiters
...
## <a name="adding-smartrecruiters-from-the-gallery"></a>Adding SmartRecruiters from the gallery
...
### <a name="create-a-smartrecruiters-test-user"></a>Create a SmartRecruiters test user
