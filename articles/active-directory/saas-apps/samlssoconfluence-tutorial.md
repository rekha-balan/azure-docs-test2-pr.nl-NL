...
---
# <a name="tutorial-azure-active-directory-integration-with-saml-sso-for-confluence-by-resolution-gmbh"></a>Tutorial: Azure Active Directory integration with SAML SSO for Confluence by resolution GmbH
...
## <a name="adding-saml-sso-for-confluence-by-resolution-gmbh-from-the-gallery"></a>Adding SAML SSO for Confluence by resolution GmbH from the gallery
...
### <a name="creating-a-saml-sso-for-confluence-by-resolution-gmbh-test-user"></a>Creating a SAML SSO for Confluence by resolution GmbH test user
