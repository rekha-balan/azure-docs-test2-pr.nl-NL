...
---
# <a name="tutorial-azure-active-directory-integration-with-apex-portal"></a>Tutorial: Azure Active Directory integration with Apex Portal
...
## <a name="adding-apex-portal-from-the-gallery"></a>Adding Apex Portal from the gallery
...
### <a name="create-an-apex-portal-test-user"></a>Create an Apex Portal test user
