...
---
# <a name="tutorial-azure-active-directory-integration-with-sauce-labs---mobile-and-web-testing"></a>Tutorial: Azure Active Directory integration with Sauce Labs - Mobile and Web Testing
...
## <a name="adding-sauce-labs---mobile-and-web-testing-from-the-gallery"></a>Adding Sauce Labs - Mobile and Web Testing from the gallery
...
### <a name="create-a-sauce-labs---mobile-and-web-testing-test-user"></a>Create a Sauce Labs - Mobile and Web Testing test user
