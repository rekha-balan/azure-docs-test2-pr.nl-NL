...
---
# <a name="tutorial-azure-active-directory-integration-with-meta-networks-connector"></a>Tutorial: Azure Active Directory integration with Meta Networks Connector
...
## <a name="adding-meta-networks-connector-from-the-gallery"></a>Adding Meta Networks Connector from the gallery
...
### <a name="create-a-meta-networks-connector-test-user"></a>Create a Meta Networks Connector test user
