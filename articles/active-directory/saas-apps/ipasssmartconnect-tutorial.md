...
---
# <a name="tutorial-azure-active-directory-integration-with-ipass-smartconnect"></a>Tutorial: Azure Active Directory integration with iPass SmartConnect
...
## <a name="adding-ipass-smartconnect-from-the-gallery"></a>Adding iPass SmartConnect from the gallery
...
### <a name="create-an-ipass-smartconnect-test-user"></a>Create an iPass SmartConnect test user
