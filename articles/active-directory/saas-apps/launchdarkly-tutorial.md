...
---
# <a name="tutorial-azure-active-directory-integration-with-launchdarkly"></a>Tutorial: Azure Active Directory integration with LaunchDarkly
...
## <a name="adding-launchdarkly-from-the-gallery"></a>Adding LaunchDarkly from the gallery
...
### <a name="create-a-launchdarkly-test-user"></a>Create a LaunchDarkly test user
