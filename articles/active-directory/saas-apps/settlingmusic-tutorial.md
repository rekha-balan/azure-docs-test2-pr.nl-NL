...
---
# <a name="tutorial-azure-active-directory-integration-with-settling-music"></a>Tutorial: Azure Active Directory integration with Settling music
...
## <a name="adding-settling-music-from-the-gallery"></a>Adding Settling music from the gallery
...
### <a name="create-a-settling-music-test-user"></a>Create a Settling music test user
