...
---
# <a name="tutorial-azure-active-directory-integration-with-te-express"></a>Tutorial: Azure Active Directory integration with T&E Express
...
## <a name="adding-te-express-from-the-gallery"></a>Adding T&E Express from the gallery
...
### <a name="creating-a-te-express-test-user"></a>Creating a T&E Express test user
