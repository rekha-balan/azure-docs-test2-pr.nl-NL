...
---
# <a name="tutorial-azure-active-directory-integration-with-tonicdm"></a>Tutorial: Azure Active Directory integration with TonicDM
...
## <a name="adding-tonicdm-from-the-gallery"></a>Adding TonicDM from the gallery
...
### <a name="create-a-tonicdm-test-user"></a>Create a TonicDM test user
