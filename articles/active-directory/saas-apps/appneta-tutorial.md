...
---
# <a name="tutorial-azure-active-directory-integration-with-appneta-performance-monitor"></a>Tutorial: Azure Active Directory integration with AppNeta Performance Monitor
...
## <a name="adding-appneta-performance-monitor-from-the-gallery"></a>Adding AppNeta Performance Monitor from the gallery
...
### <a name="create-an-appneta-performance-monitor-test-user"></a>Create an AppNeta Performance Monitor test user
