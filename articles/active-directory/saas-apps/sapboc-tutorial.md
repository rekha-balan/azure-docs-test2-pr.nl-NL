...
---
# <a name="tutorial-azure-active-directory-integration-with-sap-business-object-cloud"></a>Tutorial: Azure Active Directory integration with SAP Business Object Cloud
...
## <a name="add-sap-business-object-cloud-from-the-gallery"></a>Add SAP Business Object Cloud from the gallery
...
##  <a name="set-up-and-test-azure-ad-single-sign-on"></a>Set up and test Azure AD single sign-on
...
### <a name="set-up-azure-ad-single-sign-on"></a>Set up Azure AD single sign-on
...
### <a name="create-an-sap-business-object-cloud-test-user"></a>Create an SAP Business Object Cloud test user
