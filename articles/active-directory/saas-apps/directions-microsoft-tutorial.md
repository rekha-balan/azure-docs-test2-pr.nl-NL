...
## <a name="adding-directions-on-microsoft-from-the-gallery"></a>Adding Directions on Microsoft from the gallery
...
1. In the search box, type **Directions on Microsoft**.

    ![Creating an Azure AD test user](./media/directions-microsoft-tutorial/tutorial_directionsonmicrosoft_search.png)

1. In the results panel, select **Directions on Microsoft**, and then click **Add** button to add the application.
...
1. **[Creating a Directions on Microsoft test user](#creating-a-directions-on-microsoft-test-user)** - to have a counterpart of Britta Simon in Directions on Microsoft that is linked to the Azure AD representation of user.
...
1. On the **Directions on Microsoft Domain and URLs** section, perform the following steps:
...
### <a name="creating-a-directions-on-microsoft-test-user"></a>Creating a Directions on Microsoft test user
...
1. In the applications list, select **Directions on Microsoft**.
