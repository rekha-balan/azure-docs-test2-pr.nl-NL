...
---
# <a name="tutorial-azure-active-directory-integration-with-ebsco"></a>Tutorial: Azure Active Directory integration with EBSCO
...
## <a name="adding-ebsco-from-the-gallery"></a>Adding EBSCO from the gallery
...
### <a name="create-an-ebsco-test-user"></a>Create an EBSCO test user
