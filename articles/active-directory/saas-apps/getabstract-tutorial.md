...
---
# <a name="tutorial-azure-active-directory-integration-with-getabstract"></a>Tutorial: Azure Active Directory integration with Getabstract
...
## <a name="adding-getabstract-from-the-gallery"></a>Adding Getabstract from the gallery
...
### <a name="create-a-getabstract-test-user"></a>Create a Getabstract test user
