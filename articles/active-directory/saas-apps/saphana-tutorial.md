...
---
# <a name="tutorial-azure-active-directory-integration-with-sap-hana"></a>Tutorial: Azure Active Directory integration with SAP HANA
...
## <a name="add-sap-hana-from-the-gallery"></a>Add SAP HANA from the gallery
...
### <a name="create-a-sap-hana-test-user"></a>Create a SAP HANA test user
