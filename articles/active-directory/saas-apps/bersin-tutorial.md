...
---
# <a name="tutorial-azure-active-directory-integration-with-bersin"></a>Tutorial: Azure Active Directory integration with Bersin
...
## <a name="adding-bersin-from-the-gallery"></a>Adding Bersin from the gallery
...
### <a name="create-a-bersin-test-user"></a>Create a Bersin test user
