...
## <a name="adding-cloudpassage-from-the-gallery"></a>Adding CloudPassage from the gallery
...
1. Your CloudPassage application expects the SAML assertions in a specific format, which requires you to add custom attribute mappings to your SAML token attributes configuration. The following screenshot shows an example for this.
...
### <a name="creating-a-cloudpassage-test-user"></a>Creating a CloudPassage test user
