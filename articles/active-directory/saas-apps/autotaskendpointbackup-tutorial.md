...
---
# <a name="tutorial-azure-active-directory-integration-with-autotask-endpoint-backup"></a>Tutorial: Azure Active Directory integration with Autotask Endpoint Backup
...
## <a name="adding-autotask-endpoint-backup-from-the-gallery"></a>Adding Autotask Endpoint Backup from the gallery
...
### <a name="create-a-autotask-endpoint-backup-test-user"></a>Create a Autotask Endpoint Backup test user
