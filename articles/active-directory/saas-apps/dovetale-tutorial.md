...
---
# <a name="tutorial-azure-active-directory-integration-with-dovetale"></a>Tutorial: Azure Active Directory integration with Dovetale
...
### <a name="create-a-dovetale-test-user"></a>Create a Dovetale test user
