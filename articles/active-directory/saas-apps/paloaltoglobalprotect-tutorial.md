...
---
# <a name="tutorial-azure-active-directory-integration-with-palo-alto-networks---globalprotect"></a>Tutorial: Azure Active Directory integration with Palo Alto Networks - GlobalProtect
...
## <a name="adding-palo-alto-networks---globalprotect-from-the-gallery"></a>Adding Palo Alto Networks - GlobalProtect from the gallery
...
### <a name="create-a-palo-alto-networks---globalprotect-test-user"></a>Create a Palo Alto Networks - GlobalProtect test user
