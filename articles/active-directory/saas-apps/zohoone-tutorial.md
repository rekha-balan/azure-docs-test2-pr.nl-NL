...
---
# <a name="tutorial-azure-active-directory-integration-with-zoho-one"></a>Tutorial: Azure Active Directory integration with Zoho One
...
## <a name="adding-zoho-one-from-the-gallery"></a>Adding Zoho One from the gallery
...
### <a name="create-a-zoho-one-test-user"></a>Create a Zoho One test user
