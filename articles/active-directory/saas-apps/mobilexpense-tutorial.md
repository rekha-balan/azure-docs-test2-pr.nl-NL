...
---
# <a name="tutorial-azure-active-directory-integration-with-mobile-xpense"></a>Tutorial: Azure Active Directory integration with Mobile Xpense
...
## <a name="adding-mobile-xpense-from-the-gallery"></a>Adding Mobile Xpense from the gallery
...
### <a name="create-a-mobile-xpense-test-user"></a>Create a Mobile Xpense test user
