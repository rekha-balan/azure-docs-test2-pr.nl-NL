...
---
# <a name="tutorial-azure-active-directory-integration-with-jda-cloud"></a>Tutorial: Azure Active Directory integration with JDA Cloud
...
## <a name="adding-jda-cloud-from-the-gallery"></a>Adding JDA Cloud from the gallery
...
### <a name="create-a-jda-cloud-test-user"></a>Create a JDA Cloud test user
