...
---
# <a name="tutorial-azure-active-directory-integration-with-skyhigh-networks"></a>Tutorial: Azure Active Directory integration with Skyhigh Networks
...
## <a name="adding-skyhigh-networks-from-the-gallery"></a>Adding Skyhigh Networks from the gallery
...
### <a name="create-a-skyhigh-networks-test-user"></a>Create a Skyhigh Networks test user
