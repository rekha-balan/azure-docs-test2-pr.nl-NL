...
## <a name="adding-innotas-from-the-gallery"></a>Adding Innotas from the gallery
...
1. In the search box, type **Innotas**.

    ![Creating an Azure AD test user](./media/innotas-tutorial/tutorial_innotas_search.png)

1. In the results panel, select **Innotas**, and then click **Add** button to add the application.
...
1. **[Creating an Innotas test user](#creating-an-innotas-test-user)** - to have a counterpart of Britta Simon in Innotas that is linked to the Azure AD representation of user.
...
1. On the **Innotas Domain and URLs** section, perform the following steps:
...
1. To configure single sign-on on **Innotas** side, you need to send the downloaded **Metadata XML** to [Innotas support team](https://www.innotas.com/contact). They set this setting to have the SAML SSO connection set properly on both sides.
...
### <a name="creating-an-innotas-test-user"></a>Creating an Innotas test user
