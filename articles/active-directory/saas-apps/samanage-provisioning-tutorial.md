...
---
# <a name="tutorial-configure-samanage-for-automatic-user-provisioning"></a>Tutorial: Configure Samanage for automatic user provisioning
...
## <a name="assigning-users-to-samanage"></a>Assigning users to Samanage
...
### <a name="important-tips-for-assigning-users-to-samanage"></a>Important tips for assigning users to Samanage
...
## <a name="configuring-automatic-user-provisioning-to-samanage"></a>Configuring automatic user provisioning to Samanage
...
### <a name="to-configure-automatic-user-provisioning-for-samanage-in-azure-ad"></a>To configure automatic user provisioning for Samanage in Azure AD:
