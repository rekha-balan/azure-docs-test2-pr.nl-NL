...
---
# <a name="tutorial-azure-active-directory-integration-with-adobe-captivate-prime"></a>Tutorial: Azure Active Directory integration with Adobe Captivate Prime
...
## <a name="adding-adobe-captivate-prime-from-the-gallery"></a>Adding Adobe Captivate Prime from the gallery
...
### <a name="create-an-adobe-captivate-prime-test-user"></a>Create an Adobe Captivate Prime test user
