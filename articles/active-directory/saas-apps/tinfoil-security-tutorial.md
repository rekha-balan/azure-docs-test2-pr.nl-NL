...
## <a name="add-tinfoil-security-from-the-gallery"></a>Add TINFOIL SECURITY from the gallery
...
### <a name="create-a-tinfoil-security-test-user"></a>Create a TINFOIL SECURITY test user
