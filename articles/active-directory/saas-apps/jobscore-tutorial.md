...
---
# <a name="tutorial-azure-active-directory-integration-with-jobscore"></a>Tutorial: Azure Active Directory integration with JobScore
...
## <a name="adding-jobscore-from-the-gallery"></a>Adding JobScore from the gallery
...
1. In the search box, type **JobScore**.

    ![Creating an Azure AD test user](./media/jobscore-tutorial/tutorial_jobscore_search.png)

1. In the results panel, select **JobScore**, and then click **Add** button to add the application.
...
### <a name="creating-a-jobscore-test-user"></a>Creating a JobScore test user
