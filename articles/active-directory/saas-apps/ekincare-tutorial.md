...
---
# <a name="tutorial-azure-active-directory-integration-with-ekincare"></a>Tutorial: Azure Active Directory integration with eKincare
...
## <a name="adding-ekincare-from-the-gallery"></a>Adding eKincare from the gallery
...
### <a name="creating-a-ekincare-test-user"></a>Creating a eKincare test user
