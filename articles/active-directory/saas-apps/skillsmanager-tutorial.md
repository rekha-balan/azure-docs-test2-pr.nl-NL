...
---
# <a name="tutorial-azure-active-directory-integration-with-skills-manager"></a>Tutorial: Azure Active Directory integration with Skills Manager
...
## <a name="adding-skills-manager-from-the-gallery"></a>Adding Skills Manager from the gallery
...
### <a name="create-a-skills-manager-test-user"></a>Create a Skills Manager test user
