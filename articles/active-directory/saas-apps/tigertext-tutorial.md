...
## <a name="add-tigertext-secure-messenger-from-the-gallery"></a>Add TigerText Secure Messenger from the gallery
...
### <a name="create-a-tigertext-secure-messenger-test-user"></a>Create a TigerText Secure Messenger test user
