...
## <a name="adding-chromeriver-from-the-gallery"></a>Adding Chromeriver from the gallery
...
1. In the search box, type **Chromeriver**.

    ![Creating an Azure AD test user](./media/chromeriver-tutorial/tutorial_chromeriver_search.png)

1. In the results panel, select **Chromeriver**, and then click **Add** button to add the application.
...
1. **[Creating a Chromeriver test user](#creating-a-chromeriver-test-user)** - to have a counterpart of Britta Simon in Chromeriver that is linked to the Azure AD representation of user.
...
1. On the **Chromeriver Domain and URLs** section, perform the following steps:
...
1. To configure single sign-on on **Chromeriver** side, you need to send the downloaded **Metadata XML** to [Chromeriver support team](https://www.chromeriver.com/services/support). You will get a notification when SSO has been enabled for your subscription.
...
### <a name="creating-a-chromeriver-test-user"></a>Creating a Chromeriver test user
...
When you click the Chromeriver tile in the Access Panel, you should get automatically signed-on to your Chromeriver application. For more details about the Access Panel, see [Introduction to the Access Panel](../user-help/active-directory-saas-access-panel-introduction.md).
