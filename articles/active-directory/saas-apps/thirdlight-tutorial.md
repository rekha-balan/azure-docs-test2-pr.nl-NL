...
## <a name="adding-thirdlight-from-the-gallery"></a>Adding ThirdLight from the gallery
...
### <a name="creating-a-thirdlight-test-user"></a>Creating a ThirdLight test user
