...
---
# <a name="tutorial-azure-active-directory-integration-with-mypolicies"></a>Tutorial: Azure Active Directory integration with myPolicies
...
## <a name="adding-mypolicies-from-the-gallery"></a>Adding myPolicies from the gallery
...
### <a name="creating-a-mypolicies-test-user"></a>Creating a myPolicies test user
