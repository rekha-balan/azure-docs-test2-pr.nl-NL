...
---
# <a name="tutorial-azure-active-directory-integration-with-attendance-management-services"></a>Tutorial: Azure Active Directory integration with Attendance Management Services
...
## <a name="adding-attendance-management-services-from-the-gallery"></a>Adding Attendance Management Services from the gallery
...
### <a name="create-an-attendance-management-services-test-user"></a>Create an Attendance Management Services test user
