...
---
# <a name="tutorial-azure-active-directory-integration-with-zephyrsso"></a>Tutorial: Azure Active Directory integration with ZephyrSSO
...
## <a name="adding-zephyrsso-from-the-gallery"></a>Adding ZephyrSSO from the gallery
...
### <a name="create-a-zephyrsso-test-user"></a>Create a ZephyrSSO test user
