...
---
# <a name="tutorial-azure-active-directory-integration-with-promaster-by-inlogik"></a>Tutorial: Azure Active Directory integration with ProMaster (by Inlogik)
...
## <a name="adding-promaster-by-inlogik-from-the-gallery"></a>Adding ProMaster (by Inlogik) from the gallery
...
### <a name="create-a-promaster-by-inlogik-test-user"></a>Create a ProMaster (by Inlogik) test user
