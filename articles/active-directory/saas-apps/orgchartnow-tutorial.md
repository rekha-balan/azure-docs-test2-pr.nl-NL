...
---
# <a name="tutorial-azure-active-directory-integration-with-orgchart-now"></a>Tutorial: Azure Active Directory integration with OrgChart Now
...
## <a name="adding-orgchart-now-from-the-gallery"></a>Adding OrgChart Now from the gallery
...
### <a name="create-an-orgchart-now-test-user"></a>Create an OrgChart Now test user
