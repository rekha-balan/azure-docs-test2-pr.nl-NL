...
## <a name="adding-zscaler-zscloud-from-the-gallery"></a>Adding Zscaler ZSCloud from the gallery
...
### <a name="creating-a-zscaler-zscloud-test-user"></a>Creating a Zscaler ZSCloud test user
