...
---
# <a name="tutorial-azure-active-directory-integration-with-moxi-engage"></a>Tutorial: Azure Active Directory integration with Moxi Engage
...
## <a name="adding-moxi-engage-from-the-gallery"></a>Adding Moxi Engage from the gallery
...
### <a name="creating-a-moxi-engage-test-user"></a>Creating a Moxi Engage test user
