...
---
# <a name="tutorial-azure-active-directory-integration-with-montage-online"></a>Tutorial: Azure Active Directory integration with Montage Online
...
## <a name="adding-montage-online-from-the-gallery"></a>Adding Montage Online from the gallery
...
### <a name="create-a-montage-online-test-user"></a>Create a Montage Online test user
