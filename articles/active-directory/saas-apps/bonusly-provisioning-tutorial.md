...
---
# <a name="tutorial-configure-bonusly-for-automatic-user-provisioning"></a>Tutorial: Configure Bonusly for automatic user provisioning
...
## <a name="assigning-users-to-bonusly"></a>Assigning users to Bonusly
...
### <a name="important-tips-for-assigning-users-to-bonusly"></a>Important tips for assigning users to Bonusly
...
## <a name="configuring-automatic-user-provisioning-to-bonusly"></a>Configuring automatic user provisioning to Bonusly
...
### <a name="to-configure-automatic-user-provisioning-for-bonusly-in-azure-ad"></a>To configure automatic user provisioning for Bonusly in Azure AD:
