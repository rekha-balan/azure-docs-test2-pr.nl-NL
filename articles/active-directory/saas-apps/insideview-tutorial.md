...
## <a name="adding-insideview-from-the-gallery"></a>Adding InsideView from the gallery
...
### <a name="creating-a-insideview-test-user"></a>Creating a InsideView test user
