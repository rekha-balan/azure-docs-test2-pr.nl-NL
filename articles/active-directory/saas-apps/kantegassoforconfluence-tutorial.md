...
---
# <a name="tutorial-azure-active-directory-integration-with-kantega-sso-for-confluence"></a>Tutorial: Azure Active Directory integration with Kantega SSO for Confluence
...
## <a name="adding-kantega-sso-for-confluence-from-the-gallery"></a>Adding Kantega SSO for Confluence from the gallery
...
### <a name="creating-a-kantega-sso-for-confluence-test-user"></a>Creating a Kantega SSO for Confluence test user
