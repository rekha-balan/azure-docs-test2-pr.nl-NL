...
---
# <a name="tutorial-azure-active-directory-integration-with-fiscalnote"></a>Tutorial: Azure Active Directory integration with FiscalNote
...
## <a name="adding-fiscalnote-from-the-gallery"></a>Adding FiscalNote from the gallery
...
### <a name="create-a-fiscalnote-test-user"></a>Create a FiscalNote test user
