...
---
# <a name="tutorial-azure-active-directory-integration-with-dome9-arc"></a>Tutorial: Azure Active Directory integration with Dome9 Arc
...
## <a name="adding-dome9-arc-from-the-gallery"></a>Adding Dome9 Arc from the gallery
...
### <a name="create-a-dome9-arc-test-user"></a>Create a Dome9 Arc test user
