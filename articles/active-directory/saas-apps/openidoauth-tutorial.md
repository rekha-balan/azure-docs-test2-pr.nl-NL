...
---
# <a name="steps-to-configure-an-openidoauth-application-from-azure-ad-app-gallery"></a>Steps to configure an OpenID/OAuth application from Azure AD App gallery

## <a name="process-of-open-id-application-addition-from-gallery"></a>Process of Open ID application addition from gallery
...
## <a name="what-is-consent-framework"></a>What is Consent Framework?
...
## <a name="whats-the-difference-between-admin-consent-and-user-consent"></a>What’s the difference between Admin consent and User consent?
