...
---
# <a name="tutorial-azure-active-directory-integration-with-sciforma"></a>Tutorial: Azure Active Directory integration with Sciforma
...
## <a name="adding-sciforma-from-the-gallery"></a>Adding Sciforma from the gallery
...
### <a name="creating-a-sciforma-test-user"></a>Creating a Sciforma test user
