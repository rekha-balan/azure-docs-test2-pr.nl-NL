...
## <a name="adding-splunk-enterprise-and-splunk-cloud-from-the-gallery"></a>Adding Splunk Enterprise and Splunk Cloud from the gallery
...
### <a name="creating-a-splunk-enterprise-and-splunk-cloud-test-user"></a>Creating a Splunk Enterprise and Splunk Cloud test user
