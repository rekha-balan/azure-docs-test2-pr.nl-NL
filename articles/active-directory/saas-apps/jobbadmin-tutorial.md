...
---
# <a name="tutorial-azure-active-directory-integration-with-jobbadmin"></a>Tutorial: Azure Active Directory integration with Jobbadmin
...
## <a name="adding-jobbadmin-from-the-gallery"></a>Adding Jobbadmin from the gallery
...
### <a name="creating-a-jobbadmin-test-user"></a>Creating a Jobbadmin test user
