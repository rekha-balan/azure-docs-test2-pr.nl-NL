...
---
# <a name="tutorial-azure-active-directory-integration-with-tivitz"></a>Tutorial: Azure Active Directory integration with TiViTz
...
## <a name="adding-tivitz-from-the-gallery"></a>Adding TiViTz from the gallery
...
### <a name="creating-a-tivitz-test-user"></a>Creating a TiViTz test user
