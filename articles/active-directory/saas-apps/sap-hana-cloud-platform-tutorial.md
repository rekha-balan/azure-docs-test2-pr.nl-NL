...
---
# <a name="tutorial-azure-active-directory-integration-with-sap-cloud-platform"></a>Tutorial: Azure Active Directory integration with SAP Cloud Platform
...
## <a name="adding-sap-cloud-platform-from-the-gallery"></a>Adding SAP Cloud Platform from the gallery
...
### <a name="create-a-sap-cloud-platform-test-user"></a>Create a SAP Cloud Platform test user
