...
---
# <a name="tutorial-azure-active-directory-integration-with-adp"></a>Tutorial: Azure Active Directory integration with ADP
...
## <a name="adding-adp-from-the-gallery"></a>Adding ADP from the gallery
...
### <a name="configure-your-adp-services-for-federated-access"></a>Configure your ADP service(s) for federated access
...
### <a name="create-an-adp-test-user"></a>Create an ADP test user
