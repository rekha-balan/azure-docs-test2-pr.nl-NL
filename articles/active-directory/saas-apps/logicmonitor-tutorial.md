...
## <a name="adding-logicmonitor-from-the-gallery"></a>Adding LogicMonitor from the gallery
...
### <a name="creating-a-logicmonitor-test-user"></a>Creating a LogicMonitor test user
