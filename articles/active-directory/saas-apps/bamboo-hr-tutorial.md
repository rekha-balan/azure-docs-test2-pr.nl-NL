...
---
# <a name="tutorial-azure-active-directory-integration-with-bamboohr"></a>Tutorial: Azure Active Directory integration with BambooHR
...
## <a name="add-bamboohr-from-the-gallery"></a>Add BambooHR from the gallery
...
### <a name="create-a-bamboohr-test-user"></a>Create a BambooHR test user
