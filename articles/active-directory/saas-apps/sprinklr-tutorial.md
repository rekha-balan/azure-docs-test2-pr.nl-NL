...
## <a name="adding-sprinklr-from-the-gallery"></a>Adding Sprinklr from the gallery
...
### <a name="creating-a-sprinklr-test-user"></a>Creating a Sprinklr test user
...
When you click the Sprinklr tile in the Access Panel, you should get automatically signed-on to your Sprinklr application For more information about the Access Panel, see [Introduction to the Access Panel](../user-help/active-directory-saas-access-panel-introduction.md). 
