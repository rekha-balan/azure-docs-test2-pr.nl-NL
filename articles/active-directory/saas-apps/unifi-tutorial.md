...
---
# <a name="tutorial-azure-active-directory-integration-with-unifi"></a>Tutorial: Azure Active Directory integration with UNIFI
...
## <a name="adding-unifi-from-the-gallery"></a>Adding UNIFI from the gallery
...
### <a name="creating-a-unifi-test-user"></a>Creating a UNIFI test user
