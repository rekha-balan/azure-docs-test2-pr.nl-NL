...
## <a name="add-timeoffmanager-from-the-gallery"></a>Add TimeOffManager from the gallery
...
### <a name="create-a-timeoffmanager-test-user"></a>Create a TimeOffManager test user
