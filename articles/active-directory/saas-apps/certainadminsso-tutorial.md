...
---
# <a name="tutorial-azure-active-directory-integration-with-certain-admin-sso"></a>Tutorial: Azure Active Directory integration with Certain Admin SSO
...
## <a name="adding-certain-admin-sso-from-the-gallery"></a>Adding Certain Admin SSO from the gallery
...
### <a name="create-a-certain-admin-sso-test-user"></a>Create a Certain Admin SSO test user
