...
## <a name="adding-rally-software-from-the-gallery"></a>Adding Rally Software from the gallery
...
### <a name="create-a-rally-software-test-user"></a>Create a Rally Software test user
