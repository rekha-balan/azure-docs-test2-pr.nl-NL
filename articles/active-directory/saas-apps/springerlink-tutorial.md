...
---
# <a name="tutorial-azure-active-directory-integration-with-springer-link"></a>Tutorial: Azure Active Directory integration with Springer Link
...
## <a name="adding-springer-link-from-the-gallery"></a>Adding Springer Link from the gallery
...
1. In the search box, type **Springer Link**, select **Springer Link** from result panel then click **Add** button to add the application.
