...
---
# <a name="tutorial-azure-active-directory-integration-with-screencast-o-matic"></a>Tutorial: Azure Active Directory integration with Screencast-O-Matic
...
## <a name="adding-screencast-o-matic-from-the-gallery"></a>Adding Screencast-O-Matic from the gallery
...
### <a name="create-a-screencast-o-matic-test-user"></a>Create a Screencast-O-Matic test user
