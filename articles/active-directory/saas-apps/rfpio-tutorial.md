...
---
# <a name="tutorial-azure-active-directory-integration-with-rfpio"></a>Tutorial: Azure Active Directory integration with RFPIO
...
## <a name="add-rfpio-from-the-gallery"></a>Add RFPIO from the gallery
...
### <a name="to-add-rfpio-from-the-gallery"></a>To add RFPIO from the gallery
...
### <a name="create-a-rfpio-test-user"></a>Create a RFPIO test user
