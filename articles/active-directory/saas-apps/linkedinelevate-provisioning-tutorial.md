...
---
# <a name="tutorial-configure-linkedin-elevate-for-automatic-user-provisioning"></a>Tutorial: Configure LinkedIn Elevate for automatic user provisioning
...
## <a name="assigning-users-to-linkedin-elevate"></a>Assigning users to LinkedIn Elevate
...
### <a name="important-tips-for-assigning-users-to-linkedin-elevate"></a>Important tips for assigning users to LinkedIn Elevate
...
## <a name="configuring-user-provisioning-to-linkedin-elevate"></a>Configuring user provisioning to LinkedIn Elevate
...
### <a name="to-configure-automatic-user-account-provisioning-to-linkedin-elevate-in-azure-ad"></a>To configure automatic user account provisioning to LinkedIn Elevate in Azure AD:
