...
---
# <a name="tutorial-azure-active-directory-integration-with-mindwireless"></a>Tutorial: Azure Active Directory integration with mindWireless
...
## <a name="adding-mindwireless-from-the-gallery"></a>Adding mindWireless from the gallery
...
### <a name="create-a-mindwireless-test-user"></a>Create a mindWireless test user
