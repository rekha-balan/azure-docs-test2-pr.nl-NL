...
---
# <a name="tutorial-azure-active-directory-integration-with-ibm-openpages"></a>Tutorial: Azure Active Directory integration with IBM OpenPages
...
## <a name="adding-ibm-openpages-from-the-gallery"></a>Adding IBM OpenPages from the gallery
...
### <a name="create-an-ibm-openpages-test-user"></a>Create an IBM OpenPages test user
