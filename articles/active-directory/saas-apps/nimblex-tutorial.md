...
---
# <a name="tutorial-azure-active-directory-integration-with-nimblex"></a>Tutorial: Azure Active Directory integration with Nimblex
...
## <a name="adding-nimblex-from-the-gallery"></a>Adding Nimblex from the gallery
...
### <a name="create-a-nimblex-test-user"></a>Create a Nimblex test user
