...
---
# <a name="tutorial-azure-active-directory-integration-with-jira-saml-sso-by-microsoft"></a>Tutorial: Azure Active Directory integration with JIRA SAML SSO by Microsoft
...
## <a name="supported-versions-of-jira"></a>Supported versions of JIRA
...
## <a name="adding-jira-saml-sso-by-microsoft-from-the-gallery"></a>Adding JIRA SAML SSO by Microsoft from the gallery
...
### <a name="create-a-jira-saml-sso-by-microsoft-test-user"></a>Create a JIRA SAML SSO by Microsoft test user
