...
---
# <a name="tutorial-azure-active-directory-integration-with-convercent"></a>Tutorial: Azure Active Directory integration with Convercent
...
## <a name="adding-convercent-from-the-gallery"></a>Adding Convercent from the gallery
...
### <a name="creating-a-convercent-test-user"></a>Creating a Convercent test user
