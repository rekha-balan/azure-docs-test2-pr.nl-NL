...
---
# <a name="tutorial-azure-active-directory-integration-with-workteam"></a>Tutorial: Azure Active Directory integration with Workteam
...
## <a name="adding-workteam-from-the-gallery"></a>Adding Workteam from the gallery
...
### <a name="create-a-workteam-test-user"></a>Create a Workteam test user
