...
---
# <a name="tutorial-azure-active-directory-integration-with-qumu-cloud"></a>Tutorial: Azure Active Directory integration with Qumu Cloud
...
## <a name="adding-qumu-cloud-from-the-gallery"></a>Adding Qumu Cloud from the gallery
...
### <a name="create-a-qumu-cloud-test-user"></a>Create a Qumu Cloud test user
