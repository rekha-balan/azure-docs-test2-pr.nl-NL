...
---
# <a name="tutorial-azure-active-directory-integration-with-cylanceprotect"></a>Tutorial: Azure Active Directory integration with CylancePROTECT
...
## <a name="adding-cylanceprotect-from-the-gallery"></a>Adding CylancePROTECT from the gallery
...
### <a name="create-a-cylanceprotect-test-user"></a>Create a CylancePROTECT test user
