...
---
# <a name="tutorial-azure-active-directory-integration-with-confluence-saml-sso-by-microsoft"></a>Tutorial: Azure Active Directory integration with Confluence SAML SSO by Microsoft
...
## <a name="supported-versions-of-confluence"></a>Supported versions of Confluence 
...
## <a name="adding-confluence-saml-sso-by-microsoft-from-the-gallery"></a>Adding Confluence SAML SSO by Microsoft from the gallery
...
### <a name="creating-a-confluence-saml-sso-by-microsoft-test-user"></a>Creating a Confluence SAML SSO by Microsoft test user
