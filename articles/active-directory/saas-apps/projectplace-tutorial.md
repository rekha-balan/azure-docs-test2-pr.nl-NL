...
## <a name="adding-projectplace-from-the-gallery"></a>Adding Projectplace from the gallery
...
### <a name="creating-a-projectplace-test-user"></a>Creating a Projectplace test user
