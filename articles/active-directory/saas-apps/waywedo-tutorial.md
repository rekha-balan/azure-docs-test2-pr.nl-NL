...
---
# <a name="tutorial-azure-active-directory-integration-with-way-we-do"></a>Tutorial: Azure Active Directory integration with Way We Do
...
## <a name="adding-way-we-do-from-the-gallery"></a>Adding Way We Do from the gallery
...
### <a name="create-a-way-we-do-test-user"></a>Create a Way We Do test user
