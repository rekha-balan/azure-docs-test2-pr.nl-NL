...
### <a name="configuring-reauthentication-frequency"></a>Configuring Reauthentication Frequency
...
### <a name="creating-a-workplace-by-facebook-test-user"></a>Creating a Workplace by Facebook test user
