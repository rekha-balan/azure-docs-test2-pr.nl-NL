...
---
# <a name="tutorial-azure-active-directory-integration-with-elium"></a>Tutorial: Azure Active Directory integration with Elium
...
## <a name="adding-elium-from-the-gallery"></a>Adding Elium from the gallery
...
### <a name="create-an-elium-test-user"></a>Create an Elium test user
