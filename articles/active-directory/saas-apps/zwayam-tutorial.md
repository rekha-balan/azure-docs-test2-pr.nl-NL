...
---
# <a name="tutorial-azure-active-directory-integration-with-zwayam"></a>Tutorial: Azure Active Directory integration with Zwayam
...
## <a name="adding-zwayam-from-the-gallery"></a>Adding Zwayam from the gallery
...
### <a name="create-a-zwayam-test-user"></a>Create a Zwayam test user
