...
## <a name="add-runmyprocess-from-the-gallery"></a>Add RunMyProcess from the gallery
...
### <a name="create-a-runmyprocess-test-user"></a>Create a RunMyProcess test user
...
2. Click **Account** and select **Users** in left navigation panel, then click **New User**.
   ...
   ![New User](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-runmyprocess-tutorial/tutorial_runmyprocess_003.png "New User")
3. In the **User Settings** section, perform the following steps:
   
   ![Profile](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-runmyprocess-tutorial/tutorial_runmyprocess_004.png "Profile")   
