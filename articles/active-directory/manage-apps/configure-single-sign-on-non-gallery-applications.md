...
---
# <a name="configure-single-sign-on-to-applications-that-are-not-in-the-azure-active-directory-application-gallery"></a>Configure single sign-on to applications that are not in the Azure Active Directory application gallery
...
### <a name="enter-basic-saml-configuration"></a>Enter basic SAML configuration
...
### <a name="review-or-customize-the-claims-issued-in-the-saml-token"></a>Review or customize the claims issued in the SAML token
...
### <a name="review-certificate-expiration-data-status-and-email-notification"></a>Review certificate expiration data, status, and email notification
...
### <a name="set-up-target-application"></a>Set up target application
...
### <a name="assign-users-and-groups-to-your-saml-application"></a>Assign users and groups to your SAML application
...
### <a name="test-the-saml-application"></a>Test the SAML application
