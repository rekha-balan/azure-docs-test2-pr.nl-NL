...
---
# <a name="migrate-ad-fs-on-premises-apps-to-azure"></a>Migrate AD FS on-premises apps to Azure 
...
## <a name="reasons-for-migrating-apps-to-azure-ad"></a>Reasons for migrating apps to Azure AD
...
## <a name="mapping-types-of-apps-on-premises-to-types-of-apps-in-azure-ad"></a>Mapping types of apps on-premises to types of apps in Azure AD
...
### <a name="federated-saas-apps-vs-custom-lob-apps"></a>Federated SaaS apps vs. custom LOB apps
...
### <a name="non-federated-apps"></a>Non-federated apps
...
## <a name="translating-on-premises-federated-apps-to-azure-ad"></a>Translating on-premises federated apps to Azure AD 
...
### <a name="representing-the-app-in-azure-ad-or-ad-fs"></a>Representing the app in Azure AD or AD FS
...
### <a name="representing-azure-ad-as-an-identity-provider-in-an-saas-app"></a>Representing Azure AD as an identity provider in an SaaS app
...
## <a name="migrating-saas-apps"></a>Migrating SaaS apps
...
### <a name="assess-what-can-be-migrated"></a>Assess what can be migrated
...
#### <a name="what-can-be-migrated-today"></a>What can be migrated today
...
#### <a name="apps-and-configurations-not-supported-in-azure-ad-today"></a>Apps and configurations not supported in Azure AD today
...
### <a name="configure-azure-ad"></a>Configure Azure AD    
#### <a name="configure-single-sign-on-sso-settings-for-the-saas-app"></a>Configure single sign-on (SSO) settings for the SaaS app
...
#### <a name="assign-users-to-the-app"></a>Assign users to the app
...
### <a name="configure-the-saas-app"></a>Configure the SaaS app
...
#### <a name="example-support-for-multiple-idps"></a>Example: Support for multiple IdPs
...
### <a name="optional-configure-user-provisioning-in-azure-ad"></a>Optional: Configure user provisioning in Azure AD
