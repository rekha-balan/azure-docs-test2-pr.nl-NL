...
---
# <a name="advanced-certificate-signing-options-in-the-saml-token-for-gallery-apps-in-azure-active-directory"></a>Advanced certificate signing options in the SAML token for gallery apps in Azure Active Directory
...
## <a name="certificate-signing-options"></a>Certificate signing options
...
## <a name="certificate-signing-algorithms"></a>Certificate signing algorithms
