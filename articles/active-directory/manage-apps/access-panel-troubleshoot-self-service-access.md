...
---
# <a name="problem-using-self-service-application-access"></a>Problem using self-service application access
...
## <a name="how-to-configure-self-service-application-access"></a>How to configure self-service application access
