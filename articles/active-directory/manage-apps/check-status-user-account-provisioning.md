...
---
# <a name="tutorial-reporting-on-automatic-user-account-provisioning"></a>Tutorial: Reporting on automatic user account provisioning
...
## <a name="getting-provisioning-reports-from-the-azure-management-portal"></a>Getting provisioning reports from the Azure management portal
...
## <a name="provisioning-summary-report"></a>Provisioning summary report
...
## <a name="provisioning-audit-logs"></a>Provisioning audit logs
...
### <a name="looking-up-provisioning-events-for-a-specific-user"></a>Looking up provisioning events for a specific user
...
### <a name="tips-for-viewing-the-provisioning-audit-logs"></a>Tips for viewing the provisioning audit logs
