...
---
# <a name="remove-a-user-or-group-assignment-from-an-enterprise-app-in-azure-active-directory"></a>Remove a user or group assignment from an enterprise app in Azure Active Directory
...
## <a name="how-do-i-remove-a-user-or-group-assignment-to-an-enterprise-app-in-the-azure-portal"></a>How do I remove a user or group assignment to an enterprise app in the Azure portal?
...
## <a name="how-do-i-remove-a-user-or-group-assignment-to-an-enterprise-app-using-powershell"></a>How do I remove a user or group assignment to an enterprise app using PowerShell?
