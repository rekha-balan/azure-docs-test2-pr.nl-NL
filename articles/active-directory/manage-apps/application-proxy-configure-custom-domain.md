...
## <a name="configure-a-custom-domain"></a>Configure a custom domain
...
## <a name="manage-certificates"></a>Manage certificates

### <a name="certificate-format"></a>Certificate format
...
### <a name="changing-the-domain"></a>Changing the domain
