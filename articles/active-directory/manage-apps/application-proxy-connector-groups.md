...
## <a name="create-connector-groups"></a>Create connector groups
...
## <a name="assign-applications-to-your-connector-groups"></a>Assign applications to your connector groups
