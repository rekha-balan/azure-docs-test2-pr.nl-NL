...
---
# <a name="tutorial-configure-saml-based-single-sign-on-for-an-application-with-azure-active-directory"></a>Tutorial: Configure SAML-based single sign-on for an application with Azure Active Directory
...
## <a name="select-a-single-sign-on-mode"></a>Select a single sign-on mode
...
## <a name="configure-domain-and-urls"></a>Configure domain and URLs
...
## <a name="configure-user-attributes"></a>Configure user attributes
...
## <a name="create-a-saml-signing-certificate"></a>Create a SAML signing certificate
...
## <a name="configure-the-application-to-use-azure-ad"></a>Configure the application to use Azure AD
