...
---
# <a name="remove-personal-data-for-azure-active-directory-application-proxy"></a>Remove personal data for Azure Active Directory Application Proxy  
...
## <a name="where-is-the-personal-data"></a>Where is the personal data?
It is possible for Application Proxy to write personal data to the following log types:

- Connector event logs
- Windows event logs

## <a name="remove-personal-data-from-windows-event-logs"></a>Remove personal data from Windows event logs
...
## <a name="remove-personal-data-from-connector-event-logs"></a>Remove personal data from Connector event logs
...
### <a name="view-or-export-specific-data"></a>View or export specific data
...
### <a name="delete-specific-data"></a>Delete specific data
...
### <a name="turn-off-connector-logs"></a>Turn off connector logs
