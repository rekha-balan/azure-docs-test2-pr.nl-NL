...
---
# <a name="redirect-hardcoded-links-for-apps-published-with-azure-ad-application-proxy"></a>Redirect hardcoded links for apps published with Azure AD Application Proxy
...
### <a name="option-1-intune-managed-browser-integration"></a>Option 1: Intune Managed Browser Integration 
...
### <a name="option-2-myapps-browser-extension"></a>Option 2: MyApps Browser Extension 
...
### <a name="option-3-link-translation-setting"></a>Option 3: Link Translation Setting 
...
## <a name="how-link-translation-works"></a>How link translation works
...
### <a name="which-links-are-affected"></a>Which links are affected?
...
### <a name="how-do-apps-link-to-each-other"></a>How do apps link to each other?
...
### <a name="which-links-arent-translated"></a>Which links aren't translated?
...
## <a name="enable-link-translation"></a>Enable link translation
...
## <a name="send-feedback"></a>Send feedback
