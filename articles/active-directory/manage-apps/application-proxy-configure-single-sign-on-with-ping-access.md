...
---
# <a name="header-based-authentication-for-single-sign-on-with-application-proxy-and-pingaccess"></a>Header-based authentication for single sign-on with Application Proxy and PingAccess
...
## <a name="what-is-pingaccess-for-azure-ad"></a>What is PingAccess for Azure AD?
...
## <a name="how-do-i-get-access"></a>How do I get access?
...
## <a name="publish-your-application-in-azure"></a>Publish your application in Azure
...
### <a name="install-an-application-proxy-connector"></a>Install an Application Proxy connector
...
### <a name="add-your-app-to-azure-ad-with-application-proxy"></a>Add your app to Azure AD with Application Proxy
...
### <a name="collect-information-for-the-pingaccess-steps"></a>Collect information for the PingAccess steps
...
### <a name="optional---update-graphapi-to-send-custom-fields"></a>Optional - Update GraphAPI to send custom fields
...
### <a name="optional---use-a-custom-claim"></a>Optional - Use a custom claim
...
## <a name="download-pingaccess-and-configure-your-app"></a>Download PingAccess and configure your app
