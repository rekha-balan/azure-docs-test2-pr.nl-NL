...
### <a name="check-if-the-connector-traffic-bypasses-outbound-proxies"></a>Check if the connector traffic bypasses outbound proxies
...
### <a name="check-if-the-connector-traffic-uses-outbound-proxies"></a>Check if the connector traffic uses outbound proxies
