...
---
# <a name="problems-signing-in-to-a-non-gallery-application-configured-for-federated-single-sign-on"></a>Problems signing in to a non-gallery application configured for federated single sign-on
...
## <a name="the-reply-address-does-not-match-the-reply-addresses-configured-for-the-application"></a>The reply address does not match the reply addresses configured for the application. 
...
## <a name="problem-when-customizing-the-saml-claims-sent-to-an-application"></a>Problem when customizing the SAML claims sent to an application
