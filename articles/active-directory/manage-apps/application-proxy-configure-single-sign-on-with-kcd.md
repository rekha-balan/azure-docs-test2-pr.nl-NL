...
---
# <a name="kerberos-constrained-delegation-for-single-sign-on-to-your-apps-with-application-proxy"></a>Kerberos Constrained Delegation for single sign-on to your apps with Application Proxy
...
## <a name="how-single-sign-on-with-kcd-works"></a>How single sign-on with KCD works
...
### <a name="configure-active-directory"></a>Configure Active Directory
...
#### <a name="connector-and-application-server-in-the-same-domain"></a>Connector and application server in the same domain
...
#### <a name="connector-and-application-server-in-different-domains"></a>Connector and application server in different domains
...
## <a name="working-with-different-on-premises-and-cloud-identities"></a>Working with different on-premises and cloud identities
...
### <a name="configure-sso-for-different-identities"></a>Configure SSO for different identities
