...
---
# <a name="create-an-unattended-installation-script-for-the-azure-ad-application-proxy-connector"></a>Create an unattended installation script for the Azure AD Application Proxy connector
...
## <a name="register-the-connector-with-azure-ad"></a>Register the connector with Azure AD
