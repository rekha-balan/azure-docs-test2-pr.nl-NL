...
---
# <a name="troubleshoot-kerberos-constrained-delegation-configurations-for-application-proxy"></a>Troubleshoot Kerberos constrained delegation configurations for Application Proxy
...
### <a name="client-pre-authentication"></a>Client pre-authentication 
...
### <a name="delegation-service"></a>Delegation service 
...
### <a name="target-application"></a>Target application 
