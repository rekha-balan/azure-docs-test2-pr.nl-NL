...
---
# <a name="problem-configuring-federated-single-sign-on-for-an-azure-ad-gallery-application"></a>Problem configuring federated single sign-on for an Azure AD Gallery application
...
## <a name="cant-add-the-identifier-or-the-reply-url"></a>Can’t add the Identifier or the Reply URL
...
## <a name="cant-find-the-azure-ad-metadata-to-complete-the-configuration-with-the-application"></a>Can’t find the Azure AD metadata to complete the configuration with the application
