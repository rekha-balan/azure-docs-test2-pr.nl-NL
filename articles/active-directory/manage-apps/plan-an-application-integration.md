...
## <a name="take-inventory"></a>Take inventory
...
### <a name="find-unsanctioned-cloud-applications-with-cloud-discovery"></a>Find unsanctioned cloud applications with Cloud Discovery
