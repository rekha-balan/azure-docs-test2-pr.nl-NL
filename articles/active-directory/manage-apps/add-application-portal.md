...
---
# <a name="quickstart-add-an-application-to-your-azure-active-directory-tenant"></a>Quickstart: Add an application to your Azure Active Directory tenant
...
## <a name="add-an-application-to-your-azure-ad-tenant"></a>Add an application to your Azure AD tenant
...
## <a name="find-your-azure-ad-tenant-application"></a>Find your Azure AD tenant application
...
## <a name="configure-user-sign-in-properties"></a>Configure user sign-in properties
...
## <a name="use-a-custom-logo"></a>Use a custom logo
