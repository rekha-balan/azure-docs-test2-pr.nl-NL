...
---
# <a name="configure-azure-active-directory-sign-in-behavior-for-an-application-by-using-a-home-realm-discovery-policy"></a>Configure Azure Active Directory sign in behavior for an application by using a Home Realm Discovery policy
...
### <a name="domain-hints"></a>Domain hints    
...
## <a name="enable-direct-authentication-for-legacy-applications"></a>Enable direct authentication for legacy applications
...
## <a name="set-hrd-policy"></a>Set HRD policy
...
### <a name="priority-and-evaluation-of-hrd-policies"></a>Priority and evaluation of HRD policies
...
## <a name="tutorial-for-setting-hrd-policy-on-an-application"></a>Tutorial for setting HRD policy on an application 
...
### <a name="example-set-hrd-policy-for-an-application"></a>Example: Set HRD policy for an application 
...
#### <a name="step-1-create-an-hrd-policy"></a>Step 1: Create an HRD policy
...
#### <a name="step-2-locate-the-service-principal-to-which-to-assign-the-policy"></a>Step 2: Locate the service principal to which to assign the policy  
...
#### <a name="step-3-assign-the-policy-to-your-service-principal"></a>Step 3: Assign the policy to your service principal  
...
#### <a name="step-4-check-which-application-service-principals-your-hrd-policy-is-assigned-to"></a>Step 4: Check which application service principals your HRD policy is assigned to
...
```
#### <a name="step-5-youre-done"></a>Step 5: You're done!
Try the application to check that the new policy is working.

### <a name="example-list-the-applications-for-which-hrd-policy-is-configured"></a>Example: List the applications for which HRD policy is configured

#### <a name="step-1-list-all-policies-that-were-created-in-your-organization"></a>Step 1: List all policies that were created in your organization 
...
#### <a name="step-2-list-the-service-principals-to-which-the-policy-is-assigned"></a>Step 2: List the service principals to which the policy is assigned  

``` powershell
Get-AzureADPolicyAppliedObject -ObjectId <ObjectId of the Policy>
```

### <a name="example-remove-an-hrd-policy-for-an-application"></a>Example: Remove an HRD policy for an application
#### <a name="step-1-get-the-objectid"></a>Step 1: Get the ObjectID
...
#### <a name="step-2-remove-the-policy-assignment-from-the-application-service-principal"></a>Step 2: Remove the policy assignment from the application service principal  

``` powershell
Remove-AzureADApplicationPolicy -ObjectId <ObjectId of the Service Principal>  -PolicyId <ObjectId of the policy>
```

#### <a name="step-3-check-removal-by-listing-the-service-principals-to-which-the-policy-is-assigned"></a>Step 3: Check removal by listing the service principals to which the policy is assigned 
