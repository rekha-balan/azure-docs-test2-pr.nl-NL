...
---
# <a name="problems-signing-in-to-an-azure-ad-gallery-application-configured-for-password-single-sign-on"></a>Problems signing in to an Azure AD Gallery application configured for password single sign-on
