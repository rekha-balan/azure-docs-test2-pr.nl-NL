...
---
# <a name="assign-a-user-or-group-to-an-enterprise-app-in-azure-active-directory"></a>Assign a user or group to an enterprise app in Azure Active Directory
...
## <a name="how-do-i-assign-user-access-to-an-enterprise-app-in-the-azure-portal"></a>How do I assign user access to an enterprise app in the Azure portal?
...
## <a name="how-do-i-assign-a-user-to-an-enterprise-app-using-powershell"></a>How do I assign a user to an enterprise app using PowerShell?
