...
---
# <a name="security-considerations-for-accessing-apps-remotely-with-azure-ad-application-proxy"></a>Security considerations for accessing apps remotely with Azure AD Application Proxy
...
## <a name="security-benefits"></a>Security benefits

Azure AD Application Proxy offers the following security benefits:

### <a name="authenticated-access"></a>Authenticated access 
...
### <a name="traffic-termination"></a>Traffic termination
...
### <a name="all-access-is-outbound"></a>All access is outbound 
...
### <a name="cloud-scale-analytics-and-machine-learning"></a>Cloud-scale analytics and machine learning 
...
### <a name="remote-access-as-a-service"></a>Remote access as a service
...
### <a name="ddos-prevention"></a>DDOS prevention
...
#### <a name="1-the-service-authenticates-the-user-for-the-app"></a>1. The service authenticates the user for the app
...
#### <a name="2-the-service-places-a-request-in-the-connector-queue"></a>2. The service places a request in the connector queue
...
#### <a name="3-the-connector-processes-the-request-from-the-queue"></a>3. The connector processes the request from the queue. 
...
#### <a name="4-the-connector-waits-for-a-response"></a>4. The connector waits for a response.
...
#### <a name="5-the-service-streams-data-to-the-user"></a>5. The service streams data to the user. 
