...
---
# <a name="enable-remote-access-to-sharepoint-with-azure-ad-application-proxy"></a>Enable remote access to SharePoint with Azure AD Application Proxy
...
## <a name="step-1-set-up-single-sign-on-to-sharepoint"></a>Step 1: Set up single sign-on to SharePoint
...
### <a name="ensure-that-sharepoint-is-running-under-a-service-account"></a>Ensure that SharePoint is running under a service account
...
### <a name="configure-sharepoint-for-kerberos"></a>Configure SharePoint for Kerberos
...
### <a name="set-a-service-principal-name-for-the-sharepoint-service-account"></a>Set a service principal name for the SharePoint service account
...
### <a name="ensure-that-the-connector-is-set-as-a-trusted-delegate-to-sharepoint"></a>Ensure that the connector is set as a trusted delegate to SharePoint
...
## <a name="step-2-enable-remote-access-to-sharepoint"></a>Step 2: Enable remote access to SharePoint
...
## <a name="step-3-ensure-that-sharepoint-knows-about-the-external-url"></a>Step 3: Ensure that SharePoint knows about the external URL
