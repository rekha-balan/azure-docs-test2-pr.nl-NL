...
---
# <a name="view-your-azure-active-directory-tenant-applications"></a>View your Azure Active Directory tenant applications
...
## <a name="find-the-list-of-tenant-applications"></a>Find the list of tenant applications
...
## <a name="select-viewing-options"></a>Select viewing options
...
## <a name="search-for-a-tenant-application"></a>Search for a tenant application
