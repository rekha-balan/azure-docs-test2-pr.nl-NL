...
---
# <a name="writing-expressions-for-attribute-mappings-in-azure-active-directory"></a>Writing Expressions for Attribute Mappings in Azure Active Directory
...
## <a name="syntax-overview"></a>Syntax Overview
...
## <a name="list-of-functions"></a>List of Functions
...
**Function:**<br> Append(source, suffix)

**Description:**<br> Takes a source string value and appends the suffix to the end of it.
...
**Function:**<br> FormatDateTime(source, inputFormat, outputFormat)

**Description:**<br> Takes a date string from one format and converts it into a different format.
...
- - -
### <a name="join"></a>Join
**Function:**<br> Join(separator, source1, source2, …)

**Description:**<br> Join() is similar to Append(), except that it can combine multiple **source** string values into a single string, and each value will be separated by a **separator** string.
...
- - -
### <a name="mid"></a>Mid
**Function:**<br> Mid(source, start, length)

**Description:**<br> Returns a substring of the source value. A substring is a string that contains only some of the characters from the source string.
...
- - -
### <a name="not"></a>Not
**Function:**<br> Not(source)

**Description:**<br> Flips the boolean value of the **source**. If **source** value is "*True*", returns "*False*". Otherwise, returns "*True*".
...
**Function:**<br> Replace(source, oldValue, regexPattern, regexGroupName, replacementValue, replacementAttributeName, template)
...
**Function:**<br> SingleAppRoleAssignment([appRoleAssignments])

**Description:**<br> Requires one string argument. Returns the string, but with any diacritical characters repalced with equivalent non-diacritical characters.
...
**Function:**<br> StripSpaces(source)

**Description:**<br> Removes all space (" ") characters from the source string.
...
**Function:**<br> Switch(source, defaultValue, key1, value1, key2, value2, …)

**Description:**<br> When **source** value matches a **key**, returns **value** for that **key**. If **source** value doesn't match any keys, returns **defaultValue**.  **Key** and **value** parameters must always come in pairs. The function always expects an even number of parameters.
...
### <a name="strip-known-domain-name"></a>Strip known domain name
...
### <a name="append-constant-suffix-to-user-name"></a>Append constant suffix to user name
...
### <a name="generate-user-alias-by-concatenating-parts-of-first-and-last-name"></a>Generate user alias by concatenating parts of first and last name
...
### <a name="remove-diacritics-from-a-string"></a>Remove diacritics from a string
...
### <a name="output-date-as-a-string-in-a-certain-format"></a>Output date as a string in a certain format
...
### <a name="replace-a-value-based-on-predefined-set-of-options"></a>Replace a value based on predefined set of options
