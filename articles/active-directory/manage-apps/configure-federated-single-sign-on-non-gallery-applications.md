...
## <a name="configuring-single-sign-on-to-non-gallery-applications"></a>Configuring single sign-on to non-gallery applications
...
## <a name="customizing-the-saml-claims-sent-to-an-application"></a>Customizing the SAML claims sent to an application
