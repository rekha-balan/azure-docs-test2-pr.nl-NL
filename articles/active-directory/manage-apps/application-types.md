...
---
# <a name="unexpected-application-in-my-applications-list"></a>Unexpected application in my applications list

This article help you to understand how applications appear in your **All Applications** list under **Enterprise Applications**. 

## <a name="how-to-see-all-applications-in-your-tenant"></a>How to see all applications in your tenant
...
## <a name="why-does-a-specific-application-appear-in-my-all-applications-list"></a>Why does a specific application appear in my all applications list?
...
## <a name="i-want-to-disable-all-access-to-an-application-for-every-user"></a>I want to disable all access to an application for every user
