...
---
# <a name="problem-configuring-password-single-sign-on-for-an-azure-ad-gallery-application"></a>Problem configuring password single sign-on for an Azure AD Gallery application
...
## <a name="credentials-are-filled-in-but-the-extension-does-not-submit-them"></a>Credentials are filled in, but the extension does not submit them
...
## <a name="credentials-are-filled-in-and-submitted-but-the-page-indicates-the-credentials-are-incorrect"></a>Credentials are filled in and submitted, but the page indicates the credentials are incorrect
...
## <a name="the-extension-works-in-chrome-and-firefox-but-not-in-internet-explorer"></a>The extension works in Chrome and Firefox, but not in Internet Explorer
...
## <a name="check-if-the-applications-login-page-has-changed-recently-or-requires-an-additional-field"></a>Check if the application’s login page has changed recently or requires an additional field
