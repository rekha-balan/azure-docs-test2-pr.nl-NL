...
---
# <a name="application-management-with-azure-active-directory"></a>Application management with Azure Active Directory
...
## <a name="why-manage-applications-with-a-cloud-solution"></a>Why manage applications with a cloud solution?
...
## <a name="manage-risk-with-conditional-access-policies"></a>Manage risk with conditional access policies
...
## <a name="improve-productivity-with-single-sign-on"></a>Improve productivity with single sign-on
...
## <a name="address-governance-and-compliance"></a>Address governance and compliance
