...
## <a name="improvements-to-the-azure-active-directory-application-gallery"></a>Improvements to the Azure Active Directory Application Gallery
...
## <a name="quickstart-get-going-with-your-new-application-right-away"></a>Quickstart: Get going with your new application right away 
...
### <a name="relay-state-parameter"></a>Relay State parameter
