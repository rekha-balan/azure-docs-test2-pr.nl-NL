...
## <a name="add-skydesk-email-from-the-gallery"></a>Add SkyDesk Email from the gallery
...
### <a name="create-a-skydesk-email-test-user"></a>Create a SkyDesk Email test user
