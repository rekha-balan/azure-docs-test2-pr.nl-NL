...
---
# <a name="use-tenant-restrictions-to-manage-access-to-saas-cloud-applications"></a>Use Tenant Restrictions to manage access to SaaS cloud applications
...
## <a name="set-up-tenant-restrictions"></a>Set up Tenant Restrictions
...
### <a name="urls-and-ip-addresses"></a>URLs and IP addresses
...
### <a name="proxy-configuration-and-requirements"></a>Proxy configuration and requirements
...
## <a name="the-user-experience"></a>The user experience
...
## <a name="office-365-support-for-tenant-restrictions"></a>Office 365 support for Tenant Restrictions
...
### <a name="fiddler-for-a-host-based-approach"></a>Fiddler for a host-based approach
...
### <a name="staged-rollout-of-proxy-settings"></a>Staged rollout of proxy settings
