...
---
# <a name="enable-application-proxy-in-the-classic-portal-and-download-connectors"></a>Enable Application Proxy in the classic portal and download connectors
...
## <a name="open-your-ports"></a>Open your ports
...
## <a name="enable-application-proxy-in-azure-ad"></a>Enable Application Proxy in Azure AD
...
4. Toggle **Enable Application Proxy Services for this Directory** to **Enabled**.
    ...
    ![Enable Application Proxy](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-application-proxy-enable/app_proxy_enable.png)
...
## <a name="install-and-register-the-connector"></a>Install and register the Connector
