...
---
# <a name="self-service-application-access-and-delegated-management-with-azure-active-directory"></a>Self-service application access and delegated management with Azure Active Directory
...
## <a name="configuring-self-service-application-access"></a>Configuring self-service application access
...
## <a name="delegated-application-access-management"></a>Delegated application access management
...
### <a name="configure-password-sso-credentials-if-applicable"></a>Configure Password SSO Credentials (if applicable)
