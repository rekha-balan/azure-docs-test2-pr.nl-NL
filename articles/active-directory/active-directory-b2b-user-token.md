...
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Understand user tokens in Azure AD B2B collaboration
...
## <a name="azure-ad-guest-token"></a>Azure AD guest token
```
...
## <a name="microsoft-account-guest-token"></a>Microsoft account guest token
```
