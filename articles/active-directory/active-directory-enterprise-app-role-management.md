...
---
# <a name="configure-the-role-claim-issued-in-the-saml-token-for-enterprise-applications-in-azure-active-directory"></a>Configure the role claim issued in the SAML token for enterprise applications in Azure Active Directory
...
## <a name="when-to-use-this-feature"></a>When to use this feature
...
## <a name="create-roles-for-an-application"></a>Create roles for an application
...
## <a name="update-an-existing-role"></a>Update an existing role
...
## <a name="delete-an-existing-role"></a>Delete an existing role
