...
---
# <a name="configuring-the-custom-banned-password-list"></a>Configuring the custom banned password list
...
## <a name="add-to-the-custom-list"></a>Add to the custom list
