...
---
# <a name="licensing-requirements-for-azure-ad-self-service-password-reset"></a>Licensing requirements for Azure AD self-service password reset
...
## <a name="compare-editions-and-features"></a>Compare editions and features
...
## <a name="enable-group-or-user-based-licensing"></a>Enable group or user-based licensing
