...
---
# <a name="advanced-configuration-options-for-the-nps-extension-for-multi-factor-authentication"></a>Advanced configuration options for the NPS extension for Multi-Factor Authentication
...
## <a name="ip-exceptions"></a>IP exceptions
