...
## <a name="how-to-turn-on-azure-multi-factor-authentication-for-azure-ad-administrators"></a>How to turn on Azure Multi-Factor Authentication for Azure AD Administrators
...
### <a name="option-1---licenses-that-include-mfa"></a>Option 1 - Licenses that include MFA
...
### <a name="option-2---mfa-consumption-based-model"></a>Option 2 - MFA consumption-based model
