...
## <a name="block-and-unblock-users"></a>Block and unblock users
...
### <a name="block-a-user"></a>Block a user
...
### <a name="unblock-a-user"></a>Unblock a user
...
### <a name="turn-on-fraud-alerts"></a>Turn on fraud alerts
...
### <a name="enable-named-locations-by-using-conditional-access"></a>Enable named locations by using conditional access
...
### <a name="enable-the-trusted-ips-feature-by-using-conditional-access"></a>Enable the Trusted IPs feature by using conditional access
...
### <a name="enable-the-trusted-ips-feature-by-using-service-settings"></a>Enable the Trusted IPs feature by using service settings
...
### <a name="considerations-about-app-passwords"></a>Considerations about app passwords
...
### <a name="guidance-for-app-password-names"></a>Guidance for app password names
...
### <a name="federated-or-single-sign-on-app-passwords"></a>Federated or single sign-on app passwords
...
### <a name="allow-users-to-create-app-passwords"></a>Allow users to create app passwords
...
## <a name="remember-multi-factor-authentication-for-trusted-devices"></a>Remember Multi-Factor Authentication for trusted devices
...
### <a name="how-the-feature-works"></a>How the feature works
...
### <a name="enable-and-disable-verification-methods"></a>Enable and disable verification methods
