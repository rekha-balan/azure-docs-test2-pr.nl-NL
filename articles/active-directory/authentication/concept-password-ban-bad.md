...
---
# <a name="eliminate-bad-passwords-in-your-organization"></a>Eliminate bad passwords in your organization
...
## <a name="global-banned-password-list"></a>Global banned password list
...
## <a name="preview-custom-banned-password-list"></a>Preview: Custom banned password list
...
## <a name="on-premises-hybrid-scenarios"></a>On-premises hybrid scenarios
...
## <a name="how-does-the-banned-password-list-work"></a>How does the banned password list work
