...
---
# <a name="user-portal-for-the-azure-multi-factor-authentication-server"></a>User portal for the Azure Multi-Factor Authentication Server
...
## <a name="deploy-the-user-portal-on-a-separate-server"></a>Deploy the user portal on a separate server
...
## <a name="configure-user-portal-settings-in-the-azure-multi-factor-authentication-server"></a>Configure user portal settings in the Azure Multi-Factor Authentication Server
