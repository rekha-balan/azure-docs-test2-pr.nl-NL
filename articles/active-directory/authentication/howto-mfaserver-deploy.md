...
### <a name="azure-mfa-server-components"></a>Azure MFA Server Components
...
## <a name="download-the-mfa-server"></a>Download the MFA Server
...
## <a name="install-and-configure-the-mfa-server"></a>Install and configure the MFA Server
...
### <a name="manual-import-from-active-directory"></a>Manual import from Active Directory
...
### <a name="automated-synchronization-with-active-directory"></a>Automated synchronization with Active Directory
...
## <a name="back-up-and-restore-azure-mfa-server"></a>Back up and restore Azure MFA Server
...
## <a name="managing-the-tlsssl-protocols-and-cipher-suites"></a>Managing the TLS/SSL Protocols and Cipher Suites
