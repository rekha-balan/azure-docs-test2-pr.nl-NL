...
---
# <a name="tutorial-use-risk-events-to-trigger-multi-factor-authentication-and-password-changes"></a>Tutorial: Use risk events to trigger Multi-Factor Authentication and password changes
...
## <a name="enable-risk-based-policies-for-sspr-and-mfa"></a>Enable risk-based policies for SSPR and MFA
...
### <a name="enable-users-to-register-for-multi-factor-authentication"></a>Enable users to register for Multi-Factor Authentication
...
### <a name="enable-risk-based-password-changes"></a>Enable risk-based password changes
...
### <a name="enable-risk-based-multi-factor-authentication"></a>Enable risk-based Multi-Factor Authentication
