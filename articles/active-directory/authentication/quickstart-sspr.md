...
---
# <a name="quickstart-self-service-password-reset"></a>Quickstart: Self-service password reset
...
## <a name="test-self-service-password-reset"></a>Test self-service password reset
