...
---
# <a name="tutorial-complete-an-azure-ad-self-service-password-reset-pilot-roll-out"></a>Tutorial: Complete an Azure AD self-service password reset pilot roll out
...
## <a name="test-sspr-as-a-user"></a>Test SSPR as a user
