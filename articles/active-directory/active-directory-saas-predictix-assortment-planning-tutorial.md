...
## <a name="add-predictix-assortment-planning-from-the-gallery"></a>Add Predictix Assortment Planning from the gallery
...
### <a name="create-an-predictix-assortment-planning-test-user"></a>Create an Predictix Assortment Planning test user
