...
---
# <a name="how-to-configure-automatic-registration-of-windows-domain-joined-devices-with-azure-active-directory"></a>How to configure automatic registration of Windows domain-joined devices with Azure Active Directory
...
## <a name="step-1-configure-service-connection-point"></a>Step 1: Configure service connection point
...
## <a name="step-2-setup-issuance-of-claims"></a>Step 2: Setup issuance of claims
...
### <a name="issue-account-type-claim"></a>Issue account type claim
...
### <a name="issue-objectguid-of-the-computer-account-on-premises"></a>Issue objectGUID of the computer account on-premises
...
### <a name="issue-objectsid-of-the-computer-account-on-premises"></a>Issue objectSID of the computer account on-premises
...
### <a name="issue-issuerid-for-computer-when-multiple-verified-domain-names-in-azure-ad"></a>Issue issuerID for computer when multiple verified domain names in Azure AD
...
### <a name="issue-immutableid-for-computer-when-one-for-users-exist-eg-alternate-login-id-is-set"></a>Issue ImmutableID for computer when one for users exist (e.g. alternate login ID is set)
...
### <a name="helper-script-to-create-the-ad-fs-issuance-transform-rules"></a>Helper script to create the AD FS issuance transform rules
...
## <a name="step-3-enable-windows-down-level-devices"></a>Step 3: Enable Windows down-level devices
...
### <a name="set-policy-in-azure-ad-to-enable-users-to-register-devices"></a>Set policy in Azure AD to enable users to register devices
...
### <a name="configure-on-premises-federation-service"></a>Configure on-premises federation service 
...
### <a name="add-the-azure-ad-device-authentication-end-point-to-the-local-intranet-zones"></a>Add the Azure AD device authentication end-point to the Local Intranet zones
...
## <a name="step-4-control-deployment-and-rollout"></a>Step 4: Control deployment and rollout
...
### <a name="create-a-group-policy-object"></a>Create a Group Policy object 
...
### <a name="windows-installer-packages-for-non-windows-10-computers"></a>Windows Installer packages for non-Windows 10 computers
...
## <a name="step-5-verify-registered-devices"></a>Step 5: Verify registered devices
