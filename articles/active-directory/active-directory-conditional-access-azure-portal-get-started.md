...
---
# <a name="get-started-with-conditional-access-in-azure-active-directory---preview"></a>Get started with conditional access in Azure Active Directory - preview
...
## <a name="policy-configuration-steps"></a>Policy configuration steps
...
## <a name="testing-the-policy"></a>Testing the policy
