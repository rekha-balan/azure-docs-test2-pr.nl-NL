...
## <a name="add-secure-deliver-from-the-gallery"></a>Add SECURE DELIVER from the gallery
...
### <a name="create-a-secure-deliver-test-user"></a>Create a SECURE DELIVER test user
