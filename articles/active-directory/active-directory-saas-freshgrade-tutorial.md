...
* You can control in Azure AD who has access to FreshGrade- You can enable your users to automatically get signed-on to FreshGrade single sign-on (SSO) with their Azure AD accounts
...
* A FreshGrade SSO enabled subscription
...
## <a name="add-freshgrade-from-the-gallery"></a>Add FreshGrade from the gallery
...
In this section, you configure and test Azure AD SSO with FreshGrade based on a test user called "Britta Simon".

For SSO to work, Azure AD needs to know what the counterpart user in FreshGrade is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in FreshGrade needs to be established.
...
To configure and test Azure AD SSO with FreshGrade, you need to complete the following building blocks:
...
In this section, you enable Azure AD SSO in the classic portal and configure SSO in your FreshGrade application.

**To configure Azure AD SSO with FreshGrade, perform the following steps:**
...
3. On the **Configure App Settings** dialog page, perform the following steps:
  ...
  1. In the **SIGN ON URL** textbox, type a URL using the following pattern:`https://<your-subdomain>.freshgrade.com` or `https://<your-subdomain>.onboarding.freshgrade.com`.
  2. click **Next**
4. On the **Configure single sign-on at FreshGrade** page, perform the following steps:
  ...
  3. Click **Download metadata**, and then save the file on your computer.
...
### <a name="create-a-azure-ad-test-user"></a>Create a Azure AD test user
...
### <a name="create-a-freshgrade-test-user"></a>Create a FreshGrade test user
