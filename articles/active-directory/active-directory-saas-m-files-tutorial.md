...
---
# <a name="tutorial-azure-active-directory-integration-with-m-files"></a>Tutorial: Azure Active Directory integration with M-Files
...
## <a name="adding-m-files-from-the-gallery"></a>Adding M-Files from the gallery
...
8. On the **Document Vault Connection Properties** window, perform the following steps:
  ...
  ![Configure Single Sign-On](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-m-files-tutorial/tutorial_m_files_11.png)  
...
### <a name="create-a-m-files-test-user"></a>Create a M-Files test user
