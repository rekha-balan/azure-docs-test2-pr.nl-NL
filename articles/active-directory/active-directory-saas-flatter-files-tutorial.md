...
## <a name="add-flatter-files-from-the-gallery"></a>Add Flatter Files from the gallery
...
2. On the **How would you like users to sign on to Flatter Files** page, select **Azure AD Single Sign-On**, and then click **Next**.
       ![Configure Single Sign-On](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-flatter-files-tutorial/tutorial_flatter_files_02.png) 
...
### <a name="create-a-flatter-files-test-user"></a>Create a Flatter Files test user
