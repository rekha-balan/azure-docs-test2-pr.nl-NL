...
---
# <a name="tutorial-azure-active-directory-integration-with-procore-sso"></a>Tutorial: Azure Active Directory integration with Procore SSO
...
## <a name="adding-procore-sso-from-the-gallery"></a>Adding Procore SSO from the gallery
...
### <a name="creating-a-procore-sso-test-user"></a>Creating a Procore SSO test user
