...
---
# <a name="view-your-access-and-usage-reports"></a>View your access and usage reports
...
## <a name="report-editions"></a>Report editions
...
## <a name="anomalous-activity-reports"></a>Anomalous activity reports
...
### <a name="audit-report"></a>Audit report
...
### <a name="password-reset-activity"></a>Password reset activity
| Description | Report location |
|:--- |:--- |
...
### <a name="password-reset-registration-activity"></a>Password reset registration activity
| Description | Report location |
|:--- |:--- |
...
### <a name="self-service-groups-activity"></a>Self service groups activity
| Description | Report location |
|:--- |:--- |
...
## <a name="integrated-applications-reports"></a>Integrated applications reports
### <a name="application-usage-summary"></a>Application usage: summary
| Description | Report location |
|:--- |:--- |
...
### <a name="application-usage-detailed"></a>Application usage: detailed
| Description | Report location |
|:--- |:--- |
...
## <a name="error-reports"></a>Error reports
### <a name="account-provisioning-errors"></a>Account provisioning errors
| Description | Report location |
|:--- |:--- |
...
## <a name="user-specific-reports"></a>User-specific reports
...
#### <a name="sign-in-events-included-in-the-user-activity-report"></a>Sign in events included in the User Activity report
...
## <a name="things-to-consider-if-you-suspect-security-breach"></a>Things to consider if you suspect security breach
...
## <a name="view-or-download-a-report"></a>View or download a report
...
## <a name="ignore-an-event"></a>Ignore an event
...
## <a name="automatic-email-notifications"></a>Automatic email notifications
