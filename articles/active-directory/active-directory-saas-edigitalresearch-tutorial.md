...
---
# <a name="tutorial-azure-active-directory-integration-with-edigitalresearch"></a>Tutorial: Azure Active Directory integration with eDigitalResearch
...
## <a name="adding-edigitalresearch-from-the-gallery"></a>Adding eDigitalResearch from the gallery
...
3. On the **Configure App Settings** dialog page, perform the following steps and click **Next**:
  ...
  1. In the **Reply URL** textbox, type a URL using the following pattern: `https://<company name>.edigitalresearch.com/login/consume` 
  2. Click **Next**.
...
### <a name="create-a-edigitalresearch-test-user"></a>Create a eDigitalResearch test user
