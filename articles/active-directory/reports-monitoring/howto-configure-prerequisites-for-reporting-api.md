...
---
# <a name="prerequisites-to-access-the-azure-active-directory-reporting-api"></a>Prerequisites to access the Azure Active Directory reporting API
...
## <a name="assign-roles"></a>Assign roles
...
## <a name="gather-configuration-settings"></a>Gather configuration settings 
...
### <a name="get-your-applications-client-id"></a>Get your application's client ID
...
### <a name="get-your-applications-client-secret"></a>Get your application's client secret
