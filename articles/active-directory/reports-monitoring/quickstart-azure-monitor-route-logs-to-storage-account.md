...
---
# <a name="tutorial-archive-azure-ad-logs-to-an-azure-storage-account-preview"></a>Tutorial: Archive Azure AD logs to an Azure storage account (preview)
...
## <a name="archive-logs-to-an-azure-storage-account"></a>Archive logs to an Azure storage account
