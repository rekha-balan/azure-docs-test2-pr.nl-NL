...
---
# <a name="interpret-the-azure-ad-audit-logs-schema-in-azure-monitor-preview"></a>Interpret the Azure AD audit logs schema in Azure Monitor (preview)
...
## <a name="field-and-property-descriptions"></a>Field and property descriptions
