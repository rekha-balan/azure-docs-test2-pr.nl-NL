...
---
# <a name="how-to-use-the-azure-active-directory-power-bi-content-pack"></a>How to use the Azure Active Directory Power BI Content Pack
...
## <a name="what-can-i-do-with-this-content-pack"></a>What can I do with this content pack?
...
### <a name="reports-included-in-this-version-of-azure-active-directory-logs-content-pack"></a>Reports included in this version of Azure Active Directory logs Content Pack
...
## <a name="customizing-azure-ad-activity-content-pack"></a>Customizing Azure AD Activity content pack
...
## <a name="scheduling-a-daily-refresh-of-your-power-bi-report"></a>Scheduling a daily refresh of your Power BI report
...
## <a name="updating-to-newer-version-of-content-pack"></a>Updating to newer version of content pack
...
## <a name="still-having-issues"></a>Still having issues? 
