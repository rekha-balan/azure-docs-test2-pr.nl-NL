...
---
# <a name="sign-in-activity-report-error-codes-in-the-azure-active-directory-portal"></a>Sign-in activity report error codes in the Azure Active Directory portal
...
## <a name="how-can-i-display-failed-sign-ins"></a>How can I display failed sign-ins? 
...
Clicking an item in the displayed list, opens the **Activity Details: Sign-ins** blade. This view provides you with all the details that Azure Active Directory tracks about sign-ins, including the **sign-in error code** and a **failure reason**.
