...
---
# <a name="azure-ad-activity-logs-in-azure-monitor-preview"></a>Azure AD activity logs in Azure Monitor (preview)
...
## <a name="supported-reports"></a>Supported reports
...
### <a name="storage-size-for-activity-logs"></a>Storage size for activity logs
...
### <a name="event-hub-messages-for-activity-logs"></a>Event hub messages for activity logs
