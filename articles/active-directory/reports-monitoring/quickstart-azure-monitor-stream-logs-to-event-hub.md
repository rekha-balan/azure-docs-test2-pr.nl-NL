...
---
# <a name="tutorial-stream-azure-ad-logs-to-an-azure-event-hub-preview"></a>Tutorial: Stream Azure AD logs to an Azure event hub (preview)
...
## <a name="archive-logs-to-an-event-hub"></a>Archive logs to an event hub
...
## <a name="access-data-from-your-event-hub"></a>Access data from your event hub
