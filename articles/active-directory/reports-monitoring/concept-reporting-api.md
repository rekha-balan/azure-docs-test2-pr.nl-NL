...
---
# <a name="get-started-with-the-azure-active-directory-reporting-api"></a>Get started with the Azure Active Directory reporting API
...
## <a name="apis-with-graph-explorer"></a>APIs with Graph Explorer
...
## <a name="use-certificates-to-access-the-azure-ad-reporting-api"></a>Use certificates to access the Azure AD reporting API 
