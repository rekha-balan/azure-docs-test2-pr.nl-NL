...
---
# <a name="how-to-start-an-access-review-in-azure-ad-privileged-identity-management"></a>How to start an access review in Azure AD Privileged Identity Management
...
## <a name="start-an-access-review"></a>Start an access review
> [!NOTE]
...
## <a name="pim-table-of-contents"></a>PIM Table of Contents
