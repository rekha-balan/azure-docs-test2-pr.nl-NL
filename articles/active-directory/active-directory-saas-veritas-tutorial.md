...
---
# <a name="tutorial-azure-active-directory-integration-with-veritas-enterprise-vaultcloud-sso"></a>Tutorial: Azure Active Directory integration with Veritas Enterprise Vault.cloud SSO
...
## <a name="adding-veritas-enterprise-vaultcloud-sso-from-the-gallery"></a>Adding Veritas Enterprise Vault.cloud SSO from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-veritas-enterprise-vault-cloud-sso-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps: ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-veritas-enterprise-vault-cloud-sso-tutorial/create_aaduser_06.png) 
...
### <a name="creating-a-veritas-enterprise-vaultcloud-sso-test-user"></a>Creating a Veritas Enterprise Vault.cloud SSO test user
