...
---
# <a name="tutorial-configuring-slack-for-automatic-user-provisioning"></a>Tutorial: Configuring Slack for Automatic User Provisioning
...
## <a name="assigning-users-to-slack"></a>Assigning users to Slack
...
### <a name="important-tips-for-assigning-users-to-slack"></a>Important tips for assigning users to Slack
...
## <a name="configuring-user-provisioning-to-slack"></a>Configuring user provisioning to Slack 
...
### <a name="to-configure-automatic-user-account-provisioning-to-slack-in-azure-ad"></a>To configure automatic user account provisioning to Slack in Azure AD:
...
## <a name="optional-configuring-group-object-provisioning-to-slack"></a>[Optional] Configuring group object provisioning to Slack 
...
### <a name="to-enable-provisioning-of-group-objects"></a>To enable provisioning of group objects:
