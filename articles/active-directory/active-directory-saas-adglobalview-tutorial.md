...
## <a name="add-adp-globalview-from-the-gallery"></a>Add ADP GlobalView from the gallery
...
### <a name="create-a-adp-globalview-test-user"></a>Create a ADP GlobalView test user
