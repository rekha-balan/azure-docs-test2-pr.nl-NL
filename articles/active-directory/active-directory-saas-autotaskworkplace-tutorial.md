...
---
# <a name="tutorial-azure-active-directory-integration-with-autotask"></a>Tutorial: Azure Active Directory integration with Autotask
...
## <a name="adding-autotask-from-the-gallery"></a>Adding Autotask from the gallery
...
### <a name="creating-an-autotask-test-user"></a>Creating an Autotask test user
