...
---
# <a name="tutorial-use-a-linux-vm-system-assigned-managed-identity-to-access-azure-data-lake-store"></a>Tutorial: Use a Linux VM system-assigned managed identity to access Azure Data Lake Store
...
## <a name="get-an-access-token-and-call-the-data-lake-store-file-system"></a>Get an access token and call the Data Lake Store file system
