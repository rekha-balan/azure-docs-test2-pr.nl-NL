...
---
# <a name="faqs-and-known-issues-with-managed-identities-for-azure-resources"></a>FAQs and known issues with managed identities for Azure resources
...
### <a name="does-managed-identities-for-azure-resources-work-with-azure-cloud-services"></a>Does managed identities for Azure resources work with Azure Cloud Services?

No, there are no plans to support managed identities for Azure resources in Azure Cloud Services.

### <a name="does-managed-identities-for-azure-resources-work-with-the-active-directory-authentication-library-adal-or-the-microsoft-authentication-library-msal"></a>Does managed identities for Azure resources work with the Active Directory Authentication Library (ADAL) or the Microsoft Authentication Library (MSAL)?
...
### <a name="what-is-the-security-boundary-of-managed-identities-for-azure-resources"></a>What is the security boundary of managed identities for Azure resources?
...
### <a name="should-i-use-the-managed-identities-for-azure-resources-vm-imds-endpoint-or-the-vm-extension-endpoint"></a>Should I use the managed identities for Azure resources VM IMDS endpoint or the VM extension endpoint?
...
### <a name="what-are-the-supported-linux-distributions"></a>What are the supported Linux distributions?
...
### <a name="how-do-you-restart-the-managed-identities-for-azure-resources-extension"></a>How do you restart the managed identities for Azure resources extension?
...
### <a name="automation-script-fails-when-attempting-schema-export-for-managed-identities-for-azure-resources-extension"></a>"Automation script" fails when attempting schema export for managed identities for Azure resources extension
...
### <a name="configuration-blade-does-not-appear-in-the-azure-portal"></a>Configuration blade does not appear in the Azure portal
...
### <a name="cannot-assign-access-to-virtual-machines-in-the-access-control-iam-blade"></a>Cannot assign access to virtual machines in the Access Control (IAM) blade
...
### <a name="vm-fails-to-start-after-being-moved-from-resource-group-or-subscription"></a>VM fails to start after being moved from resource group or subscription
...
## <a name="known-issues-with-user-assigned-identities"></a>Known issues with user-assigned Identities
