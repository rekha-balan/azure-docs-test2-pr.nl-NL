...
---
# <a name="tutorial-use-a-windows-vm-system-assigned-managed-identity-to-access-azure-storage"></a>Tutorial: Use a Windows VM system-assigned managed identity to access Azure Storage
...
## <a name="create-a-blob-container-and-upload-a-file-to-the-storage-account"></a>Create a blob container and upload a file to the storage account
...
## <a name="grant-your-vm-access-to-an-azure-storage-container"></a>Grant your VM access to an Azure Storage container 
...
## <a name="get-an-access-token-and-use-it-to-call-azure-storage"></a>Get an access token and use it to call Azure Storage 
