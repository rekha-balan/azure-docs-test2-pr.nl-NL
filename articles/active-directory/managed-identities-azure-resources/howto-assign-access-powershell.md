...
---
# <a name="assign-a-managed-service-identity-msi-access-to-a-resource-using-powershell"></a>Assign a Managed Service Identity (MSI) access to a resource using PowerShell
