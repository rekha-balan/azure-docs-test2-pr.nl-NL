...
---
# <a name="tutorial-use-a-windows-vm-system-assigned-managed-identity-to-access-azure-cosmos-db"></a>Tutorial: Use a Windows VM system-assigned managed identity to access Azure Cosmos DB
...
## <a name="grant-windows-vm-system-assigned-managed-identity-access-to-the-cosmos-db-account-access-keys"></a>Grant Windows VM system-assigned managed identity access to the Cosmos DB account access keys
...
## <a name="get-an-access-token-using-the-windows-vm-system-assigned-managed-identity-to-call-azure-resource-manager"></a>Get an access token using the Windows VM system-assigned managed identity to call Azure Resource Manager
