...
---
# <a name="configure-managed-identities-for-azure-resources-on-an-azure-vm-using-azure-cli"></a>Configure managed identities for Azure resources on an Azure VM using Azure CLI
...
### <a name="disable-system-assigned-identity-from-an-azure-vm"></a>Disable system-assigned identity from an Azure VM
