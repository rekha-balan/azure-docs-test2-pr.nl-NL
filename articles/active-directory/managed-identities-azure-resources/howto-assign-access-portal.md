...
---
# <a name="assign-a-managed-service-identity-access-to-a-resource-by-using-the-azure-portal"></a>Assign a Managed Service Identity access to a resource by using the Azure portal
