...
---
# <a name="configure-managed-identities-for-azure-resources-on-a-virtual-machine-scale-set-using-the-azure-portal"></a>Configure managed identities for Azure resources on a virtual machine scale set using the Azure portal
...
### <a name="enable-system-assigned-managed-identity-on-an-existing-virtual-machine-scale-set"></a>Enable system-assigned managed identity on an existing virtual machine scale set
...
### <a name="remove-system-assigned-managed-identity-from-a-virtual-machine-scale-set"></a>Remove system-assigned managed identity from a virtual machine scale set
