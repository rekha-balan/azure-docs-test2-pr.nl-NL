...
---
# <a name="tutorial-use-a-linux-vm-system-assigned-managed-identity-to-access-azure-key-vault"></a>Tutorial: Use a Linux VM system-assigned managed identity to access Azure Key Vault 
...
## <a name="get-an-access-token-using-the-vms-identity-and-use-it-to-retrieve-the-secret-from-the-key-vault"></a>Get an access token using the VM's identity and use it to retrieve the secret from the Key Vault  
