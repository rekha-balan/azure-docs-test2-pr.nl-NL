...
## <a name="create-a-user-assigned-identity"></a>Create a user-assigned identity
...
## <a name="assign-the-user-assigned-identity-to-a-windows-vm"></a>Assign the user-assigned identity to a Windows VM
...
## <a name="grant-your-user-assigned-identity-access-to-a-resource-group-in-azure-resource-manager"></a>Grant your user-assigned identity access to a Resource Group in Azure Resource Manager 
...
## <a name="read-the-properties-of-a-resource-group"></a>Read the properties of a Resource Group
