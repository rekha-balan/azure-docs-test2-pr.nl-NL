...
---
# <a name="tutorial-use-a-linux-vm-system-assigned-identity-to-access-azure-storage-via-a-sas-credential"></a>Tutorial: Use a Linux VM system-assigned identity to access Azure Storage via a SAS credential
...
## <a name="grant-your-vms-system-assigned-managed-identity-access-to-use-a-storage-sas"></a>Grant your VM's system-assigned managed identity access to use a storage SAS 
...
## <a name="get-an-access-token-using-the-vms-identity-and-use-it-to-call-azure-resource-manager"></a>Get an access token using the VM's identity and use it to call Azure Resource Manager
...
## <a name="get-a-sas-credential-from-azure-resource-manager-to-make-storage-calls"></a>Get a SAS credential from Azure Resource Manager to make storage calls
