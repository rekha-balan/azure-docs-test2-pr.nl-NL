...
---
# <a name="what-is-managed-identities-for-azure-resources"></a>What is managed identities for Azure resources?
...
### <a name="how-a-system-assigned-managed-identity-works-with-an-azure-vm"></a>How a system-assigned managed identity works with an Azure VM
...
### <a name="how-a-user-assigned-managed-identity-works-with-an-azure-vm"></a>How a user-assigned managed identity works with an Azure VM
...
## <a name="how-can-i-use-managed-identities-for-azure-resources"></a>How can I use managed identities for Azure resources?
