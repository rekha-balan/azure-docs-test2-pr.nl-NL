...
---
# <a name="how-to-use-managed-identities-for-azure-resources-on-an-azure-vm-for-sign-in"></a>How to use managed identities for Azure resources on an Azure VM for sign in 
...
## <a name="error-handling-guidance"></a>Error handling guidance 
