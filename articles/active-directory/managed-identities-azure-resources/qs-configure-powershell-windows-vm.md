...
---
# <a name="configure-managed-identities-for-azure-resources-on-an-azure-vm-using-powershell"></a>Configure managed identities for Azure resources on an Azure VM using PowerShell
...
### <a name="enable-system-assigned-managed-identity-on-an-existing-azure-vm"></a>Enable system-assigned managed identity on an existing Azure VM
...
### <a name="assign-a-user-assigned-managed-identity-to-a-vm-during-creation"></a>Assign a user-assigned managed identity to a VM during creation
