...
---
# <a name="tutorial-use-a-linux-vm-system-assigned-managed-identity-to-access-azure-storage-via-access-key"></a>Tutorial: Use a Linux VM system-assigned managed identity to access Azure Storage via access key
