...
---
# <a name="tutorial-use-a-windows-vm-system-assigned-managed-identity-to-access-azure-sql"></a>Tutorial: Use a Windows VM system-assigned managed identity to access Azure SQL
...
## <a name="grant-your-vm-access-to-a-database-in-an-azure-sql-server"></a>Grant your VM access to a database in an Azure SQL server
...
## <a name="create-a-group-in-azure-ad-and-make-the-vms-system-assigned-managed-identity-a-member-of-the-group"></a>Create a group in Azure AD and make the VM's system-assigned managed identity a member of the group
...
## <a name="enable-azure-ad-authentication-for-the-sql-server"></a>Enable Azure AD authentication for the SQL server
...
## <a name="get-an-access-token-using-the-vms-system-assigned-managed-identity-and-use-it-to-call-azure-sql"></a>Get an access token using the VM's system-assigned managed identity and use it to call Azure SQL 
