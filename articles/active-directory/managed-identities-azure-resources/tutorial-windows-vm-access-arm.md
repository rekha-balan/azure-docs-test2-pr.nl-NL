...
---
# <a name="use-a-windows-vm-system-assigned-managed-identity-to-access-resource-manager"></a>Use a Windows VM system-assigned managed identity to access Resource Manager
...
## <a name="grant-your-vm-access-to-a-resource-group-in-resource-manager"></a>Grant your VM access to a resource group in Resource Manager
...
## <a name="get-an-access-token-using-the-vms-system-assigned-managed-identity-and-use-it-to-call-azure-resource-manager"></a>Get an access token using the VM's system-assigned managed identity and use it to call Azure Resource Manager 
