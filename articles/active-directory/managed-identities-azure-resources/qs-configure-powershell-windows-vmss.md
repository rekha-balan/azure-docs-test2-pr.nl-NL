...
---
# <a name="configure-managed-identities-for-azure-resources-on-virtual-machine-scale-sets-using-powershell"></a>Configure managed identities for Azure resources on virtual machine scale sets using PowerShell
...
### <a name="enable-system-assigned-managed-identity-during-the-creation-of-an-azure-virtual-machine-scale-set"></a>Enable system-assigned managed identity during the creation of an Azure virtual machine scale set
...
### <a name="disable-the-system-assigned-managed-identity-from-an-azure-virtual-machine-scale-set"></a>Disable the system-assigned managed identity from an Azure virtual machine scale set
...
### <a name="assign-a-user-assigned-managed-identity-during-creation-of-an-azure-virtual-machine-scale-set"></a>Assign a user-assigned managed identity during creation of an Azure virtual machine scale set
