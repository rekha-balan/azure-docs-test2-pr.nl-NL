...
---
# <a name="tutorial-use-a-user-assigned-managed-identity-on-a-linux-vm-to-access-azure-resource-manager"></a>Tutorial: Use a user-assigned managed identity on a Linux VM to access Azure Resource Manager
...
## <a name="assign-a-user-assigned-managed-identity-to-your-linux-vm"></a>Assign a user-assigned managed identity to your Linux VM
...
## <a name="grant-your-user-assigned-managed-identity-access-to-a-resource-group-in-azure-resource-manager"></a>Grant your user-assigned managed identity access to a Resource Group in Azure Resource Manager 
...
## <a name="get-an-access-token-using-the-vms-identity-and-use-it-to-call-resource-manager"></a>Get an access token using the VM's identity and use it to call Resource Manager 
