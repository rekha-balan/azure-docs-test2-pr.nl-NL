...
---
# <a name="tutorial-use-a-linux-vm-system-assigned-managed-identity-to-access-azure-cosmos-db"></a>Tutorial: Use a Linux VM system-assigned managed identity to access Azure Cosmos DB 
...
## <a name="create-a-collection-in-the-cosmos-db-account"></a>Create a collection in the Cosmos DB account
...
## <a name="retrieve-the-principalid-of-the-linux-vms-system-assigned-managed-identity"></a>Retrieve the `principalID` of the Linux VM's system-assigned managed identity
...
```
## <a name="grant-your-linux-vms-system-assigned-identity-access-to-the-cosmos-db-account-access-keys"></a>Grant your Linux VM's system-assigned identity access to the Cosmos DB account access keys
...
## <a name="get-an-access-token-using-the-linux-vms-system-assigned-managed-identity-and-use-it-to-call-azure-resource-manager"></a>Get an access token using the Linux VM's system-assigned managed identity and use it to call Azure Resource Manager
...
## <a name="get-access-keys-from-azure-resource-manager-to-make-cosmos-db-calls"></a>Get access keys from Azure Resource Manager to make Cosmos DB calls  
