...
---
# <a name="how-do-information-workers-add-b2b-collaboration-users-to-azure-active-directory"></a>How do information workers add B2B collaboration users to Azure Active Directory?
...
## <a name="information-workers-adding-b2b-collaboration-users-to-an-application"></a>Information workers adding B2B collaboration users to an application
...
## <a name="information-workers-adding-b2b-collaboration-users-to-a-group"></a>Information workers adding B2B collaboration users to a group
