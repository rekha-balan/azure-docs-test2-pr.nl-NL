...
## <a name="azure-ad-and-microsoft-account-users"></a>Azure AD and Microsoft account users
For users with existing Azure AD account or Microsoft accounts, the redemption experience is as easy as signing in.

## <a name="social-id-user-first-time-redemption"></a>Social ID user first time redemption
