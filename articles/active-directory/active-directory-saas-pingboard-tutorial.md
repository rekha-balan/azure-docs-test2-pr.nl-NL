...
---
# <a name="tutorial-azure-active-directory-integration-with-pingboard"></a>Tutorial: Azure Active Directory integration with Pingboard
...
## <a name="adding-pingboard-from-the-gallery"></a>Adding Pingboard from the gallery
...
### <a name="creating-a-pingboard-test-user"></a>Creating a Pingboard test user
