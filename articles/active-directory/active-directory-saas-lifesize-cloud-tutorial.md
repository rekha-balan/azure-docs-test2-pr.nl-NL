...
## <a name="add-lifesize-cloud-from-the-gallery"></a>Add Lifesize Cloud from the gallery
...
### <a name="create-an-lifesize-cloud-test-user"></a>Create an Lifesize Cloud test user
