...
---
# <a name="create-attribute-based-rules-for-dynamic-group-membership-in-azure-active-directory-preview"></a>Create attribute-based rules for dynamic group membership in Azure Active Directory preview
