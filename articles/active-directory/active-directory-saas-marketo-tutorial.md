...
---
# <a name="tutorial-azure-active-directory-integration-with-marketo"></a>Tutorial: Azure Active Directory integration with Marketo
...
## <a name="adding-marketo-from-the-gallery"></a>Adding Marketo from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-marketo-tutorial/create_aaduser_05.png) 
    ...
    c. Click **Next**.
6. On the **User Profile** dialog page, perform the following steps:  ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-marketo-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-marketo-test-user"></a>Creating an Marketo test user
