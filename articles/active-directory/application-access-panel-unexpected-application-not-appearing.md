...
---
# <a name="an-assigned-application-is-not-appearing-on-the-access-panel"></a>An assigned application is not appearing on the access panel
...
## <a name="problems-related-to-application-configuration"></a>Problems related to application configuration
...
### <a name="how-to-configure-federated-single-sign-on-for-a-non-gallery-application"></a>How to configure federated single sign-on for a non-gallery application
...
#### <a name="configure-the-applications-metadata-values-in-azure-ad-sign-on-url-identifier-reply-url"></a>Configure the application’s metadata values in Azure AD (Sign on URL, Identifier, Reply URL)
...
### <a name="how-to-assign-a-user-a-license"></a>How to assign a user a license 
...
### <a name="how-to-assign-an-application-to-a-group-directly"></a>How to assign an application to a group directly
...
### <a name="check-if-a-user-is-part-of-group-assigned-to-a-license"></a>Check if a user is part of group assigned to a license
...
### <a name="how-to-assign-a-license-to-a-group"></a>How to assign a license to a group
