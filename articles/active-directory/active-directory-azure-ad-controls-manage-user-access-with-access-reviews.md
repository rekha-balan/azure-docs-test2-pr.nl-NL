...
---
# <a name="manage-user-access-with-azure-ad-access-reviews"></a>Manage user access with Azure AD access reviews
...
## <a name="create-and-perform-an-access-review"></a>Create and perform an access review
