...
---
# <a name="tutorial-azure-active-directory-integration-with-bambu-by-sprout-social"></a>Tutorial: Azure Active Directory integration with Bambu by Sprout Social
...
## <a name="adding-bambu-by-sprout-social-from-the-gallery"></a>Adding Bambu by Sprout Social from the gallery
...
### <a name="creating-a-bambu-by-sprout-social-test-user"></a>Creating a Bambu by Sprout Social test user
