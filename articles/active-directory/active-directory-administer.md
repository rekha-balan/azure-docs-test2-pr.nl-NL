...
---
# <a name="administer-your-azure-ad-directory"></a>Administer your Azure AD directory
...
### <a name="associate-an-azure-ad-directory-with-a-new-azure-subscription"></a>Associate an Azure AD directory with a new Azure subscription
...
### <a name="manage-an-azure-provisioned-default-directory"></a>Manage an Azure-provisioned Default directory
...
## <a name="how-can-i-delete-an-azure-ad-directory"></a>How can I delete an Azure AD directory?
...
### <a name="conditions-that-must-be-met-to-delete-an-azure-ad-directory"></a>Conditions that must be met to delete an Azure AD directory
