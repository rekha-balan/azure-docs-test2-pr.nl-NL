...
---
# <a name="activate-my-azure-ad-directory-roles-in-pim"></a>Activate my Azure AD directory roles in PIM
...
## <a name="activate-a-role"></a>Activate a role
...
## <a name="view-the-status-of-your-requests"></a>View the status of your requests
...
## <a name="use-a-role-immediately-after-activation"></a>Use a role immediately after activation
...
## <a name="deactivate-a-role"></a>Deactivate a role
...
## <a name="cancel-a-pending-request"></a>Cancel a pending request
