...
---
# <a name="assign-azure-resource-roles-in-pim"></a>Assign Azure resource roles in PIM
...
## <a name="update-or-remove-an-existing-role-assignment"></a>Update or remove an existing role assignment
