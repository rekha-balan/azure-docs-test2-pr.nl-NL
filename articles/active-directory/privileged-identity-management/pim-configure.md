...
---
# <a name="what-is-azure-ad-privileged-identity-management"></a>What is Azure AD Privileged Identity Management?
...
*Eligible role user* – An eligible role user is a user within your organization that’s been assigned to an Azure AD role as eligible (role requires activation).

*Delegated approver* – A delegated approver is one or multiple individuals or groups within your Azure AD responsible for approving requests to activate roles.
...
## <a name="privileged-identity-management-overview-entry-point"></a>Privileged Identity Management Overview (Entry Point)
...
## <a name="azure-ad-pim-at-subscription-expiration"></a>Azure AD PIM at subscription expiration
