...
---
# <a name="tutorial-azure-active-directory-integration-with-inkling"></a>Tutorial: Azure Active Directory integration with Inkling
...
## <a name="adding-inkling-from-the-gallery"></a>Adding Inkling from the gallery
...
### <a name="creating-an-inkling-test-user"></a>Creating an Inkling test user
