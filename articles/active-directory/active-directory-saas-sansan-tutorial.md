...
## <a name="add-sansan-from-the-gallery"></a>Add SanSan from the gallery
...
## <a name="configure-and-test-microsoft-azure-ad-single-sign-on"></a>Configure and test Microsoft Azure AD Single Sign-On
...
### <a name="create-an-sansan-test-user"></a>Create an SanSan test user
