...
---
# <a name="get-help-with-two-step-verification"></a>Get help with two-step verification
...
## <a name="why-do-i-need-to-use-another-verification-method"></a>Why do I need to use another verification method?
...
## <a name="sign-in-using-another-verification-method"></a>Sign in using another verification method
