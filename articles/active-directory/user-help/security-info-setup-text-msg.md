...
---
# <a name="set-up-security-info-to-use-text-messaging-preview"></a>Set up security info to use text messaging (preview)
...
## <a name="set-up-text-messaging"></a>Set up text messaging
...
### <a name="to-use-a-text-message"></a>To use a text message
