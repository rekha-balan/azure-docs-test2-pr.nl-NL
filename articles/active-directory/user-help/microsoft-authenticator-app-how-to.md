...
## <a name="opt-in-for-two-step-verification"></a>Opt in for two-step verification
...
### <a name="add-a-personal-microsoft-account"></a>Add a personal Microsoft account
...
### <a name="add-a-work-or-school-account"></a>Add a work or school account
...
### <a name="using-your-devices-fingerprint-or-facial-recognition-capabilities"></a>Using your device's fingerprint or facial recognition capabilities
...
## <a name="use-the-app-when-you-sign-in"></a>Use the app when you sign in
