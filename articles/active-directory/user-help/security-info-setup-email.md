...
---
# <a name="set-up-security-info-to-use-email-preview"></a>Set up security info to use email (preview)
...
### <a name="to-use-your-email-address"></a>To use your email address
