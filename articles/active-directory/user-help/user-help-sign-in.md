...
---
# <a name="sign-in-using-two-step-verification-or-security-info"></a>Sign in using two-step verification or security info
...
## <a name="sign-in-using-an-authenticator-app-notification-on-your-mobile-device"></a>Sign in using an authenticator app notification on your mobile device
...
## <a name="sign-in-using-an-authenticator-app-code-on-your-mobile-device"></a>Sign in using an authenticator app code on your mobile device
...
## <a name="sign-in-using-your-phone-number"></a>Sign in using your phone number
...
## <a name="sign-in-using-a-text-message"></a>Sign in using a text message
