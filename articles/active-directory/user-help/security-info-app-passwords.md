...
---
# <a name="manage-app-passwords-using-security-info-preview"></a>Manage app passwords using security info (preview)
...
## <a name="create-and-delete-app-passwords-using-security-info"></a>Create and delete app passwords using security info
...
### <a name="to-create-app-passwords-using-the-my-apps-portal"></a>To create app passwords using the My Apps portal
...
### <a name="to-delete-app-passwords-using-the-my-apps-portal"></a>To delete app passwords using the My Apps portal
