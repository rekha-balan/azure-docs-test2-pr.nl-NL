...
---
# <a name="set-up-security-info-to-use-an-authenticator-app-preview"></a>Set up security info to use an authenticator app (preview)
...
## <a name="set-up-the-microsoft-authenticator-app"></a>Set up the Microsoft Authenticator app
...
### <a name="to-use-the-microsoft-authenticator-app"></a>To use the Microsoft Authenticator app
