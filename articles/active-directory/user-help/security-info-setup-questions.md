...
---
# <a name="set-up-security-info-to-use-pre-defined-security-questions-preview"></a>Set up security info to use pre-defined security questions (preview)
...
## <a name="set-up-security-questions"></a>Set up security questions
...
### <a name="to-choose-and-answer-your-security-questions"></a>To choose and answer your security questions
...
## <a name="additional-security-info-options"></a>Additional security info options
