...
---
# <a name="troubleshoot-issues-with-accessing-and-using-the-myapps-portal"></a>Troubleshoot issues with accessing and using the MyApps portal
...
## <a name="i-am-having-trouble-signing-into-the-myapps-portal"></a>I am having trouble signing into the MyApps portal
...
## <a name="i-seem-to-be-having-password-issues"></a>I seem to be having password issues
...
## <a name="i-need-to-register-for-password-reset"></a>I need to register for password reset
...
## <a name="i-am-having-trouble-installing-the-my-apps-secure-sign-in-extension"></a>I am having trouble installing the My Apps Secure Sign-in Extension
...
## <a name="how-do-i-add-a-new-app"></a>How do I add a new app?
...
## <a name="how-do-i-manage-my-group-memberships"></a>How do I manage my group memberships?
