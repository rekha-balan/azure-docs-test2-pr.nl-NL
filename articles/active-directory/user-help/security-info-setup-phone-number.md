...
---
# <a name="set-up-security-info-to-use-phone-calls-preview"></a>Set up security info to use phone calls (preview)
...
## <a name="set-up-phone-calls"></a>Set up phone calls
...
### <a name="to-use-your-phone-number"></a>To use your phone number
