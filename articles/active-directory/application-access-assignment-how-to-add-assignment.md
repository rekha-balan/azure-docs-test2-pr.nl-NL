...
---
# <a name="how-to-assign-users-and-groups-to-an-application"></a>How to assign users and groups to an application
...
## <a name="methods-to-assign-applications-with-azure-active-directory"></a>Methods to assign applications with Azure Active Directory 
...
## <a name="assign-a-user-directly-as-an-administrator"></a>Assign a user directly as an administrator
...
## <a name="assign-a-group-directly-to-an-application-as-an-administrator"></a>Assign a group directly to an application as an administrator
...
## <a name="enable-self-service-application-access-to-allow-users-to-find-their-own-applications"></a>Enable self-service application access to allow users to find their own applications
