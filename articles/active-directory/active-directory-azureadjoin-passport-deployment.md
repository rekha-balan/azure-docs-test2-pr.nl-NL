...
---
# <a name="enable-microsoft-windows-hello-for-business-in-your-organization"></a>Enable Microsoft Windows Hello for Business in your organization
...
## <a name="deploy-system-center-configuration-manager"></a>Deploy System Center Configuration Manager
...
## <a name="configure-policy-settings"></a>Configure policy settings
...
Using System Center Configuration Manager is the preferred method when you also use it to deploy certificates. This scenario:

* Ensures compatibility with the newer deployment scenarios
* Requires on the client side Windows 10 Version 1607 or better.

### <a name="configure-microsoft-windows-hello-for-business-via-group-policy-in-active-directory"></a>Configure Microsoft Windows Hello for Business via group policy in Active Directory
**Steps**:
...
### <a name="configure-windows-hello-for-business-using-system-center-configuration-manager"></a>Configure Windows Hello for Business using System Center Configuration Manager
**Steps**:
...
## <a name="configure-the-certificate-profile"></a>Configure the certificate profile
