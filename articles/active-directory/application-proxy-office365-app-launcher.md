...
---
# <a name="set-a-custom-home-page-for-published-apps-by-using-azure-ad-application-proxy"></a>Set a custom home page for published apps by using Azure AD Application Proxy
...
## <a name="determine-the-home-page-url"></a>Determine the home-page URL
...
## <a name="set-a-custom-home-page-url-by-using-the-azure-ad-powershell-module"></a>Set a custom home-page URL by using the Azure AD PowerShell module
...
### <a name="step-1-find-the-objectid-of-the-app"></a>Step 1: Find the ObjectID of the app
...
### <a name="step-2-update-the-home-page-url"></a>Step 2: Update the home-page URL
