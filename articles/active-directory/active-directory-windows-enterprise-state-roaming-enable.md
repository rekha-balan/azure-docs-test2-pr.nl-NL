...
## <a name="view-per-user-device-sync-status"></a>View per-user device sync status
...
### <a name="explicit-deletion"></a>Explicit deletion
...
### <a name="stale-data-deletion"></a>Stale data deletion
...
### <a name="deleted-data-recovery"></a>Deleted data recovery
