...
### <a name="diagnose-and-remediate-sync-errors"></a>Diagnose and remediate sync errors 
For specific duplicated attribute sync error scenario involving user Source Anchor update, you can fix them directly from the portal. Read more about [Diagnose and remediate duplicated attribute sync errors](active-directory-aadconnect-health-diagnose-sync-errors.md)
