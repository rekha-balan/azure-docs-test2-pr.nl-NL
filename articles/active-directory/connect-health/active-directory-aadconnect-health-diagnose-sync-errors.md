...
---
# <a name="diagnose-and-remediate-duplicated-attribute-sync-errors"></a>Diagnose and remediate duplicated attribute sync errors
...
### <a name="a-common-scenario"></a>A common scenario
...
### <a name="orphaned-object-scenario"></a>Orphaned object scenario
...
## <a name="diagnostic-and-troubleshooting-steps-in-connect-health"></a>Diagnostic and troubleshooting steps in Connect Health 
...
## <a name="how-to-answer-the-diagnosis-questions"></a>How to answer the diagnosis questions 
### <a name="does-the-user-exist-in-your-on-premises-active-directory"></a>Does the user exist in your on-premises Active Directory?
...
### <a name="do-both-of-these-accounts-belong-to-the-same-user"></a>Do both of these accounts belong to the same user?
...
## <a name="what-happens-after-the-fix-is-applied-in-the-orphaned-object-scenario"></a>What happens after the fix is applied in the orphaned object scenario
...
## <a name="failures-and-error-messages"></a>Failures and error messages
