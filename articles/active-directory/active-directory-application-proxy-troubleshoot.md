...
---
# <a name="troubleshoot-application-proxy-problems-and-error-messages"></a>Troubleshoot Application Proxy problems and error messages
...
* Open the Windows Services console and verify that the **Microsoft AAD Application Proxy Connector** service is enabled and running. You may also want to look at the Application Proxy service properties page, as shown in the following image:  
  ![Microsoft AAD Application Proxy Connector Properties window screenshot](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-application-proxy-troubleshoot/connectorproperties.png)
...
## <a name="connector-errors"></a>Connector errors
...
## <a name="end-user-errors"></a>End user errors
...
## <a name="my-error-wasnt-listed-here"></a>My error wasn't listed here
