...
---
# <a name="scenarios-limitations-and-known-issues-using-groups-to-manage-licensing-in-azure-active-directory"></a>Scenarios, limitations, and known issues using groups to manage licensing in Azure Active Directory
...
## <a name="usage-location"></a>Usage location
...
## <a name="use-group-based-licensing-with-dynamic-groups"></a>Use group-based licensing with dynamic groups
...
#### <a name="enterprise-mobility--security-licensed-users"></a>Enterprise Mobility + Security: licensed users
...
## <a name="multiple-groups-and-multiple-licenses"></a>Multiple groups and multiple licenses
...
## <a name="direct-licenses-coexist-with-group-licenses"></a>Direct licenses coexist with group licenses
...
## <a name="managing-new-services-added-to-products"></a>Managing new services added to products
...
## <a name="use-powershell-to-see-who-has-inherited-and-direct-licenses"></a>Use PowerShell to see who has inherited and direct licenses
...
## <a name="use-audit-logs-to-monitor-group-based-licensing-activity"></a>Use Audit logs to monitor group-based licensing activity
...
### <a name="find-out-who-modified-a-group-license"></a>Find out who modified a group license
...
### <a name="find-out-when-group-changes-started-and-finished-processing"></a>Find out when group changes started and finished processing
...
## <a name="deleting-a-group-with-an-assigned-license"></a>Deleting a group with an assigned license
...
When trying to delete a group in the Azure portal you may see an error notification like this: ![Screenshot group deletion failed](./media/licensing-group-advanced/groupdeletionfailed.png)
