...
---
# <a name="change-static-group-membership-to-dynamic-in-azure-active-directory"></a>Change static group membership to dynamic in Azure Active Directory
...
## <a name="change-the-membership-type-for-a-group"></a>Change the membership type for a group
...
## <a name="change-membership-type-for-a-group-powershell"></a>Change membership type for a group (PowerShell)
