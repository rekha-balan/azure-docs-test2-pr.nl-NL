...
---
# <a name="enforce-a-naming-policy-for-office-365-groups-in-azure-active-directory-preview"></a>Enforce a naming policy for Office 365 groups in Azure Active Directory (preview)
...
## <a name="naming-policy-features"></a>Naming policy features
...
### <a name="prefix-suffix-naming-policy"></a>Prefix-suffix naming policy
...
#### <a name="fixed-strings"></a>Fixed strings
...
### <a name="custom-blocked-words"></a>Custom blocked words
...
### <a name="administrator-override"></a>Administrator override
...
## <a name="install-powershell-cmdlets-to-configure-a-naming-policy"></a>Install PowerShell cmdlets to configure a naming policy
...
## <a name="configure-the-group-naming-policy-for-a-tenant-using-azure-ad-powershell"></a>Configure the group naming policy for a tenant using Azure AD PowerShell
...
### <a name="view-the-current-settings"></a>View the current settings
...
### <a name="set-the-naming-policy-and-custom-blocked-words"></a>Set the naming policy and custom blocked words
...
## <a name="export-or-import-the-list-of-custom-blocked-words"></a>Export or import the list of custom blocked words
...
## <a name="naming-policy-experiences-across-office-365-apps"></a>Naming policy experiences across Office 365 apps
