...
---
# <a name="product-names-and-service-plan-identifiers-for-licensing"></a>Product names and service plan identifiers for licensing
...
## <a name="service-plans-that-cannot-be-assigned-at-the-same-time"></a>Service plans that cannot be assigned at the same time
