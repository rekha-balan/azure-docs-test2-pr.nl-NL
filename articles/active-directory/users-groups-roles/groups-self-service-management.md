...
---
# <a name="set-up-azure-active-directory-for-self-service-group-management"></a>Set up Azure Active Directory for self-service group management
...
## <a name="make-a-group-available-for-user-self-service"></a>Make a group available for user self-service
