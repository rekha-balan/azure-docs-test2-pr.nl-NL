...
---
# <a name="create-a-dynamic-group-and-check-status"></a>Create a dynamic group and check status
...
## <a name="to-create-a-group-membership-rule"></a>To create a group membership rule
...
## <a name="check-processing-status-for-a-membership-rule"></a>Check processing status for a membership rule
