...
---
# <a name="delete-an-azure-active-directory-tenant"></a>Delete an Azure Active Directory tenant
...
## <a name="prepare-the-tenant-for-deletion"></a>Prepare the tenant for deletion
...
## <a name="delete-an-azure-ad-tenant"></a>Delete an Azure AD tenant
...
## <a name="i-have-an-expired-subscription-but-i-cant-delete-the-tenant"></a>I have an expired subscription but I can't delete the tenant
