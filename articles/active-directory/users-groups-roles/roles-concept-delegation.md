...
---
# <a name="delegate-administration-in-azure-active-directory"></a>Delegate administration in Azure Active Directory
...
## <a name="centralized-versus-delegated-permissions"></a>Centralized versus delegated permissions
...
## <a name="delegation-planning"></a>Delegation planning
...
## <a name="define-roles"></a>Define roles
...
## <a name="delegate-app-administration"></a>Delegate app administration
...
## <a name="delegate-app-registration"></a>Delegate app registration
...
## <a name="delegate-app-ownership"></a>Delegate app ownership
...
## <a name="develop-a-security-plan"></a>Develop a security plan
...
## <a name="establish-emergency-accounts"></a>Establish emergency accounts
...
## <a name="secure-your-administrator-roles"></a>Secure your administrator roles
...
## <a name="elevate-privilege-temporarily"></a>Elevate privilege temporarily
