...
---
# <a name="quickstart-set-office-365-groups-to-expire-in-azure-active-directory"></a>Quickstart: Set Office 365 groups to expire in Azure Active Directory
...
## <a name="turn-on-user-creation-for-groups"></a>Turn on user creation for groups
