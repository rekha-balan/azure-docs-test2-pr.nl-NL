...
## <a name="how-to-find-license-assignment-errors"></a>How to find license assignment errors
...
## <a name="how-do-you-manage-licenses-for-products-with-prerequisites"></a>How do you manage licenses for products with prerequisites?
...
## <a name="license-assignment-fails-silently-for-a-user-due-to-duplicate-proxy-addresses-in-exchange-online"></a>License assignment fails silently for a user due to duplicate proxy addresses in Exchange Online
