...
---
# <a name="take-over-an-unmanaged-directory-as-administrator-in-azure-active-directory"></a>Take over an unmanaged directory as administrator in Azure Active Directory
...
## <a name="decide-how-you-want-to-take-over-an-unmanaged-directory"></a>Decide how you want to take over an unmanaged directory
...
## <a name="internal-admin-takeover"></a>Internal admin takeover
...
### <a name="adding-the-domain-name-to-a-managed-tenant-in-azure-ad"></a>Adding the domain name to a managed tenant in Azure AD 
...
## <a name="external-admin-takeover"></a>External admin takeover
...
### <a name="support-for-external-admin-takeover"></a>Support for external admin takeover
...
#### <a name="more-information-about-rms-for-individuals"></a>More information about RMS for individuals
...
### <a name="azure-ad-powershell-cmdlets-for-the-forcetakeover-option"></a>Azure AD PowerShell cmdlets for the ForceTakeover option
