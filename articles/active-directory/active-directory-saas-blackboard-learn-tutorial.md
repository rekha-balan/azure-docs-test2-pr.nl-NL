...
## <a name="add-blackboard-learn-from-the-gallery"></a>Add Blackboard Learn from the gallery
...
### <a name="create-an-blackboard-learn-test-user"></a>Create an Blackboard Learn test user
