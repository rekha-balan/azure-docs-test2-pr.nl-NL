...
## <a name="add-reward-gateway-from-the-gallery"></a>Add Reward Gateway from the gallery
...
### <a name="create-an-reward-gateway-test-user"></a>Create an Reward Gateway test user
