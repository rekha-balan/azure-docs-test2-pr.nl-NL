...
---
# <a name="transition-to-azure-ad-application-proxies-from-microsoft-forefront"></a>Transition to Azure AD application proxies from Microsoft Forefront
...
## <a name="functionality-details-for-the-conversion"></a>Functionality details for the conversion
