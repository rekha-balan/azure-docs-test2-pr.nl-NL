...
---
# <a name="reset-the-password-for-a-user-in-azure-active-directory---public-preview"></a>Reset the password for a user in Azure Active Directory - Public preview
