...
---
# <a name="tutorial-azure-active-directory-integration-with-lessonly"></a>Tutorial: Azure Active Directory integration with Lesson.ly
...
## <a name="adding-lessonly-from-the-gallery"></a>Adding Lesson.ly from the gallery
...
### <a name="creating-a-lessonly-test-user"></a>Creating a Lesson.ly test user
