...
---
# <a name="tutorial-azure-active-directory-integration-with-dow-jones-factiva"></a>Tutorial: Azure Active Directory integration with Dow Jones Factiva
...
## <a name="adding-dow-jones-factiva-from-the-gallery"></a>Adding Dow Jones Factiva from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-dowjones-factiva-tutorial/create_aaduser_05.png) 
...
6.  On the **User Profile** dialog page, perform the following steps: ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-dowjones-factiva-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-dow-jones-factiva-test-user"></a>Creating an Dow Jones Factiva test user
