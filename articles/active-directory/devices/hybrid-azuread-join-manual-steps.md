...
---
# <a name="tutorial-configure-hybrid-azure-active-directory-joined-devices-manually"></a>Tutorial: Configure hybrid Azure Active Directory joined devices manually 
...
## <a name="configure-service-connection-point"></a>Configure service connection point
...
## <a name="setup-issuance-of-claims"></a>Setup issuance of claims
...
## <a name="enable-windows-down-level-devices"></a>Enable Windows down-level devices
...
## <a name="verify-joined-devices"></a>Verify joined devices
...
## <a name="troubleshoot-your-implementation"></a>Troubleshoot your implementation
