...
---
# <a name="how-to-control-the-hybrid-azure-ad-join-of-your-devices"></a>How to control the hybrid Azure AD join of your devices
...
## <a name="control-windows-current-devices"></a>Control Windows current devices
...
### <a name="configuration-manager-controlled-deployment"></a>Configuration Manager controlled deployment 
...
## <a name="control-windows-down-level-devices"></a>Control Windows down-level devices
