...
---
# <a name="tutorial-join-a-new-windows-10-device-with-azure-ad-during-a-first-run"></a>Tutorial: Join a new Windows 10 device with Azure AD during a first run
...
## <a name="joining-a-device"></a>Joining a device
