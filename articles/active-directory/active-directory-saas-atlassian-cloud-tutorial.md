...
---
# <a name="tutorial-azure-active-directory-integration-with-atlassian-cloud"></a>Tutorial: Azure Active Directory integration with Atlassian Cloud
...
## <a name="add-atlassian-cloud-from-the-gallery"></a>Add Atlassian Cloud from the gallery
...
### <a name="create-an-atlassian-cloud-test-user"></a>Create an Atlassian Cloud test user
...
### <a name="assig-the-azure-ad-test-user"></a>Assig the Azure AD test user
