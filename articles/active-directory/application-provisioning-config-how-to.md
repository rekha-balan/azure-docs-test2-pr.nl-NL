...
---
# <a name="how-to-configure-user-provisioning-to-an-azure-ad-gallery-application"></a>How to configure user provisioning to an Azure AD Gallery application
...
## <a name="configuring-an-application-for-manual-provisioning"></a>Configuring an application for Manual Provisioning
...
## <a name="configuring-an-application-for-automatic-provisioning"></a>Configuring an application for Automatic Provisioning
