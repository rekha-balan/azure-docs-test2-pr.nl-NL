...
## <a name="key-benefits-of-azure-ad-b2b-collaboration"></a>Key benefits of Azure AD B2B collaboration
...
## <a name="easily-add-b2b-collaboration-users"></a>Easily add B2B collaboration users
...
### <a name="use-apis-and-sample-code-to-easily-build-applications-to-onboard"></a>Use APIs and sample code to easily build applications to onboard
