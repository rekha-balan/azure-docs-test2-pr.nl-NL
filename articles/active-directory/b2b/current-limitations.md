...
---
# <a name="limitations-of-azure-ad-b2b-collaboration"></a>Limitations of Azure AD B2B collaboration
Azure Active Directory (Azure AD) B2B collaboration is currently subject to the limitations described in this article.

## <a name="possible-double-multi-factor-authentication"></a>Possible double multi-factor authentication
...
## <a name="azure-ad-directories"></a>Azure AD directories
