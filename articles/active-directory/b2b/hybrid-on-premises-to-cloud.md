...
---
# <a name="grant-locally-managed-partner-accounts-access-to-cloud-resources-using-azure-ad-b2b-collaboration"></a>Grant locally-managed partner accounts access to cloud resources using Azure AD B2B collaboration
...
## <a name="identify-unique-attributes-for-usertype"></a>Identify unique attributes for UserType
...
## <a name="configure-azure-ad-connect-to-sync-users-to-the-cloud"></a>Configure Azure AD Connect to sync users to the cloud
