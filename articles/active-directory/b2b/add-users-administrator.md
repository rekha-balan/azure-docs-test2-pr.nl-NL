...
---
# <a name="add-azure-active-directory-b2b-collaboration-users-in-the-azure-portal"></a>Add Azure Active Directory B2B collaboration users in the Azure portal
...
## <a name="add-guest-users-to-the-directory"></a>Add guest users to the directory
...
## <a name="add-guest-users-to-a-group"></a>Add guest users to a group
...
## <a name="add-guest-users-to-an-application"></a>Add guest users to an application
...
## <a name="resend-invitations-to-guest-users"></a>Resend invitations to guest users
