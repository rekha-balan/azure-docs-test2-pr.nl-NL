...
## <a name="set-the-allow-or-deny-list-policy-in-the-portal"></a>Set the allow or deny list policy in the portal
...
### <a name="add-a-deny-list"></a>Add a deny list
...
### <a name="add-an-allow-list"></a>Add an allow list
...
### <a name="switch-from-allow-to-deny-list-and-vice-versa"></a>Switch from allow to deny list and vice versa 
...
## <a name="set-the-allow-or-deny-list-policy-using-powershell"></a>Set the allow or deny list policy using PowerShell
...
### <a name="use-the-azureadpolicy-cmdlets-to-configure-the-policy"></a>Use the AzureADPolicy cmdlets to configure the policy
