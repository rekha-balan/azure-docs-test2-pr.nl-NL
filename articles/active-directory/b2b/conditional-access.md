...
### <a name="device-based-location-based-and-risk-based-conditional-access-for-b2b-users"></a>Device-based, location-based, and risk-based conditional access for B2B users
