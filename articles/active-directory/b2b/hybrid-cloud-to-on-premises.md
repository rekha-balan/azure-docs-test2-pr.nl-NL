...
---
# <a name="grant-b2b-users-in-azure-ad-access-to-your-on-premises-applications"></a>Grant B2B users in Azure AD access to your on-premises applications
...
## <a name="access-to-saml-apps"></a>Access to SAML apps
...
## <a name="access-to-iwa-and-kcd-apps"></a>Access to IWA and KCD apps
...
### <a name="lifecycle-management-policies"></a>Lifecycle management policies
...
### <a name="create-b2b-guest-user-objects-through-mim-preview"></a>Create B2B guest user objects through MIM (Preview)
...
### <a name="create-b2b-guest-user-objects-through-a-script-preview"></a>Create B2B guest user objects through a script (Preview)
