...
### <a name="changes-to-azure-active-directory-ip-address-ranges"></a>Changes to Azure Active Directory IP address ranges
...
### <a name="change-notice-authorization-codes-will-no-longer-be-available-for-reuse"></a>Change notice: Authorization codes will no longer be available for reuse 
...
### <a name="converged-security-info-management-for-self-service-password-sspr-and-multi-factor-authentication-mfa"></a>Converged security info management for self-service password (SSPR) and Multi-Factor Authentication (MFA)
...
### <a name="new-http-only-cookies-setting-in-azure-ad-application-proxy-apps"></a>New HTTP-Only cookies setting in Azure AD Application proxy apps
...
### <a name="privileged-identity-management-pim-for-azure-resources-supports-management-group-resource-types"></a>Privileged Identity Management (PIM) for Azure resources supports Management Group resource types
...
### <a name="application-access-preview-provides-faster-access-to-the-azure-ad-portal"></a>Application access (preview) provides faster access to the Azure AD portal
...
### <a name="new-federated-apps-available-in-azure-ad-app-gallery---august-2018"></a>New Federated Apps available in Azure AD app gallery - August 2018
...
### <a name="native-tableau-support-is-now-available-in-azure-ad-application-proxy"></a>Native Tableau support is now available in Azure AD Application Proxy
...
### <a name="new-support-to-add-google-as-an-identity-provider-for-b2b-guest-users-in-azure-active-directory-preview"></a>New support to add Google as an identity provider for B2B guest users in Azure Active Directory (preview)
...
## <a name="july-2018"></a>July 2018

### <a name="improvements-to-azure-active-directory-email-notifications"></a>Improvements to Azure Active Directory email notifications
...
### <a name="azure-ad-activity-logs-are-now-available-through-azure-monitor"></a>Azure AD Activity Logs are now available through Azure Monitor
...
### <a name="view-legacy-authentications-through-sign-ins-activity-logs"></a>View legacy authentications through Sign-ins activity logs
...
### <a name="new-federated-apps-available-in-azure-ad-app-gallery---july-2018"></a>New Federated Apps available in Azure AD app gallery - July 2018
...
### <a name="new-user-provisioning-saas-app-integrations---july-2018"></a>New user provisioning SaaS app integrations - July 2018
...
### <a name="connect-health-for-sync---an-easier-way-to-fix-orphaned-and-duplicate-attribute-sync-errors"></a>Connect Health for Sync - An easier way to fix orphaned and duplicate attribute sync errors
...
### <a name="visual-updates-to-the-azure-ad-and-msa-sign-in-experiences"></a>Visual updates to the Azure AD and MSA sign-in experiences
...
### <a name="new-release-of-azure-ad-connect---july-2018"></a>New release of Azure AD Connect - July 2018
...
### <a name="updates-to-the-terms-of-use-tou-end-user-ui"></a>Updates to the Terms of Use (ToU) end-user UI
...
### <a name="pass-through-authentication-supports-legacy-protocols-and-applications"></a>Pass-through Authentication supports legacy protocols and applications
...
### <a name="converged-security-info-management-for-self-service-password-reset-and-multi-factor-authentication"></a>Converged security info management for self-service password reset and Multi-Factor Authentication
...
### <a name="use-the-microsoft-authenticator-app-to-verify-your-identity-when-you-reset-your-password"></a>Use the Microsoft Authenticator app to verify your identity when you reset your password
...
### <a name="change-notice-security-fix-to-the-delegated-authorization-flow-for-apps-using-azure-ad-activity-logs-api"></a>Change notice: Security fix to the delegated authorization flow for apps using Azure AD Activity Logs API
...
### <a name="configure-tls-settings-to-connect-to-azure-ad-services-for-pci-dss-compliance"></a>Configure TLS settings to connect to Azure AD services for PCI DSS compliance
...
### <a name="new-federated-apps-available-in-azure-ad-app-gallery---june-2018"></a>New Federated Apps available in Azure AD app gallery - June 2018
...
### <a name="azure-ad-password-protection-is-available-in-public-preview"></a>Azure AD Password Protection is available in public preview
...
### <a name="new-all-guests-conditional-access-policy-template-created-during-terms-of-use-tou-creation"></a>New "all guests" conditional access policy template created during Terms of Use (ToU) creation
...
### <a name="new-custom-conditional-access-policy-template-created-during-terms-of-use-tou-creation"></a>New "custom" conditional access policy template created during Terms of Use (ToU) creation
...
### <a name="new-and-comprehensive-guidance-about-deploying-azure-multi-factor-authentication"></a>New and comprehensive guidance about deploying Azure Multi-Factor Authentication
...
### <a name="azure-ad-delegated-app-management-roles-are-in-public-preview"></a>Azure AD delegated app management roles are in public preview
...
### <a name="expressroute-support-changes"></a>ExpressRoute support changes
...
### <a name="microsoft-graph-apis-for-administrative-scenarios-for-tou"></a>Microsoft Graph APIs for administrative scenarios for TOU
...
### <a name="add-azure-ad-multi-tenant-endpoint-as-an-identity-provider-in-azure-ad-b2c"></a>Add Azure AD multi-tenant endpoint as an identity provider in Azure AD B2C
...
### <a name="use-internal-urls-to-access-apps-from-anywhere-with-our-my-apps-sign-in-extension-and-the-azure-ad-application-proxy"></a>Use Internal URLs to access apps from anywhere with our My Apps Sign-in Extension and the Azure AD Application Proxy
...
### <a name="azure-active-directory---data-in-europe-for-europe-customers"></a>Azure Active Directory - Data in Europe for Europe customers
...
### <a name="new-user-provisioning-saas-app-integrations---may-2018"></a>New user provisioning SaaS app integrations - May 2018
...
### <a name="azure-ad-access-reviews-of-groups-and-app-access-now-provides-recurring-reviews"></a>Azure AD access reviews of groups and app access now provides recurring reviews
...
### <a name="azure-ad-activity-logs-sign-ins-and-audit-are-now-available-through-ms-graph"></a>Azure AD Activity logs (sign-ins and audit) are now available through MS Graph
...
### <a name="improvements-to-the-b2b-redemption-experience-and-leave-an-org"></a>Improvements to the B2B redemption experience and leave an org
...
### <a name="new-federated-apps-available-in-azure-ad-app-gallery---may-2018"></a>New Federated Apps available in Azure AD app gallery - May 2018
...
### <a name="new-step-by-step-deployment-guides-for-azure-active-directory"></a>New step-by-step deployment guides for Azure Active Directory
...
### <a name="enterprise-applications-search---load-more-apps"></a>Enterprise Applications Search - Load More Apps
...
### <a name="the-may-release-of-aadconnect-contains-a-public-preview-of-the-integration-with-pingfederate-important-security-updates-many-bug-fixes-and-new-great-new-troubleshooting-tools"></a>The May release of AADConnect contains a public preview of the integration with PingFederate, important security updates, many bug fixes, and new great new troubleshooting tools. 
...
### <a name="azure-ad-access-reviews-auto-apply"></a>Azure AD access reviews: auto-apply
...
### <a name="id-tokens-can-no-longer-be-returned-using-the-query-responsemode-for-new-apps"></a>ID tokens can no longer be returned using the query response_mode for new apps. 
...
### <a name="azure-ad-b2c-access-token-are-ga"></a>Azure AD B2C Access Token are GA
...
### <a name="test-single-sign-on-configuration-for-saml-based-applications"></a>Test single sign-on configuration for SAML-based applications
...
### <a name="azure-ad-connect-health-risky-ip-for-ad-fs-extranet-lockout-protection"></a>Azure AD Connect Health: Risky IP for AD FS extranet lockout protection 
...
### <a name="easy-app-config-with-metadata-file-or-url"></a>Easy app config with metadata file or URL
...
### <a name="azure-ad-terms-of-use-now-generally-available"></a>Azure AD Terms of use now generally available
...
### <a name="allow-or-block-invitations-to-b2b-users-from-specific-organizations"></a>Allow or block invitations to B2B users from specific organizations
...
### <a name="new-federated-apps-available-in-azure-ad-app-gallery"></a>New federated apps available in Azure AD app gallery
...
### <a name="grant-b2b-users-in-azure-ad-access-to-your-on-premises-applications-public-preview"></a>Grant B2B users in Azure AD access to your on-premises applications (public preview)
...
### <a name="get-sso-integration-tutorials-from-the-azure-marketplace"></a>Get SSO integration tutorials from the Azure Marketplace
...
### <a name="faster-performance-of-azure-ad-automatic-user-provisioning-to-saas-applications"></a>Faster performance of Azure AD automatic user provisioning to SaaS applications
...
### <a name="self-service-password-reset-from-windows-10-lock-screen-for-hybrid-azure-ad-joined-machines"></a>Self-service password reset from Windows 10 lock screen for hybrid Azure AD joined machines
...
## <a name="march-2018"></a>March 2018
 
### <a name="certificate-expire-notification"></a>Certificate expire notification
...
### <a name="twitter-and-github-identity-providers-in-azure-ad-b2c"></a>Twitter and GitHub identity providers in Azure AD B2C
...
### <a name="office-365-native-clients-are-supported-by-seamless-sso-using-a-non-interactive-protocol"></a>Office 365 native clients are supported by Seamless SSO using a non-interactive protocol
...
### <a name="users-get-a-silent-sign-on-experience-with-seamless-sso-if-an-application-sends-sign-in-requests-to-azure-ads-tenant-endpoints"></a>Users get a silent sign-on experience, with Seamless SSO, if an application sends sign-in requests to Azure AD's tenant endpoints
...
### <a name="need-to-add-only-one-azure-ad-url-instead-of-two-urls-previously-to-users-intranet-zone-settings-to-roll-out-seamless-sso"></a>Need to add only one Azure AD URL, instead of two URLs previously, to users' Intranet zone settings to roll out Seamless SSO
...
### <a name="pim-for-azure-resources-is-generally-available"></a>PIM for Azure Resources is generally available
...
### <a name="adding-optional-claims-to-your-apps-tokens-public-preview"></a>Adding Optional Claims to your apps tokens (public preview)
...
### <a name="azure-ad-supports-pkce-for-more-secure-oauth-flows"></a>Azure AD supports PKCE for more secure OAuth flows
...
### <a name="support-for-provisioning-all-user-attribute-values-available-in-the-workday-getworkers-api"></a>Support for provisioning all user attribute values available in the Workday Get_Workers API
...
### <a name="changing-group-membership-from-dynamic-to-static-and-vice-versa"></a>Changing group membership from dynamic to static, and vice versa
...
### <a name="improved-sign-out-behavior-with-seamless-sso"></a>Improved sign-out behavior with Seamless SSO
...
### <a name="application-proxy-connector-version-154020-released"></a>Application Proxy Connector Version 1.5.402.0 Released
...
## <a name="february-2018"></a>February 2018
 
### <a name="improved-navigation-for-managing-users-and-groups"></a>Improved navigation for managing users and groups
...
### <a name="availability-of-sign-ins-and-audit-reports-in-microsoft-azure-operated-by-21vianet-azure-china-21vianet"></a>Availability of sign-ins and audit reports in Microsoft Azure operated by 21Vianet (Azure China 21Vianet)
...
### <a name="use-report-reader-role-non-admin-role-to-view-azure-ad-activity-reports"></a>Use "Report Reader" role (non-admin role) to view Azure AD Activity Reports
...
### <a name="employeeid-claim-available-as-user-attribute-and-user-identifier"></a>EmployeeID claim available as user attribute and user identifier
...
### <a name="simplified-application-management-using-wildcards-in-azure-ad-application-proxy"></a>Simplified Application Management using Wildcards in Azure AD Application Proxy
...
### <a name="new-cmdlets-to-support-configuration-of-application-proxy"></a>New cmdlets to support configuration of Application Proxy
...
### <a name="new-cmdlets-to-support-configuration-of-groups"></a>New cmdlets to support configuration of groups
...
### <a name="a-new-release-of-azure-ad-connect-is-available"></a>A new release of Azure AD Connect is available
...
## <a name="january-2018"></a>January 2018
...
### <a name="sign-in-with-additional-risk-detected"></a>Sign in with additional risk detected
...
### <a name="hide-office-365-applications-from-end-users-access-panels"></a>Hide Office 365 applications from end user's access panels
...
### <a name="seamless-sign-into-apps-enabled-for-password-sso-directly-from-apps-url"></a>Seamless sign into apps enabled for Password SSO directly from app's URL 
...
### <a name="azure-ad-administration-experience-in-azure-classic-portal-has-been-retired"></a>Azure AD administration experience in Azure Classic Portal has been retired
...
### <a name="the-phonefactor-web-portal-has-been-retired"></a>The PhoneFactor web portal has been retired
...
### <a name="deprecate-azure-ad-reports"></a>Deprecate Azure AD reports
...
### <a name="terms-of-use-in-the-access-panel"></a>Terms of use in the Access Panel
...
### <a name="new-azure-ad-sign-in-experience"></a>New Azure AD sign-in experience
...
### <a name="fewer-sign-in-prompts-a-new-keep-me-signed-in-experience-for-azure-ad-sign-in"></a>Fewer sign-in prompts: A new "keep me signed in" experience for Azure AD sign-in
...
### <a name="add-configuration-to-require-the-terms-of-use-to-be-expanded-prior-to-accepting"></a>Add configuration to require the terms of use to be expanded prior to accepting
...
### <a name="scoped-activation-for-eligible-role-assignments"></a>Scoped activation for eligible role assignments
...
### <a name="new-federated-apps-in-the-azure-ad-app-gallery"></a>New federated apps in the Azure AD app gallery
...
### <a name="approval-workflows-for-azure-ad-directory-roles"></a>Approval workflows for Azure AD directory roles
...
### <a name="pass-through-authentication-skype-for-business-support"></a>Pass-through authentication: Skype for Business support
...
### <a name="updates-to-azure-ad-privileged-identity-management-for-azure-rbac-preview"></a>Updates to Azure AD Privileged Identity Management for Azure RBAC (preview)
...
### <a name="access-control-service-retirement"></a>Access Control service retirement
...
### <a name="restrict-browser-access-to-the-intune-managed-browser"></a>Restrict browser access to the Intune Managed Browser 
...
### <a name="new-approved-client-apps-for-azure-ad-app-based-conditional-access"></a>New approved client apps for Azure AD app-based conditional access
...
### <a name="terms-of-use-support-for-multiple-languages"></a>Terms-of-use support for multiple languages
...
### <a name="real-time-password-writeback-client-status"></a>Real-time password writeback client status
...
### <a name="manage-azure-ad-devices-in-the-azure-portal"></a>Manage Azure AD devices in the Azure Portal
...
### <a name="support-for-macos-as-a-device-platform-for-azure-ad-conditional-access"></a>Support for macOS as a device platform for Azure AD conditional access 
...
### <a name="network-policy-server-extension-for-azure-multi-factor-authentication"></a>Network Policy Server extension for Azure Multi-Factor Authentication 
...
### <a name="restore-or-permanently-remove-deleted-users"></a>Restore or permanently remove deleted users
...
### <a name="use-or-between-controls-in-a-conditional-access-policy"></a>Use "OR" between controls in a conditional access policy 
...
### <a name="aggregation-of-real-time-risk-events"></a>Aggregation of real-time risk events
...
## <a name="october-2017"></a>October 2017
...
### <a name="automatic-sign-in-field-detection"></a>Automatic sign-in field detection
...
### <a name="new-multi-factor-authentication-features"></a>New Multi-Factor Authentication features
...
### <a name="enhancements-to-privileged-identity-management"></a>Enhancements to Privileged Identity Management
...
### <a name="hide-third-party-applications-from-my-apps-and-the-office-365-app-launcher"></a>Hide third-party applications from My Apps and the Office 365 app launcher
...
### <a name="hotfix-for-identity-manager"></a>Hotfix for Identity Manager
