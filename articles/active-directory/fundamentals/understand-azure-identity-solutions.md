...
---
# <a name="understand-azure-identity-solutions"></a>Understand Azure identity solutions
...
## <a name="terms-to-know"></a>Terms to know
...
## <a name="concepts-to-understand"></a>Concepts to understand
...
### <a name="the-difference-between-windows-server-ad-ds-and-azure-ad"></a>The difference between Windows Server AD DS and Azure AD
...
### <a name="extend-office-365-management-and-security-capabilities"></a>Extend Office 365 management and security capabilities
...
## <a name="microsoft-azure-identity-solutions"></a>Microsoft Azure identity solutions
...
### <a name="hybrid-identity"></a>Hybrid identity
