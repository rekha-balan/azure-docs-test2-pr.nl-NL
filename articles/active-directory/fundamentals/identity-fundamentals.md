...
---
# <a name="fundamentals-of-azure-identity-management"></a>Fundamentals of Azure identity management
...
## <a name="connect-on-premises-active-directory-with-azure-ad-and-office-365"></a>Connect on-premises Active Directory with Azure AD and Office 365
...
## <a name="increase-productivity-and-reduce-helpdesk-costs-with-self-service-and-single-sign-on-experiences"></a>Increase productivity and reduce helpdesk costs with self-service and single sign-on experiences
...
## <a name="manage-and-control-access-to-corporate-resources"></a>Manage and control access to corporate resources
...
## <a name="benefits-of-azure-identity"></a>Benefits of Azure Identity
