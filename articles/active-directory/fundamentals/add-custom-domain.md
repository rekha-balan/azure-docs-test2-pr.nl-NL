...
---
# <a name="quickstart-add-a-custom-domain-name-to-azure-active-directory"></a>Quickstart: Add a custom domain name to Azure Active Directory
...
## <a name="add-the-custom-domain-name-to-your-directory"></a>Add the custom domain name to your directory
...
## <a name="add-a-dns-entry-for-the-domain-name-at-the-domain-name-registrar"></a>Add a DNS entry for the domain name at the domain name registrar
...
## <a name="verify-the-custom-domain-name-in-azure-ad"></a>Verify the custom domain name in Azure AD
