...
---
# <a name="manage-your-azure-ad-directory"></a>Manage your Azure AD directory

## <a name="what-is-an-azure-ad-tenant"></a>What is an Azure AD tenant?
...
## <a name="how-can-i-get-an-azure-ad-directory"></a>How can I get an Azure AD directory?
...
### <a name="using-the-azure-ad-directory-that-comes-with-a-new-azure-subscription"></a>Using the Azure AD directory that comes with a new Azure subscription
...
### <a name="associate-an-existing-azure-ad-directory-with-a-new-azure-subscription"></a>Associate an existing Azure AD directory with a new Azure subscription
...
### <a name="create-an-azure-ad-directory-by-signing-up-for-a-microsoft-cloud-service-as-an-organization"></a>Create an Azure AD directory by signing up for a Microsoft cloud service as an organization
...
### <a name="how-to-change-the-default-directory-for-a-subscription"></a>How to change the default directory for a subscription
...
### <a name="manage-the-default-directory-in-azure"></a>Manage the default directory in Azure
...
## <a name="how-can-i-manage-directory-data"></a>How can I manage directory data?
...
## <a name="how-can-i-add-and-manage-multiple-directories"></a>How can I add and manage multiple directories?
...
## <a name="how-to-prepare-to-delete-an-azure-ad-directory"></a>How to prepare to delete an Azure AD directory
