...
---
# <a name="quickstart-add-company-branding-to-your-sign-in-page-in-azure-ad"></a>Quickstart: Add company branding to your sign-in page in Azure AD
...
### <a name="banner-logo"></a>Banner logo 
...
### <a name="username-hint"></a>Username hint   
Description | Constraints | Recommendations
------- | ------- | ----------
...
### <a name="sign-in-page-text"></a>Sign-in page text   
Description | Constraints | Recommendations
------- | ------- | ----------
...
### <a name="sign-in-page-image"></a>Sign-in page image  
Description | Constraints | Recommendations
------- | ------- | ----------
...
### <a name="sign-in-page-background-color"></a>Sign-in page background color
Description | Constraints | Recommendations
------- | ------- | ----------
...
### <a name="square-logo-image"></a>Square logo image
Description | Constraints | Recommendations
------- | ------- | ----------
...
### <a name="show-option-to-remain-signed-in"></a>Show option to remain signed in
Description | Constraints | Recommendations
------- | ------- | ----------
...
## <a name="add-company-branding-to-your-directory"></a>Add company branding to your directory
...
## <a name="add-language-specific-company-branding-to-your-directory"></a>Add language-specific company branding to your directory
