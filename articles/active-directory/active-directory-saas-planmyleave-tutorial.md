...
---
# <a name="tutorial-azure-active-directory-integration-with-planmyleave"></a>Tutorial: Azure Active Directory integration with PlanMyLeave
...
## <a name="adding-planmyleave-from-the-gallery"></a>Adding PlanMyLeave from the gallery
...
### <a name="creating-a-planmyleave-test-user"></a>Creating a PlanMyLeave test user
