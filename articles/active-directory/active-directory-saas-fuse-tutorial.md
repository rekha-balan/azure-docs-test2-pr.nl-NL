...
## <a name="add-fuse-from-the-gallery"></a>Add Fuse from the gallery
...
10. To get SSO configured for your application, contact [Fuse support team](mailto:support@fusion-universal.com) and provide them with the following: 
    ...
    •  The downloaded **Certificate file** •  The **SAML Single Sign-On Service URL** •  The **SAML Entity ID** •  The **Sign-Out URL**
...
### <a name="create-a-fuse-test-user"></a>Create a Fuse test user
