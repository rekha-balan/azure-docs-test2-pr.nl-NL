...
## <a name="add-origami-from-the-gallery"></a>Add Origami from the gallery
...
5. On the **Tell us about this user** dialog page, perform the following steps:  ![Creating an Azure AD test user](https://docstestmedia1.blob.core.windows.net/azure-media/articles/active-directory/media/active-directory-saas-origami-tutorial/create_aaduser_05.png) 
...
### <a name="create-an-origami-test-user"></a>Create an Origami test user
