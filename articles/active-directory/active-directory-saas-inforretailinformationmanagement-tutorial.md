...
---
# <a name="tutorial-azure-active-directory-integration-with-infor-retail--information-management"></a>Tutorial: Azure Active Directory integration with Infor Retail – Information Management
...
## <a name="adding-infor-retail--information-management-from-the-gallery"></a>Adding Infor Retail – Information Management from the gallery
...
### <a name="creating-an-infor-retail--information-management-test-user"></a>Creating an Infor Retail – Information Management test user
