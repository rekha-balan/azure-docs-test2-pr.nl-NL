...
---
# <a name="how-to-secure-access-to-data-catalog-and-data-assets"></a>How to secure access to data catalog and data assets
> [!IMPORTANT]
...
## <a name="catalog-users-and-permissions"></a>Catalog users and permissions
