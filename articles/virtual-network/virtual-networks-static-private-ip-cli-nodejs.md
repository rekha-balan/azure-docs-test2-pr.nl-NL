...
---
# <a name="configure-private-ip-addresses-for-a-virtual-machine-using-the-azure-cli-10"></a>Configure private IP addresses for a virtual machine using the Azure CLI 1.0
