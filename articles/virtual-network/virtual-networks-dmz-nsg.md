...
#### <a name="allowed-rdp-to-iis-server"></a>(*Allowed*) RDP to IIS server
...
#### <a name="allowed-web-server-dns-look-up-on-dns-server"></a>(*Allowed*) Web server DNS look-up on DNS server
...
#### <a name="denied-rdp-to-backend"></a>(*Denied*) RDP to backend
...
#### <a name="denied-web-dns-look-up-on-dns-server"></a>(*Denied*) Web DNS look-up on DNS server
...
#### <a name="denied-sql-access-on-the-web-server"></a>(*Denied*) SQL access on the web server
