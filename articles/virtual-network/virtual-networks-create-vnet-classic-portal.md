...
---
# <a name="create-a-virtual-network-classic-with-a-netcfg-file-using-the-azure-classic-portal"></a>Create a virtual network (classic) with a netcfg file using the Azure classic portal
...
## <a name="how-to-create-a-vnet-with-a-network-config-file-in-the-microsoft-azure-classic-portal"></a>How to create a VNet with a network config file in the Microsoft Azure classic portal
