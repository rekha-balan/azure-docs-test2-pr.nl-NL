...
---
# <a name="ip-address-types-and-allocation-methods-in-azure"></a>IP address types and allocation methods in Azure
...
### <a name="ip-address-version"></a>IP address version
...
#### <a name="internal-dns-hostname-resolution-for-virtual-machines"></a>Internal DNS hostname resolution (for virtual machines)
