...
---
# <a name="create-a-vm-with-a-static-public-ip-address-using-an-azure-resource-manager-template"></a>Create a VM with a static public IP address using an Azure Resource Manager template
...
## <a name="public-ip-address-resources-in-a-template-file"></a>Public IP address resources in a template file
