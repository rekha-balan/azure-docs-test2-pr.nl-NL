...
---
# <a name="configure-private-ip-addresses-for-a-virtual-machine-using-powershell"></a>Configure private IP addresses for a virtual machine using PowerShell
...
## <a name="create-a-vm-with-a-static-private-ip-address"></a>Create a VM with a static private IP address
...
## <a name="retrieve-static-private-ip-address-information-for-a-network-interface"></a>Retrieve static private IP address information for a network interface
...
## <a name="remove-a-static-private-ip-address-from-a-network-interface"></a>Remove a static private IP address from a network interface
...
## <a name="add-a-static-private-ip-address-to-a-network-interface"></a>Add a static private IP address to a network interface
...
Set-AzureRmNetworkInterface -NetworkInterface $nic
```
## <a name="change-the-allocation-method-for-a-private-ip-address-assigned-to-a-network-interface"></a>Change the allocation method for a private IP address assigned to a network interface
