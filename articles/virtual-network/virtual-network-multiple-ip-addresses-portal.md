...
---
# <a name="assign-multiple-ip-addresses-to-virtual-machines-using-the-azure-portal"></a>Assign multiple IP addresses to virtual machines using the Azure portal
...
### <a name="add-a-private-ip-address"></a>**Add a private IP address**
...
### <a name="add-a-public-ip-address"></a>Add a public IP address
...
#### <a name="associate-the-public-ip-address-resource-to-a-new-ip-configuration"></a>Associate the public IP address resource to a new IP configuration
...
#### <a name="associate-the-public-ip-address-resource-to-an-existing-ip-configuration"></a>Associate the public IP address resource to an existing IP configuration
