...
ms.locfileid: "44661742"
---
# <a name="create-a-virtual-network-classic-using-a-network-configuration-file-with-powershell"></a>Create a virtual network (classic) using a network configuration file with PowerShell
