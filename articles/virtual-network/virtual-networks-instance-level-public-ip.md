...
---
# <a name="instance-level-public-ip-classic-overview"></a>Instance level public IP (Classic) overview
...
## <a name="why-would-i-request-an-ilpip"></a>Why would I request an ILPIP?
...
## <a name="manage-an-ilpip-for-a-vm"></a>Manage an ILPIP for a VM
The following tasks enable you to create, assign, and remove ILPIPs from VMs:

### <a name="how-to-request-an-ilpip-during-vm-creation-using-powershell"></a>How to request an ILPIP during VM creation using PowerShell
...
## <a name="manage-an-ilpip-for-a-cloud-services-role-instance"></a>Manage an ILPIP for a Cloud Services role instance
...
### <a name="how-to-retrieve-ilpip-information-for-a-cloud-service"></a>How to retrieve ILPIP information for a Cloud Service
