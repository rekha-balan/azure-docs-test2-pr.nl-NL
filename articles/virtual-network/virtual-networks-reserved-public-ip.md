...
## <a name="reserve-the-ip-address-of-an-existing-cloud-service"></a>Reserve the IP address of an existing cloud service
...
## <a name="associate-a-reserved-ip-to-a-new-cloud-service"></a>Associate a reserved IP to a new cloud service
...
## <a name="remove-a-reserved-ip-from-a-running-deployment"></a>Remove a reserved IP from a running deployment
...
## <a name="associate-a-reserved-ip-to-a-running-deployment"></a>Associate a reserved IP to a running deployment
...
## <a name="associate-a-reserved-ip-to-a-cloud-service-by-using-a-service-configuration-file"></a>Associate a reserved IP to a cloud service by using a service configuration file
