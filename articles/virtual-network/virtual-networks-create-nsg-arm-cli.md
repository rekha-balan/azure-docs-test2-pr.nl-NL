...
---
# <a name="create-network-security-groups-using-the-azure-cli-20"></a>Create network security groups using the Azure CLI 2.0
...
## <a name="create-the-nsg-for-the-frontend-subnet"></a>Create the NSG for the `FrontEnd` subnet
...
## <a name="create-the-nsg-for-the-backend-subnet"></a>Create the NSG for the `BackEnd` subnet
