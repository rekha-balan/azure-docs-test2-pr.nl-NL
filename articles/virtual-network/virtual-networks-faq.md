...
### <a name="how-do-i-know-if-i-need-a-vnet"></a>How do I know if I need a VNet?
...
### <a name="what-happens-to-my-ip-addresses-if-i-stop-a-cloud-service-deployment-slot-or-shutdown-a-vm-from-within-the-operating-system"></a>What happens to my IP addresses if I stop a Cloud Service deployment slot or shutdown a VM from within the operating system?
...
### <a name="can-i-connect-a-virtual-machine-scale-set-vmss-to-a-vnet"></a>Can I connect a Virtual Machine Scale Set (VMSS) to a VNet?
