...
---
# <a name="create-a-virtual-network-peering-using-an-azure-resource-manager-template"></a>Create a virtual network peering using an Azure Resource Manager template
