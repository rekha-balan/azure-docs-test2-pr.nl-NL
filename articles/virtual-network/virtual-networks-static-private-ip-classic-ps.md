...
---
# <a name="configure-private-ip-addresses-for-a-virtual-machine-classic-using-powershell"></a>Configure private IP addresses for a virtual machine (Classic) using PowerShell
