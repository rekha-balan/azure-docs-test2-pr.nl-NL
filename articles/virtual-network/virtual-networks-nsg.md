...
---
# <a name="filter-network-traffic-with-network-security-groups"></a>Filter network traffic with network security groups
...
### <a name="db-servers-management-nic"></a>DB servers (Management NIC)
**Inbound rules**
...
### <a name="db-servers-database-traffic-nic"></a>DB servers (Database traffic NIC)
**Inbound rules**
