...
---
# <a name="assign-multiple-ip-addresses-to-virtual-machines-using-an-azure-resource-manager-template"></a>Assign multiple IP addresses to virtual machines using an Azure Resource Manager template
...
## <a name="template-description"></a>Template description
...
## <a name="deploy-using-the-azure-portal"></a>Deploy using the Azure portal
...
## <a name="deploy-using-powershell"></a>Deploy using PowerShell
...
## <a name="deploy-using-the-azure-cli"></a>Deploy using the Azure CLI
