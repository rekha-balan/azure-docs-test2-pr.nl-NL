...
---
# <a name="manage-dns-servers-used-by-a-virtual-network-classic-using-the-azure-portal-classic"></a>Manage DNS servers used by a virtual network (Classic) using the Azure portal (Classic)
...
## <a name="edit-a-dns-server-list-for-a-virtual-network-using-the-azure-portal-classic"></a>Edit a DNS server list for a virtual network using the Azure portal (Classic)
