...
---
# <a name="migrate-a-virtual-network-classic-from-an-affinity-group-to-a-region"></a>Migrate a virtual network (classic) from an affinity group to a region
...
## <a name="edit-the-network-configuration-file"></a>Edit the network configuration file
...
## <a name="what-to-do-if-you-have-a-vm-classic-in-an-affinity-group"></a>What to do if you have a VM (classic) in an affinity group
