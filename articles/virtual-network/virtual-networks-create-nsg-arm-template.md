...
---
# <a name="create-network-security-groups-using-an-azure-resource-manager-template"></a>Create network security groups using an Azure Resource Manager template
