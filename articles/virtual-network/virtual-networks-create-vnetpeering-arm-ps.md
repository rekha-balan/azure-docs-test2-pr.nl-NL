...
---
# <a name="create-a-virtual-network-peering-using-azure-powershell"></a>Create a virtual network peering using Azure PowerShell
...
## <a name="remove-a-vnet-peering"></a>Remove a VNet peering
