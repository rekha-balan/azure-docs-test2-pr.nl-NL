...
---
# <a name="assign-multiple-ip-addresses-to-virtual-machines-using-the-azure-cli-20"></a>Assign multiple IP addresses to virtual machines using the Azure CLI 2.0
