...
---
# <a name="create-a-virtual-network-using-an-azure-resource-manager-template"></a>Create a virtual network using an Azure Resource Manager template
...
## <a name="deploy-the-template-using-powershell"></a>Deploy the template using PowerShell
...
## <a name="deploy-the-template-using-click-to-deploy"></a>Deploy the template using click-to-deploy
