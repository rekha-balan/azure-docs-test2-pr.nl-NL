...
---
# <a name="designing-highly-available-applications-using-ra-grs"></a>Designing Highly Available Applications using RA-GRS
...
## <a name="key-features-of-ra-grs"></a>Key features of RA-GRS
...
## <a name="application-design-considerations-when-using-ra-grs"></a>Application design considerations when using RA-GRS
...
### <a name="using-eventually-consistent-data"></a>Using eventually consistent data
...
### <a name="handling-services-separately-or-all-together"></a>Handling services separately or all together
...
## <a name="running-your-application-in-read-only-mode"></a>Running your application in read-only mode
...
## <a name="handling-updates-when-running-in-read-only-mode"></a>Handling updates when running in read-only mode
...
## <a name="handling-retries"></a>Handling retries
...
### <a name="read-requests"></a>Read requests
...
### <a name="update-requests"></a>Update requests
...
## <a name="circuit-breaker-pattern"></a>Circuit Breaker pattern
...
### <a name="how-to-implement-the-circuit-breaker-pattern"></a>How to implement the circuit breaker pattern
...
### <a name="options-for-monitoring-the-error-frequency"></a>Options for monitoring the error frequency
...
## <a name="handling-eventually-consistent-data"></a>Handling eventually consistent data
