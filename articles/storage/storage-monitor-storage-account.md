...
## <a name="configure-monitoring-for-a-storage-account"></a>Configure monitoring for a storage account
...
## <a name="customize-metrics-charts"></a>Customize metrics charts
...
### <a name="metrics-availability-in-charts"></a>Metrics availability in charts
...
### <a name="metrics-resolution"></a>Metrics resolution
...
## <a name="configure-metrics-alerts"></a>Configure metrics alerts
...
## <a name="add-metrics-charts-to-the-portal-dashboard"></a>Add metrics charts to the portal dashboard
