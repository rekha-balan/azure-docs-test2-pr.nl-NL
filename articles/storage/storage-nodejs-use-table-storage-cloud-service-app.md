...
> [!NOTE]
> Storage credentials are only used when the application is deployed to Azure. When running in the emulator, the application will use the storage emulator.
>
>
...
![A browser window displaying the My Task List page. The URL indicates the page is now being hosted on Azure.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storage/media/storage-nodejs-use-table-storage-cloud-service-app/getting-started-1.png)
