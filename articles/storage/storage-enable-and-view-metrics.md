...
## <a name="metrics-alerts"></a>Metrics alerts
...
[Enabling Storage Logging and Accessing Log Data](/rest/api/storageservices/fileservices/Enabling-Storage-Logging-and-Accessing-Log-Data)