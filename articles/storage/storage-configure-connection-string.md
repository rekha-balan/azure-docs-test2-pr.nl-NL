...
## <a name="create-a-connection-string-for-the-storage-emulator"></a>Create a connection string for the storage emulator
...
## <a name="create-a-connection-string-for-an-azure-storage-account"></a>Create a connection string for an Azure storage account
...
## <a name="create-a-connection-string-for-an-explicit-storage-endpoint"></a>Create a connection string for an explicit storage endpoint
...
### <a name="create-a-connection-string-with-an-endpoint-suffix"></a>Create a connection string with an endpoint suffix
