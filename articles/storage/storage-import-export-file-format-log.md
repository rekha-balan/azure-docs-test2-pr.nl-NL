...
---
# <a name="azure-importexport-service-log-file-format"></a>Azure Import/Export service log file format
...
## <a name="log-file-location"></a>Log file location  
...
## <a name="log-file-format"></a>Log file format  
...
# <a name="drive-status-codes"></a>Drive status codes  
...
## <a name="blob-status-codes"></a>Blob status codes  
...
## <a name="import-disposition-status-codes"></a>Import disposition status codes  
...
## <a name="page-rangeblock-status-codes"></a>Page range/block status codes  
...
## <a name="metadata-status-codes"></a>Metadata status codes  
...
## <a name="properties-status-codes"></a>Properties status codes  
...
## <a name="sample-logs"></a>Sample logs  
