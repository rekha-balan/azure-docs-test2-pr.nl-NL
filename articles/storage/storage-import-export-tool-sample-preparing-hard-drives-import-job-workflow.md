...
---
# <a name="sample-workflow-to-prepare-hard-drives-for-an-import-job"></a>Sample workflow to prepare hard drives for an import job
...
## <a name="storage-account-destinations"></a>Storage account destinations
...
## <a name="determine-hard-drive-requirements"></a>Determine hard drive requirements
...
## <a name="attach-drives-and-configure-the-job"></a>Attach drives and configure the job
...
## <a name="run-the-azure-importexport-tool-waimportexportexe"></a>Run the Azure Import/Export Tool (WAImportExport.exe)
