...
## <a name="preparing-disk-for-import-when-data-is-pre-loaded"></a>Preparing disk for import when data is pre-loaded
...
## <a name="copy-sessions---first-drive"></a>Copy sessions - first drive
...
## <a name="copy-sessions---second-drive"></a>Copy sessions - second drive
...
## <a name="copy-session-completion"></a>Copy session completion
