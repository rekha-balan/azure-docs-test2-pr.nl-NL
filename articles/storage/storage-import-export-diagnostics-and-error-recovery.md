...
---
# <a name="diagnostics-and-error-recovery-for-azure-importexport-jobs"></a>Diagnostics and error recovery for Azure Import/Export jobs
...
## <a name="drive-errors"></a>Drive errors
...
## <a name="blob-errors"></a>Blob errors
