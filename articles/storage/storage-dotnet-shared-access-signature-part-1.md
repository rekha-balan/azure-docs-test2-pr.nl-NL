...
---
# <a name="using-shared-access-signatures-sas"></a>Using shared access signatures (SAS)
...
## <a name="what-is-a-shared-access-signature"></a>What is a shared access signature?
...
## <a name="when-should-you-use-a-shared-access-signature"></a>When should you use a shared access signature?
...
## <a name="how-a-shared-access-signature-works"></a>How a shared access signature works
...
### <a name="parameters-common-to-account-sas-and-service-sas-tokens"></a>Parameters common to account SAS and service SAS tokens
...
### <a name="parameters-for-a-service-sas-token"></a>Parameters for a service SAS token
...
### <a name="parameters-for-an-account-sas-token"></a>Parameters for an account SAS token
...
## <a name="examples-of-sas-uris"></a>Examples of SAS URIs

### <a name="service-sas-uri-example"></a>Service SAS URI example
...
### <a name="account-sas-uri-example"></a>Account SAS URI example
...
## <a name="controlling-a-sas-with-a-stored-access-policy"></a>Controlling a SAS with a stored access policy
...
## <a name="authenticating-from-a-client-application-with-a-sas"></a>Authenticating from a client application with a SAS
...
### <a name="using-a-sas-in-a-connection-string"></a>Using a SAS in a connection string
[!INCLUDE [storage-use-sas-in-connection-string-include](../../includes/storage-use-sas-in-connection-string-include.md)]

### <a name="using-a-sas-in-a-constructor-or-method"></a>Using a SAS in a constructor or method
...
## <a name="best-practices-when-using-sas"></a>Best practices when using SAS
...
### <a name="example-create-and-use-an-account-sas"></a>Example: Create and use an account SAS
...
### <a name="example-create-a-stored-access-policy"></a>Example: Create a stored access policy
...
### <a name="example-create-a-service-sas-on-a-container"></a>Example: Create a service SAS on a container
...
### <a name="example-create-a-service-sas-on-a-blob"></a>Example: Create a service SAS on a blob
