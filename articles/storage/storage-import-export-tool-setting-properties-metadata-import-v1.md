...
---
# <a name="setting-properties-and-metadata-during-the-import-process"></a>Setting properties and metadata during the import process
...
## <a name="specify-blob-properties-in-a-text-file"></a>Specify Blob Properties in a Text File  
...
## <a name="specify-blob-metadata-in-a-text-file"></a>Specify Blob Metadata in a Text File  
...
## <a name="create-a-copy-session-including-the-properties-or-metadata-files"></a>Create a Copy Session Including the Properties or Metadata Files  
