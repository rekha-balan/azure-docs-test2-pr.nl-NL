...
---
# <a name="about-disks-and-vhds-for-azure-windows-vms"></a>About disks and VHDs for Azure Windows VMs
...
## <a name="one-last-recommendation-use-trim-with-unmanaged-standard-disks"></a>One last recommendation: Use TRIM with unmanaged standard disks 
