...
---
# <a name="get-started-with-azure-table-storage-and-visual-studio-connected-services-aspnet"></a>Get started with Azure table storage and Visual Studio Connected Services (ASP.NET)
...
### <a name="create-a-model-class"></a>Create a model class
...
## <a name="add-a-batch-of-entities-to-a-table"></a>Add a batch of entities to a table
...
## <a name="get-all-entities-in-a-partition"></a>Get all entities in a partition
