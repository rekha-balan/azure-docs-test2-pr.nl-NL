...
## <a name="identify-the-data-to-be-imported"></a>Identify the data to be imported
...
## <a name="identify-the-destination-locations-in-the-blob-service"></a>Identify the destination locations in the blob service
...
## <a name="determine-how-many-drives-are-needed"></a>Determine how many drives are needed
...
## <a name="copy-data-to-your-hard-drive"></a>Copy data to your hard drive
...
### <a name="azure-importexport-tool-syntax-for-an-import-job"></a>Azure Import/Export Tool syntax for an import job
...
### <a name="parameters-for-the-first-copy-session-for-a-hard-drive"></a>Parameters for the first copy session for a hard drive
...
### <a name="parameters-required-for-all-copy-sessions"></a>Parameters required for all copy sessions
...
### <a name="parameters-for-copying-a-single-directory"></a>Parameters for copying a single directory
...
### <a name="parameters-for-copying-a-single-file"></a>Parameters for copying a single file
...
### <a name="resuming-an-interrupted-copy-session"></a>Resuming an interrupted copy session
...
### <a name="aborting-an-interrupted-copy-session"></a>Aborting an interrupted copy session
