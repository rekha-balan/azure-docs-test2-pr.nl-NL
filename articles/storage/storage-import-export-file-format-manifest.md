...
---
# <a name="azure-importexport-service-manifest-file-format"></a>Azure Import/Export service manifest file format
...
## <a name="manifest-xml-elements-and-attributes"></a>Manifest XML elements and attributes
