...
---
# <a name="preparing-hard-drives-for-an-import-job"></a>Preparing hard drives for an Import Job
...
### <a name="requirements-for-waimportexportexe"></a>Requirements for WAImportExport.exe
...
### <a name="preparing-disk-for-import-job"></a>Preparing disk for import job
...
### <a name="repairing-a-partially-failed-import-job"></a>Repairing a partially failed import job
...
### <a name="repairing-a-partially-failed-export-job"></a>Repairing a partially failed export job
...
## <a name="download-and-install-waimportexport"></a>Download and install WAImportExport
...
## <a name="prepare-the-dataset-csv-file"></a>Prepare the dataset CSV file

### <a name="what-is-dataset-csv"></a>What is dataset CSV
...
### <a name="sample-datasetcsv"></a>Sample dataset.csv
...
### <a name="dataset-csv-file-fields"></a>Dataset CSV file fields
...
## <a name="prepare-initialdriveset-or-additionaldriveset-csv-file"></a>Prepare InitialDriveSet or AdditionalDriveSet CSV file

### <a name="what-is-driveset-csv"></a>What is driveset CSV
...
### <a name="create-basic-volume-and-assign-drive-letter"></a>Create basic volume and assign drive letter
...
### <a name="sample-initialdriveset-and-additionaldriveset-csv-file"></a>Sample InitialDriveSet and AdditionalDriveSet CSV file
...
### <a name="driveset-csv-file-fields"></a>Driveset CSV file fields
...
### <a name="add-data-in-subsequent-session"></a>Add data in subsequent session
...
### <a name="abort-the-latest-session"></a>Abort the latest session:
...
### <a name="resume-a-latest-interrupted-session"></a>Resume a latest interrupted session
...
## <a name="tool-output"></a>Tool output

### <a name="sample-drive-manifest-file"></a>Sample drive manifest file
...
### <a name="sample-journal-file-xml-for-each-drive"></a>Sample journal file (XML) for each drive
...
### <a name="sample-journal-file-jrn-for-session-which-records-the-trail-of-sessions"></a>Sample journal file (JRN) for session which records the trail of sessions
...
#### <a name="what-is-waimportexport-tool"></a>What is WAImportExport tool?
...
#### <a name="how-does-the-waimportexport-tool-work-on-multiple-sorce-dir-and-disks"></a>How does the WAImportExport tool work on multiple sorce dir and disks?
...
#### <a name="where-can-i-find-previous-version-of-waimportexport-tool"></a>Where can I find previous version of WAImportExport tool?
...
#### <a name="what-is-a-session-id"></a>What is a session ID?
...
#### <a name="what-is-a-journal-file"></a>What is a journal file?
...
#### <a name="what-is-a-log-directory"></a>What is a log directory?
...
#### <a name="what-are-the-specifications-of-my-disk"></a>What are the specifications of my disk?

One or more empty 2.5 or 3.5-inch SATAII or III or SSD hard drives connected to the copy machine.

#### <a name="how-can-i-enable-bitlocker-on-my-machine"></a>How can I enable BitLocker on my machine?
...
#### <a name="how-to-disable-trusted-platform-module-tpm-in-bitlocker"></a>How to disable Trusted Platform Module (TPM) in BitLocker?
> [!NOTE]
...
####  <a name="how-to-check-if-net-4-or-higher-version-is-installed-on-my-machine"></a>How to check if .NET 4 or higher version is installed on my machine?
...
#### <a name="how-many-drives-can-i-preparesend-at-the-same-time"></a>How many drives can I prepare/send at the same time?
...
#### <a name="can-i-target-more-than-one-storage-account"></a>Can I target more than one storage account?

Only one storage account can be submitted per job and in single copy session.

### <a name="capabilities"></a>Capabilities

#### <a name="does-waimportexportexe-encrypt-my-data"></a>Does WAImportExport.exe encrypt my data?

Yes. BitLocker encryption is enabled and required for this process.

#### <a name="what-will-be-the-hierarchy-of-my-data-when-it-appears-in-the-storage-account"></a>What will be the hierarchy of my data when it appears in the storage account?
...
#### <a name="how-many-of-the-input-disks-will-have-active-io-in-parallel-when-copy-is-in-progress"></a>How many of the input disks will have active IO in parallel, when copy is in progress?
...
#### <a name="how-does-the-tool-distribute-the-files-across-the-disks"></a>How does the tool distribute the files across the disks?
...
### <a name="waimportexport-output"></a>WAImportExport output

#### <a name="there-are-two-journal-files-which-one-should-i-upload-to-azure-portal"></a>There are two journal files, which one should I upload to Azure portal?
