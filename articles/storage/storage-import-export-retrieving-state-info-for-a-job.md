...
---
# <a name="retrieving-state-information-for-an-importexport-job"></a>Retrieving state information for an Import/Export job
...
## <a name="job-states"></a>Job states
...
![JobStates](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storage/media/storage-import-export-retrieving-state-info-for-a-job/JobStates.png "JobStates")
...
## <a name="drive-states"></a>Drive states
...
![DriveStates](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storage/media/storage-import-export-retrieving-state-info-for-a-job/DriveStates.png "DriveStates")
...
## <a name="faulted-states"></a>Faulted states
