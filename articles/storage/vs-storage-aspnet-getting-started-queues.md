...
---
# <a name="get-started-with-azure-queue-storage-and-visual-studio-connected-services-aspnet"></a>Get started with Azure queue storage and Visual Studio Connected Services (ASP.NET)
...
## <a name="read-a-message-from-a-queue-without-removing-it"></a>Read a message from a queue without removing it
...
## <a name="read-and-remove-a-message-from-a-queue"></a>Read and remove a message from a queue
