...
## <a name="direct-vs-intermediary-domain-mapping"></a>Direct vs. intermediary domain mapping
...
### <a name="intermediary-mapping-with-asverify"></a>Intermediary mapping with *asverify*
...
## <a name="register-a-custom-domain"></a>Register a custom domain
...
## <a name="register-a-custom-domain-using-the-asverify-subdomain"></a>Register a custom domain using the *asverify* subdomain
...
## <a name="test-your-custom-domain"></a>Test your custom domain
...
## <a name="deregister-a-custom-domain"></a>Deregister a custom domain
