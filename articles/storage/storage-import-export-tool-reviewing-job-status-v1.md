...
---
# <a name="reviewing-azure-importexport-job-status-with-copy-log-files"></a>Reviewing Azure Import/Export job status with copy log files
...
## <a name="example-urls"></a>Example URLs
