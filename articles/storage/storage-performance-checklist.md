...
---
# <a name="microsoft-azure-storage-performance-and-scalability-checklist"></a>Microsoft Azure Storage Performance and Scalability Checklist
...
#### <a name="what-to-do-when-approaching-a-scalability-target"></a>What to do when approaching a scalability target
...
#### <a name="client-network-capability"></a>Client Network Capability
...
##### <a name="useful-resources"></a>Useful Resources
For more information about virtual machine sizes and allocated bandwidth, see [Windows VM sizes](../virtual-machines/windows/sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) or [Linux VM sizes](../virtual-machines/linux/sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).  
...
### <a name="blob-specific-scalability-targets"></a>Blob-Specific Scalability Targets
...
### <a name="copying-and-moving-blobs"></a>Copying and Moving Blobs
...
### <a name="uploading-fast"></a>Uploading Fast
...
#### <a name="entities-per-second-account"></a>Entities per Second (Account)
...
#### <a name="entities-per-second-partition"></a>Entities per Second (Partition)
...
#### <a name="hot-partitions"></a>Hot Partitions
...
###### <a name="point-queries"></a>Point Queries
...
###### <a name="partition-queries"></a>Partition Queries
...
###### <a name="table-queries"></a>Table Queries
...
##### <a name="limiting-the-amount-of-data-returned"></a>Limiting the Amount of Data Returned
