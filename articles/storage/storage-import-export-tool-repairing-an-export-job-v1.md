...
---
# <a name="repairing-an-export-job"></a>Repairing an export job
...
## <a name="using-repairexport-mode-to-correct-failed-exports"></a>Using RepairExport mode to correct failed exports  
...
## <a name="using-repairexport-to-validate-drive-contents"></a>Using RepairExport to validate drive contents  
