...
---
# <a name="azure-importexport-service-metadata-and-properties-file-format"></a>Azure Import/Export service metadata and properties file format
...
## <a name="metadata-file-format"></a>Metadata file format  
...
## <a name="properties-file-format"></a>Properties file format  
