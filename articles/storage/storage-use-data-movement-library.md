...
---
# <a name="transfer-data-with-the-microsoft-azure-storage-data-movement-library"></a>Transfer Data with the Microsoft Azure Storage Data Movement Library
...
## <a name="add-data-movement-library-to-your-project"></a>Add Data Movement Library to your project
...
## <a name="set-up-the-skeleton-of-your-application"></a>Set up the skeleton of your application
...
## <a name="transfer-local-file-to-azure-blob"></a>Transfer local file to Azure Blob
...
## <a name="set-number-of-parallel-operations"></a>Set number of parallel operations
...
## <a name="track-transfer-progress"></a>Track transfer progress
...
## <a name="resume-a-canceled-transfer"></a>Resume a canceled transfer
...
## <a name="transfer-local-directory-to-azure-blob-directory"></a>Transfer local directory to Azure Blob directory
...
## <a name="copy-file-from-url-to-azure-blob"></a>Copy file from URL to Azure Blob
...
## <a name="transfer-azure-blob-to-azure-blob"></a>Transfer Azure Blob to Azure Blob
