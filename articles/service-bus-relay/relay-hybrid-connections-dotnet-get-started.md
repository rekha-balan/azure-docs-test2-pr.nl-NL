...
---
# <a name="get-started-with-relay-hybrid-connections-websockets-in-net"></a>Get started with Relay Hybrid Connections Websockets in .NET
...
## <a name="1-create-a-namespace-by-using-the-azure-portal"></a>1. Create a namespace by using the Azure portal
...
## <a name="2-create-a-hybrid-connection-by-using-the-azure-portal"></a>2. Create a hybrid connection by using the Azure portal
