...
---
# <a name="azure-wcf-relay-rest-tutorial"></a>Azure WCF Relay REST tutorial
...
## <a name="step-1-create-a-namespace"></a>Step 1: Create a namespace
...
## <a name="step-2-define-a-rest-based-wcf-service-contract-to-use-with-azure-relay"></a>Step 2: Define a REST-based WCF service contract to use with Azure Relay
...
### <a name="to-create-a-contract-with-an-interface"></a>To create a contract with an interface
...
## <a name="step-4-host-the-rest-based-wcf-service-to-use-azure-relay"></a>Step 4: Host the REST-based WCF service to use Azure Relay
