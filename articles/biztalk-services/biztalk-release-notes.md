...
* Open the .bcs file again from the Solution Explorer.  
  ...
  `‘<old name>’ Entity’s associated file ‘<old name>.bridgeconfig’ does not exist` To avoid running into this scenario, make sure you save changes after you rename the entities in a BizTalk Service project.  
...
### <a name="pipelines-versus-bridges"></a>Pipelines versus Bridges
