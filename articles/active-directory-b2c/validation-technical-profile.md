...
---
# <a name="define-a-validation-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Define a validation technical profile in an Azure Active Directory B2C custom policy
