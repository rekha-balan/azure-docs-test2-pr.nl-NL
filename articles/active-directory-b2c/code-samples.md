...
---
# <a name="azure-active-directory-b2c-code-samples"></a>Azure Active Directory B2C code samples

The following tables provide links to samples for applications including iOS, Android, .NET, and Node.js.

## <a name="mobile-and-desktop-apps"></a>Mobile and desktop apps
...
## <a name="web-apps-and-apis"></a>Web apps and APIs
...
## <a name="single-page-apps"></a>Single page apps
