...
---
# <a name="predicates-and-predicatevalidations"></a>Predicates and PredicateValidations
...
## <a name="configure-password-complexity"></a>Configure password complexity
...
![Predicate process](./media/predicates/predicates-pass.png)
 ...
 ## <a name="configure-a-date-range"></a>Configure a date range
