...
---
# <a name="azure-active-directory-b2c-modify-sign-up-to-add-new-claims-and-configure-user-input"></a>Azure Active Directory B2C: Modify sign up to add new claims and configure user input.
...
## <a name="define-the-claim-its-display-name-and-the-user-input-type"></a>Define the claim, its display name and the user input type
...
* `CheckboxMultiSelect` Allows for the selection of one or more values.
...
## <a name="add-the-claim-to-the-sign-upsign-in-user-journey"></a>Add the claim to the sign up/sign in user journey
...
## <a name="test-the-custom-policy-using-run-now"></a>Test the custom policy using "Run Now"
...
## <a name="optional-remove-email-verification-from-signup-journey"></a>Optional: Remove email verification from signup journey
