...
---
# <a name="azure-active-directory-b2c-sign-in-using-azure-ad-accounts-through-a-built-in-policy"></a>Azure Active Directory B2C: Sign in using Azure AD accounts through a built-in policy
...
## <a name="configure-azure-ad-as-an-identity-provider-in-your-tenant"></a>Configure Azure AD as an identity provider in your tenant
