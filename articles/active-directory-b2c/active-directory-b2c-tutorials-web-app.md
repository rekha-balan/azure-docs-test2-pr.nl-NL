...
---
# <a name="tutorial-enable-a-web-application-to-authenticate-with-accounts-using-azure-active-directory-b2c"></a>Tutorial: Enable a web application to authenticate with accounts using Azure Active Directory B2C
...
## <a name="register-web-app"></a>Register web app
...
### <a name="create-a-client-password"></a>Create a client password
...
## <a name="update-web-app-code"></a>Update web app code
