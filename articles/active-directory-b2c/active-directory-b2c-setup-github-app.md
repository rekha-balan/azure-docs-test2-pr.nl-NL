...
---
# <a name="set-up-sign-up-and-sign-in-with-a-github-account-using-azure-active-directory-b2c"></a>Set up sign-up and sign-in with a GitHub account using Azure Active Directory B2C
...
## <a name="create-a-github-oauth-application"></a>Create a GitHub OAuth application
...
## <a name="configure-a-github-account-as-an-identity-provider"></a>Configure a GitHub account as an identity provider
