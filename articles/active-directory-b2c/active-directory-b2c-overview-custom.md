...
---
# <a name="custom-policies-in-azure-active-directory-b2c"></a>Custom policies in Azure Active Directory B2C
...
## <a name="comparing-built-in-policies-and-custom-policies"></a>Comparing built-in policies and custom policies
...
## <a name="policy-files"></a>Policy files
...
## <a name="custom-policy-core-concepts"></a>Custom policy core concepts
...
### <a name="inheritance-model"></a>Inheritance model
