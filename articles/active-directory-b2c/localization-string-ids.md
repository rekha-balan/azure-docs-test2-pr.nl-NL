...
---
# <a name="localization-string-ids"></a>Localization string IDs
...
## <a name="sign-up-or-sign-in-page-elements"></a>Sign-up or sign-in page elements
...
## <a name="sign-up-or-sign-in-error-messages"></a>Sign-up or sign-in error messages
...
## <a name="sign-up-and-self-asserted-pages-user-interface-elements"></a>Sign-up and self asserted pages user interface elements
...
## <a name="sign-up-and-self-asserted-pages-error-messages"></a>Sign-up and self asserted pages error messages
...
## <a name="phone-factor-authentication-page-user-interface-elements"></a>Phone factor authentication page user interface elements
