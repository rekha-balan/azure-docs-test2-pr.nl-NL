...
---
# <a name="understanding-the-custom-policies-of-the-azure-ad-b2c-custom-policy-starter-pack"></a>Understanding the custom policies of the Azure AD B2C Custom Policy starter pack
...
## <a name="claims-schemas"></a>Claims schemas
...
### <a name="claims-that-are-required-for-the-user-journeys"></a>Claims that are required for the user journeys
...
### <a name="claims-required-for-query-string-parameters-and-other-special-parameters"></a>Claims required for query string parameters and other special parameters
...
### <a name="additional-optional-claims-that-can-be-collected"></a>Additional (optional) claims that can be collected
...
## <a name="claim-transformations"></a>Claim transformations
...
## <a name="content-definitions"></a>Content definitions
...
## <a name="technical-profiles"></a>Technical profiles
...
### <a name="technical-profiles-for-facebook"></a>Technical profiles for Facebook

| Technical profile | Description |
|-------------------|-------------|
| *Facebook-OAUTH* | |

### <a name="technical-profiles-for-local-account-signin"></a>Technical profiles for Local Account Signin

| Technical profile | Description |
|-------------------|-------------|
| *Login-NonInteractive* | |

### <a name="technical-profiles-for-phone-factor"></a>Technical profiles for Phone Factor
...
### <a name="technical-profiles-for-azure-active-directory"></a>Technical profiles for Azure Active Directory
...
### <a name="technical-profiles-for-self-asserted"></a>Technical profiles for Self Asserted
...
### <a name="technical-profiles-for-local-account"></a>Technical profiles for Local Account

| Technical profile | Description |
|-------------------|-------------|
| *LocalAccountSignUpWithLogonEmail* | |

### <a name="technical-profiles-for-session-management"></a>Technical profiles for Session Management
...
### <a name="technical-profiles-for-the-trust-framework-policy-engine"></a>Technical profiles for the trust framework policy engine

Currently, no technical profiles are defined for the **Trustframework Policy Engine TechnicalProfiles** claims provider.

### <a name="technical-profiles-for-token-issuer"></a>Technical profiles for Token Issuer
