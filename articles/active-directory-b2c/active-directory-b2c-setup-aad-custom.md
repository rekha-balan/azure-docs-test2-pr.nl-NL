...
---
# <a name="azure-active-directory-b2c-sign-in-by-using-azure-ad-accounts"></a>Azure Active Directory B2C: Sign in by using Azure AD accounts
...
## <a name="create-an-azure-ad-app"></a>Create an Azure AD app
...
## <a name="add-the-azure-ad-key-to-azure-ad-b2c"></a>Add the Azure AD key to Azure AD B2C
...
## <a name="add-a-claims-provider-in-your-base-policy"></a>Add a claims provider in your base policy
...
## <a name="register-the-azure-ad-claims-provider-to-a-user-journey"></a>Register the Azure AD claims provider to a user journey
...
### <a name="update-the-rp-file"></a>Update the RP file
