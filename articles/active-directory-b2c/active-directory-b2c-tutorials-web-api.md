...
---
# <a name="tutorial-grant-access-to-an-aspnet-web-api-from-a-web-app-using-azure-active-directory-b2c"></a>Tutorial: Grant access to an ASP.NET web API from a web app using Azure Active Directory B2C
...
5. Press **F5** to run both applications. Each application opens in its own browser tab. `https://localhost:44316/` is the web app.
