...
---
# <a name="tutorial-grant-access-to-a-nodejs-web-api-from-a-desktop-app-using-azure-active-directory-b2c"></a>Tutorial: Grant access to a Node.js web API from a desktop app using Azure Active Directory B2C
...
## <a name="update-web-api-code"></a>Update web API code
...
### <a name="configure-the-desktop-app"></a>Configure the desktop app
