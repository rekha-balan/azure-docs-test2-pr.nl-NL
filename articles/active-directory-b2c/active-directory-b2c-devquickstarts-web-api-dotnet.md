...
---
# <a name="azure-ad-b2c-call-a-net-web-api-from-a-net-web-app"></a>Azure AD B2C: Call a .NET web API from a .NET web app
...
## <a name="requesting-and-saving-an-access-token"></a>Requesting and saving an access token

### <a name="specify-the-permissions"></a>Specify the permissions
...
### <a name="exchange-the-authorization-code-for-an-access-token"></a>Exchange the authorization code for an access token
...
## <a name="calling-the-web-api"></a>Calling the web API
...
### <a name="retrieve-the-saved-token-in-the-controllers"></a>Retrieve the saved token in the controllers
