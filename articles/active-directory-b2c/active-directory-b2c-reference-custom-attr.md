...
---
# <a name="define-custom-attributes-in-azure-active-directory-b2c"></a>Define custom attributes in Azure Active Directory B2C
...
## <a name="use-a-custom-attribute-in-your-policy"></a>Use a custom attribute in your policy
