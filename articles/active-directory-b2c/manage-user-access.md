...
---
# <a name="manage-user-access-in-azure-active-directory-b2c"></a>Manage user access in Azure Active Directory B2C
...
## <a name="control-minor-access"></a>Control minor access
...
## <a name="get-parental-consent"></a>Get parental consent
...
## <a name="gather-date-of-birth-and-country-data"></a>Gather date of birth and country data
...
## <a name="capture-terms-of-use-agreement"></a>Capture terms of use agreement
