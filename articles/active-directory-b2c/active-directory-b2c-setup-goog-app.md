...
---
# <a name="set-up-sign-up-and-sign-in-with-a-google-account-using-azure-active-directory-b2c"></a>Set up sign-up and sign-in with a Google account using Azure Active Directory B2C
...
## <a name="configure-a-google-account-as-an-identity-provider"></a>Configure a Google account as an identity provider
