...
---
# <a name="azure-active-directory-b2c-add-microsoft-account-msa-as-an-identity-provider-using-custom-policies"></a>Azure Active Directory B2C: Add Microsoft Account (MSA) as an identity provider using custom policies
...
## <a name="add-the-microsoft-account-application-key-to-azure-ad-b2c"></a>Add the Microsoft account application key to Azure AD B2C
...
## <a name="register-the-microsoft-account-claims-provider-to-sign-up-or-sign-in-user-journey"></a>Register the Microsoft Account claims provider to Sign up or Sign-in user journey
...
## <a name="optional-register-the-microsoft-account-claims-provider-to-profile-edit-user-journey"></a>[Optional] Register the Microsoft Account claims provider to Profile-Edit user journey
