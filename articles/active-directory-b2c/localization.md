...
## <a name="set-up-localization"></a>Set up localization
...
### <a name="set-up-the-explicit-list-of-supported-languages"></a>Set up the explicit list of supported languages
...
### <a name="provide-language-specific-strings-and-collections"></a>Provide language-specific strings and collections 
