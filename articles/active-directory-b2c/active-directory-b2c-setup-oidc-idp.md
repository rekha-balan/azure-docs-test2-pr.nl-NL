...
---
# <a name="azure-active-directory-b2c-add-a-custom-openid-connect-identity-provider-in-built-in-policies"></a>Azure Active Directory B2C: Add a custom OpenID Connect identity provider in built-in policies
...
## <a name="configuring-a-custom-openid-connect-identity-provider"></a>Configuring a custom OpenID Connect identity provider
...
### <a name="setting-up-the-openid-connect-identity-provider"></a>Setting up the OpenID Connect identity provider
...
#### <a name="client-id-and-secret"></a>Client ID and secret
...
#### <a name="response-mode"></a>Response mode
...
#### <a name="domain-hint"></a>Domain hint
...
### <a name="mapping-the-claims-from-the-openid-connect-identity-provider"></a>Mapping the claims from the OpenID Connect identity provider
