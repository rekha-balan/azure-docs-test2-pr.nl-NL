...
## <a name="when-password-rules-are-enforced"></a>When password rules are enforced
...
## <a name="how-to-configure-password-complexity"></a>How to configure password complexity
...
### <a name="comparison-chart"></a>Comparison Chart
...
## <a name="options-available-under-custom"></a>Options available under custom

### <a name="character-set"></a>Character Set
