...
---
# <a name="define-an-azure-active-directory-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Define an Azure Active Directory technical profile in an Azure Active Directory B2C custom policy
...
## <a name="requirements-of-an-operation"></a>Requirements of an operation
...
## <a name="azure-ad-technical-provider-operations"></a>Azure AD technical provider operations
