...
---
# <a name="troubleshoot-azure-ad-b2c-custom-policies-and-identity-experience-framework"></a>Troubleshoot Azure AD B2C custom policies and Identity Experience Framework
...
## <a name="xml-editing"></a>XML editing
...
## <a name="upload-policies-and-policy-validation"></a>Upload policies and policy validation
...
## <a name="troubleshoot-the-runtime"></a>Troubleshoot the runtime
...
## <a name="recommended-practices"></a>Recommended practices
