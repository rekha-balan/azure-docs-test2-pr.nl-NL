...
---
# <a name="set-up-sign-up-and-sign-in-with-a-twitter-account-using-azure-active-directory-b2c"></a>Set up sign-up and sign-in with a Twitter account using Azure Active Directory B2C
...
## <a name="configure-twitter-as-an-identity-provider-in-your-tenant"></a>Configure Twitter as an identity provider in your tenant
