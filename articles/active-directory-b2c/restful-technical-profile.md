...
---
# <a name="define-a-restful-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Define a RESTful technical profile in an Azure Active Directory B2C custom policy
...
## <a name="returning-error-message"></a>Returning error message
