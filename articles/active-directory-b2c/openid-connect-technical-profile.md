...
---
# <a name="define-a-openid-connect-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Define a OpenId Connect technical profile in an Azure Active Directory B2C custom policy
