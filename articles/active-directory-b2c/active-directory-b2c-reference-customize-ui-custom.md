...
---
# <a name="customize-the-ui-of-a-user-journey-with-custom-policies"></a>Customize the UI of a user journey with custom policies
...
## <a name="understand-the-cors-way-for-ui-customization"></a>Understand the CORS way for UI customization
...
## <a name="downloading-the-helper-tool"></a>Downloading the helper tool
...
## <a name="upload-the-ui-customization-pack-sample-files"></a>Upload the UI-Customization-Pack sample files
...
3.  When prompted, specify: a.  The name of your storage account, *storageAccountName*, for example *contoso369b2c*.
...
## <a name="ensure-the-storage-account-has-cors-enabled"></a>Ensure the storage account has CORS enabled
...
## <a name="add-a-link-to-your-html5css-templates-to-your-user-journey"></a>Add a link to your HTML5/CSS templates to your user journey
