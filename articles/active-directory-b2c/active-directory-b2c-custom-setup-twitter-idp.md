...
---
# <a name="azure-active-directory-b2c-add-twitter-as-an-oauth1-identity-provider-by-using-custom-policies"></a>Azure Active Directory B2C: Add Twitter as an OAuth1 identity provider by using custom policies
...
## <a name="step-1-create-a-twitter-account-application"></a>Step 1: Create a Twitter account application
...
## <a name="step-2-add-your-twitter-account-application-key-to-azure-ad-b2c"></a>Step 2: Add your Twitter account application key to Azure AD B2C
...
## <a name="step-3-add-a-claims-provider-in-your-extension-policy"></a>Step 3: Add a claims provider in your extension policy
...
## <a name="step-4-register-the-twitter-account-claims-provider-to-your-sign-up-or-sign-in-user-journey"></a>Step 4: Register the Twitter account claims provider to your sign-up or sign-in user journey
...
### <a name="step-41-make-a-copy-of-the-user-journey"></a>Step 4.1: Make a copy of the user journey
...
### <a name="step-42-display-the-button"></a>Step 4.2: Display the "button"
...
### <a name="step-43-link-the-button-to-an-action"></a>Step 4.3: Link the button to an action
...
## <a name="step-7-optional-register-the-twitter-account-claims-provider-to-the-profile-edit-user-journey"></a>Step 7: (Optional) Register the Twitter account claims provider to the profile-edit user journey
