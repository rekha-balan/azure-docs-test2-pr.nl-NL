...
---
# <a name="language-customization-in-azure-active-directory-b2c"></a>Language customization in Azure Active Directory B2C
...
## <a name="how-language-customization-works"></a>How language customization works
...
## <a name="support-requested-languages-for-uilocales"></a>Support requested languages for ui_locales 
...
## <a name="select-which-languages-in-your-user-journey-are-enabled"></a>Select which languages in your user journey are enabled 
...
## <a name="customize-your-strings"></a>Customize your strings
...
### <a name="change-any-string-on-the-page"></a>Change any string on the page
...
### <a name="change-extension-attributes"></a>Change extension attributes
...
### <a name="provide-a-list-of-values-by-using-localizedcollections"></a>Provide a list of values by using LocalizedCollections
...
### <a name="upload-your-changes"></a>Upload your changes
...
## <a name="customize-the-page-ui-by-using-language-customization"></a>Customize the page UI by using language customization
...
## <a name="add-custom-languages"></a>Add custom languages
...
### <a name="page-ui-customization-labels-as-overrides"></a>Page UI customization labels as overrides
...
### <a name="up-to-date-translations"></a>Up-to-date translations
...
### <a name="support-for-right-to-left-languages"></a>Support for right-to-left languages
...
### <a name="social-identity-provider-translations"></a>Social identity provider translations
...
### <a name="browser-behavior"></a>Browser behavior
