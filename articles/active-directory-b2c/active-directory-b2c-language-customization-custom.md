...
---
# <a name="language-customization-in-custom-policies"></a>Language customization in custom policies
...
## <a name="enable-supported-languages"></a>Enable supported languages
...
## <a name="enable-custom-language-strings"></a>Enable custom language strings
...
### <a name="edit-the-contentdefinition-for-the-page"></a>Edit the ContentDefinition for the page
...
### <a name="create-the-localizedresources"></a>Create the LocalizedResources
