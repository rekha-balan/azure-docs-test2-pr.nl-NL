...
---
# <a name="define-a-saml-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Define a SAML technical profile in an Azure Active Directory B2C custom policy
...
## <a name="digital-signing-certificates-exchange"></a>Digital signing certificates exchange
...
## <a name="digital-encryption"></a>Digital encryption
...
## <a name="identity-provider-initiated-flow"></a>Identity provider initiated flow
