...
---
# <a name="overview-of-user-accounts-in-azure-active-directory-b2c"></a>Overview of user accounts in Azure Active Directory B2C
...
## <a name="work-account"></a>Work account
...
### <a name="create-a-work-account"></a>Create a work account
...
### <a name="update-a-user-profile"></a>Update a user profile
...
### <a name="reset-a-password-for-a-user"></a>Reset a password for a user
...
## <a name="consumer-user"></a>Consumer user
...
### <a name="migrate-consumer-user-accounts"></a>Migrate consumer user accounts
