...
---
# <a name="azure-active-directory-b2c-manage-sso-and-token-customization-with-custom-policies"></a>Azure Active Directory B2C: Manage SSO and token customization with custom policies
...
## <a name="token-lifetimes-and-claims-configuration"></a>Token lifetimes and claims configuration
...
## <a name="session-behavior-and-sso"></a>Session behavior and SSO
