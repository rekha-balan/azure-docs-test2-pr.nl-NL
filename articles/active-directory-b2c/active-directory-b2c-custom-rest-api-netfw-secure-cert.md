...
---
# <a name="secure-your-restful-service-by-using-client-certificates"></a>Secure your RESTful service by using client certificates
...
## <a name="step-1-configure-a-web-app-for-client-certificate-authentication"></a>Step 1: Configure a web app for client certificate authentication
...
## <a name="step-2-upload-your-certificate-to-azure-ad-b2c-policy-keys"></a>Step 2: Upload your certificate to Azure AD B2C policy keys
...
## <a name="step-3-change-the-technical-profile"></a>Step 3: Change the technical profile
...
## <a name="step-4-upload-the-policy-to-your-tenant"></a>Step 4: Upload the policy to your tenant
...
## <a name="step-5-test-the-custom-policy-by-using-run-now"></a>Step 5: Test the custom policy by using Run Now
...
## <a name="step-6-add-certificate-validation"></a>Step 6: Add certificate validation
...
### <a name="61-add-application-settings-to-your-projects-webconfig-file"></a>6.1 Add application settings to your project's web.config file
...
### <a name="62-add-the-isvalidclientcertificate-function"></a>6.2 Add the IsValidClientCertificate function
...
### <a name="63-call-the-isvalidclientcertificate-function"></a>6.3 Call the IsValidClientCertificate function
...
## <a name="step-7-publish-your-project-to-azure-and-test-it"></a>Step 7: Publish your project to Azure and test it
