...
---
# <a name="tutorial-grant-access-to-an-aspnet-core-web-api-from-a-single-page-app-using-azure-active-directory-b2c"></a>Tutorial: Grant access to an ASP.NET Core web API from a single-page app using Azure Active Directory B2C
...
## <a name="register-web-api"></a>Register web API
...
## <a name="define-and-configure-scopes"></a>Define and configure scopes
...
### <a name="define-scopes-for-the-web-api"></a>Define scopes for the web API
...
### <a name="grant-app-permissions-to-web-api"></a>Grant app permissions to web API
...
## <a name="update-code"></a>Update code
...
### <a name="configure-the-web-api"></a>Configure the web API
...
#### <a name="enable-cors"></a>Enable CORS
...
### <a name="configure-the-single-page-app"></a>Configure the single page app
...
## <a name="run-the-spa-app-and-web-api"></a>Run the SPA app and web API
...
### <a name="run-the-single-page-app"></a>Run the single page app
