...
---
# <a name="accessing-usage-reports-in-azure-ad-b2c-via-the-reporting-api"></a>Accessing usage reports in Azure AD B2C via the reporting API
...
## <a name="usage-report-definitions"></a>Usage report definitions
...
### <a name="estimating-your-azure-ad-monthly-bill"></a>Estimating your Azure AD monthly bill.
...
### <a name="options-for-other-output-formats"></a>Options for other output formats
```
