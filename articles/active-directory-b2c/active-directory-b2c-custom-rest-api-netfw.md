...
---
# <a name="integrate-rest-api-claims-exchanges-in-your-azure-ad-b2c-user-journey-as-validation-of-user-input"></a>Integrate REST API claims exchanges in your Azure AD B2C user journey as validation of user input
...
## <a name="restful-walkthrough"></a>RESTful walkthrough
...
## <a name="step-1-create-an-aspnet-web-api"></a>Step 1: Create an ASP.NET web API
...
## <a name="step-2-prepare-the-rest-api-endpoint"></a>Step 2: Prepare the REST API endpoint

### <a name="step-21-add-data-models"></a>Step 2.1: Add data models
...
### <a name="step-22-add-a-controller"></a>Step 2.2: Add a controller
...
## <a name="step-3-publish-the-project-to-azure"></a>Step 3: Publish the project to Azure
...
## <a name="step-4-add-the-new-loyaltynumber-claim-to-the-schema-of-your-trustframeworkextensionsxml-file"></a>Step 4: Add the new `loyaltyNumber` claim to the schema of your TrustFrameworkExtensions.xml file
...
## <a name="step-5-add-a-claims-provider"></a>Step 5: Add a claims provider 
...
## <a name="step-6-add-the-loyaltynumber-claim-to-your-relying-party-policy-file-so-the-claim-is-sent-to-your-application"></a>Step 6: Add the `loyaltyNumber` claim to your relying party policy file so the claim is sent to your application
...
## <a name="step-7-upload-the-policy-to-your-tenant"></a>Step 7: Upload the policy to your tenant
...
## <a name="step-8-test-the-custom-policy-by-using-run-now"></a>Step 8: Test the custom policy by using Run Now
