...
---
# <a name="azure-ad-b2c-sign-in-using-an-android-application"></a>Azure AD B2C: Sign-in using an Android application
...
In Azure AD B2C, every user experience is defined by a [policy](active-directory-b2c-reference-policies.md). This app contains one identity experience: a combined sign-in and sign-up. You need to create this policy, as described in the [policy reference article](active-directory-b2c-reference-policies.md#create-a-sign-up-policy). When you create the policy, be sure to:
...
## <a name="download-the-sample-code"></a>Download the sample code
...
## <a name="modifying-your-app-to-use-azure-ad-b2c-with-appauth"></a>Modifying your app to use Azure AD B2C with AppAuth
...
### <a name="authorizing"></a>Authorizing
