...
---
# <a name="azure-active-directory-b2c-migrate-users-with-social-identities"></a>Azure Active Directory B2C: Migrate users with social identities
...
## <a name="social-identities-migration-introduction"></a>Social identities migration introduction
...
## <a name="migrate-social-account-only"></a>Migrate social account (only)
...
```
## <a name="migrate-social-account-with-local-account"></a>Migrate social account with local account
...
### <a name="how-can-i-know-the-issuer-name"></a>How can I know the issuer name?
...
### <a name="is-it-possible-to-add-social-identity-to-an-existing-local-account"></a>Is it possible to add social identity to an existing local account?
...
### <a name="is-it-possible-to-add-multiple-social-identities"></a>Is it possible to add multiple social identities?
...
## <a name="optional-user-migration-application-sample"></a>[Optional] User migration application sample
