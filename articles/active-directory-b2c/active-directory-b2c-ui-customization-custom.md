...
---
# <a name="azure-active-directory-b2c-configure-ui-customization-in-a-custom-policy"></a>Azure Active Directory B2C: Configure UI customization in a custom policy
...
## <a name="page-ui-customization"></a>Page UI customization
...
## <a name="create-your-html5-content"></a>Create your HTML5 content
...
## <a name="modify-your-sign-up-or-sign-in-custom-policy"></a>Modify your sign-up or sign-in custom policy
...
## <a name="upload-your-updated-custom-policy"></a>Upload your updated custom policy
