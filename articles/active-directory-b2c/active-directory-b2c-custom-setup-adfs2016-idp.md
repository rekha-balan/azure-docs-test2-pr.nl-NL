...
---
# <a name="add-adfs-as-a-saml-identity-provider-using-custom-policies-in-azure-active-directory-b2c"></a>Add ADFS as a SAML identity provider using custom policies in Azure Active Directory B2C
...
## <a name="add-the-adfs-account-application-key-to-azure-ad-b2c"></a>Add the ADFS account application key to Azure AD B2C
...
## <a name="register-the-claims-provider-for-sign-up-and-sign-in"></a>Register the claims provider for sign-up and sign-in
...
## <a name="optional-register-the-claims-provider-for-profile-edit"></a>[Optional] Register the claims provider for profile edit
...
## <a name="configure-an-adfs-relying-party-trust"></a>Configure an ADFS Relying Party Trust
...
### <a name="update-the-relying-party-metadata"></a>Update the relying party metadata
...
### <a name="test-the-policy-by-using-run-now"></a>Test the policy by using Run Now
