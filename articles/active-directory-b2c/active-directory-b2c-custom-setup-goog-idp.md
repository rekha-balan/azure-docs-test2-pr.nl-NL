...
---
# <a name="azure-active-directory-b2c-add-google-as-an-oauth2-identity-provider-using-custom-policies"></a>Azure Active Directory B2C: Add Google+ as an OAuth2 identity provider using custom policies
...
## <a name="create-a-google-account-application"></a>Create a Google+ account application
...
## <a name="add-the-google-account-application-key-to-azure-ad-b2c"></a>Add the Google+ account application key to Azure AD B2C
...
## <a name="add-a-claims-provider-in-your-extension-policy"></a>Add a claims provider in your extension policy
...
## <a name="register-the-google-account-claims-provider-to-sign-up-or-sign-in-user-journey"></a>Register the Google+ account claims provider to Sign up or Sign in user journey
...
### <a name="display-the-button"></a>Display the button
...
### <a name="link-the-button-to-an-action"></a>Link the button to an action
...
## <a name="upload-the-policy-to-your-tenant"></a>Upload the policy to your tenant
...
## <a name="test-the-custom-policy-by-using-run-now"></a>Test the custom policy by using Run Now
...
## <a name="optional-register-the-google-account-claims-provider-to-profile-edit-user-journey"></a>[Optional] Register the Google+ account claims provider to Profile-Edit user journey
...
### <a name="test-the-custom-profile-edit-policy-by-using-run-now"></a>Test the custom Profile-Edit policy by using Run Now

1.  Open **Azure AD B2C Settings** and go to **Identity Experience Framework**.
2.  Open **B2C_1A_ProfileEdit**, the relying party (RP) custom policy that you uploaded. Select **Run now**.
3.  You should be able to sign in using Google+ account.

## <a name="download-the-complete-policy-files"></a>Download the complete policy files
