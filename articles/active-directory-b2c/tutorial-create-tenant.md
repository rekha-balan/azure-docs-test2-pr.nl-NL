...
---
# <a name="tutorial-create-an-azure-active-directory-b2c-tenant"></a>Tutorial: Create an Azure Active Directory B2C tenant
...
## <a name="link-your-tenant-to-your-subscription"></a>Link your tenant to your subscription
