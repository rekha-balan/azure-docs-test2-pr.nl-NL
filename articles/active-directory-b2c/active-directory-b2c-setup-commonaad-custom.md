...
---
# <a name="azure-active-directory-b2c-allow-users-to-sign-in-to-a-multi-tenant-azure-ad-identity-provider-using-custom-policies"></a>Azure Active Directory B2C: Allow users to sign in to a multi-tenant Azure AD identity provider using custom policies
...
## <a name="step-1-create-a-multi-tenant-azure-ad-app"></a>Step 1. Create a multi-tenant Azure AD app
...
## <a name="step-2-add-the-azure-ad-key-to-azure-ad-b2c"></a>Step 2. Add the Azure AD key to Azure AD B2C
...
## <a name="step-3-add-a-claims-provider-in-your-base-policy"></a>Step 3. Add a claims provider in your base policy
...
### <a name="step-31-restrict-access-to-a-specific-list-of-azure-ad-tenants"></a>Step 3.1 Restrict access to a specific list of Azure AD tenants
...
## <a name="step-4-register-the-azure-ad-account-claims-provider"></a>Step 4. Register the Azure AD account claims provider
...
## <a name="step-5-create-a-new-rp-policy"></a>Step 5: Create a new RP policy
...
## <a name="optional-step-8-register-the-azure-ad-account-claims-provider-to-the-profile-edit-user-journey"></a>(Optional) Step 8: Register the Azure AD account claims provider to the Profile-Edit user journey
