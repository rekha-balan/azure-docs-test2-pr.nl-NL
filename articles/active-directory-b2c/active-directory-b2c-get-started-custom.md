...
---
# <a name="azure-active-directory-b2c-get-started-with-custom-policies"></a>Azure Active Directory B2C: Get started with custom policies
...
## <a name="register-identity-experience-framework-applications"></a>Register Identity Experience Framework applications
...
### <a name="create-the-identityexperienceframework-application"></a>Create the IdentityExperienceFramework application
...
### <a name="create-the-proxyidentityexperienceframework-application"></a>Create the ProxyIdentityExperienceFramework application
...
## <a name="download-starter-pack-and-modify-policies"></a>Download starter pack and modify policies
...
## <a name="upload-the-policies-to-your-tenant"></a>Upload the policies to your tenant
...
### <a name="add-facebook-as-an-identity-provider"></a>Add Facebook as an identity provider
To set up Facebook:
...
### <a name="add-azure-active-directory-as-an-identity-provider"></a>Add Azure Active Directory as an identity provider
