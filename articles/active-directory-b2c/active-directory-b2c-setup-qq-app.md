...
---
# <a name="set-up-sign-up-and-sign-in-with-a-qq-account-using-azure-active-directory-b2c"></a>Set up sign-up and sign-in with a QQ account using Azure Active Directory B2C
...
## <a name="configure-qq-as-an-identity-provider"></a>Configure QQ as an identity provider
