...
---
# <a name="azure-active-directory-b2c-add-linkedin-as-an-identity-provider-by-using-custom-policies"></a>Azure Active Directory B2C: Add LinkedIn as an identity provider by using custom policies
...
## <a name="step-1-create-a-linkedin-account-application"></a>Step 1: Create a LinkedIn account application
...
## <a name="step-2-add-your-linkedin-application-key-to-azure-ad-b2c"></a>Step 2: Add your LinkedIn application key to Azure AD B2C
...
## <a name="step-4-register-the-linkedin-account-claims-provider"></a>Step 4: Register the LinkedIn account claims provider
...
## <a name="step-7-optional-register-the-linkedin-account-claims-provider-to-the-profile-edit-user-journey"></a>Step 7: (Optional) Register the LinkedIn account claims provider to the Profile-Edit user journey
