...
---
# <a name="azure-active-directory-b2c-use-custom-attributes-in-a-custom-profile-edit-policy"></a>Azure Active Directory B2C: Use custom attributes in a custom profile edit policy
...
## <a name="use-custom-attributes-to-collect-information-about-your-customers-in-azure-ad-b2c-by-using-custom-policies"></a>Use custom attributes to collect information about your customers in Azure AD B2C by using custom policies
...
## <a name="create-a-new-application-to-store-the-extension-properties"></a>Create a new application to store the extension properties
...
## <a name="modify-your-custom-policy-to-add-the-applicationobjectid"></a>Modify your custom policy to add the **ApplicationObjectId**
...
## <a name="use-the-new-extension-property-or-custom-attribute-in-a-user-journey"></a>Use the new extension property or custom attribute in a user journey
...
## <a name="test-the-custom-policy"></a>Test the custom policy
