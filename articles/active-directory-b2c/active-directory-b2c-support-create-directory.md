...
---
# <a name="troubleshoot-creating-an-azure-active-directory-or-azure-active-directory-b2c-tenant"></a>Troubleshoot creating an Azure Active Directory or Azure Active Directory B2C tenant 

## <a name="create-an-azure-ad-tenant"></a>Create an Azure AD tenant
...
## <a name="create-an-azure-ad-b2c-tenant"></a>Create an Azure AD B2C tenant
