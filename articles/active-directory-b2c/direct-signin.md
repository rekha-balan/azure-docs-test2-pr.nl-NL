...
---
# <a name="set-up-direct-sign-in-using-azure-active-directory-b2c"></a>Set up direct sign-in using Azure Active Directory B2C
...
## <a name="prepopulate-the-sign-in-name"></a>Prepopulate the sign-in name
...
## <a name="redirect-sign-in-to-a-social-provider"></a>Redirect sign-in to a social provider
