...
---
# <a name="azure-active-directory-b2c-provide-sign-up-and-sign-in-to-consumers-with-weibo-accounts"></a>Azure Active Directory B2C: Provide sign-up and sign-in to consumers with Weibo accounts

> [!NOTE]
> This feature is in preview. Do not use this identity provider in your production environment.
> 

## <a name="create-a-weibo-application"></a>Create a Weibo application
...
### <a name="register-for-the-weibo-developer-program"></a>Register for the Weibo developer program
...
### <a name="register-a-weibo-application"></a>Register a Weibo application
...
## <a name="configure-weibo-as-an-identity-provider-in-your-tenant"></a>Configure Weibo as an identity provider in your tenant
