...
---
# <a name="set-up-sign-up-and-sign-in-with-a-weibo-account-using-azure-active-directory-b2c"></a>Set up sign-up and sign-in with a Weibo account using Azure Active Directory B2C
...
## <a name="configure-a-weibo-account-as-an-identity-provider"></a>Configure a Weibo account as an identity provider
