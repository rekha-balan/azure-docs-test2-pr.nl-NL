...
---
# <a name="tutorial-enable-desktop-app-authentication-with-accounts-using-azure-active-directory-b2c"></a>Tutorial: Enable desktop app authentication with accounts using Azure Active Directory B2C
...
## <a name="register-desktop-app"></a>Register desktop app
...
## <a name="update-desktop-app-code"></a>Update desktop app code
...
## <a name="run-the-sample-desktop-application"></a>Run the sample desktop application
...
### <a name="sign-up-using-an-email-address"></a>Sign up using an email address
