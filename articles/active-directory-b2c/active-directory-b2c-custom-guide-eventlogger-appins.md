...
---
# <a name="track-user-behavior-in-azure-ad-b2c-journeys-by-using-application-insights"></a>Track user behavior in Azure AD B2C journeys by using Application Insights
...
## <a name="step-1-create-an-application-insights-resource-and-get-the-instrumentation-key"></a>Step 1. Create an Application Insights resource and get the instrumentation key
...
## <a name="step-2-add-new-claimtype-definitions-to-your-trust-framework-extension-file"></a>Step 2. Add new ClaimType definitions to your trust framework extension file
...
## <a name="step-3-add-new-technical-profiles-that-use-the-application-insights-provider"></a>Step 3. Add new technical profiles that use the Application Insights provider
...
## <a name="step-4-add-the-technical-profiles-for-application-insights-as-orchestration-steps-in-an-existing-user-journey"></a>Step 4. Add the technical profiles for Application Insights as orchestration steps in an existing user journey
...
## <a name="step-5-upload-your-modified-extensions-file-run-the-policy-and-view-events-in-application-insights"></a>Step 5. Upload your modified extensions file, run the policy, and view events in Application Insights
...
### <a name="culture-specific-claims"></a>Culture-specific claims
...
### <a name="policy-specific-claims"></a>Policy-specific claims
...
### <a name="openid-connect-specific-claims"></a>OpenID Connect-specific claims
...
### <a name="non-protocol-parameters-included-with-oidc--oauth2-requests"></a>Non-protocol parameters included with OIDC & OAuth2 requests
...
### <a name="other-system-claims"></a>Other system claims
