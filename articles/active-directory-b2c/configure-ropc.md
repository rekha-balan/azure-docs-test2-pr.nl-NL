...
---
# <a name="configure-the-resource-owner-password-credentials-flow-in-azure-ad-b2c"></a>Configure the resource owner password credentials flow in Azure AD B2C
...
##  <a name="create-a-resource-owner-policy"></a>Create a resource owner policy
...
## <a name="test-the-policy"></a>Test the policy
...
## <a name="redeem-a-refresh-token"></a>Redeem a refresh token
...
## <a name="implement-with-your-preferred-native-sdk-or-use-app-auth"></a>Implement with your preferred native SDK or use App-Auth
