...
---
# <a name="azure-ad-b2c-single-page-app-sign-in-by-using-oauth-20-implicit-flow"></a>Azure AD B2C: Single-page app sign-in by using OAuth 2.0 implicit flow
...
## <a name="use-your-own-azure-ad-b2c-tenant"></a>Use your own Azure AD B2C tenant
