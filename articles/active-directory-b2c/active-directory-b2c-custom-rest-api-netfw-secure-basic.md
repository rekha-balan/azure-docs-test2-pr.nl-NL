...
---
# <a name="secure-your-restful-services-by-using-http-basic-authentication"></a>Secure your RESTful services by using HTTP basic authentication
...
## <a name="step-1-add-authentication-support"></a>Step 1: Add authentication support

### <a name="step-11-add-application-settings-to-your-projects-webconfig-file"></a>Step 1.1: Add application settings to your project's web.config file
...
### <a name="step-12-install-owin-libraries"></a>Step 1.2: Install OWIN libraries
...
### <a name="step-13-add-an-authentication-middleware-class"></a>Step 1.3: Add an authentication middleware class
...
### <a name="step-14-add-an-owin-startup-class"></a>Step 1.4: Add an OWIN startup class
...
### <a name="step-15-protect-the-identity-api-class"></a>Step 1.5: Protect the Identity API class
...
## <a name="step-2-publish-to-azure"></a>Step 2: Publish to Azure
To publish your project, in Solution Explorer, right-click the **Contoso.AADB2C.API** project, and then select **Publish**.

## <a name="step-3-add-the-restful-services-app-id-and-app-secret-to-azure-ad-b2c"></a>Step 3: Add the RESTful services app ID and app secret to Azure AD B2C
...
### <a name="step-31-add-a-restful-services-client-id"></a>Step 3.1: Add a RESTful services client ID
...
### <a name="step-32-add-a-restful-services-client-secret"></a>Step 3.2: Add a RESTful services client secret
1. In your Azure AD B2C tenant, select **B2C Settings** > **Identity Experience Framework**.
...
## <a name="step-4-change-the-technical-profile-to-support-basic-authentication-in-your-extension-policy"></a>Step 4: Change the technical profile to support basic authentication in your extension policy
...
## <a name="step-5-upload-the-policy-to-your-tenant"></a>Step 5: Upload the policy to your tenant
...
## <a name="step-6-test-the-custom-policy-by-using-run-now"></a>Step 6: Test the custom policy by using Run Now
