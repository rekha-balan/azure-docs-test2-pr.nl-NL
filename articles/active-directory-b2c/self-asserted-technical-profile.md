...
---
# <a name="define-a-self-asserted-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Define a self-asserted technical profile in an Azure Active Directory B2C custom policy
...
## <a name="persist-claims"></a>Persist claims
...
## <a name="validation-technical-profiles"></a>Validation technical profiles
