...
---
# <a name="azure-active-directory-b2c-user-migration"></a>Azure Active Directory B2C: User migration
...
### <a name="step-12-create-the-application-secret"></a>Step 1.2: Create the application secret
...
### <a name="step-13-grant-administrative-permission-to-your-application"></a>Step 1.3: Grant administrative permission to your application
