...
---
# <a name="tutorial-enable-single-page-app-authentication-with-accounts-using-azure-active-directory-b2c"></a>Tutorial: Enable single-page app authentication with accounts using Azure Active Directory B2C
...
## <a name="register-single-page-app"></a>Register single page app
...
## <a name="update-single-page-app-code"></a>Update single page app code
