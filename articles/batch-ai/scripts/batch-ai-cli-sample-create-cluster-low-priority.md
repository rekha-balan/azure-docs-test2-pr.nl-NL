...
---
# <a name="cli-example-create-and-manage-a-batch-ai-cluster-of-low-priority-nodes"></a>CLI example: Create and manage a Batch AI cluster of low-priority nodes

This script demonstrates some of the commands available in the Azure CLI to create and manage a Batch AI cluster consisting of low-priority nodes (virtual machines).
