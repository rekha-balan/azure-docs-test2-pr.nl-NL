...
---
# <a name="cli-example-create-a-batch-ai-cluster-using-a-cluster-configuration-file"></a>CLI example: Create a Batch AI cluster using a cluster configuration file
