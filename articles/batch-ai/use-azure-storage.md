...
---
# <a name="store-batch-ai-job-input-and-output-with-azure-storage"></a>Store Batch AI job input and output with Azure Storage
...
## <a name="introduction-to-azure-storage"></a>Introduction to Azure Storage
...
## <a name="store-datasets-and-input-scripts-in-azure-storage"></a>Store datasets and input scripts in Azure Storage
...
### <a name="auto-storage-with-batch-ai"></a>Auto-storage with Batch AI
...
## <a name="mount-azure-storage"></a>Mount Azure Storage 

### <a name="mount-volumes-to-a-job"></a>Mount volumes to a job
...
### <a name="mount-volumes-to-a-cluster"></a>Mount volumes to a cluster
...
## <a name="access-mounted-filesystem-in-a-job"></a>Access mounted filesystem in a job

### <a name="azbatchaijobmountroot-environment-variable"></a>$AZ_BATCHAI_JOB_MOUNT_ROOT environment variable
...
### <a name="abbreviate-input-paths"></a>Abbreviate input paths
...
### <a name="abbreviate-output-paths"></a>Abbreviate output paths
...
## <a name="retrieve-job-output-from-azure-storage"></a>Retrieve job output from Azure Storage
...
### <a name="access-stdout-and-stderr-output"></a>Access Stdout and Stderr output
...
### <a name="list-the-output-files"></a>List the output files
...
### <a name="stream-output-files"></a>Stream output files
