...
---
# <a name="quickstart-create-a-cluster-for-batch-ai-training-jobs-using-the-azure-cli"></a>Quickstart: Create a cluster for Batch AI training jobs using the Azure CLI
