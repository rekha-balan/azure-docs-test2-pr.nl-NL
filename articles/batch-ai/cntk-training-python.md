...
---
# <a name="run-a-cntk-training-job-using-the-azure-python-sdk"></a>Run a CNTK training job using the Azure Python SDK
...
## <a name="configure-credentials"></a>Configure credentials
...
## <a name="create-batch-ai-client"></a>Create Batch AI client
...
## <a name="prepare-azure-file-share"></a>Prepare Azure file share
...
## <a name="create-batch-ai-workspace"></a>Create Batch AI workspace
...
## <a name="create-gpu-cluster"></a>Create GPU cluster
...
## <a name="get-cluster-status"></a>Get cluster status
...
## <a name="create-experiment-and-training-job"></a>Create experiment and training job
...
## <a name="monitor-job"></a>Monitor job
...
## <a name="list-stdout-and-stderr-output"></a>List stdout and stderr output
...
## <a name="list-generated-model-files"></a>List generated model files
...
## <a name="delete-resources"></a>Delete resources
