...
---
# <a name="work-with-batch-ai-clusters"></a>Work with Batch AI clusters 
...
## <a name="introduction-to-clusters"></a>Introduction to clusters
...
## <a name="cluster-configuration-options"></a>Cluster configuration options
...
## <a name="monitor-the-cluster"></a>Monitor the cluster
...
### <a name="list-all-clusters"></a>List all clusters
...
### <a name="show-information-about-a-cluster"></a>Show information about a cluster
...
### <a name="list-cluster-nodes"></a>List cluster nodes
...
## <a name="submit-jobs-to-the-cluster"></a>Submit jobs to the cluster
...
## <a name="downscale-cluster-for-later-use"></a>Downscale cluster for later use
...
## <a name="delete-a-cluster"></a>Delete a cluster
