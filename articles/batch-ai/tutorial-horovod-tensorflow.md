...
---
# <a name="tutorial-train-a-distributed-model-with-horovod"></a>Tutorial: Train a distributed model with Horovod
...
## <a name="why-use-horovod"></a>Why use Horovod?
...
## <a name="prepare-the-batch-ai-environment"></a>Prepare the Batch AI environment
...
## <a name="set-up-a-gpu-cluster"></a>Set up a GPU cluster
...
## <a name="set-up-storage"></a>Set up storage
...
## <a name="create-the-training-script"></a>Create the training script
...
## <a name="upload-the-training-script"></a>Upload the training script
...
## <a name="submit-the-training-job"></a>Submit the training job
...
### <a name="visualize-the-distributed-training"></a>Visualize the distributed training
...
## <a name="monitor-the-job"></a>Monitor the job

### <a name="list-output-files"></a>List output files
...
### <a name="stream-an-output-file"></a>Stream an output file
...
## <a name="retrieve-the-results"></a>Retrieve the results
