...
---
# <a name="quickstart-train-a-deep-learning-model-with-batch-ai"></a>Quickstart: Train a deep learning model with Batch AI
...
## <a name="upload-training-script"></a>Upload training script
...
## <a name="submit-training-job"></a>Submit training job
...
## <a name="get-job-output"></a>Get job output
