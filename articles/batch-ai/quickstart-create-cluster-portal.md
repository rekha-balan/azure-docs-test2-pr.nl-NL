...
---
# <a name="quickstart-create-a-cluster-for-batch-ai-training-jobs-using-the-azure-portal"></a>Quickstart: Create a cluster for Batch AI training jobs using the Azure portal
...
## <a name="create-ssh-key-pair"></a>Create SSH key pair
...
## <a name="create-a-batch-ai-workspace"></a>Create a Batch AI workspace
...
## <a name="create-a-file-server"></a>Create a file server
...
### <a name="resize-the-cluster"></a>Resize the cluster
