...
---
# <a name="develop-with-storage-api-on-azure-government"></a>Develop with Storage API on Azure Government
...
## <a name="connecting-storage-explorer-to-azure-government"></a>Connecting Storage Explorer to Azure Government
...
### <a name="getting-started-with-storage-explorer"></a>Getting Started with Storage Explorer
...
## <a name="connecting-to-the-storage-api"></a>Connecting to the Storage API 
...
### <a name="getting-started-with-storage-api"></a>Getting Started with Storage API
