...
---
# <a name="tutorial-create-virtual-machines"></a>Tutorial: Create Virtual Machines 
...
## <a name="sign-in-to-azure-government"></a>Sign in to Azure Government 
...
## <a name="create-a-new-virtual-network"></a>Create a new Virtual Network
...
## <a name="create-a-new-virtual-machine"></a>Create a new Virtual Machine
