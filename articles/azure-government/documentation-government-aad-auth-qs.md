...
---
# <a name="integrate-azure-ad-authentication-with-web-apps-on-azure-government"></a>Integrate Azure AD Authentication with Web Apps on Azure Government
...
## <a name="integrate-azure-ad-login-into-a-web-application-using-openid-connect"></a>Integrate Azure AD login into a web application using OpenID Connect
...
### <a name="step-1-register-your-web-application-with-your-azure-ad-tenant"></a>Step 1: Register your web application with your Azure AD Tenant 
...
### <a name="step-2--configure-your-app-to-use-your-azure-ad-tenant"></a>Step 2:  Configure your app to use your Azure AD tenant
#### <a name="azure-government-variations"></a>Azure Government Variations
...
#### <a name="configure-the-inventoryapp-project"></a>Configure the InventoryApp project
