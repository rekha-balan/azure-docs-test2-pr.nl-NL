...
---
# <a name="cognitive-services-on-azure-government--computer-vision-face-translator-text-apis"></a>Cognitive Services on Azure Government – Computer Vision, Face, Translator Text APIs
...
## <a name="part-1-provision-cognitive-services-accounts"></a>Part 1: Provision Cognitive Services Accounts
...
### <a name="retrieve-account-key"></a>Retrieve Account Key
...
## <a name="part-2-api-quickstarts"></a>Part 2: API Quickstarts 
...
### <a name="text-translation-method"></a>Text Translation Method
...
### <a name="text-translation-c-example-request"></a>Text Translation C# example request
