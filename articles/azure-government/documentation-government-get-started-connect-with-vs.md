...
---
# <a name="develop-with-visual-studio"></a>Develop with Visual Studio
...
### <a name="automatically-configuring-your-target-using-a-visual-studio-extension"></a>Automatically configuring your target using a Visual Studio Extension 
...
### <a name="manually-configuring-your-target"></a>Manually configuring your target 

>[!NOTE] 
>If you have successfully completed the extension installation above, you do not need to complete this section.
>

#### <a name="manually-creating-a-configuration-file-for-azure-government"></a>Manually creating a configuration file for Azure Government 
...
#### <a name="manually-updating-visual-studio-for-azure-government"></a>Manually updating Visual Studio for Azure Government
...
#### <a name="manually-reverting-visual-studio-connection-to-azure-government"></a>Manually reverting Visual Studio Connection to Azure Government
...
### <a name="updating-visual-studio-for-azure-government"></a>Updating Visual Studio for Azure Government
...
### <a name="reverting-visual-studio-connection-to-azure-government"></a>Reverting Visual Studio Connection to Azure Government
