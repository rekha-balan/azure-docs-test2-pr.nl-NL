...
### <a name="storage-pairing-in-azure-government"></a>Storage pairing in Azure Government
...
### <a name="checking-the-secondary-region-for-a-storage-account"></a>Checking the secondary region for a storage account
...
### <a name="storage-service-and-feature-availability-by-azure-government-region"></a>Storage service and feature availability by Azure Government region
