...
---
# <a name="planning-identity-for-azure-government-applications"></a>Planning identity for Azure Government applications
...
## <a name="identity-models"></a>Identity models
...
## <a name="selecting-identity-for-an-azure-government-application"></a>Selecting identity for an Azure Government application
...
### <a name="applications-using-modern-authentication-in-azure-government"></a>Applications using modern authentication in Azure Government
...
#### <a name="choosing-your-identity-authority"></a>Choosing your identity authority
...
### <a name="applications-using-legacy-authentication-protocols-kerberosntlm"></a>Applications using legacy authentication protocols (Kerberos/NTLM)
...
## <a name="identity-scenarios-for-subscription-administration-in-azure-government"></a>Identity scenarios for subscription administration in Azure Government
...
### <a name="using-cloud-identities-for-multi-cloud-subscription-administration"></a>Using cloud identities for multi-cloud subscription administration
...
### <a name="using-hybrid-and-cloud-identities-for-multi-cloud-subscription-administration"></a>Using hybrid and cloud identities for multi-cloud subscription administration
...
### <a name="using-hybrid-identities-for-multi-cloud-subscription-administration"></a>Using hybrid identities for multi-cloud subscription administration
