...
### <a name="why-do-i-get-a-parent-resource-not-found-error-when-provisioning-a-vm-from-powershell"></a>Why do I get a "Parent resource not found" error when provisioning a VM from PowerShell?
