...
---
# <a name="frequently-asked-questions-for-application-gateway"></a>Frequently asked questions for Application Gateway
...
## <a name="web-application-firewall-waf-configuration"></a>Web Application Firewall (WAF) Configuration
...
## <a name="diagnostics-and-logging"></a>Diagnostics and Logging
