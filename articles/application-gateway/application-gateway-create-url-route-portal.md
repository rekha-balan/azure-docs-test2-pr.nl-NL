...
---
# <a name="create-an-application-gateway-with-path-based-routing-rules-using-the-azure-portal"></a>Create an application gateway with path-based routing rules using the Azure portal
...
## <a name="create-backend-pools-with-the-virtual-machines"></a>Create backend pools with the virtual machines
...
## <a name="create-a-backend-listener"></a>Create a backend listener
...
## <a name="create-a-path-based-routing-rule"></a>Create a path-based routing rule
