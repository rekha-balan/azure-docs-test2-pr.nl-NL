...
---
# <a name="create-an-application-gateway-with-http-to-https-redirection-using-the-azure-cli"></a>Create an application gateway with HTTP to HTTPS redirection using the Azure CLI
