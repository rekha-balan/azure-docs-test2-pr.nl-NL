...
---
# <a name="what-is-azure-application-gateway"></a>What is Azure Application Gateway?
...
## <a name="secure-sockets-layer-ssl-termination"></a>Secure Sockets Layer (SSL) termination
...
## <a name="url-based-routing"></a>URL-based routing
...
## <a name="multiple-site-hosting"></a>Multiple-site hosting
...
## <a name="websocket-and-http2-traffic"></a>Websocket and HTTP/2 traffic
