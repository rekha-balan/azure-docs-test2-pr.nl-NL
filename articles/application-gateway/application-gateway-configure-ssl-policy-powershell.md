...
---
# <a name="configure-ssl-policy-versions-and-cipher-suites-on-application-gateway"></a>Configure SSL policy versions and cipher suites on Application Gateway
...
## <a name="get-available-ssl-options"></a>Get available SSL options
...
## <a name="list-pre-defined-ssl-policies"></a>List pre-defined SSL Policies
...
## <a name="configure-a-custom-ssl-policy"></a>Configure a custom SSL policy
...
## <a name="create-an-application-gateway-with-a-pre-defined-ssl-policy"></a>Create an application gateway with a pre-defined SSL policy
...
## <a name="update-an-existing-application-gateway-with-a-pre-defined-ssl-policy"></a>Update an existing application gateway with a pre-defined SSL policy
