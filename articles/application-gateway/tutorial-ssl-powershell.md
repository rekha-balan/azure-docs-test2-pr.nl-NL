...
---
# <a name="create-an-application-gateway-with-ssl-termination-using-azure-powershell"></a>Create an application gateway with SSL termination using Azure PowerShell
...
### <a name="create-the-application-gateway-with-the-certificate"></a>Create the application gateway with the certificate
