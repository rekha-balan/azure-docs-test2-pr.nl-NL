...
---
# <a name="create-an-application-gateway-with-internal-redirection-using-the-azure-cli"></a>Create an application gateway with internal redirection using the Azure CLI
