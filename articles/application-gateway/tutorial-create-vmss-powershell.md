...
---
# <a name="create-an-application-gateway-and-virtual-machine-scale-set-using-azure-powershell"></a>Create an application gateway and virtual machine scale set using Azure PowerShell
