...
---
# <a name="create-an-application-gateway-with-http-to-https-redirection-using-azure-powershell"></a>Create an application gateway with HTTP to HTTPS redirection using Azure PowerShell
...
### <a name="create-the-backend-pool-and-settings"></a>Create the backend pool and settings
...
## <a name="add-a-listener-and-redirection-rule"></a>Add a listener and redirection rule

### <a name="add-the-http-port"></a>Add the HTTP port
...
### <a name="add-the-http-listener"></a>Add the HTTP listener
...
### <a name="add-the-redirection-configuration"></a>Add the redirection configuration
...
### <a name="add-the-routing-rule"></a>Add the routing rule
