...
---
# <a name="create-an-application-gateway-with-external-redirection-using-the-azure-cli"></a>Create an application gateway with external redirection using the Azure CLI
