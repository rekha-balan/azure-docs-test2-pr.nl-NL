...
---
# <a name="tutorial-enable-web-application-firewall-using-the-azure-cli"></a>Tutorial: Enable web application firewall using the Azure CLI
...
## <a name="create-an-application-gateway-with-a-waf"></a>Create an application gateway with a WAF
