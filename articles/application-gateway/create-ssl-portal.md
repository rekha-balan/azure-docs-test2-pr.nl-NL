...
---
# <a name="configure-an-application-gateway-with-ssl-termination-using-the-azure-portal"></a>Configure an application gateway with SSL termination using the Azure portal
...
### <a name="add-backend-servers"></a>Add backend servers
