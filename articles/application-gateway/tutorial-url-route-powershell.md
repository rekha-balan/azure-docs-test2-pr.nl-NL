...
---
# <a name="route-web-traffic-based-on-the-url-using-azure-powershell"></a>Route web traffic based on the URL using Azure PowerShell
...
### <a name="add-image-and-video-backend-pools-and-port"></a>Add image and video backend pools and port
...
### <a name="add-backend-listener"></a>Add backend listener
...
### <a name="add-url-path-map"></a>Add URL path map
...
### <a name="add-routing-rule"></a>Add routing rule
