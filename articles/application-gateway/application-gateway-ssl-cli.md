...
---
# <a name="create-an-application-gateway-with-ssl-termination-using-the-azure-cli"></a>Create an application gateway with SSL termination using the Azure CLI
