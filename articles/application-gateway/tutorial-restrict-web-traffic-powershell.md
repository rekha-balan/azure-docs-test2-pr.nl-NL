...
---
# <a name="enable-web-application-firewall-using-azure-powershell"></a>Enable web application firewall using Azure PowerShell
...
### <a name="create-the-application-gateway-with-the-waf"></a>Create the application gateway with the WAF
...
## <a name="create-a-storage-account-and-configure-diagnostics"></a>Create a storage account and configure diagnostics
...
### <a name="configure-diagnostics"></a>Configure diagnostics
