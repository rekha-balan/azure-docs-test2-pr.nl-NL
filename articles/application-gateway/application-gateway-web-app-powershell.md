...
---
# <a name="configure-app-service-web-apps-with-application-gateway"></a>Configure App Service Web Apps with Application Gateway 
...
## <a name="configure-a-web-app-behind-an-existing-application-gateway"></a>Configure a web app behind an existing application gateway
...
## <a name="configure-a-web-application-behind-a-new-application-gateway"></a>Configure a web application behind a new application gateway
