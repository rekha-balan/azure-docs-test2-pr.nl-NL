...
---
# <a name="application-gateway-ssl-policy-overview"></a>Application Gateway SSL policy overview
...
## <a name="predefined-ssl-policy"></a>Predefined SSL policy
...
## <a name="custom-ssl-policy"></a>Custom SSL policy
...
### <a name="ssl-protocol-versions"></a>SSL protocol versions
