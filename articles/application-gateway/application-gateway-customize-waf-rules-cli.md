...
---
# <a name="customize-web-application-firewall-rules-through-the-azure-cli-20"></a>Customize web application firewall rules through the Azure CLI 2.0
...
### <a name="view-rules-in-a-rule-group"></a>View rules in a rule group
