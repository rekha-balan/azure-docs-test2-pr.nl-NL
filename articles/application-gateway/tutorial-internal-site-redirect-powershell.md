...
---
# <a name="create-an-application-gateway-with-internal-redirection-using-azure-powershell"></a>Create an application gateway with internal redirection using Azure PowerShell
...
### <a name="create-the-first-listener-and-rule"></a>Create the first listener and rule
...
### <a name="add-the-second-listener"></a>Add the second listener
...
### <a name="add-the-second-routing-rule"></a>Add the second routing rule
...
## <a name="create-virtual-machine-scale-set"></a>Create virtual machine scale set
