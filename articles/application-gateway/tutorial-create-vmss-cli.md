...
---
# <a name="create-an-application-gateway-with-a-virtual-machine-scale-set-using-the-azure-cli"></a>Create an application gateway with a virtual machine scale set using the Azure CLI
