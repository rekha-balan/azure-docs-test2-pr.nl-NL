...
---
# <a name="create-an-application-gateway-with-external-redirection-using-azure-powershell"></a>Create an application gateway with external redirection using Azure PowerShell
...
### <a name="create-the-listener-and-rule"></a>Create the listener and rule
