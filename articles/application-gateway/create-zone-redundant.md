...
---
# <a name="create-a-zone-redundant-azure-application-gateway---private-preview"></a>Create a zone redundant Azure application gateway - private preview
...
### <a name="resource-manager-template-deployment"></a>Resource Manager template deployment
