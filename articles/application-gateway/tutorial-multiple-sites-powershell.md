...
---
# <a name="create-an-application-gateway-that-hosts-multiple-web-sites-using-azure-powershell"></a>Create an application gateway that hosts multiple web sites using Azure PowerShell
...
### <a name="create-the-backend-pools-and-settings"></a>Create the backend pools and settings
...
### <a name="create-the-listeners-and-rules"></a>Create the listeners and rules
