...
---
# <a name="create-and-configure-an-application-gateway-to-host-multiple-web-sites-using-the-azure-portal"></a>Create and configure an application gateway to host multiple web sites using the Azure portal
...
## <a name="create-backend-listeners"></a>Create backend listeners
...
## <a name="create-routing-rules"></a>Create routing rules
