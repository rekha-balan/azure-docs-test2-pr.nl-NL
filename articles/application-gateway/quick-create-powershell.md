...
---
# <a name="quickstart-direct-web-traffic-with-azure-application-gateway---azure-powershell"></a>Quickstart: Direct web traffic with Azure Application Gateway - Azure PowerShell
...
### <a name="create-the-backend-pool"></a>Create the backend pool
...
### <a name="create-the-listener-and-add-a-rule"></a>Create the listener and add a rule
