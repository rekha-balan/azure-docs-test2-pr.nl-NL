...
---
# <a name="create-an-application-gateway-with-url-path-based-routing-rules-using-the-azure-cli"></a>Create an application gateway with URL path-based routing rules using the Azure CLI
...
## <a name="create-the-application-gateway-with-url-map"></a>Create the application gateway with URL map
