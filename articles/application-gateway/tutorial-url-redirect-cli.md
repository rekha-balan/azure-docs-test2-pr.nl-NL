...
---
# <a name="tutorial-create-an-application-gateway-with-url-path-based-redirection-using-the-azure-cli"></a>Tutorial: Create an application gateway with URL path-based redirection using the Azure CLI
