...
---
# <a name="overview-of-integration-between-application-gateway-and-azure-security-center"></a>Overview of integration between Application Gateway and Azure Security Center
...
## <a name="add-a-web-application-firewall-to-an-existing-resource"></a>Add a web application firewall to an existing resource
...
## <a name="add-a-resource-to-an-existing-web-application-firewall"></a>Add a resource to an existing web application firewall
...
## <a name="finalize-configuration"></a>Finalize configuration
