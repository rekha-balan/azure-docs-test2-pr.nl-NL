...
---
# <a name="debugging-a-published-azure-cloud-service-with-visual-studio-and-intellitrace"></a>Debugging a published Azure cloud service with Visual Studio and IntelliTrace
...
## <a name="configure-an-azure-application-for-intellitrace"></a>Configure an Azure application for IntelliTrace
...
## <a name="download-intellitrace-logs-for-a-role-instance"></a>Download IntelliTrace logs for a role instance
