...
---
# <a name="discover-and-assess-a-large-vmware-environment"></a>Discover and assess a large VMware environment
...
### <a name="set-up-permissions"></a>Set up permissions
...
## <a name="plan-your-migration-projects-and-discoveries"></a>Plan your migration projects and discoveries
...
### <a name="multiple-vcenter-servers-with-less-than-1500-vms"></a>Multiple vCenter Servers with less than 1500 VMs
...
### <a name="multiple-vcenter-servers-with-more-than-1500-vms"></a>Multiple vCenter Servers with more than 1500 VMs
...
### <a name="more-than-1500-machines-in-a-single-vcenter-server"></a>More than 1500 machines in a single vCenter Server
...
### <a name="multi-tenant-environment"></a>Multi-tenant environment
...
## <a name="discover-on-premises-environment"></a>Discover on-premises environment
...
### <a name="set-up-the-collector-appliance"></a>Set up the collector appliance
...
#### <a name="one-time-discovery"></a>One-time discovery
...
#### <a name="continuous-discovery"></a>Continuous discovery
...
### <a name="create-the-collector-vm"></a>Create the collector VM
...
3. In **Name** and **Location**, specify a friendly name for the collector VM, and the inventory object in which the VM will be hosted.
...
### <a name="identify-the-id-and-key-for-each-project"></a>Identify the ID and key for each project
...
### <a name="set-the-vcenter-statistics-level"></a>Set the vCenter statistics level
