...
---
# <a name="contoso-migration-refactor-a-contoso-linux-service-desk-app-to-multiple-regions-with-azure-app-service-traffic-manager-and-azure-mysql"></a>Contoso migration: Refactor a Contoso Linux service desk app to multiple regions with Azure App Service, Traffic Manager, and Azure MySQL
...
## <a name="step-1-provision-azure-app-services"></a>Step 1: Provision Azure App Services
...
## <a name="step-2-set-up-traffic-manager"></a>Step 2: Set up Traffic Manager
...
## <a name="step-4-migrate-the-database"></a>Step 4: Migrate the database
...
## <a name="step-5-set-up-github"></a>Step 5: Set up GitHub
...
## <a name="step-6-configure-the-web-apps"></a>Step 6: Configure the Web Apps
...
### <a name="set-up-autoscaling"></a>Set up autoscaling
