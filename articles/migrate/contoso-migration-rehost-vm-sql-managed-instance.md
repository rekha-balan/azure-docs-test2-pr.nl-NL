...
---
# <a name="contoso-migration-rehost-an-on-premises-app-on-an-azure-vm-and-sql-database-managed-instance"></a>Contoso migration: Rehost an on-premises app on an Azure VM and SQL Database Managed Instance
...
## <a name="step-1-prepare-a-sql-database-managed-instance"></a>Step 1: Prepare a SQL Database Managed Instance
...
### <a name="set-up-a-virtual-network-for-the-managed-instance"></a>Set up a virtual network for the Managed Instance
...
### <a name="set-up-routing"></a>Set up routing
...
### <a name="create-a-managed-instance"></a>Create a Managed Instance
...
## <a name="step-2-prepare-the-database-migration-service"></a>Step 2: Prepare the Database Migration Service
...
## <a name="step-3-prepare-azure-for-the-site-recovery-service"></a>Step 3: Prepare Azure for the Site Recovery service
...
## <a name="step-4-prepare-on-premises-vmware-for-site-recovery"></a>Step 4: Prepare on-premises VMware for Site Recovery
...
## <a name="step-5-replicate-the-on-premises-vms-to-azure"></a>Step 5: Replicate the on-premises VMs to Azure
...
## <a name="step-6-migrate-the-database"></a>Step 6: Migrate the database 

Contoso admins need to create a Database Migration Service project, and then migrate the database.

### <a name="create-a-database-migration-service-project"></a>Create a Database Migration Service project
...
### <a name="migrate-the-database"></a>Migrate the database 
...
## <a name="step-7-migrate-the-vm"></a>Step 7: Migrate the VM
...
### <a name="migrate-the-vm"></a>Migrate the VM
