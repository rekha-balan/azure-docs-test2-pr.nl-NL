...
---
# <a name="contoso---deploy-a-migration-infrastructure"></a>Contoso - Deploy a migration infrastructure
...
## <a name="on-premises-architecture"></a>On-premises architecture
...
### <a name="manage-subscriptions"></a>Manage subscriptions
...
### <a name="examine-licensing"></a>Examine licensing
...
#### <a name="reserve-instances-for-predictable-workloads"></a>Reserve instances for predictable workloads
...
## <a name="step-2-manage-hybrid-identity"></a>Step 2: Manage hybrid identity
...
### <a name="create-an-azure-ad"></a>Create an Azure AD
...
### <a name="add-the-domain-name"></a>Add the domain name
...
### <a name="set-up-on-premises-and-azure-groups-and-users"></a>Set up on-premises and Azure groups and users
...
#### <a name="create-resource-groups-in-azure"></a>Create resource groups in Azure
...
##### <a name="scaling-resource-groups"></a>Scaling resource groups
...
#### <a name="create-matching-security-groups-on-premises"></a>Create matching security groups on-premises
...
### <a name="synchronize-ad"></a>Synchronize AD
...
### <a name="set-up-rbac"></a>Set up RBAC
...
## <a name="step-3-design-for-resilience-and-disaster"></a>Step 3: Design for resilience and disaster

### <a name="set-up-regions"></a>Set up regions
...
### <a name="set-up-availability-zones"></a>Set up availability zones
...
## <a name="step-4-design-a-network-infrastructure"></a>Step 4: Design a network infrastructure
...
### <a name="plan-hybrid-network-connectivity"></a>Plan hybrid network connectivity
...
### <a name="design-the-azure-network-infrastructure"></a>Design the Azure network infrastructure
...
#### <a name="network-peering"></a>Network peering
...
#### <a name="hub-to-hub-across-regions"></a>Hub-to-hub across regions
...
#### <a name="hub-and-spoke-within-a-region"></a>Hub-and-spoke within a region
...
#### <a name="design-the-hub-network"></a>Design the hub network
...
### <a name="design-and-set-up-azure-networks"></a>Design and set up Azure networks
...
#### <a name="virtual-networks-in-east-us-2"></a>Virtual networks in East US 2
...
#### <a name="subnets-in-the-east-us-2-hub-network-vnet-hub-eus2"></a>Subnets in the East US 2 Hub network (VNET-HUB-EUS2)
...
#### <a name="subnets-in-the-east-us-2-dev-network-vnet-dev-eus2"></a>Subnets in the East US 2 Dev network (VNET-DEV-EUS2)
...
#### <a name="subnets-in-the-east-us-2-production-network-vnet-prod-eus2"></a>Subnets in the East US 2 Production network (VNET-PROD-EUS2)
...
#### <a name="virtual-networks-in-central-us-secondary-region"></a>Virtual networks in Central US (secondary region)
...
#### <a name="subnets-in-the--central-us-hub-network-vnet-hub-cus"></a>Subnets in the  Central US Hub network (VNET-HUB-CUS)
...
#### <a name="subnets-in-the-central-us-production-network-vnet-prod-cus"></a>Subnets in the Central US Production network (VNET-PROD-CUS)
...
#### <a name="subnets-in-the-central-us-failoverrecovery-network-in-central-us-vnet-asr-cus"></a>Subnets in the Central US failover/recovery network in Central US (VNET-ASR-CUS)
...
#### <a name="configure-peered-connections"></a>Configure peered connections
...
##### <a name="domain-controller"></a>Domain controller
...
##### <a name="production-networks"></a>Production networks 
...
### <a name="set-up-dns"></a>Set up DNS
...
#### <a name="set-up-domain-controllers-in-azure"></a>Set up domain controllers in Azure
...
## <a name="step-5-plan-for-governance"></a>Step 5: Plan for governance
...
### <a name="set-up-policies"></a>Set up policies
...
#### <a name="limit-resources-to-regions"></a>Limit resources to regions
...
#### <a name="allow-specific-vm-skus"></a>Allow specific VM SKUs
...
#### <a name="check-policy-compliance"></a>Check policy compliance
...
### <a name="set-up-locks"></a>Set up locks
...
### <a name="set-up-tagging"></a>Set up tagging
...
## <a name="step-6-consider-security"></a>Step 6: Consider security
...
### <a name="work-with-the-azure-security-center"></a>Work with the Azure Security Center
...
#### <a name="centralize-policy-management"></a>Centralize policy management
...
#### <a name="assess-and-action"></a>Assess and action
...
### <a name="work-with-nsgs"></a>Work with NSGs
...
### <a name="encrypt-data"></a>Encrypt data
