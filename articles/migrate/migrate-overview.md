...
---
# <a name="about-azure-migrate"></a>About Azure Migrate
...
## <a name="why-use-azure-migrate"></a>Why use Azure Migrate?
...
## <a name="what-do-i-need-to-pay-for"></a>What do I need to pay for?

[Learn more](https://azure.microsoft.com/pricing/details/azure-migrate/) about Azure Migrate pricing.


## <a name="whats-in-an-assessment"></a>What's in an assessment?
...
## <a name="how-does-azure-migrate-work"></a>How does Azure Migrate work?
...
## <a name="what-are-the-port-requirements"></a>What are the port requirements?
...
## <a name="what-happens-after-assessment"></a>What happens after assessment?
