...
---
# <a name="troubleshoot-azure-migrate"></a>Troubleshoot Azure Migrate
...
### <a name="migration-project-creation-failed-with-error-requests-must-contain-user-identity-headers"></a>Migration project creation failed with error *Requests must contain user identity headers*
...
### <a name="performance-data-for-disks-and-networks-adapters-shows-as-zeros"></a>Performance data for disks and networks adapters shows as zeros
...
### <a name="i-installed-agents-and-used-the-dependency-visualization-to-create-groups-now-post-failover-the-machines-show-install-agent-action-instead-of-view-dependencies"></a>I installed agents and used the dependency visualization to create groups. Now post failover, the machines show "Install agent" action instead of "View dependencies"
...
## <a name="collector-errors"></a>Collector errors

### <a name="deployment-of-collector-ova-failed"></a>Deployment of collector OVA failed
...
### <a name="collector-is-not-able-to-connect-to-the-internet"></a>Collector is not able to connect to the internet
...
### <a name="error-802-date-and-time-synchronization-error"></a>Error 802: Date and time synchronization error
...
### <a name="vmware-powercli-installation-failed"></a>VMware PowerCLI installation failed
...
## <a name="troubleshoot-readiness-issues"></a>Troubleshoot readiness issues
...
## <a name="collect-logs"></a>Collect logs
...
## <a name="collector-error-codes-and-recommended-actions"></a>Collector error codes and recommended actions
