...
---
# <a name="discover-and-assess-on-premises-vmware-vms-for-migration-to-azure"></a>Discover and assess on-premises VMware VMs for migration to Azure
...
## <a name="create-an-account-for-vm-discovery"></a>Create an account for VM discovery
...
## <a name="create-and-view-an-assessment"></a>Create and view an assessment
...
### <a name="assessment-details"></a>Assessment details
...
#### <a name="azure-readiness"></a>Azure readiness
...
#### <a name="monthly-cost-estimate"></a>Monthly cost estimate
...
#### <a name="confidence-rating"></a>Confidence rating
