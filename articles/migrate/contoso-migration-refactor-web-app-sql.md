...
---
# <a name="contoso-migration-refactor-an-on-premises-app-to-an-azure-web-app-and-azure-sql-database"></a>Contoso migration: Refactor an on-premises app to an Azure Web App and Azure SQL database
...
## <a name="step-2-migrate-the-database-with-dma"></a>Step 2: Migrate the database with DMA
...
### <a name="migrate-the-database-with-dma"></a>Migrate the database with DMA
...
## <a name="step-3-provision-web-apps"></a>Step 3: Provision Web Apps
...
## <a name="step-4-set-up-vsts"></a>Step 4: Set up VSTS
...
## <a name="step-5-configure-connection-strings"></a>Step 5: Configure connection strings
...
## <a name="step-6-set-up-build-and-release-pipelines-in-vsts"></a>Step 6: Set up build and release pipelines in VSTS
