...
---
# <a name="contoso-migration-rehost-an-on-premises-app-on-azure-vms-and-sql-server-alwayson-availability-group"></a>Contoso migration: Rehost an on-premises app on Azure VMs and SQL Server AlwaysOn Availability Group
...
## <a name="business-drivers"></a>Business drivers
...
## <a name="migration-goals"></a>Migration goals
...
### <a name="proposed-architecture"></a>Proposed architecture
...
### <a name="database-considerations"></a>Database considerations
...
### <a name="solution-review"></a>Solution review
...
## <a name="scenario-steps"></a>Scenario steps
...
## <a name="step-1-prepare-a-sql-server-alwayson-availability-group-cluster"></a>Step 1: Prepare a SQL Server AlwaysOn availability group cluster
...
## <a name="step-2-deploy-and-set-up-the-cluster"></a>Step 2: Deploy and set up the cluster
...
### <a name="set-up-a-storage-account-as-cloud-witness"></a>Set up a storage account as cloud witness
...
### <a name="add-sql-server-vms-to-contoso-domain"></a>Add SQL Server VMs to Contoso domain
...
### <a name="set-up-the-cluster"></a>Set up the cluster
...
## <a name="configure-the-cloud-witness"></a>Configure the cloud witness
...
### <a name="enable-sql-server-always-on-availability-groups"></a>Enable SQL Server Always On availability groups
...
## <a name="step-3-deploy-the-azure-load-balancer"></a>Step 3: Deploy the Azure Load Balancer
...
### <a name="add-a-backend-pool"></a>Add a backend pool
...
### <a name="configure-the-load-balancer-to-receive-traffic"></a>Configure the load balancer to receive traffic
...
## <a name="step-4-prepare-azure-for-the-site-recovery-service"></a>Step 4: Prepare Azure for the Site Recovery service
...
## <a name="step-5-prepare-on-premises-vmware-for-site-recovery"></a>Step 5: Prepare on-premises VMware for Site Recovery
...
### <a name="prepare-an-account-for-mobility-service-installation"></a>Prepare an account for Mobility service installation
...
## <a name="step-6-replicate-the-on-premises-vms-to-azure-with-site-recovery"></a>Step 6: Replicate the on-premises VMs to Azure with Site Recovery

Before they can run a migration to Azure, Contoso admins need to set up and enable replication.

### <a name="set-a-replication-goal"></a>Set a replication goal
...
### <a name="confirm-deployment-planning"></a>Confirm deployment planning
...
### <a name="set-up-the-target"></a>Set up the target
...
## <a name="step-7-install-the-database-migration-assistant-dma"></a>Step 7: Install the Database Migration Assistant (DMA)
...
## <a name="step-8-migrate-the-database-with-dma"></a>Step 8: Migrate the database with DMA
...
## <a name="step-7-protect-the-database-with-alwayson"></a>Step 7: Protect the database with AlwaysOn
...
### <a name="create-an-alwayson-availability-group"></a>Create an AlwaysOn availability group
...
### <a name="configure-a-listener-on-the-cluster"></a>Configure a listener on the cluster
...
## <a name="step-8-migrate-the-vm-with-site-recovery"></a>Step 8: Migrate the VM with Site Recovery
...
### <a name="update-the-connection-string"></a>Update the connection string
...
## <a name="clean-up-after-migration"></a>Clean up after migration
...
## <a name="review-the-deployment"></a>Review the deployment
...
### <a name="licensing-and-cost-optimization"></a>Licensing and cost optimization
