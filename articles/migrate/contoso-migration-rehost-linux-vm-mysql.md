...
---
# <a name="contoso-migration-rehost-an-on-premises-linux-app-to-azure-vms-and-azure-mysql"></a>Contoso migration: Rehost an on-premises Linux app to Azure VMs and Azure MySQL
...
## <a name="step-1-prepare-azure-for-the-site-recovery-service"></a>Step 1: Prepare Azure for the Site Recovery service
...
## <a name="step-2-prepare-on-premises-vmware-for-site-recovery"></a>Step 2: Prepare on-premises VMware for Site Recovery
...
## <a name="step-3-provision-azure-database-for-mysql"></a>Step 3: Provision Azure Database for MySQL
...
## <a name="step-4-replicate-the-on-premises-vms"></a>Step 4: Replicate the on-premises VMs

Before they can migrate the web VM to Azure, Contoso admins set up and enable replication.

### <a name="set-a-protection-goal"></a>Set a protection goal
...
### <a name="enable-replication-for-the-web-vm"></a>Enable replication for the Web VM
...
## <a name="step-5-migrate-the-database"></a>Step 5: Migrate the database
...
### <a name="install-mysql-workbench"></a>Install MySQL Workbench
...
## <a name="step-6-migrate-the-vms-with-site-recovery"></a>Step 6: Migrate the VMs with Site Recovery
...
### <a name="connect-the-vm-to-the-database"></a>Connect the VM to the database
