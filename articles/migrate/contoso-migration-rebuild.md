...
---
# <a name="contoso-migration-rebuild-an-on-premises-app-to-azure"></a>Contoso migration: Rebuild an on-premises app to Azure
...
### <a name="provision-aks-and-acr"></a>Provision AKS and ACR
...
### <a name="create-an-azure-devops-project-and-build"></a>Create an Azure DevOps project and build
...
### <a name="deploy-the-back-end-infrastructure"></a>Deploy the back-end infrastructure
...
### <a name="create-the-back-end-release-pipeline"></a>Create the back-end release pipeline
...
### <a name="create-blob-storage-containers"></a>Create blob storage containers
...
### <a name="provision-a-cosmos-database"></a>Provision a Cosmos database
...
### <a name="provision-computer-vision"></a>Provision Computer Vision
...
### <a name="provision-the-azure-web-app"></a>Provision the Azure Web App
...
### <a name="provision-the-azure-function-app"></a>Provision the Azure function app
...
### <a name="deploy-the-website-to-the-azure-app-service"></a>Deploy the website to the Azure App Service
...
### <a name="deploy-the-petchecker-function-app"></a>Deploy the PetChecker Function App
...
### <a name="backups-and-disaster-recovery"></a>Backups and disaster recovery
