...
---
# <a name="contoso-migration--refactor-a-team-foundation-server-deployment-to-azure-devops-services"></a>Contoso migration:  Refactor a Team Foundation Server deployment to Azure DevOps Services
...
## <a name="step-2-upgrade-tfs"></a>Step 2: Upgrade TFS
...
## <a name="step-3-validate-the-tfs-collection"></a>Step 3: Validate the TFS collection
...
## <a name="step-4-create-the-migration-files"></a>Step 4: Create the migration files
...
## <a name="step-5-migrate-to-azure-devops-services"></a>Step 5: Migrate to Azure DevOps Services
...
### <a name="detach-the-collection"></a>Detach the collection
...
### <a name="generate-a-dacpac"></a>Generate a DACPAC
...
### <a name="update-the-file-to-storage"></a>Update the file to storage
...
### <a name="fill-in-the-import-settings"></a>Fill in the import settings
...
They open the import.json file, and fill out the following fields: •   Location: Location of the SAS key that was generated above.
...
### <a name="do-a-dry-run-migration"></a>Do a dry run migration
...
### <a name="run-the-production-migration"></a>Run the production migration
...
### <a name="move-source-control-from-tfvc-to-git"></a>Move source control from TFVC to GIT
