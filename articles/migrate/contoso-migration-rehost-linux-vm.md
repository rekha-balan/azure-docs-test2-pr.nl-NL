...
---
# <a name="contoso-migration-rehost-an-on-premises-linux-app-to-azure-vms"></a>Contoso migration: Rehost an on-premises Linux app to Azure VMs
...
## <a name="step-3-replicate-the-on-premises-vms"></a>Step 3: Replicate the on-premises VMs
...
### <a name="enable-replication-for-osticketweb"></a>Enable replication for OSTICKETWEB
...
### <a name="enable-replication-for-osticketmysql"></a>Enable replication for OSTICKETMYSQL
...
## <a name="step-4-migrate-the-vms"></a>Step 4: Migrate the VMs 
...
### <a name="create-and-customize-a-recovery-plan"></a>Create and customize a recovery plan
...
### <a name="migrate-the-vms"></a>Migrate the VMs
