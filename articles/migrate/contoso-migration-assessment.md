...
---
# <a name="contoso-migration-assess-on-premises-workloads-for-migration-to-azure"></a>Contoso migration: Assess on-premises workloads for migration to Azure
...
## <a name="assessment-goals"></a>Assessment goals
...
## <a name="assessment-architecture"></a>Assessment architecture
...
## <a name="assessment-overview"></a>Assessment overview
...
## <a name="step-1-download-and-install-data-migration-assistant"></a>Step 1: Download and install Data Migration Assistant
...
## <a name="step-2-run-and-analyze-the-database-assessment-for-smarthotel360"></a>Step 2: Run and analyze the database assessment for SmartHotel360
...
### <a name="analyze-the-database-assessment"></a>Analyze the database assessment
...
## <a name="step-3-prepare-for-vm-assessment-by-using-azure-migrate"></a>Step 3: Prepare for VM assessment by using Azure Migrate
...
### <a name="set-up-a-vmware-account"></a>Set up a VMware account
...
### <a name="verify-permissions-to-create-a-vm"></a>Verify permissions to create a VM
...
### <a name="verify-ports"></a>Verify ports
...
### <a name="set-statistics-settings"></a>Set statistics settings
...
## <a name="step-4-discover-vms"></a>Step 4: Discover VMs
...
### <a name="download-the-collector-appliance"></a>Download the collector appliance
...
### <a name="verify-the-collector-appliance"></a>Verify the collector appliance
...
### <a name="create-the-collector-appliance"></a>Create the collector appliance
...
### <a name="run-the-collector-to-discover-vms"></a>Run the collector to discover VMs
...
### <a name="verify-vms-in-the-portal"></a>Verify VMs in the portal
...
## <a name="step-5-prepare-for-dependency-analysis"></a>Step 5: Prepare for dependency analysis
...
### <a name="install-the-agents-on-windows-vms"></a>Install the agents on Windows VMs

Contoso runs the installation on each VM.

#### <a name="install-the-mma-on-windows-vms"></a>Install the MMA on Windows VMs
...
#### <a name="install-the-dependency-agent-on-windows-vms"></a>Install the Dependency agent on Windows VMs
...
### <a name="install-the-agents-on-linux-vms"></a>Install the agents on Linux VMs

Contoso runs the installation on each VM.

#### <a name="install-the-mma-on-linux-vms"></a>Install the MMA on Linux VMs
...
#### <a name="install-the-dependency-agent-on-linux-vms"></a>Install the Dependency Agent on Linux VMs
...
## <a name="step-6-run-and-analyze-the-vm-assessment"></a>Step 6: Run and analyze the VM assessment

Contoso can now verify machine dependencies and create a group. Then, it runs the assessment for the group.

### <a name="verify-dependencies-and-create-a-group"></a>Verify dependencies and create a group
...
### <a name="run-an-assessment"></a>Run an assessment
...
### <a name="analyze-the-vm-assessment"></a>Analyze the VM assessment
...
#### <a name="review-confidence-rating"></a>Review confidence rating
...
#### <a name="verify-azure-readiness"></a>Verify Azure readiness
...
#### <a name="review-monthly-cost-estimates"></a>Review monthly cost estimates
...
## <a name="clean-up-after-assessment"></a>Clean up after assessment
