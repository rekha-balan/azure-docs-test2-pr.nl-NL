...
---
# <a name="bing-entity-search-sdk-java-quickstart"></a>Bing Entity Search SDK Java quickstart
...
Get a [Cognitive Services access key](https://azure.microsoft.com/try/cognitive-services/) under **Search**. Install the Bing Entity Search SDK dependencies by using Maven, Gradle, or another dependency management system. The Maven POM file requires the declaration:
```
  <dependencies>
    <dependency>
