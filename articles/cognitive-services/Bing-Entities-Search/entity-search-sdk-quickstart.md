...
---
# <a name="entity-search-sdk-c-quickstart"></a>Entity Search SDK C# quickstart
...
## <a name="ambiguous-results"></a>Ambiguous results
...
## <a name="entitydata-places"></a>EntityData places
...
```
## <a name="entityscenario-list"></a>EntityScenario list
...
```
## <a name="error-results"></a>Error results
