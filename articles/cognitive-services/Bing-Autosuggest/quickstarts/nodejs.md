...
---
# <a name="quickstart-for-bing-autosuggest-api-with-nodejs"></a>Quickstart for Bing Autosuggest API with Node.js
<a name="HOLTop"></a>
...
## <a name="get-autosuggest-results"></a>Get Autosuggest results
