...
ms.locfileid: "44870797"
---
# <a name="tutorial-single-page-web-app"></a><span data-ttu-id="d9685-103">Tutorial: Single-page Web app</span><span class="sxs-lookup"><span data-stu-id="d9685-103">Tutorial: Single-page Web app</span></span>

<span data-ttu-id="d9685-104">This is the complete source code discussed in the [single-page app tutorial](autosuggest.md) for the Bing Autosuggest API.</span><span class="sxs-lookup"><span data-stu-id="d9685-104">This is the complete source code discussed in the [single-page app tutorial](autosuggest.md) for the Bing Autosuggest API.</span></span> <span data-ttu-id="d9685-105">To run the app, copy the source code into a text editor and save the file as `autosuggest.html`.</span><span class="sxs-lookup"><span data-stu-id="d9685-105">To run the app, copy the source code into a text editor and save the file as `autosuggest.html`.</span></span> <span data-ttu-id="d9685-106">Then open the saved file in your Web browser.</span><span class="sxs-lookup"><span data-stu-id="d9685-106">Then open the saved file in your Web browser.</span></span>
