...
---
# <a name="migrate-from-the-video-indexer-api-v1-to-v2"></a>Migrate from the Video Indexer API v1 to v2
...
### <a name="authorization-and-operations"></a>Authorization and Operations
...
## <a name="getting-and-using-the-access-token-for-operations-apis"></a>Getting and using the access token for operations APIs
...
### <a name="v1-vs-v2-examples"></a>V1 vs V2 examples
...
#### <a name="uploading-a-video-in-v1"></a>Uploading a video in V1:
...
#### <a name="uploading-a-video-in-v2"></a>Uploading a video in V2:
...
#### <a name="getting-insights-in-v1"></a>Getting insights in V1:

```
https://videobreakdown.azure-api.net/Breakdowns/Api/Partner/Breakdowns/[VIDEO_ID]
```
  
#### <a name="getting-insights-in-v2"></a>Getting insights in V2:
...
#### <a name="getting-video-processing-state-in-v1"></a>Getting video processing state in V1:

```
https://videobreakdown.azure-api.net/Breakdowns/Api/Partner/Breakdowns/[VIDEO_ID]/State
```
  
#### <a name="getting-video-processing-state-in-v2"></a>Getting video processing state in V2:
