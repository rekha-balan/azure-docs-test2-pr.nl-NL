...
---
# <a name="manage-a-video-indexer-account-connected-to-azure"></a>Manage a Video Indexer account connected to Azure
...
## <a name="examine-account-settings"></a>Examine account settings
...
## <a name="auto-scale-reserved-units"></a>Auto-scale reserved units
