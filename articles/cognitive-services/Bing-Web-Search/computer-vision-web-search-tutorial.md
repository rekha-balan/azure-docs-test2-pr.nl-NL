...
---
# <a name="visual-search-mobile-app-tutorial"></a>Visual Search mobile app tutorial
...
## <a name="setup-for-development"></a>Setup for development  

### <a name="installing-xamarin-on-windows"></a>Installing Xamarin on Windows
...
### <a name="installing-xamarin-on-macos"></a>Installing Xamarin on macOS
...
### <a name="add-keys-page"></a>Add Keys Page
...
### <a name="ocr-select-page"></a>OCR Select page
...
### <a name="ocr-results-page"></a>OCR Results page
...
### <a name="web-results-page"></a>Web Results page
