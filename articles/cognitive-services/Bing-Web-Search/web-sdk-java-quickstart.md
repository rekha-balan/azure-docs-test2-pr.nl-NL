...
---
# <a name="quickstart-use-the-bing-web-search-sdk-for-java"></a>Quickstart: Use the Bing Web Search SDK for Java
...
## <a name="create-a-project-and-configure-your-pom-file"></a>Create a project and configure your POM file
...
## <a name="declare-the-bingwebsearchsample-class"></a>Declare the BingWebSearchSample class
