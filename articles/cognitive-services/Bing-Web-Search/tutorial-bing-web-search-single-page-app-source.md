...
ms.locfileid: "44869794"
---
# <a name="tutorial-single-page-web-app"></a><span data-ttu-id="bcc5a-103">Tutorial: Single-page Web app</span><span class="sxs-lookup"><span data-stu-id="bcc5a-103">Tutorial: Single-page Web app</span></span>

<span data-ttu-id="bcc5a-104">This is the complete source code discussed in the [single-page app tutorial](tutorial-bing-web-search-single-page-app.md) for Bing Web Search.</span><span class="sxs-lookup"><span data-stu-id="bcc5a-104">This is the complete source code discussed in the [single-page app tutorial](tutorial-bing-web-search-single-page-app.md) for Bing Web Search.</span></span> <span data-ttu-id="bcc5a-105">To run the app, copy the source code into Notepad or another text editor and save it as `bing.html`.</span><span class="sxs-lookup"><span data-stu-id="bcc5a-105">To run the app, copy the source code into Notepad or another text editor and save it as `bing.html`.</span></span> <span data-ttu-id="bcc5a-106">Then open the saved file in Microsoft Edge or another popular browser.</span><span class="sxs-lookup"><span data-stu-id="bcc5a-106">Then open the saved file in Microsoft Edge or another popular browser.</span></span>
