...
---
# <a name="quickstart-use-the-bing-web-search-sdk-for-c"></a>Quickstart: Use the Bing Web Search SDK for C#
...
## <a name="create-a-project-and-install-dependencies"></a>Create a project and install dependencies
...
## <a name="declare-dependencies"></a>Declare dependencies
...
## <a name="create-project-scaffolding"></a>Create project scaffolding
...
## <a name="construct-a-request"></a>Construct a request
...
## <a name="declare-the-main-method"></a>Declare the main method
...
## <a name="define-functions-and-filter-results"></a>Define functions and filter results
...
### <a name="limit-the-number-of-results-returned-by-bing"></a>Limit the number of results returned by Bing
...
### <a name="filter-for-news"></a>Filter for news
...
### <a name="use-safe-search-answer-count-and-the-promote-filter"></a>Use safe search, answer count, and the promote filter
