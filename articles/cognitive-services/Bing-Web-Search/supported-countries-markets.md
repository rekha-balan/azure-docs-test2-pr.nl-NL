...
---
# <a name="countries-regions-and-languages-supported-by-the-bing-web-search-api"></a>Countries, regions, and languages supported by the Bing Web Search API
...
## <a name="countriesregions"></a>Countries/regions
