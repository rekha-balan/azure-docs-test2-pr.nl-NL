...
---
# <a name="quickstart-use-ruby-to-call-the-bing-web-search-api"></a>Quickstart: Use Ruby to call the Bing Web Search API  
...
## <a name="print-the-response"></a>Print the response
