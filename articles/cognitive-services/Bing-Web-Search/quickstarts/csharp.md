...
---
# <a name="quickstart-use-c-to-call-the-bing-web-search-api"></a>Quickstart: Use C# to call the Bing Web Search API  
...
## <a name="create-a-project-and-declare-dependencies"></a>Create a project and declare dependencies
...
## <a name="declare-a-namespace-and-class-for-your-program"></a>Declare a namespace and class for your program
...
## <a name="create-a-struct-for-search-results"></a>Create a struct for search results
...
## <a name="format-the-response"></a>Format the response
