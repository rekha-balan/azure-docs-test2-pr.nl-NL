...
---
# <a name="quickstart-use-nodejs-to-call-the-bing-web-search-api"></a>Quickstart: Use Node.js to call the Bing Web Search API  
...
## <a name="create-a-response-handler"></a>Create a response handler
