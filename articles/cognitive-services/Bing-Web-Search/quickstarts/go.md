...
---
# <a name="quickstart-use-go-to-call-the-bing-web-search-api"></a>Quickstart: Use Go to call the Bing Web Search API  
...
## <a name="create-a-project-and-import-core-libraries"></a>Create a project and import core libraries
...
## <a name="create-a-struct-to-format-the-search-results"></a>Create a struct to format the search results
...
## <a name="declare-the-main-function-and-define-variables"></a>Declare the main function and define variables  
