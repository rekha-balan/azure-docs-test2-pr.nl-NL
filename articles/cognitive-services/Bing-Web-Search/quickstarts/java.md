...
---
# <a name="quickstart-use-java-to-call-the-bing-web-search-api"></a>Quickstart: Use Java to call the Bing Web Search API  
...
## <a name="create-a-project-and-import-dependencies"></a>Create a project and import dependencies
...
### <a name="declare-gson-in-the-maven-pom-file"></a>Declare Gson in the Maven POM file
...
## <a name="declare-the-bingwebsearch-class"></a>Declare the BingWebSearch class
...
## <a name="create-a-container-class-for-search-results"></a>Create a container class for search results
