...
---
# <a name="use-the-anomaly-finder-api-with-java"></a>Use the Anomaly Finder API with Java
...
## <a name="getting-anomaly-points-with-the-anomaly-detection-api-using-java"></a>Getting anomaly points with the Anomaly Detection API using Java
...
### <a name="analyze-data-and-get-anomaly-points-java-example"></a>Analyze data and get anomaly points Java example
