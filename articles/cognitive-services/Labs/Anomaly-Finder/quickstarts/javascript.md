...
---
# <a name="use-the-anomaly-finder-api-with-javascript"></a>Use the Anomaly Finder API with Javascript
...
## <a name="getting-anomaly-points-with-anomaly-detection-api-using-javascript"></a>Getting anomaly points with Anomaly Detection API using Javascript
...
### <a name="analyze-data-and-get-anomaly-points-javascript-example"></a>Analyze data and get anomaly points Javascript example
