...
---
# <a name="project-answer-search-use-and-display-requirements"></a>Project Answer Search use and display requirements
...
## <a name="1-bing-spell-check-and-bing-autosuggest-api"></a>1. Bing Spell Check and Bing Autosuggest API.
...
## <a name="2-definitions"></a>2. Definitions
...
## <a name="3-search-apis"></a>3. Search APIs
...
- display advertising that is not provided by Microsoft on any page that displays any part of a response; -display any advertising with responses (i) from the Bing Image, News or Video Search APIs; or (ii) that are filtered or limited primarily (or solely) to image, news and/or video results.
