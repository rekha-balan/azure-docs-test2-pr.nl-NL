...
---
# <a name="managing-user-data"></a>Managing user data
...
## <a name="overview-of-end-user-data-logging"></a>Overview of end-user data logging
...
## <a name="how-to-disable-logging"></a>How to disable logging
...
## <a name="what-is-logged"></a>What is logged 
...
## <a name="associating-logged-dialogs-with-a-user-id"></a>Associating logged dialogs with a user ID
...
## <a name="headers-for-http-calls"></a>Headers for HTTP calls
...
## <a name="how-to-obtain-raw-data-for-a-logged-dialog"></a>How to obtain raw data for a logged dialog
...
## <a name="how-to-delete-a-logged-dialog"></a>How to delete a logged dialog
