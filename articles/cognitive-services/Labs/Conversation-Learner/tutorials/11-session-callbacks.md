...
---
# <a name="how-to-use-session-callbacks-with-a-conversation-learner-model"></a>How to use session callbacks with a Conversation Learner model
...
### <a name="code-for-the-callbacks"></a>Code for the callbacks

The code for the callback methods is in the file: c:\<installedpath>\src\demos\tutorialSessionCallbacks.ts.
...
### <a name="try-the-bot"></a>Try the bot
