...
---
# <a name="connecting-to-cognitive-services-face-api-by-using-connected-services-in-visual-studio"></a>Connecting to Cognitive Services Face API by using Connected Services in Visual Studio
...
## <a name="create-a-project-and-add-support-for-cognitive-services-face-api"></a>Create a project and add support for Cognitive Services Face API
...
## <a name="use-the-face-api-to-detect-attributes-of-faces-in-an-image"></a>Use the Face API to detect attributes of faces in an image
