...
---
# <a name="design-process-overview"></a>Design process overview
...
## <a name="pre-bake-design"></a>Pre-bake design
...
## <a name="sound-source-placement"></a>Sound source placement
...
## <a name="post-bake-design"></a>Post-bake design
...
### <a name="distance-based-attenuation"></a>Distance-based attenuation
...
### <a name="tuning-scene-parameters"></a>Tuning scene parameters
...
### <a name="tuning-source-parameters"></a>Tuning source parameters
