...
---
# <a name="getting-started-with-project-acoustics"></a>Getting started with Project Acoustics
...
## <a name="download-the-plugin"></a>Download the plugin
...
## <a name="supported-platforms-for-quickstart"></a>Supported platforms for quickstart
...
## <a name="enable-the-plugin"></a>Enable the plugin
...
## <a name="create-a-navigation-mesh"></a>Create a navigation mesh
...
## <a name="mark-static-meshes-for-acoustics"></a>Mark static meshes for acoustics
...
## <a name="preview-the-probes"></a>Preview the probes
...
## <a name="bake-the-scene"></a>Bake the scene
...
## <a name="set-up-audio-runtime-dsp"></a>Set up audio runtime DSP
...
## <a name="set-up-the-acoustics-lookup-table"></a>Set up the acoustics lookup table
...
## <a name="apply-acoustics-to-sound-sources"></a>Apply acoustics to sound sources
...
## <a name="apply-post-bake-design"></a>Apply post-bake design
