...
---
# <a name="bake-acoustics"></a>Bake acoustics
...
## <a name="import-the-plugin"></a>Import the plugin
...
## <a name="create-or-mark-a-navigation-mesh"></a>Create or mark a navigation mesh
...
## <a name="objects-tab"></a>Objects tab
...
### <a name="objects-tab-parts"></a>Objects tab parts
...
### <a name="guidelines-for-marking-objects"></a>Guidelines for marking objects
...
## <a name="materials-tab"></a>Materials tab

Once your objects are marked, click the **Materials** button to go to the Materials Tab.

### <a name="parts-of-the-materials-tab"></a>Parts of the Materials tab
...
### <a name="guidelines-for-assigning-materials-or-absorption-values"></a>Guidelines for assigning materials (or absorption values)
...
## <a name="probes-tab"></a>Probes tab

After assigning the materials, switch to the **Probes** tab.

### <a name="parts-of-the-probes-tab"></a>Parts of the Probes tab
...
### <a name="what-the-calculate-button-calculates"></a>What the "Calculate..." button calculates
...
### <a name="scene-rename"></a>Scene rename
...
## <a name="debug-display-through-gizmos"></a>Debug display through Gizmos
...
### <a name="probe-points"></a>Probe points
...
### <a name="reviewing-the-bake-results"></a>Reviewing the bake results
