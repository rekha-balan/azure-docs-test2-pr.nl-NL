...
## <a name="custom-search-endpoint"></a>Custom Search Endpoint
...
## <a name="custom-search-response-json"></a>Custom Search Response JSON
...
## <a name="custom-autosuggest-endpoint"></a>Custom Autosuggest Endpoint
...
## <a name="custom-image-search-endpoint"></a>Custom Image Search Endpoint
