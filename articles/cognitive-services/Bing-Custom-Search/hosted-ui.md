...
---
# <a name="configure-your-hosted-ui-experience"></a>Configure your hosted UI experience
...
## <a name="configure-custom-hosted-ui"></a>Configure custom hosted UI
...
## <a name="consume-custom-ui"></a>Consume custom UI
...
- Use the URL provided `https://ui.customsearch.ai/hosted?customConfig=YOUR-CUSTOM-CONFIG-ID`
