...
---
# <a name="configure-your-custom-search-experience"></a>Configure your custom search experience
...
## <a name="adding-slices-to-your-custom-search"></a>Adding slices to your custom search
...
## <a name="active-and-blocked-lists"></a>Active and Blocked lists 
...
## <a name="pinned-list"></a>Pinned list
...
## <a name="site-suggestions"></a>Site suggestions
...
## <a name="preview-pane"></a>Preview pane
...
<a name="adjustrank"></a>
## <a name="adjust-rank"></a>Adjust rank
...
## <a name="boosting-and-demoting"></a>Boosting and demoting
...
## <a name="pin-to-top"></a>Pin to top
...
## <a name="use-bing-to-specify-slices"></a>Use Bing to specify slices
...
## <a name="view-statistics"></a>View statistics
