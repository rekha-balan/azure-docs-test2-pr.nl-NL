...
---
# <a name="build-a-custom-search-web-page"></a>Build a Custom Search web page
...
## <a name="add-active-entries"></a>Add active entries
...
## <a name="add-blocked-entries"></a>Add blocked entries
...
## <a name="add-pinned-entries"></a>Add pinned entries
...
## <a name="configure-hosted-ui"></a>Configure Hosted UI
...
## <a name="consuming-hosted-ui"></a>Consuming Hosted UI
...
## <a name="set-up-your-visual-studio-solution"></a>Set up your Visual Studio solution
...
## <a name="edit-indexcshtml"></a>Edit index.cshtml
