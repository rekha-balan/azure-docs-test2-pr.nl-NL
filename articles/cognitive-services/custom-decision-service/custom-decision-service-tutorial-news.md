...
---
# <a name="article-personalization"></a>Article personalization
...
Custom Decision Service consumes action sets via RSS or Atom feeds provided by the customer. You provide two feeds: one for politics and one for sports. Suppose they are served from `http://www.domain.com/feeds/<feed-name>`.
