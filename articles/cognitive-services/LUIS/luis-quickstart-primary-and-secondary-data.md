...
---
# <a name="tutorial-7-add-simple-entity-and-phrase-list"></a>Tutorial: 7. Add simple entity and phrase list
...
## <a name="purpose-of-the-app"></a>Purpose of the app
...
## <a name="purpose-of-the-simple-entity"></a>Purpose of the simple entity
...
## <a name="create-job-simple-entity"></a>Create job simple entity
...
## <a name="label-entity-in-example-utterances-for-getjobinformation-intent"></a>Label entity in example utterances for GetJobInformation intent
...
## <a name="names-are-tricky"></a>Names are tricky
...
## <a name="to-boost-signal-add-jobs-phrase-list"></a>To boost signal, add jobs phrase list
...
## <a name="phrase-lists"></a>Phrase lists
