...
---
# <a name="build-a-luis-app-programmatically-using-nodejs"></a>Build a LUIS app programmatically using Node.js
...
## <a name="map-preexisting-data-to-intents-and-entities"></a>Map preexisting data to intents and entities
...
## <a name="steps-to-generate-a-luis-app-from-non-luis-data"></a>Steps to generate a LUIS app from non-LUIS data
...
## <a name="parse-the-csv"></a>Parse the CSV
...
## <a name="create-the-luis-app"></a>Create the LUIS app
...
## <a name="add-utterances"></a>Add utterances
...
### <a name="install-nodejs-dependencies"></a>Install Node.js dependencies
...
### <a name="change-configuration-settings"></a>Change Configuration Settings
...
### <a name="application-progress"></a>Application progress
...
## <a name="open-the-luis-app"></a>Open the LUIS app
