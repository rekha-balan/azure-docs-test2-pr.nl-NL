...
## <a name="types-of-datetimev2"></a>Types of datetimeV2
...
## <a name="example-json"></a>Example JSON 
...
## <a name="json-property-descriptions"></a>JSON property descriptions
...
## <a name="values-of-resolution"></a>Values of resolution
...
## <a name="valid-date-values"></a>Valid date values
...
## <a name="date-range-resolution-examples-for-numeric-date"></a>Date range resolution examples for numeric date
...
## <a name="date-range-resolution-examples-for-day-of-week"></a>Date range resolution examples for day of week
...
```
## <a name="ambiguous-time"></a>Ambiguous time
...
## <a name="time-range-resolution-example"></a>Time range resolution example
...
## <a name="deprecated-prebuilt-datetime"></a>Deprecated prebuilt datetime
