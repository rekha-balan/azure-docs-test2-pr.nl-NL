...
---
# <a name="add-example-utterances-and-label-with-entities"></a>Add example utterances and label with entities
...
## <a name="add-an-utterance"></a>Add an utterance
...
## <a name="add-simple-entity-label"></a>Add simple entity label
...
## <a name="add-list-entity-and-label"></a>Add list entity and label
...
## <a name="add-synonyms-to-the-list-entity"></a>Add synonyms to the list entity 
...
## <a name="create-new-item-for-list-entity"></a>Create new item for list entity
...
## <a name="wrap-entities-in-composite-label"></a>Wrap entities in composite label
...
## <a name="add-hierarchical-entity-and-label"></a>Add hierarchical entity and label
...
## <a name="remove-entity-labels-from-utterances"></a>Remove entity labels from utterances
...
## <a name="add-prebuilt-entity-label"></a>Add prebuilt entity label
...
## <a name="add-regular-expression-entity-label"></a>Add regular expression entity label
...
## <a name="add-patternany-entity-label"></a>Add pattern.any entity label
...
-->
## <a name="train-your-app-after-changing-model-with-utterances"></a>Train your app after changing model with utterances
