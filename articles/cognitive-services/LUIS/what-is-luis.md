...
---
# <a name="what-is-language-understanding-luis"></a>What is Language Understanding (LUIS)?
...
## <a name="use-luis-in-a-chat-bot"></a>Use LUIS in a chat bot
...
## <a name="build-the-luis-model"></a>Build the LUIS model
...
|"Schedule a meeting at __1pm__ with __Bob__ in Distribution"|ScheduleMeeting|1pm, Bob|
-->
## <a name="query-prediction-endpoint"></a>Query prediction endpoint
...
## <a name="improve-model-prediction"></a>Improve model prediction
...
## <a name="integrating-with-luis"></a>Integrating with LUIS
