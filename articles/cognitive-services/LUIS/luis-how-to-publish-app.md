...
---
# <a name="publish-your-trained-app"></a>Publish your trained app
...
## <a name="production-and-staging-slots"></a>Production and staging slots
...
## <a name="settings-configuration-requires-publishing-model"></a>Settings configuration requires publishing model
Publish to the endpoint after changes to the following settings. 

## <a name="external-services-settings"></a>External services settings
External service settings include **[Sentiment Analysis](#enable-sentiment-analysis)** and **[Speech Priming](#enable-speech-priming)**.

### <a name="enable-sentiment-analysis"></a>Enable sentiment analysis
...
### <a name="enable-speech-priming"></a>Enable speech priming 
...
## <a name="endpoint-url-settings"></a>Endpoint URL settings
...
### <a name="set-timezone-offset"></a>Set Timezone offset 
...
### <a name="include-all-predicted-intent-scores"></a>Include all predicted intent scores
...
### <a name="enable-bing-spell-checker"></a>Enable Bing spell checker 
...
## <a name="publish-your-trained-app-to-an-http-endpoint"></a>Publish your trained app to an HTTP endpoint
...
## <a name="assign-key"></a>Assign key
...
## <a name="endpoint-url-construction"></a>Endpoint URL construction
...
### <a name="optional-query-string-parameters"></a>Optional query string parameters
...
## <a name="test-your-published-endpoint-in-a-browser"></a>Test your published endpoint in a browser
