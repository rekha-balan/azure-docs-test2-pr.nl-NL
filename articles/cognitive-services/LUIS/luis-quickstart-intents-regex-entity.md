...
---
# <a name="tutorial-3-add-regular-expression-entity"></a>Tutorial: 3. Add regular expression entity
...
## <a name="purpose-of-the-regular-expression-entity"></a>Purpose of the regular expression entity
...
### <a name="tokenization-with-hyphens"></a>Tokenization with hyphens
...
## <a name="add-findform-intent"></a>Add FindForm intent
...
## <a name="create-an-hrf-number-regular-expression-entity"></a>Create an HRF-number regular expression entity 
