...
---
# <a name="usage-data-for-luis-service-from-azure-cloud-shell"></a>Usage data for LUIS service from Azure Cloud Shell
...
## <a name="cloud-shell-storage-account-and-authentication"></a>Cloud shell storage account and authentication
...
## <a name="open-cloud-shell"></a>Open Cloud Shell
...
## <a name="luis-endpoint-usage-information"></a>LUIS endpoint usage information
