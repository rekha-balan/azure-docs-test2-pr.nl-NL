...
---
# <a name="web-app-bot-using-the-luis-template-for-c"></a>Web App Bot using the LUIS template for C#
...
## <a name="change-code-to-homeautomation-intents"></a>Change code to HomeAutomation intents
...
## <a name="build-the-bot"></a>Build the bot
...
## <a name="download-the-bot-to-debug"></a>Download the bot to debug
