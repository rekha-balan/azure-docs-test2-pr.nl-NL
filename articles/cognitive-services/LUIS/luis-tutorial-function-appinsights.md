...
## <a name="web-app-bot-with-luis"></a>Web app bot with LUIS
...
## <a name="add-application-insights-library-to-web-app-bot"></a>Add Application Insights library to web app bot
...
## <a name="capture-and-send-luis-query-results-to-application-insights"></a>Capture and send LUIS query results to Application Insights
