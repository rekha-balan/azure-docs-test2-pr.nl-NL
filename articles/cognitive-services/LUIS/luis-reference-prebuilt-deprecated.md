...
---
# <a name="deprecated-entities"></a>Deprecated entities
...
## <a name="geography-culture"></a>Geography culture
**Geography** is available only in the `en-us` locale.

#### <a name="3-geography-subtypes"></a>3 Geography subtypes
...
## <a name="encyclopedia-culture"></a>Encyclopedia culture
**Encyclopedia** is available only in the `en-US` locale.

#### <a name="encyclopedia-subtypes"></a>Encyclopedia subtypes
