...
ms.locfileid: "44965660"
---
# <a name="deprecated-entities"></a><span data-ttu-id="4b15e-103">Deprecated entities</span><span class="sxs-lookup"><span data-stu-id="4b15e-103">Deprecated entities</span></span>
<span data-ttu-id="4b15e-104">The following prebuilt entities are deprecated and can't be added to new LUIS apps.</span><span class="sxs-lookup"><span data-stu-id="4b15e-104">The following prebuilt entities are deprecated and can't be added to new LUIS apps.</span></span>

* <span data-ttu-id="4b15e-105">**Datetime**: Existing LUIS apps that use **datetime** should be migrated to **datetimeV2**, although the datetime entity continues to function in pre-existing apps that use it.</span><span class="sxs-lookup"><span data-stu-id="4b15e-105">**Datetime**: Existing LUIS apps that use **datetime** should be migrated to **datetimeV2**, although the datetime entity continues to function in pre-existing apps that use it.</span></span>
* <span data-ttu-id="4b15e-106">**Geography**: Existing LUIS apps that use **geography** is supported until December 2018.</span><span class="sxs-lookup"><span data-stu-id="4b15e-106">**Geography**: Existing LUIS apps that use **geography** is supported until December 2018.</span></span>
* <span data-ttu-id="4b15e-107">**Encyclopedia**: Existing LUIS apps that use **encyclopedia** is supported until December 2018.</span><span class="sxs-lookup"><span data-stu-id="4b15e-107">**Encyclopedia**: Existing LUIS apps that use **encyclopedia** is supported until December 2018.</span></span>

## <a name="geography-culture"></a><span data-ttu-id="4b15e-108">Geography culture</span><span class="sxs-lookup"><span data-stu-id="4b15e-108">Geography culture</span></span>
<span data-ttu-id="4b15e-109">**Geography** is available only in the `en-us` locale.</span><span class="sxs-lookup"><span data-stu-id="4b15e-109">**Geography** is available only in the `en-us` locale.</span></span>

#### <a name="3-geography-subtypes"></a><span data-ttu-id="4b15e-110">3 Geography subtypes</span><span class="sxs-lookup"><span data-stu-id="4b15e-110">3 Geography subtypes</span></span>

<span data-ttu-id="4b15e-111">Prebuilt entity</span><span class="sxs-lookup"><span data-stu-id="4b15e-111">Prebuilt entity</span></span>   |   <span data-ttu-id="4b15e-112">Example utterance</span><span class="sxs-lookup"><span data-stu-id="4b15e-112">Example utterance</span></span>   |   <span data-ttu-id="4b15e-113">JSON</span><span class="sxs-lookup"><span data-stu-id="4b15e-113">JSON</span></span>
------|------|------|
...
## <a name="encyclopedia-culture"></a><span data-ttu-id="4b15e-114">Encyclopedia culture</span><span class="sxs-lookup"><span data-stu-id="4b15e-114">Encyclopedia culture</span></span>
<span data-ttu-id="4b15e-115">**Encyclopedia** is available only in the `en-US` locale.</span><span class="sxs-lookup"><span data-stu-id="4b15e-115">**Encyclopedia** is available only in the `en-US` locale.</span></span>

#### <a name="encyclopedia-subtypes"></a><span data-ttu-id="4b15e-116">Encyclopedia subtypes</span><span class="sxs-lookup"><span data-stu-id="4b15e-116">Encyclopedia subtypes</span></span>
<span data-ttu-id="4b15e-117">Encyclopedia built-in entity includes over 100 sub-types in the following table: In addition, encyclopedia entities often map to multiple types.</span><span class="sxs-lookup"><span data-stu-id="4b15e-117">Encyclopedia built-in entity includes over 100 sub-types in the following table: In addition, encyclopedia entities often map to multiple types.</span></span> <span data-ttu-id="4b15e-118">For example, the query Ronald Reagan yields:</span><span class="sxs-lookup"><span data-stu-id="4b15e-118">For example, the query Ronald Reagan yields:</span></span> 
...
<span data-ttu-id="4b15e-119">Prebuilt entity</span><span class="sxs-lookup"><span data-stu-id="4b15e-119">Prebuilt entity</span></span>   |   <span data-ttu-id="4b15e-120">Prebuilt entity (sub-types)</span><span class="sxs-lookup"><span data-stu-id="4b15e-120">Prebuilt entity (sub-types)</span></span>   |   <span data-ttu-id="4b15e-121">Example utterance</span><span class="sxs-lookup"><span data-stu-id="4b15e-121">Example utterance</span></span>
------|------|------|
...
<span data-ttu-id="4b15e-122">\`\`\`builtin.encyclopedia.organization.organization</span><span class="sxs-lookup"><span data-stu-id="4b15e-122">\`\`\`builtin.encyclopedia.organization.organization</span></span> |<span data-ttu-id="4b15e-123">builtin.encyclopedia.government.political_party</span><span class="sxs-lookup"><span data-stu-id="4b15e-123">builtin.encyclopedia.government.political_party</span></span>|<span data-ttu-id="4b15e-124">pertubuhan kebangsaan melayu singapura\`\`\`</span><span class="sxs-lookup"><span data-stu-id="4b15e-124">pertubuhan kebangsaan melayu singapura\`\`\`</span></span>|
...
## <a name="next-steps"></a><span data-ttu-id="4b15e-125">Next steps</span><span class="sxs-lookup"><span data-stu-id="4b15e-125">Next steps</span></span>

<span data-ttu-id="4b15e-126">Learn about the [dimension](luis-reference-prebuilt-dimension.md), [email](luis-reference-prebuilt-email.md) entities, and [number](luis-reference-prebuilt-number.md).</span><span class="sxs-lookup"><span data-stu-id="4b15e-126">Learn about the [dimension](luis-reference-prebuilt-dimension.md), [email](luis-reference-prebuilt-email.md) entities, and [number](luis-reference-prebuilt-number.md).</span></span> 
