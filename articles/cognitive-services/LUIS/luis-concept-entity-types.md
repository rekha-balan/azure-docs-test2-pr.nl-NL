...
## <a name="entities-are-optional-but-highly-recommended"></a>Entities are optional but highly recommended
...
## <a name="label-for-word-meaning"></a>Label for word meaning
...
## <a name="entities-are-shared-across-intents"></a>Entities are shared across intents
...
## <a name="assign-entities-in-none-intent"></a>Assign entities in None intent
...
## <a name="data-matching-multiple-list-entities"></a>Data matching multiple List entities
