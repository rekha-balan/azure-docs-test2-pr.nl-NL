...
---
# <a name="use-phrase-lists-to-boost-signal-of-word-list"></a>Use phrase lists to boost signal of word list
...
## <a name="add-phrase-list"></a>Add phrase list
...
## <a name="pattern-regular-expression-feature"></a>Pattern (regular expression) feature 
