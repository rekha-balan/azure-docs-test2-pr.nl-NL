...
## <a name="luis-authoring"></a>LUIS authoring

### <a name="what-are-the-luis-best-practices"></a>What are the LUIS best practices? 
Start with the [Authoring Cycle](luis-concept-app-iteration.md), then read the [best practices](luis-concept-best-practices.md). 

### <a name="what-is-the-best-way-to-start-building-my-app-in-luis"></a>What is the best way to start building my app in LUIS?
...
### <a name="how-can-i-correct-spelling-mistakes-in-utterances"></a>How can I correct spelling mistakes in utterances?
...
### <a name="how-do-i-edit-my-luis-app-programmatically"></a>How do I edit my LUIS app programmatically?
...
### <a name="where-is-the-pattern-feature-that-provided-regular-expression-matching"></a>Where is the Pattern feature that provided regular expression matching?
The previous **Pattern feature** is currently deprecated, replaced by **[Patterns](luis-concept-patterns.md)**. 

### <a name="how-do-i-use-an-entity-to-pull-out-the-correct-data"></a>How do I use an entity to pull out the correct data? 
See [entities](luis-concept-entity-types.md) and [data extraction](luis-concept-data-extraction.md).

### <a name="should-variations-of-an-example-utterance-include-punctuation"></a>Should variations of an example utterance include punctuation? 
...
### <a name="does-luis-currently-support-cortana"></a>Does LUIS currently support Cortana?

Cortana prebuilt apps were deprecated in 2017. They are no longer supported. 

## <a name="luis-endpoint"></a>LUIS endpoint

### <a name="why-does-luis-add-spaces-to-the-query-around-or-in-the-middle-of-words"></a>Why does LUIS add spaces to the query around or in the middle of words?
...
### <a name="how-do-i-create-and-assign-a-luis-endpoint-key"></a>How do I create and assign a LUIS endpoint key?
...
### <a name="how-do-i-interpret-luis-scores"></a>How do I interpret LUIS scores? 
...
### <a name="why-dont-i-see-my-endpoint-hits-in-my-apps-dashboard"></a>Why don't I see my endpoint hits in my app's Dashboard?
...
### <a name="my-luis-app-was-working-yesterday-but-today-im-getting-403-errors-i-didnt-change-the-app-how-do-i-fix-it"></a>My LUIS app was working yesterday but today I'm getting 403 errors. I didn't change the app. How do I fix it? 
...
### <a name="how-do-i-secure-my-luis-endpoint"></a>How do I secure my LUIS endpoint? 
See [Securing the endpoint](luis-concept-security.md#securing-the-endpoint).

## <a name="working-within-luis-limits"></a>Working within LUIS limits

### <a name="what-is-the-maximum-number-of-intents-and-entities-that-a-luis-app-can-support"></a>What is the maximum number of intents and entities that a LUIS app can support?
See the [boundaries](luis-boundaries.md) reference.

### <a name="i-want-to-build-a-luis-app-with-more-than-the-maximum-number-of-intents-what-should-i-do"></a>I want to build a LUIS app with more than the maximum number of intents. What should I do?

See [Best practices for intents](luis-concept-intent.md#if-you-need-more-than-the-maximum-number-of-intents).

### <a name="i-want-to-build-an-app-in-luis-with-more-than-the-maximum-number-of-entities-what-should-i-do"></a>I want to build an app in LUIS with more than the maximum number of entities. What should I do?

See [Best practices for entities](luis-concept-entity-types.md#if-you-need-more-than-the-maximum-number-of-entities)

### <a name="what-are-the-limits-on-the-number-and-size-of-phrase-lists"></a>What are the limits on the number and size of phrase lists?
For the maximum length of a [phrase list](./luis-concept-feature.md), see the [boundaries](luis-boundaries.md) reference.

### <a name="what-are-the-limits-on-example-utterances"></a>What are the limits on example utterances?
See the [boundaries](luis-boundaries.md) reference.

## <a name="testing-and-training"></a>Testing and training
...
### <a name="when-an-app-is-exported-then-reimported-into-a-new-app-with-a-new-app-id-the-luis-prediction-scores-are-different-why-does-this-happen"></a>When an app is exported then reimported into a new app (with a new app ID), the LUIS prediction scores are different. Why does this happen? 

See [Prediction differences between copies of same app](luis-concept-prediction-score.md#differences-with-predictions).

## <a name="app-publishing"></a>App publishing

### <a name="what-is-the-tenant-id-in-the-add-a-key-to-your-app-window"></a>What is the tenant ID in the "Add a key to your app" window?
...
### <a name="why-are-there-more-endpoint-keys-on-my-apps-publish-page-than-i-assigned-to-the-app"></a>Why are there more endpoint keys on my app's publish page than I assigned to the app? 
...
## <a name="app-management"></a>App management

### <a name="how-do-i-transfer-ownership-of-a-luis-app"></a>How do I transfer ownership of a LUIS app?
...
### <a name="how-do-i-download-a-log-of-user-utterances"></a>How do I download a log of user utterances?
...
### <a name="how-can-i-disable-the-logging-of-utterances"></a>How can I disable the logging of utterances?
...
### <a name="why-dont-i-want-all-my-endpoint-utterances-logged"></a>Why don't I want all my endpoint utterances logged?
...
### <a name="can-i-delete-data-from-luis"></a>Can I delete data from LUIS? 
...
### <a name="does-microsoft-access-my-luis-app-data-for-its-own-purposes-for-example-to-enhance-luis-or-microsoft-in-general"></a>Does Microsoft access my LUIS app data for its own purposes, for example, to enhance LUIS or Microsoft in general? 
...
## <a name="language-and-translation-support"></a>Language and translation support 

### <a name="i-have-an-app-in-one-language-and-want-to-create-a-parallel-app-in-another-language-what-is-the-easiest-way-to-do-so"></a>I have an app in one language and want to create a parallel app in another language. What is the easiest way to do so?
1. Export your app.
...
## <a name="app-notification"></a>App notification

### <a name="why-did-i-get-an-email-saying-im-almost-out-of-quota"></a>Why did I get an email saying I'm almost out of quota?
...
## <a name="integrating-luis"></a>Integrating LUIS

### <a name="where-is-my-luis-app-created-during-the-azure-web-app-bot-subscription-process"></a>Where is my LUIS app created during the Azure web app bot subscription process?
...
### <a name="what-luis-regions-support-bot-framework-speech-priming"></a>What LUIS regions support Bot Framework speech priming?
...
### <a name="is-luis-available-on-premises-or-in-private-cloud"></a>Is LUIS available on-premises or in private cloud?
No. 


### <a name="at-the-build-2018-conference-i-heard-about-a-language-understanding-feature-or-demo-but-i-dont-remember-what-it-was-called"></a>At the Build 2018 Conference, I heard about a Language Understanding feature or demo but I don't remember what it was called? 
