...
---
# <a name="authoring-and-endpoint-user-access"></a>Authoring and endpoint user access
...
## <a name="access-to-authoring"></a>Access to authoring
...
## <a name="access-to-endpoint"></a>Access to endpoint
...
### <a name="private-app-endpoint-security"></a>Private app endpoint security
...
### <a name="public-app-endpoint-access"></a>Public app endpoint access
...
## <a name="microsoft-user-accounts"></a>Microsoft user accounts
...
-->
## <a name="securing-the-endpoint"></a>Securing the endpoint 
