...
---
# <a name="quickstart-change-model-using-python"></a>Quickstart: Change model using Python
...
### <a name="add-utterances-from-the-command-line"></a>Add utterances from the command-line
