...
## <a name="create-a-language-understanding-bot-with-bot-service"></a>Create a Language Understanding bot with Bot Service
...
## <a name="try-the-default-bot"></a>Try the default bot
...
## <a name="install-npm-resources"></a>Install NPM resources
...
## <a name="test-in-web-chat"></a>Test in Web Chat
...
## <a name="connect-your-luis-app-to-the-bot"></a>Connect your LUIS app to the bot
...
## <a name="modify-the-bot-code"></a>Modify the bot code
...
## <a name="add-a-dialog-that-matches-homeautomationturnon"></a>Add a dialog that matches HomeAutomation.TurnOn
...
## <a name="add-a-dialog-that-matches-homeautomationturnoff"></a>Add a dialog that matches HomeAutomation.TurnOff
...
```
## <a name="test-the-bot"></a>Test the bot
...
<!-- From trying the bot, you can see that the recognizer can trigger interruption of the currently active dialog. Allowing and handling interruptions is a flexible design that accounts for what users really do. Learn more about the various actions you can associate with a recognized intent.--> You can try to add other intents, like Help, Cancel, and Greeting, to the LUIS app. Then add dialogs for the new intents and test them using the bot. 
