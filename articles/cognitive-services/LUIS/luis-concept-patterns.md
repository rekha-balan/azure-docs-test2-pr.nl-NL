...
---
# <a name="patterns-improve-prediction-accuracy"></a>Patterns improve prediction accuracy
...
## <a name="patterns-solve-low-intent-confidence"></a>Patterns solve low intent confidence
...
## <a name="patterns-are-not-a-guarantee-of-intent"></a>Patterns are not a guarantee of intent
...
## <a name="patterns-do-not-improve-entity-detection"></a>Patterns do not improve entity detection
...
## <a name="patterns-use-entity-roles"></a>Patterns use entity roles
...
## <a name="prediction-scores-with-and-without-patterns"></a>Prediction scores with and without patterns
...
### <a name="syntax-to-add-an-entity-to-a-pattern-template"></a>Syntax to add an entity to a pattern template
...
### <a name="syntax-to-add-an-entity-and-role-to-a-pattern-template"></a>Syntax to add an entity and role to a pattern template
...
### <a name="syntax-to-add-a-patternany-to-pattern-template"></a>Syntax to add a pattern.any to pattern template
...
### <a name="explicit-lists"></a>Explicit lists
...
### <a name="syntax-to-mark-optional-text-in-a-template-utterance"></a>Syntax to mark optional text in a template utterance
...
## <a name="patterns-only"></a>Patterns only
