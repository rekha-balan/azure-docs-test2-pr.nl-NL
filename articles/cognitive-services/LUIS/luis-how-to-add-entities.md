...
---
# <a name="manage-entities"></a>Manage entities
...
## <a name="add-prebuilt-entity"></a>Add prebuilt entity
...
## <a name="add-regular-expression-entities"></a>Add regular expression entities
...
## <a name="add-patternany-entities"></a>Add Pattern.any entities
...
## <a name="add-role-to-pattern-based-entity"></a>Add role to pattern-based entity
...
## <a name="add-list-entities"></a>Add list entities
...
## <a name="import-list-entity-values"></a>Import list entity values
...
## <a name="edit-entity-name"></a>Edit entity name
...
## <a name="changing-entity-type"></a>Changing entity type
...
## <a name="search-utterances"></a>Search utterances
You can search and filter utterances with the magnifying glass icon on the toolbar. 

## <a name="train-your-app-after-changing-model-with-entities"></a>Train your app after changing model with entities
