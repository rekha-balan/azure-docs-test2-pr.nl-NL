...
---
# <a name="quickstart-call-a-luis-endpoint-using-python"></a>Quickstart: Call a LUIS endpoint using Python
...
## <a name="understand-what-luis-returns"></a>Understand what LUIS returns
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-python"></a>Consume a LUIS result using the Endpoint API with Python
