...
---
# <a name="batch-testing-with-a-set-of-example-utterances"></a>Batch testing with a set of example utterances
 Batch testing is a comprehensive test on your current trained model to measure its performance in LUIS. 

<a name="batch-testing"></a>
## <a name="import-a-dataset-file-for-batch-testing"></a>Import a dataset file for batch testing
...
## <a name="run-rename-export-or-delete-dataset"></a>Run, rename, export, or delete dataset
...
## <a name="run-a-batch-test-on-your-trained-app"></a>Run a batch test on your trained app
...
## <a name="view-batch-test-results"></a>View batch test results 
...
## <a name="filter-chart-results"></a>Filter chart results
...
## <a name="view-single-point-utterance-data"></a>View single-point utterance data
...
## <a name="view-section-data"></a>View section data
