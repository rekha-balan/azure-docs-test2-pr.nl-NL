...
---
# <a name="find-endpoint-region-with-nodejs"></a>Find endpoint region with Node.js
...
## <a name="luis-endpoint-query-strategy"></a>LUIS endpoint query strategy
...
## <a name="nodejs-code-to-find-region"></a>Node.js code to find region
