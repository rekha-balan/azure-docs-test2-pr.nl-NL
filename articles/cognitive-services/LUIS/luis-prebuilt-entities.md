...
---
# <a name="prebuilt-entities-to-recognize-common-data-types"></a>Prebuilt entities to recognize common data types
...
## <a name="add-a-prebuilt-entity"></a>Add a prebuilt entity
...
## <a name="use-a-prebuilt-number-entity"></a>Use a prebuilt number entity
...
```
## <a name="use-a-prebuilt-datetimev2-entity"></a>Use a prebuilt datetimeV2 entity
