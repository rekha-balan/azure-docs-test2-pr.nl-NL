...
---
# <a name="tutorial-review-endpoint-utterances"></a>Tutorial: Review endpoint utterances
...
## <a name="purpose-of-reviewing-endpoint-utterances"></a>Purpose of reviewing endpoint utterances
...
## <a name="add-new-job-name-to-phrase-list"></a>Add new job name to phrase list
...
## <a name="query-the-endpoint-with-an-utterance"></a>Query the endpoint with an utterance
...
## <a name="can-reviewing-be-replaced-by-adding-more-utterances"></a>Can reviewing be replaced by adding more utterances? 
...
## <a name="why-is-the-top-intent-on-the-utterance-list"></a>Why is the top intent on the utterance list? 
