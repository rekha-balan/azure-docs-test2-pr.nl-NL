...
---
# <a name="integrate-speech-service"></a>Integrate Speech service
...
## <a name="create-luis-endpoint-key"></a>Create LUIS endpoint key
In the Azure portal, [create](luis-how-to-azure-subscription.md#create-luis-endpoint-key) a **Language Understanding** (LUIS) key. 

## <a name="import-human-resources-luis-app"></a>Import Human Resources LUIS app
...
## <a name="add-keyphrase-prebuilt-entity"></a>Add KeyPhrase prebuilt entity
...
## <a name="audio-device"></a>Audio device
...
## <a name="download-the-luis-sample-project"></a>Download the LUIS Sample project
...
## <a name="modify-the-c-code"></a>Modify the C# code
...
## <a name="test-code-with-utterance"></a>Test code with utterance
