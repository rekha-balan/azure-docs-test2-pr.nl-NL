...
---
# <a name="use-a-list-entity-to-increase-entity-detection"></a>Use a list entity to increase entity detection 
...
## <a name="use-homeautomation-app"></a>Use HomeAutomation app
...
## <a name="use-a-list-entity"></a>Use a list entity
...
## <a name="create-a-list-entity"></a>Create a list entity
...
```
## <a name="publish-the-model"></a>Publish the model
...
## <a name="query-the-app"></a>Query the app 
