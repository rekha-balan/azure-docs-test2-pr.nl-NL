...
---
# <a name="add-luis-results-to-application-insights-from-a-web-app-bot"></a>Add LUIS results to Application Insights from a web app bot
...
## <a name="review-luis-web-app-bot"></a>Review LUIS web app bot
...
## <a name="download-web-app-bot"></a>Download web app bot
...
## <a name="open-solution-in-visual-studio-2017"></a>Open solution in Visual Studio 2017
...
## <a name="add-application-insights-to-the-project"></a>Add Application Insights to the project
...
## <a name="build-and-resolve-errors"></a>Build and resolve errors
...
## <a name="publish-project-to-azure"></a>Publish project to Azure
...
## <a name="open-three-browser-tabs"></a>Open three browser tabs
...
## <a name="modify-basicluisdialogcs-code"></a>Modify BasicLuisDialog.cs code
...
## <a name="build-web-app-bot"></a>Build web app bot
...
## <a name="test-the-web-app-bot"></a>Test the web app bot
...
## <a name="view-luis-entries-in-application-insights"></a>View LUIS entries in Application Insights
...
## <a name="query-application-insights-for-intent-score-and-utterance"></a>Query Application Insights for intent, score, and utterance
...
## <a name="learn-more-about-bot-framework"></a>Learn more about Bot Framework
