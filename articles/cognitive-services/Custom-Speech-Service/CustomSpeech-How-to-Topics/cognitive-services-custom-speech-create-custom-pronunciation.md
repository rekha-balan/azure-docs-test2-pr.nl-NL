...
## <a name="supported-pronunciation-characters"></a>Supported pronunciation characters
...
>[NOTE] A term's display form (in a pronunciation file) should be written the same way in a language adaptation data set.
