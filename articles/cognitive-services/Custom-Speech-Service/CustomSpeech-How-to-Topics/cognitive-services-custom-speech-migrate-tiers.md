...
---
# <a name="migrate-deployments-to-the-new-pricing-model"></a>Migrate deployments to the new pricing model
...
## <a name="step-2-select-your-new-pricing-tier-in-the-azure-portal"></a>Step 2: Select your new pricing tier in the Azure portal
...
## <a name="step-3-check-the-migration-status-in-the-custom-speech-service-portal"></a>Step 3: Check the migration status in the Custom Speech Service portal
