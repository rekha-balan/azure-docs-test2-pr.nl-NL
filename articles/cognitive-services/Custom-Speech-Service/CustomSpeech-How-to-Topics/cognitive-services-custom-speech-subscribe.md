...
---
# <a name="obtain-subscription-keys"></a>Obtain subscription keys
...
## <a name="get-a-subscription-key"></a>Get a subscription key
...
## <a name="get-a-subscription-id"></a>Get a subscription ID
