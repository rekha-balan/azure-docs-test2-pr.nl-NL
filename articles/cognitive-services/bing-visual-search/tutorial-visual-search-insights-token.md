...
---
# <a name="tutorial-bing-visual-search-sdk-imageinsightstoken-and-results"></a>Tutorial: Bing Visual Search SDK ImageInsightsToken and results
...
## <a name="get-the-imageinsightstoken-from-image-search"></a>Get the ImageInsightsToken from Image Search
...
## <a name="specify-the-imageinsightstoken-for-visual-search-request"></a>Specify the ImageInsightsToken for Visual Search request
...
```
## <a name="use-visual-search-to-find-images-from-an-imageinsightstoken"></a>Use Visual Search to find images from an ImageInsightsToken
...
## <a name="get-the-url-data-from-imagemoduleaction"></a>Get the URL data from ImageModuleAction
...
## <a name="pagesincluding-actiontype-urls-of-images-found-by-visual-search"></a>PagesIncluding ActionType URLs of images found by Visual Search
