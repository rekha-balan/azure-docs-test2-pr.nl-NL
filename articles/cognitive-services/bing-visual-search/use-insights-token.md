...
---
# <a name="using-an-insights-token-to-get-insights-about-an-image"></a>Using an insights token to get insights about an image
...
## <a name="using-java"></a>Using Java
...
## <a name="using-nodejs"></a>Using Node.js
...
## <a name="using-python"></a>Using Python
