...
---
# <a name="tutorial-bing-visual-search-sdk-image-crop-area-and-results"></a>Tutorial: Bing Visual Search SDK image crop area and results
...
## <a name="image-and-crop-area"></a>Image and crop area
...
## <a name="specify-the-crop-area-as-imageinfo-in-visualsearchrequest"></a>Specify the crop area as ImageInfo in VisualSearchRequest
...
```
## <a name="search-for-images-similar-to-crop-area"></a>Search for images similar to crop area
