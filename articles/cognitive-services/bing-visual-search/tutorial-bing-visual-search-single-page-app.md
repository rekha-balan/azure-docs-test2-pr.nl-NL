...
---
# <a name="tutorial-visual-search-single-page-web-app"></a>Tutorial: Visual Search Single-page Web app
...
## <a name="call-bing-visual-search"></a>Call Bing Visual Search
...
## <a name="capture-insights-token"></a>Capture insights token
...
## <a name="display-similar-images"></a>Display similar images
