...
---
# <a name="examples-of-bing-insights-usage"></a>Examples of Bing insights usage

This section contains examples of how Bing might display insights on Bing.com.

## <a name="pagesincluding-insight-example"></a>PagesIncluding insight example
...
## <a name="shoppingsources-insight-example"></a>ShoppingSources insight example
...
## <a name="visualsearch-insight-example"></a>VisualSearch insight example
...
## <a name="recipes-insight-example"></a>Recipes insight example
...
## <a name="relatedsearches-insight-example"></a>RelatedSearches insight example
...
## <a name="entity-insight-example"></a>Entity insight example
...
## <a name="displaying-other-insights-that-the-user-might-explore"></a>Displaying other insights that the user might explore
...
## <a name="bounding-boxes-and-hot-spots"></a>Bounding boxes and hot spots
