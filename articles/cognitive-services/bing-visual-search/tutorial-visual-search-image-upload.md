...
---
# <a name="tutorial-breaking-down-bing-visual-search-upload"></a>Tutorial: Breaking down Bing Visual Search upload
...
## <a name="get-the-file-to-upload"></a>Get the file to upload
...
## <a name="what-else-is-needed-before-making-the-call-to-bing"></a>What else is needed before making the call to Bing?
...
## <a name="making-the-call"></a>Making the call
...
## <a name="handling-the-response"></a>Handling the response
...
## <a name="adding-styles-to-make-the-page-display-correctly"></a>Adding styles to make the page display correctly
