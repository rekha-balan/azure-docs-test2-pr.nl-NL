...
# <a name="get-started-with-the-knowledge-exploration-service"></a>Get started with the Knowledge Exploration Service
...
## <a name="define-the-schema"></a>Define the schema
...
## <a name="generate-data"></a>Generate data
...
## <a name="build-a-compressed-binary-index"></a>Build a compressed binary index
...
## <a name="use-an-xml-grammar-specification"></a>Use an XML grammar specification
...
## <a name="compile-the-grammar"></a>Compile the grammar
...
## <a name="host-the-grammar-and-index-in-a-web-service"></a>Host the grammar and index in a web service
...
<a name="scaling-up"></a>
## <a name="scale-up-to-host-larger-indices"></a>Scale up to host larger indices
...
## <a name="deploy-the-service"></a>Deploy the service
