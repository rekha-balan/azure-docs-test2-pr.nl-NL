...
---
# <a name="how-to-detect-language-in-text-analytics"></a>How to detect language in Text Analytics
...
### <a name="ambiguous-content"></a>Ambiguous content
...
```
### <a name="mixed-language-content"></a>Mixed language content
