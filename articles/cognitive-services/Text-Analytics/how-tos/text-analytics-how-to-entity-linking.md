...
---
# <a name="how-to-identify-linked-entities-in-text-analytics-preview"></a>How to identify linked entities in Text Analytics (Preview)
...
## <a name="entity-linking-vs-named-entity-recognition"></a>Entity Linking vs. Named Entity Recognition
...
## <a name="step-1-structure-the-request"></a>Step 1: Structure the request
...
## <a name="step-2-post-the-request"></a>Step 2: Post the request
...
## <a name="step-3-view-results"></a>Step 3: View results
