...
---
# <a name="connect-to-the-text-analytics-service-by-using-connected-services-in-visual-studio"></a>Connect to the Text Analytics Service by using Connected Services in Visual Studio
...
## <a name="add-support-to-your-project-for-the-text-analytics-service"></a>Add support to your project for the Text Analytics Service
...
## <a name="use-the-text-analytics-service-to-detect-the-language-for-a-text-sample"></a>Use the Text Analytics Service to detect the language for a text sample.
