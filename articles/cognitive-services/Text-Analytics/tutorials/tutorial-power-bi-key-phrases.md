...
---
# <a name="text-analytics-with-power-bi"></a>Text Analytics with Power BI
...
## <a name="loading-customer-data"></a>Loading customer data
...
## <a name="understanding-the-api"></a>Understanding the API
...
## <a name="creating-a-custom-function"></a>Creating a custom function
...
## <a name="using-the-function"></a>Using the function
...
## <a name="authentication-and-privacy"></a>Authentication and privacy
...
## <a name="creating-the-word-cloud"></a>Creating the word cloud
...
## <a name="more-text-analytics-services"></a>More Text Analytics services
