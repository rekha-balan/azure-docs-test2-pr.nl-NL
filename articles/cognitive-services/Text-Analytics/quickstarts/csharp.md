...
---
# <a name="quickstart-using-c-to-call-the-text-analytics-cognitive-service"></a>Quickstart: Using C# to call the Text Analytics Cognitive Service
<a name="HOLTop"></a>
...
## <a name="install-the-nuget-sdk-package"></a>Install the NuGet SDK package
...
## <a name="call-the-text-analytics-api-by-using-the-sdk"></a>Call the Text Analytics API by using the SDK
...
## <a name="extract-key-phrases"></a>Extract key phrases
...
## <a name="analyze-sentiment"></a>Analyze sentiment
...
## <a name="identify-linked-entities"></a>Identify linked entities
