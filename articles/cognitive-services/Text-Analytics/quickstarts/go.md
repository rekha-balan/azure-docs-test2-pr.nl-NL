...
---
# <a name="quickstart-using-go-to-call-the-text-analytics-cognitive-service"></a>Quickstart: Using Go to call the Text Analytics Cognitive Service
<a name="HOLTop"></a>
...
## <a name="detect-language-request"></a>Detect language request
...
## <a name="detect-language-response"></a>Detect language response
...
## <a name="analyze-sentiment-request"></a>Analyze sentiment request
...
## <a name="analyze-sentiment-response"></a>Analyze sentiment response
...
## <a name="extract-key-phrases-request"></a>Extract key phrases request
...
## <a name="extract-key-phrases-response"></a>Extract key phrases response
...
## <a name="identify-linked-entities-request"></a>Identify linked entities request
...
## <a name="identify-linked-entities-response"></a>Identify linked entities response
