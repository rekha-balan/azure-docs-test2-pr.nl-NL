...
---
# <a name="quickstart-using-python-to-call-the-text-analytics-cognitive-service"></a>Quickstart: Using Python to call the Text Analytics Cognitive Service
<a name="HOLTop"></a>
...
## <a name="detect-languages"></a>Detect languages
