...
---
# <a name="what-is-computer-vision-api-version-10"></a>What is Computer Vision API Version 1.0?
...
## <a name="tagging-images"></a>Tagging Images
...
```
## <a name="categorizing-images"></a>Categorizing Images
...
## <a name="identifying-image-types"></a>Identifying Image Types
...
## <a name="domain-specific-content"></a>Domain-Specific Content
...
## <a name="generating-descriptions"></a>Generating Descriptions 
...
## <a name="perceiving-color-schemes"></a>Perceiving Color Schemes
...
## <a name="flagging-adult-content"></a>Flagging Adult Content
...
## <a name="optical-character-recognition-ocr"></a>Optical Character Recognition (OCR)
...
## <a name="recognize-handwritten-text"></a>Recognize Handwritten Text
...
## <a name="generating-thumbnails"></a>Generating Thumbnails
