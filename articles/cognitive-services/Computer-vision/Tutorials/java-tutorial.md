...
---
# <a name="computer-vision-api-java-tutorial"></a>Computer Vision API Java tutorial
...
## <a name="import-the-tutorial-project"></a>Import the tutorial project
...
## <a name="add-the-tutorial-code"></a>Add the tutorial code
...
## <a name="analyze-an-image"></a>Analyze an image
...
### <a name="analyze-step-1-add-the-event-handler-code-for-the-form-button"></a>Analyze step 1: Add the event handler code for the form button
...
### <a name="analyze-step-2-add-the-wrapper-for-the-rest-api-call"></a>Analyze step 2: Add the wrapper for the REST API call
...
### <a name="analyze-step-3-run-the-application"></a>Analyze step 3: Run the application
...
## <a name="recognize-a-landmark"></a>Recognize a landmark
...
### <a name="landmark-step-1-add-the-event-handler-code-for-the-form-button"></a>Landmark step 1: Add the event handler code for the form button
...
### <a name="landmark-step-2-add-the-wrapper-for-the-rest-api-call"></a>Landmark step 2: Add the wrapper for the REST API call
...
### <a name="landmark-step-3-run-the-application"></a>Landmark step 3: Run the application
...
## <a name="recognize-celebrities"></a>Recognize celebrities
...
### <a name="celebrities-step-1-add-the-event-handler-code-for-the-form-button"></a>Celebrities step 1: Add the event handler code for the form button
...
### <a name="celebrities-step-2-add-the-wrapper-for-the-rest-api-call"></a>Celebrities step 2: Add the wrapper for the REST API call
...
### <a name="celebrities-step-3-run-the-application"></a>Celebrities step 3: Run the application
...
## <a name="intelligently-generate-a-thumbnail"></a>Intelligently generate a thumbnail
...
### <a name="thumbnail-step-1-add-the-event-handler-code-for-the-form-button"></a>Thumbnail step 1: Add the event handler code for the form button
...
### <a name="thumbnail-step-2-add-the-wrapper-for-the-rest-api-call"></a>Thumbnail step 2: Add the wrapper for the REST API call
...
### <a name="thumbnail-step-3-run-the-application"></a>Thumbnail step 3: Run the application
...
## <a name="read-printed-text-ocr"></a>Read printed text (OCR)
...
### <a name="ocr-step-1-add-the-event-handler-code-for-the-form-button"></a>OCR step 1: Add the event handler code for the form button
...
### <a name="ocr-step-2-add-the-wrapper-for-the-rest-api-call"></a>OCR step 2: Add the wrapper for the REST API call
...
### <a name="ocr-step-3-run-the-application"></a>OCR step 3: Run the application
...
## <a name="read-handwritten-text-handwriting-recognition"></a>Read handwritten text (handwriting recognition)
...
### <a name="handwriting-recognition-step-1-add-the-event-handler-code-for-the-form-button"></a>Handwriting Recognition step 1: Add the event handler code for the form button
...
### <a name="handwriting-recognition-step-2-add-the-wrapper-for-the-rest-api-call"></a>Handwriting Recognition step 2: Add the wrapper for the REST API call
...
### <a name="handwriting-recognition-step-3-run-the-application"></a>Handwriting Recognition step 3: Run the application
