...
---
# <a name="connecting-to-cognitive-services-computer-vision-api-by-using-connected-services-in-visual-studio"></a>Connecting to Cognitive Services Computer Vision API by using Connected Services in Visual Studio
...
## <a name="add-support-to-your-project-for-cognitive-services-computer-vision-api"></a>Add support to your project for Cognitive Services Computer Vision API
...
## <a name="use-the-computer-vision-api-to-detect-attributes-of-an-image"></a>Use the Computer Vision API to detect attributes of an image
