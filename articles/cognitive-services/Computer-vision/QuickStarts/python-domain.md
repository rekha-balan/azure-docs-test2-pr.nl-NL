...
---
# <a name="quickstart-use-a-domain-model---rest-python---computer-vision"></a>Quickstart: Use a domain model - REST, Python - Computer Vision
...
## <a name="identify-celebrities-and-landmarks"></a>Identify celebrities and landmarks
...
## <a name="landmark-identification"></a>Landmark identification

### <a name="recognize-landmark-request"></a>Recognize Landmark request
...
### <a name="recognize-landmark-response"></a>Recognize Landmark response
...
## <a name="celebrity-identification"></a>Celebrity identification

### <a name="recognize-celebrity-request"></a>Recognize Celebrity request
...
### <a name="recognize-celebrity-response"></a>Recognize Celebrity response
