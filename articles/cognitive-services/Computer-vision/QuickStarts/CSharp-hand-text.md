...
---
# <a name="quickstart-extract-handwritten-text---rest-c35---computer-vision"></a>Quickstart: Extract handwritten text - REST, C&#35; - Computer Vision
...
## <a name="create-and-run-the-sample-application"></a>Create and run the sample application
...
## <a name="examine-the-response"></a>Examine the response
