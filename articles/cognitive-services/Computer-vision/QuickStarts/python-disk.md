...
---
# <a name="quickstart-analyze-a-local-image---rest-python---computer-vision"></a>Quickstart: Analyze a local image - REST, Python - Computer Vision
...
## <a name="analyze-a-local-image"></a>Analyze a local image
