...
---
# <a name="quickstart-extract-printed-text-ocr---rest-python---computer-vision"></a>Quickstart: Extract printed text (OCR) - REST, Python - Computer Vision
...
## <a name="extract-printed-text"></a>Extract printed text
