...
---
# <a name="quickstart-analyze-a-remote-image---rest-python---computer-vision"></a>Quickstart: Analyze a remote image - REST, Python - Computer Vision
...
## <a name="analyze-a-remote-image"></a>Analyze a remote image
...
## <a name="analyze-image-request"></a>Analyze Image request
...
## <a name="analyze-image-response"></a>Analyze Image response
