...
---
# <a name="quickstart-extract-handwritten-text---rest-python---computer-vision"></a>Quickstart: Extract handwritten text - REST, Python - Computer Vision
...
## <a name="extract-handwritten-text"></a>Extract handwritten text
...
## <a name="recognize-text-request"></a>Recognize Text request
...
## <a name="recognize-text-response"></a>Recognize Text response
