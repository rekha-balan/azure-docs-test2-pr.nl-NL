...
---
# <a name="use-custom-vision-api-to-build-an-object-detection-project-with-python"></a>Use Custom Vision API to build an object detection project with Python
...
## <a name="step-1-get-the-training-and-prediction-keys"></a>Step 1: Get the training and prediction keys
