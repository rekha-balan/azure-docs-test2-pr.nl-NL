...
---
# <a name="use-custom-vision-api-to-build-an-image-classification-project-with-java"></a>Use Custom Vision API to build an image classification project with Java
...
## <a name="add-tags-to-your-project"></a>Add tags to your project
