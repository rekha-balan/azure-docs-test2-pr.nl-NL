...
---
# <a name="export-your-model-for-use-with-mobile-devices"></a>Export your model for use with mobile devices
...
## <a name="convert-to-a-compact-domain"></a>Convert to a compact domain
...
## <a name="export-your-model"></a>Export your model
