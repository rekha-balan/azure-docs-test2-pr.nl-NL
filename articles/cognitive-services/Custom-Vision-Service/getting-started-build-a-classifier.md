...
---
# <a name="how-to-build-a-classifier-with-custom-vision"></a>How to build a classifier with Custom Vision
...
## <a name="upload-and-tag-images"></a>Upload and tag images
...
## <a name="train-and-evaluate-the-classifier"></a>Train and evaluate the classifier
