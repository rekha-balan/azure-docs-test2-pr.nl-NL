...
---
# <a name="tutorial-use-the-custom-vision-rest-api"></a>Tutorial: Use the Custom Vision REST API
...
### <a name="specific-domains"></a>Specific domains
...
## <a name="add-images"></a>Add images
...
## <a name="test-the-model"></a>Test the model
...
## <a name="export-the-model"></a>Export the model
...
### <a name="request-a-model-export"></a>Request a model export
...
### <a name="download-the-exported-model"></a>Download the exported model
