...
---
# <a name="test-and-retrain-a-model-with-custom-vision-service"></a>Test and retrain a model with Custom Vision Service
...
## <a name="use-the-predicted-image-for-training"></a>Use the predicted image for training.
