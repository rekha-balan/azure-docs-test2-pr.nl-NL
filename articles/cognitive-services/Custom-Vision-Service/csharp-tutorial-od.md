...
---
# <a name="use-custom-vision-api-to-build-an-object-detection-project-in-c35"></a>Use Custom Vision API to build an object detection project in C&#35; 
...
### <a name="get-the-custom-vision-sdk-and-samples"></a>Get the Custom Vision SDK and samples
...
## <a name="step-1-create-a-console-application"></a>Step 1: Create a console application
...
## <a name="step-2-create-a-custom-vision-service-project"></a>Step 2: Create a Custom Vision Service project
...
## <a name="step-3-add-tags-to-your-project"></a>Step 3: Add tags to your project
...
## <a name="step-4-upload-images-to-the-project"></a>Step 4: Upload images to the project
...
## <a name="step-5-train-the-project"></a>Step 5: Train the project
...
## <a name="step-6-get-and-use-the-default-prediction-endpoint"></a>Step 6: Get and use the default prediction endpoint
...
## <a name="step-7-run-the-example"></a>Step 7: Run the example
