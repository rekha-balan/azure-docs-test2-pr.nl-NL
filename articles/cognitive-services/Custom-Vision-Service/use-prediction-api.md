...
---
# <a name="use-the-prediction-endpoint-to-test-images-programmatically-with-a-custom-vision-service-classifier"></a>Use the prediction endpoint to test images programmatically with a Custom Vision Service classifier
...
## <a name="get-the-url-and-prediction-key"></a>Get the URL and prediction key
