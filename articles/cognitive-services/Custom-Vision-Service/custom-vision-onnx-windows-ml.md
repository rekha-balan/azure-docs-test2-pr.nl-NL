...
---
# <a name="tutorial-use-an-onnx-model-from-custom-vision-with-windows-ml-preview"></a>Tutorial: Use an ONNX model from Custom Vision with Windows ML (preview)
...
## <a name="about-the-example-app"></a>About the example app
...
### <a name="the-model-class-file"></a>The model class file
...
### <a name="camera-access"></a>Camera access
...
## <a name="get-the-example-code"></a>Get the example code
...
## <a name="use-your-own-model"></a>Use your own model
