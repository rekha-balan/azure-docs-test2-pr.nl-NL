...
---
# <a name="create-a-new-knowledge-base-in-go"></a>Create a new knowledge base in Go
...
## <a name="the-create-knowledge-base-response"></a>The create knowledge base response
