...
---
# <a name="publish-a-knowledge-base-in-python"></a>Publish a knowledge base in Python
...
## <a name="the-publish-a-knowledge-base-response"></a>The publish a knowledge base response
