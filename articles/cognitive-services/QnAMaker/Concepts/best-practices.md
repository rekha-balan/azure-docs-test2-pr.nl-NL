...
## <a name="rankingmatching"></a>Ranking/Matching
...
### <a name="use-metadata-filters"></a>Use metadata filters
...
### <a name="use-synonyms"></a>Use synonyms
...
### <a name="use-distinct-words-to-differentiate-questions"></a>Use distinct words to differentiate questions
