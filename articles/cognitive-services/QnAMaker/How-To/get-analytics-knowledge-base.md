...
---
# <a name="get-analytics-on-your-knowledge-base"></a>Get analytics on your knowledge base
...
## <a name="run-queries-for-other-analytics-on-your-qna-maker-knowledge-base"></a>Run queries for other analytics on your QnA Maker knowledge base

### <a name="total-90-day-traffic"></a>Total 90-day traffic
...
### <a name="total-question-traffic-in-a-given-time-period"></a>Total question traffic in a given time period
...
### <a name="user-traffic"></a>User traffic
...
### <a name="latency-distribution-of-questions"></a>Latency distribution of questions
