...
---
# <a name="using-metadata-and-the-generateanswer-api"></a>Using metadata and the GenerateAnswer API
...
### <a name="generateanswer-request"></a>GenerateAnswer request
...
### <a name="generateanswer-response"></a>GenerateAnswer Response
...
## <a name="metadata-example"></a>Metadata example
...
### <a name="filter-results-with-strictfilters"></a>Filter results with strictFilters
...
### <a name="keep-context"></a>Keep context
