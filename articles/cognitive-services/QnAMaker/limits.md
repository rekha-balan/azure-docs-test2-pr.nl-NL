...
---
# <a name="qna-maker-limits"></a>QnA Maker Limits
...
## <a name="extraction-limits"></a>Extraction Limits
...
## <a name="metadata-limits"></a>Metadata Limits
...
## <a name="knowledge-base-content-limits"></a>Knowledge Base content limits
...
## <a name="create-knowledge-base-call-limits"></a>Create Knowledge base call limits:
...
## <a name="update-knowledge-base-call-limits"></a>Update Knowledge base call limits
