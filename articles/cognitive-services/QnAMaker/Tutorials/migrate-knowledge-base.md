...
---
# <a name="migrate-a-knowledge-base-using-export-import"></a>Migrate a knowledge base using export-import
...
## <a name="migrate-a-knowledge-base-from-qna-maker-preview-portal"></a>Migrate a knowledge base from QnA Maker Preview portal
...
## <a name="chatlogs-and-alterations"></a>Chatlogs and alterations
