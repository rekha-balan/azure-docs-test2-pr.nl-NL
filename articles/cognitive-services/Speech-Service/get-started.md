...
---
# <a name="try-the-speech-service-for-free"></a>Try the Speech service for free
...
## <a name="new-azure-account"></a>New Azure account
...
## <a name="create-a-speech-resource-in-azure"></a>Create a Speech resource in Azure
