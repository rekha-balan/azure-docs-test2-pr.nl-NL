...
---
# <a name="tutorial-create-a-custom-acoustic-model"></a>Tutorial: Create a custom acoustic model
...
### <a name="transcriptions-for-the-audio-dataset"></a>Transcriptions for the audio dataset
...
## <a name="import-the-acoustic-dataset"></a>Import the acoustic dataset
...
## <a name="create-a-custom-acoustic-model"></a>Create a custom acoustic model
