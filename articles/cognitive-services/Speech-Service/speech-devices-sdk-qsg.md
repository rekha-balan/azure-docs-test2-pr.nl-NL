...
---
# <a name="get-started-with-the-speech-devices-sdk"></a>Get started with the Speech Devices SDK
...
## <a name="set-up-the-development-kit"></a>Set up the development kit
...
## <a name="run-a-sample-application"></a>Run a sample application
...
### <a name="certificate-failures"></a>Certificate failures
