...
ms.date: 07/16/2018
ms.author: wolfma
ms.openlocfilehash: e294ed71625aa938989df317d7d34d5ac3fef0c1
ms.sourcegitcommit: d1451406a010fd3aa854dc8e5b77dc5537d8050e
ms.translationtype: MT
ms.contentlocale: nl-NL
ms.lasthandoff: 09/13/2018
ms.locfileid: "44855667"
---
# <a name="recognize-intents-from-speech-by-using-the-speech-sdk-for-c"></a><span data-ttu-id="a0883-103">Recognize intents from speech by using the Speech SDK for C++</span><span class="sxs-lookup"><span data-stu-id="a0883-103">Recognize intents from speech by using the Speech SDK for C++</span></span>
...
<span data-ttu-id="a0883-104">Look for the code that's used in this article in the samples/cpp/windows/console folder.</span><span class="sxs-lookup"><span data-stu-id="a0883-104">Look for the code that's used in this article in the samples/cpp/windows/console folder.</span></span>

## <a name="next-steps"></a><span data-ttu-id="a0883-105">Next steps</span><span class="sxs-lookup"><span data-stu-id="a0883-105">Next steps</span></span>

- [<span data-ttu-id="a0883-106">How to recognize speech</span><span class="sxs-lookup"><span data-stu-id="a0883-106">How to recognize speech</span></span>](how-to-recognize-speech-cpp.md)
- [<span data-ttu-id="a0883-107">How to translate speech</span><span class="sxs-lookup"><span data-stu-id="a0883-107">How to translate speech</span></span>](how-to-translate-speech-cpp.md)
