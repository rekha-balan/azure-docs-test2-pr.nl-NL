...
---
# <a name="speech-to-text-frequently-asked-questions"></a>Speech to Text frequently asked questions
...
## <a name="creating-an-acoustic-model"></a>Creating an acoustic model
...
## <a name="accuracy-testing"></a>Accuracy testing
...
**A**: WER is the evaluation metric for speech recognition. WER is counted as the total number of errors, which includes insertions, deletions, and substitutions, divided by the total number of words in the reference transcription. For more information, see [word error rate](https://en.wikipedia.org/wiki/Word_error_rate).
...
## <a name="creating-a-language-model"></a>Creating a language model
