...
---
# <a name="speech-service-rest-apis"></a>Speech service REST APIs
...
### <a name="getting-a-token-http"></a>Getting a token: HTTP
...
### <a name="getting-a-token-powershell"></a>Getting a token: PowerShell
...
### <a name="getting-a-token-curl"></a>Getting a token: cURL
...
### <a name="getting-a-token-c"></a>Getting a token: C#
...
### <a name="using-a-token"></a>Using a token
...
### <a name="renewing-authorization"></a>Renewing authorization
