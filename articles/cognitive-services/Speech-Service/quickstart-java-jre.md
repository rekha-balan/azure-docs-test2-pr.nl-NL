...
---
# <a name="quickstart-recognize-speech-in-java-on-windows-or-linux-using-the-speech-sdk"></a>Quickstart: Recognize speech in Java on Windows or Linux using the Speech SDK
