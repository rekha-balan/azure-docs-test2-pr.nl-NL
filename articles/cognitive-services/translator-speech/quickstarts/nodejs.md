...
---
# <a name="quickstart-for-microsoft-translator-speech-api-with-nodejs"></a>Quickstart for Microsoft Translator Speech API with Node.js 
<a name="HOLTop"></a>
...
## <a name="translate-speech"></a>Translate speech
