...
## <a name="3-query-languages"></a>3. Query languages
...
## <a name="5-process-the-results"></a>5. Process the results
...
### <a name="sending-audio"></a>Sending audio
...
### <a name="partial-result"></a>Partial result
...
### <a name="closing-the-connection"></a>Closing the connection
...
### <a name="response-messages"></a>Response messages
