...
ms.locfileid: "44968684"
---
# <a name="tutorial-single-page-web-app"></a><span data-ttu-id="7f96c-103">Tutorial: Single-page Web app</span><span class="sxs-lookup"><span data-stu-id="7f96c-103">Tutorial: Single-page Web app</span></span>

<span data-ttu-id="7f96c-104">This is the complete source code discussed in the [single-page app tutorial](spellcheck.md) for the Bing Spell Check API.</span><span class="sxs-lookup"><span data-stu-id="7f96c-104">This is the complete source code discussed in the [single-page app tutorial](spellcheck.md) for the Bing Spell Check API.</span></span> <span data-ttu-id="7f96c-105">To run the app, copy the source code into a text editor and save the file as `spellcheck.html`.</span><span class="sxs-lookup"><span data-stu-id="7f96c-105">To run the app, copy the source code into a text editor and save the file as `spellcheck.html`.</span></span> <span data-ttu-id="7f96c-106">Then open the saved file in your Web browser.</span><span class="sxs-lookup"><span data-stu-id="7f96c-106">Then open the saved file in your Web browser.</span></span>
