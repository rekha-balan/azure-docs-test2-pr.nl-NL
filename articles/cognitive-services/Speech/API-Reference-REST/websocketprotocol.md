...
---
# <a name="speech-service-websocket-protocol"></a>Speech Service WebSocket protocol
...
## <a name="connection-establishment"></a>Connection establishment
...
### <a name="speech-endpoints"></a>Speech endpoints
...
### <a name="report-connection-problems"></a>Report connection problems
...
### <a name="text-websocket-messages"></a>Text WebSocket messages
...
### <a name="binary-websocket-messages"></a>Binary WebSocket messages
...
## <a name="client-originated-messages"></a>Client-originated messages
...
#### <a name="detect-end-of-speech"></a>Detect end of speech
...
### <a name="received-message-time-stamps"></a>Received message time stamps
...
### <a name="metric-connection"></a>Metric `Connection`
...
### <a name="metric-microphone"></a>Metric `Microphone`
...
### <a name="metric-listeningtrigger"></a>Metric `ListeningTrigger`
...
#### <a name="requestid-values"></a>RequestId values
...
#### <a name="requestid-reuse"></a>RequestId reuse
...
### <a name="websocket-error-codes"></a>WebSocket error codes
