...
---
# <a name="authenticate-to-the-speech-api"></a>Authenticate to the Speech API
...
## <a name="use-a-subscription-key"></a>Use a subscription key
...
## <a name="use-an-authorization-token"></a>Use an authorization token
...
### <a name="get-an-authorization-token"></a>Get an authorization token
...
### <a name="use-an-authorization-token-in-a-request"></a>Use an authorization token in a request
...
### <a name="renew-an-authorization-token"></a>Renew an authorization token
