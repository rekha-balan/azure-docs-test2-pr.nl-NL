...
---
# <a name="get-started-with-speech-recognition-by-using-the-rest-api"></a>Get started with speech recognition by using the REST API
...
### <a name="subscribe-to-the-speech-api-and-get-a-free-trial-subscription-key"></a>Subscribe to the Speech API, and get a free trial subscription key
...
### <a name="prerecorded-audio-file"></a>Prerecorded audio file
...
## <a name="build-a-recognition-request-and-send-it-to-the-speech-recognition-service"></a>Build a recognition request, and send it to the speech recognition service
...
### <a name="send-a-request-to-the-service"></a>Send a request to the service
...
## <a name="process-the-speech-recognition-response"></a>Process the speech recognition response
