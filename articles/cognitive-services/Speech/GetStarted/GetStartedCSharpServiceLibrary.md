...
---
# <a name="get-started-with-the-speech-recognition-service-library-in-c35-for-net-windows"></a>Get started with the speech recognition service library in C&#35; for .NET Windows
...
### <a name="get-the-sample-application"></a>Get the sample application
...
## <a name="step-1-install-the-sample-application"></a>Step 1: Install the sample application
...
## <a name="step-2-build-the-sample-application"></a>Step 2: Build the sample application

Press Ctrl+Shift+B, or select **Build** on the ribbon menu. Then select **Build Solution**.

## <a name="step-3-run-the-sample-application"></a>Step 3: Run the sample application
...
## <a name="samples-explained"></a>Samples explained
...
### <a name="speech-input"></a>Speech input
...
### <a name="speech-request"></a>Speech request
...
### <a name="speech-recognition-events"></a>Speech recognition events
...
## <a name="connection-management"></a>Connection management
...
## <a name="buffering-behavior"></a>Buffering behavior
