...
---
# <a name="get-started-with-the-speech-recognition-api-in-c35-for-net-on-windows"></a>Get started with the Speech Recognition API in C&#35; for .NET on Windows
...
### <a name="recognition-events"></a>Recognition events
