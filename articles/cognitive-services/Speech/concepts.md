...
## <a name="understanding-speech-recognition"></a>Understanding speech recognition
...
### <a name="audio-streams"></a>Audio streams
...
### <a name="end-of-speech"></a>End of speech
...
### <a name="asynchronous-service-responses"></a>Asynchronous service responses
...
### <a name="speech-application-states"></a>Speech application states
...
## <a name="using-the-speech-recognition-service-from-your-apps"></a>Using the speech recognition service from your apps
...
## <a name="transcription-responses"></a>Transcription responses
...
### <a name="profanity-value-masked"></a>Profanity value `Masked`
...
### <a name="profanity-value-removed"></a>Profanity value `Removed`
...
### <a name="profanity-value-raw"></a>Profanity value `Raw`
