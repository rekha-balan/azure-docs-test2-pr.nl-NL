...
## <a name="response-status-codes"></a>Response status codes
...
### <a name="translate-a-single-input"></a>Translate a single input
...
### <a name="translate-a-single-input-with-language-auto-detection"></a>Translate a single input with language auto-detection
...
### <a name="translate-with-transliteration"></a>Translate with transliteration
...
### <a name="translate-multiple-pieces-of-text"></a>Translate multiple pieces of text
...
### <a name="translate-to-multiple-languages"></a>Translate to multiple languages
...
### <a name="handle-profanity"></a>Handle profanity
...
### <a name="translate-content-with-markup-and-decide-whats-translated"></a>Translate content with markup and decide what's translated
...
### <a name="obtain-alignment-information"></a>Obtain alignment information
...
### <a name="obtain-sentence-boundaries"></a>Obtain sentence boundaries
...
### <a name="translate-with-dynamic-dictionary"></a>Translate with dynamic dictionary
