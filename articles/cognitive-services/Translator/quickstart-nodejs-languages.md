...
---
# <a name="quickstart-get-supported-languages-with-nodejs"></a>Quickstart: Get supported languages with Node.js
...
## <a name="languages-request"></a>Languages request
...
## <a name="languages-response"></a>Languages response
