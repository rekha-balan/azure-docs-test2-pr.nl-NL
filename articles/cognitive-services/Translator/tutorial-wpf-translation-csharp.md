...
---
# <a name="tutorial-write-a-wpf-application-for-translator-text-using-c35"></a>Tutorial: Write a WPF application for Translator Text using C&#35;
...
## <a name="the-translation-app"></a>The translation app
...
## <a name="the-mainwindow-class"></a>The MainWindow class
...
## <a name="get-supported-languages"></a>Get supported languages
...
## <a name="populate-the-language-menus"></a>Populate the language menus
...
## <a name="perform-translation"></a>Perform translation
