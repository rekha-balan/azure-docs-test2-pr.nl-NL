...
---
# <a name="how-to-use-collaborative-translation-framework-ctf-reporting"></a>How to use Collaborative Translation Framework (CTF) reporting
...
The endpoint of the CTF Reporting API is http://api.microsofttranslator.com/v2/beta/ctfreporting.svc
...
## <a name="getusertranslations-method"></a>GetUserTranslations method
