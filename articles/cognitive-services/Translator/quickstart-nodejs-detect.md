...
---
# <a name="quickstart-identify-language-from-text-with-nodejs"></a>Quickstart: Identify language from text with Node.js
...
## <a name="detect-request"></a>Detect request
...
## <a name="detect-response"></a>Detect response
