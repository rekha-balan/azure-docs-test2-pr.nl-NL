...
---
# <a name="supported-languages-in-the-microsoft-translator-text-api"></a>Supported languages in the Microsoft Translator Text API
...
## <a name="languages-detected-by-the-detect-method"></a>Languages detected by the Detect method
