...
---
# <a name="microsoft-translator-text-api-v2-to-v3-migration"></a>Microsoft Translator Text API V2 to V3 Migration
...
## <a name="summary-of-features"></a>Summary of features
...
## <a name="move-to-json-format"></a>Move to JSON format
...
## <a name="v3-end-points"></a>V3 End Points
...
## <a name="v3-api-text-translations-methods"></a>V3 API text translations methods
