...
---
# <a name="bing-video-search-sdk-java-quickstart"></a>Bing Video Search SDK Java quickstart
...
Get a [Cognitive Services access key](https://azure.microsoft.com/try/cognitive-services/) under **Search**. Install the Bing Video Search SDK dependencies by using Maven, Gradle, or another dependency management system. The Maven POM file requires the declaration:
```
  <dependencies>
    <dependency>
