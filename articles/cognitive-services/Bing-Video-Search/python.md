...
---
# <a name="quickstart-for-bing-video-search-api-with-python"></a>Quickstart for Bing Video Search API with Python
...
## <a name="running-the-walkthrough"></a>Running the walkthrough
...
## <a name="see-also"></a>See also 
 ...
 [Searching the web for videos](search-the-web.md) [Try it](https://azure.microsoft.com/services/cognitive-services/bing-video-search-api/)
