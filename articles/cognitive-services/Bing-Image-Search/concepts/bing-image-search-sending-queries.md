...
---
# <a name="send-queries-to-the-bing-image-search-api"></a>Send queries to the Bing Image Search API
...
## <a name="use-and-suggest-search-terms"></a>Use and suggest search terms
...
## <a name="pivot-the-query"></a>Pivot the query
...
## <a name="expand-the-query"></a>Expand the query
