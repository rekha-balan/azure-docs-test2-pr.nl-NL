...
---
# <a name="tutorial-bing-image-upload-for-insights"></a>Tutorial: Bing image upload for insights
...
## <a name="webclient-and-headers-for-the-post-request"></a>WebClient and headers for the POST request
...
## <a name="upload-the-image-and-get-results"></a>Upload the image and get results
...
```
## <a name="get-request-using-the-imageinsightstoken"></a>GET Request using the ImageInsightsToken
