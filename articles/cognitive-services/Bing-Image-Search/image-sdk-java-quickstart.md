...
---
# <a name="quickstart-request-and-filter-images-using-the-sdk-and-java"></a>Quickstart: Request and filter images using the SDK and Java
...
Get a [Cognitive Services access key](https://azure.microsoft.com/try/cognitive-services/) under **Search**. Install the Bing Image Search SDK dependencies by using Maven, Gradle, or another dependency management system. The Maven POM file requires the declaration:
```
 <dependencies>
    <dependency>
