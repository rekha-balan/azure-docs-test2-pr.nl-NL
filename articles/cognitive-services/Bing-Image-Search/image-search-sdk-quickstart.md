...
---
# <a name="quickstart-request-and-filter-images-using-the-sdk-and-c"></a>Quickstart: Request and filter images using the SDK and C#
...
## <a name="search-options"></a>Search options
...
### <a name="search-using-a-filter"></a>Search using a filter
...
### <a name="trending-images"></a>Trending images
...
### <a name="image-details"></a>Image details
