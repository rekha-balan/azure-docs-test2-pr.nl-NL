...
---
# <a name="quickstart-send-search-queries-using-the-rest-api-and-nodejs"></a>Quickstart: Send search queries using the REST API and Node.js
...
## <a name="json-response"></a>JSON response
