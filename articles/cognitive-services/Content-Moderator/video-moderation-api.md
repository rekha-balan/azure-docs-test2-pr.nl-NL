...
## <a name="sign-up-for-the-content-moderator-media-processor-preview"></a>Sign up for the Content Moderator media processor (preview)

### <a name="create-a-free-azure-account"></a>Create a free Azure account
...
### <a name="get-azure-active-directory-credentials"></a>Get Azure Active Directory credentials
...
## <a name="net-quickstart-with-visual-studio-and-c"></a>.NET QuickStart with Visual Studio and C#
...
### <a name="create-a-preset-file-json"></a>Create a preset file (json)
...
### <a name="add-the-following-code-to-the-main-method"></a>Add the following code to the main method
...
### <a name="add-the-code-to-create-an-azure-media-context"></a>Add the code to create an Azure Media Context
...
### <a name="add-the-code-to-create-an-azure-storage-context"></a>Add the code to create an Azure Storage Context
...
### <a name="add-the-code-to-create-azure-media-assets-from-local-file-and-blob"></a>Add the code to create Azure Media Assets from local file and blob
...
### <a name="add-the-code-to-scan-a-collection-of-videos-as-blobs-within-a-container"></a>Add the code to scan a collection of videos (as blobs) within a container
...
### <a name="add-the-method-to-run-the-content-moderator-job"></a>Add the method to run the Content Moderator Job
...
### <a name="add-a-couple-of-helper-functions"></a>Add a couple of helper functions
