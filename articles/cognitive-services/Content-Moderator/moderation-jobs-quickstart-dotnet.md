...
---
# <a name="start-moderation-jobs-using-net"></a>Start moderation jobs using .NET
...
## <a name="define-a-custom-moderation-workflow"></a>Define a custom moderation workflow
...
> [!NOTE]
> You set the TeamName constant to the name you used when you created your Content Moderator subscription. You retrieve TeamName from the [Content Moderator web site](https://westus.contentmoderator.cognitive.microsoft.com/).
...
## <a name="add-code-to-auto-moderate-create-a-review-and-get-the-job-details"></a>Add code to auto-moderate, create a review, and get the job details
...
## <a name="see-the-sample-output-in-the-log-file"></a>See the sample output in the log file
