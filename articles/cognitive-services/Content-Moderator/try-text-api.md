...
---
# <a name="moderate-text-from-the-api-console"></a>Moderate text from the API console
...
## <a name="get-your-api-key"></a>Get your API key
...
## <a name="open-the-api-console"></a>Open the API console
...
## <a name="select-the-inputs"></a>Select the inputs
...
### <a name="sample-text-to-scan"></a>Sample text to scan
...
### <a name="text-classification-feature"></a>Text classification feature
...
### <a name="analyze-the-response"></a>Analyze the response
