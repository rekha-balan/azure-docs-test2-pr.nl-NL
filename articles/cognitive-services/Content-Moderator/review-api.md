...
---
# <a name="moderation-jobs-and-reviews"></a>Moderation jobs and reviews
...
## <a name="job-operations"></a>Job operations
...
### <a name="get-job-status"></a>Get job status
...
## <a name="review-operations"></a>Review operations

### <a name="create-reviews"></a>Create reviews
...
### <a name="get-review-status"></a>Get review status
