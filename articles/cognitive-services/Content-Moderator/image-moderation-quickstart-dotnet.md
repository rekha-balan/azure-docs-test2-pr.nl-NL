...
---
# <a name="moderate-images-using-net"></a>Moderate images using .NET
...
## <a name="store-the-analysis-results"></a>Store the analysis results

Add the following class to the **Program** class. Use an instance of this class to record the moderation results for the reviewed images.
...
## <a name="evaluate-an-individual-image"></a>Evaluate an individual image
...
## <a name="process-the-image-urls-in-your-code"></a>Process the image URLs in your code
...
## <a name="next-steps---get-the-source-code"></a>Next steps - get the source code
