...
---
# <a name="manage-credentials"></a>Manage credentials
...
## <a name="the-azure-portal"></a>The Azure portal
...
### <a name="use-the-azure-account-with-the-review-tool-and-review-api"></a>Use the Azure account with the review tool and review API
...
>
> Once you replace the two places in the review tool with the key and the Resource ID from your Azure subscription, your **Trial Ocp-Apim-Subscription-Key** displayed on the Credentials screen is no longer used, but is always available.
...
### <a name="use-the-azure-account-with-the-workflows-in-the-review-tool"></a>Use the Azure account with the workflows in the review tool
...
## <a name="the-review-tool"></a>The Review tool
