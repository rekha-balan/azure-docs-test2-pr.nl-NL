...
---
# <a name="moderation-workflows"></a>Moderation workflows
...
## <a name="your-first-workflow"></a>Your first workflow
...
### <a name="open-the-default-workflow"></a>Open the default workflow

Use the **edit** option to open the workflow editing page as shown in the following image: ![Content Moderator default workflow](images/default-workflow-listed.PNG)

### <a name="the-designer-view"></a>The designer view
...
### <a name="the-json-view"></a>The JSON view
...
### <a name="key-learning"></a>Key learning
...
## <a name="define-a-custom-workflow"></a>Define a custom workflow
...
### <a name="the-sample-image"></a>The sample image
...
### <a name="workflow-result"></a>Workflow result
...
## <a name="advanced-workflow-with-combination"></a>Advanced workflow with combination
...
## <a name="the-workflow-api"></a>The Workflow API
...
### <a name="get-all-workflow-details"></a>Get [All] workflow details
...
### <a name="create-or-update-workflow"></a>Create or update workflow
...
If the operation succeeds, the **Response status** is `200 OK` and the **Response content** box displays `true`. To learn more, [test drive the `Create` operation](try-review-api-job.md).
