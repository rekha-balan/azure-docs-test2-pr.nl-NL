...
---
# <a name="facebook-content-moderation-with-content-moderator"></a>Facebook content moderation with Content Moderator
...
## <a name="create-a-content-moderator-team"></a>Create a Content Moderator team

Refer to the [Quickstart](quick-start.md) page to sign up for Content Moderator and create a team.

## <a name="configure-image-moderation-workflow-threshold"></a>Configure image moderation workflow (threshold)
...
## <a name="3-configure-text-moderation-workflow-threshold"></a>3. Configure text moderation workflow (threshold)
...
## <a name="create-azure-functions"></a>Create Azure Functions
...
## <a name="configure-the-facebook-page-and-app"></a>Configure the Facebook page and App
