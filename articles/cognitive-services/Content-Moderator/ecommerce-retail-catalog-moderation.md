...
---
# <a name="ecommerce-catalog-moderation-with-machine-learning"></a>eCommerce catalog moderation with machine learning
...
## <a name="define-custom-tags"></a>Define custom tags
...
## <a name="list-your-api-keys-and-endpoints"></a>List your API keys and endpoints
...
## <a name="scan-for-adult-and-racy-content"></a>Scan for adult and racy content
...
## <a name="scan-for-celebrities"></a>Scan for celebrities
...
## <a name="classify-into-flags-toys-and-pens"></a>Classify into flags, toys, and pens
...
## <a name="reviews-for-human-in-the-loop"></a>Reviews for human-in-the-loop
...
## <a name="submit-batch-of-images"></a>Submit batch of images
...
## <a name="initiate-all-scans"></a>Initiate all scans
