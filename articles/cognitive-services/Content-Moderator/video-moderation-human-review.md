...
## <a name="video-trained-classifier-preview"></a>Video-trained classifier (preview)
...
## <a name="shot-detection"></a>Shot detection
...
## <a name="key-frame-detection"></a>Key frame detection
...
## <a name="visualization-for-human-reviews"></a>Visualization for human reviews
...
## <a name="player-view-for-video-level-review"></a>Player view for video-level review
...
## <a name="frames-view-for-detailed-reviews"></a>Frames view for detailed reviews
