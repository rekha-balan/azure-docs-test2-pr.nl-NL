...
---
# <a name="moderate-with-custom-image-lists-in-the-api-console"></a>Moderate with custom image lists in the API console
...
## <a name="refresh-search-index"></a>Refresh search index
...
## <a name="create-an-image-list"></a>Create an image list
...
## <a name="delete-images-and-lists"></a>Delete images and lists
...
## <a name="change-list-information"></a>Change list information
