...
---
# <a name="moderate-text-using-net"></a>Moderate text using .NET
...
## <a name="add-code-to-load-and-evaluate-the-input-text"></a>Add code to load and evaluate the input text
