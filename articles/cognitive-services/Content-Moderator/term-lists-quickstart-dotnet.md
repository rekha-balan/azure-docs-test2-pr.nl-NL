...
---
# <a name="moderate-with-custom-term-lists-in-net"></a>Moderate with custom term lists in .NET
...
### <a name="add-private-properties"></a>Add private properties
...
## <a name="create-a-term-list"></a>Create a term list
...
## <a name="update-term-list-name-and-description"></a>Update term list name and description
...
## <a name="add-a-term-to-a-term-list"></a>Add a term to a term list
...
## <a name="get-all-terms-in-a-term-list"></a>Get all terms in a term list
...
## <a name="add-code-to-refresh-the-search-index"></a>Add code to refresh the search index
...
## <a name="screen-text-using-a-term-list"></a>Screen text using a term list
...
## <a name="delete-terms-and-lists"></a>Delete terms and lists
...
### <a name="delete-a-term"></a>Delete a term
...
### <a name="delete-all-terms-in-a-term-list"></a>Delete all terms in a term list
...
### <a name="delete-a-term-list"></a>Delete a term list
...
## <a name="run-the-application-to-see-the-output"></a>Run the application to see the output
