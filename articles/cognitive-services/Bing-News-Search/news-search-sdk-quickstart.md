...
---
# <a name="news-search-sdk-c-quickstart"></a>News Search SDK C# quickstart
...
```
## <a name="recent-news-freshness-and-sortby-parameters"></a>Recent news, freshness and sortBy parameters
...
## <a name="category-news-safe-search"></a>Category news, safe search
...
```
## <a name="trending-topics"></a>Trending topics
