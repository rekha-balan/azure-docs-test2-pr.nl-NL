...
---
# <a name="connect-to-bing-news-search-api-by-using-connected-services-in-visual-studio"></a>Connect to Bing News Search API by using Connected Services in Visual Studio
...
## <a name="add-support-to-your-project-for-bing-news-search-api"></a>Add support to your project for Bing News Search API
...
## <a name="use-the-bing-news-search-api-to-add-search-functionality-to-a-web-page"></a>Use the Bing News Search API to add search functionality to a web page
