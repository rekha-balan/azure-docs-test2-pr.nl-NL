...
ms.locfileid: "44871132"
---
# <a name="tutorial-single-page-news-search-app"></a><span data-ttu-id="c3023-103">Tutorial: Single-page News Search app</span><span class="sxs-lookup"><span data-stu-id="c3023-103">Tutorial: Single-page News Search app</span></span>

<span data-ttu-id="c3023-104">This is the complete source code discussed in the [single-page app tutorial](tutorial-bing-news-search-single-page-app.md) for Bing News Search.</span><span class="sxs-lookup"><span data-stu-id="c3023-104">This is the complete source code discussed in the [single-page app tutorial](tutorial-bing-news-search-single-page-app.md) for Bing News Search.</span></span> <span data-ttu-id="c3023-105">To run the app, copy the source code into Notepad or another text editor and save it as `bing.html`.</span><span class="sxs-lookup"><span data-stu-id="c3023-105">To run the app, copy the source code into Notepad or another text editor and save it as `bing.html`.</span></span> <span data-ttu-id="c3023-106">Then open the saved file in Microsoft Edge or another popular browser.</span><span class="sxs-lookup"><span data-stu-id="c3023-106">Then open the saved file in Microsoft Edge or another popular browser.</span></span>
