...
---
# <a name="bing-news-search-sdk-java-quickstart"></a>Bing News Search SDK Java quickstart
...
Get a [Cognitive Services access key](https://azure.microsoft.com/try/cognitive-services/) under **Search**. Install the Bing News Search SDK dependencies by using Maven, Gradle, or another dependency management system. The Maven POM file requires the declaration:
```
  <dependencies>
    <dependency>
...
```
## <a name="news-search-client"></a>News Search client
