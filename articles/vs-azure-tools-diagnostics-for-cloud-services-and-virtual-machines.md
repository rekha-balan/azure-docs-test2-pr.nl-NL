...
---
# <a name="set-up-diagnostics-for-azure-cloud-services-and-virtual-machines"></a>Set up diagnostics for Azure Cloud Services and virtual machines
...
## <a name="migrate-projects-to-azure-sdk-26-and-later"></a>Migrate projects to Azure SDK 2.6 and later
...
### <a name="what-does-the-update-development-storage-connection-strings-check-box-do"></a>What does the "Update development storage connection strings..." check box do?
...
## <a name="turn-on-diagnostics-in-cloud-service-projects-before-you-deploy-them"></a>Turn on diagnostics in cloud service projects before you deploy them
...
### <a name="to-turn-on-diagnostics-in-visual-studio-before-deployment"></a>To turn on diagnostics in Visual Studio before deployment
...
## <a name="turn-on-diagnostics-on-azure-virtual-machines"></a>Turn on diagnostics on Azure virtual machines
In Visual Studio, you can collect diagnostics data for Azure virtual machines.

### <a name="to-turn-on-diagnostics-on-azure-virtual-machines"></a>To turn on diagnostics on Azure virtual machines
...
## <a name="set-up-diagnostics-data-sources"></a>Set up diagnostics data sources
...
## <a name="set-up-cloud-service-diagnostics-after-deployment"></a>Set up cloud service diagnostics after deployment
...
### <a name="to-set-up-diagnostics-for-a-running-cloud-service"></a>To set up diagnostics for a running cloud service
