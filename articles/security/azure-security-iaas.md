...
---
# <a name="security-best-practices-for-iaas-workloads-in-azure"></a>Security best practices for IaaS workloads in Azure
...
## <a name="use-privileged-access-workstations"></a>Use Privileged Access Workstations
...
## <a name="use-multi-factor-authentication"></a>Use Multi-Factor Authentication
...
## <a name="limit-and-constrain-administrative-access"></a>Limit and constrain administrative access
...
## <a name="use-devtest-labs"></a>Use DevTest Labs
...
## <a name="control-and-limit-endpoint-access"></a>Control and limit endpoint access
...
## <a name="use-a-key-management-solution"></a>Use a key management solution
...
## <a name="encrypt-virtual-disks-and-disk-storage"></a>Encrypt virtual disks and disk storage
...
## <a name="use-a-centralized-security-management-system"></a>Use a centralized security management system
...
## <a name="manage-operating-systems"></a>Manage operating systems
...
### <a name="harden-systems"></a>Harden systems
...
### <a name="install-and-manage-antimalware"></a>Install and manage antimalware
...
### <a name="install-the-latest-security-updates"></a>Install the latest security updates
...
### <a name="deploy-and-test-a-backup-solution"></a>Deploy and test a backup solution
