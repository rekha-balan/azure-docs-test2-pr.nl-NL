...
---
# <a name="securing-paas-web-and-mobile-applications-using-sql-database-and-sql-data-warehouse"></a>Securing PaaS web and mobile applications using SQL Database and SQL Data Warehouse
...
## <a name="azure-sql-database-and-sql-data-warehouse"></a>Azure SQL Database and SQL Data Warehouse
...
### <a name="use-a-centralized-identity-repository-for-authentication-and-authorization"></a>Use a centralized identity repository for authentication and authorization
...
### <a name="restrict-access-based-on-ip-address"></a>Restrict Access based on IP Address
...
### <a name="encryption-of-data-at-rest"></a>Encryption of data at rest
