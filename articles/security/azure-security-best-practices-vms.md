...
---
# <a name="best-practices-for-azure-vm-security"></a>Best practices for Azure VM security
...
## <a name="vm-authentication-and-access-control"></a>VM authentication and access control
...
## <a name="vm-availability-and-network-access"></a>VM availability and network access
...
## <a name="protect-data-at-rest-in-your-vms-by-enforcing-encryption"></a>Protect data at rest in your VMs by enforcing encryption
