...
ms.locfileid: "44554108"
---
# <a name="security-frame-input-validation--mitigations"></a>Security Frame: Input Validation | Mitigations 
...
| Attributes              | N/A  |
| References              | N/A  |
| Steps | Many javascript functions don't do encoding by default. When assigning untrusted input to DOM elaments via such functions, may result in cross site script (XSS) executions.| 
