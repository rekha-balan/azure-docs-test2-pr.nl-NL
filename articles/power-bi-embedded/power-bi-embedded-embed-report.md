...
---
# <a name="embed-a-report-in-power-bi-embedded"></a>Embed a report in Power BI Embedded
...
## <a name="using-the-access-keys-to-use-rest-apis"></a>Using the access keys to use REST APIs
...
## <a name="get-a-report-id"></a>Get a report id
...
### <a name="using-the-power-bi-net-sdk"></a>Using the Power BI .NET SDK
...
### <a name="calling-the-rest-api-directly"></a>Calling the REST API directly
...
### <a name="adding-permission-scopes-to-embed-tokens"></a>Adding permission scopes to embed tokens
...
## <a name="embed-using-javascript"></a>Embed using JavaScript
...
### <a name="set-the-size-of-embedded-elements"></a>Set the size of embedded elements
