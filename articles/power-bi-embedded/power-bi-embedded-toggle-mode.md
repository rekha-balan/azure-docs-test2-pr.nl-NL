...
---
# <a name="toggle-between-view-and-edit-mode-for-reports-in-power-bi-embedded"></a>Toggle between view and edit mode for reports in Power BI Embedded

Learn how to toggle between view and edit mode for your reports within Power BI Embedded.

## <a name="creating-an-access-token"></a>Creating an access token
...
## <a name="embed-configuration"></a>Embed configuration
