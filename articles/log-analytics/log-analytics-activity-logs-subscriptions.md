...
---
# <a name="collect-azure-activity-logs-into-log-analytics-across-subscriptions"></a>Collect Azure Activity Logs into Log Analytics across subscriptions
...
## <a name="step-1---create-an-event-hub"></a>Step 1 - Create an Event Hub
...
## <a name="step-2---export-activity-logs-to-event-hub"></a>Step 2 - Export Activity Logs to Event Hub
...
## <a name="step-3---create-logic-app"></a>Step 3 - Create Logic App
...
### <a name="logic-app-requirements"></a>Logic App Requirements
...
### <a name="create-a-new-blank-logic-app"></a>Create a new blank Logic App
...
### <a name="add-parse-json-action"></a>Add Parse JSON action
...
### <a name="add-compose-action"></a>Add Compose action
...
### <a name="add-log-analytics-send-data-action"></a>Add Log Analytics Send Data action
...
## <a name="step-4---test-and-troubleshoot-the-logic-app"></a>Step 4 - Test and troubleshoot the Logic App
...
## <a name="step-5---view-azure-activity-log-in-log-analytics"></a>Step 5 - View Azure Activity Log in Log Analytics
