...
---
# <a name="collect-data-about-azure-virtual-machines"></a>Collect data about Azure Virtual Machines
...
## <a name="enable-the-log-analytics-vm-extension"></a>Enable the Log Analytics VM Extension
...
## <a name="collect-event-and-performance-data"></a>Collect event and performance data
...
### <a name="data-collection-from-windows-vm"></a>Data collection from Windows VM
...
### <a name="data-collection-from-linux-vm"></a>Data collection from Linux VM
...
## <a name="view-data-collected"></a>View data collected
