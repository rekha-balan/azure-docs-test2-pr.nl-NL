...
---
# <a name="wire-data-20-preview-solution-in-log-analytics"></a>Wire Data 2.0 (Preview) solution in Log Analytics
...
#### <a name="oracle-enterprise-linux-with-unbreakable-enterprise-kernel"></a>Oracle Enterprise Linux with Unbreakable Enterprise Kernel
...
### <a name="install-the-dependency-agent-on-windows"></a>Install the Dependency Agent on Windows
...
2. Download the Linux Dependency Agent using the link in the previous section and then install it as root by using the following command: sh InstallDependencyAgent-Linux64.bin
...
```
### <a name="uninstall-the-dependency-agent"></a>Uninstall the Dependency Agent

Use the following sections to help you remove the Dependency Agent.

#### <a name="uninstall-the-dependency-agent-on-windows"></a>Uninstall the Dependency Agent on Windows
...
#### <a name="uninstall-the-dependency-agent-on-linux"></a>Uninstall the Dependency Agent on Linux
...
## <a name="using-the-wire-data-20-solution"></a>Using the Wire Data 2.0 solution
...
## <a name="output-data"></a>Output data
