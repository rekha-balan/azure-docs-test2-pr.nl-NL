...
---
# <a name="application-insights-connector-management-solution-preview"></a>Application Insights Connector management solution (Preview)
...
### <a name="view-application-insights-connector-information"></a>View Application Insights Connector information
...
### <a name="view-the-application-insights-perspective-with-log-search"></a>View the Application Insights perspective with log search
...
### <a name="pivot-to-an-app-in-the-azure-portal"></a>Pivot to an app in the Azure portal
...
### <a name="sample-corrected-data"></a>Sample-corrected data
...
### <a name="generic-fields"></a>Generic fields
...
### <a name="availability-specific-fields"></a>Availability-specific fields
...
### <a name="exception-specific-fields"></a>Exception-specific fields
...
### <a name="request-specific-fields"></a>Request-specific fields
