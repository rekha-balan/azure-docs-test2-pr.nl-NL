...
## <a name="use-the-dns-analytics-solution"></a>Use the DNS Analytics solution
...
### <a name="search-by-using-dns-analytics-log-search"></a>Search by using DNS Analytics Log Search
