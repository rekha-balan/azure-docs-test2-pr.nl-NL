...
---
# <a name="collect-data-from-collectd-on-linux-agents-in-log-analytics"></a>Collect data from CollectD on Linux agents in Log Analytics
...
## <a name="versions-supported"></a>Versions supported
...
### <a name="configure-collectd-to-forward-data"></a>Configure CollectD to forward data 
...
## <a name="collectd-metrics-to-log-analytics-schema-conversion"></a>CollectD metrics to Log Analytics schema conversion
