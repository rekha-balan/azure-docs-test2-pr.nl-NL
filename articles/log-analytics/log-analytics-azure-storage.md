...
---
# <a name="collect-azure-service-logs-and-metrics-for-use-in-log-analytics"></a>Collect Azure service logs and metrics for use in Log Analytics
...
## <a name="azure-diagnostics-direct-to-log-analytics"></a>Azure diagnostics direct to Log Analytics
...
### <a name="enable-diagnostics-with-powershell"></a>Enable diagnostics with PowerShell
...
### <a name="enable-diagnostics-with-resource-manager-templates"></a>Enable diagnostics with Resource Manager templates
...
## <a name="azure-diagnostics-to-storage-then-to-log-analytics"></a>Azure diagnostics to storage then to Log Analytics
...
## <a name="connectors-for-azure-services"></a>Connectors for Azure services
...
## <a name="scripts-to-collect-and-post-data-to-log-analytics"></a>Scripts to collect and post data to Log Analytics
