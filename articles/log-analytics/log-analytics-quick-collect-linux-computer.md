...
---
# <a name="configure-log-analytics-agent-for-linux-computers-in-a-hybrid-environment"></a>Configure Log Analytics agent for Linux computers in a hybrid environment
...
## <a name="install-the-agent-for-linux"></a>Install the agent for Linux
