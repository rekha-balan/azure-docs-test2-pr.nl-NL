...
---
# <a name="log-analytics-search-reference"></a>Log Analytics search reference
...
## <a name="general-query-syntax"></a>General query syntax
...
### <a name="general-syntax-examples"></a>General syntax examples
Examples:
...
## <a name="filter-expressions"></a>Filter expressions
...
### <a name="dates-and-times"></a>Dates and times
...
### <a name="datetime-math"></a>Date/Time math
...
### <a name="field-facets"></a>Field facets
...
## <a name="search-field-and-facet-reference"></a>Search field and facet reference
