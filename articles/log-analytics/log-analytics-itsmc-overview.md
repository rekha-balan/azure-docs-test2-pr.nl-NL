...
---
# <a name="connect-azure-to-itsm-tools-using-it-service-management-connector"></a>Connect Azure to ITSM tools using IT Service Management Connector
...
##  <a name="adding-the-it-service-management-connector-solution"></a>Adding the IT Service Management Connector Solution
...
## <a name="creating-an-itsm--connection"></a>Creating an ITSM  connection
...
## <a name="create-itsm-work-items-from-azure-alerts"></a>Create ITSM work items from Azure alerts
...
## <a name="visualize-and-analyze-the-incident-and-change-request-data"></a>Visualize and analyze the incident and change request data
...
### <a name="data-synced-from-itsm-product"></a>Data synced from ITSM product
...
## <a name="output-data-for-a-servicenow-incident"></a>Output data for a ServiceNow incident
...
## <a name="output-data-for-a-servicenow-change-request"></a>Output data for a ServiceNow change request
...
## <a name="troubleshoot-itsm-connections"></a>Troubleshoot ITSM connections
...
## <a name="troubleshoot-service-manager-web-app-deployment"></a>Troubleshoot Service Manager Web App deployment
