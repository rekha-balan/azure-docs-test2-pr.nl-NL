...
### <a name="configure-network-security-group-rules"></a>Configure network security group rules 
...
### <a name="discover-expressroute-peering-connections"></a>Discover ExpressRoute peering connections 
...
### <a name="enable-monitoring-of-the-expressroute-peering-connections"></a>Enable monitoring of the ExpressRoute peering connections 
...
### <a name="circuits-list"></a>Circuits list 
...
### <a name="trends-of-loss-latency-and-throughput"></a>Trends of loss, latency, and throughput 
...
### <a name="peerings-list"></a>Peerings list 
...
### <a name="circuit-topology"></a>Circuit topology 
...
### <a name="detailed-topology-view-of-a-circuit"></a>Detailed topology view of a circuit 
