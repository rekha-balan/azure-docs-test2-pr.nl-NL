...
---
# <a name="optimize-your-environment-with-the-system-center-operations-manager-assessment-preview-solution"></a>Optimize your environment with the System Center Operations Manager Assessment (Preview) solution
...
# <a name="system-center-operations-manager-assessment-data-collection-details"></a>System Center Operations Manager assessment data collection details
...
### <a name="set-the-run-as-account"></a>Set the Run As account
...
### <a name="sql-script-to-grant-granular-permissions-to-the-run-as-account"></a>SQL script to grant granular permissions to the Run As account
...
### <a name="configure-the-assessment-rule"></a>Configure the assessment rule
...
#### <a name="enable-the-rule-for-a-specific-management-server"></a>Enable the rule for a specific management server
...
5.  Ensure that you change override value to **True** for the **Enabled** parameter value.  
    ![override parameter](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-scom-assessment/rule.png)

While still in this window, configure the frequency of the run using the next procedure.

#### <a name="configure-the-run-frequency"></a>Configure the run frequency
...
4. Change the **Interval** parameter value to your desired interval value. In the example below, the value is set to 1440 minutes (one day).  
    ![interval parameter](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-scom-assessment/interval.png)  
...
3. On any of the focus area pages, you can view the prioritized recommendations made for your environment. Click a recommendation under **Affected Objects** to view details about why the recommendation is made.  
    ![focus area](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-scom-assessment/focus-area.png)
...
### <a name="to-identify-recommendations-that-you-want-to-ignore"></a>To identify recommendations that you want to ignore
...
## <a name="system-center-operations-manager-assessment-solution-faq"></a>System Center Operations Manager Assessment solution FAQ
