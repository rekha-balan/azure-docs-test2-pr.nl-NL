...
---
# <a name="configure-log-analytics-agent-for-windows-computers-in-a-hybrid-environment"></a>Configure Log Analytics agent for Windows computers in a hybrid environment
...
## <a name="obtain-workspace-id-and-key"></a>Obtain workspace ID and key
...
## <a name="install-the-agent-for-windows"></a>Install the agent for Windows
