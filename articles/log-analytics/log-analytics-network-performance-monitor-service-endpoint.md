...
### <a name="configure-operations-management-suite-agents-for-monitoring"></a>Configure Operations Management Suite agents for monitoring
...
### <a name="create-service-connectivity-monitor-tests"></a>Create Service Connectivity Monitor tests 
