...
---
# <a name="create-a-data-pipeline-with-the-data-collector-api"></a>Create a data pipeline with the Data Collector API
...
## <a name="example-problem"></a>Example problem
...
## <a name="general-design"></a>General design
...
## <a name="setting-up-the-pipeline"></a>Setting up the pipeline
...
## <a name="ingesting-json-data"></a>Ingesting JSON data
...
## <a name="ingesting-xml-csv-or-other-formats-of-data"></a>Ingesting XML, CSV, or other formats of data
...
## <a name="testing-the-pipeline"></a>Testing the pipeline
...
## <a name="correlating-with-other-data-in-log-analytics-and-application-insights"></a>Correlating with other data in Log Analytics and Application Insights
...
## <a name="suggested-improvements-for-a-production-pipeline"></a>Suggested improvements for a production pipeline
