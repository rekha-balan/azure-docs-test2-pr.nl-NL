...
---
# <a name="collect-data-in-a-hybrid-environment-with-log-analytics-agent"></a>Collect data in a hybrid environment with Log Analytics agent
...
## <a name="network-firewall-requirements"></a>Network firewall requirements
...
## <a name="install-and-configure-agent"></a>Install and configure agent 
