...
---
# <a name="create-an-alert-webhook-action-in-oms-log-analytics-to-send-message-to-slack"></a>Create an alert webhook action in OMS Log Analytics to send message to Slack
