...
---
# <a name="oms-portal-moving-to-azure"></a>OMS portal moving to Azure
...
## <a name="what-is-changing"></a>What is changing? 
...
## <a name="what-should-i-do-now"></a>What should I do now?
...
## <a name="user-access-and-role-migration"></a>User access and role migration
...
## <a name="new-workspaces"></a>New workspaces
...
## <a name="changes-to-alerts"></a>Changes to alerts

### <a name="alert-extension"></a>Alert extension  
...
### <a name="alert-management-solution"></a>Alert management solution
...
## <a name="application-insights-connector-and-solution"></a>Application Insights Connector and solution
