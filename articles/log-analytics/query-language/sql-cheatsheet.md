...
---
# <a name="sql-to-log-analytics-query-language-cheat-sheet"></a>SQL to Log Analytics query language cheat sheet 
...
## <a name="sql-to-log-analytics"></a>SQL to Log Analytics
