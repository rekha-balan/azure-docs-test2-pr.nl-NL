...
---
# <a name="search-queries-in-log-analytics"></a>Search queries in Log Analytics
...
### <a name="table-scoping"></a>Table scoping
...
### <a name="table-and-column-scoping"></a>Table and column scoping
...
## <a name="use-wild-cards"></a>Use wild cards
...
## <a name="add-and--or-to-search-queries"></a>Add *and* / *or* to search queries
...
## <a name="pipe-search-queries"></a>Pipe search queries
