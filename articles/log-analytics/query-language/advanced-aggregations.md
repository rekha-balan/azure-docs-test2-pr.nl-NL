...
---
# <a name="advanced-aggregations-in-log-analytics-queries"></a>Advanced aggregations in Log Analytics queries
...
## <a name="generating-lists-and-sets"></a>Generating lists and sets
...
## <a name="expanding-lists"></a>Expanding lists
...
## <a name="narrowing-results-to-a-set-of-elements-let-makeset-toscalar-in"></a>Narrowing results to a set of elements: `let`, `makeset`, `toscalar`, `in`
