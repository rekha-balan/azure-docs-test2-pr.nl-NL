...
---
# <a name="get-started-with-the-log-analytics-page-in-the-azure-portal"></a>Get started with the Log Analytics page in the Azure portal
...
## <a name="meet-the-log-analytics-page"></a>Meet the Log Analytics page 
...
## <a name="basic-queries"></a>Basic queries
...
## <a name="understand-the-schema"></a>Understand the schema
...
## <a name="filter-the-results"></a>Filter the results
...
### <a name="add-a-filter-to-the-query"></a>Add a filter to the query
...
### <a name="filter-through-the-table-elements"></a>Filter through the table elements
...
## <a name="sort-and-group-results"></a>Sort and group results
...
## <a name="select-columns-to-display"></a>Select columns to display
...
## <a name="select-a-time-range"></a>Select a time range
...
## <a name="load-queries"></a>Load queries
...
## <a name="export-and-share-as-link"></a>Export and share as link
