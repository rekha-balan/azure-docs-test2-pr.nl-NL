...
---
# <a name="splunk-to-log-analytics"></a>Splunk to Log Analytics
...
## <a name="structure-and-concepts"></a>Structure and concepts
...
### <a name="getting-n-eventsrows-for-inspection"></a>Getting n events/rows for inspection 
...
### <a name="getting-the-first-n-eventsrows-ordered-by-a-fieldcolumn"></a>Getting the first n events/rows ordered by a field/column
...
### <a name="extending-the-result-set-with-new-fieldscolumns"></a>Extending the result set with new fields/columns
...
### <a name="format-resultsprojection"></a>Format results/Projection
...
### <a name="multivalue-expand"></a>Multivalue expand
