...
---
# <a name="get-started-with-queries-in-log-analytics"></a>Get started with queries in Log Analytics
...
## <a name="writing-a-new-query"></a>Writing a new query
...
### <a name="table-based-queries"></a>Table-based queries
...
### <a name="search-queries"></a>Search queries
...
## <a name="sort-and-top"></a>Sort and top
...
## <a name="where-filtering-on-a-condition"></a>Where: filtering on a condition
...
## <a name="specify-a-time-range"></a>Specify a time range

### <a name="time-picker"></a>Time picker
...
### <a name="time-filter-in-query"></a>Time filter in query
...
## <a name="project-and-extend-select-and-compute-columns"></a>Project and Extend: select and compute columns
...
## <a name="summarize-aggregate-groups-of-rows"></a>Summarize: aggregate groups of rows
...
### <a name="summarize-by-a-time-column"></a>Summarize by a time column
