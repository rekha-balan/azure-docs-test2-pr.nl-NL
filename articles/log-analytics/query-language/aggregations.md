...
---
# <a name="aggregations-in-log-analytics-queries"></a>Aggregations in Log Analytics queries
...
### <a name="evaluating-subgroups"></a>Evaluating subgroups
...
## <a name="percentiles-and-variance"></a>Percentiles and Variance
