...
---
# <a name="create-log-searches-in-azure-log-analytics-using-the-log-search-portal"></a>Create log searches in Azure Log Analytics using the Log search portal
...
## <a name="open-the-log-search-portal"></a>Open the Log Search portal
...
## <a name="create-a-simple-search"></a>Create a simple search
...
## <a name="set-the-time-scope"></a>Set the time scope
...
## <a name="filter-results-of-the-query"></a>Filter results of the query
...
## <a name="work-with-performance-data"></a>Work with performance data
