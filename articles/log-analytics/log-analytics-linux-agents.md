...
---
# <a name="connect-your-linux-computers-to-log-analytics"></a>Connect your Linux computers to Log Analytics
...
## <a name="supported-linux-versions"></a>Supported Linux versions
...
### <a name="additional-installation-artifacts"></a>Additional installation artifacts
...
### <a name="linux-data-collection-details"></a>Linux data collection details
...
| --- | --- | --- | --- | --- | --- | --- |
| Zabbix |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |1 minute |
| Nagios |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |on arrival |
| syslog |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |from Azure storage: 10 minutes; from agent: on arrival |
| Linux performance counters |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |As scheduled, minimum of 10 seconds |
| change tracking |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-bullet-red.png) |hourly |

### <a name="package-requirements"></a>Package Requirements
...
## <a name="choose-your-linux-data-collection-method"></a>Choose your Linux data collection method
...
### <a name="disable-oms-management-for-an-individual-linux-computer"></a>Disable OMS management for an individual Linux computer
...
## <a name="linux-performance-counters"></a>Linux performance counters
...
### <a name="to-add-a-linux-performance-counter-in-oms"></a>To add a Linux performance counter in OMS
...
2. On the **Settings** page under **Data** , click **Linux performance counters** and then select or type the name of the counter you want to add.  
    ![data](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-settings-data01.png)
...
### <a name="configure-linux-performance-counters-in-oms"></a>Configure Linux performance counters in OMS
...
### <a name="add-and-configure-performance-metrics-with-linux"></a>Add and configure performance metrics with Linux
...
### <a name="enable-mysql-performance-counters-using-linux-commands"></a>Enable MySQL performance counters using Linux commands
...
### <a name="enable-apache-http-server-performance-counters-using-linux-commands"></a>Enable Apache HTTP Server performance counters using Linux commands
...
```
### <a name="to-view-performance-data-with-log-analytics"></a>To view performance data with Log Analytics
...
### <a name="to-add-a-new-linux-syslog-facility-in-oms"></a>To add a new Linux syslog facility in OMS
1. On the **Settings** page under **Data** , click **Syslog** and then to the left of the plus icon, type the name of the syslog facility that you want to add.
    ![Linux syslog](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/oms-linuxsyslog01.png)
...
### <a name="configure-linux-syslog-facilities-in-linux"></a>Configure Linux syslog facilities in Linux
...
### <a name="to-view-all-syslog-events-with-log-analytics"></a>To view all Syslog events with Log Analytics
1. In the Operations Management Suite portal, click the **Log Search** tile.
...
## <a name="linux-alerts"></a>Linux alerts
...
### <a name="collect-alerts-from-nagios"></a>Collect alerts from Nagios
...
### <a name="collect-alerts-from-zabbix"></a>Collect alerts from Zabbix
...
### <a name="view-alerts-in-log-analytics-search"></a>View alerts in Log Analytics search
...
#### <a name="to-view-all-nagios-alerts-with-log-analytics"></a>To view all Nagios alerts with Log Analytics
1. In the Operations Management Suite portal, click the **Log Search** tile.
...
### <a name="to-view-all-zabbix-alerts-with-log-analytics"></a>To view all Zabbix alerts with Log Analytics
1. In the Operations Management Suite portal, click the **Log Search** tile.
2. In the query bar, type the following search query
...
## <a name="compatibility-with-system-center-operations-manager"></a>Compatibility with System Center Operations Manager
...
### <a name="to-enable-the-oms-agent-for-linux-to-communicate-with-operations-manager"></a>To enable the OMS Agent for Linux to communicate with Operations Manager
...
### <a name="configure-the-mysql-omi-provider"></a>Configure the MySQL OMI provider
...
### <a name="mysql-omi-authentication-file"></a>MySQL OMI authentication file
...
### <a name="authentication-file-format"></a>Authentication file format
...
#### <a name="authentication-file-location"></a>Authentication file location
...
## <a name="agent-logs"></a>Agent logs
...
## <a name="troubleshooting-the-oms-agent-for-linux"></a>Troubleshooting the OMS Agent for Linux
...
### <a name="important-log-locations"></a>Important log locations
| File | Path |
| --- | --- |
...
### <a name="important-configuration-files"></a>Important configuration files
...
### <a name="enable-debug-logging"></a>Enable debug logging
To enable debug logging, you can use the OMS output plugin and verbose output.

#### <a name="oms-output-plugin"></a>OMS output plugin
...
### <a name="forwarded-syslog-messages-do-not-appear-in-the-log"></a>Forwarded Syslog messages do not appear in the log
...
### <a name="problems-connecting-to-oms-when-using-a-proxy"></a>Problems connecting to OMS when using a proxy
#### <a name="probable-causes"></a>Probable causes
...
### <a name="a-403-error-is-displayed-when-onboarding"></a>A 403 error is displayed when onboarding
#### <a name="probable-causes"></a>Probable causes
...
### <a name="a-500-error-or-404-error-appears-in-the-log-file-after-onboarding"></a>A 500 error or 404 error appears in the log file after onboarding
...
### <a name="nagios-data-does-not-appear-in-the-oms-portal"></a>Nagios data does not appear in the OMS Portal
#### <a name="probable-causes"></a>Probable causes
...
### <a name="linux-data-doesnt-appear-in-the-oms-portal"></a>Linux data doesn't appear in the OMS Portal
#### <a name="probable-causes"></a>Probable causes
...
### <a name="syslog-linux-performance-counter-configuration-is-not-applied-in-the-oms-portal"></a>Syslog Linux performance counter configuration is not applied in the OMS portal
#### <a name="probable-causes"></a>Probable causes
...
### <a name="custom-linux-log-data-does-not-appear-in-the-oms-portal"></a>Custom Linux log data does not appear in the OMS Portal
#### <a name="probable-causes"></a>Probable causes
...
* In the OMS Portal, under **Settings** on the **Data** tab, ensure that the **Apply the following configuration to my Linux Servers** setting is selected  
  ![apply configuration](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-linux-agents/customloglinuxenabled.png)
* Verify that the `omsconfig` agent can communicate with the OMS service
...
### <a name="sysklog-is-not-supported"></a>Sysklog is not supported
