...
---
# <a name="manage-cost-by-controlling-data-volume-and-retention-in-log-analytics"></a>Manage cost by controlling data volume and retention in Log Analytics
...
## <a name="review-estimated-cost"></a>Review estimated cost
...
### <a name="identify-what-daily-data-limit-to-define"></a>Identify what daily data limit to define 
...
### <a name="manage-the-maximum-daily-data-volume"></a>Manage the maximum daily data volume 
...
### <a name="alert-when-limit-reached"></a>Alert when limit reached
...
## <a name="change-the-data-retention-period"></a>Change the data retention period 
