...
---
# <a name="optimize-your-active-directory-environment-with-the-active-directory-health-check-solution-in-log-analytics"></a>Optimize your Active Directory environment with the Active Directory Health Check solution in Log Analytics
...
## <a name="active-directory-health-check-data-collection-details"></a>Active Directory Health Check data collection details
...
## <a name="use-health-check-focus-area-recommendations"></a>Use health check focus area recommendations
...
## <a name="ad-health-check-solutions-faq"></a>AD Health Check solutions FAQ
