...
---
# <a name="using-regular-expressions-to-filter-log-searches-in-log-analytics"></a>Using regular expressions to filter log searches in Log Analytics
...
## <a name="regex-keyword"></a>RegEx keyword
...
## <a name="partial-matches"></a>Partial matches
...
## <a name="multiple-occurences-of-character"></a>Multiple occurences of character
...
## <a name="logical-expressions"></a>Logical expressions
