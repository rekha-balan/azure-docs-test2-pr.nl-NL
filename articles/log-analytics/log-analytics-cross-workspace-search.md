...
---
# <a name="perform-cross-resource-log-searches-in-log-analytics"></a>Perform cross-resource log searches in Log Analytics  
...
## <a name="querying-across-log-analytics-workspaces-and-from-application-insights"></a>Querying across Log Analytics workspaces and from Application Insights
...
### <a name="identifying-workspace-resources"></a>Identifying workspace resources
...
### <a name="identifying-an-application"></a>Identifying an application
...
### <a name="performing-a-query-across-multiple-resources"></a>Performing a query across multiple resources
