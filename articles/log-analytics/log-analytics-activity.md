...
---
# <a name="view-azure-activity-logs"></a>View Azure activity logs
...
2. Configure activity logs to go to your Log Analytics workspace.
    ...
    3. In the *SubscriptionName* blade, click **Connect**.  
        ![connect subscription](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-activity/subscription-connect.png)
