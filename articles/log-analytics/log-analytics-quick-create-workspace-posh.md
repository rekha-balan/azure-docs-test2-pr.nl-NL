...
---
# <a name="create-a-log-analytics-workspace-with-azure-powershell"></a>Create a Log Analytics workspace with Azure PowerShell
...
### <a name="create-and-deploy-template"></a>Create and deploy template
