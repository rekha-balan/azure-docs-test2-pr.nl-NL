...
---
# <a name="azure-key-vault-analytics-solution-in-log-analytics"></a>Azure Key Vault Analytics solution in Log Analytics
...
### <a name="enable-key-vault-diagnostics-in-the-portal"></a>Enable Key Vault diagnostics in the portal
...
### <a name="enable-key-vault-diagnostics-using-powershell"></a>Enable Key Vault diagnostics using PowerShell
...
## <a name="migrating-from-the-old-key-vault-solution"></a>Migrating from the old Key Vault solution
