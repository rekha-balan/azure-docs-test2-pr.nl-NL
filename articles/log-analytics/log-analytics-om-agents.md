...
## <a name="connecting-operations-manager-to-log-analytics"></a>Connecting Operations Manager to Log Analytics
...
### <a name="configure-proxy-settings-in-the-operations-console"></a>Configure proxy settings in the Operations console
...
## <a name="switch-an-operations-manager-group-to-a-new-log-analytics-workspace"></a>Switch an Operations Manager group to a new Log Analytics Workspace
...
## <a name="validate-operations-manager-integration-with-log-analytics"></a>Validate Operations Manager Integration with Log Analytics
There are a few different ways you can verify that Log Analytics to Operations Manager integration is successful.

### <a name="to-confirm-integration-from-the-azure-portal"></a>To confirm integration from the Azure portal
...
## <a name="remove-integration-with-log-analytics"></a>Remove Integration with Log Analytics
