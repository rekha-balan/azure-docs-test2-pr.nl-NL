...
---
# <a name="create-and-manage-alert-rules-in-log-analytics-with-rest-api"></a>Create and manage alert rules in Log Analytics with REST API
...
##### <a name="customize-e-mail-subject-for-action-group"></a>Customize E-Mail Subject for Action Group
By default, the email subject for alerts is: Alert Notification <AlertName> for <WorkspaceName>. But this can be customized, so that you can specific words or tags - to allow you to easily employ filter rules in your Inbox. The customize email header details need to send along with ActionGroup details, as in sample below.
...
##### <a name="customize-webhook-payload-for-action-group"></a>Customize Webhook Payload for Action Group
