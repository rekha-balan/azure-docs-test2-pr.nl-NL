...
---
# <a name="monitor-active-directory-replication-status-with-log-analytics"></a>Monitor Active Directory replication status with Log Analytics
...
![AD Replication Status dashboard](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-ad-replication-status/oms-ad-replication-dash.png)
