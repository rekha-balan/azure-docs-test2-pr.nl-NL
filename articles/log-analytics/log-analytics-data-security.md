...
## <a name="sending-data-securely-using-tls-12"></a>Sending data securely using TLS 1.2 
...
### <a name="platform-specific-guidance"></a>Platform specific guidance
...
## <a name="certifications-and-attestations"></a>Certifications and attestations
