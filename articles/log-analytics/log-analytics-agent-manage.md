...
---
# <a name="managing-and-maintaining-the-log-analytics-agent-for-windows-and-linux"></a>Managing and maintaining the Log Analytics agent for Windows and Linux
...
## <a name="adding-or-removing-a-workspace"></a>Adding or removing a workspace 

### <a name="windows-agent"></a>Windows agent

#### <a name="update-settings-from-control-panel"></a>Update settings from Control Panel
...
#### <a name="remove-a-workspace-using-powershell"></a>Remove a workspace using PowerShell 
...
#### <a name="add-a-workspace-in-azure-commercial-using-powershell"></a>Add a workspace in Azure commercial using PowerShell 
...
#### <a name="add-a-workspace-in-azure-for-us-government-using-powershell"></a>Add a workspace in Azure for US Government using PowerShell 
...
## <a name="update-proxy-settings"></a>Update proxy settings 
...
#### <a name="update-settings-using-control-panel"></a>Update settings using Control Panel
...
#### <a name="update-settings-using-powershell"></a>Update settings using PowerShell 
...
#### <a name="uninstall-from-control-panel"></a>Uninstall from Control Panel
1. Sign on to the computer with an account that has administrative rights.  
...
#### <a name="uninstall-from-the-command-line"></a>Uninstall from the command line
...
## <a name="configure-agent-to-report-to-an-operations-manager-management-group"></a>Configure agent to report to an Operations Manager management group
