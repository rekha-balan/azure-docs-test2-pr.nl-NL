...
## <a name="configure-settings-for-a-linux-container-host"></a>Configure settings for a Linux container host
...
### <a name="for-all-linux-container-hosts-except-coreos"></a>For all Linux container hosts except CoreOS
...
### <a name="for-all-linux-container-hosts-including-coreos"></a>For all Linux container hosts including CoreOS
...
### <a name="switching-from-using-an-installed-linux-agent-to-one-in-a-container"></a>Switching from using an installed Linux agent to one in a container
...
### <a name="docker-versions-supported-on-windows"></a>Docker versions supported on Windows

- Docker 1.12 – 1.13

### <a name="preparation-before-installing-agents"></a>Preparation before installing agents
...
#### <a name="to-start-docker-and-verify-its-configuration"></a>To start Docker and verify its configuration
...
### <a name="install-windows-agents"></a>Install Windows agents
...
| --- | --- | --- | --- | --- | --- | --- |
| Windows |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |every 3 minutes |
...
| --- | --- | --- | --- | --- | --- | --- |
| Azure |![Yes](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-green.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |![No](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/oms-bullet-red.png) |every 3 minutes |
...
1. Click the **Container Events** blade.  
   ![containers events](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/containers-events.png)
...
3. Next, click the failed value to view additional information such as image size and number of stopped and failed images. Expand **show more** to view the image ID.  
   ![failed containers](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/containers-state-failed.png)
4. Next, find the container that is running this image. Type the following into the search query.
   ...
   ![failed containers](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/containers-failed04.png)
...
* Choose an image that you know has failed recently and find the error logs for it. Start by finding a container name that is running that image with a **ContainerInventory** search. For example, search for `Type=ContainerInventory ubuntu Failed`  
    ![Search for Ubuntu containers](https://docstestmedia1.blob.core.windows.net/azure-media/articles/log-analytics/media/log-analytics-containers/search-ubuntu.png)
