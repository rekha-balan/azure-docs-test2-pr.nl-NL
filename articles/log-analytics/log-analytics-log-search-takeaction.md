...
---
# <a name="take-action-with-an-automation-runbook-from-a-log-analytics-log-search-result"></a>Take Action with an Automation Runbook from a Log Analytics log search result
...
## <a name="to-initiate-runbook-from-log-search"></a>To initiate runbook from log search
