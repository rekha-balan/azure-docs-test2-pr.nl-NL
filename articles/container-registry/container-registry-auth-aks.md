...
---
# <a name="authenticate-with-azure-container-registry-from-azure-kubernetes-service"></a>Authenticate with Azure Container Registry from Azure Kubernetes Service
...
## <a name="grant-aks-access-to-acr"></a>Grant AKS access to ACR
...
## <a name="access-with-kubernetes-secret"></a>Access with Kubernetes secret
