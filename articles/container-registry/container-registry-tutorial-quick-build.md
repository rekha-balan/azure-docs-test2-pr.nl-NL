...
---
# <a name="tutorial-build-container-images-in-the-cloud-with-azure-container-registry-build"></a>Tutorial: Build container images in the cloud with Azure Container Registry Build
...
### <a name="fork-sample-repository"></a>Fork sample repository
...
### <a name="clone-your-fork"></a>Clone your fork
...
## <a name="build-in-azure-with-acr-build"></a>Build in Azure with ACR Build
...
## <a name="deploy-to-azure-container-instances"></a>Deploy to Azure Container Instances
...
### <a name="configure-registry-authentication"></a>Configure registry authentication
...
#### <a name="create-service-principal-and-store-credentials"></a>Create service principal and store credentials
...
### <a name="deploy-container-with-azure-cli"></a>Deploy container with Azure CLI
...
### <a name="verify-deployment"></a>Verify deployment
