...
---
# <a name="create-a-private-docker-container-registry-using-the-azure-portal"></a>Create a private Docker container registry using the Azure portal
...
3. Select **Azure Container Registry**, with publisher **Microsoft**.
    ![Container Registry service in Azure Marketplace](https://docstestmedia1.blob.core.windows.net/azure-media/articles/container-registry/media/container-registry-get-started-portal/container-registry-marketplace.png)
...
## <a name="manage-registry-settings"></a>Manage registry settings
