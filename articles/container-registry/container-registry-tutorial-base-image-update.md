...
---
# <a name="tutorial-automate-image-builds-on-base-image-update-with-azure-container-registry-build"></a>Tutorial: Automate image builds on base image update with Azure Container Registry Build
...
### <a name="complete-previous-tutorials"></a>Complete previous tutorials
...
### <a name="base-image-updates"></a>Base image updates
...
### <a name="base-image-update-scenario"></a>Base image update scenario
...
## <a name="build-base-image"></a>Build base image
...
## <a name="create-build-task"></a>Create build task
...
## <a name="build-application-container"></a>Build application container
...
### <a name="optional-run-application-container-locally"></a>Optional: Run application container locally
...
## <a name="update-base-image"></a>Update base image
...
### <a name="optional-run-newly-built-image"></a>Optional: Run newly built image
