...
---
# <a name="quickstart-create-an-azure-container-registry-using-powershell"></a>Quickstart: Create an Azure Container Registry using PowerShell
...
## <a name="create-container-registry"></a>Create container registry
...
## <a name="log-in-to-registry"></a>Log in to registry
...
## <a name="push-image-to-registry"></a>Push image to registry
...
## <a name="view-running-application"></a>View running application
