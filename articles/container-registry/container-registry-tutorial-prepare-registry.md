...
---
# <a name="tutorial-prepare-a-geo-replicated-azure-container-registry"></a>Tutorial: Prepare a geo-replicated Azure container registry
...
## <a name="configure-geo-replication"></a>Configure geo-replication
...
## <a name="container-registry-login"></a>Container registry login
...
## <a name="get-application-code"></a>Get application code
...
## <a name="update-dockerfile"></a>Update Dockerfile
...
## <a name="build-container-image"></a>Build container image
...
## <a name="push-image-to-azure-container-registry"></a>Push image to Azure Container Registry
