...
## <a name="managed-vs-unmanaged"></a>Managed vs. unmanaged
...
### <a name="unmanaged-classic"></a>Unmanaged (Classic)
...
## <a name="sku-feature-matrix"></a>SKU feature matrix
...
## <a name="changing-from-classic"></a>Changing from Classic
