...
---
# <a name="best-practices-for-azure-container-registry"></a>Best practices for Azure Container Registry
...
## <a name="network-close-deployment"></a>Network-close deployment
...
## <a name="geo-replicate-multi-region-deployments"></a>Geo-replicate multi-region deployments
...
## <a name="repository-namespaces"></a>Repository namespaces
...
## <a name="dedicated-resource-group"></a>Dedicated resource group
...
## <a name="manage-registry-size"></a>Manage registry size
...
### <a name="delete-in-azure-portal"></a>Delete in Azure portal
