...
---
# <a name="tutorial-push-an-updated-image-to-regional-deployments"></a>Tutorial: Push an updated image to regional deployments
...
## <a name="rebuild-the-image"></a>Rebuild the image
...
## <a name="view-the-webhook-logs"></a>View the webhook logs
...
## <a name="view-the-updated-web-app"></a>View the updated web app
...
### <a name="acr-build-automated-image-build-and-patch"></a>ACR Build: Automated image build and patch
