...
---
# <a name="tutorial-automate-container-image-builds-with-azure-container-registry-build"></a>Tutorial: Automate container image builds with Azure Container Registry Build
...
### <a name="get-sample-code"></a>Get sample code
...
## <a name="build-task"></a>Build task
...
## <a name="create-a-build-task"></a>Create a build task
...
### <a name="create-a-github-personal-access-token"></a>Create a GitHub personal access token
...
### <a name="create-the-build-task"></a>Create the build task
...
## <a name="test-the-build-task"></a>Test the build task
...
## <a name="view-build-status"></a>View build status
...
## <a name="trigger-a-build-with-a-commit"></a>Trigger a build with a commit
