...
---
# <a name="push-your-first-image-to-a-private-docker-container-registry-using-the-docker-cli"></a>Push your first image to a private Docker container registry using the Docker CLI
...
## <a name="log-in-to-a-registry"></a>Log in to a registry
...
## <a name="steps-to-pull-and-push-an-image"></a>Steps to pull and push an image
...
##<a name="concurrent-limits"></a>Concurrent Limits
