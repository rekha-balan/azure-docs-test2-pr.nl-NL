...
---
# <a name="content-trust-in-azure-container-registry"></a>Content trust in Azure Container Registry
...
## <a name="how-content-trust-works"></a>How content trust works
...
### <a name="trusted-images"></a>Trusted images
...
### <a name="signing-keys"></a>Signing keys
...
## <a name="enable-registry-content-trust"></a>Enable registry content trust
...
## <a name="enable-client-content-trust"></a>Enable client content trust
...
## <a name="grant-image-signing-permissions"></a>Grant image signing permissions
...
## <a name="push-a-trusted-image"></a>Push a trusted image
...
## <a name="pull-a-trusted-image"></a>Pull a trusted image
...
### <a name="lost-root-key"></a>Lost root key
