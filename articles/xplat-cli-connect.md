...
---
# <a name="log-in-to-azure-from-the-azure-cli"></a>Log in to Azure from the Azure CLI
...
## <a name="scenario-1-azure-login-with-interactive-login"></a>Scenario 1: azure login with interactive login
...
## <a name="scenario-2-azure-login-with-a-username-and-password"></a>Scenario 2: azure login with a username and password
...
## <a name="scenario-3-azure-login-with-a-service-principal"></a>Scenario 3: azure login with a service principal
...
## <a name="scenario-4-use-a-publish-settings-file"></a>Scenario 4: Use a publish settings file
...
## <a name="cli-command-modes"></a>CLI command modes
...
## <a name="multiple-subscriptions"></a>Multiple subscriptions
...
## <a name="storage-of-cli-settings"></a>Storage of CLI settings
...
## <a name="logging-out"></a>Logging out
