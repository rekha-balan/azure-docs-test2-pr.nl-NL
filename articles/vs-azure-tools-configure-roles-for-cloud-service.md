...
## <a name="programmatically-access-a-connection-string"></a>Programmatically access a connection string
...
## <a name="programmatically-access-a-custom-settings-value"></a>Programmatically access a custom setting's value
...
## <a name="programmatically-accessing-local-storage"></a>Programmatically accessing local storage
...
### <a name="write-a-text-file-to-local-storage"></a>Write a text file to local storage
...
### <a name="find-a-file-written-to-local-storage"></a>Find a file written to local storage
