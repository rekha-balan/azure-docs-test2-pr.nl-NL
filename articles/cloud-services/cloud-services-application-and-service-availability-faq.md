...
---
# <a name="application-and-service-availability-issues-for-azure-cloud-services-frequently-asked-questions-faqs"></a>Application and service availability issues for Azure Cloud Services: Frequently asked questions (FAQs)
...
## <a name="my-role-got-recycled-was-there-any-update-rolled-out-for-my-cloud-service"></a>My role got recycled. Was there any update rolled out for my cloud service?
...
## <a name="why-does-the-first-request-to-my-cloud-service-after-the-service-has-been-idle-for-some-time-take-longer-than-usual"></a>Why does the first request to my cloud service after the service has been idle for some time take longer than usual?
