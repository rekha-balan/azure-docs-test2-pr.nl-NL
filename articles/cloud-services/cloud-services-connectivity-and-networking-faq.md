...
---
# <a name="connectivity-and-networking-issues-for-azure-cloud-services-frequently-asked-questions-faqs"></a>Connectivity and networking issues for Azure Cloud Services: Frequently asked questions (FAQs)
...
## <a name="how-do-i-use-remote-desktop-when-i-have-an-nsg"></a>How do I use Remote Desktop when I have an NSG?
...
## <a name="can-i-ping-a-cloud-service"></a>Can I ping a cloud service?
...
## <a name="how-do-i-prevent-receiving-thousands-of-hits-from-unknown-ip-addresses-that-might-indicate-a-malicious-attack-to-the-cloud-service"></a>How do I prevent receiving thousands of hits from unknown IP addresses that might indicate a malicious attack to the cloud service?
...
## <a name="when-i-try-to-rdp-to-my-cloud-service-instance-i-get-the-message-the-user-account-has-expired"></a>When I try to RDP to my cloud service instance, I get the message "The user account has expired."
...
## <a name="why-is-azure-load-balancer-not-balancing-traffic-equally"></a>Why is Azure Load Balancer not balancing traffic equally?
...
## <a name="how-can-i-redirect-incoming-traffic-to-the-default-url-of-my-cloud-service-to-a-custom-url"></a>How can I redirect incoming traffic to the default URL of my cloud service to a custom URL? 
...
## <a name="how-can-i-blockdisable-incoming-traffic-to-the-default-url-of-my-cloud-service"></a>How can I block/disable incoming traffic to the default URL of my cloud service? 
...
## <a name="how-can-i-make-sure-the-public-facing-ip-address-of-a-cloud-service-never-changes"></a>How can I make sure the public-facing IP address of a cloud service never changes?
...
## <a name="how-can-i-use-azure-resource-manager-virtual-networks-with-cloud-services"></a>How can I use Azure Resource Manager virtual networks with cloud services? 
