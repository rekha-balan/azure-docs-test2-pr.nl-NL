...
## <a name="the-function-of-a-load-balancer-probe"></a>The function of a load balancer probe
...
## <a name="basic-service-definition-schema-for-a-load-balancer-probe"></a>Basic service definition schema for a load balancer probe
