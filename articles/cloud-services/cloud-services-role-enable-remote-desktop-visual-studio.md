...
---
# <a name="enable-remote-desktop-connection-for-a-role-in-azure-cloud-services-using-visual-studio"></a>Enable Remote Desktop Connection for a Role in Azure Cloud Services using Visual Studio
...
## <a name="configure-remote-desktop-through-visual-studio-2017-version-154-and-earlier"></a>Configure Remote Desktop through Visual Studio 2017 version 15.4 and earlier
...
## <a name="configure-remote-desktop-when-using-visual-studio-2017-version-155-and-later"></a>Configure Remote Desktop when using Visual Studio 2017 version 15.5 and later
...
### <a name="deploying-from-a-build-server-with-visual-studio-2017-version-155-and-later"></a>Deploying from a build server with Visual Studio 2017 version 15.5 and later
