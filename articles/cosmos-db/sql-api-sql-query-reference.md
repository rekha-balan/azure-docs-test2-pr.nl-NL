...
---
# <a name="azure-cosmos-db-sql-syntax-reference"></a>Azure Cosmos DB SQL syntax reference
...
### <a name="logical-processing-order-of-the-select-statement"></a>Logical Processing Order of the SELECT statement  
...
### <a name="whitespace-characters-and-comments"></a>Whitespace characters and comments  
...
### <a name="handling-missing-properties-missing-array-elements-and-undefined-values"></a>handling missing properties, missing array elements, and undefined values
...
### <a name="collection-expression-context-scoping"></a>Collection expression context scoping  
...
### <a name="examples-of-joins"></a>Examples of joins  
