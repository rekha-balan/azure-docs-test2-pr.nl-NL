...
---
# <a name="unique-keys-in-azure-cosmos-db"></a>Unique keys in Azure Cosmos DB
...
## <a name="using-unique-keys"></a>Using unique keys
...
## <a name="sql-api-sample"></a>SQL API sample
...
## <a name="mongodb-api-sample"></a>MongoDB API sample
...
```
## <a name="configure-unique-keys-by-using-azure-portal"></a>Configure unique keys by using Azure Portal
