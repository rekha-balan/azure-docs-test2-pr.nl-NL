...
---
# <a name="azure-cosmos-db-gremlin-graph-support"></a>Azure Cosmos DB Gremlin graph support
...
## <a name="gremlin-by-example"></a>Gremlin by example
...
## <a name="gremlin-features"></a>Gremlin features
...
## <a name="gremlin-wire-format-graphson"></a>Gremlin wire format: GraphSON
...
## <a name="gremlin-steps"></a>Gremlin steps
