...
---
# <a name="build-a-java-application-by-using-azure-cosmos-db-async-java-sdk"></a>Build a Java application by using Azure Cosmos DB Async Java SDK 
...
## <a name="step-4-initialize-the-client-object"></a>Step 4: Initialize the client object
