...
---
# <a name="how-to-use-azure-table-storage-or-azure-cosmos-db-table-api-from-java"></a>How to use Azure Table storage or Azure Cosmos DB Table API from Java
...
## <a name="add-an-azure-storage-connection-string"></a>Add an Azure storage connection string
...
## <a name="add-an-azure-cosmos-db-table-api-connection-string"></a>Add an Azure Cosmos DB Table API connection string
...
## <a name="list-the-tables"></a>List the tables
...
## <a name="modify-an-entity"></a>Modify an entity
