...
---
# <a name="expire-data-in-azure-cosmos-db-collections-automatically-with-time-to-live"></a>Expire data in Azure Cosmos DB collections automatically with time to live
...
## <a name="ttl-and-index-interaction"></a>TTL and index interaction
