...
---
# <a name="create-a-mongodb-app-with-angular-and-azure-cosmos-db---part-2-create-a-nodejs-express-app-with-the-angular-cli"></a>Create a MongoDB app with Angular and Azure Cosmos DB - Part 2: Create a Node.js Express app with the Angular CLI 
...
## <a name="install-the-angular-cli-and-typescript"></a>Install the Angular CLI and TypeScript
...
## <a name="use-the-angular-cli-to-create-a-new-project"></a>Use the Angular CLI to create a new project
...
## <a name="build-the-app-using-the-express-framework"></a>Build the app using the Express framework
...
## <a name="use-postman-to-test-the-app"></a>Use Postman to test the app
