...
---
# <a name="accelerate-big-data-analytics-by-using-the-apache-spark-to-azure-cosmos-db-connector"></a>Accelerate big data analytics by using the Apache Spark to Azure Cosmos DB connector
...
## <a name="connect-apache-spark-to-azure-cosmos-db"></a>Connect Apache Spark to Azure Cosmos DB
...
## <a name="connect-by-using-python-or-pydocumentdb-sdk"></a>Connect by using Python or pyDocumentDB SDK
...
### <a name="considerations-when-using-pydocumentdb-sdk"></a>Considerations when using pyDocumentDB SDK
...
## <a name="connect-by-using-the-java-sdk"></a>Connect by using the Java SDK
...
### <a name="find-and-attach-the-java-sdk-to-the-spark-cluster"></a>Find and attach the Java SDK to the Spark cluster
...
### <a name="read-twitter-data-from-azure-cosmos-db"></a>Read Twitter data from Azure Cosmos DB
...
### <a name="read-twitter-data-that-is-streaming-to-azure-cosmos-db"></a>Read Twitter data that is streaming to Azure Cosmos DB
...
### <a name="write-twitter-data-to-azure-cosmos-db"></a>Write Twitter data to Azure Cosmos DB 
...
### <a name="write-twitter-data-that-is-streaming-to-azure-cosmos-db"></a>Write Twitter data that is streaming to Azure Cosmos DB 
...
### <a name="considerations-when-using-java-sdk"></a>Considerations when using Java SDK
