...
---
# <a name="how-to-use-azure-table-storage-and-the-azure-cosmos-db-table-api-with-ruby"></a>How to use Azure Table Storage and the Azure Cosmos DB Table API with Ruby
...
## <a name="add-access-to-storage-or-azure-cosmos-db"></a>Add access to Storage or Azure Cosmos DB
