...
---
# <a name="introduction-to-azure-cosmos-db-gremlin-api"></a>Introduction to Azure Cosmos DB: Gremlin API
...
## <a name="what-is-a-graph-database"></a>What is a graph database
...
## <a name="features-of-azure-cosmos-db-graph-database"></a>Features of Azure Cosmos DB graph database
...
## <a name="graph-database-design-considerations"></a>Graph database design considerations
...
## <a name="scenarios-that-can-use-gremlin-api"></a>Scenarios that can use Gremlin API
