...
---
# <a name="azure-cosmos-db-nodejs-examples"></a>Azure Cosmos DB Node.js examples
...
## <a name="container-examples"></a>Container examples
...
## <a name="item-examples"></a>Item examples
