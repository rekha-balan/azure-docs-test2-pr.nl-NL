...
---
# <a name="azure-cosmos-db-as-a-key-value-store--cost-overview"></a>Azure Cosmos DB as a key value store – Cost overview
...
## <a name="why-we-use-request-units-rus"></a>Why we use Request Units (RUs)
...
## <a name="cost-of-reads-and-writes"></a>Cost of reads and writes
