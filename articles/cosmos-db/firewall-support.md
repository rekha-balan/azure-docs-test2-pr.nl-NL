...
---
# <a name="azure-cosmos-db-firewall-support"></a>Azure Cosmos DB firewall support
...
## <a name="connections-from-the-azure-portal"></a>Connections from the Azure portal 
...
## <a name="connections-from-global-azure-datacenters-or-azure-paas-services"></a>Connections from Global Azure datacenters or Azure PaaS services
...
## <a name="connections-from-your-current-ip"></a>Connections from your current IP
...
## <a name="using-azure-resource-manager-template-to-set-up-the-ip-access-control"></a>Using Azure Resource Manager Template to set up the IP access control
