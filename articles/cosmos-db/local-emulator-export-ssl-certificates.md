...
---
# <a name="export-the-azure-cosmos-db-emulator-certificates-for-use-with-java-python-and-nodejs"></a>Export the Azure Cosmos DB Emulator certificates for use with Java, Python, and Node.js
...
## <a name="certification-rotation"></a>Certification rotation
...
## <a name="how-to-export-the-azure-cosmos-db-ssl-certificate"></a>How to export the Azure Cosmos DB SSL certificate
...
## <a name="how-to-use-the-certificate-in-java"></a>How to use the certificate in Java
...
## <a name="how-to-use-the-certificate-in-python"></a>How to use the certificate in Python
...
## <a name="how-to-use-the-certificate-in-nodejs"></a>How to use the certificate in Node.js
