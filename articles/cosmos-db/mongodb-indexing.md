...
---
# <a name="indexing-in-the-azure-cosmos-db-mongodb-api"></a>Indexing in the Azure Cosmos DB: MongoDB API
...
## <a name="dropping-the-default-indexes"></a>Dropping the default indexes
...
## <a name="creating-compound-indexes"></a>Creating compound indexes
...
## <a name="creating-unique-indexes"></a>Creating unique indexes
...
## <a name="ttl-indexes"></a>TTL indexes
...
## <a name="migrating-collections-with-indexes"></a>Migrating collections with indexes
