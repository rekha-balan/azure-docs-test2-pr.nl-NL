...
---
# <a name="use-azure-cosmos-db-change-feed-to-visualize-real-time-data-analytics"></a>Use Azure Cosmos DB change feed to visualize real-time data analytics
...
## <a name="create-a-database-and-the-collection"></a>Create a database and the collection
...
## <a name="get-the-connection-string-and-keys"></a>Get the connection string and keys

### <a name="get-the-azure-cosmos-db-connection-string"></a>Get the Azure Cosmos DB connection string
...
### <a name="get-the-storage-account-key-and-connection-string"></a>Get the storage account key and connection string
...
### <a name="get-the-event-hub-namespace-connection-string"></a>Get the event hub namespace connection string
...
## <a name="set-up-azure-function-to-read-the-change-feed"></a>Set up Azure Function to read the change feed
...
## <a name="insert-data-into-azure-cosmos-db"></a>Insert data into Azure Cosmos DB 
...
## <a name="set-up-a-stream-analytics-job"></a>Set up a stream analytics job
...
## <a name="connect-to-power-bi"></a>Connect to Power BI
...
## <a name="optional-visualize-with-an-e-commerce-site"></a>Optional: Visualize with an E-commerce site
...
## <a name="delete-the-resources"></a>Delete the resources
