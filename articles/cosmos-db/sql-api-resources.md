...
---
# <a name="azure-cosmos-db-hierarchical-resource-model-and-core-concepts"></a>Azure Cosmos DB hierarchical resource model and core concepts
...
### <a name="elastic-scale-of-an-azure-cosmos-db-database"></a>Elastic scale of an Azure Cosmos DB database
