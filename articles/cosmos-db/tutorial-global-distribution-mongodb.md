...
---
# <a name="set-up-azure-cosmos-db-global-distribution-using-the-mongodb-api"></a>Set up Azure Cosmos DB global distribution using the MongoDB API
...
## <a name="verifying-your-regional-setup-using-the-mongodb-api"></a>Verifying your regional setup using the MongoDB API
...
## <a name="connecting-to-a-preferred-region-using-the-mongodb-api"></a>Connecting to a preferred region using the MongoDB API
