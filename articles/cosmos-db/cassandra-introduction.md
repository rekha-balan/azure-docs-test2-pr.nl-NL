...
---
# <a name="introduction-to-azure-cosmos-db-apache-cassandra-api"></a>Introduction to Azure Cosmos DB: Apache Cassandra API
...
## <a name="what-is-the-azure-cosmos-db-apache-cassandra-api"></a>What is the Azure Cosmos DB Apache Cassandra API?
...
## <a name="what-is-the-benefit-of-using-apache-cassandra-api-for-azure-cosmos-db"></a>What is the benefit of using Apache Cassandra API for Azure Cosmos DB?
...
<a id="sign-up-now"></a>
## <a name="sign-up-now"></a>Sign up now 
