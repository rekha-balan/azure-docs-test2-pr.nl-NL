...
---
# <a name="build-mobile-applications-with-xamarin-and-azure-cosmos-db"></a>Build mobile applications with Xamarin and Azure Cosmos DB
...
## <a name="azure-cosmos-db-capabilities-for-mobile-apps"></a>Azure Cosmos DB capabilities for mobile apps
...
## <a name="azure-cosmos-db-and-xamarin-tutorial"></a>Azure Cosmos DB and Xamarin tutorial
