...
---
# <a name="create-a-mongodb-app-with-angular-and-azure-cosmos-db---part-5-use-mongoose-to-connect-to-azure-cosmos-db"></a>Create a MongoDB app with Angular and Azure Cosmos DB - Part 5: Use Mongoose to connect to Azure Cosmos DB
...
## <a name="use-mongoose-to-connect-to-azure-cosmos-db"></a>Use Mongoose to connect to Azure Cosmos DB
...
## <a name="get-the-connection-string-information"></a>Get the connection string information
...
## <a name="create-a-hero-model"></a>Create a Hero model
...
## <a name="create-a-hero-service"></a>Create a Hero service
...
## <a name="add-the-hero-service-to-routesjs"></a>Add the hero service to routes.js
