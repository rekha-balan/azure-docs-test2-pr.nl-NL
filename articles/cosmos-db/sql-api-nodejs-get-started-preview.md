...
---
# <a name="nodejs-tutorial-create-a-nodejs-console-application-with-azure-cosmos-db-sql-api-and-javascript-sdk-20-preview"></a>Node.js tutorial: Create a Node.js console application with Azure Cosmos DB SQL API and JavaScript SDK 2.0 (preview)
...
## <a name="step-1-create-an-azure-cosmos-db-account"></a>Step 1: Create an Azure Cosmos DB account
...
## <a name="step-5-create-a-database"></a>Step 5: Create a database
