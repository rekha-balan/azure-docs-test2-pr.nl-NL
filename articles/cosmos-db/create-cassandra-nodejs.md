...
---
# <a name="quickstart-build-a-cassandra-app-with-nodejs-and-azure-cosmos-db"></a>Quickstart: Build a Cassandra app with Node.js and Azure Cosmos DB
...
## <a name="use-the-x509-certificate"></a>Use the X509 certificate 
