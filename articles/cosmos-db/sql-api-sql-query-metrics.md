...
---
# <a name="tuning-query-performance-with-azure-cosmos-db"></a>Tuning query performance with Azure Cosmos DB
...
## <a name="about-sql-query-execution"></a>About SQL query execution
...
## <a name="best-practices-for-query-performance"></a>Best practices for query performance
...
### <a name="provisioned-throughput"></a>Provisioned throughput
...
### <a name="partitioning-and-partition-keys"></a>Partitioning and partition keys
...
### <a name="sdk-and-query-options"></a>SDK and query options
...
#### <a name="max-item-count"></a>Max Item Count
...
#### <a name="max-degree-of-parallelism"></a>Max Degree of Parallelism
...
## <a name="query-execution-metrics"></a>Query execution metrics
