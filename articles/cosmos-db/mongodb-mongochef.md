...
---
# <a name="azure-cosmos-db-use-studio-3t-with-a-mongodb-api-account"></a>Azure Cosmos DB: Use Studio 3T with a MongoDB API account
...
## <a name="create-the-connection-in-studio-3t"></a>Create the connection in Studio 3T
...
## <a name="use-studio-3t-to-create-a-database-collection-and-documents"></a>Use Studio 3T to create a database, collection, and documents
