...
---
# <a name="set-and-get-throughput-for-azure-cosmos-db-containers-and-database"></a>Set and get throughput for Azure Cosmos DB containers and database
...
## <a name="provision-throughput-by-using-azure-portal"></a>Provision throughput by using Azure portal

### <a name="provision-throughput-for-a-container-collectiongraphtable"></a>Provision throughput for a container (collection/graph/table)
...
### <a name="provision-throughput-for-a-set-of-containers-or-at-the-database-level"></a>Provision throughput for a set of containers or at the database level
...
### <a name="provision-throughput-for-a-set-of-containers-as-well-as-for-an-individual-container-in-a-database"></a>Provision throughput for a set of containers as well as for an individual container in a database
...
## <a name="considerations-when-provisioning-throughput"></a>Considerations when provisioning throughput

Below are some considerations that help you decide on a throughput reservation strategy.

### <a name="considerations-when-provisioning-throughput-at-the-database-level"></a>Considerations when provisioning throughput at the database level
...
### <a name="considerations-when-provisioning-throughput-at-the-container-level"></a>Considerations when provisioning throughput at the container level
...
## <a name="throughput-ranges"></a>Throughput ranges
...
## <a name="set-throughput-by-using-sql-api-for-net"></a>Set throughput by using SQL API for .NET

### <a name="set-throughput-at-the-container-level"></a>Set throughput at the container level
...
### <a name="set-throughput-for-a-set-of-containers-at-the-database-level"></a>Set throughput for a set of containers at the database level
...
## <a name="to-set-the-throughput-by-using-the-sql-api-for-java"></a>To set the throughput by using the SQL API for Java
...
## <a name="get-throughput-by-using-mongodb-api-portal-metrics"></a>Get throughput by using MongoDB API portal metrics
