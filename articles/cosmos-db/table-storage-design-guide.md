...
---
# <a name="azure-storage-table-design-guide-designing-scalable-and-performant-tables"></a>Azure Storage Table Design Guide: Designing Scalable and Performant Tables
...
## <a name="about-the-azure-table-service"></a>About the Azure Table service
...
### <a name="table-partitions"></a>Table partitions
...
### <a name="entity-group-transactions"></a>Entity Group Transactions
...
### <a name="capacity-considerations"></a>Capacity considerations
...
## <a name="guidelines-for-table-design"></a>Guidelines for table design
...
## <a name="design-for-querying"></a>Design for querying
...
### <a name="how-your-choice-of-partitionkey-and-rowkey-impacts-query-performance"></a>How your choice of PartitionKey and RowKey impacts query performance
...
* A ***Table Scan*** does not include the **PartitionKey** and is inefficient because it searches all of the partitions that make up your table in turn for any matching entities. It will perform a table scan regardless of whether or not your filter uses the **RowKey**. For example: $filter=LastName eq 'Jones'  
...
### <a name="choosing-an-appropriate-partitionkey"></a>Choosing an appropriate PartitionKey
...
### <a name="optimizing-queries-for-the-table-service"></a>Optimizing queries for the Table service
...
### <a name="sorting-data-in-the-table-service"></a>Sorting data in the Table service
...
## <a name="design-for-data-modification"></a>Design for data modification
...
### <a name="optimizing-the-performance-of-insert-update-and-delete-operations"></a>Optimizing the performance of insert, update, and delete operations
...
### <a name="ensuring-consistency-in-your-stored-entities"></a>Ensuring consistency in your stored entities
...
### <a name="ensuring-your-design-for-efficient-modifications-facilitates-efficient-queries"></a>Ensuring your design for efficient modifications facilitates efficient queries
...
## <a name="encrypting-table-data"></a>Encrypting Table Data
...
## <a name="modeling-relationships"></a>Modeling relationships
...
### <a name="one-to-one-relationships"></a>One-to-one relationships
...
### <a name="join-in-the-client"></a>Join in the client
...
### <a name="inheritance-relationships"></a>Inheritance relationships
...
## <a name="table-design-patterns"></a>Table Design Patterns
...
### <a name="intra-partition-secondary-index-pattern"></a>Intra-partition secondary index pattern
...
### <a name="inter-partition-secondary-index-pattern"></a>Inter-partition secondary index pattern
...
### <a name="eventually-consistent-transactions-pattern"></a>Eventually consistent transactions pattern
...
#### <a name="recovering-from-failures"></a>Recovering from failures
...
### <a name="index-entities-pattern"></a>Index Entities Pattern
...
### <a name="denormalization-pattern"></a>Denormalization pattern
...
### <a name="log-tail-pattern"></a>Log tail pattern
...
### <a name="high-volume-delete-pattern"></a>High volume delete pattern
...
### <a name="data-series-pattern"></a>Data series pattern
...
### <a name="wide-entities-pattern"></a>Wide entities pattern
...
### <a name="large-entities-pattern"></a>Large entities pattern
...
### <a name="prependappend-anti-pattern"></a>Prepend/append anti-pattern
...
### <a name="log-data-anti-pattern"></a>Log data anti-pattern
...
### <a name="retrieving-entities"></a>Retrieving entities
...
#### <a name="executing-a-point-query-using-the-storage-client-library"></a>Executing a point query using the Storage Client Library
...
#### <a name="retrieving-multiple-entities-using-linq"></a>Retrieving multiple entities using LINQ
...
#### <a name="retrieving-large-numbers-of-entities-from-a-query"></a>Retrieving large numbers of entities from a query
...
### <a name="modifying-entities"></a>Modifying entities
...
#### <a name="managing-concurrency"></a>Managing concurrency
...
#### <a name="merge-or-replace"></a>Merge or replace
...
### <a name="working-with-heterogeneous-entity-types"></a>Working with heterogeneous entity types
...
#### <a name="retrieving-heterogeneous-entity-types"></a>Retrieving heterogeneous entity types
...
#### <a name="modifying-heterogeneous-entity-types"></a>Modifying heterogeneous entity types
...
### <a name="controlling-access-with-shared-access-signatures"></a>Controlling access with Shared Access Signatures
...
### <a name="asynchronous-and-parallel-operations"></a>Asynchronous and parallel operations
