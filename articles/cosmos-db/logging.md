...
---
# <a name="azure-cosmos-db-diagnostic-logging"></a>Azure Cosmos DB diagnostic logging
...
## <a name="logs-available-in-azure"></a>Logs available in Azure
...
### <a name="what-is-logged-by-azure-diagnostic-logs"></a>What is logged by Azure Diagnostic Logs?
...
<a id="#turn-on"></a>
## <a name="turn-on-logging-in-the-azure-portal"></a>Turn on logging in the Azure portal
...
## <a name="turn-on-logging-by-using-azure-cli"></a>Turn on logging by using Azure CLI
...
## <a name="turn-on-logging-by-using-powershell"></a>Turn on logging by using PowerShell
