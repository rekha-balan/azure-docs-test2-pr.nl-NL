...
---
# <a name="azure-cosmos-db-develop-with-the-table-api-in-net"></a>Azure Cosmos DB: Develop with the Table API in .NET
...
## <a name="tables-in-azure-cosmos-db"></a>Tables in Azure Cosmos DB 
...
## <a name="azure-cosmos-db-capabilities"></a>Azure Cosmos DB capabilities
...
## <a name="create-the-table-client"></a>Create the table client
...
## <a name="query-entities-using-automatic-secondary-indexes"></a>Query entities using automatic secondary indexes
