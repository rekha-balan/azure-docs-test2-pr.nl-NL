...
---
# <a name="migrate-your-data-to-azure-cosmos-db-mongodb-api-account"></a>Migrate your data to Azure Cosmos DB MongoDB API account
...
## <a name="migrate-data-by-using-mongoimport"></a>Migrate data by using mongoimport
...
## <a name="migrate-data-by-using-mongorestore"></a>Migrate data by using mongorestore
...
## <a name="steps-for-a-successful-migration"></a>Steps for a successful migration
