...
## <a name="throughput-isolation-in-globally-distributed-databases"></a>Throughput isolation in globally distributed databases
...
### <a name="use-the-azure-cosmos-db-request-charge-response-header"></a>Use the Azure Cosmos DB request charge response header
...
## <a name="a-request-unit-estimate-example"></a>A request unit estimate example
