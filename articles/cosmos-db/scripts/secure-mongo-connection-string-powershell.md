...
---
# <a name="get-an-azure-cosmos-db-connection-string-for-mongodb-apps-using-powershell"></a>Get an Azure Cosmos DB connection string for MongoDB apps using PowerShell
