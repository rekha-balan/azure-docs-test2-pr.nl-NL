...
---
# <a name="azure-cosmos-db-create-query-and-traverse-a-graph-in-the-gremlin-console"></a>Azure Cosmos DB: Create, query, and traverse a graph in the Gremlin console
...
2. Fill in your *host*, *port*, *username*, *password*, *connectionPool*, and *serializer* configurations as defined in the following table:
    ...
    For the hosts value, copy the **Gremlin URI** value from the **Overview** page: ![View and copy the Gremlin URI value on the Overview page in the Azure portal](./media/create-graph-gremlin-console/gremlin-uri.png)

    For the password value, copy the **Primary key** from the **Keys** page: ![View and copy your primary key in the Azure portal, Keys page](./media/create-graph-gremlin-console/keys.png)
...
## <a name="create-vertices-and-edges"></a>Create vertices and edges
...
## <a name="update-a-vertex"></a>Update a vertex
...
## <a name="query-your-graph"></a>Query your graph
...
## <a name="traverse-your-graph"></a>Traverse your graph
...
## <a name="drop-a-vertex"></a>Drop a vertex
...
## <a name="clear-your-graph"></a>Clear your graph
