...
---
# <a name="retiring-the-s1-s2-and-s3-performance-levels"></a>Retiring the S1, S2, and S3 performance levels
...
## <a name="how-will-my-billing-change-after-i-migrated-to-the-single-partition-collections"></a>How will my billing change after I migrated to the single partition collections?
...
## <a name="can-i-change-between-the-s1-s2-and-s3-performance-levels-before-the-planned-migration"></a>Can I change between the S1, S2, and S3 performance levels before the planned migration?
...
### <a name="migrate-to-single-partition-collections-by-using-the-net-sdk"></a>Migrate to single partition collections by using the .NET SDK
