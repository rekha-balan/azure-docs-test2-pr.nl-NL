...
---
# <a name="securing-access-to-azure-cosmos-db-data"></a>Securing access to Azure Cosmos DB data
...
## <a name="master-keys"></a>Master keys 
...
### <a name="code-sample-to-use-a-master-key"></a>Code sample to use a master key
...
### <a name="code-sample-to-create-permission"></a>Code sample to create permission
...
### <a name="code-sample-to-read-permissions-for-user"></a>Code sample to read permissions for user
...
## <a name="add-users-and-assign-roles"></a>Add users and assign roles
...
## <a name="delete-or-export-user-data"></a>Delete or export user data
