...
---
# <a name="automatic-online-backup-and-restore-with-azure-cosmos-db"></a>Automatic online backup and restore with Azure Cosmos DB
...
## <a name="high-availability-with-cosmos-db---a-recap"></a>High availability with Cosmos DB - a recap
...
## <a name="backup-retention-period"></a>Backup retention period
...
## <a name="restoring-a-database-from-an-online-backup"></a>Restoring a database from an online backup
...
## <a name="handling-data-corruption"></a>Handling data corruption
