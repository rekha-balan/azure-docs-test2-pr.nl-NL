...
---
# <a name="azure-cosmos-db-implement-a-lambda-architecture-on-the-azure-platform"></a>Azure Cosmos DB: Implement a lambda architecture on the Azure platform 
...
## <a name="what-is-a-lambda-architecture"></a>What is a lambda architecture?
...
### <a name="code-example-spark-structured-streaming-to-an-azure-cosmos-db-change-feed"></a>Code Example: Spark structured streaming to an Azure Cosmos DB change feed
...
## <a name="batch-and-serving-layers"></a>Batch and serving layers
...
### <a name="code-example-pre-computing-batch-views"></a>Code example: Pre-computing batch views
...
## <a name="lambda-architecture-rearchitected"></a>Lambda architecture: Rearchitected
