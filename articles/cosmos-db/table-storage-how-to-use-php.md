...
---
# <a name="how-to-use-azure-storage-table-service-or-the-azure-cosmos-db-table-api-from-php"></a>How to use Azure Storage Table service or the Azure Cosmos DB Table API from PHP
...
## <a name="get-the-client-library"></a>Get the client library
...
## <a name="add-required-references"></a>Add required references
...
## <a name="add-a-storage-table-service-connection"></a>Add a Storage Table service connection
...
## <a name="add-an-azure-cosmos-db-connection"></a>Add an Azure Cosmos DB connection
...
## <a name="add-a-storage-emulator-connection"></a>Add a Storage emulator connection
