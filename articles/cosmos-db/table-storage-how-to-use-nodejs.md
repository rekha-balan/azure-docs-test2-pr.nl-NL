...
---
# <a name="how-to-use-azure-table-storage-or-the-azure-cosmos-db-table-api-from-nodejs"></a>How to use Azure Table storage or the Azure Cosmos DB Table API from Node.js
...
## <a name="configure-your-application-to-access-azure-storage-or-the-azure-cosmos-db-table-api"></a>Configure your application to access Azure Storage or the Azure Cosmos DB Table API
...
## <a name="add-an-azure-storage-connection"></a>Add an Azure Storage connection
