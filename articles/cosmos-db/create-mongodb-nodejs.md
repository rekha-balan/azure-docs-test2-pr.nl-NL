...
---
# <a name="azure-cosmos-db-migrate-an-existing-nodejs-mongodb-web-app"></a>Azure Cosmos DB: Migrate an existing Node.js MongoDB web app 
...
## <a name="add-the-azure-cosmos-db-module"></a>Add the Azure Cosmos DB module
...
## <a name="connect-your-nodejs-application-to-the-database"></a>Connect your Node.js application to the database
...
## <a name="retrieve-the-key"></a>Retrieve the key
...
### <a name="run-the-application-again"></a>Run the application again.
...
## <a name="view-data-in-data-explorer"></a>View data in Data Explorer
...
## <a name="deploy-the-nodejs-application-to-azure"></a>Deploy the Node.js application to Azure
