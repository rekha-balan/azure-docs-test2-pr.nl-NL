...
---
# <a name="developing-with-azure-cosmos-db-table-api-and-azure-table-storage"></a>Developing with Azure Cosmos DB Table API and Azure Table storage
...
## <a name="developing-with-the-azure-cosmos-db-table-api"></a>Developing with the Azure Cosmos DB Table API
...
## <a name="developing-with-azure-table-storage"></a>Developing with Azure Table storage
