...
---
# <a name="connect-to-azure-cosmos-db-using-bi-analytics-tools-with-the-odbc-driver"></a>Connect to Azure Cosmos DB using BI analytics tools with the ODBC driver
...
## <a name="optional-set-up-linked-server-connection"></a>(Optional) Set up linked server connection
...
### <a name="query-linked-database"></a>Query linked database
