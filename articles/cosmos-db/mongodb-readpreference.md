...
---
# <a name="how-to-globally-distribute-reads-using-read-preference-with-the-azure-cosmos-db-mongodb-api"></a>How to globally distribute reads using Read Preference with the Azure Cosmos DB MongoDB API 
...
## <a name="read-using-read-preference-mode"></a>Read using Read Preference mode
...
## <a name="read-using-tags"></a>Read using tags
