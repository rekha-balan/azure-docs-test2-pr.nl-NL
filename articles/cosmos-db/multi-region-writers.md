...
---
# <a name="multi-master-at-global-scale-with-azure-cosmos-db"></a>Multi-master at global scale with Azure Cosmos DB 
...
## <a name="sign-up-for-multi-master-support"></a>Sign up for multi-master support
...
## <a name="a-simple-multi-master-example--content-publishing"></a>A simple multi-master example – content publishing  
...
## <a name="benefits-of-having-multi-master-support"></a>Benefits of having multi-master support 
...
## <a name="use-cases-where-multi-master-support-is-needed"></a>Use-cases where multi-master support is needed
...
## <a name="conflict-resolution-with-multi-master"></a>Conflict resolution with multi-master 
