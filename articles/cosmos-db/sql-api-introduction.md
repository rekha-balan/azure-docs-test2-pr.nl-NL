...
---
# <a name="introduction-to-azure-cosmos-db-sql-api"></a>Introduction to Azure Cosmos DB: SQL API
...
## <a name="what-capabilities-and-key-features-does-azure-cosmos-db-offer"></a>What capabilities and key features does Azure Cosmos DB offer?
