...
---
# <a name="azure-cosmos-db-using-the-mongoose-framework-with-azure-cosmos-db"></a>Azure Cosmos DB: Using the Mongoose framework with Azure Cosmos DB
...
## <a name="set-up-your-nodejs-application"></a>Set up your Node.js application
...
## <a name="caveats-to-using-mongoose-with-azure-cosmos-db"></a>Caveats to using Mongoose with Azure Cosmos DB
...
### <a name="one-collection-per-object-model"></a>One collection per object model
...
### <a name="using-mongoose-discriminators-to-store-data-in-a-single-collection"></a>Using Mongoose discriminators to store data in a single collection
