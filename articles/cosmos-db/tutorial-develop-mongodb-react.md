...
---
# <a name="create-a-mongodb-app-with-react-and-azure-cosmos-db"></a>Create a MongoDB app with React and Azure Cosmos DB  
...
### <a name="finished-project"></a>Finished Project
...
## <a name="read-and-create-heroes-in-the-app"></a>Read and create heroes in the app
...
## <a name="delete-and-update-heroes-in-the-app"></a>Delete and update heroes in the app
...
## <a name="complete-the-app"></a>Complete the app
