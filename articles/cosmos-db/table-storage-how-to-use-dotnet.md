...
---
# <a name="get-started-with-azure-table-storage-and-the-azure-cosmos-db-table-api-using-net"></a>Get started with Azure Table storage and the Azure Cosmos DB Table API using .NET
...
### <a name="install-the-required-nuget-packages"></a>Install the required NuGet packages
