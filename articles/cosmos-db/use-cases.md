...
---
# <a name="common-azure-cosmos-db-use-cases"></a>Common Azure Cosmos DB use cases
...
## <a name="iot-and-telematics"></a>IoT and telematics
...
## <a name="retail-and-marketing"></a>Retail and marketing
...
## <a name="web-and-mobile-applications"></a>Web and mobile applications
...
### <a name="social-applications"></a>Social Applications
...
* [TEXA](https://customers.microsoft.com/story/texaspa) TEXA’s revolutionary IoT solution for vehicle owners helps save time, money, gas—and possibly lives.
