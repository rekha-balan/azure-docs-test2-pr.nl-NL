...
---
# <a name="expire-data-in-azure-cosmos-db-mongodb-api"></a>Expire data in Azure Cosmos DB MongoDB API
...
## <a name="set-time-to-live-value-for-a-document"></a>Set time to live value for a document 
...
## <a name="how-to-activate-the-per-document-ttl-feature"></a>How to activate the per-document TTL feature
