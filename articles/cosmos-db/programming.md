...
---
# <a name="azure-cosmos-db-server-side-programming-stored-procedures-database-triggers-and-udfs"></a>Azure Cosmos DB server-side programming: Stored procedures, database triggers, and UDFs
...
### <a name="example-write-a-stored-procedure"></a>Example: Write a stored procedure
