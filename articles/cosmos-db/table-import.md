...
---
# <a name="migrate-your-data-to-azure-cosmos-db-table-api-account"></a>Migrate your data to Azure Cosmos DB Table API account
...
## <a name="data-migration-tool"></a>Data Migration tool
...
### <a name="command-line-source-settings"></a>Command-line source settings
...
### <a name="command-line-target-settings"></a>Command-line target settings
...
### <a name="sample-command-source-is-azure-table-storage"></a>Sample command: Source is Azure Table storage
...
### <a name="sample-command-source-is-azure-cosmos-db-table-api-preview"></a>Sample command: Source is Azure Cosmos DB Table API (preview)
...
## <a name="migrate-data-by-using-azcopy"></a>Migrate data by using AzCopy
...
## <a name="migrate-from-table-api-preview-to-table-api"></a>Migrate from Table API (preview) to Table API
