...
---
# <a name="introduction-to-azure-cosmos-db-mongodb-api"></a>Introduction to Azure Cosmos DB: MongoDB API
...
## <a name="what-is-the-benefit-of-using-azure-cosmos-db-for-mongodb-applications"></a>What is the benefit of using Azure Cosmos DB for MongoDB applications?
