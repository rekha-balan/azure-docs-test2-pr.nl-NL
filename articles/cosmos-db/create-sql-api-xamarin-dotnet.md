...
---
# <a name="azure-cosmos-db-build-a-todo-app-with-xamarin"></a>Azure Cosmos DB: Build a todo app with Xamarin
...
## <a name="obtain-your-api-keys"></a>Obtain your API keys
