...
---
# <a name="partition-and-scale-in-azure-cosmos-db"></a>Partition and scale in Azure Cosmos DB
...
## <a name="partitioning-in-azure-cosmos-db"></a>Partitioning in Azure Cosmos DB
...
### <a name="physical-partition"></a>Physical partition
...
### <a name="logical-partition"></a>Logical partition
...
## <a name="how-does-partitioning-work"></a>How does partitioning work
...
## <a name="best-practices-when-choosing-a-partition-key"></a>Best practices when choosing a partition key
...
## <a name="form-partition-key-by-concatenating-multiple-fields"></a>Form partition key by concatenating multiple fields
...
### <a name="partitioning-and-multitenancy"></a>Partitioning and multitenancy
