...
---
# <a name="nodejs-tutorial-use-the-sql-api-in-azure-cosmos-db-to-create-a-nodejs-console-application"></a>Node.js tutorial: Use the SQL API in Azure Cosmos DB to create a Node.js console application
