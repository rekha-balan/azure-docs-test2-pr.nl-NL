...
---
# <a name="how-does-azure-cosmos-db-index-data"></a>How does Azure Cosmos DB index data?
...
### <a name="customize-the-indexing-policy-in-the-portal"></a>Customize the indexing policy in the portal
...
### <a name="index-paths"></a>Index paths
...
### <a name="index-data-types-kinds-and-precisions"></a>Index data types, kinds, and precisions
...
#### <a name="index-kind"></a>Index kind
...
## <a name="opt-in-and-opt-out-of-indexing"></a>Opt in and opt out of indexing
...
## <a name="modify-the-indexing-policy-of-a-collection"></a>Modify the indexing policy of a collection
...
## <a name="changes-to-the-indexing-policy-specification"></a>Changes to the indexing policy specification
