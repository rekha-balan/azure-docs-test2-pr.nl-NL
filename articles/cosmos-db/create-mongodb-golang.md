...
---
# <a name="azure-cosmos-db-build-a-mongodb-api-console-app-with-golang-and-the-azure-portal"></a>Azure Cosmos DB: Build a MongoDB API console app with Golang and the Azure portal
...
### <a name="connecting-the-go-app-to-azure-cosmos-db"></a>Connecting the Go app to Azure Cosmos DB
...
### <a name="query-or-read-a-document"></a>Query or read a document
...
## <a name="review-your-document-in-data-explorer"></a>Review your document in Data Explorer
