...
---
# <a name="migrate-your-data-to-azure-cosmos-db-cassandra-api-account"></a>Migrate your data to Azure Cosmos DB Cassandra API account
...
## <a name="migrate-data-by-using-cqlsh-copy"></a>Migrate data by using cqlsh COPY
...
### <a name="steps-to-move-data-with-cqlsh"></a>Steps to move data with cqlsh
...
## <a name="migrate-data-by-using-spark"></a>Migrate data by using Spark
