...
---
# <a name="notifying-patients-of-hl7-fhir-health-care-record-changes-using-logic-apps-and-azure-cosmos-db"></a>Notifying patients of HL7 FHIR health care record changes using Logic Apps and Azure Cosmos DB
...
An API app connects to Azure Cosmos DB and queries for new or modified FHIR documents By resource type. This app has one controller, **FhirNotificationApi** with a one operation **GetNewOrModifiedFhirDocuments**, see [source for API app](#api-app-source).
