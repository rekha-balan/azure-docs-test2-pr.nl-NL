...
---
# <a name="welcome-to-azure-cosmos-db"></a>Welcome to Azure Cosmos DB
...
## <a name="capability-comparison"></a>Capability comparison
...
## <a name="solutions-that-benefit-from-azure-cosmos-db"></a>Solutions that benefit from Azure Cosmos DB
