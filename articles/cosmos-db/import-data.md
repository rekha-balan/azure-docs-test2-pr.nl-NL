...
---
# <a name="use-data-migration-tool-to-migrate-your-data-to-azure-cosmos-db"></a>Use Data migration tool to migrate your data to Azure Cosmos DB 
...
## <a name="select-data-source"></a>Select data source
