...
---
# <a name="create-a-mongodb-app-with-angular-and-azure-cosmos-db---part-6-add-post-put-and-delete-functions-to-the-app"></a>Create a MongoDB app with Angular and Azure Cosmos DB - Part 6: Add Post, Put, and Delete functions to the app
...
## <a name="add-a-post-function-to-the-hero-service"></a>Add a Post function to the hero service
...
## <a name="add-the-put-and-delete-functions"></a>Add the Put and Delete functions
