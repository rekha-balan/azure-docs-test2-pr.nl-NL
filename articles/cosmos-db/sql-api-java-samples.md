...
---
# <a name="azure-cosmos-db-java-examples-for-the-sql-api"></a>Azure Cosmos DB: Java examples for the SQL API
...
## <a name="offer-examples"></a>Offer examples
...
## <a name="partition-key-examples"></a>Partition key examples
...
## <a name="stored-procedure-examples"></a>Stored procedure examples
