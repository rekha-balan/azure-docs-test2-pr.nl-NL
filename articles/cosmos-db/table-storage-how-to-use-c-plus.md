...
---
# <a name="how-to-use-azure-table-storage-and-azure-cosmos-db-table-api-with-c"></a>How to use Azure Table storage and Azure Cosmos DB Table API with C++
...
## <a name="configure-access-to-the-table-client-library"></a>Configure access to the Table client library
...
## <a name="set-up-an-azure-cosmos-db-connection-string"></a>Set up an Azure Cosmos DB connection string
