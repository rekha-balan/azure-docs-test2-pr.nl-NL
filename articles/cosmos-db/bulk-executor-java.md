...
---
# <a name="use-bulk-executor-java-library-to-perform-bulk-operations-on-azure-cosmos-db-data"></a>Use bulk executor Java library to perform bulk operations on Azure Cosmos DB data
...
## <a name="bulk-import-data-to-azure-cosmos-db"></a>Bulk import data to Azure Cosmos DB
...
## <a name="bulk-update-data-in-azure-cosmos-db"></a>Bulk update data in Azure Cosmos DB
