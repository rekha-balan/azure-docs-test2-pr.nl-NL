...
---
# <a name="how-to-manage-an-azure-cosmos-db-account"></a>How to manage an Azure Cosmos DB account
...
### <a name="to-specify-the-default-consistency-for-an-azure-cosmos-db-account"></a>To specify the default consistency for an Azure Cosmos DB account
...
### <a name="copy-an-access-key-or-password-in-the-azure-portal"></a>Copy an access key or password in the Azure portal
...
### <a name="regenerate-access-keys-and-passwords"></a>Regenerate access keys and passwords
...
2. Regenerate the primary access key for your Azure Cosmos DB account. In the [Azure portal](https://portal.azure.com/), access your Azure Cosmos DB account.
