...
---
# <a name="using-the-graph-bulkexecutor-net-library-to-perform-bulk-operations-in-azure-cosmos-db-gremlin-api"></a>Using the graph BulkExecutor .NET library to perform bulk operations in Azure Cosmos DB Gremlin API
...
## <a name="bulk-operations-with-graph-data"></a>Bulk operations with graph data
...
### <a name="creating-vertices-and-edges"></a>Creating Vertices and Edges
...
## <a name="sample-application"></a>Sample application
