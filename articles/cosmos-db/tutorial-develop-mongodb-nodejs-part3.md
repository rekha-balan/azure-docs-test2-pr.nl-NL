...
---
# <a name="create-a-mongodb-app-with-angular-and-azure-cosmos-db---part-3-build-the-ui-with-angular"></a>Create a MongoDB app with Angular and Azure Cosmos DB - Part 3: Build the UI with Angular
...
## <a name="use-css-to-set-the-look-and-feel"></a>Use CSS to set the look and feel
...
## <a name="display-the-component"></a>Display the component
