...
---
# <a name="azure-cosmos-db-create-a-graph-database-using-python-and-the-azure-portal"></a>Azure Cosmos DB: Create a graph database using Python and the Azure portal
...
## <a name="update-your-connection-information"></a>Update your connection information
...
## <a name="review-and-add-sample-data"></a>Review and add sample data
