...
---
# <a name="azure-cosmos-db-build-a-net-framework-or-core-application-using-the-gremlin-api"></a>Azure Cosmos DB: Build a .NET Framework or Core application using the Gremlin API
...
## <a name="browse-using-the-data-explorer"></a>Browse using the Data Explorer
