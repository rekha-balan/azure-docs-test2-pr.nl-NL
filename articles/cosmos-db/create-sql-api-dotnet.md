...
---
# <a name="quickstart-build-a-net-web-app-with-azure-cosmos-db-using-the-sql-api-and-the-azure-portal"></a>Quickstart: Build a .NET web app with Azure Cosmos DB using the SQL API and the Azure portal
