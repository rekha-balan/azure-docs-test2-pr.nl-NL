...
---
# <a name="partitioning-in-azure-cosmos-db-using-the-sql-api"></a>Partitioning in Azure Cosmos DB using the SQL API
...
## <a name="working-with-the-azure-cosmos-db-sdks"></a>Working with the Azure Cosmos DB SDKs
...
### <a name="creating-containers"></a>Creating containers
...
### <a name="reading-and-writing-items"></a>Reading and writing items
...
### <a name="querying-partitioned-containers"></a>Querying partitioned containers
