...
---
# <a name="tunable-data-consistency-levels-in-azure-cosmos-db"></a>Tunable data consistency levels in Azure Cosmos DB
...
## <a name="distributed-databases-and-consistency"></a>Distributed databases and consistency
...
## <a name="service-level-agreements"></a>Service level agreements
...
## <a name="consistency-levels-for-the-mongodb-api"></a>Consistency levels for the MongoDB API
