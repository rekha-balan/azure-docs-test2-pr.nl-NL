...
---
# <a name="azure-cosmos-db-serverless-database-computing-using-azure-functions"></a>Azure Cosmos DB: Serverless database computing using Azure Functions
...
### <a name="iot-use-case---azure-cosmos-db-trigger-and-output-binding"></a>IoT use case - Azure Cosmos DB trigger and output binding
...
### <a name="financial-use-case---timer-trigger-and-input-binding"></a>Financial use case - Timer trigger and input binding
...
### <a name="gaming-use-case---azure-cosmos-db-trigger-and-output-binding"></a>Gaming use case - Azure Cosmos DB trigger and output binding
...
### <a name="retail-use-case---multiple-functions"></a>Retail use case - Multiple functions
...
* In the Azure Functions portal, you can create an Azure Cosmos DB trigger. For quickstart instructions, see [Create an Azure Cosmos DB trigger in the Azure portal](https://aka.ms/cosmosdbtriggerportalfunc) ![Create an Azure Cosmos DB trigger in the Azure Functions portal](./media/serverless-computing-database/azure-function-cosmos-db-trigger.png) 
...
## <a name="why-choose-azure-functions-integration-for-serverless-computing"></a>Why choose Azure Functions integration for serverless computing?
