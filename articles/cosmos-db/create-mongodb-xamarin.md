...
---
# <a name="quickstart-build-a-mongodb-api-xamarinforms-app-with-net-and-the-azure-portal"></a>QuickStart: Build a MongoDB API Xamarin.Forms app with .NET and the Azure portal
...
## <a name="prerequisites-to-run-the-sample-app"></a>Prerequisites to run the sample app
