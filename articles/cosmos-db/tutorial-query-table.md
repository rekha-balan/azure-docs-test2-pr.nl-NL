...
---
# <a name="tutorial-query-azure-cosmos-db-by-using-the-table-api"></a>Tutorial: Query Azure Cosmos DB by using the Table API
...
## <a name="query-on-partitionkey-and-rowkey"></a>Query on PartitionKey and RowKey
...
## <a name="query-by-using-an-odata-filter"></a>Query by using an OData filter
...
## <a name="query-by-using-linq"></a>Query by using LINQ 
