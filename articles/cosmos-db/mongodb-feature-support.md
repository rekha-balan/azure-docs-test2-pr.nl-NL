...
---
# <a name="mongodb-api-support-for-mongodb-features-and-syntax"></a>MongoDB API support for MongoDB features and syntax
...
## <a name="mongodb-protocol-support"></a>MongoDB Protocol Support
...
## <a name="mongodb-query-language-support"></a>MongoDB query language support
...
## <a name="database-commands"></a>Database commands

Azure Cosmos DB supports the following database commands on all MongoDB API accounts.

### <a name="query-and-write-operation-commands"></a>Query and write operation commands
- delete
- find
- findAndModify
- getLastError
...
### <a name="authentication-commands"></a>Authentication commands
- logout
- authenticate
- getnonce

### <a name="administration-commands"></a>Administration commands
- dropDatabase
- listCollections
- drop
- create
...
## <a name="aggregation-pipelinea"></a>Aggregation pipeline</a>
...
### <a name="aggregation-commands"></a>Aggregation commands
- aggregate
- count
- distinct

### <a name="aggregation-stages"></a>Aggregation stages
- $project
- $match
- $limit
- $skip
...
### <a name="aggregation-expressions"></a>Aggregation expressions
...
#### <a name="comparison-expressions"></a>Comparison expressions
- $cmp
- $eq
- $gt
- $gte
...
#### <a name="arithmetic-expressions"></a>Arithmetic expressions
- $abs
- $add
- $ceil
- $divide
...
#### <a name="string-expressions"></a>String expressions
- $concat
- $indexOfBytes
- $indexOfCP
- $split
...
#### <a name="array-expressions"></a>Array expressions
- $arrayElemAt
- $concatArrays
- $filter
- $indexOfArray
...
#### <a name="date-expressions"></a>Date expressions
- $dayOfYear
- $dayOfMonth
- $dayOfWeek
- $year
...
## <a name="aggregation-accumulators"></a>Aggregation accumulators
- $sum
- $avg
- $first
- $last
...
When there's a need to include '$' or '|', it is best to create two (or more) regex queries. For example, given the following original query: ```find({x:{$regex: /^abc$/})```, it has to be modified as follows: ```find({x:{$regex: /^abc/, x:{$regex:/^abc$/}})```.
...
#### <a name="field-update-operators"></a>Field update operators
- $inc
- $mul
- $rename
- $setOnInsert
...
#### <a name="array-update-operators"></a>Array update operators
- $addToSet
- $pop
- $pullAll
...
#### <a name="bitwise-update-operator"></a>Bitwise update operator
- $bit

### <a name="geospatial-operators"></a>Geospatial operators
...
## <a name="additional-operators"></a>Additional operators
...
## <a name="unsupported-operators"></a>Unsupported operators
...
#### <a name="cursor-methods"></a>Cursor methods
...
## <a name="user-and-role-management"></a>User and role management
