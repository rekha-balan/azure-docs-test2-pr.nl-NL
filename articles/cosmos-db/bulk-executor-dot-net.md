...
---
# <a name="use-bulk-executor-net-library-to-perform-bulk-operations-in-azure-cosmos-db"></a>Use bulk executor .NET library to perform bulk operations in Azure Cosmos DB
