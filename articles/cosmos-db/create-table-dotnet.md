...
---
# <a name="quickstart-build-a-table-api-app-with-net-and-azure-cosmos-db"></a>Quickstart: Build a Table API app with .NET and Azure Cosmos DB 
...
3. Run the following command to clone the sample repository. This command creates a copy of the sample app on your computer.
    ...
    ```
## <a name="open-the-sample-application-in-visual-studio"></a>Open the sample application in Visual Studio
...
## <a name="build-and-deploy-the-app"></a>Build and deploy the app
