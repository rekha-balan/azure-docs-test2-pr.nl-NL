...
---
# <a name="mock-api-responses"></a>Mock API responses
...
## <a name="create-a-test-api"></a>Create a test API 
...
## <a name="add-an-operation-to-the-test-api"></a>Add an operation to the test API
...
## <a name="enable-response-mocking"></a>Enable response mocking
...
## <a name="test-the-mocked-api"></a>Test the mocked API
