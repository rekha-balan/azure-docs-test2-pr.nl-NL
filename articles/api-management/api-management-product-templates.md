...
---
# <a name="product-templates-in-azure-api-management"></a>Product templates in Azure API Management
...
##  <a name="ProductList"></a> Product list  
 ...
 ![Products list](https://docstestmedia1.blob.core.windows.net/azure-media/articles/api-management/media/api-management-product-templates/apim_productslisttemplatepage.png "APIM_ProductsListTemplatePage")  
...
##  <a name="Product"></a> Product  
 ...
 ![Developer portal product page](https://docstestmedia1.blob.core.windows.net/azure-media/articles/api-management/media/api-management-product-templates/apim_productpage.png "APIM_ProductPage")  
