...
#### <a name="powershell-method"></a>Powershell method ####
...
#### <a name="direct-api-update-method"></a>Direct API update method ####
...
### <a name="why-do-we-require-a-dedicated-subnet-in-resource-manager-style-vnets-when-api-management-is-deployed-into-them"></a>Why do we require a dedicated subnet in Resource Manager style VNETs when API Management is deployed into them?
...
### <a name="what-is-the-minimum-subnet-size-needed-when-deploying-api-management-into-a-vnet"></a>What is the minimum subnet size needed when deploying API Management into a VNET?
...
### <a name="are-there-restrictions-on-or-known-issues-with-importing-my-api"></a>Are there restrictions on or known issues with importing my API?
