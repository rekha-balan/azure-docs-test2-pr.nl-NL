...
---
# <a name="how-to-integrate-azure-api-management-with-azure-application-insights"></a>How to integrate Azure API Management with Azure Application Insights
...
## <a name="create-an-azure-application-insights-instance"></a>Create an Azure Application Insights instance
...
## <a name="create-a-connection-between-azure-application-insights-and-azure-api-management-service-instance"></a>Create a connection between Azure Application Insights and Azure API Management service instance
...
## <a name="enable-application-insights-logging-for-your-api"></a>Enable Application Insights logging for your API
...
## <a name="what-data-is-added-to-azure-application-insights"></a>What data is added to Azure Application Insights
...
## <a name="performance-implications-and-log-sampling"></a>Performance implications and log sampling
