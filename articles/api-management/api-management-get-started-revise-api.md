...
---
# <a name="use-revisions-to-make-non-breaking-changes-safely"></a>Use revisions to make non-breaking changes safely
...
## <a name="add-a-new-revision"></a>Add a new revision
...
## <a name="make-non-breaking-changes-to-your-revision"></a>Make non-breaking changes to your revision
...
## <a name="make-your-revision-current-and-add-a-change-log-entry"></a>Make your revision current and add a change log entry
...
## <a name="browse-the-developer-portal-to-see-changes-and-change-log"></a>Browse the developer portal to see changes and change log
