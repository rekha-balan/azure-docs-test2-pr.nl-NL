...
---
# <a name="api-management-access-restriction-policies"></a>API Management access restriction policies
...
#### <a name="azure-mobile-services-token-validation"></a>Azure Mobile Services token validation  
...
#### <a name="azure-active-directory-token-validation"></a>Azure Active Directory token validation  
...
#### <a name="azure-active-directory-b2c-token-validation"></a>Azure Active Directory B2C token validation  
...
#### <a name="authorize-access-to-operations-based-on-token-claims"></a>Authorize access to operations based on token claims  
