...
---
# <a name="add-an-api-manually"></a>Add an API manually
...
## <a name="create-an-api"></a>Create an API
...
### <a name="test-an-operation"></a>Test an operation
...
## <a name="add-and-test-a-parameterized-operation"></a>Add and test a parameterized operation
...
### <a name="add-the-operation"></a>Add the operation
...
### <a name="test-the-operation"></a>Test the operation 
