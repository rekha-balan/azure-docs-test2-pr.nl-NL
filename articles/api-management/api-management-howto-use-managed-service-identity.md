...
---
# <a name="use-azure-managed-service-identity-in-azure-api-management"></a>Use Azure Managed Service Identity in Azure API Management
...
## <a name="create-a-managed-service-identity-for-an-api-management-instance"></a>Create a managed service identity for an API Management instance
...
### <a name="using-the-azure-resource-manager-template"></a>Using the Azure Resource Manager template
...
```
## <a name="use-the-managed-service-identity-to-access-other-resources"></a>Use the managed service identity to access other resources
...
### <a name="obtain-a-certificate-from-azure-key-vault"></a>Obtain a certificate from Azure Key Vault
