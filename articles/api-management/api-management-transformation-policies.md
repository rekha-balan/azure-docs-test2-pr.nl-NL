...
---
# <a name="api-management-transformation-policies"></a>API Management transformation policies
...
#### <a name="literal-text-example"></a>Literal text example  
  
```xml  
<set-body>Hello world!</set-body>  
```  
  
#### <a name="example-accessing-the-body-as-a-string-note-that-we-are-preserving-the-original-request-body-so-that-we-can-access-it-later-in-the-pipeline"></a>Example accessing the body as a string. Note that we are preserving the original request body so that we can access it later in the pipeline.
...
#### <a name="filter-response-based-on-product"></a>Filter response based on product  
...
### <a name="using-liquid-templates-with-set-body"></a>Using Liquid templates with set body 
...
#### <a name="convert-json-to-soap-using-a-liquid-template"></a>Convert JSON to SOAP using a Liquid template
```xml
...
#### <a name="tranform-json-using-a-liquid-template"></a>Tranform JSON using a Liquid template
```xml
{
"order": {
...
#### <a name="forward-context-information-to-the-backend-service"></a>Forward context information to the backend service  
