...
---
# <a name="using-azure-api-management-service-with-an-internal-virtual-network"></a>Using Azure API Management service with an internal virtual network
...
### <a name="enable-a-virtual-network-connection-using-the-azure-portal"></a>Enable a virtual network connection using the Azure portal
...
### <a name="enable-a-virtual-network-connection-by-using-powershell-cmdlets"></a>Enable a virtual network connection by using PowerShell cmdlets
