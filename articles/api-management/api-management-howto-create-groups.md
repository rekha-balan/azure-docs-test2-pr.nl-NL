...
---
# <a name="how-to-create-and-use-groups-to-manage-developer-accounts-in-azure-api-management"></a>How to create and use groups to manage developer accounts in Azure API Management
