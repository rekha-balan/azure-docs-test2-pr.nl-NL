...
---
# <a name="configure-a-custom-domain-name"></a>Configure a custom domain name 
...
## <a name="use-the-azure-portal-to-set-a-custom-domain-name"></a>Use the Azure portal to set a custom domain name
