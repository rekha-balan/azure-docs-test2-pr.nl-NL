...
---
# <a name="publish-multiple-versions-of-your-api"></a>Publish multiple versions of your API 
...
## <a name="add-a-new-version"></a>Add a new version
...
## <a name="choose-a-versioning-scheme"></a>Choose a versioning scheme
...
## <a name="add-the-version-to-a-product"></a>Add the version to a product
...
## <a name="browse-the-developer-portal-to-see-the-version"></a>Browse the developer portal to see the version
