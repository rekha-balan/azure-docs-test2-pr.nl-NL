...
---
# <a name="application-templates-in-azure-api-management"></a>Application templates in Azure API Management
...
##  <a name="ProductList"></a> Application list  
 ...
 ![Application List Page Developer Portal Templates](https://docstestmedia1.blob.core.windows.net/azure-media/articles/api-management/media/api-management-application-templates/apim-application-list-page-developer-portal-templates.png "APIM Application List Page Developer Portal Templates")  
...
##  <a name="Application"></a> Application  
 ...
 ![Application Page Developer Portal Templates](https://docstestmedia1.blob.core.windows.net/azure-media/articles/api-management/media/api-management-application-templates/apim-application-page-developer-portal-templates.png "APIM Application Page Developer Portal Templates")  
