...
---
# <a name="add-messages-to-an-azure-storage-queue-using-functions"></a>Add messages to an Azure Storage queue using Functions
...
## <a name="add-code-that-uses-the-output-binding"></a>Add code that uses the output binding
...
### <a name="connect-storage-explorer-to-your-account"></a>Connect Storage Explorer to your account
...
### <a name="examine-the-output-queue"></a>Examine the output queue
