...
---
# <a name="choose-the-correct-service-plan-for-azure-functions"></a>Choose the correct service plan for Azure Functions
...
## <a name="service-plan-options"></a>Service plan options
...
### <a name="consumption-plan"></a>Consumption plan
...
## <a name="how-the-consumption-plan-works"></a>How the Consumption plan works
...
### <a name="billing-model"></a>Billing model
