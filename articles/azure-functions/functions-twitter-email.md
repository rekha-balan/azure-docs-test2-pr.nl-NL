...
---
# <a name="create-a-function-that-integrates-with-azure-logic-apps"></a>Create a function that integrates with Azure Logic Apps
...
## <a name="create-a-cognitive-services-resource"></a>Create a Cognitive Services resource
...
## <a name="create-the-function-app"></a>Create the function app
...
## <a name="add-sentiment-detection"></a>Add sentiment detection
...
## <a name="connect-sentiment-output-to-your-function"></a>Connect sentiment output to your function
...
## <a name="add-email-notifications"></a>Add email notifications
...
## <a name="disable-the-logic-app"></a>Disable the logic app
