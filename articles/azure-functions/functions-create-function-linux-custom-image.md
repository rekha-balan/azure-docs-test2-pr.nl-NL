...
---
# <a name="create-a-function-on-linux-using-a-custom-image-preview"></a>Create a function on Linux using a custom image (preview)
...
### <a name="run-the-build-command"></a>Run the Build command
...
### <a name="test-the-image-locally"></a>Test the image locally
...
## <a name="push-the-custom-image-to-docker-hub"></a>Push the custom image to Docker Hub
...
## <a name="create-and-deploy-the-custom-image"></a>Create and deploy the custom image
...
## <a name="configure-the-function-app"></a>Configure the function app
