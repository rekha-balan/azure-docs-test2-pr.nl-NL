...
---
# <a name="create-a-function-triggered-by-azure-blob-storage"></a>Create a function triggered by Azure Blob storage
...
## <a name="create-a-blob-storage-triggered-function"></a>Create a Blob storage triggered function
...
## <a name="create-the-container"></a>Create the container
