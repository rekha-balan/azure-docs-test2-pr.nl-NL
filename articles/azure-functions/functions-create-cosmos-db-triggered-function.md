...
---
# <a name="create-a-function-triggered-by-azure-cosmos-db"></a>Create a function triggered by Azure Cosmos DB
...
## <a name="create-azure-cosmos-db-trigger"></a>Create Azure Cosmos DB trigger
...
## <a name="create-the-items-collection"></a>Create the Items collection
