...
### <a name="test-with-curl-from-the-command-line"></a>Test with cURL from the command line
...
### <a name="test-a-blob-trigger-by-using-storage-explorer"></a>Test a blob trigger by using Storage Explorer
...
#### <a name="create-a-queue-trigger-for-testing"></a>Create a queue trigger for testing
...
### <a name="test-an-http-trigger-function-with-code-nodejs"></a>Test an HTTP trigger function with code: Node.js
