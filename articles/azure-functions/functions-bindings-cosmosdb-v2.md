...
---
# <a name="azure-cosmos-db-bindings-for-azure-functions-2x-preview"></a>Azure Cosmos DB bindings for Azure Functions 2.x (Preview)
...
### <a name="ouput---c-examples"></a>Ouput - C# examples
