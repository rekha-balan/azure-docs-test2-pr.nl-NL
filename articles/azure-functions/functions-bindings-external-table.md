...
---
# <a name="external-table-binding-for-azure-functions-experimental"></a>External Table binding for Azure Functions (experimental)
...
## <a name="api-connections"></a>API connections
...
### <a name="available-api-connections-tables"></a>Available API connections (tables)
...
## <a name="creating-an-api-connection-step-by-step"></a>Creating an API connection: step by step
...
### <a name="sql-server-data-source"></a>SQL Server data source
...
### <a name="google-sheets-data-source"></a>Google Sheets data source
