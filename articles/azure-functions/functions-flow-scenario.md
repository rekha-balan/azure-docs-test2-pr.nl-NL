...
---
# <a name="call-a-function-from-microsoft-flow"></a>Call a function from Microsoft Flow
...
## <a name="create-a-sharepoint-list"></a>Create a SharePoint list
...
## <a name="add-a-connection-to-the-api"></a>Add a connection to the API
...
## <a name="create-a-flow"></a>Create a flow

Now you're ready to create a flow that uses the custom connector and the SharePoint list you created.

### <a name="add-a-trigger-and-specify-a-condition"></a>Add a trigger and specify a condition
...
### <a name="add-the-custom-connector"></a>Add the custom connector
...
### <a name="send-email-based-on-function-results"></a>Send email based on function results
...
## <a name="run-the-flow"></a>Run the flow
