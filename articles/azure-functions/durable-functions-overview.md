...
---
# <a name="durable-functions-overview"></a>Durable Functions overview
...
## <a name="pattern-1-function-chaining"></a>Pattern #1: Function chaining
...
#### <a name="javascript-functions-v2-only"></a>JavaScript (Functions v2 only)
...
## <a name="pattern-2-fan-outfan-in"></a>Pattern #2: Fan-out/fan-in
...
## <a name="pattern-3-async-http-apis"></a>Pattern #3: Async HTTP APIs
...
## <a name="pattern-4-monitoring"></a>Pattern #4: Monitoring
...
## <a name="pattern-5-human-interaction"></a>Pattern #5: Human interaction
...
### <a name="event-sourcing-checkpointing-and-replay"></a>Event sourcing, checkpointing, and replay
...
### <a name="orchestrator-code-constraints"></a>Orchestrator code constraints
...
## <a name="storage-and-scalability"></a>Storage and scalability
