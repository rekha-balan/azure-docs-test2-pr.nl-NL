...
---
# <a name="call-a-function-from-powerapps"></a>Call a function from PowerApps
...
## <a name="create-an-app-and-add-data-sources"></a>Create an app and add data sources
...
## <a name="add-controls-to-view-data-in-the-app"></a>Add controls to view data in the app
...
## <a name="add-controls-to-call-the-function-and-display-data"></a>Add controls to call the function and display data
