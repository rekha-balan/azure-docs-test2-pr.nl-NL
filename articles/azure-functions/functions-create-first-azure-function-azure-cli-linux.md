...
---
# <a name="create-your-first-function-running-on-linux-using-the-azure-cli-preview"></a>Create your first function running on Linux using the Azure CLI (preview)
...
## <a name="create-a-function-app-on-linux"></a>Create a function app on Linux
