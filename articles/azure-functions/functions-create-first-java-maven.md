...
---
# <a name="create-your-first-function-with-java-and-maven-preview"></a>Create your first function with Java and Maven (Preview)
...
## <a name="install-the-azure-functions-core-tools"></a>Install the Azure Functions Core Tools
...
## <a name="generate-a-new-functions-project"></a>Generate a new Functions project
...
## <a name="deploy-the-function-to-azure"></a>Deploy the function to Azure
...
## <a name="make-changes-and-redeploy"></a>Make changes and redeploy
