...
### <a name="other-requirements"></a>Other requirements
...
## <a name="add-bindings"></a>Add bindings
...
## <a name="testing-functions"></a>Testing functions
...
## <a name="function-app-settings"></a>Function app settings
