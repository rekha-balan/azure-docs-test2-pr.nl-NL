...
---
# <a name="create-a-serverless-api-using-azure-functions"></a>Create a serverless API using Azure Functions
...
## <a name="customize-your-http-function"></a>Customize your HTTP function
...
### <a name="test-your-api"></a>Test your API
...
## <a name="proxies-overview"></a>Proxies overview
...
## <a name="create-your-first-proxy"></a>Create your first proxy

In this section, you will create a new proxy which serves as a frontend to your overall API. 

### <a name="setting-up-the-frontend-environment"></a>Setting up the frontend environment
...
### <a name="creating-a-proxy-on-the-frontend"></a>Creating a proxy on the frontend
...
## <a name="create-a-mock-api"></a>Create a mock API
