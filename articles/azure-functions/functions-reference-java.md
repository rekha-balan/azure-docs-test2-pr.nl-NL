...
### <a name="plain-old-java-objects-pojos"></a>Plain old Java objects (POJOs)
...
## <a name="function-method-overloading"></a>Function method overloading
...
## <a name="specialized-types"></a>Specialized Types
