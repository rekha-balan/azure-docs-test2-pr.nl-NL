...
---
# <a name="overview-of-function-types-and-features-for-durable-functions-azure-functions"></a>Overview of function types and features for Durable Functions (Azure Functions)
...
## <a name="types-of-functions"></a>Types of functions
...
### <a name="sub-orchestrations"></a>Sub-orchestrations
...
### <a name="external-events"></a>External events
...
### <a name="cross-function-app-communication"></a>Cross-function app communication
