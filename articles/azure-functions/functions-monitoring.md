...
## <a name="enable-app-insights-integration"></a>Enable App Insights integration
...
### <a name="new-function-app"></a>New function app
...
### <a name="manually-connect-an-app-insights-resource"></a>Manually connect an App Insights resource 
...
## <a name="view-telemetry-in-app-insights"></a>View telemetry in App Insights
...
### <a name="configure-logging-in-hostjson"></a>Configure logging in host.json
...
### <a name="logging-custom-metrics"></a>Logging custom metrics  
...
## <a name="custom-telemetry-in-c-functions"></a>Custom telemetry in C# functions
...
## <a name="custom-telemetry-in-javascript-functions"></a>Custom telemetry in JavaScript functions
...
## <a name="monitoring-without-application-insights"></a>Monitoring without Application Insights
...
### <a name="logging-to-storage"></a>Logging to storage
...
### <a name="viewing-log-files-locally"></a>Viewing log files locally
