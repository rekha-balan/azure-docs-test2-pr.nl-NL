...
---
# <a name="send-sms-messages-from-azure-functions-using-the-twilio-output-binding"></a>Send SMS messages from Azure Functions using the Twilio output binding
...
## <a name="functionjson-for-the-twilio-output-binding"></a>function.json for the Twilio output binding
