...
---
# <a name="install-the-durable-functions-extension-and-samples-azure-functions"></a>Install the Durable Functions extension and samples (Azure Functions)
...
### <a name="start-with-sample-functions"></a>Start with sample functions 
...
### <a name="start-with-an-empty-project"></a>Start with an empty project
...
2. Search for the following NuGet package reference using *Manage NuGet Packages* and add it to the project: Microsoft.Azure.WebJobs.Extensions.DurableTask v1.6.0
