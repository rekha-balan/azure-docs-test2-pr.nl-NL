...
## <a name="view-the-current-runtime-version"></a>View the current runtime version
...
## <a name="target-a-version-using-the-portal"></a>Target a version using the portal
...
## <a name="target-a-version-using-azure-cli"></a>Target a version using Azure CLI
