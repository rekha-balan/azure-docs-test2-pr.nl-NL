...
---
# <a name="how-to-manage-connections-in-azure-functions"></a>How to manage connections in Azure Functions
...
## <a name="connections-limit"></a>Connections limit
...
## <a name="use-static-clients"></a>Use static clients
...
## <a name="httpclient-code-example"></a>HttpClient code example
...
## <a name="documentclient-code-example"></a>DocumentClient code example
