...
### <a name="example-queue-trigger-and-table-output-binding"></a>Example: queue trigger and table output binding
...
## <a name="using-the-function-return-type-to-return-a-single-output"></a>Using the function return type to return a single output
...
## <a name="resolving-app-settings"></a>Resolving app settings
...
## <a name="trigger-metadata-properties"></a>Trigger metadata properties
...
## <a name="binding-expressions-and-patterns"></a>Binding expressions and patterns
...
## <a name="bind-to-custom-input-properties-in-a-binding-expression"></a>Bind to custom input properties in a binding expression
