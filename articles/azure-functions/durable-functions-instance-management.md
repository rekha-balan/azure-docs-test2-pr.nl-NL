...
---
# <a name="manage-instances-in-durable-functions-azure-functions"></a>Manage instances in Durable Functions (Azure Functions)
...
## <a name="starting-instances"></a>Starting instances
...
## <a name="querying-instances"></a>Querying instances
...
```
## <a name="querying-all-instances"></a>Querying all instances
...
## <a name="terminating-instances"></a>Terminating instances
...
## <a name="sending-events-to-instances"></a>Sending events to instances
...
## <a name="retrieving-http-management-webhook-urls"></a>Retrieving HTTP Management Webhook URLs
...
## <a name="rewinding-instances-preview"></a>Rewinding instances (preview)
