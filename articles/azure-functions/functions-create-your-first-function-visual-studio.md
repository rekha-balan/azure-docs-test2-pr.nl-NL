...
---
# <a name="create-your-first-function-using-visual-studio"></a>Create your first function using Visual Studio
...
## <a name="create-a-function-app-project"></a>Create a function app project
