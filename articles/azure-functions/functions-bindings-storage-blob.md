...
### <a name="blob-only-storage-accounts"></a>Blob-only storage accounts
...
### <a name="cold-start-delay"></a>Cold-start delay
...
### <a name="input---c-example"></a>Input - C# example
