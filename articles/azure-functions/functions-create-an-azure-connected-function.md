...
---
# <a name="use-azure-functions-to-create-a-function-that-connects-to-other-azure-services"></a>Use Azure Functions to create a function that connects to other Azure services
...
## <a name="create-a-function-that-writes-to-the-queue"></a>Create a function that writes to the queue
...
## <a name="add-a-message-queue-output-binding"></a>Add a message queue output binding
...
## <a name="view-storage-updates-by-using-storage-explorer"></a>View storage updates by using Storage Explorer
...
## <a name="create-a-function-that-reads-from-the-queue"></a>Create a function that reads from the queue
...
## <a name="add-a-table-output-binding"></a>Add a table output binding
