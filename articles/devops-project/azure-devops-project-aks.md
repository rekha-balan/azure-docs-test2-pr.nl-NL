...
---
# <a name="tutorial--deploy-your-aspnet-core-app-to-azure-kubernetes-service-aks-with-the-azure-devops-project"></a>Tutorial:  Deploy your ASP.NET Core App to Azure Kubernetes Service (AKS) with the Azure DevOps Project
...
## <a name="create-an-azure-devops-project-for-an-aspnet-core-app-and-aks"></a>Create an Azure DevOps Project for an ASP.NET Core App and AKS
...
## <a name="examine-the-aks-cluster"></a>Examine the AKS cluster
...
## <a name="examine-the-azure-devops-services-cd-release-pipeline"></a>Examine the Azure DevOps Services CD Release pipeline
...
## <a name="commit-changes-to-azure-devops-services-and-automatically-deploy-to-azure"></a>Commit changes to Azure DevOps Services and automatically deploy to Azure 
