...
---
# <a name="create-a-cicd-pipeline-for-ruby-on-rails-with-the-azure-devops-project"></a>Create a CI/CD pipeline for Ruby on Rails with the Azure DevOps Project
