...
---
# <a name="tutorial--deploy-your-aspnet-app-to-azure-virtual-machines-with-the-azure-devops-project"></a>Tutorial:  Deploy your ASP.NET App to Azure Virtual Machines with the Azure DevOps Project
...
## <a name="create-an-azure-devops-project-for-an-aspnet-app"></a>Create an Azure DevOps Project for an ASP.NET App
