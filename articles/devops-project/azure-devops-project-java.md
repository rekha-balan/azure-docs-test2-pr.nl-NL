...
---
# <a name="create-a-cicd-pipeline-for-java-with-the-azure-devops-project"></a>Create a CI/CD pipeline for Java with the Azure DevOps Project
...
## <a name="select-a-sample-application-and-azure-service"></a>Select a sample application and Azure service
...
## <a name="commit-code-changes-and-execute-cicd"></a>Commit code changes and execute CI/CD
...
## <a name="examine-the-azure-cicd-pipeline"></a>Examine the Azure CI/CD pipeline
