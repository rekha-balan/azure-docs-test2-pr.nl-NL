...
---
# <a name="create-a-cicd-pipeline-for-your-existing-code-with-the-azure-devops-project"></a>Create a CI/CD pipeline for your existing code with the Azure DevOps Project
...
## <a name="configure-access-to-your-github-repository-and-choose-a-framework"></a>Configure access to your GitHub repository and choose a framework
...
## <a name="commit-changes-to-github-and-automatically-deploy-to-azure"></a>Commit changes to GitHub and automatically deploy to Azure 
...
## <a name="examine-the-azure-devops-services-cicd-pipeline"></a>Examine the Azure DevOps Services CI/CD pipeline
...
## <a name="configure-azure-application-insights-monitoring"></a>Configure Azure Application Insights monitoring
