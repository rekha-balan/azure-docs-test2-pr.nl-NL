...
---
# <a name="tutorial--deploy-your-aspnet-app-and-azure-sql-database-with-the-azure-devops-project"></a>Tutorial:  Deploy your ASP.NET App and Azure SQL Database with the Azure DevOps Project
...
## <a name="create-an-azure-devops-project-for-an-aspnet-app-and-azure-sql-database"></a>Create an Azure DevOps Project for an ASP.NET App and Azure SQL Database
...
## <a name="connect-to-the-azure-sql-server-database"></a>Connect to the Azure SQL Server Database
