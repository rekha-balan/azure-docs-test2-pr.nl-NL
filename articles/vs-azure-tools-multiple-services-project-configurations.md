...
---
# <a name="configuring-your-azure-project-in-visual-studio-to-use-multiple-service-configurations"></a>Configuring your Azure project in Visual Studio to use multiple service configurations
...
### <a name="startup-action-web-role-only"></a>Startup Action (Web role only)
...
### <a name="configuring-a-connection-string-for-a-storage-account"></a>Configuring a connection string for a storage account
...
1. Selecting **Manually entered credentials** lets you specify the account name and key directly using information from the Azure portal. To copy the account key: a. Navigate to the storage account on the Azure portal and select **Manage Keys**.
