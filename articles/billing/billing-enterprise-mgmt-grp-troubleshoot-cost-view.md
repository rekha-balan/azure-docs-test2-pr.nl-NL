...
---
# <a name="troubleshoot-enterprise-cost-views"></a>Troubleshoot enterprise cost views 
...
## <a name="enabling-access-to-costs"></a>Enabling access to costs

Are you seeing a message Unauthorized, or *"Cost views are disabled in your enrollment."* when looking for cost information? ![unauthorized](media/billing-enterprise-mgmt-groups/unauthorized.png)
...
## <a name="asset-is-unavailable"></a>Asset is unavailable? 
