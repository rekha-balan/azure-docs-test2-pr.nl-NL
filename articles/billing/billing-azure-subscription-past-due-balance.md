...
---
# <a name="resolve-past-due-balance-for-your-azure-subscription-after-getting-an-email-from-azure"></a>Resolve past due balance for your Azure subscription after getting an email from Azure
...
## <a name="resolve-the-past-due-balance"></a>Resolve the past due balance
...
## <a name="not-getting-billing-email-notifications"></a>Not getting billing email notifications?
...
## <a name="if-i-forget-to-pay-what-happens"></a>If I forget to pay, what happens?
