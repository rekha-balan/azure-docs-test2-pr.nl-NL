...
---
# <a name="create-services-included-with-azure-free-account"></a>Create services included with Azure free account
...
## <a name="create-free-services-in-the-azure-portal"></a>Create free services in the Azure portal
...
## <a name="services-can-be-created-in-any-region"></a>Services can be created in any region
...
## <a name="multiple-instances-of-services-can-be-created-within-allowed-limits"></a>Multiple instances of services can be created within allowed limits
