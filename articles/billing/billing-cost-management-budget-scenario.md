...
---
# <a name="manage-costs-with-azure-budgets"></a>Manage costs with Azure Budgets
...
### <a name="import-the-stop-azure-v2-vms-runbook"></a>Import the Stop Azure V2 VMs runbook
...
## <a name="create-webhooks-for-the-runbook"></a>Create webhooks for the runbook
...
## <a name="create-an-azure-logic-app-for-orchestration"></a>Create an Azure Logic App for orchestration
...
### <a name="add-the-first-conditional-action"></a>Add the first conditional action
...
3.  Click **Expression** at the top of the list and enter the following expression in the expression editor: `float()`
...
10. Click **Expression** at the top of the list and enter the following expression in the expression editor: `float()`
...
### <a name="add-the-second-conditional-action"></a>Add the second conditional action
...
### <a name="logic-app-summary"></a>Logic App summary
...
## <a name="create-an-azure-monitor-action-group"></a>Create an Azure Monitor Action Group
...
### <a name="create-an-action-group-in-azure-monitor"></a>Create an action group in Azure Monitor
...
## <a name="create-the-azure-budget"></a>Create the Azure Budget 
...
### <a name="create-an-authentication-token"></a>Create an authentication token
...
### <a name="create-the-budget"></a>Create the Budget
