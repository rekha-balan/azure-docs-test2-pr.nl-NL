...
---
# <a name="windows-software-costs-not-included-with-azure-reserved-vm-instances"></a>Windows software costs not included with Azure Reserved VM Instances
...
## <a name="windows-software-meters-not-included-in-reservation-cost"></a>Windows software meters not included in reservation cost
