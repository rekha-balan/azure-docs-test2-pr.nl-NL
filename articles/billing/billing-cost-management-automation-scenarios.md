...
---
# <a name="billing-and-cost-management-automation-scenarios"></a>Billing and cost management automation scenarios
...
## <a name="scenario-to-api-mappings"></a>Scenario to API mappings
...
## <a name="api-summaries"></a>API summaries
...
### <a name="what-is-the-difference-between-the-enterprise-reporting-apis-and-the-consumption-apis-when-should-i-use-each"></a>What is the difference between the Enterprise Reporting APIs and the Consumption APIs? When should I use each?
...
### <a name="what-is-the-difference-between-the-usage-details-api-and-the-usage-api"></a>What is the difference between the Usage Details API and the Usage API?
...
### <a name="what-is-the-difference-between-the-invoice-api-and-the-usage-details-api"></a>What is the difference between the Invoice API and the Usage Details API?
...
### <a name="what-is-the-difference-between-the-price-sheet-api-and-the-ratecard-api"></a>What is the difference between the Price Sheet API and the RateCard API?
