...
---
# <a name="prevent-unexpected-charges-with-azure-billing-and-cost-management"></a>Prevent unexpected charges with Azure billing and cost management
...
## <a name="get-estimated-costs-before-adding-azure-services"></a>Get estimated costs before adding Azure services

### <a name="estimate-cost-online-using-the-pricing-calculator"></a>Estimate cost online using the pricing calculator
...
### <a name="review-the-estimated-cost-in-the-azure-portal"></a>Review the estimated cost in the Azure portal
...
## <a name="ways-to-monitor-your-costs-when-using-azure-services"></a>Ways to monitor your costs when using Azure services
...
### <a name="consider-enabling-cost-cutting-features-like-auto-shutdown-for-vms"></a>Consider enabling cost-cutting features like auto-shutdown for VMs
...
### <a name="turn-on-and-check-out-azure-advisor-recommendations"></a>Turn on and check out Azure Advisor recommendations
...
## <a name="reviewing-costs-at-the-end-of-your-billing-cycle"></a>Reviewing costs at the end of your billing cycle
...
### <a name="ea-csp-and-sponsorship-customers"></a>EA, CSP, and Sponsorship customers
...
### <a name="check-your-subscription-and-access"></a>Check your subscription and access
