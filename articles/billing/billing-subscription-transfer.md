...
---
# <a name="transfer-ownership-of-an-azure-subscription-to-another-account"></a>Transfer ownership of an Azure subscription to another account
...
## <a name="transfer-ownership-of-an-azure-subscription"></a>Transfer ownership of an Azure subscription
...
6. The recipient clicks the link and follows the instructions, including entering their payment information.
   ...
   ![First subscription transfer web page](https://docstestmedia1.blob.core.windows.net/azure-media/articles/billing/media/billing-subscription-transfer/image4.png)
...
## <a name="transfer-subscription-ownership-for-enterprise-agreement-ea-customers"></a>Transfer subscription ownership for Enterprise Agreement (EA) customers
