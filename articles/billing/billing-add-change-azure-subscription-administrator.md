...
---
# <a name="add-or-change-azure-administrator-roles-that-manage-the-subscription-or-services"></a>Add or change Azure administrator roles that manage the subscription or services
...
## <a name="add-an-admin-for-a-subscription"></a>Add an admin for a subscription
...
3. Type the email address of the person you want to add as Co-administrator and then select the subscription that you want the Co-administrator to access.</br>
    ...
    ![Screenshot that shows a subscription selected ](https://docstestmedia1.blob.core.windows.net/azure-media/articles/billing/media/billing-add-change-azure-subscription-administrator/addcoadmin2.png)</br>
...
## <a name="change-service-administrator-for-a-subscription"></a>Change Service Administrator for a subscription
...
## <a name="change-the-account-administrator"></a>Change the Account Administrator
...
## <a name="check-the-account-administrator-of-the-subscription"></a>Check the Account Administrator of the subscription
...
## <a name="types-of-azure-admin-accounts"></a>Types of Azure admin accounts
...
## <a name="limitations-and-restrictions-for-admin-accounts"></a>Limitations and restrictions for admin accounts
...
## <a name="learn-more-about-resource-access-control-and-active-directory"></a>Learn more about resource access control and Active Directory
