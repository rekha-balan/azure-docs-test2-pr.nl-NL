...
---
# <a name="manage-access-to-billing-information-for-azure-using-role-based-access-control"></a>Manage access to billing information for Azure using role-based access control
...
## <a name="adding-users-to-the-billing-reader-role"></a>Adding users to the Billing Reader role
...
## <a name="adding-users-to-other-roles"></a>Adding users to other roles
...
## <a name="who-can-access-the-account-centerhttpsaccountwindowsazurecom"></a>Who can access the [Account Center](https://account.windowsazure.com)?
