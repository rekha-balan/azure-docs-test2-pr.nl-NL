...
---
# <a name="get-started-with-azure-mobile-engagement-for-xamarinandroid-apps"></a>Get Started with Azure Mobile Engagement for Xamarin.Android Apps
...
### <a name="create-a-new-xamarinandroid-project"></a>Create a new Xamarin.Android project
