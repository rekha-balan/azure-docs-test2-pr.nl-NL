...
---
# <a name="how-to-monitor-real-time-data-about-your-application"></a>How to monitor real-time data about your application
...
## <a name="monitor---sessions-jobs-events-errors-and-crashes"></a>Monitor - Sessions, Jobs, Events, Errors, and Crashes
...
## <a name="troubleshooting-with-monitor---events---details"></a>Troubleshooting with Monitor - Events - Details
...
## <a name="troubleshooting-with-monitor---crashes---details"></a>Troubleshooting with Monitor - Crashes - Details
...
## <a name="monitor---alerts"></a>Monitor - Alerts
