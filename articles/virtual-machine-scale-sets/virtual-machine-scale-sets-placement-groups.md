...
---
# <a name="working-with-large-virtual-machine-scale-sets"></a>Working with large virtual machine scale sets
...
## <a name="placement-groups"></a>Placement groups 
...
## <a name="checklist-for-using-large-scale-sets"></a>Checklist for using large scale sets
...
## <a name="creating-a-large-scale-set"></a>Creating a large scale set
...
## <a name="converting-an-existing-scale-set-to-span-multiple-placement-groups"></a>Converting an existing scale set to span multiple placement groups
