...
---
# <a name="automatically-scale-linux-machines-in-a-virtual-machine-scale-set"></a>Automatically scale Linux machines in a virtual machine scale set
...
## <a name="step-1-create-a-resource-group-and-a-storage-account"></a>Step 1: Create a resource group and a storage account
...
## <a name="step-2-create-the-template"></a>Step 2: Create the template
...
## <a name="step-3-upload-the-template-to-storage"></a>Step 3: Upload the template to storage
...
> [!NOTE]
> You can also use the portal’s ability to deploy the resources. Use this link: https://portal.azure.com/#create/Microsoft.Template/uri/<link to VM Scale Set JSON template>


## <a name="step-5-monitor-resources"></a>Step 5: Monitor resources
...
## <a name="step-6-remove-the-resources"></a>Step 6: Remove the resources
