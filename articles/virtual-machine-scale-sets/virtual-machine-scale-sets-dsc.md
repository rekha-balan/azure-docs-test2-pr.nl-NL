...
## <a name="differences-between-deploying-to-virtual-machines-and-virtual-machine-scale-sets"></a>Differences between deploying to Virtual Machines and Virtual Machine Scale Sets
...
## <a name="behavior-for-a-virtual-machine-scale-set"></a>Behavior for a Virtual Machine Scale Set
