...
---
# <a name="azure-virtual-machine-scale-sets-and-attached-data-disks"></a>Azure virtual machine scale sets and attached data disks
...
## <a name="create-and-manage-disks-in-a-scale-set"></a>Create and manage disks in a scale set
...
## <a name="create-a-service-fabric-cluster-with-attached-data-disks"></a>Create a Service Fabric cluster with attached data disks
...
## <a name="adding-pre-populated-data-disks-to-an-existing-scale-set"></a>Adding pre-populated data disks to an existing scale set
