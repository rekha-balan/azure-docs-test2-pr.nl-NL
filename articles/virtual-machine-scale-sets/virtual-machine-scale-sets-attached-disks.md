...
---
# <a name="azure-vm-scale-sets-and-attached-data-disks"></a>Azure VM scale sets and attached data disks
...
## <a name="create-a-scale-set-with-attached-data-disks"></a>Create a scale set with attached data disks
...
## <a name="adding-a-data-disk-to-an-existing-scale-set"></a>Adding a data disk to an existing scale set
...
## <a name="removing-a-data-disk-from-a-scale-set"></a>Removing a data disk from a scale set
