...
---
# <a name="create-and-deploy-a-virtual-machine-scale-set"></a>Create and deploy a virtual machine scale set
...
## <a name="create-from-azure-cli"></a>Create from Azure CLI
...
## <a name="create-from-powershell"></a>Create from PowerShell
...
## <a name="create-from-a-template"></a>Create from a template
...
## <a name="create-from-visual-studio"></a>Create from Visual Studio
...
## <a name="create-from-the-azure-portal"></a>Create from the Azure portal
