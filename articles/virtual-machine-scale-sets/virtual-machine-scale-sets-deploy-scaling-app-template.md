...
---
# <a name="deploy-an-autoscaling-app-using-a-template"></a>Deploy an autoscaling app using a template
...
## <a name="two-quickstart-templates"></a>Two quickstart templates
...
### <a name="python-http-server-on-linux"></a>Python HTTP server on Linux
...
### <a name="aspnet-mvc-application-on-windows"></a>ASP.NET MVC application on Windows
