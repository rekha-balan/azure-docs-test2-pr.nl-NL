...
---
# <a name="add-reference-to-a-virtual-network-to-an-azure-scale-set-template"></a>Add reference to a virtual network to an Azure scale set template
...
## <a name="change-the-template-definition"></a>Change the template definition
