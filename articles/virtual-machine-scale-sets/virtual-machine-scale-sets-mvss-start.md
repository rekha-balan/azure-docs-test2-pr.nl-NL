...
---
# <a name="learn-about-virtual-machine-scale-set-templates"></a>Learn about virtual machine scale set templates
...
## <a name="review-the-template"></a>Review the template
...
## <a name="define-resources"></a>Define resources
...
## <a name="specify-location"></a>Specify location
...
## <a name="specify-virtual-network-properties"></a>Specify virtual network properties
...
## <a name="add-dependson-list"></a>Add dependsOn list
...
```
## <a name="specify-scale-set-properties"></a>Specify scale set properties
...
### <a name="supply-vm-size-and-capacity"></a>Supply VM size and capacity
...
### <a name="choose-type-of-updates"></a>Choose type of updates
...
### <a name="choose-vm-operating-system"></a>Choose VM operating system
...
### <a name="specify-computernameprefix"></a>Specify computerNamePrefix
...
### <a name="specify-vm-network-configuration"></a>Specify VM network configuration
