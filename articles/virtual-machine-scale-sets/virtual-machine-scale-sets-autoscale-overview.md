...
---
# <a name="overview-of-autoscale-with-azure-virtual-machine-scale-sets"></a>Overview of autoscale with Azure virtual machine scale sets
...
## <a name="benefits-of-autoscale"></a>Benefits of autoscale
...
## <a name="use-host-based-metrics"></a>Use host-based metrics
...
### <a name="metric-sources"></a>Metric sources
...
### <a name="autoscale-rule-criteria"></a>Autoscale rule criteria
...
### <a name="actions-when-rules-trigger"></a>Actions when rules trigger
...
## <a name="in-guest-vm-metrics-with-the-azure-diagnostics-extension"></a>In-guest VM metrics with the Azure diagnostics extension
...
## <a name="application-level-metrics-with-app-insights"></a>Application-level metrics with App Insights
...
## <a name="scheduled-autoscale"></a>Scheduled autoscale
