...
---
# <a name="what-are-availability-zones-in-azure"></a>What are Availability Zones in Azure?
...
## <a name="regions-that-support-availability-zones"></a>Regions that support Availability Zones
...
## <a name="services-that-support-availability-zones"></a>Services that support Availability Zones
...
## <a name="get-started-with-availability-zones"></a>Get started with Availability Zones
