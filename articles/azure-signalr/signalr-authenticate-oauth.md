...
---
# <a name="tutorial-azure-signalr-service-authentication"></a>Tutorial: Azure SignalR Service authentication
...
## <a name="create-an-oauth-app"></a>Create an OAuth app
...
## <a name="implement-the-oauth-flow"></a>Implement the OAuth flow

### <a name="update-the-startup-class-to-support-github-authentication"></a>Update the Startup class to support GitHub authentication
...
### <a name="add-an-authentication-controller"></a>Add an authentication controller
...
### <a name="update-the-hub-class"></a>Update the Hub class
...
### <a name="update-the-web-client-code"></a>Update the web client code
...
## <a name="build-and-run-the-app-locally"></a>Build and Run the app locally
...
### <a name="create-the-web-app-and-plan"></a>Create the web app and plan
...
### <a name="add-app-settings-to-the-web-app"></a>Add app settings to the web app
...
### <a name="configure-the-web-app-for-local-git-deployment"></a>Configure the web app for local Git deployment
...
### <a name="deploy-your-code-to-the-azure-web-app"></a>Deploy your code to the Azure web app
...
### <a name="update-the-github-oauth-app"></a>Update the GitHub OAuth app 
