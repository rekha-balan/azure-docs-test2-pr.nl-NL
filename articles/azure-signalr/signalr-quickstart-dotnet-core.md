...
---
# <a name="quickstart-create-a-chat-room-with-signalr-service"></a>Quickstart: Create a chat room with SignalR Service
...
## <a name="create-an-azure-signalr-resource"></a>Create an Azure SignalR resource

[!INCLUDE [azure-signalr-create](../../includes/signalr-create.md)]

## <a name="create-an-aspnet-core-web-app"></a>Create an ASP.NET Core web app
...
## <a name="add-secret-manager-to-the-project"></a>Add Secret Manager to the project
...
## <a name="add-azure-signalr-to-the-web-app"></a>Add Azure SignalR to the web app
...
### <a name="add-a-hub-class"></a>Add a hub class
...
### <a name="add-the-web-app-client-interface"></a>Add the web app client interface
...
## <a name="add-a-development-runtime-profile"></a>Add a development runtime profile
