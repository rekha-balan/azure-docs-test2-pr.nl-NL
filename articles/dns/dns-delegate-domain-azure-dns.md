...
## <a name="retrieve-name-servers"></a>Retrieve name servers
...
## <a name="delegate-the-domain"></a>Delegate the domain
...
## <a name="verify-name-resolution-is-working"></a>Verify name resolution is working
...
## <a name="delegate-sub-domains-in-azure-dns"></a>Delegate sub-domains in Azure DNS
...
### <a name="create-name-server-record-in-parent-zone"></a>Create name server record in parent zone
...
### <a name="delegating-sub-domains-in-azure-dns-with-other-tools"></a>Delegating sub-domains in Azure DNS with other tools
