...
### <a name="what-is-azure-dns"></a>What is Azure DNS?
...
### <a name="what-is-the-sla-for-azure-dns"></a>What is the SLA for Azure DNS?
...
### <a name="what-is-a-dns-zone-is-it-the-same-as-a-dns-domain"></a>What is a ‘DNS zone’? Is it the same as a DNS domain? 
...
### <a name="do-i-need-to-purchase-a-dns-domain-name-to-use-azure-dns"></a>Do I need to purchase a DNS domain name to use Azure DNS? 
...
### <a name="does-azure-dns-support-extended-ascii-encoding-8-bit-set-for-txt-recordset-"></a>Does Azure DNS support extended ASCII encoding (8-bit) set for TXT Recordset ?
...
## <a name="using-azure-dns"></a>Using Azure DNS

### <a name="can-i-co-host-a-domain-using-azure-dns-and-another-dns-provider"></a>Can I co-host a domain using Azure DNS and another DNS provider?
...
### <a name="do-azure-dns-nameservers-resolve-over-ipv6"></a>Do Azure DNS Nameservers resolve over IPv6? 
...
### <a name="how-do-i-set-up-an-international-domain-name-idn-in-azure-dns"></a>How do I set up an International Domain Name (IDN) in Azure DNS?
...
### <a name="what-is-the-difference-between-registration-virtual-network-and-resolution-virtual-network-in-the-context-of-private-zones"></a>What is the difference between Registration virtual network and Resolution virtual network in the context of private zones? 
...
### <a name="will-azure-dns-private-zones-work-across-azure-regions"></a>Will Azure DNS Private Zones work across Azure regions?
...
### <a name="can-the-same-private-zone-be-used-for-multiple-virtual-networks-for-resolution"></a>Can the same Private Zone be used for multiple virtual networks for resolution? 
Yes. Customers can associate up to 10 Resolution virtual networks with a single private zone.

### <a name="can-a-virtual-network-that-belongs-to-a-different-subscription-be-added-as-a-resolution-virtual-network-to-a-private-zone"></a>Can a virtual network that belongs to a different subscription be added as a resolution virtual network to a Private Zone? 
...
### <a name="will-the-automatically-registered-virtual-machine-dns-records-in-a-private-zone-be-automatically-deleted-when-the-virtual-machines-are-deleted-by-the-customer"></a>Will the automatically registered virtual machine DNS records in a private zone be automatically deleted when the virtual machines are deleted by the customer?
...
### <a name="can-an-automatically-registered-virtual-machine-record-in-a-private-zone-from-a-registration-virtual-network-be-deleted-manually"></a>Can an automatically registered virtual machine record in a private zone (from a Registration virtual network) be deleted manually? 
...
### <a name="what-happens-when-we-attempt-to-manually-create-a-new-dns-record-into-a-private-zone-that-has-the-same-hostname-as-an-automatically-registered-existing-virtual-machine-in-a-registration-virtual-network"></a>What happens when we attempt to manually create a new DNS record into a private zone that has the same hostname as an (automatically registered) existing virtual machine in a Registration virtual network? 
...
### <a name="what-happens-when-we-unlink-a-registration-virtual-network-from-a-private-zone--would-the-automatically-registered-virtual-machine-records-from-the-virtual-network-be-removed-from-the-zone-as-well"></a>What happens when we unlink a Registration virtual network from a private zone ? Would the automatically registered virtual machine records from the virtual network be removed from the zone as well?
...
### <a name="would-dns-resolution-using-the-default-fqdn-internalcloudappnet-still-work-even-when-a-private-zone-for-example-contosolocal-is-linked-to-a-virtual-network"></a>Would DNS resolution using the default FQDN (internal.cloudapp.net) still work even when a Private Zone (for example: contoso.local) is linked to a virtual network? 
...
### <a name="would-the-dns-suffix-on-virtual-machines-within-a-linked-virtual-network-be-changed-to-that-of-the-private-zone"></a>Would the DNS suffix on virtual machines within a linked virtual network be changed to that of the Private Zone? 
...
### <a name="are-there-any-limitations-for-private-zones-during-this-preview"></a>Are there any limitations for Private Zones during this preview?
...
### <a name="are-there-any-quotas-or-limits-on-zones-or-records-for-private-zones"></a>Are there any quotas or limits on Zones or Records for Private Zones?
...
### <a name="is-there-portal-support-for-private-zones"></a>Is there Portal support for Private Zones?
