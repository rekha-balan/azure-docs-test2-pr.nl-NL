...
## <a name="i-cant-create-a-dns-record"></a>I can't create a DNS record
...
## <a name="i-cant-resolve-my-dns-record"></a>I can't resolve my DNS record
...
## <a name="how-do-i-specify-the-service-and-protocol-for-an-srv-record"></a>How do I specify the ‘service’ and ‘protocol’ for an SRV record?
