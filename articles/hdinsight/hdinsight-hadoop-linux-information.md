...
## <a name="hdfs-azure-storage-and-data-lake-store"></a>HDFS, Azure Storage, and Data Lake Store
...
### <a name="what-storage-is-the-cluster-using"></a>What storage is the cluster using
...
### <a name="how-do-i-access-files-from-outside-hdinsight"></a>How do I access files from outside HDInsight
