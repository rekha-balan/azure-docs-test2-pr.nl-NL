...
---
# <a name="troubleshoot-a-slow-or-failing-hdinsight-cluster"></a>Troubleshoot a slow or failing HDInsight cluster
...
## <a name="step-1-gather-data-about-the-issue"></a>Step 1: Gather data about the issue
...
## <a name="step-2-validate-the-hdinsight-cluster-environment"></a>Step 2: Validate the HDInsight cluster environment
...
### <a name="view-cluster-configuration-settings-with-the-ambari-ui"></a>View cluster configuration settings with the Ambari UI
...
#### <a name="check-for-azure-service-outages"></a>Check for Azure service outages
...
#### <a name="check-azure-service-usage-limits"></a>Check Azure service usage limits
...
#### <a name="check-the-release-version"></a>Check the release version
...
#### <a name="restart-your-cluster-services"></a>Restart your cluster services
...
## <a name="step-3-view-your-clusters-health"></a>Step 3: View your cluster's health
...
### <a name="get-a-snapshot-of-the-cluster-health-using-the-ambari-ui-dashboard"></a>Get a snapshot of the cluster health using the Ambari UI dashboard
...
### <a name="check-your-webhcat-service"></a>Check your WebHCat service
...
#### <a name="webhcat-times-out"></a>WebHCat times out
...
##### <a name="webhcat-level-timeout"></a>WebHCat level timeout
...
##### <a name="yarn-level-timeout"></a>YARN level timeout
...
#### <a name="other-webhcat-failures"></a>Other WebHCat failures
...
## <a name="step-4-review-the-environment-stack-and-versions"></a>Step 4: Review the environment stack and versions
...
## <a name="step-5-examine-the-log-files"></a>Step 5: Examine the log files
...
### <a name="check-the-script-action-logs"></a>Check the script action logs
...
### <a name="view-hdinsight-logs-using-ambari-quick-links"></a>View HDInsight logs using Ambari Quick Links
...
### <a name="view-hadoop-generated-log-files"></a>View Hadoop-generated log files
...
### <a name="review-heap-dumps"></a>Review heap dumps
...
## <a name="step-6-check-configuration-settings"></a>Step 6: Check configuration settings
...
## <a name="step-7-reproduce-the-failure-on-a-different-cluster"></a>Step 7: Reproduce the failure on a different cluster
