...
---
# <a name="customize-linux-based-hdinsight-clusters-using-script-actions"></a>Customize Linux-based HDInsight clusters using script actions
...
### <a name="cant-import-name-blobservice"></a>Can't import name BlobService
