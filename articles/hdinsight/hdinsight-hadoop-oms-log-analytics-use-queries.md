...
---
# <a name="query-azure-log-analytics-to-monitor-hdinsight-clusters"></a>Query Azure Log Analytics to monitor HDInsight clusters
...
## <a name="analyze-hdinsight-cluster-metrics"></a>Analyze HDInsight cluster metrics
...
## <a name="search-for-specific-log-messages"></a>Search for specific log messages
...
## <a name="create-alerts-for-tracking-events"></a>Create alerts for tracking events
