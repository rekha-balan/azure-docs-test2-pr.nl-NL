...
---
# <a name="work-in-the-hadoop-ecosystem-on-hdinsight-from-a-windows-pc"></a>Work in the Hadoop ecosystem on HDInsight from a Windows PC
...
## <a name="use-powershell-for-deployment-and-management-tasks"></a>Use PowerShell for deployment and management tasks
...
## <a name="utilities-you-can-run-in-a-browser"></a>Utilities you can run in a browser
...
## <a name="visual-studio-and-the-net-sdk"></a>Visual Studio and the .NET SDK 
...
> TIP If you're running .NET solutions with Windows-based HDInsight clusters, it's a good time to plan a migration to Linux-based clusters. For more information, see [Migrate .NET solution for Windows-based HDInsight to Linux-based HDInsight](hdinsight-hadoop-migrate-dotnet-to-linux.md).

## <a name="intellij-idea-and-eclipse-ide-for-spark-clusters"></a>Intellij IDEA and Eclipse IDE for Spark clusters
...
## <a name="notebooks-on-spark-for-data-scientists"></a>Notebooks on Spark for data scientists 
...
## <a name="run-linux-based-tools-and-technologies-on-windows"></a>Run Linux-based tools and technologies on Windows
