...
---
# <a name="use-zeppelin-to-run-hive-queries-in-azure-hdinsight"></a>Use Zeppelin to run Hive queries in Azure HDInsight 
...
## <a name="create-a-zeppelin-note"></a>Create a Zeppelin Note
