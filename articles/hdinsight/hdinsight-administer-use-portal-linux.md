...
## <a name="open-the-azure-portal"></a>Open the Azure portal
...
HDInsight works with a wide range of Hadoop components. For the list of the components that are verified and supported, see [What version of Hadoop is in Azure HDInsight?](hdinsight-component-versioning.md) For general cluster creation information, see [Create Hadoop clusters in HDInsight](hdinsight-hadoop-provision-linux-clusters.md).
...
4. Click a cluster from the list to see the overview page:
    ...
    ![Azure portal HDInsight cluster essentials](./media/hdinsight-administer-use-portal-linux/hdinsight-essentials.png) **Overview menu:**
...
## <a name="add-additional-storage-accounts"></a>Add additional storage accounts
...
## <a name="move-cluster"></a>Move cluster
...
## <a name="find-the-storage-accounts"></a>Find the storage accounts
