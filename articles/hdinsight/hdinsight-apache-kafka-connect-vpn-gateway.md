...
---
# <a name="connect-to-kafka-on-hdinsight-preview-through-an-azure-virtual-network"></a>Connect to Kafka on HDInsight (preview) through an Azure Virtual Network
...
## <a name="create-using-powershell"></a>Create: Using PowerShell
...
## <a name="configure-kafka-for-ip-advertising"></a>Configure Kafka for IP advertising
...
## <a name="connect-to-the-vpn-gateway"></a>Connect to the VPN gateway
...
## <a name="remote-kafka-client"></a>Remote Kafka client
