...
---
# <a name="use-hdinsight-spark-cluster-to-read-and-write-data-to-azure-sql-database"></a>Use HDInsight Spark cluster to read and write data to Azure SQL database
...
## <a name="read-data-from-azure-sql-database"></a>Read data from Azure SQL database
...
## <a name="write-data-into-azure-sql-database"></a>Write data into Azure SQL database
...
## <a name="stream-data-into-azure-sql-database"></a>Stream data into Azure SQL database
