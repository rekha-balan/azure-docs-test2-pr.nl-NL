...
---
# <a name="optimize-spark-jobs"></a>Optimize Spark jobs
...
## <a name="choose-the-data-abstraction"></a>Choose the data abstraction
...
## <a name="use-optimal-data-format"></a>Use optimal data format
...
## <a name="select-default-storage"></a>Select default storage
...
## <a name="use-the-cache"></a>Use the cache
...
## <a name="use-memory-efficiently"></a>Use memory efficiently
...
### <a name="spark-memory-considerations"></a>Spark memory considerations
...
## <a name="optimize-data-serialization"></a>Optimize data serialization
...
## <a name="use-bucketing"></a>Use bucketing
...
## <a name="optimize-joins-and-shuffles"></a>Optimize joins and shuffles
...
## <a name="customize-cluster-configuration"></a>Customize cluster configuration
...
### <a name="select-the-correct-executor-size"></a>Select the correct executor size
...
## <a name="optimize-job-execution"></a>Optimize job execution
