...
---
# <a name="use-azure-toolkit-for-intellij-to-create-spark-applications-for-an-hdinsight-cluster"></a>Use Azure Toolkit for IntelliJ to create Spark applications for an HDInsight cluster
...
## <a name="install-azure-toolkit-for-intellij"></a>Install Azure Toolkit for IntelliJ
...
## <a name="link-a-cluster"></a>Link a cluster
...
## <a name="debug-spark-applications-locally-or-remotely-on-an-hdinsight-cluster"></a>Debug Spark applications locally or remotely on an HDInsight cluster 
...
## <a name="access-and-manage-hdinsight-spark-clusters-by-using-azure-toolkit-for-intellij"></a>Access and manage HDInsight Spark clusters by using Azure Toolkit for IntelliJ
You can perform various operations by using Azure Toolkit for IntelliJ.

### <a name="access-the-job-view"></a>Access the job view
...
### <a name="start-the-ambari-portal"></a>Start the Ambari portal
...
## <a name="convert-existing-intellij-idea-applications-to-use-azure-toolkit-for-intellij"></a>Convert existing IntelliJ IDEA applications to use Azure Toolkit for IntelliJ
...
### <a name="error-in-local-run-please-use-a-larger-heap-size"></a>Error in local run: *Please use a larger heap size*
...
## <a name="feedback-and-known-issues"></a>Feedback and known issues
...
### <a name="creating-and-running-applications"></a>Creating and running applications
...
### <a name="managing-resources"></a>Managing resources
