...
---
# <a name="create-high-availability-spark-streaming-jobs-with-yarn"></a>Create high-availability Spark Streaming jobs with YARN
...
## <a name="spark-structured-streaming-jobs"></a>Spark Structured Streaming jobs
...
## <a name="create-fault-tolerant-spark-streaming-jobs"></a>Create fault-tolerant Spark Streaming jobs
...
### <a name="exactly-once-semantics-with-spark-streaming"></a>Exactly-once semantics with Spark Streaming
...
## <a name="spark-streaming-and-yarn"></a>Spark Streaming and YARN
...
### <a name="plan-for-failures"></a>Plan for failures
...
### <a name="typical-concerns-for-high-availability"></a>Typical concerns for high availability
