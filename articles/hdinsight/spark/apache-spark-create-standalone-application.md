...
---
# <a name="tutorial-create-a-scala-maven-application-for-spark-in-hdinsight-using-intellij"></a>Tutorial: create a Scala Maven application for Spark in HDInsight using IntelliJ
...
## <a name="use-intellij-to-create-application"></a>Use IntelliJ to create application
