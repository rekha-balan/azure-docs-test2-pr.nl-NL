...
---
# <a name="what-is-apache-spark-in-azure-hdinsight"></a>What is Apache Spark in Azure HDInsight
...
## <a name="spark-cluster-architecture"></a>Spark cluster architecture
...
## <a name="spark-in-hdinsight-use-cases"></a>Spark in HDInsight use cases
...
- Spark Machine Learning
    ...
    [Tutorial: Predict building temperatures using HVAC data](apache-spark-ipython-notebook-machine-learning.md) [Tutorial: Predict food inspection results](apache-spark-machine-learning-mllib-ipython.md)    
