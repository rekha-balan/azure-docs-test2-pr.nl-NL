...
---
# <a name="debug-spark-applications-locally-or-remotely-on-an-hdinsight-cluster-with-azure-toolkit-for-intellij-through-ssh"></a>Debug Spark applications locally or remotely on an HDInsight cluster with Azure Toolkit for IntelliJ through SSH
...
## <a name="learn-how-to-perform-local-run-and-debugging"></a>Learn how to perform local run and debugging
### <a name="scenario-1-create-a-spark-scala-application"></a>Scenario 1: Create a Spark Scala application 
...
### <a name="prerequisite-for-windows"></a>Prerequisite for windows
...
### <a name="scenario-2-perform-local-run"></a>Scenario 2: Perform local run
...
### <a name="scenario-3-perform-local-debugging"></a>Scenario 3: Perform local debugging
...
## <a name="learn-how-to-perform-remote-run-and-debugging"></a>Learn how to perform remote run and debugging
### <a name="scenario-1-perform-remote-run"></a>Scenario 1: Perform remote run
...
### <a name="scenario-2-perform-remote-debugging"></a>Scenario 2: Perform remote debugging
...
### <a name="scenario-3-perform-remote-debugging-and-bug-fixing"></a>Scenario 3: Perform remote debugging and bug fixing
