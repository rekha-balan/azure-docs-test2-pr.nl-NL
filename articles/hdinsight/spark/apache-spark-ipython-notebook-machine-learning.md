...
---
# <a name="tutorial-build-a-spark-machine-learning-application-in-hdinsight"></a>Tutorial: Build a Spark machine learning application in HDInsight 
...
## <a name="understand-the-data-set"></a>Understand the data set
...
## <a name="develop-a-spark-machine-learning-application-using-spark-mllib"></a>Develop a Spark machine learning application using Spark MLlib
...
## <a name="use-anaconda-scikit-learn-library-for-spark-machine-learning"></a>Use Anaconda scikit-learn library for Spark machine learning
