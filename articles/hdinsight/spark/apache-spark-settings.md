...
---
# <a name="configure-spark-settings"></a>Configure Spark settings
...
## <a name="spark-versions"></a>Spark versions
...
## <a name="view-cluster-configuration-settings"></a>View cluster configuration settings
...
## <a name="configuring-spark-executors"></a>Configuring Spark executors
...
## <a name="change-parameters-for-an-application-running-in-jupyter-notebook"></a>Change parameters for an application running in Jupyter notebook
