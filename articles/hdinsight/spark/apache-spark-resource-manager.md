...
## <a name="open-the-yarn-ui"></a>Open the Yarn UI
...
## <a name="optimize-clusters-for-spark-applications"></a>Optimize clusters for Spark applications
...
### <a name="change-these-parameters-on-a-spark-thrift-server"></a>Change these parameters on a Spark Thrift Server
...
### <a name="change-the-driver-memory-of-the-spark-thrift-server"></a>Change the driver memory of the Spark Thrift Server
...
## <a name="reclaim-spark-cluster-resources"></a>Reclaim Spark cluster resources
...
## <a name="restart-the-jupyter-service"></a>Restart the Jupyter service
...
## <a name="kill-running-applications"></a>Kill running applications
...
### <a name="for-data-analysts"></a>For data analysts
...
### <a name="for-spark-developers"></a>For Spark developers
