...
---
# <a name="use-apache-spark-rest-api-to-submit-remote-jobs-to-an-hdinsight-spark-cluster"></a>Use Apache Spark REST API to submit remote jobs to an HDInsight Spark cluster
...
## <a name="submit-a-livy-spark-batch-job"></a>Submit a Livy Spark batch job
...
## <a name="get-information-on-livy-spark-batches-running-on-the-cluster"></a>Get information on Livy Spark batches running on the cluster
...
## <a name="delete-a-livy-spark-batch-job"></a>Delete a Livy Spark batch job
...
## <a name="livy-spark-and-high-availability"></a>Livy Spark and high-availability
...
## <a name="using-livy-spark-on-hdinsight-35-clusters"></a>Using Livy Spark on HDInsight 3.5 clusters
...
## <a name="submitting-livy-jobs-for-a-cluster-within-an-azure-virtual-network"></a>Submitting Livy jobs for a cluster within an Azure virtual network
...
### <a name="using-an-external-jar-from-the-additional-storage-is-not-supported"></a>Using an external jar from the additional storage is not supported
