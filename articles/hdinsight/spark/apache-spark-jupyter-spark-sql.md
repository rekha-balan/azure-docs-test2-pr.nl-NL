...
---
# <a name="quickstart-create-a-spark-cluster-in-hdinsight-using-template"></a>Quickstart: Create a Spark cluster in HDInsight using template
...
## <a name="create-an-hdinsight-spark-cluster"></a>Create an HDInsight Spark cluster
...
## <a name="install-intellijeclipse-for-spark-application"></a>Install IntelliJ/Eclipse for Spark application
...
## <a name="install-vscode-for-pysparkhive-applications"></a>Install VSCode for PySpark/hive applications
...
## <a name="run-spark-sql-statements"></a>Run Spark SQL statements
