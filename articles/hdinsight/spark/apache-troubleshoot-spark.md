...
---
# <a name="troubleshoot-spark-by-using-azure-hdinsight"></a>Troubleshoot Spark by using Azure HDInsight

Learn about the top issues and their resolutions when working with Apache Spark payloads in Apache Ambari.

## <a name="how-do-i-configure-a-spark-application-by-using-ambari-on-clusters"></a>How do I configure a Spark application by using Ambari on clusters?

### <a name="resolution-steps"></a>Resolution steps
...
## <a name="how-do-i-configure-a-spark-application-by-using-a-jupyter-notebook-on-clusters"></a>How do I configure a Spark application by using a Jupyter notebook on clusters?
...
## <a name="how-do-i-configure-a-spark-application-by-using-livy-on-clusters"></a>How do I configure a Spark application by using Livy on clusters?
...
## <a name="how-do-i-configure-a-spark-application-by-using-spark-submit-on-clusters"></a>How do I configure a Spark application by using spark-submit on clusters?
...
## <a name="what-causes-a-spark-application-outofmemoryerror-exception"></a>What causes a Spark application OutofMemoryError exception?

### <a name="detailed-description"></a>Detailed description
...
### <a name="probable-cause"></a>Probable cause
