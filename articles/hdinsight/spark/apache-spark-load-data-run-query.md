...
---
# <a name="tutorial-load-data-and-run-queries-on-an-apache-spark-cluster-in-azure-hdinsight"></a>Tutorial: Load data and run queries on an Apache Spark cluster in Azure HDInsight
...
## <a name="create-a-dataframe-from-a-csv-file"></a>Create a dataframe from a csv file
...
## <a name="run-queries-on-the-dataframe"></a>Run queries on the dataframe
