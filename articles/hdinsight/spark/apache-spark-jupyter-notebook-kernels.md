...
---
# <a name="kernels-for-jupyter-notebook-on-spark-clusters-in-azure-hdinsight"></a>Kernels for Jupyter notebook on Spark clusters in Azure HDInsight 
...
## <a name="create-a-jupyter-notebook-on-spark-hdinsight"></a>Create a Jupyter notebook on Spark HDInsight
...
## <a name="benefits-of-using-the-kernels"></a>Benefits of using the kernels
