...
---
# <a name="run-spark-from-the-spark-shell"></a>Run Spark from the Spark Shell
...
## <a name="get-to-a-spark-shell-with-ssh"></a>Get to a Spark Shell with SSH
...
## <a name="run-a-spark-shell"></a>Run a Spark Shell
...
## <a name="sparksession-and-sparkcontext-instances"></a>SparkSession and SparkContext instances
...
## <a name="important-shell-parameters"></a>Important shell parameters
