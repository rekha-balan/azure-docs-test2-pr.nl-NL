...
---
# <a name="tutorial-process-tweets-using-azure-event-hubs-and-spark-in-hdinsight"></a>Tutorial: Process tweets using Azure Event Hubs and Spark in HDInsight
...
## <a name="send-tweets-to-the-event-hub"></a>Send tweets to the event hub
...
## <a name="read-tweets-from-the-event-hub"></a>Read tweets from the event hub
