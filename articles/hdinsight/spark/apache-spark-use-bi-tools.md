...
---
# <a name="tutorial-analyze-spark-data-using-power-bi-in-hdinsight"></a>Tutorial: Analyze Spark data using Power BI in HDInsight 
...
## <a name="verify-the-data"></a>Verify the data
...
## <a name="visualize-the-data"></a>Visualize the data
...
### <a name="publish-the-report-to-the-power-bi-service-optional"></a>Publish the report to the Power BI Service (optional)
