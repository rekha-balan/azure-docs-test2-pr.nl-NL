...
---
# <a name="install-jupyter-notebook-on-your-computer-and-connect-to-apache-spark-on-hdinsight"></a>Install Jupyter notebook on your computer and connect to Apache Spark on HDInsight
...
## <a name="configure-spark-magic-to-connect-to-hdinsight-spark-cluster"></a>Configure Spark magic to connect to HDInsight Spark cluster
