...
---
# <a name="create-on-demand-hadoop-clusters-in-hdinsight-using-azure-data-factory"></a>Create on-demand Hadoop clusters in HDInsight using Azure Data Factory
...
## <a name="create-a-data-factory-using-resource-manager-template"></a>Create a data factory using Resource Manager template
...
### <a name="check-the-data-factory-output"></a>Check the data factory output
...
### <a name="defining-entities-within-the-data-factory"></a>Defining entities within the data factory
...
### <a name="delete-the-blob-containers-created-by-on-demand-hdinsight-cluster"></a>Delete the blob containers created by on-demand HDInsight cluster
...
### <a name="delete-the-resource-group"></a>Delete the resource group
...
You can use Azure CLI instead of using Azure PowerShell to do the tutorial. To use Azure CLI, first install Azure CLI as per the following instructions: [!INCLUDE [use-latest-version](../../includes/hdinsight-use-latest-cli.md)]

#### <a name="use-azure-cli-to-prepare-the-storage-and-copy-the-files"></a>Use Azure CLI to prepare the storage and copy the files
