...
---
# <a name="use-multiple-hdinsight-clusters-with-an-azure-data-lake-store-account"></a>Use multiple HDInsight clusters with an Azure Data Lake Store account
...
## <a name="data-lake-store-file-and-folder-level-acls"></a>Data Lake Store file and folder level ACLs
...
## <a name="data-lake-store-setup-for-multiple-hdinsight-clusters"></a>Data Lake Store setup for multiple HDInsight clusters
...
## <a name="recommendations-for-job-input-and-output-data"></a>Recommendations for job input and output data
...
## <a name="limit-on-clusters-sharing-a-single-storage-account"></a>Limit on clusters sharing a single storage account
...
## <a name="support-for-default-acls"></a>Support for Default-ACLs
...
## <a name="known-issues-and-workarounds"></a>Known issues and workarounds

This section lists the known issues for using HDInsight with Data Lake Store, and their workarounds.

### <a name="publicly-visible-localized-yarn-resources"></a>Publicly visible localized YARN resources
