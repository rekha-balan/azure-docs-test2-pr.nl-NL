...
---
# <a name="troubleshoot-yarn-by-using-azure-hdinsight"></a>Troubleshoot YARN by using Azure HDInsight

Learn about the top issues and their resolutions when working with Apache Hadoop YARN payloads in Apache Ambari.

## <a name="how-do-i-create-a-new-yarn-queue-on-a-cluster"></a>How do I create a new YARN queue on a cluster?
...
## <a name="how-do-i-download-yarn-logs-from-a-cluster"></a>How do I download YARN logs from a cluster?
