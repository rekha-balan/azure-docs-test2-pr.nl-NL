...
---
# <a name="create-hadoop-clusters-in-hdinsight-by-using-resource-manager-templates"></a>Create Hadoop clusters in HDInsight by using Resource Manager templates
...
## <a name="generate-templates"></a>Generate templates
...
## <a name="deploy-with-cli"></a>Deploy with CLI
...
## <a name="appendix-resource-manager-template"></a>Appendix: Resource Manager template
