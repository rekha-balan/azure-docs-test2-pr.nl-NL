...
---
# <a name="add-additional-storage-accounts-to-hdinsight"></a>Add additional storage accounts to HDInsight
...
### <a name="storage-accounts-not-displayed-in-azure-portal-or-tools"></a>Storage accounts not displayed in Azure portal or tools
...
### <a name="unable-to-access-storage-after-changing-key"></a>Unable to access storage after changing key
...
### <a name="poor-performance"></a>Poor performance
...
### <a name="additional-charges"></a>Additional charges
