...
---
# <a name="install-and-use-presto-on-hdinsight-hadoop-clusters"></a>Install and use Presto on HDInsight Hadoop clusters
...
## <a name="what-is-presto"></a>What is Presto?
...
## <a name="install-presto-using-script-action"></a>Install Presto using script action
...
## <a name="use-presto-with-hdinsight"></a>Use Presto with HDInsight
...
## <a name="use-airpal-with-presto"></a>Use Airpal with Presto
...
## <a name="customize-a-presto-installation-on-hdinsight-cluster"></a>Customize a Presto installation on HDInsight cluster
...
## <a name="generate-benchmark-data-for-hdinsight-clusters-that-run-presto"></a>Generate benchmark data for HDInsight clusters that run Presto
