...
---
# <a name="combining-scaler-and-sparkr-in-hdinsight"></a>Combining ScaleR and SparkR in HDInsight
...
## <a name="the-airline-and-weather-datasets"></a>The airline and weather datasets
...
## <a name="setting-up-the-spark-environment"></a>Setting up the Spark environment
...
## <a name="preparing-the-weather-data"></a>Preparing the weather data
...
## <a name="importing-the-airline-and-weather-data-to-spark-dataframes"></a>Importing the airline and weather data to Spark DataFrames
...
## <a name="data-cleansing-and-transformation"></a>Data cleansing and transformation
...
## <a name="joining-the-weather-and-airline-data"></a>Joining the weather and airline data
...
## <a name="save-results-to-csv-for-exchange-with-scaler"></a>Save results to CSV for exchange with ScaleR
...
## <a name="import-to-xdf-for-use-by-scaler"></a>Import to XDF for use by ScaleR
...
## <a name="splitting-data-for-training-and-test"></a>Splitting data for training and test
...
## <a name="train-and-test-a-logistic-regression-model"></a>Train and test a logistic regression model
...
## <a name="scoring-elsewhere"></a>Scoring elsewhere
...
## <a name="next-steps-and-more-information"></a>Next steps and more information
