...
---
# <a name="use-azure-toolkit-for-eclipse-to-create-spark-applications-for-hdinsight-cluster"></a>Use Azure Toolkit for Eclipse to create Spark applications for HDInsight cluster
