...
---
# <a name="quickstart-create-a-kafka-on-hdinsight-cluster"></a>Quickstart: Create a Kafka on HDInsight cluster
...
## <a name="manage-kafka-topics"></a>Manage Kafka topics
