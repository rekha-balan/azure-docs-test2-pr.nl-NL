...
---
# <a name="use-apache-kafka-on-hdinsight-with-azure-iot-hub"></a>Use Apache Kafka on HDInsight with Azure IoT Hub
...
## <a name="install-the-connector"></a>Install the connector
...
## <a name="get-iot-hub-connection-information"></a>Get IoT Hub connection information
...
## <a name="configure-the-source-connection"></a>Configure the source connection
...
## <a name="configure-the-sink-connection"></a>Configure the sink connection
...
## <a name="start-the-source-connector"></a>Start the source connector
...
## <a name="start-the-sink-connector"></a>Start the sink connector
