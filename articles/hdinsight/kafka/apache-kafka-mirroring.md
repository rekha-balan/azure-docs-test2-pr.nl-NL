...
---
# <a name="use-mirrormaker-to-replicate-apache-kafka-topics-with-kafka-on-hdinsight"></a>Use MirrorMaker to replicate Apache Kafka topics with Kafka on HDInsight
...
## <a name="how-kafka-mirroring-works"></a>How Kafka mirroring works
...
### <a name="mirroring-across-network-boundaries"></a>Mirroring across network boundaries
...
## <a name="create-kafka-clusters"></a>Create Kafka clusters
...
## <a name="configure-mirroring"></a>Configure mirroring
