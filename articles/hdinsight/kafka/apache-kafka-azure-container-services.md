...
---
# <a name="use-azure-kubernetes-service-with-kafka-on-hdinsight"></a>Use Azure Kubernetes Service with Kafka on HDInsight
...
### <a name="network-topology"></a>Network topology
...
## <a name="create-an-azure-kubernetes-service-aks"></a>Create an Azure Kubernetes Service (AKS)
...
## <a name="configure-virtual-network-peering"></a>Configure virtual network peering
...
## <a name="install-kafka-on-hdinsight"></a>Install Kafka on HDInsight
...
## <a name="test-the-configuration"></a>Test the configuration
