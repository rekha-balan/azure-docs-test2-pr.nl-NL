...
---
# <a name="tutorial-use-the-apache-kafka-producer-and-consumer-apis"></a>Tutorial: Use the Apache Kafka Producer and Consumer APIs
...
## <a name="set-up-your-deployment-environment"></a>Set up your deployment environment
...
## <a name="build-and-deploy-the-example"></a>Build and deploy the example
