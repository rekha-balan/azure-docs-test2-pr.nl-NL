...
---
# <a name="analyze-logs-for-apache-kafka-on-hdinsight"></a>Analyze logs for Apache Kafka on HDInsight

Learn how to use Log Analytics to analyze logs generated by Apache Kafka on HDInsight.

## <a name="enable-log-analytics-for-kafka"></a>Enable Log Analytics for Kafka
...
## <a name="query-logs"></a>Query logs
