...
---
# <a name="high-availability-of-your-data-with-apache-kafka-on-hdinsight"></a>High availability of your data with Apache Kafka on HDInsight
...
## <a name="fault-and-update-domains-with-kafka"></a>Fault and update domains with Kafka
...
## <a name="when-to-rebalance-partition-replicas"></a>When to rebalance partition replicas
...
## <a name="replication-factor"></a>Replication factor
...
## <a name="how-to-rebalance-partition-replicas"></a>How to rebalance partition replicas
...
For more information on connecting to HDInsight using SSH, see the [Use SSH with HDInsight](../hdinsight-hadoop-linux-use-ssh-unix.md) document.
