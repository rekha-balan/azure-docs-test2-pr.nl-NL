...
---
# <a name="build-java-applications-for-apache-hbase"></a>Build Java applications for Apache HBase
...
## <a name="upload-the-jar-and-run-jobs-ssh"></a>Upload the JAR and run jobs (SSH)
...
## <a name="upload-the-jar-and-run-jobs-powershell"></a>Upload the JAR and run jobs (PowerShell)
