...
---
# <a name="bulk-load-data-into-phoenix-using-psql"></a>Bulk load data into Phoenix using psql
...
## <a name="bulk-loading-with-phoenix"></a>Bulk loading with Phoenix
...
### <a name="use-psql-to-bulk-load-tables"></a>Use `psql` to bulk load tables
...
## <a name="use-mapreduce-to-bulk-load-tables"></a>Use MapReduce to bulk load tables
