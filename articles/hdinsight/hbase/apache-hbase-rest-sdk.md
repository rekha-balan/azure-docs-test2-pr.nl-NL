...
---
# <a name="use-the-hbase-net-sdk"></a>Use the HBase .NET SDK
...
## <a name="instantiate-a-new-hbaseclient-object"></a>Instantiate a new HBaseClient object
...
## <a name="scan-over-rows"></a>Scan over rows
