...
---
# <a name="migrate-an-hbase-cluster-to-a-new-version"></a>Migrate an HBase cluster to a new version
...
## <a name="review-hbase-compatibility"></a>Review HBase compatibility
...
## <a name="upgrade-with-same-hbase-major-version"></a>Upgrade with same HBase major version
