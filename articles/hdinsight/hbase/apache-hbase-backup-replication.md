...
---
# <a name="set-up-backup-and-replication-for-hbase-and-phoenix-on-hdinsight"></a>Set up backup and replication for HBase and Phoenix on HDInsight
...
## <a name="copy-the-hbase-folder"></a>Copy the hbase folder
...
## <a name="export-then-import"></a>Export then Import
...
## <a name="copy-tables"></a>Copy tables
...
### <a name="manually-collect-the-zookeeper-quorum-list"></a>Manually collect the ZooKeeper quorum List
