...
## <a name="instantiate-new-phoenixclient-object"></a>Instantiate new PhoenixClient object
...
## <a name="generate-unique-connection-identifier"></a>Generate unique connection identifier
...
## <a name="create-a-new-table"></a>Create a new table
...
## <a name="insert-data-individually"></a>Insert data individually
...
## <a name="batch-insert-data"></a>Batch insert data
