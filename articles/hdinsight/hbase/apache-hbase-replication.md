...
---
# <a name="set-up-hbase-cluster-replication-in-azure-virtual-networks"></a>Set up HBase cluster replication in Azure virtual networks
...
## <a name="set-up-the-environments"></a>Set up the environments
...
### <a name="set-up-two-virtual-networks-in-two-different-regions"></a>Set up two virtual networks in two different regions
...
## <a name="create-hbase-clusters"></a>Create HBase clusters
...
## <a name="load-test-data"></a>Load test data
...
### <a name="replication-scenarios"></a>Replication scenarios
...
## <a name="copy-and-migrate-data"></a>Copy and migrate data
...
## <a name="disable-replication"></a>Disable replication
