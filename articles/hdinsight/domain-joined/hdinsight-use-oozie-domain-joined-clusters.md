...
---
# <a name="run-apache-oozie-in-domain-joined-hdinsight-hadoop-clusters"></a>Run Apache Oozie in domain-joined HDInsight Hadoop clusters
...
## <a name="connect-to-a-domain-joined-cluster"></a>Connect to a domain-joined cluster
...
hdfs dfs -put examples /user/<DomainUser>/
 ```
Replace `DomainUser` with the domain user name. Replace `DomainUserPath` with the home directory path for the domain user. Replace `ClusterVersion` with your cluster Hortonworks Data Platform (HDP) version.
...
## <a name="define-the-properties-file-for-the-oozie-job"></a>Define the properties file for the Oozie job
...
## <a name="create-custom-hive-scripts-for-oozie-jobs"></a>Create custom Hive scripts for Oozie jobs
You can create the two Hive scripts for Hive server 1 and Hive server 2 as shown in the following sections.
### <a name="hive-server-1-file"></a>Hive server 1 file
...
### <a name="hive-server-2-file"></a>Hive server 2 file
...
## <a name="submit-oozie-jobs"></a>Submit Oozie jobs
...
## <a name="results-from-an-oozie-job-submission"></a>Results from an Oozie job submission
...
## <a name="configure-user-authorization-in-oozie"></a>Configure user authorization in Oozie
