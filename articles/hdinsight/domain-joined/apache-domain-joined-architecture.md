...
## <a name="integrate-hdinsight-with-active-directory"></a>Integrate HDInsight with Active Directory
...
## <a name="set-up-different-domain-controllers"></a>Set up different domain controllers
...
### <a name="on-premises-active-directory-or-active-directory-on-iaas-vms"></a>On-premises Active Directory or Active Directory on IaaS VMs
