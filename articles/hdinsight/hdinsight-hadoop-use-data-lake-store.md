...
---
# <a name="use-data-lake-store-with-azure-hdinsight-clusters"></a>Use Data Lake Store with Azure HDInsight clusters
...
## <a name="availability-for-hdinsight-clusters"></a>Availability for HDInsight clusters
...
## <a name="use-data-lake-store-as-default-storage"></a>Use Data Lake Store as default storage
...
## <a name="use-data-lake-store-as-additional-storage"></a>Use Data Lake Store as additional storage
...
## <a name="use-more-than-one-data-lake-store-accounts"></a>Use more than one Data Lake Store accounts
...
## <a name="configure-data-lake-store-access"></a>Configure Data Lake store access
...
## <a name="access-files-from-the-cluster"></a>Access files from the cluster
...
## <a name="create-hdinsight-clusters-with-access-to-data-lake-store"></a>Create HDInsight clusters with access to Data Lake Store
...
## <a name="refresh-the-hdinsight-certificate-for-data-lake-store-access"></a>Refresh the HDInsight certificate for Data Lake Store access
