...
---
# <a name="analyze-application-insights-telemetry-logs-with-spark-on-hdinsight"></a>Analyze Application Insights telemetry logs with Spark on HDInsight
...
## <a name="export-telemetry-data"></a>Export telemetry data
...
## <a name="configure-hdinsight-to-access-the-data"></a>Configure HDInsight to access the data
...
## <a name="analyze-the-data-using-python-pyspark"></a>Analyze the data using Python (PySpark)
...
## <a name="analyze-the-data-using-scala"></a>Analyze the data using Scala
1. From the [Azure portal](https://portal.azure.com), select your Spark on HDInsight cluster. From the **Quick Links** section, select **Cluster Dashboards**, and then select **Jupyter Notebook** from the Cluster Dashboard__ blade.
