...
## <a name="how-to-configure-the-os-patching-schedule-for-linux-based-hdinsight-clusters"></a>How to configure the OS patching schedule for Linux-based HDInsight clusters
...
## <a name="how-to-use-the-script"></a>How to use the script 
