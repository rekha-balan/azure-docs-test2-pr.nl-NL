...
---
# <a name="connect-hdinsight-to-your-on-premises-network"></a>Connect HDInsight to your on-premises network
...
## <a name="create-the-virtual-network-configuration"></a>Create the Virtual network configuration
...
## <a name="configure-name-resolution"></a>Configure name resolution
...
### <a name="install-and-configure-bind-dns-software"></a>Install and configure Bind (DNS software)
...
### <a name="configure-the-virtual-network-to-use-the-custom-dns-server"></a>Configure the virtual network to use the custom DNS server
...
### <a name="configure-the-on-premises-dns-server"></a>Configure the on-premises DNS server
...
## <a name="optional-control-network-traffic"></a>Optional: Control network traffic
...
## <a name="create-the-hdinsight-cluster"></a>Create the HDInsight cluster
...
## <a name="connecting-to-hdinsight"></a>Connecting to HDInsight
