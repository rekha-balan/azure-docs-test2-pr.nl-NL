...
---
# <a name="use-spark-structured-streaming-with-kafka-and-azure-cosmos-db"></a>Use Spark Structured Streaming with Kafka and Azure Cosmos DB
...
## <a name="get-the-kafka-brokers"></a>Get the Kafka brokers
...
## <a name="upload-the-notebooks"></a>Upload the notebooks
