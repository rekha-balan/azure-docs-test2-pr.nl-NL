...
---
# <a name="capacity-planning-for-hdinsight-clusters"></a>Capacity planning for HDInsight clusters
...
## <a name="choose-an-azure-region"></a>Choose an Azure region
...
## <a name="choose-storage-location-and-size"></a>Choose storage location and size

### <a name="location-of-default-storage"></a>Location of default storage
...
### <a name="location-of-existing-data"></a>Location of existing data
...
### <a name="storage-size"></a>Storage size
...
## <a name="choose-a-cluster-type"></a>Choose a cluster type
...
## <a name="choose-the-vm-size-and-type"></a>Choose the VM size and type
...
## <a name="choose-the-cluster-scale"></a>Choose the cluster scale
...
### <a name="cluster-lifecycle"></a>Cluster lifecycle
...
### <a name="isolate-cluster-job-errors"></a>Isolate cluster job errors
