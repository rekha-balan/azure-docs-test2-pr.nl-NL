...
---
# <a name="operationalize-a-data-analytics-pipeline"></a>Operationalize a data analytics pipeline
...
## <a name="oozie-solution-overview"></a>Oozie solution overview
...
### <a name="provision-azure-resources"></a>Provision Azure resources
...
#### <a name="provision-an-hdinsight-hadoop-cluster"></a>Provision an HDInsight Hadoop Cluster
...
### <a name="verify-ssh-tunneling-setup"></a>Verify SSH tunneling setup
...
### <a name="configure-hive"></a>Configure Hive
...
### <a name="create-the-oozie-workflow"></a>Create the Oozie workflow
...
### <a name="deploy-and-run-the-oozie-workflow"></a>Deploy and run the Oozie workflow
...
### <a name="run-the-workflow-with-a-coordinator"></a>Run the workflow with a coordinator
...
### <a name="deploy-and-run-the-oozie-coordinator"></a>Deploy and run the Oozie Coordinator
