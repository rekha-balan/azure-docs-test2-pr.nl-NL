...
---
# <a name="visualize-interactive-query-hive-data-with-microsoft-power-bi-using-direct-query-in-azure-hdinsight"></a>Visualize Interactive Query Hive data with Microsoft Power BI using direct query in Azure HDInsight
...
## <a name="load-data-from-hdinsight"></a>Load data from HDInsight
