...
---
# <a name="process-events-from-azure-event-hubs-with-storm-on-hdinsight-java"></a>Process events from Azure Event Hubs with Storm on HDInsight (Java)
...
## <a name="understanding-the-example"></a>Understanding the example
...
#### <a name="hortonworks-repository"></a>Hortonworks repository
...
#### <a name="the-eventhubs-storm-spout-dependency"></a>The EventHubs Storm Spout dependency
...
#### <a name="the-hdfsbolt-and-wasb-components"></a>The HdfsBolt and WASB components
...
#### <a name="the-maven-compiler-plugin"></a>The maven-compiler-plugin
...
#### <a name="the-maven-shade-plugin"></a>The maven-shade-plugin
...
#### <a name="the-exec-maven-plugin"></a>The exec-maven-plugin
...
#### <a name="the-resources-section"></a>The resources section
...
## <a name="download-and-register-the-eventhub-components"></a>Download and register the EventHub components
...
## <a name="download-and-build-the-project"></a>Download and build the project
