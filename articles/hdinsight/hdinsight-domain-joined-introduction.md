...
---
# <a name="an-introduction-to-hadoop-security-with-domain-joined-hdinsight-clusters-preview"></a>An introduction to Hadoop security with domain-joined HDInsight clusters (Preview)
...
![Domain Joined HDInsight clusters benefits pillars](https://docstestmedia1.blob.core.windows.net/azure-media/articles/hdinsight/media/hdinsight-domain-joined-introduction/hdinsight-domain-joined-four-pillars.png).
