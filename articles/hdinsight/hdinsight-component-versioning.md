...
---
# <a name="what-are-the-different-hadoop-components-and-versions-available-with-hdinsight"></a>What are the different Hadoop components and versions available with HDInsight?
...
### <a name="cluster-types-supported-for-hdinsight-premium"></a>Cluster types supported for HDInsight Premium
...
### <a name="features-not-supported-for-hdinsight-premium"></a>Features not supported for HDInsight Premium
...
##<a name="hdi-version-33-nearing-deprecation-date"></a>HDI Version 3.3 nearing deprecation date
...
### <a name="the-service-level-agreement-for-hdinsight-cluster-versions"></a>The service-level agreement for HDInsight cluster versions
