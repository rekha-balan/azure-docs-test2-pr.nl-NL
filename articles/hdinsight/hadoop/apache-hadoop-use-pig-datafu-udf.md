...
---
# <a name="use-apache-datafu-pig-with-pig-on-hdinsight"></a>Use Apache DataFu Pig with pig on HDInsight
...
### <a name="find-a-version"></a>Find a version
...
### <a name="download-datafu-to-hdinsight"></a>Download DataFu to HDInsight
