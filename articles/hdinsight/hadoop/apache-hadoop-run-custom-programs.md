...
---
# <a name="run-custom-mapreduce-programs"></a>Run custom MapReduce programs
...
## <a name="custom-mapreduce-components"></a>Custom map/reduce components
...
## <a name="upload-and-run-your-custom-mapreduce-program"></a>Upload and run your custom MapReduce program
