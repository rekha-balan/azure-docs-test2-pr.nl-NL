...
---
# <a name="use-apache-hive-as-an-extract-transform-and-load-etl-tool"></a>Use Apache Hive as an Extract, Transform, and Load (ETL) tool
...
## <a name="use-case-and-model-overview"></a>Use case and model overview
...
## <a name="output-targets"></a>Output targets
