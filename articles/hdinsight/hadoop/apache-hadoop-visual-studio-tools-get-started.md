...
---
# <a name="use-data-lake-tools-for-visual-studio-to-connect-to-azure-hdinsight-and-run-hive-queries"></a>Use Data Lake Tools for Visual Studio to connect to Azure HDInsight and run Hive queries
...
## <a name="install-or-update-data-lake-tools-for-visual-studio"></a>Install or update Data Lake Tools for Visual Studio

### <a name="install-data-lake-tools"></a>Install Data Lake Tools
...
### <a name="update-the-tools"></a>Update the tools
...
## <a name="explore-linked-resources"></a>Explore linked resources
...
## <a name="run-interactive-hive-queries"></a>Run interactive Hive queries
...
### <a name="execute-queries-via-hiveserver2-vs-submit-queries-via-webhcat"></a>Execute queries via HiveServer2 vs. submit queries via WebHCat
...
## <a name="run-hive-batch-jobs"></a>Run Hive batch jobs
