...
---
# <a name="develop-java-mapreduce-programs-for-hadoop-on-hdinsight"></a>Develop Java MapReduce programs for Hadoop on HDInsight
...
## <a name="configure-development-environment"></a>Configure development environment
