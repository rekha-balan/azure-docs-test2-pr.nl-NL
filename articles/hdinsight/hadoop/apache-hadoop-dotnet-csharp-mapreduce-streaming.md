...
---
# <a name="use-c-with-mapreduce-streaming-on-hadoop-in-hdinsight"></a>Use C# with MapReduce streaming on Hadoop in HDInsight
...
## <a name="how-hadoop-streaming-works"></a>How Hadoop streaming works
...
## <a name="create-the-mapper"></a>Create the mapper
...
## <a name="create-the-reducer"></a>Create the reducer
...
## <a name="run-a-job-using-an-ssh-session"></a>Run a job: Using an SSH session
...
## <a name="run-a-job-using-powershell"></a>Run a job: Using PowerShell
