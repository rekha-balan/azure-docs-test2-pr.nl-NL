...
---
# <a name="run-sqoop-jobs-by-using-azure-powershell-for-hadoop-in-hdinsight"></a>Run Sqoop jobs by using Azure PowerShell for Hadoop in HDInsight
...
## <a name="run-sqoop-by-using-powershell"></a>Run Sqoop by using PowerShell
