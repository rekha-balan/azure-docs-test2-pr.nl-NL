...
---
# <a name="run-sqoop-jobs-by-using-net-sdk-for-hadoop-in-hdinsight"></a>Run Sqoop jobs by using .NET SDK for Hadoop in HDInsight
...
## <a name="use-sqoop-on-hdinsight-clusters-with-the-net-sdk"></a>Use Sqoop on HDInsight clusters with the .NET SDK
...
## <a name="submit-a-sqoop-job"></a>Submit a Sqoop job
