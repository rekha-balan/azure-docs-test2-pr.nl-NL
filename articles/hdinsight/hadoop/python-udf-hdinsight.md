...
### <a name="create-the-hiveudfpy-file"></a>Create the hiveudf.py file
...
### <a name="create-the-pigudfpy-file"></a>Create the pigudf.py file
...
#### <a name="use-the-hive-udf"></a>Use the Hive UDF
...
#### <a name="use-the-pig-udf"></a>Use the Pig UDF
...
### <a name="powershell-upload-the-files"></a>PowerShell: Upload the files
...
#### <a name="powershell-use-the-hive-udf"></a>PowerShell: Use the Hive UDF
