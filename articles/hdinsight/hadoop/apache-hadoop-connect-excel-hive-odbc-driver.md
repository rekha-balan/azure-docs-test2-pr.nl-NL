...
---
# <a name="connect-excel-to-hadoop-in-azure-hdinsight-with-the-microsoft-hive-odbc-driver"></a>Connect Excel to Hadoop in Azure HDInsight with the Microsoft Hive ODBC driver
