...
---
# <a name="process-and-analyze-json-documents-by-using-apache-hive-in-azure-hdinsight"></a>Process and analyze JSON documents by using Apache Hive in Azure HDInsight
...
### <a name="use-a-custom-serde"></a>Use a custom SerDe
