...
---
# <a name="run-the-mapreduce-examples-included-in-hdinsight"></a>Run the MapReduce examples included in HDInsight
...
## <a name="the-mapreduce-examples"></a>The MapReduce examples
...
## <a name="run-the-wordcount-example"></a>Run the wordcount example
...
## <a name="the-sudoku-example"></a>The Sudoku example
...
## <a name="pi--example"></a>Pi (π) example
...
## <a name="10-gb-greysort-example"></a>10 GB Greysort example
