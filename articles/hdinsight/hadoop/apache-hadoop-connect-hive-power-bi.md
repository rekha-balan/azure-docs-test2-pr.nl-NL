...
---
# <a name="visualize-hive-data-with-microsoft-power-bi-using-odbc-in-azure-hdinsight"></a>Visualize Hive data with Microsoft Power BI using ODBC in Azure HDInsight
