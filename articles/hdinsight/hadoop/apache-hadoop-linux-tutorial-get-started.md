...
---
# <a name="quickstart-get-started-with-hadoop-and-hive-in-azure-hdinsight-using-resource-manager-template"></a>Quickstart: Get started with Hadoop and Hive in Azure HDInsight using Resource Manager template
...
## <a name="create-a-hadoop-cluster"></a>Create a Hadoop cluster
...
## <a name="use-vscode-to-run-hive-queries"></a>Use VSCode to run Hive queries
...
### <a name="submit-hive-batch-scripts"></a>Submit Hive batch scripts
...
## <a name="use-visualstudio-to-run-hive-queries"></a>Use VisualStudio to run Hive queries
