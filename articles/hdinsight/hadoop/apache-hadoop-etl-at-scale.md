...
---
# <a name="extract-transform-and-load-etl-at-scale"></a>Extract, transform, and load (ETL) at scale
...
## <a name="ingest-file-storage-and-result-storage"></a>Ingest file storage and result storage
...
#### <a name="considerations-for-both-storage-options"></a>Considerations for both storage options
...
### <a name="azure-sql-database-and-azure-database"></a>Azure SQL Database and Azure Database
...
## <a name="extract-and-load"></a>Extract and Load
