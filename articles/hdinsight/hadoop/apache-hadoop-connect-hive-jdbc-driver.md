...
---
# <a name="query-hive-through-the-jdbc-driver-in-hdinsight"></a>Query Hive through the JDBC driver in HDInsight
...
## <a name="jdbc-connection-string"></a>JDBC connection string
