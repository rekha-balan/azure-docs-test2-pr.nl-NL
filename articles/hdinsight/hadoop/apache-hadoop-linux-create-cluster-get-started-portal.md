...
---
# <a name="quickstart-get-started-with-hadoop-and-hive-in-azure-hdinsight-using-the-azure-portal"></a>Quickstart: Get started with Hadoop and Hive in Azure HDInsight using the Azure portal
