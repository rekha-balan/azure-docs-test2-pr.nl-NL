...
---
# <a name="develop-python-streaming-mapreduce-programs-for-hdinsight"></a>Develop Python streaming MapReduce programs for HDInsight
...
## <a name="run-using-powershell"></a>Run using PowerShell
...
## <a name="run-from-an-ssh-session"></a>Run from an SSH session
