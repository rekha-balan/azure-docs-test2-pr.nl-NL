...
---
# <a name="configure-hbase-replication"></a>Configure HBase replication
...
## <a name="configure-the-environments"></a>Configure the environments
...
### <a name="configure-one-virtual-network"></a>Configure one virtual network
...
### <a name="configure-two-virtual-networks-in-the-same-region"></a>Configure two virtual networks in the same region
...
### <a name="configure-two-virtual-networks-in-two-different-regions"></a>Configure two virtual networks in two different regions
