...
## <a name="how-to-use-the-ambari-rest-api"></a>How to use the Ambari REST API
...
### <a name="base-uri-for-ambari-rest-api"></a>Base URI for Ambari Rest API
...
## <a name="examples-authentication-and-parsing-json"></a>Examples: Authentication and parsing JSON
...
### <a name="parsing-json-data"></a>Parsing JSON data
...
## <a name="example-get-the-internal-ip-address-of-cluster-nodes"></a>Example: Get the internal IP address of cluster nodes
...
## <a name="example-get-the-default-storage"></a>Example: Get the default storage
...
## <a name="example-get-configuration"></a>Example: Get configuration
...
## <a name="example-update-configuration"></a>Example: Update configuration
