...
---
# <a name="use-ssh-tunneling-to-access-ambari-web-ui-jobhistory-namenode-oozie-and-other-web-uis"></a>Use SSH Tunneling to access Ambari web UI, JobHistory, NameNode, Oozie, and other web UIs
...
## <a name="why-use-an-ssh-tunnel"></a>Why use an SSH tunnel
