...
---
#<a name="get-started-with-the-storm-starter-samples-for-big-data-analytics-on-linux-based-hdinsight"></a>Get started with the Storm Starter samples for big data analytics on Linux-based HDInsight
