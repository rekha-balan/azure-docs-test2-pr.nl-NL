...
---
# <a name="use-azure-hdinsight-tools-for-visual-studio-code"></a>Use Azure HDInsight Tools for Visual Studio Code
...
## <a name="install-the-hdinsight-tools"></a>Install the HDInsight Tools
   
After you have installed the prerequisites, you can install the Azure HDInsight Tools for VS Code. 

### <a name="to-install-azure-hdinsight-tools"></a>To install Azure HDInsight Tools
...
## <a name="open-hdinsight-workspace"></a>Open HDInsight workspace

Create a workspace in VS Code before you can connect to Azure.

### <a name="to-open-a-workspace"></a>To open a workspace
...
## <a name="connect-to-hdinsight-cluster"></a>Connect to HDInsight Cluster
...
### <a name="to-connect-to-azure"></a>To connect to Azure
...
3. To sign in, follow the sign-in instructions in the **OUTPUT** pane.
    ...
    > [!NOTE]
    > Because of a known Azure authentication issue, you need to open a browser in private mode or incognito mode. If your Azure account has two factors enabled, we recommended using phone authentication instead of PIN authentication.
...
### <a name="to-link-a-generic-livy-endpoint"></a>To link a generic livy endpoint
...
### <a name="to-list-hdinsight-clusters-under-your-azure-subscription"></a>To list HDInsight clusters under your Azure subscription
...
## <a name="set-a-default-cluster"></a>Set a default cluster
...
## <a name="set-the-azure-environment"></a>Set the Azure environment
...
## <a name="submit-interactive-hive-queries-hive-batch-scripts"></a>Submit interactive Hive queries, Hive batch scripts
...
## <a name="submit-interactive-pyspark-queries"></a>Submit interactive PySpark queries

### <a name="to-submit-interactive-pyspark-queries-to-spark-clusters"></a>To submit interactive PySpark queries to Spark clusters.
...
8. The tool also supports the **SQL Clause** query.
   ...
   ![Submit Python job result](./media/hdinsight-for-vscode/pyspark-ineteractive-select-result.png) The submission status appears on the left of the bottom status bar when you're running queries. Don't submit other queries when the status is **PySpark Kernel (busy)**. 
...
### <a name="to-disable-environment-check"></a>To disable environment check
...
### <a name="pyspark3-is-not-supported-with-spark2223"></a>PySpark3 is not supported with Spark2.2/2.3
...
## <a name="submit-pyspark-batch-job"></a>Submit PySpark batch job
...
## <a name="livy-configuration"></a>Livy configuration
...
## <a name="integrate-with-azure-hdinsight-from-explorer"></a>Integrate with Azure HDInsight from Explorer
...
### <a name="create-and-running-applications"></a>Create and running applications
