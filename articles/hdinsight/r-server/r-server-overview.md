...
---
# <a name="introduction-to-ml-services-and-open-source-r-capabilities-on-hdinsight"></a>Introduction to ML Services and open-source R capabilities on HDInsight
...
### <a name="change-hadoop-mapreduce-memory-settings"></a>Change Hadoop MapReduce memory settings
