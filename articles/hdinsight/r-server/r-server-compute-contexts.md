...
---
# <a name="compute-context-options-for-ml-services-on-hdinsight"></a>Compute context options for ML Services on HDInsight
...
## <a name="ml-services-on-azure-hdinsight"></a>ML Services on Azure HDInsight
