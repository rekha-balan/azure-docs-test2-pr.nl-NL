...
---
# <a name="manage-ml-services-cluster-on-azure-hdinsight"></a>Manage ML Services cluster on Azure HDInsight
...
## <a name="enable-multiple-concurrent-users"></a>Enable multiple concurrent users
...
### <a name="step-1-use-the-created-ssh-user-to-sign-in-to-the-edge-node"></a>Step 1: Use the created SSH user to sign in to the edge node
...
### <a name="step-2-add-more-linux-users-in-edge-node"></a>Step 2: Add more Linux users in edge node
...
### <a name="step-3-use-rstudio-community-version-with-the-user-created"></a>Step 3: Use RStudio Community version with the user created
...
## <a name="connect-remotely-to-microsoft-ml-services"></a>Connect remotely to Microsoft ML Services
...
## <a name="access-data-in-hive-and-parquet"></a>Access data in Hive and Parquet
...
## <a name="install-additional-r-packages-on-the-cluster"></a>Install additional R packages on the cluster

### <a name="to-install-r-packages-on-the-edge-node"></a>To install R packages on the edge node
...
### <a name="to-install-r-packages-on-the-worker-node"></a>To install R packages on the worker node
