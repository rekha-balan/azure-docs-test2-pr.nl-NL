...
---
# <a name="operationalize-ml-services-cluster-on-azure-hdinsight"></a>Operationalize ML Services cluster on Azure HDInsight
...
## <a name="operationalize-ml-services-cluster-with-one-box-configuration"></a>Operationalize ML Services cluster with one-box configuration
...
### <a name="ml-services-cluster-on-virtual-network"></a>ML Services cluster on virtual network
...
### <a name="ml-services-cluster-not-set-up-on-virtual-network"></a>ML Services cluster not set up on virtual network
...
## <a name="scale-operationalized-compute-nodes-on-hdinsight-worker-nodes"></a>Scale operationalized compute nodes on HDInsight worker nodes
...
### <a name="step-1-decommission-the-worker-nodes"></a>Step 1: Decommission the worker nodes
...
### <a name="step-2-configure-compute-nodes-on-each-decommissioned-worker-nodes"></a>Step 2: Configure compute nodes on each decommissioned worker node(s)
...
### <a name="step-3-add-compute-nodes-details-on-web-node"></a>Step 3: Add compute nodes details on web node
