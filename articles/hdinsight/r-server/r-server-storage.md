...
## <a name="use-azure-blob-storage-accounts-with-ml-services-cluster"></a>Use Azure Blob storage accounts with ML Services cluster
...
### <a name="use-the-default-storage-with-ml-services-on-hdinsight"></a>Use the default storage with ML Services on HDInsight
...
### <a name="use-the-additional-storage-with-ml-services-on-hdinsight"></a>Use the additional storage with ML Services on HDInsight
...
## <a name="use-an-azure-data-lake-store-with-ml-services-cluster"></a>Use an Azure Data Lake Store with ML Services cluster 
...
### <a name="how-to-access-the-data-lake-store-from-ml-services-on-hdinsight"></a>How to access the Data Lake store from ML Services on HDInsight
...
## <a name="use-azure-file-storage-with-ml-services-on-hdinsight"></a>Use Azure File storage with ML Services on HDInsight
