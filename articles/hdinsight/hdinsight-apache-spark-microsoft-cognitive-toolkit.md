...
---
# <a name="use-microsoft-cognitive-toolkit-deep-learning-model-with-azure-hdinsight-spark-cluster"></a>Use Microsoft Cognitive Toolkit deep learning model with Azure HDInsight Spark cluster
...
## <a name="how-does-this-solution-flow"></a>How does this solution flow?
...
## <a name="install-microsoft-cognitive-toolkit"></a>Install Microsoft Cognitive Toolkit
...
## <a name="upload-the-jupyter-notebook-to-azure-hdinsight-spark-cluster"></a>Upload the Jupyter notebook to Azure HDInsight Spark cluster
...
3. From the Jupyter notebook, click **Upload** in the top-right corner and then navigate to the location where you cloned the GitHub repository.
    ...
    ![Upload Jupyter notebook to Azure HDInsight Spark cluster](https://docstestmedia1.blob.core.windows.net/azure-media/articles/hdinsight/media/hdinsight-apache-spark-microsoft-cognitive-toolkit.md/hdinsight-microsoft-cognitive-toolkit-load-jupyter-notebook.png "Upload Jupyter notebook to Azure HDInsight Spark cluster")
