...
---
# <a name="overview-apache-spark-on-hdinsight"></a>Overview: Apache Spark on HDInsight
...
![Apache Spark on Azure HDInsight](https://docstestmedia1.blob.core.windows.net/azure-media/articles/hdinsight/media/hdinsight-apache-spark-overview/hdispark.architecture.png "Apache Spark on Azure HDInsight")
