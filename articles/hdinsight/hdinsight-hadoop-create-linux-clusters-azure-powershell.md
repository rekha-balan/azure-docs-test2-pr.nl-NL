...
---
# <a name="create-linux-based-clusters-in-hdinsight-using-azure-powershell"></a>Create Linux-based clusters in HDInsight using Azure PowerShell
...
## <a name="create-cluster-configuration-object"></a>Create cluster: Configuration object
