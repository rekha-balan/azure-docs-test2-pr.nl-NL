...
---
# <a name="manage-logs-for-an-hdinsight-cluster"></a>Manage logs for an HDInsight cluster
...
## <a name="step-1-determine-log-retention-policies"></a>Step 1: Determine log retention policies
...
### <a name="understand-the-workloads-running-on-your-clusters"></a>Understand the workloads running on your clusters
...
### <a name="example-log-retention-patterns-and-practices"></a>Example log retention patterns and practices
...
## <a name="step-2-manage-cluster-service-versions-and-view-script-action-logs"></a>Step 2: Manage cluster service versions and view Script Action logs
...
### <a name="view-the-script-action-logs"></a>View the script action logs
...
## <a name="step-3-manage-the-cluster-job-execution-log-files"></a>Step 3: Manage the cluster job execution log files
...
### <a name="access-the-hadoop-log-files"></a>Access the Hadoop log files
...
#### <a name="hdinsight-logs-written-to-azure-blob-storage"></a>HDInsight logs written to Azure Blob storage
...
### <a name="hdinsight-logs-generated-by-yarn"></a>HDInsight logs generated by YARN
...
## <a name="step-4-forecast-log-volume-storage-sizes-and-costs"></a>Step 4: Forecast log volume storage sizes and costs
...
## <a name="step-5-determine-log-archive-policies-and-processes"></a>Step 5: Determine log archive policies and processes
...
### <a name="accessing-azure-storage-metrics"></a>Accessing Azure storage metrics
...
### <a name="control-the-size-and-number-of-backup-indexes-for-old-log-files"></a>Control the size and number of backup indexes for old log files
...
### <a name="other-log-management-techniques"></a>Other log management techniques
