...
---
# <a name="scale-hdinsight-clusters"></a>Scale HDInsight clusters
...
## <a name="scaling-impacts-on-running-jobs"></a>Scaling impacts on running jobs
...
## <a name="rebalancing-an-hbase-cluster"></a>Rebalancing an HBase cluster
...
## <a name="scale-down-implications"></a>Scale down implications
...
## <a name="hdinsight-name-node-stays-in-safe-mode-after-scaling-down"></a>HDInsight name node stays in safe mode after scaling down
...
### <a name="example-errors-when-safe-mode-is-turned-on"></a>Example errors when safe mode is turned on
...
### <a name="view-the-health-and-state-of-your-hdfs-file-system"></a>View the health and state of your HDFS file system
...
### <a name="how-to-prevent-hdinsight-from-getting-stuck-in-safe-mode-due-to-under-replicated-blocks"></a>How to prevent HDInsight from getting stuck in safe mode due to under-replicated blocks
...
#### <a name="stop-all-hive-jobs"></a>Stop all Hive jobs
...
#### <a name="manually-clean-up-hives-scratch-files"></a>Manually clean up Hive's scratch files
...
#### <a name="scale--hdinsight-to-three-worker-nodes"></a>Scale  HDInsight to three worker nodes
...
#### <a name="run-the-command-to-leave-safe-mode"></a>Run the command to leave safe mode
