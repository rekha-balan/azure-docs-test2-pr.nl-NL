...
---
# <a name="troubleshoot-hive-by-using-azure-hdinsight"></a>Troubleshoot Hive by using Azure HDInsight

Learn about the top questions and their resolutions when working with Apache Hive payloads in Apache Ambari.


## <a name="how-do-i-export-a-hive-metastore-and-import-it-on-another-cluster"></a>How do I export a Hive metastore and import it on another cluster?
...
## <a name="how-do-i-locate-hive-logs-on-a-cluster"></a>How do I locate Hive logs on a cluster?
...
## <a name="how-do-i-launch-the-hive-shell-with-specific-configurations-on-a-cluster"></a>How do I launch the Hive shell with specific configurations on a cluster?
...
## <a name="how-do-i-download-tez-dag-data-from-a-cluster"></a>How do I download Tez DAG data from a cluster?
