...
---
# <a name="create-hadoop-cluster-with-secure-transfer-storage-accounts-in-azure-hdinsight"></a>Create Hadoop cluster with secure transfer storage accounts in Azure HDInsight
