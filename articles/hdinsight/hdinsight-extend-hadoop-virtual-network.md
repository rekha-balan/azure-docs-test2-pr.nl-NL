...
### <a name="connect-cloud-resources-together-in-a-private-network-cloud-only"></a>Connect cloud resources together in a private network (cloud-only)
...
### <a name="connect-cloud-resources-to-a-local-datacenter-network"></a>Connect cloud resources to a local datacenter network
...
### <a name="working-with-hdinsight-in-secured-virtual-networks"></a>Working with HDInsight in secured virtual networks
...
### <a name="example-secured-virtual-network"></a>Example: Secured virtual network
...
## <a name="retrieve-internal-ips-and-fqdns"></a>Retrieve internal IPs and FQDNs
