...
---
# <a name="use-ambari-to-optimize-hdinsight-cluster-configurations"></a>Use Ambari to optimize HDInsight cluster configurations
...
## <a name="manage-your-clusters-configuration"></a>Manage your cluster's configuration
...
### <a name="modify-namenode-java-heap-size"></a>Modify NameNode Java heap size
...
## <a name="hive-optimization"></a>Hive optimization
...
### <a name="set-the-hive-execution-engine"></a>Set the Hive execution engine
...
### <a name="tune-mappers"></a>Tune mappers
...
### <a name="tune-reducers"></a>Tune reducers
...
### <a name="enable-parallel-execution"></a>Enable parallel execution
...
### <a name="enable-vectorization"></a>Enable vectorization
...
### <a name="enable-cost-based-optimization-cbo"></a>Enable cost-based optimization (CBO)
...
### <a name="enable-intermediate-compression"></a>Enable intermediate compression
...
### <a name="compress-final-output"></a>Compress final output
...
### <a name="enable-speculative-execution"></a>Enable speculative execution
...
### <a name="tune-dynamic-partitions"></a>Tune dynamic partitions
...
### <a name="enable-local-mode"></a>Enable local mode
...
### <a name="set-single-mapreduce-multigroup-by"></a>Set single MapReduce MultiGROUP BY
...
### <a name="additional-hive-optimizations"></a>Additional Hive optimizations

The following sections describe additional Hive-related optimizations you can set.

#### <a name="join-optimizations"></a>Join optimizations
...
#### <a name="execution-engine-optimizations"></a>Execution engine optimizations
...
## <a name="pig-optimization"></a>Pig optimization
...
### <a name="tune-execution-engine"></a>Tune execution engine
...
### <a name="copy-user-jar-cache"></a>Copy user jar cache
...
### <a name="optimize-performance-with-memory-settings"></a>Optimize performance with memory settings
...
### <a name="compress-temporary-files"></a>Compress temporary files
...
### <a name="enable-split-combining"></a>Enable split combining
...
## <a name="hbase-optimization-with-the-ambari-web-ui"></a>HBase optimization with the Ambari web UI
...
### <a name="optimize-read-heavy-workloads"></a>Optimize read-heavy workloads

The following configurations are important to improve the performance of read-heavy workloads.

#### <a name="block-cache-size"></a>Block cache size
...
#### <a name="memstore-size"></a>Memstore size
...
#### <a name="number-of-rows-fetched-when-scanning-from-disk"></a>Number of rows fetched when scanning from disk
...
### <a name="optimize-write-heavy-workloads"></a>Optimize write-heavy workloads

The following configurations are important to improve the performance of write-heavy workloads.


#### <a name="maximum-region-file-size"></a>Maximum region file size
...
#### <a name="avoid-update-blocking"></a>Avoid update blocking
...
### <a name="define-memstore-size"></a>Define Memstore size
...
### <a name="set-memstore-local-allocation-buffer"></a>Set Memstore local allocation buffer
