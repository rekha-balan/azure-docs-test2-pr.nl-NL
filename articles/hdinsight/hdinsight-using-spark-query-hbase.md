...
---
# <a name="use-spark-to-read-and-write-hbase-data"></a>Use Spark to read and write HBase data
...
## <a name="overall-process"></a>Overall process
...
## <a name="prepare-sample-data-in-hbase"></a>Prepare sample data in HBase
...
## <a name="acquire-hbase-sitexml-from-your-hbase-cluster"></a>Acquire hbase-site.xml from your HBase cluster
...
## <a name="put-hbase-sitexml-on-your-spark-cluster"></a>Put hbase-site.xml on your Spark cluster
...
## <a name="run-spark-shell-referencing-the-spark-hbase-connector"></a>Run Spark Shell referencing the Spark HBase Connector
...
## <a name="define-a-catalog-and-query"></a>Define a Catalog and Query
...
## <a name="insert-new-data"></a>Insert new data
