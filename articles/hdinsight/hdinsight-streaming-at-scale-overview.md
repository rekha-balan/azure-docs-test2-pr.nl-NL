...
---
# <a name="streaming-at-scale-in-hdinsight"></a>Streaming at scale in HDInsight
...
## <a name="scaling-a-cluster"></a>Scaling a cluster
...
### <a name="scale-the-stream-buffering-layer"></a>Scale the stream buffering layer
...
### <a name="scale-the-stream-processing-layer"></a>Scale the stream processing layer
