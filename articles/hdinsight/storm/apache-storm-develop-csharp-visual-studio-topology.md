...
---
# <a name="develop-c-topologies-for-apache-storm-by-using-the-data-lake-tools-for-visual-studio"></a>Develop C# topologies for Apache Storm by using the Data Lake tools for Visual Studio
...
## <a name="install-java"></a>Install Java
...
## <a name="storm-templates"></a>Storm templates
...
### <a name="hbase-templates-notes"></a>HBase templates notes
...
### <a name="eventhub-templates-notes"></a>EventHub templates notes
...
## <a name="hybrid-topology-with-c-and-java"></a>Hybrid topology with C# and Java
...
## <a name="troubleshoot-common-issues-with-topologies"></a>Troubleshoot common issues with topologies
...
### <a name="errors-submitting-topologies"></a>Errors submitting topologies
