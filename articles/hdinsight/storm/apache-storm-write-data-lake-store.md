...
---
# <a name="write-to-hdfs-from-apache-storm-on-hdinsight"></a>Write to HDFS from Apache Storm on HDInsight
...
## <a name="how-to-use-the-hdfsbolt-with-hdinsight"></a>How to use the HdfsBolt with HDInsight
...
### <a name="example-configuration"></a>Example configuration
...
## <a name="configure-the-cluster"></a>Configure the cluster
