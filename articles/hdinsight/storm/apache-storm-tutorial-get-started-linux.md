...
---
# <a name="get-started-with-apache-storm-on-hdinsight-using-the-storm-starter-examples"></a>Get started with Apache Storm on HDInsight using the storm-starter examples
