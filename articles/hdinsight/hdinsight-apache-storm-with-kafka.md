...
---
# <a name="tutorial-use-apache-storm-with-kafka-on-hdinsight"></a>Tutorial: Use Apache Storm with Kafka on HDInsight
...
## <a name="storm-and-kafka"></a>Storm and Kafka
...
### <a name="property-substitutions"></a>Property substitutions
...
## <a name="configure-the-topology"></a>Configure the topology
...
## <a name="create-the-kafka-topic"></a>Create the Kafka topic
...
## <a name="start-the-writer"></a>Start the writer
...
## <a name="start-the-reader"></a>Start the reader
