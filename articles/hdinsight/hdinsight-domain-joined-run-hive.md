...
3. Click **Add New Policy**, and then enter the following values:
   ...
   * Permissions: select
     ...
     ![HDInsight Domain-joined Ranger Hive policy configure](https://docstestmedia1.blob.core.windows.net/azure-media/articles/hdinsight/media/hdinsight-domain-joined-run-hive/hdinsight-domain-joined-configure-ranger-policy.png).
