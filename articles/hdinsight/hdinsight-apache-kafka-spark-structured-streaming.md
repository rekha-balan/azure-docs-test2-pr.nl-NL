...
---
# <a name="tutorial-use-spark-structured-streaming-with-kafka-on-hdinsight"></a>Tutorial: Use Spark Structured Streaming with Kafka on HDInsight
...
## <a name="structured-streaming-with-kafka"></a>Structured Streaming with Kafka
...
## <a name="upload-the-notebook"></a>Upload the notebook
...
## <a name="use-the-notebook"></a>Use the notebook
