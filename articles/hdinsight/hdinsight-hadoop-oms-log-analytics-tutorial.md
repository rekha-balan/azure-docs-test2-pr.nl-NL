...
---
# <a name="use-azure-log-analytics-to-monitor-hdinsight-clusters"></a>Use Azure Log Analytics to monitor HDInsight clusters
...
## <a name="enable-log-analytics-by-using-the-portal"></a>Enable Log Analytics by using the portal
...
## <a name="enable-log-analytics-by-using-azure-powershell"></a>Enable Log Analytics by using Azure PowerShell
...
## <a name="install-hdinsight-cluster-management-solutions"></a>Install HDInsight cluster management solutions
