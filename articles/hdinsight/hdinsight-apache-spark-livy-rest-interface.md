...
---
# <a name="submit-spark-jobs-remotely-to-an-apache-spark-cluster-on-hdinsight-using-livy"></a>Submit Spark jobs remotely to an Apache Spark cluster on HDInsight using Livy
...
## <a name="submit-a-batch-job"></a>Submit a batch job
...
## <a name="using-livy-on-hdinsight-35-spark-clusters"></a>Using Livy on HDInsight 3.5 Spark clusters
