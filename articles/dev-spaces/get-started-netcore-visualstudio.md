...
---
# <a name="get-started-on-azure-dev-spaces-with-net-core-and-visual-studio"></a>Get Started on Azure Dev Spaces with .NET Core and Visual Studio
...
## <a name="get-the-visual-studio-tools"></a>Get the Visual Studio tools
