...
## <a name="call-another-container"></a>Call another container
...
### <a name="challenges-with-developing-microservices"></a>Challenges with developing microservices
...
### <a name="work-in-a-shared-dev-space"></a>Work in a shared dev space
...
### <a name="work-in-your-own-space"></a>Work in your own space
...
### <a name="create-a-new-dev-space"></a>Create a new dev space
...
### <a name="update-code-for-mywebapi"></a>Update code for *mywebapi*
...
### <a name="test-code-running-in-the-defaultscott-space"></a>Test code running in the `default/scott` space
