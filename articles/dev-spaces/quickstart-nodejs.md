...
---
# <a name="quickstart-create-a-kubernetes-dev-space-with-azure-dev-spaces-nodejs"></a>Quickstart: Create a Kubernetes dev space with Azure Dev Spaces (Node.js)
...
### <a name="test-from-a-mobile-device"></a>Test from a mobile device
...
### <a name="initialize-debug-assets-with-the-vs-code-extension"></a>Initialize debug assets with the VS Code extension
...
### <a name="select-the-azds-debug-configuration"></a>Select the AZDS debug configuration
...
### <a name="debug-the-container-in-kubernetes"></a>Debug the container in Kubernetes
...
### <a name="edit-code-and-refresh-the-debug-session"></a>Edit code and refresh the debug session
...
### <a name="use-nodemon-to-develop-even-faster"></a>Use NodeMon to develop even faster
