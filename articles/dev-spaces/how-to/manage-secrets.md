...
---
# <a name="how-to-manage-secrets-when-working-with-an-azure-dev-space"></a>How to manage secrets when working with an Azure Dev Space
...
## <a name="method-1-valuesdevyaml"></a>Method 1: values.dev.yaml
...
## <a name="method-2-inline-directly-in-azdsyaml"></a>Method 2: Inline directly in azds.yaml
