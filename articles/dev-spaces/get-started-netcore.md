...
---
# <a name="get-started-on-azure-dev-spaces-with-net-core"></a>Get Started on Azure Dev Spaces with .NET Core
...
## <a name="create-a-web-app-running-in-a-container"></a>Create a web app running in a container
