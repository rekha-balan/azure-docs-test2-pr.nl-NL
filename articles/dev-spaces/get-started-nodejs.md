...
---
# <a name="get-started-on-azure-dev-spaces-with-nodejs"></a>Get Started on Azure Dev Spaces with Node.js
...
## <a name="create-a-nodejs-container-in-kubernetes"></a>Create a Node.js container in Kubernetes

In this section, you'll create a Node.js web app and get it running in a container in Kubernetes.

### <a name="create-a-nodejs-web-app"></a>Create a Node.js Web App
