...
---
# <a name="quickstart-create-a-kubernetes-dev-space-with-azure-dev-spaces-net-core-and-vs-code"></a>Quickstart: Create a Kubernetes dev space with Azure Dev Spaces (.NET Core and VS Code)
...
### <a name="edit-code-and-refresh"></a>Edit code and refresh
