...
---
# <a name="quickstart-create-a-kubernetes-dev-space-with-azure-dev-spaces-java-and-vs-code"></a>Quickstart: Create a Kubernetes dev space with Azure Dev Spaces (Java and VS Code)
