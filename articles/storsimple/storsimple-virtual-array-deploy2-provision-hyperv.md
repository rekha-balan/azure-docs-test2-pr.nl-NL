...
---
# <a name="deploy-storsimple-virtual-array---provision-in-hyper-v"></a>Deploy StorSimple Virtual Array - Provision in Hyper-V
...
### <a name="for-the-storsimple-device-manager-service"></a>For the StorSimple Device Manager service
...
### <a name="for-the-storsimple-virtual-array"></a>For the StorSimple Virtual Array
...
## <a name="step-1-ensure-that-the-host-system-meets-minimum-virtual-array-requirements"></a>Step 1: Ensure that the host system meets minimum virtual array requirements
...
## <a name="step-2-provision-a-virtual-array-in-hypervisor"></a>Step 2: Provision a virtual array in hypervisor
Perform the following steps to provision a device in your hypervisor.

#### <a name="to-provision-a-virtual-array"></a>To provision a virtual array
...
## <a name="step-3-start-the-virtual-array-and-get-the-ip"></a>Step 3: Start the virtual array and get the IP
Perform the following steps to start your virtual array and connect to it.

#### <a name="to-start-the-virtual-array"></a>To start the virtual array
