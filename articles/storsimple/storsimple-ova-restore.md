...
---
# <a name="restore-from-a-backup-set-of-shares-and-volumes-on-your-storsimple-virtual-array"></a>Restore from a backup set of shares and volumes on your StorSimple Virtual Array
...
1. Browse to the **Backup Catalog**. Filter by appropriate device and time range to search for your backups. Click the check icon ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-ova-restore/image1.png) to execute the query.
...
4. This will initiate the **Restore as new share** wizard. On the **Specify name and location** page:
   ...
   4. Click the check icon ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-ova-restore/image1.png).
...
6. Click the check icon ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-ova-restore/image1.png). This will initiate a restore job and you will see the following notification that the job is in progress.
...
![video_icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-ova-restore/video_icon.png) **Video available**
