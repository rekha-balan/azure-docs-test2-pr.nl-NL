...
---
# <a name="storsimple-as-a-backup-target-with-netbackup"></a>StorSimple as a backup target with NetBackup
...
### <a name="who-should-read-this"></a>Who should read this?
...
## <a name="why-storsimple-as-a-backup-target"></a>Why StorSimple as a backup target?
...
**StorSimple tiering**
![StorSimple tiering diagram](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-configure-backup-target-using-netbackup/image1.jpg)
...
## <a name="storsimple-benefits"></a>StorSimple benefits
...
## <a name="storsimple-as-a-primary-backup-target"></a>StorSimple as a primary backup target
...
### <a name="primary-target-backup-logical-steps"></a>Primary target backup logical steps
...
### <a name="primary-target-restore-logical-steps"></a>Primary target restore logical steps
...
## <a name="storsimple-as-a-secondary-backup-target"></a>StorSimple as a secondary backup target
...
### <a name="secondary-target-backup-logical-steps"></a>Secondary target backup logical steps
...
### <a name="secondary-target-restore-logical-steps"></a>Secondary target restore logical steps
...
### <a name="set-up-the-network"></a>Set up the network
...
## <a name="set-up-the-solution"></a>Set up the solution
...
### <a name="set-up-storsimple"></a>Set up StorSimple
...
### <a name="set-up-the-host-backup-server-storage"></a>Set up the host backup server storage
...
## <a name="best-practices-for-storsimple-and-netbackup"></a>Best practices for StorSimple and NetBackup

Set up your solution according to the guidelines in the following few sections.

### <a name="operating-system-best-practices"></a>Operating system best practices
...
## <a name="retention-policies"></a>Retention policies
...
## <a name="set-up-netbackup-storage"></a>Set up NetBackup storage

### <a name="to-set-up-netbackup-storage"></a>To set up NetBackup storage
...
## <a name="set-up-storsimple-as-a-primary-backup-target"></a>Set up StorSimple as a primary backup target
...
![Primary backup target configuration logical diagram ](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-configure-backup-target-using-netbackup/primarybackuptargetdiagram.png)

### <a name="storsimple-as-a-primary-backup-target-gfs-schedule-example"></a>StorSimple as a primary backup target GFS schedule example
...
## <a name="assigning-storsimple-volumes-to-a-netbackup-backup-job"></a>Assigning StorSimple volumes to a NetBackup backup job
...
### <a name="to-assign-storsimple-volumes-to-a-netbackup-backup-job"></a>To assign StorSimple volumes to a NetBackup backup job
...
## <a name="set-up-storsimple-as-a-secondary-backup-target"></a>Set up StorSimple as a secondary backup target
...
### <a name="storsimple-as-a-secondary-backup-target-gfs-example"></a>StorSimple as a secondary backup target GFS example
...
### <a name="backup-configuration-and-capacity-requirements"></a>Backup configuration and capacity requirements
...
### <a name="gfs-example-schedule-gfs-rotation-weekly-monthly-and-yearly-schedule"></a>GFS example schedule: GFS rotation weekly, monthly, and yearly schedule
...
## <a name="assign-storsimple-volumes-to-a-netbackup-archive-and-duplication-job"></a>Assign StorSimple volumes to a NetBackup archive and duplication job
...
### <a name="to-assign-storsimple-volumes-to-a-netbackup-archive-and-duplication-job"></a>To assign StorSimple volumes to a NetBackup archive and duplication job
...
## <a name="storsimple-cloud-snapshots"></a>StorSimple cloud snapshots
...
### <a name="start-and-delete-cloud-snapshots-by-using-a-script"></a>Start and delete cloud snapshots by using a script
...
### <a name="backup-lifecycle"></a>Backup lifecycle
...
### <a name="to-start-or-delete-a-cloud-snapshot"></a>To start or delete a cloud snapshot
...
## <a name="storsimple-as-a-restore-source"></a>StorSimple as a restore source
...
## <a name="storsimple-failover-and-disaster-recovery"></a>StorSimple failover and disaster recovery
