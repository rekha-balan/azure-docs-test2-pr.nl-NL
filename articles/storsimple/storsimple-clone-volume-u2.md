...
4. In the Clone Volume wizard, under **Specify name and location**:
   ...
   3. Click the arrow icon ![arrow-icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-clone-volume-u2/HCS_ArrowIcon.png) to proceed to the next page.
5. Under **Specify hosts that can use this volume**:
   ...
   2. Click the check icon ![check-icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-clone-volume-u2/HCS_CheckIcon.png)to complete the operation.
...
![Video available](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-clone-volume-u2/Video_icon.png) **Video available**
