...
---
# <a name="use-the-storsimple-device-manager-service-to-manage-shares-on-the-storsimple-virtual-array"></a>Use the StorSimple Device Manager service to manage shares on the StorSimple Virtual Array
...
## <a name="share-types"></a>Share Types
...
## <a name="the-shares-blade"></a>The Shares blade
...
## <a name="add-a-share"></a>Add a share
...
## <a name="modify-a-share"></a>Modify a share
...
#### <a name="to-modify-a-share"></a>To modify a share
...
3. Save your changes by clicking the **Save** command bar. Your specified settings will be applied and you will see a notification.
    ...
    ![ Edit share](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-virtual-array-manage-shares/share-edit.png)

## <a name="take-a-share-offline"></a>Take a share offline
...
#### <a name="to-take-a-share-offline"></a>To take a share offline
...
## <a name="delete-a-share"></a>Delete a share
...
#### <a name="to-delete-a-share"></a>To delete a share
