...
![video icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-overview/video_icon.png) Watch the video for a quick introduction to Microsoft Azure StorSimple.
...
![video icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-overview/video_icon.png) Watch [this video](https://www.youtube.com/watch?v=4MhJT5xrvQw&feature=youtu.be) for an overview of the StorSimple 8000 series features and benefits.
