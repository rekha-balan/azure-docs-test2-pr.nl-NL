...
## <a name="issues-fixed-in-update-4"></a>Issues fixed in Update 4
...
## <a name="known-issues-in-update-4-from-previous-releases"></a>Known issues in Update 4 from previous releases
...
## <a name="serial-attached-scsi-sas-controller-and-firmware-updates-in-update-4"></a>Serial-attached SCSI (SAS) controller and firmware updates in Update 4
...
## <a name="virtual-device-updates-in-update-4"></a>Virtual device updates in Update 4
