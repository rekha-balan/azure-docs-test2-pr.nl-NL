...
---
# <a name="use-the-net-sdk-to-initiate-data-transformation-private-preview"></a>Use the .Net SDK to initiate data transformation (Private Preview)
...
2. This script outputs the following values:      - Client ID      - Tenant ID      - Active Directory key (same as the one entered above)      - Subscription ID
