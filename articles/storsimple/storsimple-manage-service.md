...
---
# <a name="deploy-the-storsimple-manager-service-in-the-azure-classic-portal"></a>Deploy the StorSimple Manager service in the Azure classic portal
...
6. Click the check icon ![Check icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-manage-service/HCS_CheckIcon.png) to close this dialog box.
