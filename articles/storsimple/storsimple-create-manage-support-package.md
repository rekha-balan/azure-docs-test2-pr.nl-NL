...
3. In the **Create and upload support package** dialog box, do the following:
   ...
   * Click the check icon ![Check icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-create-manage-support-package/IC740895.png).
