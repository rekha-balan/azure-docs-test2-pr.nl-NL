...
---
# <a name="storsimple-as-a-backup-target-with-backup-exec"></a>StorSimple as a backup target with Backup Exec
...
**StorSimple tiering**
![StorSimple tiering diagram](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-configure-backup-target-using-backup-exec/image1.jpg)
...
### <a name="deploy-backup-exec"></a>Deploy Backup Exec
...
## <a name="best-practices-for-storsimple-and-backup-exec"></a>Best practices for StorSimple and Backup Exec
...
### <a name="backup-exec-best-practices"></a>Backup Exec best practices
...
## <a name="set-up-backup-exec-storage"></a>Set up Backup Exec storage

### <a name="to-set-up-backup-exec-storage"></a>To set up Backup Exec storage
...
### <a name="assign-storsimple-volumes-to-a-backup-exec-backup-job"></a>Assign StorSimple volumes to a Backup Exec backup job
...
#### <a name="to-assign-storsimple-volumes-to-a-backup-exec-backup-job"></a>To assign StorSimple volumes to a Backup Exec backup job
...
### <a name="assign-storsimple-volumes-to-a-backup-exec-archive-and-deduplication-job"></a>Assign StorSimple volumes to a Backup Exec archive and deduplication job

#### <a name="to-assign-storsimple-volumes-to-a-backup-exec-archive-and-duplication-job"></a>To assign StorSimple volumes to a Backup Exec archive and duplication job
