...
---
# <a name="use-the-storsimple-device-manager-service-to-administer-your-storsimple-virtual-array"></a>Use the StorSimple Device Manager service to administer your StorSimple Virtual Array
...
## <a name="connect-to-the-storsimple-device-manager-service"></a>Connect to the StorSimple Device Manager service
...
## <a name="use-the-storsimple-device-manager-service-to-perform-management-tasks"></a>Use the StorSimple Device Manager service to perform management tasks
...
#### <a name="storsimple-device-manager-workflows"></a>StorSimple Device Manager workflows
