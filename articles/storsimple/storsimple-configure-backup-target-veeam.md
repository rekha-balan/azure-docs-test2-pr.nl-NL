...
---
# <a name="storsimple-as-a-backup-target-with-veeam"></a>StorSimple as a backup target with Veeam
...
**StorSimple tiering**
![StorSimple tiering diagram](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-configure-backup-target-using-veeam/image1.jpg)
...
### <a name="deploy-veeam"></a>Deploy Veeam
...
## <a name="best-practices-for-storsimple-and-veeam"></a>Best practices for StorSimple and Veeam
...
## <a name="set-up-veeam-storage"></a>Set up Veeam storage

### <a name="to-set-up-veeam-storage"></a>To set up Veeam storage
...
### <a name="assign-storsimple-volumes-to-a-veeam-backup-job"></a>Assign StorSimple volumes to a Veeam backup job
...
#### <a name="to-assign-storsimple-volumes-to-a-veeam-backup-job"></a>To assign StorSimple volumes to a Veeam backup job
...
### <a name="gfs-example-schedule"></a>GFS example schedule
...
### <a name="assign-storsimple-volumes-to-a-veeam-copy-job"></a>Assign StorSimple volumes to a Veeam copy job

#### <a name="to-assign-storsimple-volumes-to-a-veeam-copy-job"></a>To assign StorSimple volumes to a Veeam copy job
