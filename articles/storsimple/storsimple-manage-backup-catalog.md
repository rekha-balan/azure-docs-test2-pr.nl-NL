...
2. Filter the selections as follows:
   ...
   4. Click the check icon ![Check icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-manage-backup-catalog/HCS_CheckIcon.png) to execute this query.
