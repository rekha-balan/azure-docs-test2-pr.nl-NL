...
---
# <a name="use-the-service-summary-blade-for-storsimple-device-manager-connected-to-storsimple-virtual-array"></a>Use the service summary blade for StorSimple Device Manager connected to StorSimple Virtual Array
...
## <a name="management-commands-and-essentials"></a>Management commands and essentials
...
## <a name="storsimple-device-manager-service-summary"></a>StorSimple Device Manager service summary
...
## <a name="view-the-activity-logs"></a>View the activity logs
