...
## <a name="what-is-disaster-recovery-and-device-failover"></a>What is disaster recovery and device failover?
...
### <a name="device-failover-prechecks"></a>Device failover prechecks
