...
---
# <a name="use-the-storsimple-diagnostics-tool-to-troubleshoot-8000-series-device-issues"></a>Use the StorSimple Diagnostics Tool to troubleshoot 8000 series device issues
...
## <a name="run-diagnostics-tool"></a>Run diagnostics tool
...
#### <a name="to-run-the-diagnostics-tool"></a>To run the diagnostics tool
...
## <a name="scenarios-to-use-the-diagnostics-tool"></a>Scenarios to use the diagnostics tool
...
## <a name="diagnostics-test-and-sample-outputs"></a>Diagnostics test and sample outputs

### <a name="hardware-test"></a>Hardware test
...
#### <a name="sample-output-of-hardware-test-run-on-an-8100-device"></a>Sample output of hardware test run on an 8100 device
...
#### <a name="sample-output-of-system-test-run-on-an-8100-device"></a>Sample output of system test run on an 8100 device
...
### <a name="network-test"></a>Network test
...
#### <a name="sample-output-of-network-test-when-only-data0-is-enabled"></a>Sample output of network test when only DATA0 is enabled
...
#### <a name="sample-output-of-network-test-when-data0-and-data1-are-enabled"></a>Sample output of network test when DATA0 and DATA1 are enabled
...
#### <a name="sample-output-of-performance-test-run-on-an-8100-device"></a>Sample output of performance test run on an 8100 device
...
## <a name="appendix-interpreting-system-information"></a>Appendix: interpreting system information
