...
4. In the **Change Controller Settings** dialog box, do the following:
   ...
   3. Click the check icon ![Check Icon](https://docstestmedia1.blob.core.windows.net/azure-media/articles/storsimple/media/storsimple-manage-device-controller/IC740895.png).
