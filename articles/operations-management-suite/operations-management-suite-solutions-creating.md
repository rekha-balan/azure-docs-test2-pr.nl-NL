...
---
# <a name="design-and-build-a-management-solution-in-operations-management-suite-oms-preview"></a>Design and build a management solution in Operations Management Suite (OMS) (Preview)
> [!NOTE]
