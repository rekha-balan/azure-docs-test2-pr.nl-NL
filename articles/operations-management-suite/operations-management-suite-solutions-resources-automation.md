...
---
# <a name="adding-azure-automation-resources-to-an-oms-management-solution-preview"></a>Adding Azure Automation resources to an OMS management solution (Preview)
> [!NOTE]
...
### <a name="job-schedules"></a>Job schedules
