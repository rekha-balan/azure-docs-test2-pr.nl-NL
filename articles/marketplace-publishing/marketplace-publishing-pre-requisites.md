...
ms.date: 08/18/2016
ms.author: hascipio
ms.openlocfilehash: 7b72e00638292f593189954ff7cee1b88c7e292a
ms.sourcegitcommit: 5b9d839c0c0a94b293fdafe1d6e5429506c07e05
ms.translationtype: HT
ms.contentlocale: nl-NL
ms.lasthandoff: 08/02/2018
ms.locfileid: "44556465"
---
...
5. Navigate to Publishers->select your account->Administrators->Add the co-admin (screenshot given below)
    ...
    ![drawing](https://docstestmedia1.blob.core.windows.net/azure-media/articles/marketplace-publishing/media/marketplace-publishing-pre-requisites/imgAddAdmin_05.png)
...
3. Click on the **X** button next to the co-admin you want tot delete (screenshot given below).
    ...
    ![drawing](https://docstestmedia1.blob.core.windows.net/azure-media/articles/marketplace-publishing/media/marketplace-publishing-pre-requisites/imgDeleteAdmin_03.png)
