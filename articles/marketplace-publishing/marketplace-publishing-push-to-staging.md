...
---
# <a name="complete-the-offer-creation-with-marketing-content"></a>Complete the offer creation with marketing content
...
## <a name="step-1-provide-marketplace-marketing-content"></a>Step 1: Provide Marketplace marketing content
...
### <a name="details-and-plans"></a>Details and plans
...
### <a name="sample-images-optional"></a>Sample images (optional)
> [!NOTE]
...
**Note:** For Virtual Machine offers, once an offer/SKU is staged in the Azure Portal, you cannot change the fields given below:
...
## <a name="step-2-set-your-prices"></a>Step 2: Set your prices
### <a name="pricing-models"></a>Pricing models
...
### <a name="21-set-your-vm-prices"></a>2.1. Set your VM prices
...
### <a name="sell-to-countries-of-the-sku"></a>“Sell-to” countries of the SKU
...
### <a name="211-how-to-setup-hourly-pricing-model-for-a-sku"></a>2.1.1 How to setup hourly pricing model for a SKU
...
### <a name="212-how-to-setup-byol-pricing-model-for-a-sku"></a>2.1.2 How to setup BYOL pricing model for a SKU
...
### <a name="22-set-your-developer-service-prices"></a>2.2. Set your Developer service prices
...
## <a name="step-3-provide-support-information"></a>Step 3: Provide support information
...
## <a name="step-4-choose-azure-marketplace-categories"></a>Step 4: Choose Azure Marketplace categories
...
## <a name="how-your-marketing-will-appear"></a>How your marketing will appear
