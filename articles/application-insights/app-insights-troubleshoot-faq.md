...
---
# <a name="application-insights-frequently-asked-questions"></a>Application Insights: Frequently Asked Questions
...
## <a name="how-much-is-it-costing"></a>How much is it costing?
...
## <a name="what-is-status-monitor"></a>What is Status Monitor?
...
## <a name="how-are-city-country-and-other-geo-location-data-calculated"></a>How are City, Country and other geo location data calculated?
...
## <a name="might-personally-identifiable-information-pii-be-sent-in-the-telemetry"></a>Might personally identifiable information (PII) be sent in the telemetry?
...
## <a name="my-ikey-is-visible-in-my-web-page-source"></a>My iKey is visible in my web page source. 
...
## <a name="should-i-use-single-or-multiple-application-insights-resources"></a>Should I use single or multiple Application Insights resources?
...
## <a name="how-do-i-dynamically-change-the-instrumentation-key"></a>How do I dynamically change the instrumentation key?

* [Discussion here](app-insights-separate-resources.md)
* [Example - cloud service with worker and web roles](app-insights-cloudservices.md)

## <a name="what-are-the-user-and-session-counts"></a>What are the User and Session counts?
...
## <a name="why-are-the-counts-in-search-and-metrics-charts-unequal"></a>Why are the counts in Search and Metrics charts unequal?
...
### <a name="querying-the-telemetry"></a>Querying the telemetry

Use the [REST API](https://dev.applicationinsights.io/) to run [Analytics](app-insights-analytics.md) queries.

## <a name="how-can-i-set-an-alert-on-an-event"></a>How can I set an alert on an event?
...
## <a name="are-there-data-transfer-charges-between-an-azure-web-app-and-application-insights"></a>Are there data transfer charges between an Azure web app and Application Insights?
...
## <a name="can-i-send-telemetry-to-the-application-insights-portal"></a>Can I send telemetry to the Application Insights portal?
...
## <a name="can-i-monitor-an-intranet-web-server"></a>Can I monitor an intranet web server?

Here are two methods:

### <a name="firewall-door"></a>Firewall door
...
Route traffic from your server to a gateway on your intranet, by overwritting these settings in the example ApplicationInsights.config. If these "Endpoint" properties are not present in your config, these classes will be using the default values shown in the example below.

#### <a name="example-applicationinsightsconfig"></a>Example ApplicationInsights.config:
```xml
<ApplicationInsights>
    ...
    <TelemetryChannel>
...
## <a name="can-i-run-availability-web-tests-on-an-intranet-server"></a>Can I run Availability web tests on an intranet server?
