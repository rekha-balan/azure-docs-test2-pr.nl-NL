...
---
# <a name="find-and-diagnose-performance-issues-with-azure-application-insights"></a>Find and diagnose performance issues with Azure Application Insights
...
## <a name="identify-slow-server-operations"></a>Identify slow server operations
...
## <a name="use-analytics-data-for-server"></a>Use analytics data for server
...
## <a name="identify-slow-client-operations"></a>Identify slow client operations
...
## <a name="use-analytics-data-for-client"></a>Use analytics data for client
