...
---
# <a name="manage-application-insights-smart-detection-rules-using-azure-resource-manager-templates"></a>Manage Application Insights smart detection rules using Azure Resource Manager templates
...
## <a name="smart-detection-rule-configuration"></a>Smart detection rule configuration
...
### <a name="disable-a-smart-detection-rule"></a>Disable a smart detection rule
...
### <a name="disable-sending-email-notifications-for-a-smart-detection-rule"></a>Disable sending email notifications for a smart detection rule
...
### <a name="add-additional-email-recipients-for-a-smart-detection-rule"></a>Add additional email recipients for a smart detection rule
...
## <a name="smart-detection-rule-names"></a>Smart detection rule names
