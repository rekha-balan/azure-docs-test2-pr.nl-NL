...
---
# <a name="find-and-diagnose-run-time-exceptions-with-azure-application-insights"></a>Find and diagnose run-time exceptions with Azure Application Insights
...
## <a name="analyze-failures"></a>Analyze failures
...
## <a name="identify-failing-code"></a>Identify failing code
...
## <a name="use-analytics-data"></a>Use analytics data
...
## <a name="add-work-item"></a>Add work item
