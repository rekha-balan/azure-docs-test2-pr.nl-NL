...
---
# <a name="use-azure-application-insights-to-understand-how-customers-are-using-your-application"></a>Use Azure Application Insights to understand how customers are using your application
...
## <a name="get-information-about-your-users"></a>Get information about your users
...
## <a name="analyze-user-sessions"></a>Analyze user sessions
...
## <a name="group-together-similar-users"></a>Group together similar users
...
## <a name="compare-desired-activity-to-reality"></a>Compare desired activity to reality
...
## <a name="learn-which-customers-return"></a>Learn which customers return
...
## <a name="analyze-user-navigation"></a>Analyze user navigation
...
## <a name="consolidate-usage-data"></a>Consolidate usage data
