...
## <a name="set-up-dependency-monitoring"></a>Set up dependency monitoring
...
## <a name="where-to-find-dependency-data"></a>Where to find dependency data
...
## <a name="performance-and-failure-blades"></a>Performance and failure blades
...
## <a name="ajax-calls"></a>AJAX Calls
...
### <a name="tracing-from-requests-to-dependencies"></a>Tracing from requests to dependencies
...
### <a name="request-timeline"></a>Request timeline
...
### <a name="profiling-your-live-site"></a>Profiling your live site
