...
---
# <a name="monitor-and-alert-on-application-health-with-azure-application-insights"></a>Monitor and alert on application health with Azure Application Insights
...
## <a name="create-availability-test"></a>Create availability test
...
## <a name="create-an-alert-from-metrics"></a>Create an alert from metrics
...
## <a name="proactively-send-information"></a>Proactively send information
