...
---
# <a name="start-monitoring-your-aspnet-core-web-application"></a>Start Monitoring Your ASP.NET Core Web Application
...
## <a name="configure-app-insights-sdk"></a>Configure App Insights SDK
