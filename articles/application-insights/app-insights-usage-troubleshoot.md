...
---
# <a name="troubleshoot-user-behavior-analytics-tools-in-application-insights"></a>Troubleshoot user behavior analytics tools in Application Insights
...
## <a name="counting-users"></a>Counting Users
...
## <a name="naming-events"></a>Naming Events
