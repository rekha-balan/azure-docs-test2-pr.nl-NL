...
## <a name="send-telemetry-from-your-app"></a>Send telemetry from your app
...
## <a name="include-user-and-session-id-in-your-telemetry"></a>Include user and session ID in your telemetry
...
## <a name="explore-usage-demographics-and-statistics"></a>Explore usage demographics and statistics
...
## <a name="retention---how-many-users-come-back"></a>Retention - how many users come back?
...
## <a name="custom-business-events"></a>Custom business events
...
### <a name="slice-and-dice-events"></a>Slice and dice events

In the Users, Sessions, and Events tools, you can slice and dice custom events by user, event name, and properties.
![Users](./media/app-insights-usage-overview/users.png)  
  
## <a name="design-the-telemetry-with-the-app"></a>Design the telemetry with the app
