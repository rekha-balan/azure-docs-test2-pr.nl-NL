...
---
# <a name="smart-detection---performance-anomalies"></a>Smart Detection - Performance Anomalies
...
## <a name="when-would-i-get-a-smart-detection-notification"></a>When would I get a smart detection notification?
...
## <a name="does-my-app-definitely-have-a-problem"></a>Does my app definitely have a problem?
...
## <a name="server-response-time-degradation"></a>Server Response Time Degradation
...
## <a name="dependency-duration-degradation"></a>Dependency Duration Degradation
...
## <a name="smart-detection-of-slow-performing-patterns"></a>Smart Detection of slow performing patterns 
