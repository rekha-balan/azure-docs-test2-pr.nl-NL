...
### <a name="open-or-create-application-insights-resource"></a>Open or create Application Insights resource
...
![On your app overview blade, choose Quick Start, Get code to monitor my web pages. Copy the script.](https://docstestmedia1.blob.core.windows.net/azure-media/articles/application-insights/media/app-insights-javascript/02-monitor-web-page.png)
