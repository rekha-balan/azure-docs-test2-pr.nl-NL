...
---
# <a name="monitor-multi-component-applications-with-application-insights-preview"></a>Monitor multi-component applications with Application Insights (preview)
...
### <a name="sharing-a-single-application-insights-resource"></a>Sharing a single Application Insights resource 
...
## <a name="configure-multi-component-applications"></a>Configure multi-component applications
...
### <a name="1-install-the-latest-pre-release-package"></a>1. Install the latest pre-release package
...
### <a name="2-share-a-single-application-insights-resource"></a>2. Share a single Application Insights resource
...
### <a name="3-enable-composite-application-map"></a>3. Enable Composite Application Map
...
### <a name="4-enable-docker-metrics-optional"></a>4. Enable Docker metrics (Optional) 
...
## <a name="use-cloudrolename-to-separate-components"></a>Use cloud_RoleName to separate components
...
## <a name="trace-operations-between-components"></a>Trace operations between components
