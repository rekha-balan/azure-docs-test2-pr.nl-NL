...
### <a name="getting-the-right-type"></a>Getting the right type
...
### <a name="convert-to-local-time"></a>Convert to local time
...
## <a name="combine-with-imported-data"></a>Combine with imported data
...
### <a name="availability-results-table"></a>Availability results table
