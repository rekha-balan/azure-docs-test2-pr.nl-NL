...
---
# <a name="add-continuous-monitoring-to-your-release-pipeline"></a>Add continuous monitoring to your release pipeline
...
## <a name="configure-continuous-monitoring"></a>Configure continuous monitoring
...
## <a name="modify-alert-rules"></a>Modify alert rules
...
## <a name="add-deployment-conditions"></a>Add deployment conditions
...
## <a name="deployment-gate-status-logs"></a>Deployment gate status logs
