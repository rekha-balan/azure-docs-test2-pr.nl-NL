...
---
# <a name="separating-telemetry-from-development-test-and-production"></a>Separating telemetry from Development, Test, and Production
...
## <a name="about-resources-and-instrumentation-keys"></a>About resources and instrumentation keys
...
## <a name="create-additional-application-insights-resources"></a>Create additional Application Insights resources
