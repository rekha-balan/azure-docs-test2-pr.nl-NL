...
### <a name="etw-event-tracking"></a>ETW Event Tracking
...
#### <a name="example-configuration-via-applicationinsightsconfig"></a>Example Configuration via ApplicationInsights.config:
```xml
<ApplicationInsights>
    ...
...
#### <a name="example-configuration-via-code"></a>Example Configuration via code:
```csharp
