...
---
# <a name="manually-configure-application-insights-for-net-applications"></a>Manually configure Application Insights for .NET applications
...
### <a name="part-of-a-larger-app-use-existing-resource"></a>Part of a larger app: Use existing resource
...
### <a name="self-contained-app-create-a-new-resource"></a>Self-contained app: Create a new resource
...
## <a name="2-copy-the-instrumentation-key"></a>2. Copy the Instrumentation Key
...
### <a name="to-upgrade-to-future-package-versions"></a>To upgrade to future package versions
...
## <a name="4-send-telemetry"></a>4. Send telemetry
