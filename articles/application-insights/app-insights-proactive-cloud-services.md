...
---
# <a name="alert-on-issues-in-azure-cloud-services-using-the-azure-diagnostics-integration-with-azure-application-insights"></a>Alert on issues in Azure Cloud Services using the Azure diagnostics integration with Azure Application Insights
...
## <a name="define-a-base-query"></a>Define a base query
...
## <a name="check-for-specific-event-ids"></a>Check for specific event IDs
...
## <a name="create-an-alert"></a>Create an alert
