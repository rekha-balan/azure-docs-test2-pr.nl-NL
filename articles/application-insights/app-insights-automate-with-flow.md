...
---
# <a name="automate-azure-application-insights-processes-with-the-connector-for-microsoft-flow"></a>Automate Azure Application Insights processes with the connector for Microsoft Flow
...
## <a name="create-a-flow-for-application-insights"></a>Create a flow for Application Insights
...
### <a name="step-6-configure-the-flow-to-send-email"></a>Step 6: Configure the flow to send email
...
### <a name="step-7-save-and-test-your-flow"></a>Step 7: Save and test your flow
