...
---
# <a name="start-analyzing-your-mobile-app-with-app-center-and-application-insights"></a>Start analyzing your mobile app with App Center and Application Insights
...
## <a name="onboard-to-app-center"></a>Onboard to App Center
...
## <a name="track-events-in-your-app"></a>Track events in your app
...
## <a name="export-to-application-insights"></a>Export to Application Insights
...
## <a name="start-monitoring-your-app"></a>Start monitoring your app
