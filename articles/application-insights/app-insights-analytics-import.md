...
---
# <a name="import-data-into-analytics"></a>Import data into Analytics
...
## <a name="define-your-schema"></a>Define your schema
...
### <a name="schema-definition-file-format"></a>Schema definition file format
...
### <a name="ingest-data"></a>Ingest data
