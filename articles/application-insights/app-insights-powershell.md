...
## <a name="to-get-the-instrumentation-key"></a>To get the instrumentation key
...
<a id="price"></a>
## <a name="set-the-price-plan"></a>Set the price plan
...
## <a name="add-a-metric-alert"></a>Add a metric alert
...
## <a name="add-an-availability-test"></a>Add an availability test
...
## <a name="add-more-resources"></a>Add more resources
