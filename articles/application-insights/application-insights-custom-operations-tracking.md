...
---
# <a name="track-custom-operations-with-application-insights-net-sdk"></a>Track custom operations with Application Insights .NET SDK
...
## <a name="incoming-operations-tracking"></a>Incoming operations tracking 
...
### <a name="http-request-in-owin-self-hosted-app"></a>HTTP request in Owin self-hosted app
...
## <a name="queue-instrumentation"></a>Queue instrumentation
...
### <a name="service-bus-queue"></a>Service Bus Queue
...
## <a name="long-running-background-tasks"></a>Long-running background tasks
...
## <a name="outgoing-dependencies-tracking"></a>Outgoing dependencies tracking
...
### <a name="parallel-operations-processing-and-tracking"></a>Parallel operations processing and tracking
