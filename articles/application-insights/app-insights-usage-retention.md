...
---
# <a name="user-retention-analysis-for-web-applications-with-application-insights"></a>User retention analysis for web applications with Application Insights
...
## <a name="the-retention-tool"></a>The Retention tool
...
## <a name="use-business-events-to-track-retention"></a>Use business events to track retention
