...
---
# <a name="create-custom-kpi-dashboards-using-azure-application-insights"></a>Create custom KPI dashboards using Azure Application Insights
...
## <a name="add-health-overview"></a>Add health overview
...
## <a name="add-custom-metric-chart"></a>Add custom metric chart
...
## <a name="add-analytics-query"></a>Add Analytics query
