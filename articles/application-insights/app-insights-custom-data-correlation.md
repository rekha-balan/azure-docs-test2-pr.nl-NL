...
---
# <a name="correlating-application-insights-data-with-custom-data-sources"></a>Correlating Application Insights data with custom data sources
...
## <a name="how-to-correlate-custom-data-with-application-insights-data"></a>How to correlate custom data with Application Insights data 
