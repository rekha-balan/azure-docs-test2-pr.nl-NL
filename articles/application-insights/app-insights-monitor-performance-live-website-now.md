...
## <a name="monitor-a-live-azure-web-app"></a>Monitor a live Azure web app
...
## <a name="monitor-a-live-iis-web-app"></a>Monitor a live IIS web app
...
## <a name="customize-monitoring-options"></a>Customize monitoring options
...
## <a name="when-you-re-publish-your-app-re-enable-application-insights"></a>When you re-publish your app, re-enable Application Insights
...
## <a name="troubleshooting-runtime-configuration-of-application-insights"></a>Troubleshooting runtime configuration of Application Insights

### <a name="cant-connect-no-telemetry"></a>Can't connect? No telemetry?
...
### <a name="when-do-i-use-status-monitor"></a>When do I use Status Monitor?
...
### <a name="can-i-close-it-after-it-runs"></a>Can I close it after it runs?
...
### <a name="what-does-status-monitor-do"></a>What does Status Monitor do?
...
### <a name="do-i-need-to-run-status-monitor-whenever-i-update-the-app"></a>Do I need to run Status Monitor whenever I update the app?
...
### <a name="what-telemetry-is-collected"></a>What telemetry is collected?
