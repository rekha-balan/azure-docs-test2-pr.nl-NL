...
---
# <a name="automate-custom-reports-with-azure-application-insights-data"></a>Automate custom reports with Azure Application Insights data
...
## <a name="to-automate-custom-report-emails"></a>To automate custom report emails
...
## <a name="sample-query-for-a-weekly-digest-email"></a>Sample query for a weekly digest email
...
## <a name="application-insights-scheduled-digest-report"></a>Application Insights scheduled digest report
...
## <a name="sendgrid-with-azure"></a>SendGrid with Azure
