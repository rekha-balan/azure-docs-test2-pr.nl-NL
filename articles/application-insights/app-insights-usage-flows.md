...
---
# <a name="analyze-user-navigation-patterns-with-user-flows-in-application-insights"></a>Analyze user navigation patterns with User Flows in Application Insights
...
## <a name="start-by-choosing-an-initial-event"></a>Start by choosing an initial event
...
## <a name="after-visiting-a-page-or-feature-where-do-users-go-and-what-do-they-click"></a>After visiting a page or feature, where do users go and what do they click?
...
## <a name="where-are-the-places-that-users-churn-most-from-your-site"></a>Where are the places that users churn most from your site?
...
## <a name="are-there-places-where-users-repeat-the-same-action-over-and-over"></a>Are there places where users repeat the same action over and over?
...
### <a name="does-the-initial-event-represent-the-first-time-the-event-appears-in-a-session-or-any-time-it-appears-in-a-session"></a>Does the initial event represent the first time the event appears in a session, or any time it appears in a session?
...
### <a name="some-of-the-nodes-in-my-visualization-are-too-high-level-for-example-a-node-that-just-says-button-clicked-how-can-i-break-it-down-into-more-detailed-nodes"></a>Some of the nodes in my visualization are too high-level. For example, a node that just says “Button Clicked.” How can I break it down into more detailed nodes?
