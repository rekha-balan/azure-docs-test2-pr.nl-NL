...
## <a name="plan-resources-and-resource-groups"></a>Plan resources and resource groups
...
### <a name="resources-for-components"></a>Resources for components
...
### <a name="separating-development-test-and-production"></a>Separating development, test, and production
...
## <a name="set-up-azure-diagnostics-for-each-role"></a>Set up Azure Diagnostics for each role
...
## <a name="display-everything-together"></a>Display everything together
