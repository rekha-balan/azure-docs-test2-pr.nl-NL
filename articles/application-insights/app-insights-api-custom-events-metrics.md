...
## <a name="constructing-a-telemetryclient-instance"></a>Constructing a TelemetryClient instance
...
## <a name="send-metrics"></a>Send metrics
...
```
### <a name="custom-metrics-in-metrics-explorer"></a>Custom metrics in Metrics Explorer
...
### <a name="custom-metrics-in-analytics"></a>Custom metrics in Analytics
