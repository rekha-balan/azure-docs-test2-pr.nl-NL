...
---
# <a name="impact-analysis-with-application-insights"></a>Impact analysis with Application Insights
...
## <a name="still-not-sure-what-impact-does"></a>Still not sure what Impact does?
...
## <a name="is-page-load-time-impacting-how-many-people-convert-on-my-page"></a>Is page load time impacting how many people convert on my page?
...
## <a name="what-if-im-tracking-page-views-or-load-times-in-custom-ways"></a>What if I’m tracking page views or load times in custom ways?
...
## <a name="do-users-from-different-countries-or-regions-convert-at-different-rates"></a>Do users from different countries or regions convert at different rates?
...
## <a name="how-does-the-impact-tool-calculate-these-conversion-rates"></a>How does the Impact tool calculate these conversion rates?
