...
---
# <a name="investigate-and-share-usage-data-with-interactive-workbooks-in-application-insights"></a>Investigate and share usage data with interactive workbooks in Application Insights
...
## <a name="editing-rearranging-cloning-and-deleting-workbook-sections"></a>Editing, rearranging, cloning, and deleting workbook sections
...
## <a name="adding-usage-data-visualization-sections"></a>Adding usage data visualization sections
...
## <a name="adding-application-insights-analytics-sections"></a>Adding Application Insights Analytics sections
...
## <a name="adding-text-and-markdown-sections"></a>Adding text and Markdown sections
...
## <a name="saving-and-sharing-workbooks-with-your-team"></a>Saving and sharing workbooks with your team
