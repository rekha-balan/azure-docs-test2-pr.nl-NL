...
---
# <a name="telemetry-correlation-in-application-insights"></a>Telemetry correlation in Application Insights
...
## <a name="telemetry-correlation-data-model"></a>Telemetry correlation data model
...
## <a name="correlation-headers"></a>Correlation headers
...
## <a name="open-tracing-and-application-insights"></a>Open tracing and Application Insights
...
## <a name="telemetry-correlation-in-net"></a>Telemetry correlation in .NET
...
## <a name="telemetry-correlation-in-the-java-sdk"></a>Telemetry correlation in the Java SDK
