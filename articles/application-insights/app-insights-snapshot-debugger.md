...
---
# <a name="debug-snapshots-on-exceptions-in-net-apps"></a>Debug snapshots on exceptions in .NET apps
...
### <a name="configure-snapshot-collection-for-aspnet-applications"></a>Configure snapshot collection for ASP.NET applications
...
### <a name="configure-snapshot-collection-for-aspnet-core-20-applications"></a>Configure snapshot collection for ASP.NET Core 2.0 applications
...
### <a name="configure-snapshot-collection-for-other-net-applications"></a>Configure snapshot collection for other .NET applications
...
## <a name="grant-permissions"></a>Grant permissions
...
## <a name="debug-snapshots-in-the-application-insights-portal"></a>Debug snapshots in the Application Insights portal
...
## <a name="debug-snapshots-with-visual-studio-2017-enterprise"></a>Debug snapshots with Visual Studio 2017 Enterprise
...
## <a name="how-snapshots-work"></a>How snapshots work
...
### <a name="publish-symbols"></a>Publish symbols
...
### <a name="optimized-builds"></a>Optimized builds
...
### <a name="use-the-snapshot-health-check"></a>Use the snapshot health check
...
### <a name="verify-the-instrumentation-key"></a>Verify the instrumentation key
...
### <a name="upgrade-to-the-latest-version-of-the-nuget-package"></a>Upgrade to the latest version of the NuGet package
...
### <a name="check-the-uploader-logs"></a>Check the uploader logs
...
### <a name="troubleshooting-cloud-services"></a>Troubleshooting Cloud Services
...
### <a name="overriding-the-shadow-copy-folder"></a>Overriding the Shadow Copy folder
...
### <a name="use-application-insights-search-to-find-exceptions-with-snapshots"></a>Use Application Insights search to find exceptions with snapshots
...
### <a name="edit-network-proxy-or-firewall-rules"></a>Edit network proxy or firewall rules
