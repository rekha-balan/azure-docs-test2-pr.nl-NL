...
---
# <a name="preview-upcoming-changes-to-azure-application-insights"></a>Preview upcoming changes to Azure Application Insights 
...
## <a name="set-preferences"></a>Set preferences
