...
---
# <a name="backup-guide-for-sap-hana-on-azure-virtual-machines"></a>Backup guide for SAP HANA on Azure Virtual Machines
...
_No, currently you can only take data and log backups on the primary side. If automatic log backup is enabled, after takeover to the secondary side, the log backups will automatically be written there.&quot;_

## <a name="sap-resources-for-hana-backup"></a>SAP resources for HANA backup

### <a name="sap-hana-backup-documentation"></a>SAP HANA backup documentation
...
### <a name="why-sap-hana-backup"></a>Why SAP HANA backup?
...
### <a name="how-to-verify-correctness-of-sap-hana-backup"></a>How to verify correctness of SAP HANA backup
...
### <a name="pros-and-cons-of-hana-backup-versus-storage-snapshot"></a>Pros and cons of HANA backup versus storage snapshot
...
### <a name="sap-hana-data-consistency-when-taking-storage-snapshots"></a>SAP HANA data consistency when taking storage snapshots
...
### <a name="sap-hana-backup-scheduling-strategy"></a>SAP HANA backup scheduling strategy
...
### <a name="sap-hana-configuration-files"></a>SAP HANA configuration files
...
### <a name="sap-hana-backup-encryption"></a>SAP HANA backup encryption
...
### <a name="test-virtual-machine-on-azure"></a>Test Virtual Machine on Azure
...
### <a name="test-backup-size"></a>Test backup size
...
### <a name="test-tool-to-copy-files-directly-to-azure-storage"></a>Test tool to copy files directly to Azure storage
...
### <a name="test-backup-size-estimation"></a>Test backup size estimation
...
### <a name="test-hana-backup-file-size"></a>Test HANA backup file size
