...
---
# <a name="deploy-sap-ides-ehp7-sp3-for-sap-erp-60-on-azure"></a>Deploy SAP IDES EHP7 SP3 for SAP ERP 6.0 on Azure
...
### <a name="create-an-account-in-the-sap-cal"></a>Create an account in the SAP CAL
