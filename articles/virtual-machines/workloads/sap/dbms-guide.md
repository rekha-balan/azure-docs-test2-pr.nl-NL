...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>SAP NetWeaver on Azure Virtual Machines – DBMS Deployment Guide
...
* 3rd party tools FOr a more complete discussion of Backup and SAP on Azure, please refer to [the SAP Backup Guide](sap-hana-backup-guide.md) for more information.
