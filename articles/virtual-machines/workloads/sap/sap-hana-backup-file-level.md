...
---
# <a name="sap-hana-azure-backup-on-file-level"></a>SAP HANA Azure Backup on file level
...
## <a name="azure-blobxfer-utility-details"></a>Azure blobxfer utility details
...
## <a name="sap-hana-backup-performance"></a>SAP HANA backup performance
...
## <a name="copy-sap-hana-backup-files-to-azure-blob-storage"></a>Copy SAP HANA backup files to Azure blob storage
...
## <a name="blob-copy-of-dedicated-azure-data-disks-in-backup-software-raid"></a>Blob copy of dedicated Azure data disks in backup software RAID
...
## <a name="copy-sap-hana-backup-files-to-nfs-share"></a>Copy SAP HANA backup files to NFS share
...
## <a name="copy-sap-hana-backup-files-to-azure-file-service"></a>Copy SAP HANA backup files to Azure file service
