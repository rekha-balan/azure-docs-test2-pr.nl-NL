...
---
# <a name="using-azure-for-hosting-and-running-sap-workload-scenarios"></a>Using Azure for hosting and running SAP workload scenarios
...
## <a name="latest-changes"></a>Latest Changes
...
## <a name="sap-hana-on-sap-hana-on-azure-large-instances"></a>SAP HANA on SAP HANA on Azure (Large Instances)
