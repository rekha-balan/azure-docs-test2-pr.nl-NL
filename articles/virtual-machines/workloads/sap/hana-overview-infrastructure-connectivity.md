...
---
# <a name="sap-hana-large-instances-infrastructure-and-connectivity-on-azure"></a>SAP HANA (large instances) infrastructure and connectivity on Azure 
...
## <a name="creating-an-azure-vnet"></a>Creating an Azure VNet
...
## <a name="creating-a-gateway-subnet"></a>Creating a gateway subnet
...
## <a name="linking-vnets"></a>Linking VNets
...
## <a name="adding-more-ip-addresses-or-subnets"></a>Adding more IP addresses or subnets
...
## <a name="adding-vnets"></a>Adding VNets
...
## <a name="increasing-expressroute-circuit-bandwidth"></a>Increasing ExpressRoute circuit bandwidth
...
## <a name="adding-an-additional-expressroute-circuit"></a>Adding an additional ExpressRoute circuit
...
## <a name="deleting-a-subnet"></a>Deleting a subnet
...
## <a name="deleting-a-vnet"></a>Deleting a VNet
...
## <a name="deleting-an-expressroute-circuit"></a>Deleting an ExpressRoute circuit
