...
---
# <a name="how-to-troubleshoot-and-monitor-sap-hana-large-instances-on-azure"></a>How to troubleshoot and monitor SAP HANA (large instances) on Azure


## <a name="monitoring-in-sap-hana-on-azure-large-instances"></a>Monitoring in SAP HANA on Azure (Large Instances)
...
## <a name="monitoring-and-troubleshooting-from-hana-side"></a>Monitoring and troubleshooting from HANA side
...
- You can check if Transparent Huge Pages are enabled through the following Linux command: **cat /sys/kernel/mm/transparent\_hugepage/enabled**
...
![Another example is right-clicking on the statements under Replication: Overview. Select Execute from the context menu](https://docstestmedia1.blob.core.windows.net/azure-media/articles/virtual-machines/workloads/sap/media/troubleshooting-monitoring/image9-import-statements-c.png)
...
![HANA\_Services\_Statistics for SAP HANA service information ](https://docstestmedia1.blob.core.windows.net/azure-media/articles/virtual-machines/workloads/sap/media/troubleshooting-monitoring/image13-services-statistics.png)
