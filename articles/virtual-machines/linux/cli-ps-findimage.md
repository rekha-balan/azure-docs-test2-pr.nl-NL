...
---
# <a name="how-to-find-linux-vm-images-in-the-azure-marketplace-with-the-azure-cli"></a>How to find Linux VM images in the Azure Marketplace with the Azure CLI
...
## <a name="list-popular-images"></a>List popular images
...
## <a name="find-specific-images"></a>Find specific images
...
## <a name="navigate-the-images"></a>Navigate the images 
...
### <a name="view-plan-properties"></a>View plan properties
...
### <a name="accept-the-terms"></a>Accept the terms
...
### <a name="deploy-using-purchase-plan-parameters"></a>Deploy using purchase plan parameters
