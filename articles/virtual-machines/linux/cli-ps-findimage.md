...
---
# <a name="how-to-find-linux-vm-images-with-the-azure-cli"></a>How to find Linux VM images with the Azure CLI
...
### <a name="finding-all-current-images"></a>Finding all current images
...
## <a name="use-azure-cli-10"></a>Use Azure CLI 1.0 
