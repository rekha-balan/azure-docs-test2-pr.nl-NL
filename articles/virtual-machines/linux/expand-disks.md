...
---
# <a name="how-to-expand-virtual-hard-disks-on-a-linux-vm-with-the-azure-cli-20"></a>How to expand virtual hard disks on a Linux VM with the Azure CLI 2.0
...
## <a name="expand-managed-disk"></a>Expand managed disk
