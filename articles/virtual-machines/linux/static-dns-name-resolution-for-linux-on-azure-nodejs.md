...
---
# <a name="using-internal-dns-for-vm-name-resolution-on-azure"></a>Using internal DNS for VM name resolution on Azure
...
### <a name="create-a-vnic-with-a-static-internal-dns-name"></a>Create a VNic with a static internal DNS name
...
### <a name="deploy-the-vm-into-the-vnet-nsg-and-connect-the-vnic"></a>Deploy the VM into the VNet, NSG and, connect the VNic
...
## <a name="creating-static-dns-names"></a>Creating static DNS names
