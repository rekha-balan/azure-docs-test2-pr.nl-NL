...
---
# <a name="manage-linux-virtual-machines-with-the-azure-cli"></a>Manage Linux virtual machines with the Azure CLI
...
## <a name="step-2--create-resource-group"></a>Step 2 – Create resource group
...
## <a name="step-3---prepare-configuration"></a>Step 3 - Prepare configuration
...
## <a name="step-4---create-virtual-machine"></a>Step 4 - Create virtual machine
...
## <a name="step-5--configure-firewall"></a>Step 5 – Configure firewall
...
### <a name="create-nsg-rule"></a>Create NSG rule
...
## <a name="step-6--snapshot-virtual-machine"></a>Step 6 – Snapshot virtual machine
...
### <a name="create-disk-from-snapshot"></a>Create disk from snapshot
...
### <a name="restore-virtual-machine-from-snapshot"></a>Restore virtual machine from snapshot
...
### <a name="reconfigure-data-disk"></a>Reconfigure data disk
...
## <a name="step-7--management-tasks"></a>Step 7 – Management tasks
...
### <a name="get-ip-address"></a>Get IP address
...
### <a name="resize-virtual-machine"></a>Resize virtual machine
...
### <a name="stop-virtual-machine"></a>Stop virtual machine

```azurecli
az vm stop --resource-group myResourceGroup --name myVM
```

### <a name="start-virtual-machine"></a>Start virtual machine
