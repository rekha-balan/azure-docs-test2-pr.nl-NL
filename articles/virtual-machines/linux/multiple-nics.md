...
---
# <a name="how-to-create-a-linux-virtual-machine-in-azure-with-multiple-network-interface-cards"></a>How to create a Linux virtual machine in Azure with multiple network interface cards
...
## <a name="add-a-nic-to-a-vm"></a>Add a NIC to a VM
...
## <a name="remove-a-nic-from-a-vm"></a>Remove a NIC from a VM
...
## <a name="configure-guest-os-for-multiple-nics"></a>Configure guest OS for multiple NICs
