...
---
# <a name="detailed-walk-through-to-create-an-ssh-key-pair-and-additional-certificates-for-a-linux-vm-in-azure"></a>Detailed walk through to create an SSH key pair and additional certificates for a Linux VM in Azure
...
## <a name="understanding-ssh-keys"></a>Understanding SSH keys
...
## <a name="ssh-keys-use-and-benefits"></a>SSH keys use and benefits
...
## <a name="classic-portal-and-x509-certs"></a>Classic portal and X.509 certs
...
## <a name="classic-deploy-using-asm"></a>Classic deploy using `asm`
...
## <a name="using-ssh-copy-id-to-copy-the-key-to-an-existing-vm"></a>Using `ssh-copy-id` to copy the key to an existing VM
