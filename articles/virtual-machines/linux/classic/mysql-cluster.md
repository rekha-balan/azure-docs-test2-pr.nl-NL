...
---
# <a name="use-load-balanced-sets-to-clusterize-mysql-on-linux"></a>Use load-balanced sets to clusterize MySQL on Linux
> [!IMPORTANT]
...
### <a name="set-up-drbd"></a>Set up DRBD
...
### <a name="mount-the-drbd-resource"></a>Mount the DRBD resource
...
## <a name="set-up-mysql"></a>Set up MySQL
...
### <a name="create-the-mysql-load-balanced-set"></a>Create the MySQL load-balanced set
...
### <a name="test-the-load-balanced-set"></a>Test the load-balanced set
...
## <a name="set-up-corosync"></a>Set up Corosync
...
## <a name="set-up-pacemaker"></a>Set up Pacemaker
