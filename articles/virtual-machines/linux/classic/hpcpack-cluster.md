...
---
# <a name="get-started-with-linux-compute-nodes-in-an-hpc-pack-cluster-in-azure"></a>Get started with Linux compute nodes in an HPC Pack cluster in Azure
...
## <a name="deploy-an-hpc-pack-cluster-with-linux-compute-nodes"></a>Deploy an HPC Pack cluster with Linux compute nodes
...
### <a name="deployment-option-1-use-a-resource-manager-template"></a>Deployment option 1. Use a Resource Manager template
...
### <a name="deployment-option-2-use-the-iaas-deployment-script"></a>Deployment option 2. Use the IaaS deployment script
...
## <a name="connect-to-the-head-node"></a>Connect to the head node
...
## <a name="how-to-move-data-in-a-cluster-with-linux-nodes"></a>How to move data in a cluster with Linux nodes
...
### <a name="head-node-share"></a>Head node share
...
## <a name="how-to-submit-jobs"></a>How to submit jobs
...
## <a name="clusrun-for-linux-nodes"></a>Clusrun for Linux nodes
