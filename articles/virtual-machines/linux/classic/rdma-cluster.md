...
## <a name="sample-deployment-steps-in-the-classic-model"></a>Sample deployment steps in the classic model
...
### <a name="provision-an-sles-12-sp1-hpc-vm"></a>Provision an SLES 12 SP1 HPC VM
...
### <a name="customize-the-vm"></a>Customize the VM
...
### <a name="capture-the-image"></a>Capture the image
...
### <a name="deploy-a-cluster-with-the-image"></a>Deploy a cluster with the image
...
### <a name="run-an-mpi-command"></a>Run an MPI command
