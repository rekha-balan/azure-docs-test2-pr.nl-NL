...
---
# <a name="run-a-cassandra-cluster-on-linux-in-azure-with-nodejs"></a>Run a Cassandra cluster on Linux in Azure with Node.js
...
Use the following command sequence: The following command installs jna-3.2.7.jar and jna-platform-3.2.7.jar to /usr/share.java directory sudo apt-get install libjna-java
...
##### <a name="2-shut-down-the-vm"></a>2: Shut down the VM
...
**Step 1: Create the Virtual Network** Log into the Azure portal and create a virtual network (classic) with the attributes shown in the following table. See [Create a virtual network (classic) using the Azure portal](../../../virtual-network/virtual-networks-create-vnet-classic-pportal.md) for detailed steps of the process.      
...
**Step 2: Provision Virtual Machines** Using the image created previously, you create the following virtual machines in the cloud server “hk-c-svc-west” and bind them to the respective subnets as shown below:
