...
---
# <a name="tutorial-create-a-virtual-machine-scale-set-and-deploy-a-highly-available-app-on-linux-with-the-azure-cli-20"></a>Tutorial: Create a virtual machine scale set and deploy a highly available app on Linux with the Azure CLI 2.0
...
## <a name="scale-set-overview"></a>Scale Set overview
...
## <a name="create-an-app-to-scale"></a>Create an app to scale
...
## <a name="create-a-scale-set"></a>Create a scale set
...
## <a name="allow-web-traffic"></a>Allow web traffic
...
## <a name="management-tasks"></a>Management tasks
...
### <a name="view-vms-in-a-scale-set"></a>View VMs in a scale set
...
### <a name="manually-increase-or-decrease-vm-instances"></a>Manually increase or decrease VM instances
...
## <a name="use-data-disks-with-scale-sets"></a>Use data disks with scale sets
...
### <a name="create-scale-set-with-data-disks"></a>Create scale set with data disks
...
### <a name="add-data-disks"></a>Add data disks
...
### <a name="detach-data-disks"></a>Detach data disks
