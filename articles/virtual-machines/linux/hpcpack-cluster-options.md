...
---
# <a name="options-with-hpc-pack-to-create-and-manage-a-cluster-for-linux-hpc-workloads-in-azure"></a>Options with HPC Pack to create and manage a cluster for Linux HPC workloads in Azure
...
## <a name="hpc-pack-2012-r2-cluster-in-classic-deployment-model"></a>HPC Pack 2012 R2 cluster in classic deployment model
...
## <a name="job-submisssion"></a>Job submisssion
