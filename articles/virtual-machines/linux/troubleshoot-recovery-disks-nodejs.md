...
---
# <a name="troubleshoot-a-linux-vm-by-attaching-the-os-disk-to-a-recovery-vm-using-the-azure-cli-10"></a>Troubleshoot a Linux VM by attaching the OS disk to a recovery VM using the Azure CLI 1.0
