...
---
# <a name="convert-an-existing-azure-virtual-machine-to-a-scale-set"></a>Convert an existing Azure virtual machine to a scale set
...
## <a name="step-1---deprovision-the-vm"></a>Step 1 - Deprovision the VM
...
## <a name="step-2---capture-an-image-of-the-vm"></a>Step 2 - Capture an image of the VM
...
## <a name="step-3---create-the-scale-set"></a>Step 3 - Create the scale set
...
## <a name="step-4---initialize-the-data-disk"></a>Step 4 - Initialize the data disk
...
## <a name="step-6---automate-configuration"></a>Step 6 - Automate configuration
...
## <a name="step-7---configure-autoscale-rules"></a>Step 7 - Configure autoscale rules

Currently, autoscale rules cannot be set in Azure CLI. Use the [Azure portal](https://portal.azure.com) to configure autoscale.

## <a name="step-8---management-tasks"></a>Step 8 - Management tasks
...
### <a name="set-instance-count-manual-scale"></a>Set instance count (manual scale)
