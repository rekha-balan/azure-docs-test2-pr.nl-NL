...
---
# <a name="application-architecture-with-azure-resource-manager-templates-for-linux-vms"></a>Application architecture with Azure Resource Manager templates for Linux VMs
