...
---
# <a name="how-to-create-an-image-of-a-virtual-machine-or-vhd"></a>How to create an image of a virtual machine or VHD
...
## <a name="step-2-create-vm-image"></a>Step 2: Create VM image
...
### <a name="creating-the-vm-in-another-resource-group"></a>Creating the VM in another resource group 
...
## <a name="step-4-verify-the-deployment"></a>Step 4: Verify the deployment
