...
---
# <a name="set-up-gpu-drivers-for-n-series-vms-running-linux"></a>Set up GPU drivers for N-series VMs running Linux
...
## <a name="install-nvidia-cuda-drivers"></a>Install NVIDIA CUDA drivers
...
## <a name="cuda-driver-updates"></a>CUDA driver updates
