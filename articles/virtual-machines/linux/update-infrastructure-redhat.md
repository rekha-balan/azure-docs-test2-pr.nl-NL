...
---
# <a name="red-hat-update-infrastructure-for-on-demand-red-hat-enterprise-linux-vms-in-azure"></a>Red Hat Update Infrastructure for on-demand Red Hat Enterprise Linux VMs in Azure
...
## <a name="important-information-about-azure-rhui"></a>Important information about Azure RHUI
...
### <a name="the-ips-for-the-rhui-content-delivery-servers"></a>The IPs for the RHUI content delivery servers
...
### <a name="troubleshoot-connection-problems-to-azure-rhui"></a>Troubleshoot connection problems to Azure RHUI
...
### <a name="manual-update-procedure-to-use-the-azure-rhui-servers"></a>Manual update procedure to use the Azure RHUI servers
