...
---
# <a name="how-to-use-freebsds-packet-filter-to-create-a-secure-firewall-in-azure"></a>How to use FreeBSD's Packet Filter to create a secure firewall in Azure
...
## <a name="what-is-pf"></a>What is PF?
...
### <a name="deploy-through-azure-cli"></a>Deploy through Azure CLI
