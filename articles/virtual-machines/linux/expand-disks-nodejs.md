...
---
# <a name="expand-os-disk-on-a-linux-vm-using-the-azure-cli-with-the-azure-cli-10"></a>Expand OS disk on a Linux VM using the Azure CLI with the Azure CLI 1.0
...
## <a name="expand-os-disk"></a>Expand OS disk
