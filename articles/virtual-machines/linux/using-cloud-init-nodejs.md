...
---
# <a name="use-cloud-init-to-customize-a-linux-vm-during-creation-with-the-azure-cli-10"></a>Use cloud-init to customize a Linux VM during creation with the Azure CLI 1.0
