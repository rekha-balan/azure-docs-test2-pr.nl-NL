...
---
# <a name="application-deployment-with-azure-resource-manager-templates-for-linux-vms"></a>Application deployment with Azure Resource Manager templates for Linux VMs
