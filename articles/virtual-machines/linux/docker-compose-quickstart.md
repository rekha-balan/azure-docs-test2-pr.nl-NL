...
## <a name="set-up-a-linux-vm-as-a-docker-host"></a>Set up a Linux VM as a Docker host
...
### <a name="create-docker-host-with-azure-cli-20"></a>Create Docker host with Azure CLI 2.0
...
## <a name="verify-that-compose-is-installed"></a>Verify that Compose is installed
...
## <a name="create-a-docker-composeyml-configuration-file"></a>Create a docker-compose.yml configuration file
...
## <a name="start-the-containers-with-compose"></a>Start the containers with Compose
