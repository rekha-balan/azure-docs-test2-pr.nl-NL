...
---
# <a name="open-ports-and-endpoints-to-a-linux-vm-with-the-azure-cli"></a>Open ports and endpoints to a Linux VM with the Azure CLI
...
## <a name="quickly-open-a-port-for-a-vm"></a>Quickly open a port for a VM
...
## <a name="apply-network-security-group-to-vm"></a>Apply Network Security Group to VM
