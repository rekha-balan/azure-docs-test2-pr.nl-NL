...
---
# <a name="cloud-init-support-for-virtual-machines-in-azure"></a>Cloud-init support for virtual machines in Azure
...
## <a name="cloud-init-overview"></a>Cloud-init overview
...
## <a name="what-is-the-difference-between-cloud-init-and-the-linux-agent-wala"></a>What is the difference between cloud-init and the Linux Agent (WALA)?
...
## <a name="deploying-a-cloud-init-enabled-virtual-machine"></a>Deploying a cloud-init enabled Virtual Machine
...
## <a name="troubleshooting-cloud-init"></a>Troubleshooting cloud-init
