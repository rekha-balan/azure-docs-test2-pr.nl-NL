...
---
# <a name="use-cloud-init-to-customize-a-linux-vm-during-creation"></a>Use cloud-init to customize a Linux VM during creation
...
## <a name="add-a-cloud-init-script-to-the-vm-creation-with-the-azure-cli"></a>Add a cloud-init script to the VM creation with the Azure CLI
...
## <a name="create-a-cloud-init-script-to-set-the-hostname-of-a-linux-vm"></a>Create a cloud-init script to set the hostname of a Linux VM
...
## <a name="create-a-cloud-init-script-to-update-linux"></a>Create a cloud-init script to update Linux
...
## <a name="create-a-cloud-init-script-to-add-a-user-to-linux"></a>Create a cloud-init script to add a user to Linux
