...
---
# <a name="build-a-load-balanced-highly-available-application-on-linux-virtual-machines-in-azure"></a>Build a load balanced, highly available application on Linux virtual machines in Azure
...
## <a name="step-1---azure-prerequisites"></a>Step 1 - Azure prerequisites
...
## <a name="step-2---create-availability-set"></a>Step 2 - Create availability set
...
## <a name="step-3---create-load-balancer"></a>Step 3 - Create load balancer
...
## <a name="step-4---configure-networking"></a>Step 4 - Configure networking
...
### <a name="configure-network-security"></a>Configure network security
...
### <a name="create-virtual-network-interface-cards"></a>Create virtual network interface cards 
...
## <a name="step-5---build-your-app"></a>Step 5 - Build your app
...
## <a name="step-6---create-virtual-machines"></a>Step 6 - Create virtual machines
...
### <a name="remove-a-vm-from-the-load-balancer"></a>Remove a VM from the load balancer
...
### <a name="add-a-vm-to-the-load-balancer"></a>Add a VM to the load balancer
