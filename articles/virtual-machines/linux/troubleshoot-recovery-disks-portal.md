...
---
# <a name="troubleshoot-a-linux-vm-by-attaching-the-os-disk-to-a-recovery-vm-using-the-azure-portal"></a>Troubleshoot a Linux VM by attaching the OS disk to a recovery VM using the Azure portal
...
## <a name="troubleshoot-a-managed-disk-vm-by-attaching-a-new-os-disk"></a>Troubleshoot a Managed Disk VM by attaching a new OS disk
