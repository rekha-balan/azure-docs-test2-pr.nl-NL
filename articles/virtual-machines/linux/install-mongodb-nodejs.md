...
---
# <a name="how-to-install-and-configure-mongodb-on-a-linux-vm-using-the-azure-cli-10"></a>How to install and configure MongoDB on a Linux VM using the Azure CLI 1.0
