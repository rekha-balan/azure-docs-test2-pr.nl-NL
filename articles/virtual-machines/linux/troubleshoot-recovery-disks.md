...
---
# <a name="troubleshoot-a-linux-vm-by-attaching-the-os-disk-to-a-recovery-vm-with-the-azure-cli-20"></a>Troubleshoot a Linux VM by attaching the OS disk to a recovery VM with the Azure CLI 2.0
