...
## <a name="get-the-storage-key"></a>Get the storage key
...
## <a name="create-a-mount-point"></a>Create a mount point
...
## <a name="mount-the-share"></a>Mount the share
...
## <a name="persist-the-mount"></a>Persist the mount
