...
---
# <a name="manage-users-ssh-and-check-or-repair-disks-on-linux-vms-using-the-vmaccess-extension-with-the-azure-cli-20"></a>Manage users, SSH, and check or repair disks on Linux VMs using the VMAccess Extension with the Azure CLI 2.0
...
## <a name="ways-to-use-the-vmaccess-extension"></a>Ways to use the VMAccess Extension
...
## <a name="reset-ssh-key"></a>Reset SSH key
...
## <a name="deletes-a-user"></a>Deletes a user
...
## <a name="use-json-files-and-the-vmaccess-extension"></a>Use JSON files and the VMAccess Extension
...
### <a name="reset-user-access"></a>Reset user access
...
### <a name="check-or-repair-the-disk"></a>Check or repair the disk
