...
---
# <a name="application-deployment-with-azure-resource-manager-templates-for-windows-vms"></a>Application deployment with Azure Resource Manager templates for Windows VMs
