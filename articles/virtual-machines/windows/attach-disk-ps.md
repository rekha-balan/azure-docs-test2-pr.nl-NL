...
---
# <a name="attach-a-data-disk-to-a-windows-vm-using-powershell"></a>Attach a data disk to a Windows VM using PowerShell
...
## <a name="add-an-empty-data-disk-to-a-virtual-machine"></a>Add an empty data disk to a virtual machine

This example shows how to add an empty data disk to an existing virtual machine.

### <a name="using-managed-disks"></a>Using managed disks
...
### <a name="using-unmanaged-disks-in-a-storage-account"></a>Using unmanaged disks in a storage account
