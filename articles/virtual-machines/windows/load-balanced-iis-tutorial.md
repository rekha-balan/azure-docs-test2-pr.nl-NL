...
---
# <a name="build-a-load-balanced-highly-available-application-on-windows-virtual-machines-in-azure"></a>Build a load balanced, highly available application on Windows virtual machines in Azure
...
### <a name="create-load-balancer-rule"></a>Create load balancer rule
...
## <a name="step-5---create-virtual-machines"></a>Step 5 - Create virtual machines
