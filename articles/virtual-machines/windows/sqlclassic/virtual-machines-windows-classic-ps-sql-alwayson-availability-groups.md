...
---
# <a name="configure-the-always-on-availability-group-on-an-azure-vm-with-powershell"></a>Configure the Always On availability group on an Azure VM with PowerShell
...
## <a name="initialize-the-failover-cluster-vms"></a>Initialize the failover cluster VMs
