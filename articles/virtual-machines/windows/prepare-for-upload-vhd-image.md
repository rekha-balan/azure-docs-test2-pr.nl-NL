...
---
# <a name="prepare-a-windows-vhd-or-vhdx-to-upload-to-azure"></a>Prepare a Windows VHD or VHDX to upload to Azure
...
## <a name="convert-the-virtual-disk-to-vhd-and-fixed-size-disk"></a>Convert the virtual disk to VHD and fixed size disk 
...
### <a name="convert-disk-using-hyper-v-manager"></a>Convert disk using Hyper-V Manager
...
### <a name="convert-disk-using-powershell"></a>Convert disk using PowerShell
...
## <a name="set-windows-configurations-for-azure"></a>Set Windows configurations for Azure
...
## <a name="set-services-startup-to-windows-default-values"></a>Set services startup to Windows default values
...
## <a name="update-remote-desktop-registry-settings"></a>Update Remote Desktop registry settings
...
## <a name="verify-vm-is-healthy-secure-and-accessible-with-rdp"></a>Verify VM is healthy, secure, and accessible with RDP 
...
## <a name="complete-recommended-configurations"></a>Complete recommended configurations
