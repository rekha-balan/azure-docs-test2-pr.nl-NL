...
---
# <a name="navigate-and-select-windows-virtual-machine-images-in-azure-with-powershell"></a>Navigate and select Windows virtual machine images in Azure with PowerShell
...
## <a name="find-azure-images-with-powershell"></a>Find Azure images with PowerShell
> [!NOTE]
