...
---
# <a name="install-mysql-on-a-virtual-machine-created-with-the-classic-deployment-model-running-windows-server-2016"></a>Install MySQL on a virtual machine created with the classic deployment model running Windows Server 2016
...
## <a name="create-a-virtual-machine-running-windows-server-2016"></a>Create a virtual machine running Windows Server 2016
