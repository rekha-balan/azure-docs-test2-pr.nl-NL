...
---
# <a name="create-a-windows-virtual-machine-with-powershell-and-the-classic-deployment-model"></a>Create a Windows virtual machine with PowerShell and the classic deployment model
...
## <a name="step-3-determine-the-imagefamily"></a>Step 3: Determine the ImageFamily
...
## <a name="step-4-build-your-command-set"></a>Step 4: Build your command set
...
## <a name="step-5-run-your-command-set"></a>Step 5: Run your command set
