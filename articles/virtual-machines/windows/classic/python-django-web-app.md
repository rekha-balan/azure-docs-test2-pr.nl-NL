...
2. Instruct Azure to direct port 80 traffic from the web to port 80 on the virtual machine:
   ...
   * Click the **ADD** button at the bottom of the screen.
     ![add endpoint](https://docstestmedia1.blob.core.windows.net/azure-media/articles/virtual-machines/windows/classic/media/python-django-web-app/django-helloworld-addendpoint.png)
