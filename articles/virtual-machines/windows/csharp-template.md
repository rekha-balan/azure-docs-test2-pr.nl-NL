...
## <a name="step-1-create-a-visual-studio-project"></a>Step 1: Create a Visual Studio project
...
## <a name="step-2-install-libraries"></a>Step 2: Install libraries
...
## <a name="step-3-create-credentials-used-to-authenticate-requests"></a>Step 3: Create credentials used to authenticate requests
...
## <a name="step-5-create-a-parameters-file"></a>Step 5: Create a parameters file
...
## <a name="step-6-deploy-a-template"></a>Step 6: Deploy a template
...
## <a name="step-7-delete-the-resources"></a>Step 7: Delete the resources
...
## <a name="step-8-run-the-console-application"></a>Step 8: Run the console application
