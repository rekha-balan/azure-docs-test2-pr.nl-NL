...
---
# <a name="virtual-machine-extensions-and-features-for-windows"></a>Virtual machine extensions and features for Windows
...
## <a name="use-cases-and-samples"></a>Use cases and samples
...
## <a name="run-vm-extensions"></a>Run VM extensions
...
## <a name="secure-vm-extension-data"></a>Secure VM extension data
...
## <a name="troubleshoot-vm-extensions"></a>Troubleshoot VM extensions
...
### <a name="view-extension-status"></a>View extension status
...
### <a name="rerun-vm-extensions"></a>Rerun VM extensions
...
## <a name="common-vm-extensions-reference"></a>Common VM extensions reference
