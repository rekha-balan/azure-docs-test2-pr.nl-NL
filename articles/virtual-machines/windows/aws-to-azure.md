...
---
# <a name="migrate-from-amazon-web-services-aws-to-azure-managed-disks"></a>Migrate from Amazon Web Services (AWS) to Azure Managed Disks
...
## <a name="export-the-vhd-from-an-ec2-instance"></a>Export the VHD from an EC2 instance
