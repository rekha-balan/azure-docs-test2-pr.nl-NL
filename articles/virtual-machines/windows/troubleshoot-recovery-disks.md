...
---
# <a name="troubleshoot-a-windows-vm-by-attaching-the-os-disk-to-a-recovery-vm-using-azure-powershell"></a>Troubleshoot a Windows VM by attaching the OS disk to a recovery VM using Azure PowerShell
...
## <a name="create-a-snapshot-from-the-os-disk-of-the-vm"></a>Create a snapshot from the OS Disk of the VM
...
## <a name="create-a-disk-from-the-snapshot"></a>Create a disk from the snapshot
...
## <a name="attach-the-disk-to-another-windows-vm-for-troubleshooting"></a>Attach the disk to another Windows VM for troubleshooting
...
## <a name="connect-to-the-recovery-vm-and-fix-issues-on-the-attached-disk"></a>Connect to the recovery VM and fix issues on the attached disk
...
## <a name="unmount-and-detach-original-os-disk"></a>Unmount and detach original OS disk
...
## <a name="change-the-os-disk-for-the-affected-vm"></a>Change the OS disk for the affected VM
...
## <a name="verify-and-enable-boot-diagnostics"></a>Verify and enable boot diagnostics
