...
## <a name="target-architecture"></a>Target architecture
...
## <a name="prepare-the-infrastructure"></a>Prepare the infrastructure
...
### <a name="create-a-virtual-host-name-for-the-clustered-sap-ascsscs-instance-on-the-dns-server"></a>Create a virtual host name for the clustered SAP ASCS/SCS instance on the DNS server
...
### <a name="add-an-ip-address-to-an-existing-azure-internal-load-balancer-by-using-powershell"></a>Add an IP address to an existing Azure internal load balancer by using PowerShell
...
### <a name="add-disks-to-cluster-machines-and-configure-the-sios-cluster-share-disk"></a>Add disks to cluster machines, and configure the SIOS cluster share disk
...
### <a name="deploy-vms-for-sap-application-servers-and-dbms-cluster"></a>Deploy VMs for SAP application servers and DBMS cluster
...
## <a name="install-the-second-sap-sid2-netweaver-system"></a>Install the second SAP SID2 NetWeaver system
