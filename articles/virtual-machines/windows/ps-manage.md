...
---
# <a name="manage-azure-virtual-machines-using-powershell"></a>Manage Azure Virtual Machines using PowerShell
...
### <a name="stop-and-deallocate"></a>Stop and deallocate
...
### <a name="stop-and-stay-provisioned"></a>Stop and stay provisioned
...
### <a name="managed-data-disk"></a>Managed data disk
...
### <a name="unmanaged-data-disk"></a>Unmanaged data disk
