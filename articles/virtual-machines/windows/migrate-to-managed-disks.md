...
---
# <a name="migrate-azure-vms-to-managed-disks-in-azure"></a>Migrate Azure VMs to Managed Disks in Azure
...
## <a name="plan-for-the-conversion-to-managed-disks"></a>Plan for the conversion to Managed Disks
