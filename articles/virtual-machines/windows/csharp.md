...
---
# <a name="deploy-an-azure-virtual-machine-using-c"></a>Deploy an Azure Virtual Machine Using C# #
...
## <a name="step-3-create-the-credentials-used-to-authenticate-requests"></a>Step 3: Create the credentials used to authenticate requests
