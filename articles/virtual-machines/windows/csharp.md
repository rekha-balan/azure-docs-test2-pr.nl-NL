...
---
# <a name="create-and-manage-windows-vms-in-azure-using-c"></a>Create and manage Windows VMs in Azure using C# #
...
## <a name="create-credentials"></a>Create credentials
...
### <a name="create-the-authorization-file"></a>Create the authorization file
...
### <a name="create-the-management-client"></a>Create the management client
...
## <a name="create-resources"></a>Create resources
...
### <a name="create-the-availability-set"></a>Create the availability set
...
## <a name="perform-management-tasks"></a>Perform management tasks
...
### <a name="get-information-about-the-vm"></a>Get information about the VM
...
### <a name="start-the-vm"></a>Start the VM
...
### <a name="resize-the-vm"></a>Resize the VM
...
### <a name="add-a-data-disk-to-the-vm"></a>Add a data disk to the VM
