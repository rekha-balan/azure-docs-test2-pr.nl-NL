...
---
# <a name="azure-virtual-machine-agent-overview"></a>Azure Virtual Machine Agent overview
...
### <a name="azure-gallery-image"></a>Azure gallery image
...
## <a name="detect-the-vm-agent"></a>Detect the VM Agent
...
### <a name="manual-detection"></a>Manual Detection
...
## <a name="upgrade-the-vm-agent"></a>Upgrade the VM Agent
