...
---
# <a name="options-with-hpc-pack-to-create-and-manage-a-cluster-for-windows-hpc-workloads-in-azure"></a>Options with HPC Pack to create and manage a cluster for Windows HPC workloads in Azure
...
## <a name="hpc-pack-cluster-in-azure-vms-and-vm-scale-sets"></a>HPC Pack cluster in Azure VMs and VM scale sets
...
## <a name="hpc-pack-2012-r2-cluster-deployment-in-the-classic-deployment-model"></a>HPC Pack 2012 R2 cluster deployment in the classic deployment model
...
## <a name="burst-to-azure-from-hpc-pack-2012-r2"></a>Burst to Azure from HPC Pack 2012 R2
...
## <a name="job-submission"></a>Job submission
