...
---
# <a name="convert-a-windows-virtual-machine-from-unmanaged-disks-to-managed-disks"></a>Convert a Windows virtual machine from unmanaged disks to managed disks
...
## <a name="convert-single-instance-vms"></a>Convert single-instance VMs
...
## <a name="convert-vms-in-an-availability-set"></a>Convert VMs in an availability set
...
## <a name="convert-using-the-azure-portal"></a>Convert using the Azure portal
