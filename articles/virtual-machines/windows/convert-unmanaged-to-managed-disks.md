...
---
# <a name="convert-a-vm-from-unmanaged-disks-to-managed-disks"></a>Convert a VM from unmanaged disks to managed disks
...
## <a name="managed-disks-and-azure-storage-service-encryption-sse"></a>Managed Disks and Azure Storage Service Encryption (SSE)
...
## <a name="convert-vms-in-an-availability-set-to-managed-disks-in-a-managed-availability-set"></a>Convert VMs in an availability set to managed disks in a managed availability set
...
## <a name="convert-existing-azure-vms-to-managed-disks-of-the-same-storage-type"></a>Convert existing Azure VMs to managed disks of the same storage type
...
## <a name="migrate-existing-azure-vms-using-standard-unmanaged-disks-to-premium-managed-disks"></a>Migrate existing Azure VMs using standard unmanaged disks to Premium managed disks
