...
---
# <a name="troubleshoot-deployment-issues-when-creating-a-new-windows-vm-in-azure"></a>Troubleshoot deployment issues when creating a new Windows VM in Azure
