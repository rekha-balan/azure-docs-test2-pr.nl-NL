...
---
# <a name="set-up-gpu-drivers-for-n-series-vms-running-windows"></a>Set up GPU drivers for N-series VMs running Windows 
...
## <a name="driver-installation"></a>Driver installation
...
## <a name="verify-driver-installation"></a>Verify driver installation
...
## <a name="rdma-network-connectivity"></a>RDMA network connectivity
