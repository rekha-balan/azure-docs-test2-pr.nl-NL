...
---
# <a name="exporting-resource-groups-that-contain-vm-extensions"></a>Exporting Resource Groups that contain VM extensions
...
## <a name="supported-virtual-machine-extensions"></a>Supported Virtual Machine Extensions
...
## <a name="export-the-resource-group"></a>Export the Resource Group
...
## <a name="configure-protected-settings"></a>Configure protected settings
...
### <a name="step-1---remove-template-parameter"></a>Step 1 - Remove template parameter
...
### <a name="step-2---get-protected-settings-properties"></a>Step 2 - Get protected settings properties
...
### <a name="step-3---re-create-the-protected-configuration"></a>Step 3 - Re-create the protected configuration
