...
---
# <a name="azure-hybrid-use-benefit-for-windows-server-and-windows-client"></a>Azure Hybrid Use Benefit for Windows Server and Windows Client
...
## <a name="ways-to-use-azure-hybrid-use-benefit"></a>Ways to use Azure Hybrid Use Benefit
...
## <a name="deploy-a-vm-using-the-azure-marketplace"></a>Deploy a VM using the Azure Marketplace
...
## <a name="upload-a-windows-vhd"></a>Upload a Windows VHD
...
## <a name="deploy-an-uploaded-vm-via-resource-manager"></a>Deploy an uploaded VM via Resource Manager
...
## <a name="deploy-an-uploaded-vm-via-powershell-quickstart"></a>Deploy an uploaded VM via PowerShell quickstart
...
## <a name="detailed-powershell-deployment-walkthrough"></a>Detailed PowerShell deployment walkthrough
