...
---
# <a name="create-a-windows-vm-with-multiple-nics"></a>Create a Windows VM with multiple NICs
...
## <a name="add-a-nic-to-an-existing-vm"></a>Add a NIC to an existing VM
...
## <a name="remove-a-nic-from-an-existing-vm"></a>Remove a NIC from an existing VM
