...
---
# <a name="troubleshoot-access-to-an-application-running-on-a-windows-virtual-machine-in-azure"></a>Troubleshoot access to an application running on a Windows virtual machine in Azure
