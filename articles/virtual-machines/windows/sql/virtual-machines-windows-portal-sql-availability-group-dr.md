...
---
# <a name="configure-a-sql-server-always-on-availability-group-on-azure-virtual-machines-in-different-regions"></a>Configure a SQL Server Always On Availability Group on Azure Virtual Machines in Different Regions
...
## <a name="create-remote-replica"></a>Create remote replica
...
## <a name="set-connection-for-multiple-subnets"></a>Set connection for multiple subnets
...
## <a name="fail-over-to-remote-region"></a>Fail over to remote region 
...
### <a name="more-information-about-planned-and-forced-manual-failover"></a>More information about planned and forced manual failover
...
## <a name="additional-links"></a>Additional Links
