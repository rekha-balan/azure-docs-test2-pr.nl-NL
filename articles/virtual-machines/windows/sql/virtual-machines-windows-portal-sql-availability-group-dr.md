...
---
# <a name="configure-an-always-on-availability-group-on-azure-virtual-machines-in-different-regions"></a>Configure an Always On availability group on Azure virtual machines in different regions
