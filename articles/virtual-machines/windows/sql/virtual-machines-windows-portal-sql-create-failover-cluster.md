...
---
# <a name="configure-sql-server-failover-cluster-instance-on-azure-virtual-machines"></a>Configure SQL Server Failover Cluster Instance on Azure Virtual Machines
...
### <a name="example-azure-template"></a>Example Azure template
...
### <a name="what-to-know"></a>What to know
...
### <a name="what-to-have"></a>What to have
...
## <a name="step-1-create-virtual-machines"></a>Step 1: Create virtual machines
...
## <a name="step-2-configure-the-windows-failover-cluster-with-s2d"></a>Step 2: Configure the Windows Failover Cluster with S2D
...
### <a name="add-windows-failover-clustering-feature"></a>Add Windows Failover Clustering feature
...
### <a name="validate-the-cluster"></a>Validate the cluster
...
### <a name="create-the-failover-cluster"></a>Create the failover cluster
...
### <a name="create-a-cloud-witness"></a>Create a cloud witness
...
### <a name="add-storage"></a>Add storage
...
## <a name="step-3-test-failover-cluster-failover"></a>Step 3: Test failover cluster failover
...
## <a name="step-4-create-sql-server-fci"></a>Step 4: Create SQL Server FCI
...
## <a name="step-5-create-azure-load-balancer"></a>Step 5: Create Azure load balancer
...
### <a name="create-the-load-balancer-in-the-azure-portal"></a>Create the load balancer in the Azure portal
...
### <a name="configure-the-load-balancer-backend-pool"></a>Configure the load balancer backend pool 
...
### <a name="configure-a-load-balancer-health-probe"></a>Configure a load balancer health probe
...
### <a name="set-load-balancing-rules"></a>Set load balancing rules
...
## <a name="step-6-configure-cluster-for-probe"></a>Step 6: Configure cluster for probe
...
## <a name="step-7-test-fci-failover"></a>Step 7: Test FCI failover
...
### <a name="test-connectivity"></a>Test connectivity
