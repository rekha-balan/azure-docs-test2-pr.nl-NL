...
---
# <a name="introducing-sql-server-always-on-availability-groups-on-azure-virtual-machines"></a>Introducing SQL Server Always On availability groups on Azure virtual machines #
...
## <a name="automatically-create-an-availability-group-from-a-template"></a>Automatically create an availability group from a template
...
## <a name="manually-create-an-availability-group-in-azure-portal"></a>Manually create an availability group in Azure portal
