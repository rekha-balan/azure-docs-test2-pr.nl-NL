...
---
# <a name="automated-backup-v2-for-sql-server-2016-azure-virtual-machines-resource-manager"></a>Automated Backup v2 for SQL Server 2016 Azure Virtual Machines (Resource Manager)
...
## <a name="understanding-full-backup-frequency"></a>Understanding full backup frequency
...
### <a name="scenario-1-weekly-backups"></a>Scenario 1: Weekly backups
...
### <a name="scenario-2-daily-backups"></a>Scenario 2: Daily backups
You have a SQL Server VM which contains a number of very large databases.
...
### <a name="install-the-sql-iaas-extension"></a>Install the SQL IaaS Extension
...
### <a name="a-idverifysettings-verify-current-settings"></a><a id="verifysettings"> Verify current settings
...
### <a name="configure-automated-backup-v2"></a>Configure Automated Backup v2
...
### <a name="disable-automated-backup"></a>Disable Automated Backup
