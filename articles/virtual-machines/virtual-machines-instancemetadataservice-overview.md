...
---
# <a name="azures-instance-metadata-service---preview"></a>Azure's Instance Metadata Service --Preview
...
## <a name="retrieving-instance-metadata"></a>Retrieving Instance metadata 

Instance metadata is available for running VMs created/managed using [Azure Resource Manager](https://docs.microsoft.com/rest/api/resources/?redirectedfrom=MSDN). Access all data categories for a virtual machine instance use the following URI
...
#### <a name="retrieving-the-network-information"></a>Retrieving the network information 
...
## <a name="instance-metadata-data-categories"></a>Instance metadata data categories
...
### <a name="tracking-vm-running-on-azure"></a>Tracking VM running on Azure 
...
### <a name="placement-of-containers-data-partitions-based-faultupdate-domain"></a>Placement of containers, data-partitions based Fault/Update domain 
...
### <a name="getting-more-information-about-the-vm-during-support-case"></a>Getting more information about the VM during support case 
