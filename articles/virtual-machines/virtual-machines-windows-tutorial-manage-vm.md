...
---
# <a name="manage-windows-virtual-machines-with-azure-powershell"></a>Manage Windows virtual machines with Azure PowerShell
...
## <a name="step-3---create-virtual-machine"></a>Step 3 - Create virtual machine
...
### <a name="create-network-interface-card"></a>Create network interface card
...
## <a name="step-4--add-data-disk"></a>Step 4 – Add data disk
...
### <a name="create-disk"></a>Create disk
...
## <a name="step-5--automate-configuration"></a>Step 5 – Automate configuration
