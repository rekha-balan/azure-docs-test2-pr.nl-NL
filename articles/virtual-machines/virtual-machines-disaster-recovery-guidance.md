...
---
# <a name="what-to-do-in-the-event-that-an-azure-service-disruption-impacts-azure-vms"></a>What to do in the event that an Azure service disruption impacts Azure VMs
