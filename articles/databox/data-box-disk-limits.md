...
---
# <a name="azure-data-box-disk-limits-preview"></a>Azure Data Box Disk limits (Preview)
...
## <a name="data-box-service-limits"></a>Data Box service limits
...
## <a name="data-box-disk-performance"></a>Data Box Disk performance
...
## <a name="azure-storage-limits"></a>Azure storage limits
...
## <a name="data-upload-caveats"></a>Data upload caveats
...
## <a name="azure-storage-account-size-limits"></a>Azure storage account size limits
...
## <a name="azure-object-size-limits"></a>Azure object size limits
...
## <a name="azure-block-blob-and-page-blob-naming-conventions"></a>Azure block blob and page blob naming conventions
