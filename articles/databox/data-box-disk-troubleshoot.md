...
---
# <a name="troubleshoot-issues-in-azure-data-box-disk-preview"></a>Troubleshoot issues in Azure Data Box Disk (Preview)
...
## <a name="download-diagnostic-logs"></a>Download diagnostic logs
...
## <a name="query-activity-logs"></a>Query Activity logs
...
## <a name="data-box-disk-unlock-tool-errors"></a>Data Box Disk unlock tool errors
