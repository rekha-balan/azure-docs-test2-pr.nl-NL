...
---
# <a name="use-azure-portal-to-administer-your-data-box-disk-preview"></a>Use Azure portal to administer your Data Box Disk (Preview)
...
## <a name="clone-an-order"></a>Clone an order
...
## <a name="download-shipping-label"></a>Download shipping label
...
## <a name="edit-shipping-address"></a>Edit shipping address
...
## <a name="edit-notification-details"></a>Edit notification details
...
## <a name="view-order-status"></a>View order status
