...
---
# <a name="tutorial-unpack-connect-and-unlock-azure-data-box-disk"></a>Tutorial: Unpack, connect, and unlock Azure Data Box Disk
...
## <a name="unpack-your-disks"></a>Unpack your disks
...
## <a name="connect-to-disks-and-get-the-passkey"></a>Connect to disks and get the passkey 
...
## <a name="unlock-disks-on-windows-client"></a>Unlock disks on Windows client
...
## <a name="unlock-disks-on-linux-client"></a>Unlock disks on Linux client
