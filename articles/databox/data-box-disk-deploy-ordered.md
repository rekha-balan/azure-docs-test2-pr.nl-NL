...
---
# <a name="tutorial-order-an-azure-data-box-disk-preview"></a>Tutorial: Order an Azure Data Box Disk (Preview)
...
## <a name="order-data-box-disk"></a>Order Data Box Disk
...
## <a name="track-the-order"></a>Track the order
...
## <a name="cancel-the-order"></a>Cancel the order
