...
---
# <a name="tutorial-return-azure-data-box-disk-and-verify-data-upload-to-azure"></a>Tutorial: Return Azure Data Box Disk and verify data upload to Azure
...
## <a name="ship-data-box-disk-back"></a>Ship Data Box Disk back
...
## <a name="verify-data-upload-to-azure"></a>Verify data upload to Azure
...
## <a name="erasure-of-data-from-data-box-disk"></a>Erasure of data from Data Box Disk
