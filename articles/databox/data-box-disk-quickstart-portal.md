...
---
# <a name="quickstart-deploy-azure-data-box-disk-using-the-azure-portal-preview"></a>Quickstart: Deploy Azure Data Box Disk using the Azure portal (Preview)
...
## <a name="connect-and-unlock"></a>Connect and unlock
...
## <a name="copy-data-and-verify"></a>Copy data and verify
...
## <a name="ship-to-azure"></a>Ship to Azure
