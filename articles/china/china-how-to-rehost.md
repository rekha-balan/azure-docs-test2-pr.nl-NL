...
---
# <a name="rehost-and-migrate-an-application-to-azure"></a>Rehost and migrate an application to Azure
...
## <a name="azure-active-directory-services"></a>Azure Active Directory services
...
### <a name="basic-edition"></a>Basic edition:
...
### <a name="premium-and-basic-edition"></a>Premium and Basic edition:
...
### <a name="premium-edition"></a>Premium edition:
...
### <a name="azure-ad-b2c-and-social-identity-provider"></a>Azure AD B2C and social identity provider
...
### <a name="set-up-azure-traffic-manager"></a>Set up Azure Traffic Manager
...
### <a name="set-up-push-notifications"></a>Set up push notifications
...
### <a name="design-secure-key-management"></a>Design secure key management
...
## <a name="use-the-global-connection-toolkit"></a>Use the Global Connection Toolkit
...
## <a name="migrate-azure-classic-virtual-machines"></a>Migrate Azure classic virtual machines
