...
---
# <a name="service-bus-access-control-with-shared-access-signatures"></a>Service Bus access control with Shared Access Signatures
...
## <a name="shared-access-authorization-policies"></a>Shared Access Authorization Policies
...
## <a name="regenerating-keys"></a>Regenerating keys
