...
---
# <a name="get-started-with-service-bus-queues"></a>Get started with Service Bus queues
...
## <a name="2-create-a-queue-using-the-azure-portal"></a>2. Create a queue using the Azure portal
...
## <a name="3-send-messages-to-the-queue"></a>3. Send messages to the queue
...
### <a name="add-the-service-bus-nuget-package"></a>Add the Service Bus NuGet package
...
### <a name="write-code-to-send-messages-to-the-queue"></a>Write code to send messages to the queue
...
## <a name="4-receive-messages-from-the-queue"></a>4. Receive messages from the queue
...
### <a name="write-code-to-receive-messages-from-the-queue"></a>Write code to receive messages from the queue
