...
---
# <a name="get-started-with-a-kubernetes-cluster-in-container-service"></a>Get started with a Kubernetes cluster in Container Service
...
## <a name="create-your-kubernetes-cluster"></a>Create your Kubernetes cluster
