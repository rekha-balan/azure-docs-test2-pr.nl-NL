...
---
# <a name="jenkins-integration-with-azure-container-service-and-kubernetes"></a>Jenkins integration with Azure Container Service and Kubernetes 
...
## <a name="high-level-process"></a>High level process
...
## <a name="install-a-kubernetes-cluster"></a>Install a Kubernetes cluster
...
### <a name="step-2-deploy-the-cluster"></a>Step 2: Deploy the cluster
> [!NOTE]
...
## <a name="set-up-jenkins-and-configure-access-to-container-service"></a>Set up Jenkins and configure access to Container Service

### <a name="step-1-install-jenkins"></a>Step 1: Install Jenkins
...
### <a name="step-2-set-up-access-to-the-kubernetes-cluster"></a>Step 2: Set up access to the Kubernetes cluster
...
## <a name="create-a-jenkins-workflow"></a>Create a Jenkins workflow
...
### <a name="step-1-deploy-initial-v1-of-application"></a>Step 1: Deploy initial v1 of application
...
3. Deploy to the Kubernetes cluster.
    ...
    ```
### <a name="step-2-configure-jenkins-system"></a>Step 2: Configure Jenkins system
...
### <a name="step-3-create-the-jenkins-workflow"></a>Step 3: Create the Jenkins workflow
...
### <a name="step-4-connect-github-webhook"></a>Step 4: Connect GitHub webhook
...
## <a name="test-the-cicd-process-end-to-end"></a>Test the CI/CD process end to end
