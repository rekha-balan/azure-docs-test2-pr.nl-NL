...
---
# <a name="deploy-a-docker-container-hosting-solution-using-the-azure-portal"></a>Deploy a Docker container hosting solution using the Azure portal
...
## <a name="create-a-cluster-by-using-the-azure-portal"></a>Create a cluster by using the Azure portal
...
## <a name="create-a-cluster-by-using-a-quickstart-template"></a>Create a cluster by using a quickstart template
...
### <a name="equivalent-powershell-commands"></a>Equivalent PowerShell commands
