...
ms.locfileid: "44866669"
---
# <a name="scale-agent-nodes-in-a-container-service-cluster"></a><span data-ttu-id="3d2d5-103">Scale agent nodes in a Container Service cluster</span><span class="sxs-lookup"><span data-stu-id="3d2d5-103">Scale agent nodes in a Container Service cluster</span></span>
