...
---
# <a name="dcos-container-management-through-the-marathon-rest-api"></a>DC/OS container management through the Marathon REST API
...
## <a name="access-the-dcos-apis"></a>Access the DC/OS APIs
