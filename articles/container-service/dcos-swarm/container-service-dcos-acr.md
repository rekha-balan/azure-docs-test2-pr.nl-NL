...
## <a name="manage-acr-authentication"></a>Manage ACR authentication
...
### <a name="create-shared-storage"></a>Create shared storage
...
## <a name="upload-image-to-acr"></a>Upload image to ACR
...
## <a name="run-an-image-from-acr"></a>Run an image from ACR
