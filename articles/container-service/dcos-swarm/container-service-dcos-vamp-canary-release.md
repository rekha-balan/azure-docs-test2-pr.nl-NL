...
---
# <a name="canary-release-microservices-with-vamp-on-an-azure-container-service-dcos-cluster"></a>Canary release microservices with Vamp on an Azure Container Service DC/OS cluster
...
## <a name="about-canary-releases-and-vamp"></a>About canary releases and Vamp
...
## <a name="set-up-azure-container-service-with-dcos"></a>Set up Azure Container Service with DC/OS
...
## <a name="set-up-vamp"></a>Set up Vamp
...
### <a name="deploy-elasticsearch"></a>Deploy Elasticsearch
...
## <a name="deploy-your-first-service"></a>Deploy your first service
...
## <a name="update-the-azure-network-configuration"></a>Update the Azure network configuration
...
## <a name="run-a-canary-release"></a>Run a canary release
...
### <a name="merge-a-new-service-variant"></a>Merge a new service variant
...
### <a name="filter-traffic"></a>Filter traffic
...
## <a name="summing-up"></a>Summing up
