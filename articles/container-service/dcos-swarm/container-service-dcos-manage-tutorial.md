...
---
# <a name="azure-container-service-tutorial---manage-dcos"></a>Azure Container Service tutorial - Manage DC/OS
...
## <a name="create-dcos-cluster"></a>Create DC/OS cluster
...
## <a name="connect-to-dcos-cluster"></a>Connect to DC/OS cluster
...
## <a name="install-dcos-cli"></a>Install DC/OS CLI
...
## <a name="scale-marathon-application"></a>Scale Marathon application
...
## <a name="run-internet-accessible-app"></a>Run internet accessible app
...
## <a name="scale-dcos-cluster"></a>Scale DC/OS cluster
...
## <a name="delete-dcos-cluster"></a>Delete DC/OS cluster
