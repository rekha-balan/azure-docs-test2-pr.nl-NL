...
---
# <a name="create-and-mount-a-file-share-to-a-dcos-cluster"></a>Create and mount a file share to a DC/OS cluster
...
## <a name="create-a-file-share-on-microsoft-azure"></a>Create a file share on Microsoft Azure
...
### <a name="using-azure-cli-20"></a>Using Azure CLI 2.0
...
## <a name="mount-the-share-in-your-cluster"></a>Mount the share in your cluster

Next, we need to mount this share on every virtual machine inside your cluster using the cifs tool/protocol. We do that with the following command line: `mount -t cifs`.
...
### <a name="set-up-scripts"></a>Set up scripts
