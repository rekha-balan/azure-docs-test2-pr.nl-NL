...
---
# <a name="monitor-an-azure-container-service-kubernetes-cluster-using-sysdig"></a>Monitor an Azure Container Service Kubernetes cluster using Sysdig
...
To install the Sysdig daemonset, you should first download [the template](https://github.com/draios/sysdig-cloud-scripts/tree/master/agent_deploy/kubernetes) from sysdig. Save that file as `sysdig-daemonset.yaml`.
