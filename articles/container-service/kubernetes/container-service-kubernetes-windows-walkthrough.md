...
---
# <a name="deploy-kubernetes-cluster-for-windows-containers"></a>Deploy Kubernetes cluster for Windows containers
...
To configure `kubectl` to connect to your Kubernetes cluster, run the [az acs kubernetes get-credentials](/cli/azure/acs/kubernetes#get-credentials) command. The following example downloads the cluster configuration for your Kubernetes cluster.
...
## <a name="deploy-a-windows-iis-container"></a>Deploy a Windows IIS container
