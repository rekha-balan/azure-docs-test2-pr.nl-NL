...
---
# <a name="monitor-a-kubernetes-cluster-with-log-analytics"></a>Monitor a Kubernetes cluster with Log Analytics
...
## <a name="get-workspace-settings"></a>Get Workspace settings
...
## <a name="create-kubernetes-secret"></a>Create Kubernetes secret
...
## <a name="set-up-log-analytics-agents"></a>Set up Log Analytics agents
...
## <a name="access-monitoring-data"></a>Access monitoring data
