...
---
# <a name="set-up-an-azure-ad-service-principal-for-a-kubernetes-cluster-in-container-service"></a>Set up an Azure AD service principal for a Kubernetes cluster in Container Service
...
## <a name="option-1-create-a-service-principal-in-azure-ad"></a>Option 1: Create a service principal in Azure AD
...
### <a name="specify-service-principal-when-creating-the-kubernetes-cluster"></a>Specify service principal when creating the Kubernetes cluster
...
## <a name="option-2-generate-a-service-principal-when-creating-the-cluster-with-az-acs-create"></a>Option 2: Generate a service principal when creating the cluster with `az acs create`
...
## <a name="credential-expiration"></a>Credential expiration
