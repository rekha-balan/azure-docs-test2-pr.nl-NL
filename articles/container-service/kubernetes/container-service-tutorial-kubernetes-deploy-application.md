...
---
# <a name="run-applications-in-kubernetes"></a>Run applications in Kubernetes
...
## <a name="update-manifest-file"></a>Update manifest file
...
## <a name="deploy-application"></a>Deploy application
...
## <a name="test-application"></a>Test application
