...
---
# <a name="update-an-application-in-kubernetes"></a>Update an application in Kubernetes
...
## <a name="update-container-image"></a>Update container image
...
## <a name="test-application-locally"></a>Test application locally
...
## <a name="tag-and-push-images"></a>Tag and push images
...
## <a name="deploy-update-application"></a>Deploy update application
...
## <a name="test-updated-application"></a>Test updated application
