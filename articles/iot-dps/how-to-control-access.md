...
---
# <a name="control-access-to-azure-iot-hub-device-provisioning-service"></a>Control access to Azure IoT Hub Device Provisioning Service
...
### <a name="device-provisioning-service-permissions"></a>Device Provisioning Service permissions
