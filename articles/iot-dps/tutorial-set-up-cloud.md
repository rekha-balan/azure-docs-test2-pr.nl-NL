...
---
# <a name="configure-cloud-resources-for-device-provisioning-with-the-iot-hub-device-provisioning-service"></a>Configure cloud resources for device provisioning with the IoT Hub Device Provisioning Service
...
## <a name="create-a-device-provisioning-service-instance-and-get-the-id-scope"></a>Create a Device Provisioning Service instance and get the ID scope
...
## <a name="link-the-device-provisioning-service-to-an-iot-hub"></a>Link the Device Provisioning Service to an IoT hub
...
## <a name="set-the-allocation-policy-on-the-device-provisioning-service"></a>Set the allocation policy on the Device Provisioning Service
