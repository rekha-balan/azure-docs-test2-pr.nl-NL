...
---
# <a name="provisioning-devices-with-azure-iot-hub-device-provisioning-service"></a>Provisioning devices with Azure IoT Hub Device Provisioning Service
...
## <a name="when-to-use-device-provisioning-service"></a>When to use Device Provisioning Service
...
## <a name="provisioning-process"></a>Provisioning process
...
### <a name="manufacturing-step"></a>Manufacturing step
...
### <a name="cloud-setup-step"></a>Cloud setup step
...
## <a name="registration-and-provisioning"></a>Registration and provisioning
...
## <a name="features-of-the-device-provisioning-service"></a>Features of the Device Provisioning Service
...
## <a name="cross-platform-support"></a>Cross-platform support
