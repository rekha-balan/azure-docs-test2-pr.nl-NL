...
---
# <a name="set-up-the-iot-hub-device-provisioning-service-with-azure-cli"></a>Set up the IoT Hub Device Provisioning Service with Azure CLI
...
## <a name="create-a-provisioning-service"></a>Create a provisioning service
...
## <a name="get-the-connection-string-for-the-iot-hub"></a>Get the connection string for the IoT hub
...
## <a name="link-the-iot-hub-and-the-provisioning-service"></a>Link the IoT hub and the provisioning service
...
## <a name="verify-the-provisioning-service"></a>Verify the provisioning service
