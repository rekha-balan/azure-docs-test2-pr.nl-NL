...
---
# <a name="create-and-provision-a-simulated-x509-device-using-java-device-and-service-sdk-and-group-enrollments-for-iot-hub-device-provisioning-service"></a>Create and provision a simulated X.509 device using Java device and service SDK and group enrollments for IoT Hub Device Provisioning Service
...
## <a name="create-a-device-enrollment-entry"></a>Create a device enrollment entry
...
## <a name="simulate-the-device"></a>Simulate the device
