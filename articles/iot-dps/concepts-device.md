...
---
# <a name="iot-hub-device-provisioning-service-device-concepts"></a>IoT Hub Device Provisioning Service device concepts
...
## <a name="registration-id"></a>Registration ID
