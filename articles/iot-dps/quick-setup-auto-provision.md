...
---
# <a name="set-up-the-iot-hub-device-provisioning-service-with-the-azure-portal"></a>Set up the IoT Hub Device Provisioning Service with the Azure portal
...
## <a name="create-a-new-instance-for-the-iot-hub-device-provisioning-service"></a>Create a new instance for the IoT Hub Device Provisioning Service
