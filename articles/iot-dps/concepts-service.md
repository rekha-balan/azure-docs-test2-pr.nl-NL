...
---
# <a name="iot-hub-device-provisioning-service-concepts"></a>IoT Hub Device Provisioning Service concepts
...
## <a name="service-operations-endpoint"></a>Service operations endpoint
...
## <a name="device-provisioning-endpoint"></a>Device provisioning endpoint
...
## <a name="linked-iot-hubs"></a>Linked IoT hubs
...
## <a name="allocation-policy"></a>Allocation policy
...
### <a name="enrollment-group"></a>Enrollment group
...
### <a name="individual-enrollment"></a>Individual enrollment
