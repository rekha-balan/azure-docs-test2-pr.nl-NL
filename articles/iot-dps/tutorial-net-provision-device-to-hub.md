...
---
# <a name="enroll-the-device-to-an-iot-hub-using-the-azure-iot-hub-provisioning-service-client-net"></a>Enroll the device to an IoT hub using the Azure IoT Hub Provisioning Service Client (.NET)
...
## <a name="enroll-the-device"></a>Enroll the device
...
### <a name="enroll-the-device-using-individual-enrollments"></a>Enroll the device using Individual Enrollments
...
### <a name="enroll-the-device-using-enrollment-groups"></a>Enroll the device using Enrollment Groups
...
## <a name="start-the-device"></a>Start the device
...
## <a name="verify-the-device-is-registered"></a>Verify the device is registered
