...
---
# <a name="quickstart-provision-an-x509-simulated-device-using-the-azure-iot-c-sdk"></a>Quickstart: Provision an X.509 simulated device using the Azure IoT C SDK
...
## <a name="prepare-a-development-environment-for-the-azure-iot-c-sdk"></a>Prepare a development environment for the Azure IoT C SDK
...
## <a name="create-a-self-signed-x509-device-certificate"></a>Create a self-signed X.509 device certificate
...
## <a name="create-a-device-enrollment-entry-in-the-portal"></a>Create a device enrollment entry in the portal
...
## <a name="simulate-first-boot-sequence-for-the-device"></a>Simulate first boot sequence for the device
