...
---
# <a name="quickstart-provision-a-simulated-tpm-device-using-the-azure-iot-c-sdk"></a>Quickstart: Provision a simulated TPM device using the Azure IoT C SDK
...
## <a name="build-the-sdk-and-run-the-tpm-device-simulator"></a>Build the SDK and run the TPM device simulator
...
## <a name="read-cryptographic-keys-from-the-tpm-device"></a>Read cryptographic keys from the TPM device
