...
---
# <a name="how-to-use-different-attestation-mechanisms-with-device-provisioning-service-client-sdk-for-c"></a>How to use different attestation mechanisms with Device Provisioning Service Client SDK for C
...
### <a name="choose-an-attestation-mechanism"></a>Choose an attestation mechanism
...
## <a name="enable-authentication-for-supported-attestation-mechanisms"></a>Enable authentication for supported attestation mechanisms
...
### <a name="use-tpm-with-simulator"></a>Use TPM with simulator
...
## <a name="build-the-sdk"></a>Build the SDK
...
### <a name="libraries-to-include"></a>Libraries to include
...
## <a name="create-a-device-enrollment-entry-in-device-provisioning-services"></a>Create a device enrollment entry in Device Provisioning Services
...
## <a name="enable-authentication-for-devices-using-a-custom-attestation-mechanism-optional"></a>Enable authentication for devices using a custom attestation mechanism (optional)
...
## <a name="connecting-to-iot-hub-after-provisioning"></a>Connecting to IoT Hub after provisioning
