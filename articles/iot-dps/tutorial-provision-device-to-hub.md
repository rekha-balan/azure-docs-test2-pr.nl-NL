...
---
# <a name="provision-the-device-to-an-iot-hub-using-the-azure-iot-hub-device-provisioning-service"></a>Provision the device to an IoT hub using the Azure IoT Hub Device Provisioning Service
...
## <a name="start-the-iot-device"></a>Start the IoT device
