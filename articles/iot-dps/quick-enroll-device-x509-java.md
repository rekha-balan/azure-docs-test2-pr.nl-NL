...
---
# <a name="quickstart-enroll-x509-devices-to-the-device-provisioning-service-using-java"></a>Quickstart: Enroll X.509 devices to the Device Provisioning Service using Java
...
## <a name="download-and-modify-the-java-sample-code"></a>Download and modify the Java sample code
...
## <a name="build-and-run-sample-group-enrollment"></a>Build and run sample group enrollment
...
## <a name="modifications-to-enroll-a-single-x509-device"></a>Modifications to enroll a single X.509 device
