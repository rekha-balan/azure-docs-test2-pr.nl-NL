...
---
# <a name="set-up-the-iot-hub-device-provisioning-service-with-an-azure-resource-manager-template"></a>Set up the IoT Hub Device Provisioning Service with an Azure Resource Manager template
...
## <a name="sign-in-to-azure-and-create-a-resource-group"></a>Sign in to Azure and create a resource group
...
## <a name="create-a-resource-manager-parameter-file"></a>Create a Resource Manager parameter file
