...
---
# <a name="set-up-a-device-to-provision-using-the-azure-iot-hub-device-provisioning-service"></a>Set up a device to provision using the Azure IoT Hub Device Provisioning Service
...
## <a name="build-a-platform-specific-version-of-the-sdk"></a>Build a platform-specific version of the SDK
...
## <a name="extract-the-security-artifacts"></a>Extract the security artifacts 
...
## <a name="create-the-device-registration-software"></a>Create the device registration software
...
### <a name="sdk-apis-used-during-registration-for-reference-only"></a>SDK APIs used during registration (for reference only)
