...
---
# <a name="quickstart-enroll-x509-devices-to-the-device-provisioning-service-using-c"></a>Quickstart: Enroll X.509 devices to the Device Provisioning Service using C#
...
## <a name="prepare-test-certificates"></a>Prepare test certificates
...
## <a name="get-the-connection-string-for-your-provisioning-service"></a>Get the connection string for your provisioning service
...
## <a name="create-the-enrollment-group-sample"></a>Create the enrollment group sample 
...
## <a name="run-the-enrollment-group-sample"></a>Run the enrollment group sample
