...
---
# <a name="enroll-tpm-device-to-iot-hub-device-provisioning-service-using-c-service-sdk"></a>Enroll TPM device to IoT Hub Device Provisioning Service using C# service SDK
...
## <a name="create-the-individual-enrollment-sample"></a>Create the individual enrollment sample 
...
## <a name="run-the-individual-enrollment-sample"></a>Run the individual enrollment sample
