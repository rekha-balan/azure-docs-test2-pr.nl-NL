...
---
# <a name="enroll-tpm-device-to-iot-hub-device-provisioning-service-using-java-service-sdk"></a>Enroll TPM device to IoT Hub Device Provisioning Service using Java service SDK
...
## <a name="build-and-run-the-java-sample-code"></a>Build and run the Java sample code
