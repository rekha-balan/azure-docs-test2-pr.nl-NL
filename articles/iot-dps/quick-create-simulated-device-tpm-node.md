...
---
# <a name="create-and-provision-a-simulated-tpm-device-using-nodejs-device-sdk-for-iot-hub-device-provisioning-service"></a>Create and provision a simulated TPM device using Node.js device SDK for IoT Hub Device Provisioning Service
...
## <a name="simulate-a-tpm-device"></a>Simulate a TPM device
...
## <a name="create-a-device-entry"></a>Create a device entry
...
## <a name="register-the-device"></a>Register the device
