...
---
# <a name="azure-germany-iot-services"></a>Azure Germany IoT services
...
## <a name="deploying-the-solution-accelerator"></a>Deploying the solution accelerator

Both solutions can be deployed in two ways, via website or via PowerShell.

### <a name="deploy-via-website"></a>Deploy via website
...
### <a name="deploy-via-powershell"></a>Deploy via PowerShell
