...
---
# <a name="migration-of-database-resources-from-azure-germany-to-global-azure"></a>Migration of database resources from Azure Germany to global Azure
...
### <a name="option-1-data-loss-ok-create-new-instance"></a>Option 1: Data Loss ok, create new instance
...
### <a name="option-2-copy-data-from-source-instance-to-target-instance"></a>Option 2: Copy data from Source instance to Target instance
...
### <a name="option-3-export-from-source-instance-import-into-destination-instance"></a>Option 3: Export from source instance, import into destination instance
...
### <a name="option-4-write-data-to-two-redis-instances-read-from-one-instance"></a>Option 4: Write data to two Redis instances, read from one instance
