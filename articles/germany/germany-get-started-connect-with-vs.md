...
---
# <a name="connect-to-azure-germany-by-using-visual-studio"></a>Connect to Azure Germany by using Visual Studio
...
### <a name="update-visual-studio-for-azure-germany"></a>Update Visual Studio for Azure Germany
...
### <a name="revert-a-visual-studio-connection-to-azure-germany"></a>Revert a Visual Studio connection to Azure Germany
