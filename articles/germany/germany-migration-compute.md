...
---
# <a name="migration-of-compute-resources-from-azure-germany-to-global-azure"></a>Migration of compute resources from Azure Germany to global Azure
...
### <a name="duplicate-with-azure-site-recovery"></a>Duplicate with Azure Site Recovery
...
### <a name="duplicate-with-resource-manager-template-exportimport"></a>Duplicate with Resource Manager template export/import
...
### <a name="by-powershell"></a>By PowerShell
...
### <a name="by-rest-api"></a>By REST API
...
## <a name="virtual-machines-scale-set"></a>Virtual Machines Scale Set
