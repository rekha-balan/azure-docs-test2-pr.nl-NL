...
---
# <a name="indexing-in-azure-search"></a>Indexing in Azure Search
...
## <a name="pushing-data-to-an-index"></a>Pushing data to an index
...
### <a name="how-to-push-data-to-an-azure-search-index"></a>How to push data to an Azure Search index
...
## <a name="pulling-data-into-an-index"></a>Pulling data into an index
...
### <a name="how-to-pull-data-into-an-azure-search-index"></a>How to pull data into an Azure Search index
...
## <a name="verify-data-import-with-search-explorer"></a>Verify data import with Search explorer
