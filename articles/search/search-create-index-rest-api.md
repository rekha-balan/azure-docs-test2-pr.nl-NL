...
## <a name="define-your-azure-search-index-using-well-formed-json"></a>Define your Azure Search index using well-formed JSON
...
## <a name="issue-the-http-request"></a>Issue the HTTP request
