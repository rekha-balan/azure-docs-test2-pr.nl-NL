...
## <a name="identify-your-azure-search-services-query-api-key"></a>Identify your Azure Search service's query api-key
...
## <a name="create-an-instance-of-the-searchindexclient-class"></a>Create an instance of the SearchIndexClient class
...
## <a name="query-your-index"></a>Query your index
...
## <a name="handle-search-results"></a>Handle search results
