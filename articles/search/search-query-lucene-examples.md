...
---
# <a name="lucene-syntax-query-examples-for-building-advanced-queries-in-azure-search"></a>Lucene syntax query examples for building advanced queries in Azure Search
...
## <a name="formulate-requests-in-postman"></a>Formulate requests in Postman
...
### <a name="set-the-request-header"></a>Set the request header
...
### <a name="set-the-request-url"></a>Set the request URL
...
## <a name="send-your-first-query"></a>Send your first query
...
## <a name="how-to-invoke-full-lucene-parsing"></a>How to invoke full Lucene parsing
...
## <a name="example-1-field-scoped-query"></a>Example 1: Field-scoped query
...
## <a name="example-2-intra-field-filtering"></a>Example 2: Intra-field filtering
...
## <a name="example-3-fuzzy-search"></a>Example 3: Fuzzy search
...
## <a name="example-4-proximity-search"></a>Example 4: Proximity search
...
## <a name="example-5-term-boosting"></a>Example 5: Term boosting
...
## <a name="example-6-regex"></a>Example 6: Regex
...
## <a name="example-7-wildcard-search"></a>Example 7: Wildcard search
