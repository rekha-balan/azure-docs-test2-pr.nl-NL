...
---
# <a name="monitoring-an-azure-search-service"></a>Monitoring an Azure Search service
...
## <a name="azure-search-metrics"></a>Azure Search metrics
...
### <a name="set-up-alerts"></a>Set up alerts
...
## <a name="how-to-track-resource-usage"></a>How to track resource usage
...
### <a name="using-the-portal"></a>Using the portal
...
## <a name="how-to-export-logs-and-metrics"></a>How to export logs and metrics
...
### <a name="enabling-monitoring"></a>Enabling monitoring
...
### <a name="logs-and-metrics-schemas"></a>Logs and metrics schemas
...
#### <a name="metrics-schema"></a>Metrics schema
| Name | Type | Example | Notes |
| --- | --- | --- | --- |
...
## <a name="analyzing-your-data-with-power-bi"></a>Analyzing your data With Power BI
