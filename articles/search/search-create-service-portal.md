...
---
# <a name="create-an-azure-search-service-in-the-portal"></a>Create an Azure Search service in the portal
...
## <a name="subscribe-free-or-paid"></a>Subscribe (free or paid)
...
## <a name="find-azure-search"></a>Find Azure Search
...
## <a name="name-the-service-and-url-endpoint"></a>Name the service and URL endpoint
...
## <a name="select-a-resource-group"></a>Select a resource group
...
## <a name="select-a-hosting-location"></a>Select a hosting location 
...
## <a name="select-a-pricing-tier-sku"></a>Select a pricing tier (SKU)
...
## <a name="create-your-service"></a>Create your service
...
![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/search/media/search-create-service-portal/settings-scale.png)
...
## <a name="when-to-add-a-second-service"></a>When to add a second service
