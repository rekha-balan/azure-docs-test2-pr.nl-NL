...
---
# <a name="index-azure-table-storage-with-azure-search"></a>Index Azure Table storage with Azure Search
This article shows how to use Azure Search to index data stored in Azure Table storage.

## <a name="set-up-azure-table-storage-indexing"></a>Set up Azure Table storage indexing
...
### <a name="step-1-create-a-datasource"></a>Step 1: Create a datasource
...
#### <a name="ways-to-specify-credentials"></a>Ways to specify credentials ####
...
## <a name="deal-with-different-field-names"></a>Deal with different field names
...
## <a name="handle-document-keys"></a>Handle document keys
