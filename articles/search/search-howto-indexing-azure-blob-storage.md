...
#### <a name="how-to-specify-credentials"></a>How to specify credentials ####
...
## <a name="how-azure-search-indexes-blobs"></a>How Azure Search indexes blobs
...
### <a name="defining-document-keys-and-field-mappings"></a>Defining document keys and field mappings
...
## <a name="controlling-which-blobs-are-indexed"></a>Controlling which blobs are indexed
...
### <a name="exclude-blobs-with-specific-file-extensions"></a>Exclude blobs with specific file extensions
...
### <a name="dealing-with-unsupported-content-types"></a>Dealing with unsupported content types
...
### <a name="ignoring-parsing-errors"></a>Ignoring parsing errors
...
## <a name="controlling-which-parts-of-the-blob-are-indexed"></a>Controlling which parts of the blob are indexed
...
### <a name="using-blob-metadata-to-control-how-blobs-are-indexed"></a>Using blob metadata to control how blobs are indexed
...
## <a name="indexing-large-datasets"></a>Indexing large datasets
...
## <a name="indexing-documents-along-with-related-data"></a>Indexing documents along with related data
