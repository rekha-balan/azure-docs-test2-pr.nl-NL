...
## <a name="create-an-azure-sql-indexer"></a>Create an Azure SQL Indexer
...
## <a name="capture-new-changed-and-deleted-rows"></a>Capture new, changed, and deleted rows
...
## <a name="mapping-between-sql-and-azure-search-data-types"></a>Mapping between SQL and Azure Search data types
