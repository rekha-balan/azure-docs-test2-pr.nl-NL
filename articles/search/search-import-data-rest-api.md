...
## <a name="identify-your-azure-search-services-admin-api-key"></a>Identify your Azure Search service's admin api-key
...
## <a name="decide-which-indexing-action-to-use"></a>Decide which indexing action to use
...
## <a name="construct-your-http-request-and-request-body"></a>Construct your HTTP request and request body
...
## <a name="understand-your-http-response-code"></a>Understand your HTTP response code
#### <a name="200"></a>200
