...
---
# <a name="tutorial-use-built-in-tools-for-azure-search-indexing-and-queries"></a>Tutorial: Use built-in tools for Azure Search indexing and queries
...
### <a name="step-1-start-the-import-data-wizard"></a>Step 1: Start the Import data wizard
...
### <a name="skip-cognitive-skills"></a>Skip Cognitive skills
...
### <a name="step-4-view-the-index"></a>Step 4: View the index
...
### <a name="simple-query-with-top-n-results"></a>Simple query with top N results

#### <a name="example-string-searchseattle"></a>Example (string): `search=seattle`
...
#### <a name="example-parameterized-searchseattlecounttruetop100"></a>Example (parameterized): `search=seattle&$count=true&$top=100`
...
#### <a name="example-filtered-searchseattlefilterbeds-gt-3"></a>Example (filtered): `search=seattle&$filter=beds gt 3`
...
#### <a name="example-faceted-with-scope-reduction-searchfacetcitytop2"></a>Example (faceted with scope reduction): `search=*&facet=city&$top=2`
...
#### <a name="example-facet-on-numeric-values-searchseattlefacetbeds"></a>Example (facet on numeric values): `search=seattle&facet=beds`**
...
#### <a name="example-highlighter-searchgranite-countertopshighlightdescription"></a>Example (highlighter): `search=granite countertops&highlight=description`

* In this example, the formatted phrase *granite countertops* is easier to spot in the description field.

#### <a name="example-linguistic-analysis-searchmicehighlightdescription"></a>Example (linguistic analysis): `search=mice&highlight=description`
...
#### <a name="example-misspelled-term-unhandled-searchsamamish"></a>Example (misspelled term, unhandled): `search=samamish`
...
#### <a name="example-misspelled-term-handled-searchsamamishquerytypefull"></a>Example (misspelled term, handled): `search=samamish~&queryType=full`
...
#### <a name="example-geo-coordinate-filters-searchcounttruefiltergeodistancelocationgeographypoint-122121513-47673988-le-5"></a>Example (geo-coordinate filters): `search=*&$count=true&$filter=geo.distance(location,geography'POINT(-122.121513 47.673988)') le 5`
