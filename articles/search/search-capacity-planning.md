...
---
# <a name="allocate-partitions-and-replicas-for-query-and-indexing-workloads-in-azure-search"></a>Allocate partitions and replicas for query and indexing workloads in Azure Search
...
## <a name="how-to-allocate-partitions-and-replicas"></a>How to allocate partitions and replicas
...
### <a name="index-availability-during-a-rebuild"></a>Index availability during a rebuild
...
## <a name="billing-formula-for-replica-and-partition-resources"></a>Billing formula for replica and partition resources
