...
---
# <a name="how-to-use-azure-search-from-a-net-application"></a>How to use Azure Search from a .NET Application
...
## <a name="whats-in-the-azure-search-sdk"></a>What's in the Azure Search SDK
...
## <a name="upgrading-to-the-latest-version-of-the-sdk"></a>Upgrading to the latest version of the SDK
...
## <a name="requirements-for-the-sdk"></a>Requirements for the SDK
...
## <a name="core-scenarios"></a>Core scenarios
...
### <a name="creating-an-index"></a>Creating an index
...
### <a name="populating-the-index"></a>Populating the index
...
#### <a name="custom-serialization-with-jsonnet"></a>Custom Serialization with JSON.NET
...
### <a name="searching-for-documents-in-the-index"></a>Searching for documents in the index
...
## <a name="sample-application-source-code"></a>Sample application source code
