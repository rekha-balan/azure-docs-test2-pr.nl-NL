...
The first step is to provide data source connection information used by the indexer. The data source type, specified here as `azureblob`, determines which data extraction behaviors are invoked by the indexer. For JSON blob indexing, data source definition is the same for both JSON documents and arrays. 
...
### <a name="step-2-create-a-target-search-index"></a>Step 2: Create a target search index 
...
### <a name="step-3-configure-and-run-the-indexer"></a>Step 3: Configure and run the indexer
...
## <a name="how-to-parse-single-json-blobs"></a>How to parse single JSON blobs
...
### <a name="indexer-definition-for-single-json-blobs"></a>Indexer definition for single JSON blobs
...
## <a name="how-to-parse-json-arrays-preview"></a>How to parse JSON arrays (preview)
...
### <a name="indexer-definition-for-a-json-array"></a>Indexer definition for a JSON array
...
### <a name="nested-json-arrays"></a>Nested JSON arrays
...
## <a name="example-indexer-request-with-field-mappings"></a>Example: Indexer request with field mappings
