...
---
# <a name="query-types-and-composition-in-azure-search"></a>Query types and composition in Azure Search
...
## <a name="a-first-look-at-query-requests"></a>A first look at query requests
...
### <a name="how-to-run-this-query"></a>How to run this query
...
### <a name="how-query-operations-are-enabled-by-the-index"></a>How query operations are enabled by the index
...
## <a name="elements-of-a-query-request"></a>Elements of a query request
...
## <a name="choose-a-parser-simple--full"></a>Choose a parser: simple | full
...
## <a name="manage-search-results"></a>Manage search results 
...
### <a name="tips-for-unexpected-results"></a>Tips for unexpected results
...
## <a name="apis-and-tools-for-testing"></a>APIs and tools for testing
