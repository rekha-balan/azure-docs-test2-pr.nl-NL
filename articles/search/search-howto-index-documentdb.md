...
<a name="Concepts"></a>
## <a name="azure-search-indexer-concepts"></a>Azure Search indexer concepts
...
### <a name="using-queries-to-shape-indexed-data"></a>Using queries to shape indexed data
...
<a id="RunIndexer"></a>
### <a name="running-indexer-on-demand"></a>Running indexer on-demand
...
### <a name="getting-indexer-status"></a>Getting indexer status
...
## <a name="indexing-changed-documents"></a>Indexing changed documents
...
## <a name="indexing-deleted-documents"></a>Indexing deleted documents
