...
## <a name="sample-code-and-demo"></a>Sample code and demo
...
### <a name="app-design-pattern"></a>App design pattern
...
## <a name="build-a-faceted-navigation-app"></a>Build a faceted navigation app
...
## <a name="check-the-data"></a>Check the data
...
## <a name="build-the-ui"></a>Build the UI
...
## <a name="tips-and-best-practices"></a>Tips and best practices

### <a name="indexing-tips"></a>Indexing tips
...
### <a name="querying-tips"></a>Querying tips
**Validate fields**
...
### <a name="filtering-tips"></a>Filtering tips
...
### <a name="tips-about-result-count"></a>Tips about result count
...
### <a name="user-interface-tips"></a>User interface tips
...
### <a name="build-a-filter-for-a-range"></a>Build a filter for a range
...
## <a name="filter-based-on-distance"></a>Filter based on distance
...
## <a name="try-the-demo"></a>Try the demo
