...
### <a name="how-to-connect-to-other-clouds"></a>How to connect to other clouds
...
### <a name="to-connect-to-microsoft-azure-germany"></a>To connect to Microsoft Azure Germany
