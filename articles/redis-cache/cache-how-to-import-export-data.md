...
### <a name="what-rdb-versions-can-i-import"></a>What RDB versions can I import?

Azure Redis Cache supports RDB import up through RDB version 7.

### <a name="is-my-cache-available-during-an-importexport-operation"></a>Is my cache available during an Import/Export operation?
