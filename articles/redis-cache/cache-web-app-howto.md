...
---
# <a name="quickstart-create-an-aspnet-web-app"></a>Quickstart: Create an ASP.NET web app 
...
#### <a name="to-edit-the-cachesecretsconfig-file"></a>To edit the *CacheSecrets.config* file
...
## <a name="update-the-mvc-application"></a>Update the MVC application
...
### <a name="update-the-webconfig-file-with-an-app-setting-for-the-cache"></a>Update the web.config file with an app setting for the cache
...
#### <a name="to-update-the-webconfig-file"></a>To update the *web.config* file
...
### <a name="to-configure-the-application-to-use-stackexchangeredis"></a>To configure the application to use StackExchange.Redis
...
### <a name="to-update-the-homecontroller-and-layout"></a>To update the HomeController and Layout
...
### <a name="to-add-a-new-rediscache-view"></a>To add a new RedisCache view
...
### <a name="to-run-the-app-locally"></a>To run the app locally
...
## <a name="publish-and-run-in-azure"></a>Publish and run in Azure

After you successfully test the app locally, you can deploy the app to Azure and run it in the cloud.

### <a name="to-publish-the-app-to-azure"></a>To publish the app to Azure
...
### <a name="add-the-app-setting-for-the-cache"></a>Add the app setting for the cache
...
#### <a name="to-add-the-app-setting"></a>To add the app setting 
...
### <a name="to-delete-a-resource-group"></a>To delete a resource group
