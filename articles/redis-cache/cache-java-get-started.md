...
---
# <a name="quickstart-how-to-use-azure-redis-cache-with-java"></a>Quickstart: How to use Azure Redis Cache with Java
...
## <a name="create-a-new-java-app"></a>Create a new Java app
