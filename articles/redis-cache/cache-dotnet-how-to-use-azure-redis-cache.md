...
---
# <a name="quickstart-use-azure-redis-cache-with-a-net-application"></a>Quickstart: Use Azure Redis Cache with a .NET application
...
## <a name="configure-the-cache-client"></a>Configure the cache client
...
## <a name="executing-cache-commands"></a>Executing cache commands
