...
## <a name="view-pre-configured-metrics-charts"></a>View pre-configured metrics charts
...
## <a name="view-metrics-with-azure-monitor"></a>View metrics with Azure monitor
...
## <a name="export-cache-metrics"></a>Export cache metrics
