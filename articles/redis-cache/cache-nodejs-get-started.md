...
---
# <a name="quickstart-how-to-use-azure-redis-cache-with-nodejs"></a>Quickstart: How to use Azure Redis Cache with Node.js
...
## <a name="create-a-new-nodejs-app"></a>Create a new Node.js app
