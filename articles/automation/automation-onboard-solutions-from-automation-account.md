...
---
# <a name="onboard-update-management-change-tracking-and-inventory-solutions"></a>Onboard Update Management, Change Tracking, and Inventory solutions
...
## <a name="scope-configuration"></a>Scope Configuration
...
## <a name="onboard-azure-vms"></a>Onboard Azure VMs
...
## <a name="onboard-a-non-azure-machine"></a>Onboard a non-Azure machine
...
## <a name="onboard-machines-in-the-workspace"></a>Onboard machines in the workspace
...
### <a name="all-available-machines"></a>All available machines
...
### <a name="all-available-and-future-machines"></a>All available and future machines
...
### <a name="selected-machines"></a>Selected machines
