...
---
# <a name="onboard-update-and-change-tracking-solutions-to-azure-automation"></a>Onboard update and change tracking solutions to Azure Automation
...
## <a name="onboard-an-azure-vm"></a>Onboard an Azure VM
...
### <a name="enable-change-tracking-and-inventory"></a>Enable Change Tracking and Inventory
...
### <a name="select-azure-vm-to-be-managed"></a>Select Azure VM to be managed
...
## <a name="install-and-update-modules"></a>Install and update modules
...
## <a name="update-azure-modules"></a>Update Azure Modules
...
### <a name="install-azurermoperationalinsights-module"></a>Install AzureRM.OperationalInsights module
...
## <a name="import-the-onboarding-runbook"></a>Import the onboarding runbook
