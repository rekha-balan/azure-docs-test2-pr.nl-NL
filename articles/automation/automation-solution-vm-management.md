...
---
# <a name="startstop-vms-during-off-hours-solution-in-azure-automation"></a>Start/Stop VMs during off-hours solution in Azure Automation
...
### <a name="scenario-1-startstop-vms-on-a-schedule"></a>Scenario 1: Start/Stop VMs on a schedule
...
#### <a name="target-the-start-and-stop-actions-against-a-subscription-and-resource-group"></a>Target the start and stop actions against a subscription and resource group
...
#### <a name="target-the-start-and-stop-action-by-vm-list"></a>Target the start and stop action by VM list
...
### <a name="scenario-2-startstop-vms-in-sequence-by-using-tags"></a>Scenario 2: Start/Stop VMS in sequence by using tags
...
### <a name="scenario-3-startstop-automatically-based-on-cpu-utilization"></a>Scenario 3: Start/Stop automatically based on CPU utilization
...
#### <a name="target-the-stop-action-against-a-subscription-and-resource-group"></a>Target the stop action against a subscription and resource group
...
## <a name="viewing-the-solution"></a>Viewing the solution
...
## <a name="configure-email-notifications"></a>Configure email notifications
...
## <a name="modify-the-startup-and-shutdown-schedules"></a>Modify the startup and shutdown schedules
...
## <a name="update-the-solution"></a>Update the solution
...
## <a name="remove-the-solution"></a>Remove the solution
