...
---
# <a name="deploy-a-linux-hybrid-runbook-worker"></a>Deploy a Linux Hybrid Runbook Worker
...
## <a name="installing-a-linux-hybrid-runbook-worker"></a>Installing a Linux Hybrid Runbook Worker
...
## <a name="turning-off-signature-validation"></a>Turning off signature validation
...
## <a name="supported-runbook-types"></a>Supported runbook types
