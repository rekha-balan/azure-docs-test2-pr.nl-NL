...
---
# <a name="enable-update-management-change-tracking-and-inventory-solutions-on-multiple-vms"></a>Enable Update Management, Change Tracking, and Inventory solutions on multiple VMs
...
## <a name="enable-solutions"></a>Enable solutions
...
### <a name="vm-reports-to-a-different-workspace-workspacename--change-configuration-to-use-it-for-enabling"></a>VM reports to a different workspace: '\<workspaceName\>'.  Change configuration to use it for enabling
...
### <a name="vm-reports-to-a-workspace-that-is-not-available-in-this-subscription"></a>VM reports to a workspace that is not available in this subscription
...
### <a name="vm-operating-system-version-or-distribution-is-not-supported"></a>VM operating system version or distribution is not supported
...
### <a name="classic-vms-cannot-be-enabled"></a>Classic VMs cannot be enabled
...
### <a name="vm-is-stopped-deallocated"></a>VM is stopped. (deallocated)
