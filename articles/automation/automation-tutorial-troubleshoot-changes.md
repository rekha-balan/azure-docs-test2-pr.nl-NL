...
---
# <a name="troubleshoot-changes-in-your-environment"></a>Troubleshoot changes in your environment
...
![Enable change](./media/automation-tutorial-troubleshoot-changes/enableinventory.png) The **Change Tracking** screen opens. Configure the location, Log analytics workspace, and Automation account to use and click **Enable**. If the fields are grayed out, that means another automation solution is enabled for the VM and the same workspace and Automation account must be used.
...
## <a name="using-change-tracking-in-log-analytics"></a>Using Change tracking in Log Analytics
...
Change tracking data is stored under the type **ConfigurationChange**. The following sample Log Analytics query returns all the Windows Services that have been stopped.
...
## <a name="configure-change-tracking"></a>Configure Change tracking
...
### <a name="add-a-windows-registry-key"></a>Add a Windows Registry key
...
### <a name="add-a-windows-file"></a>Add a Windows file
...
### <a name="add-a-linux-file"></a>Add a Linux file
...
## <a name="enable-activity-log-connection"></a>Enable Activity log connection
...
## <a name="view-changes"></a>View changes
