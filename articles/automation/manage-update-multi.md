...
---
# <a name="manage-updates-for-multiple-machines"></a>Manage updates for multiple machines
...
## <a name="enable-update-management-for-azure-virtual-machines"></a>Enable Update Management for Azure virtual machines
...
## <a name="enable-update-management-for-non-azure-virtual-machines-and-computers"></a>Enable Update Management for non-Azure virtual machines and computers
...
## <a name="view-computers-attached-to-your-automation-account"></a>View computers attached to your Automation account
...
## <a name="view-an-update-assessment"></a>View an update assessment
...
## <a name="schedule-an-update-deployment"></a>Schedule an update deployment
...
## <a name="view-results-of-an-update-deployment"></a>View results of an update deployment
