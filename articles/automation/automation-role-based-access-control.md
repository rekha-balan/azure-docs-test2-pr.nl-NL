...
## <a name="roles-in-automation-accounts"></a>Roles in Automation accounts
...
### <a name="automation-job-operator"></a>Automation Job Operator
...
### <a name="onboarding-from-a-virtual-machine"></a>Onboarding from a virtual machine
...
### <a name="onboarding-from-automation-account"></a>Onboarding from Automation account
...
## <a name="configure-rbac-for-your-automation-account"></a>Configure RBAC for your Automation account
...
### <a name="configure-rbac-using-the-azure-portal"></a>Configure RBAC using the Azure portal
...
### <a name="configure-rbac-using-powershell"></a>Configure RBAC using PowerShell
...
### <a name="user-experience-for-automation-operator-role---automation-account"></a>User experience for Automation operator role - Automation Account
...
## <a name="configure-rbac-for-runbooks"></a>Configure RBAC for Runbooks
...
### <a name="user-experience-for-automation-operator-role---runbook"></a>User experience for Automation operator role - Runbook
