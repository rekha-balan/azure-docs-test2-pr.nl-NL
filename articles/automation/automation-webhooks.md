...
---
# <a name="starting-an-azure-automation-runbook-with-a-webhook"></a>Starting an Azure Automation runbook with a webhook
...
![WebhooksOverview](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-webhooks/webhook-overview-image.png)
...
## <a name="details-of-a-webhook"></a>Details of a webhook
...
## <a name="creating-a-webhook"></a>Creating a webhook
...
2. Click **Webhook** at the top of the blade to open the **Add Webhook** blade. <br>
   ![Webhooks button](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-webhooks/webhooks-button.png)
...
5. Click the copy icon and press Ctrl+C to copy the URL of the webhook.  Then record it in a safe place.  **Once you create the webhook, you cannot retrieve the URL again.** <br>
   ![Webhook URL](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-webhooks/copy-webhook-url.png)
...
## <a name="using-a-webhook"></a>Using a webhook
...
## <a name="starting-runbooks-in-response-to-azure-alerts"></a>Starting runbooks in response to Azure alerts
...
### <a name="alert-context"></a>Alert context
