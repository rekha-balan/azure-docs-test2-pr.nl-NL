...
---
# <a name="manage-azure-automation-run-as-accounts"></a>Manage Azure Automation Run As accounts
...
## <a name="create-a-run-as-account-in-the-portal"></a>Create a Run As account in the Portal
...
## <a name="create-run-as-account-using-powershell"></a>Create Run As account using PowerShell
