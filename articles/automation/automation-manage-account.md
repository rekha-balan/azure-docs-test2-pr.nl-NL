...
---
# <a name="manage-azure-automation-account"></a>Manage Azure Automation account
...
![Incomplete Run As configuration warning message](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-manage-account/automation-account-runas-incomplete-config-msg.png).
