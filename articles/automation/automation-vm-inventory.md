...
---
# <a name="manage-an-azure-virtual-machine-with-inventory-collection"></a>Manage an Azure virtual machine with inventory collection
...
## <a name="enable-inventory-collection-from-the-virtual-machine-resource-page"></a>Enable inventory collection from the virtual machine resource page
...
## <a name="configure-your-inventory-settings"></a>Configure your inventory settings
...
### <a name="linux-files"></a>Linux Files
...
## <a name="manage-machine-groups"></a>Manage machine groups
...
## <a name="disconnect-your-virtual-machine-from-management"></a>Disconnect your virtual machine from management
