...
## <a name="composite-resources"></a>Composite Resources

**Composite Resources** allow you to use DSC configurations as nested resources inside of a configuration. This enables you to apply multiple configurations to a single resource. See [Composite resources: Using a DSC configuration as a resource](/powershell/dsc/authoringresourcecomposite) to learn more about **Composite Resources**.
...
### <a name="importing-a-node-configuration-with-powershell"></a>Importing a node configuration with PowerShell
