...
## <a name="permissions-required-to-create-an-automation-account"></a>Permissions required to create an Automation account
...
## <a name="create-a-new-automation-account-in-the-azure-portal"></a>Create a new Automation account in the Azure portal
