...
---
# <a name="manage-windows-updates-by-using-azure-automation"></a>Manage Windows updates by using Azure Automation
...
## <a name="view-update-assessment"></a>View update assessment
...
### <a name="alert-conditions"></a>Alert conditions

For each type of alert, there are different alert conditions that need to be defined.

#### <a name="log-analytics-query-alert"></a>Log Analytics query alert
...
#### <a name="runbook-alert"></a>Runbook alert

For failed deployments you must alert of the failure of the master run In the Azure portal, go to **Monitor**, and then select **Create Alert**.
...
### <a name="alert-details"></a>Alert details
