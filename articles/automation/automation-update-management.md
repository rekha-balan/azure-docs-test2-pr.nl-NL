...
---
# <a name="update-management-solution-in-azure"></a>Update Management solution in Azure
...
### <a name="confirm-that-non-azure-machines-are-onboarded"></a>Confirm that non-Azure machines are onboarded
...
## <a name="install-updates"></a>Install updates
...
## <a name="view-missing-updates"></a>View missing updates
...
## <a name="view-update-deployments"></a>View update deployments
...
## <a name="create-or-edit-an-update-deployment"></a>Create or edit an update deployment
...
#### <a name="single-azure-vm-assessment-queries-windows"></a>Single Azure VM Assessment queries (Windows)
...
##### <a name="missing-updates-summary"></a>Missing updates summary
...
##### <a name="missing-updates-list"></a>Missing updates list
...
#### <a name="single-azure-vm-assessment-queries-linux"></a>Single Azure VM assessment queries (Linux)
...
#### <a name="multi-vm-assessment-queries"></a>Multi-VM assessment queries

##### <a name="computers-summary"></a>Computers summary
...
##### <a name="computers-list"></a>Computers list
...
## <a name="integrate-with-system-center-configuration-manager"></a>Integrate with System Center Configuration Manager
...
## <a name="patch-linux-machines"></a>Patch Linux machines

The following sections explain potential issues with Linux patching.

### <a name="unexpected-os-level-upgrades"></a>Unexpected OS-level upgrades
...
### <a name="critical--security-patches-arent-applied"></a>Critical / security patches aren't applied
