...
---
# <a name="troubleshooting-common-issues-in-azure-automation"></a>Troubleshooting common issues in Azure Automation 
...
## <a name="authentication-errors-when-working-with-azure-automation-runbooks"></a>Authentication errors when working with Azure Automation runbooks
...
## <a name="common-errors-when-working-with-runbooks"></a>Common errors when working with runbooks
...
## <a name="common-errors-when-importing-modules"></a>Common errors when importing modules
...
**Troubleshooting tips:** Follow the instructions in the [DSC known issues and limitations](https://msdn.microsoft.com/powershell/wmf/5.0/limitation_dsc) to fix the issue.
