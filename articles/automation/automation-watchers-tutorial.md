...
---
# <a name="create-an-azure-automation-watcher-tasks-to-track-file-changes-on-a-local-machine"></a>Create an Azure Automation watcher tasks to track file changes on a local machine
...
## <a name="import-a-watcher-runbook"></a>Import a watcher runbook
...
## <a name="create-an-automation-variable"></a>Create an Automation variable
...
## <a name="create-an-action-runbook"></a>Create an action runbook
...
## <a name="create-a-watcher-task"></a>Create a watcher task
...
## <a name="trigger-a-watcher"></a>Trigger a watcher
...
## <a name="inspect-the-output"></a>Inspect the output
