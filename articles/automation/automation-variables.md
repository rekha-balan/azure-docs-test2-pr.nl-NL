...
## <a name="creating-an-automation-variable"></a>Creating an Automation variable

### <a name="to-create-a-variable-with-the-azure-portal"></a>To create a variable with the Azure portal
...
### <a name="to-create-a-variable-with-windows-powershell"></a>To create a variable with Windows PowerShell
...
#### <a name="setting-and-retrieving-a-secure-string"></a>Setting and retrieving a secure string
