...
---
# <a name="use-an-alert-to-trigger-an-azure-automation-runbook"></a>Use an alert to trigger an Azure Automation runbook
...
## <a name="alert-types"></a>Alert types
...
## <a name="create-a-runbook-to-handle-alerts"></a>Create a runbook to handle alerts
...
## <a name="create-an-action-group"></a>Create an action group
...
### <a name="runbook-action"></a>Runbook action
...
### <a name="notification-action"></a>Notification action
...
## <a name="classic-alert"></a>Classic alert
