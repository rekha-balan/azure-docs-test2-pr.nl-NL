...
ms.date: 01/23/2017
ms.author: carolz
ms.openlocfilehash: 41902b26055cf2c86711046264f9a46cd95b3985
ms.sourcegitcommit: 5b9d839c0c0a94b293fdafe1d6e5429506c07e05
ms.translationtype: MT
ms.contentlocale: nl-NL
ms.lasthandoff: 08/02/2018
ms.locfileid: "44549425"
---
...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="/azure-nomedia/automation/automation-intro">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/index/automation.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/index/video-library.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
    ...
    <li>
        <a href="/azure-nomedia/automation/automation-first-runbook-graphical">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/index/tutorial.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
    ...
    <li>
        <a href="/azure-nomedia/automation/automation-first-runbook-textual-powershell">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/index/powershell.svg" alt="" />
                        </div>
                    </div>
                    <div class="cardText">
    ...
    <li>
        <a href="/azure-nomedia/automation/automation-first-runbook-textual">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="/azure-nomedia/automation/automation-role-based-access-control">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
