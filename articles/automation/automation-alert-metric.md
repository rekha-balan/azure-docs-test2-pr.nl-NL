...
---
# <a name="monitoring-runbooks-with-metric-alerts"></a>Monitoring runbooks with metric alerts
...
## <a name="create-alert"></a>Create alert
...
### <a name="define-the-alert-condition"></a>Define the alert condition
...
### <a name="configure-alert-criteria"></a>Configure alert criteria
...
### <a name="define-alert-details"></a>Define alert details
