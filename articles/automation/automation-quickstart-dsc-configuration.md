...
---
# <a name="configure-a-linux-virtual-machine-with-desired-state-configuration"></a>Configure a Linux virtual machine with Desired State Configuration
...
## <a name="onboard-a-virtual-machine"></a>Onboard a virtual machine
...
## <a name="import-modules"></a>Import modules
...
## <a name="import-the-configuration"></a>Import the configuration
...
## <a name="compile-a-configuration"></a>Compile a configuration
...
## <a name="assign-a-node-configuration"></a>Assign a node configuration
...
## <a name="viewing-node-status"></a>Viewing node status
