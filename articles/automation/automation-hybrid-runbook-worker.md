...
---
# <a name="automate-resources-in-your-datacenter-or-cloud-by-using-hybrid-runbook-worker"></a>Automate resources in your datacenter or cloud by using Hybrid Runbook Worker
...
## <a name="install-a-hybrid-runbook-worker"></a>Install a Hybrid Runbook Worker
...
## <a name="remove-a-hybrid-runbook-worker"></a>Remove a Hybrid Runbook Worker
...
## <a name="remove-a-hybrid-worker-group"></a>Remove a Hybrid Worker group
...
### <a name="hybrid-worker-role"></a>Hybrid Worker role
