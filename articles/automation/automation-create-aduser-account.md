...
---
# <a name="authenticate-runbooks-with-azure-classic-deployment-and-resource-manager"></a>Authenticate Runbooks with Azure classic deployment and Resource Manager
...
3. In the Automation Accounts blade, click **Add**.<br><br>![Add Automation Account](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-create-aduser-account/add-automation-acct-properties.png)
