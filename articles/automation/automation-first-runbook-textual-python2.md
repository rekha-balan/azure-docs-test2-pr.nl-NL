...
---
# <a name="my-first-python-runbook"></a>My first Python runbook
...
## <a name="create-a-new-runbook"></a>Create a new runbook
...
## <a name="add-code-to-the-runbook"></a>Add code to the runbook
...
## <a name="test-the-runbook"></a>Test the runbook
...
## <a name="publish-and-start-the-runbook"></a>Publish and start the runbook
...
## <a name="add-authentication-to-manage-azure-resources"></a>Add authentication to manage Azure resources
...
## <a name="add-code-to-create-python-compute-client-and-start-the-vm"></a>Add code to create Python Compute client and start the VM

To work with Azure VMs, create an instance of the [Azure Compute client for Python](https://docs.microsoft.com/python/api/azure.mgmt.compute.computemanagementclient?view=azure-python).
...
## <a name="use-input-parameters"></a>Use input parameters
