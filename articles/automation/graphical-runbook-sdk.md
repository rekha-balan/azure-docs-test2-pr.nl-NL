...
---
# <a name="use-the-azure-automation-graphical-runbook-sdk"></a>Use the Azure Automation Graphical runbook SDK
...
## <a name="create-a-runbook-object-instance"></a>Create a runbook object instance
...
## <a name="add-runbook-parameters"></a>Add runbook parameters
...
## <a name="add-activities-and-links"></a>Add activities and links
...
## <a name="save-the-runbook-to-a-file"></a>Save the runbook to a file
