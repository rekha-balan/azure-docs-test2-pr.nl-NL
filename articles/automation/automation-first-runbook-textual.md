...
2. Click on the **Runbooks** tile to open the list of runbooks.<br><br> ![Runbooks control](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/runbooks-control-tiles.png)
...
5. In this case, we're going to create a [PowerShell Workflow runbook](automation-runbook-types.md#powershell-workflow-runbooks) so select **Powershell Workflow** for **Runbook type**.<br><br> ![New runbook](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/new-runbook-properties.png)
...
2. Type *Write-Output "Hello World."* between the braces.
   ...
   ```
3. Save the runbook by clicking **Save**.<br><br> ![Save runbook](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/automation-runbook-edit-controls-save.png)

## <a name="step-3---test-the-runbook"></a>Step 3 - Test the runbook
Before we publish the runbook to make it available in production, we want to test it to make sure that it works properly. When you test a runbook, you run its **Draft** version and view its output interactively.

1. Click **Test pane** to open the Test pane.<br><br> ![Test pane](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/automation-runbook-edit-controls-test.png)
...
4. When the runbook job completes, its output is displayed. In our case, we should see *Hello World*.<br><br> ![Hello World](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/test-output-hello-world.png)
...
1. Click **Publish** to publish the runbook and then **Yes** when prompted.<br><br> ![Publish](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/automation-runbook-edit-controls-publish.png)
...
4. We just want to start the runbook so click **Start** and then **Yes** when prompted.<br><br> ![Start runbook](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/automation-runbook-controls-start.png)
...
6. The job status is shown in **Job Summary** and matches the statuses that we saw when we tested the runbook.<br><br> ![Job Summary](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/job-pane-status-blade-jobsummary.png)
7. Once the runbook status shows *Completed*, click **Output**. The Output pane is opened, and we can see our *Hello World*.<br><br> ![Job Summary](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/job-pane-status-blade-outputtile.png)  
8. Close the Output pane.
9. Click **All Logs** to open the Streams pane for the runbook job. We should only see *Hello World* in the output stream, but this can show other streams for a runbook job such as Verbose and Error if the runbook writes to them.<br><br> ![Job Summary](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/job-pane-status-blade-alllogstile.png)
10. Close the Streams pane and the Job pane to return to the MyFirstRunbook pane.
11. Click **Jobs** to open the Jobs pane for this runbook. This lists all of the jobs created by this runbook. We should only see one job listed since we only ran the job once.<br><br> ![Jobs](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/runbook-control-job-tile.png)
...
1. Open the textual editor by clicking **Edit** on the MyFirstRunbook-Workflow pane.<br><br> ![Edit runbook](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/automation-runbook-controls-edit.png)
...
6. Click **Start** to start the test. Once it completes, you should receive output similar to the following, displaying basic information from your account. This confirms that the credential is valid.<br><br> ![Authenticate](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/runbook-auth-output.png)
...
6. Click **Start** to start the runbook. Type in the **VMName** and **ResourceGroupName** for the virtual machine that you're going to start.<br><br> ![Start Runbook](https://docstestmedia1.blob.core.windows.net/azure-media/articles/automation/media/automation-first-runbook-textual/automation-pass-params.png)<br>  
