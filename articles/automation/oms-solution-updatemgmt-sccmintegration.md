...
---
# <a name="integrate-system-center-configuration-manager-with-update-management"></a>Integrate System Center Configuration Manager with Update Management
...
### <a name="manage-software-updates-from-configuration-manager"></a>Manage software updates from Configuration Manager 
...
### <a name="manage-software-updates-from-azure-automation"></a>Manage software updates from Azure Automation
