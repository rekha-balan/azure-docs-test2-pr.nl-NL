...
---
# <a name="route-custom-events-to-azure-event-hubs-with-azure-cli-and-event-grid"></a>Route custom events to Azure Event Hubs with Azure CLI and Event Grid
...
## <a name="create-event-hub"></a>Create event hub
