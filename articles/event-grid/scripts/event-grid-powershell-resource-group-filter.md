...
---
# <a name="subscribe-to-events-for-a-resource-group-and-filter-for-a-resource-with-powershell"></a>Subscribe to events for a resource group and filter for a resource with PowerShell
