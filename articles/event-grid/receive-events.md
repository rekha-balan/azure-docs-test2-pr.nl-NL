...
---
# <a name="receive-events-to-an-http-endpoint"></a>Receive events to an HTTP endpoint
...
## <a name="endpoint-validation"></a>Endpoint validation
...
### <a name="test-validation-response"></a>Test validation response
...
## <a name="handle-blob-storage-events"></a>Handle Blob storage events
...
### <a name="test-blob-created-event-handling"></a>Test Blob Created event handling
...
## <a name="handle-custom-events"></a>Handle Custom events
...
### <a name="test-custom-event-handling"></a>Test custom event handling
