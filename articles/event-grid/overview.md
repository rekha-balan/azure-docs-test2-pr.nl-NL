...
---
# <a name="an-introduction-to-azure-event-grid"></a>An introduction to Azure Event Grid
...
## <a name="event-sources"></a>Event sources
...
## <a name="what-can-i-do-with-event-grid"></a>What can I do with Event Grid?

Azure Event Grid provides several capabilities that vastly improve serverless, ops automation, and integration work: 

### <a name="serverless-application-architectures"></a>Serverless application architectures
...
## <a name="how-much-does-event-grid-cost"></a>How much does Event Grid cost?
