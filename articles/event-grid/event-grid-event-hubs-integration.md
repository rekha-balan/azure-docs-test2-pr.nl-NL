...
---
# <a name="stream-big-data-into-a-data-warehouse"></a>Stream big data into a data warehouse
...
## <a name="about-the-event-data"></a>About the event data
...
## <a name="deploy-the-infrastructure"></a>Deploy the infrastructure
...
## <a name="create-a-table-in-sql-data-warehouse"></a>Create a table in SQL Data Warehouse
...
## <a name="publish-the-azure-functions-app"></a>Publish the Azure Functions app
...
## <a name="subscribe-to-the-event"></a>Subscribe to the event
...
## <a name="run-the-app-to-generate-data"></a>Run the app to generate data
