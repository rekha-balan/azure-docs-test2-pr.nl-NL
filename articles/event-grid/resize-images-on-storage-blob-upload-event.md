...
---
# <a name="automate-resizing-uploaded-images-using-event-grid"></a>Automate resizing uploaded images using Event Grid
...
## <a name="deploy-the-function-code"></a>Deploy the function code 
...
## <a name="create-an-event-subscription"></a>Create an event subscription
...
## <a name="test-the-sample-app"></a>Test the sample app
