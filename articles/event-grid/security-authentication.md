...
---
# <a name="event-grid-security-and-authentication"></a>Event Grid security and authentication 
...
### <a name="validation-details"></a>Validation details
...
### <a name="event-delivery-security"></a>Event delivery security
...
### <a name="system-topics-azure-service-publishers"></a>System topics (Azure service publishers)
...
## <a name="topic-publishing"></a>Topic publishing
...
### <a name="key-authentication"></a>Key authentication
...
### <a name="operation-types"></a>Operation types
...
### <a name="enforcing-role-based-access-check-rbac"></a>Enforcing Role Based Access Check (RBAC)

Use the following steps to enforce RBAC for different users:

#### <a name="create-a-custom-role-definition-file-json"></a>Create a custom role definition file (.json)
...
#### <a name="create-and-assign-custom-role-with-azure-cli"></a>Create and assign custom role with Azure CLI
