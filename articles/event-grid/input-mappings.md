...
---
# <a name="map-custom-fields-to-event-grid-schema"></a>Map custom fields to Event Grid schema
...
## <a name="original-event-schema"></a>Original event schema
...
## <a name="create-custom-topic-with-mapped-fields"></a>Create custom topic with mapped fields
...
## <a name="subscribe-to-event-grid-topic"></a>Subscribe to event grid topic
...
## <a name="publish-event-to-topic"></a>Publish event to topic
