...
---
# <a name="route-custom-events-to-azure-queue-storage-with-azure-cli-and-event-grid"></a>Route custom events to Azure Queue storage with Azure CLI and Event Grid
...
## <a name="create-queue-storage"></a>Create Queue storage
