...
---
# <a name="route-custom-events-to-azure-relay-hybrid-connections-with-azure-cli-and-event-grid"></a>Route custom events to Azure Relay Hybrid Connections with Azure CLI and Event Grid
...
## <a name="create-a-custom-topic"></a>Create a custom topic
...
## <a name="subscribe-to-a-topic"></a>Subscribe to a topic
...
## <a name="create-application-to-process-events"></a>Create application to process events
...
## <a name="send-an-event-to-your-topic"></a>Send an event to your topic
