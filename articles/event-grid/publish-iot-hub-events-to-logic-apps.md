...
---
# <a name="send-email-notifications-about-azure-iot-hub-events-using-logic-apps"></a>Send email notifications about Azure IoT Hub events using Logic Apps
...
## <a name="create-a-new-device"></a>Create a new device
