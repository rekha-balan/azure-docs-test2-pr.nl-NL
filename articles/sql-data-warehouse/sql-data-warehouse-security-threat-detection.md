...
---
# <a name="threat-detection-in-azure-sql-data-warehouse"></a>Threat detection in Azure SQL Data Warehouse
Configure threat detection and explore suspicious events in Azure SQL Data Warehouse.

## <a name="what-is-threat-detection"></a>What is threat detection
