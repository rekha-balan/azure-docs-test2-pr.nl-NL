...
## <a name="what-are-table-partitions"></a>What are table partitions?
...
## <a name="sizing-partitions"></a>Sizing partitions
...
## <a name="syntax-differences-from-sql-server"></a>Syntax differences from SQL Server
