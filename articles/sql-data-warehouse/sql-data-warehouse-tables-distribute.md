...
---
# <a name="guidance-for-designing-distributed-tables-in-azure-sql-data-warehouse"></a>Guidance for designing distributed tables in Azure SQL Data Warehouse
...
## <a name="what-is-a-distributed-table"></a>What is a distributed table?
...
### <a name="hash-distributed"></a>Hash distributed
...
### <a name="round-robin-distributed"></a>Round-robin distributed
...
## <a name="choosing-a-distribution-column"></a>Choosing a distribution column
...
### <a name="choose-a-distribution-column-that-does-not-require-updates"></a>Choose a distribution column that does not require updates
...
### <a name="choose-a-distribution-column-with-data-that-distributes-evenly"></a>Choose a distribution column with data that distributes evenly
...
### <a name="choose-a-distribution-column-that-minimizes-data-movement"></a>Choose a distribution column that minimizes data movement
...
### <a name="what-to-do-when-none-of-the-columns-are-a-good-distribution-column"></a>What to do when none of the columns are a good distribution column
...
## <a name="how-to-tell-if-your-distribution-column-is-a-good-choice"></a>How to tell if your distribution column is a good choice
...
### <a name="determine-if-the-table-has-data-skew"></a>Determine if the table has data skew
...
### <a name="check-query-plans-for-data-movement"></a>Check query plans for data movement
...
## <a name="resolve-a-distribution-column-problem"></a>Resolve a distribution column problem
...
### <a name="re-create-the-table-with-a-new-distribution-column"></a>Re-create the table with a new distribution column
