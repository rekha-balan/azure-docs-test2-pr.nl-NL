...
---
# <a name="load-data-into-sql-data-warehouse-with-data-factory"></a>Load data into SQL Data Warehouse with Data Factory
...
## <a name="configure-a-data-factory"></a>Configure a data factory
...
## <a name="configure-the-data-factory-properties"></a>Configure the data factory properties
...
## <a name="configure-the-source-data-store-and-gateway"></a>Configure the source data store and gateway
...
## <a name="configure-the-destination-your-sql-data-warehouse"></a>Configure the destination, your SQL Data Warehouse
...
## <a name="configure-the-performance-settings"></a>Configure the performance settings
...
## <a name="review-summary-information-and-deploy-the-pipeline"></a>Review summary information and deploy the pipeline
...
## <a name="monitor-data-loading-progress"></a>Monitor data loading progress
