...
---
# <a name="load-data-from-azure-data-lake-store-into-sql-data-warehouse"></a>Load data from Azure Data Lake Store into SQL Data Warehouse
...
### <a name="create-the-external-data-source"></a>Create the external data source
...
## <a name="configure-data-format"></a>Configure data format
...
## <a name="create-the-external-tables"></a>Create the external tables
...
## <a name="optimize-columnstore-compression"></a>Optimize columnstore compression
...
## <a name="optimize-statistics"></a>Optimize statistics
