...
---
# <a name="migrate-your-schemas-to-sql-data-warehouse"></a>Migrate your schemas to SQL Data Warehouse
Guidance for migrating your SQL schemas to SQL Data Warehouse. 

## <a name="plan-your-schema-migration"></a>Plan your schema migration
...
## <a name="use-user-defined-schemas-to-consolidate-databases"></a>Use user-defined schemas to consolidate databases
...
## <a name="use-compatible-data-types"></a>Use compatible data types
...
## <a name="minimize-row-size"></a>Minimize row size
...
## <a name="specify-the-distribution-option"></a>Specify the distribution option
