...
```
## <a name="monitor-memory"></a>Monitor memory
...
```
## <a name="monitor-transaction-log-size"></a>Monitor transaction log size
...
```
## <a name="monitor-transaction-log-rollback"></a>Monitor transaction log rollback
