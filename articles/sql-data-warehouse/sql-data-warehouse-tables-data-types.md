...
---
# <a name="table-data-types-in-azure-sql-data-warehouse"></a>Table data types in Azure SQL Data Warehouse
Recommendations for defining table data types in Azure SQL Data Warehouse. 

## <a name="what-are-the-data-types"></a>What are the data types?
...
## <a name="minimize-row-length"></a>Minimize row length
...
## <a name="identify-unsupported-data-types"></a>Identify unsupported data types
