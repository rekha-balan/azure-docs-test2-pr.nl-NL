...
---
# <a name="get-started-with-sql-data-warehouse"></a>Get started with SQL Data Warehouse
...
### <a name="sign-up-for-microsoft-azure"></a>Sign up for Microsoft Azure
...
### <a name="install-appropriate-sql-client-drivers-and-tools"></a>Install appropriate SQL client drivers and tools
...
### <a name="create-a-data-warehouse"></a>Create a data warehouse

1. Sign into the [Azure portal](https://portal.azure.com).
2. Click **New** > **Databases** > **SQL Data Warehouse**.

    ![NewBlade](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/sql-data-warehouse-create-dw/blade-click-new.png) ![SelectDW](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/sql-data-warehouse-create-dw/blade-select-dw.png)
...
4. Choose **Pin to dashboard** ![Pin To Dashboard](https://docstestmedia1.blob.core.windows.net/azure-media/articles/sql-data-warehouse/media/sql-data-warehouse-get-started-tutorial/pin-to-dashboard.png)
...
### <a name="notes-about-resource-classes-for-allocating-resources-to-queries"></a>Notes about resource classes for allocating resources to queries
...
### <a name="create-an-account-that-can-control-a-database"></a>Create an account that can control a database
...
### <a name="give-the-user-medium-resource-allocations"></a>Give the user medium resource allocations
...
### <a name="define-external-data"></a>Define external data
...
### <a name="import-the-data-from-azure-blob-storage"></a>Import the data from Azure blob storage.
...
## <a name="improve-query-performance"></a>Improve query performance
...
### <a name="see-the-effect-of-scaling-on-query-performance"></a>See the effect of scaling on query performance 
...
> [!NOTE]
> Since SQL Data Warehouse uses massively parallel processing. Queries that scan or perform analytic functions on millions of rows experience the true power of Azure SQL Data Warehouse.
>

### <a name="see-the-effect-of-statistics-on-query-performance"></a>See the effect of statistics on query performance
...
3. Run this statement to create statistics on the join columns.
    ...
    > 
    > **You gain the most benefit by having statistics on columns involved in joins, columns used in the WHERE clause and columns found in GROUP BY.**
    >
...
## <a name="useful-readings"></a>Useful readings
