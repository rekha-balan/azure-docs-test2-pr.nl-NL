...
---
# <a name="add-an-internal-support-statement-to-a-lab-in-azure-devtest-labs"></a>Add an internal support statement to a lab in Azure DevTest Labs
...
## <a name="steps-to-add-a-support-statement-to-an-existing-lab"></a>Steps to add a support statement to an existing lab
...
## <a name="steps-for-users-to-view-the-support-message"></a>Steps for users to view the support message
