...
---
# <a name="manage-classroom-labs-in-azure-lab-services"></a>Manage classroom labs in Azure Lab Services 
...
## <a name="create-a-classroom-lab"></a>Create a classroom lab
...
## <a name="configure-usage-policy"></a>Configure usage policy
...
## <a name="set-up-the-template"></a>Set up the template
...
### <a name="set-template-title-and-description"></a>Set template title and description
...
### <a name="set-up-the-template-vm"></a>Set up the template VM
...
### <a name="publish-the-template"></a>Publish the template 
...
## <a name="send-registration-link-to-students"></a>Send registration link to students
...
## <a name="view-all-classroom-labs"></a>View all classroom labs
...
## <a name="delete-a-classroom-lab"></a>Delete a classroom lab
