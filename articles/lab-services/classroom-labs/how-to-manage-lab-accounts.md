...
---
# <a name="manage-lab-accounts-in-azure-lab-services"></a>Manage lab accounts in Azure Lab Services 
...
## <a name="create-a-lab-account"></a>Create a lab account
...
## <a name="add-a-user-to-the-lab-creator-role"></a>Add a user to the Lab Creator role
...
## <a name="specify-marketplace-images-available-to-lab-owners"></a>Specify Marketplace images available to lab owners
...
## <a name="view-lab-accounts"></a>View lab accounts
1. Sign in to the [Azure portal](https://portal.azure.com).
...
## <a name="delete-a-lab-account"></a>Delete a lab account
