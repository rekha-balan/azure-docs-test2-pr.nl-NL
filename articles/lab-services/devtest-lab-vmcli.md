...
---
# <a name="create-and-manage-virtual-machines-with-devtest-labs-using-the-azure-cli"></a>Create and manage virtual machines with DevTest Labs using the Azure CLI
...
## <a name="create-and-verify-the-virtual-machine"></a>Create and verify the virtual machine 
...
## <a name="start-and-connect-to-the-virtual-machine"></a>Start and connect to the virtual machine
Start a VM.
```azurecli
...
## <a name="update-the-virtual-machine"></a>Update the virtual machine
...
## <a name="stop-and-delete-the-virtual-machine"></a>Stop and delete the virtual machine    
Stop a VM.
```azurecli
