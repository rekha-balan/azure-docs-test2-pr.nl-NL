...
---
# <a name="create-virtual-machines-using-an-azure-resource-manager-template"></a>Create virtual machines using an Azure Resource Manager template 
...
## <a name="multi-vm-vs-single-vm-resource-manager-templates"></a>Multi-VM vs. single-VM Resource Manager templates
...
## <a name="view-and-save-a-virtual-machines-resource-manager-template"></a>View and save a virtual machine's Resource Manager template
