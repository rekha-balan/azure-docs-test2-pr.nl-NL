...
---
# <a name="use-powershell-to-add-a-marketplace-image-to-a-lab-in-azure-devtest-labs"></a>Use PowerShell to add a marketplace image to a lab in Azure DevTest Labs
