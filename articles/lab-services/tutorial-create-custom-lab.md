...
---
# <a name="tutorial-set-up-a-lab-by-using-azure-devtest-labs"></a>Tutorial: Set up a lab by using Azure DevTest Labs
...
## <a name="create-a-lab"></a>Create a lab
...
## <a name="add-a-vm-to-the-lab"></a>Add a VM to the lab
...
## <a name="add-a-user-to-the-lab-user-role"></a>Add a user to the Lab User role
