...
---
# <a name="add-a-git-repository-to-store-custom-artifacts-and-resource-manager-templates"></a>Add a Git repository to store custom artifacts and Resource Manager templates
...
### <a name="get-the-azure-repos-clone-url-and-personal-access-token"></a>Get the Azure Repos clone URL and personal access token
...
## <a name="connect-your-lab-to-the-repository"></a>Connect your lab to the repository
