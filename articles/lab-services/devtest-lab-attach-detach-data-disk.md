...
---
# <a name="attach-or-detach-a-data-disk-to-a-virtual-machine-in-azure-devtest-labs"></a>Attach or detach a data disk to a virtual machine in Azure DevTest Labs
...
## <a name="detach-a-data-disk"></a>Detach a data disk
...
### <a name="detach-from-the-vms-management-pane"></a>Detach from the VM's management pane
...
### <a name="detach-from-the-labs-main-pane"></a>Detach from the lab's main pane
...
## <a name="upgrade-an-unmanaged-data-disk"></a>Upgrade an unmanaged data disk
