...
---
# <a name="import-vms-from-another-lab-in-azure-devtest-labs"></a>Import VMs from another lab in Azure DevTest Labs
...
## <a name="solution-and-constraints"></a>Solution and constraints
...
## <a name="steps-to-import-a-vm-from-another-lab"></a>Steps to import a VM from another lab
...
#### <a name="import-a-single-vm"></a>Import a single VM
...
#### <a name="importing-all-vms"></a>Importing all VMs
