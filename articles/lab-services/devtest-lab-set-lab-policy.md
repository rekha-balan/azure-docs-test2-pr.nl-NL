...
---
# <a name="manage-all-policies-for-a-lab-in-azure-devtest-labs"></a>Manage all policies for a lab in Azure DevTest Labs
...
## <a name="set-expiration-date"></a>Set expiration date
...
* [Create a VM in a lab](devtest-lab-add-vm.md) - Illustrates how to create a VM from a base image (either custom or Marketplace), and how to work with artifacts in your VM.
