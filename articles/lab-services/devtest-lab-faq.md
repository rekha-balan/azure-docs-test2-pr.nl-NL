...
## <a name="how-can-i-use-devtest-labs"></a>How can I use DevTest Labs?
...
## <a name="how-am-i-billed-for-devtest-labs"></a>How am I billed for DevTest Labs?
...
**Security**
## <a name="what-are-the-different-security-levels-in-devtest-labs"></a>What are the different security levels in DevTest Labs?
...
## <a name="does-devtest-labs-integrate-with-my-cicd-toolchain"></a>Does DevTest Labs integrate with my CI/CD toolchain?
...
**Virtual machines**
## <a name="why-cant-i-see-vms-on-the-virtual-machines-blade-that-i-see-in-devtest-labs"></a>Why can't I see VMs on the Virtual Machines blade that I see in DevTest Labs?
...
## <a name="what-is-the-difference-between-a-custom-image-and-a-formula"></a>What is the difference between a custom image and a formula?
...
## <a name="how-do-i-move-my-existing-azure-vms-into-my-devtest-labs-lab"></a>How do I move my existing Azure VMs into my DevTest Labs lab?
...
## <a name="if-i-want-to-use-a-windows-os-image-for-my-testing-do-i-have-to-purchase-an-msdn-subscription"></a>If I want to use a Windows OS image for my testing, do I have to purchase an MSDN subscription?
...
## <a name="how-do-i-automate-the-process-of-deleting-all-the-vms-in-my-lab"></a>How do I automate the process of deleting all the VMs in my lab?
...
**Lab configuration**
## <a name="how-do-i-create-a-lab-from-a-resource-manager-template"></a>How do I create a lab from a Resource Manager template?
...
## <a name="why-do-i-get-a-parent-resource-not-found-error-when-i-provision-a-vm-from-powershell"></a>Why do I get a "Parent resource not found" error when I provision a VM from PowerShell?
...
## <a name="where-can-i-find-more-error-information-if-a-vm-deployment-fails"></a>Where can I find more error information if a VM deployment fails?
