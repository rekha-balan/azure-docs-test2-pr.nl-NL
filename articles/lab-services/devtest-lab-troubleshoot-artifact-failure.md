...
---
# <a name="diagnose-artifact-failures-in-the-lab"></a>Diagnose artifact failures in the lab 
...
## <a name="troubleshoot-artifact-failures-by-using-the-azure-portal"></a>Troubleshoot artifact failures by using the Azure portal
...
## <a name="troubleshoot-artifact-failures-from-within-the-virtual-machine"></a>Troubleshoot artifact failures from within the virtual machine
