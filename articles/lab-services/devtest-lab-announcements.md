...
---
# <a name="post-an-announcement-to-a-lab-in-azure-devtest-labs"></a>Post an announcement to a lab in Azure DevTest Labs
...
## <a name="steps-to-post-an-announcement-in-an-existing-lab"></a>Steps to post an announcement in an existing lab
...
## <a name="steps-for-users-to-view-an-announcement"></a>Steps for users to view an announcement
