...
## <a name="devtest-labs-public-environments"></a>DevTest Labs public environments
...
## <a name="configure-your-own-template-repositories"></a>Configure your own template repositories
...
## <a name="create-an-environment-from-a-resource-manager-template-using-the-azure-portal"></a>Create an environment from a Resource Manager template using the Azure portal
...
## <a name="deploy-a-resource-manager-template-to-create-a-vm"></a>Deploy a Resource Manager template to create a VM
...
### <a name="configure-environment-resource-group-access-rights-for-lab-users"></a>Configure environment resource group access rights for lab users
