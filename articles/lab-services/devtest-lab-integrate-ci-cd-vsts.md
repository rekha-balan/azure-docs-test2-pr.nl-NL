...
---
# <a name="integrate-azure-devtest-labs-into-your-azure-devops-continuous-integration-and-delivery-pipeline"></a>Integrate Azure DevTest Labs into your Azure DevOps continuous integration and delivery pipeline
...
## <a name="create-a-resource-manager-template"></a>Create a Resource Manager template
...
## <a name="create-a-release-pipeline-in-release-management"></a>Create a release pipeline in Release Management
...
### <a name="delete-the-vm"></a>Delete the VM
