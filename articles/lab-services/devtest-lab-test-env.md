...
---
# <a name="use-azure-devtest-labs-for-vm-and-paas-test-environments"></a>Use Azure DevTest Labs for VM and PaaS test environments
...
## <a name="implementing-test-environments-with-azure-devtest-labs"></a>Implementing test environments with Azure DevTest Labs
1. **Create the lab** 
