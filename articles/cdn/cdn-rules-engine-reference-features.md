...
---
# <a name="azure-cdn-rules-engine-features"></a>Azure CDN rules engine features
...
#### <a name="sample-scenarios"></a>Sample Scenarios
...
This URL redirection may be achieved through the following configuration: ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/cdn/media/cdn-rules-engine-reference/cdn-rules-engine-redirect.png)
...
This URL redirection may be achieved through the following configuration: ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/cdn/media/cdn-rules-engine-reference/cdn-rules-engine-rewrite.png)
...
This URL redirection may be achieved through the following configuration: ![](https://docstestmedia1.blob.core.windows.net/azure-media/articles/cdn/media/cdn-rules-engine-reference/cdn-rules-engine-to-lowercase.png)
