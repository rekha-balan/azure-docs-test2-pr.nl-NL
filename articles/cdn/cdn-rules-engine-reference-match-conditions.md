...
## <a name="always-match-condition"></a>Always match condition
...
## <a name="device-match-condition"></a>Device match condition
...
## <a name="location-match-conditions"></a>Location match conditions
...
## <a name="origin-match-conditions"></a>Origin match conditions
...
## <a name="request-match-conditions"></a>Request match conditions
...
## <a name="url-match-conditions"></a>URL match conditions
...
## <a name="reference-for-rules-engine-match-conditions"></a>Reference for rules engine match conditions
...
#### <a name="implementing-country-filtering-by-using-the-rules-engine"></a>Implementing Country Filtering by using the rules engine
...
#### <a name="wurfl-capabilities"></a>WURFL capabilities
