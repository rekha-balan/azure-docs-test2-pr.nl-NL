...
---
# <a name="set-up-failover-across-multiple-azure-cdn-endpoints-with-azure-traffic-manager"></a>Set up failover across multiple Azure CDN endpoints with Azure Traffic Manager
...
## <a name="set-up-azure-cdn"></a>Set up Azure CDN 
...
## <a name="set-up-custom-domain-on-azure-cdn-and-azure-traffic-manager"></a>Set up custom domain on Azure CDN and Azure Traffic Manager
