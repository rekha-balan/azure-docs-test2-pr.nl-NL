...
---
# <a name="how-caching-works"></a>How caching works
...
## <a name="introduction-to-caching"></a>Introduction to caching
...
### <a name="resource-freshness"></a>Resource freshness
...
## <a name="cache-directive-headers"></a>Cache-directive headers
...
## <a name="determining-which-files-can-be-cached"></a>Determining which files can be cached
...
## <a name="default-caching-behavior"></a>Default caching behavior
