...
---
# <a name="dynamic-site-acceleration-via-azure-cdn"></a>Dynamic site acceleration via Azure CDN
...
## <a name="cdn-endpoint-configuration-to-accelerate-delivery-of-dynamic-files"></a>CDN endpoint configuration to accelerate delivery of dynamic files
...
## <a name="dsa-optimization-using-azure-cdn"></a>DSA Optimization using Azure CDN
...
### <a name="route-optimization"></a>Route Optimization
...
### <a name="tcp-optimizations"></a>TCP Optimizations
...
#### <a name="eliminating-tcp-slow-start"></a>Eliminating TCP slow start
...
#### <a name="leveraging-persistent-connections"></a>Leveraging persistent connections
...
#### <a name="tuning-tcp-packet-parameters"></a>Tuning TCP packet parameters
...
### <a name="object-prefetch-azure-cdn-from-akamai-only"></a>Object prefetch (Azure CDN from Akamai only)
...
### <a name="adaptive-image-compression-azure-cdn-from-akamai-only"></a>Adaptive image compression (Azure CDN from Akamai only)
