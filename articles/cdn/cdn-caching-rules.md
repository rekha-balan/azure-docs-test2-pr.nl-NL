...
---
# <a name="control-azure-cdn-caching-behavior-with-caching-rules"></a>Control Azure CDN caching behavior with caching rules
...
## <a name="accessing-azure-cdn-caching-rules"></a>Accessing Azure CDN caching rules
...
## <a name="caching-behavior-settings"></a>Caching behavior settings
...
## <a name="cache-expiration-duration"></a>Cache expiration duration
...
## <a name="custom-caching-rules-match-conditions"></a>Custom caching rules match conditions
...
## <a name="global-and-custom-rule-processing-order"></a>Global and custom rule processing order
