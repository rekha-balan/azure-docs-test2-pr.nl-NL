...
---
# <a name="tutorial-set-azure-cdn-caching-rules"></a>Tutorial: Set Azure CDN caching rules
...
## <a name="open-the-azure-cdn-caching-rules-page"></a>Open the Azure CDN caching rules page
...
## <a name="set-global-caching-rules"></a>Set global caching rules
...
## <a name="set-custom-caching-rules"></a>Set custom caching rules
