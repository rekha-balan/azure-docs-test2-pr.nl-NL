...
---
# <a name="manage-expiration-of-web-content-in-azure-cdn"></a>Manage expiration of web content in Azure CDN
...
## <a name="setting-cache-control-headers-by-using-configuration-files"></a>Setting Cache-Control headers by using configuration files
...
### <a name="using-applicationhostconfig-files"></a>Using ApplicationHost.config files
...
### <a name="using-webconfig-files"></a>Using Web.config files
...
## <a name="setting-cache-control-headers-programmatically"></a>Setting Cache-Control headers programmatically
