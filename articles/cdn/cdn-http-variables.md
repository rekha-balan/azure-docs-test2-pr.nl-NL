...
---
# <a name="http-variables-for-azure-cdn-rules-engine"></a>HTTP variables for Azure CDN rules engine
...
## <a name="delimiter-reference"></a>Delimiter reference
...
## <a name="setting-default-header-values"></a>Setting default header values
...
## <a name="manipulating-variables"></a>Manipulating variables
Variables can be manipulated in the following ways:

- Expanding substrings
- Removing patterns

### <a name="substring-expansion"></a>Substring expansion
...
### <a name="pattern-removal"></a>Pattern removal
...
### <a name="find-and-replace"></a>Find and replace
...
### <a name="find-and-rewrite"></a>Find and rewrite
