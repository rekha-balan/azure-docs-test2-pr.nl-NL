...
---
# <a name="large-file-download-optimization-with-azure-cdn"></a>Large file download optimization with Azure CDN
...
## <a name="optimize-for-delivery-of-large-files-with-azure-cdn-from-microsoft"></a>Optimize for delivery of large files with Azure CDN from Microsoft
...
### <a name="conditions-for-large-file-optimization"></a>Conditions for large file optimization
...
## <a name="optimize-for-delivery-of-large-files-with-azure-cdn-from-verizon"></a>Optimize for delivery of large files with Azure CDN from Verizon
...
### <a name="peer-cache-fill-hot-filing"></a>Peer cache fill hot-filing
...
## <a name="optimize-for-delivery-of-large-files-with-azure-cdn-standard-from-akamai"></a>Optimize for delivery of large files with Azure CDN Standard from Akamai
...
### <a name="configure-an-akamai-cdn-endpoint-to-optimize-delivery-of-large-files"></a>Configure an Akamai CDN endpoint to optimize delivery of large files
