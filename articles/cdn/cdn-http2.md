...
---
# <a name="http2-support-in-azure-cdn"></a>HTTP/2 Support in Azure CDN
...
### <a name="http2-benefits"></a>HTTP/2 Benefits
...
## <a name="http2-browser-support"></a>HTTP/2 Browser Support
...
## <a name="enabling-http2-support-in-azure-cdn"></a>Enabling HTTP/2 Support in Azure CDN
