...
---
# <a name="azure-diagnostic-logs"></a>Azure diagnostic logs
...
## <a name="enable-logging-with-the-azure-portal"></a>Enable logging with the Azure portal
...
### <a name="enable-logging-with-azure-storage"></a>Enable logging with Azure Storage
...
### <a name="logging-with-log-analytics"></a>Logging with Log Analytics
...
### <a name="enabling-diagnostic-logs-in-a-storage-account"></a>Enabling diagnostic logs in a storage account
...
## <a name="consuming-diagnostics-logs-from-azure-storage"></a>Consuming diagnostics logs from Azure Storage
...
### <a name="using-microsoft-azure-storage-explorer"></a>Using Microsoft Azure Storage Explorer
...
#### <a name="blob-path-format"></a>Blob path format
...
### <a name="exporting-the-core-analytics-data-to-a-csv-file"></a>Exporting the core analytics data to a CSV file
...
## <a name="consuming-diagnostics-logs-from-a-log-analytics-workspace"></a>Consuming diagnostics logs from a Log Analytics workspace
...
### <a name="using-the-log-analytics-workspace"></a>Using the Log Analytics workspace
...
### <a name="add-a-log-analytics-cdn-management-solution"></a>Add a Log Analytics CDN Management Solution
...
### <a name="customizing-views"></a>Customizing views
...
## <a name="log-data-delays"></a>Log data delays
...
## <a name="diagnostic-log-types-for-cdn-core-analytics"></a>Diagnostic log types for CDN core analytics
...
### <a name="core-analytics-metrics-details"></a>Core analytics metrics details
...
### <a name="schema-of-the-core-analytics-logs"></a>Schema of the core analytics logs 
