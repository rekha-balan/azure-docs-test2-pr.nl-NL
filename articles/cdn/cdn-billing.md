...
---
# <a name="understanding-azure-cdn-billing"></a>Understanding Azure CDN billing

This FAQ describes the billing structure for content hosted by Azure Content Delivery Network (CDN).

## <a name="what-is-a-billing-region"></a>What is a billing region?
...
## <a name="how-are-delivery-charges-calculated-by-region"></a>How are delivery charges calculated by region?
...
## <a name="what-is-a-billable-azure-cdn-transaction"></a>What is a billable Azure CDN transaction?
...
## <a name="what-other-azure-costs-are-associated-with-azure-cdn-use"></a>What other Azure costs are associated with Azure CDN use?
...
## <a name="how-much-transfer-activity-occurs-to-support-the-cache"></a>How much transfer activity occurs to support the cache?
...
## <a name="how-do-i-manage-my-costs-most-effectively"></a>How do I manage my costs most effectively?
