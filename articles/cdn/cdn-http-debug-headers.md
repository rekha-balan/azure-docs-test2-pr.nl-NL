...
---
# <a name="x-ec-debug-http-headers-for-azure-cdn-rules-engine"></a>X-EC-Debug HTTP headers for Azure CDN rules engine
...
## <a name="requesting-debug-cache-information"></a>Requesting debug cache information
...
### <a name="sample-x-ec-debug-header"></a>Sample X-EC-Debug header

`X-EC-Debug: x-ec-cache,x-ec-check-cacheable,x-ec-cache-key,x-ec-cache-state`

## <a name="cache-status-code-information"></a>Cache status code information
...
### <a name="response-header-format"></a>Response header format
...
### <a name="sample-response-headers"></a>Sample response headers
...
## <a name="cacheable-response-header"></a>Cacheable response header
...
### <a name="sample-response-header"></a>Sample response header

The following sample response header indicates whether the requested content could have been cached:

`X-EC-Debug: x-ec-check-cacheable: YES`

## <a name="cache-key-response-header"></a>Cache-Key response header
...
## <a name="cache-state-response-header"></a>Cache state response header
