...
---
# <a name="retrieve-the-current-verizon-pop-list-for-azure-cdn"></a>Retrieve the current Verizon POP list for Azure CDN
...
## <a name="typical-use-case"></a>Typical use case
