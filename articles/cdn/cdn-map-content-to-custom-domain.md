...
---
# <a name="tutorial-add-a-custom-domain-to-your-azure-cdn-endpoint"></a>Tutorial: Add a custom domain to your Azure CDN endpoint
...
## <a name="create-a-cname-dns-record"></a>Create a CNAME DNS record
...
## <a name="map-the-temporary-cdnverify-subdomain"></a>Map the temporary cdnverify subdomain
...
## <a name="associate-the-custom-domain-with-your-cdn-endpoint"></a>Associate the custom domain with your CDN endpoint
...
## <a name="verify-the-custom-domain"></a>Verify the custom domain
...
## <a name="map-the-permanent-custom-domain"></a>Map the permanent custom domain
