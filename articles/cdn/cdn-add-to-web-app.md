...
---
# <a name="tutorial-add-azure-cdn-to-an-azure-app-service-web-app"></a>Tutorial: Add Azure CDN to an Azure App Service web app
...
## <a name="purge-the-cdn"></a>Purge the CDN
...
### <a name="deploy-a-change-to-the-web-app"></a>Deploy a change to the web app
...
### <a name="purge-the-cdn-in-the-portal"></a>Purge the CDN in the portal
...
### <a name="verify-that-the-cdn-is-updated"></a>Verify that the CDN is updated
...
## <a name="use-query-strings-to-version-content"></a>Use query strings to version content
...
### <a name="change-the-cache-behavior"></a>Change the cache behavior
...
### <a name="verify-that-unique-urls-are-cached-separately"></a>Verify that unique URLs are cached separately
