...
---
# <a name="verizon-specific-http-headers-for-azure-cdn-rules-engine"></a>Verizon-specific HTTP headers for Azure CDN rules engine
...
## <a name="via-request-header"></a>Via request header
...
### <a name="example-via-request-header"></a>Example Via request header

`Via: HTTP/1.1 ECD (dca/1A2B)`

## <a name="host-request-header"></a>Host request header
...
## <a name="x-gateway-list-request-header"></a>X-Gateway-List request header
