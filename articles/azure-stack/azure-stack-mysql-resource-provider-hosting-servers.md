...
---
# <a name="add-hosting-servers-for-the-mysql-resource-provider"></a>Add hosting servers for the MySQL resource provider
...
## <a name="connect-to-a-mysql-hosting-server"></a>Connect to a MySQL hosting server
...
## <a name="security-considerations-for-mysql"></a>Security considerations for MySQL
...
## <a name="increase-backend-database-capacity"></a>Increase backend database capacity
...
## <a name="make-mysql-database-servers-available-to-your-users"></a>Make MySQL database servers available to your users
