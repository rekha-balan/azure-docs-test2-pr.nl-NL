...
---
# <a name="add-a-kubernetes-cluster-to-the-azure-stack-marketplace"></a>Add a Kubernetes Cluster to the Azure Stack Marketplace
...
## <a name="create-a-plan-an-offer-and-a-subscription"></a>Create a plan, an offer, and a subscription
...
## <a name="add-an-ubuntu-server-image"></a>Add an Ubuntu server image
...
## <a name="add-a-custom-script-for-linux"></a>Add a custom script for Linux
...
## <a name="add-the-kubernetes-cluster-to-the-marketplace"></a>Add the Kubernetes Cluster to the marketplace
...
## <a name="update-or-remove-the-kubernetes-cluster"></a>Update or remove the Kubernetes Cluster 
