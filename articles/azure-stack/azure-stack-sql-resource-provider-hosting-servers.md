...
---
# <a name="add-hosting-servers-for-the-sql-resource-provider"></a>Add hosting servers for the SQL resource provider
...
### <a name="mandatory-requirements"></a>Mandatory requirements
...
### <a name="sql-server-virtual-machine-images"></a>SQL Server virtual machine images
...
### <a name="additional-security-information"></a>Additional Security Information
...
## <a name="provide-capacity-by-connecting-to-a-standalone-hosting-sql-server"></a>Provide capacity by connecting to a standalone hosting SQL server
...
## <a name="provide-high-availability-using-sql-always-on-availability-groups"></a>Provide high availability using SQL Always On Availability Groups
...
### <a name="automatic-seeding"></a>Automatic seeding
...
### <a name="configure-contained-database-authentication"></a>Configure contained database authentication
...
## <a name="make-the-sql-databases-available-to-users"></a>Make the SQL databases available to users
