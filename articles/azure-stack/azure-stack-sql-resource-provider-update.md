...
<a name="you-can-edit-and-run-the-following-script-from-an-elevated-powershell-ise"></a>You can edit and run the following script from an elevated PowerShell ISE. 
-  
