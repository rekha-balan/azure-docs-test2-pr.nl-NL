...
---
# <a name="create-sql-databases"></a>Create SQL databases
...
### <a name="verify-sql-always-on-databases"></a>Verify SQL Always On databases
...
### <a name="delete-an-alwayson-database"></a>Delete an AlwaysOn database
