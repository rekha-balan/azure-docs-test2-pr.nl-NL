...
---
# <a name="infrastructure-backup-service-reference"></a>Infrastructure Backup Service reference

## <a name="azure-backup-infrastructure"></a>Azure backup infrastructure
...
### <a name="infrastructure-backup-components"></a>Infrastructure Backup components
...
## <a name="backup-controller-requirements"></a>Backup Controller requirements
...
#### <a name="supported-storage-locations"></a>Supported storage locations
...
#### <a name="supported-smb-versions"></a>Supported SMB versions

| SMB | Version |
|-----|---------|
| SMB | 3.x     |

#### <a name="storage-location-sizing"></a>Storage location sizing 
...
## <a name="infrastructure-backup-limits"></a>Infrastructure Backup Limits
