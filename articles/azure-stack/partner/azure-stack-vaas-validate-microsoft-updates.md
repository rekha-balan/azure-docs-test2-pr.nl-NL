...
---
# <a name="validate-software-updates-from-microsoft"></a>Validate software updates from Microsoft
...
## <a name="test-an-existing-solution"></a>Test an existing solution
