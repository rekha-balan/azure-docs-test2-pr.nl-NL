...
---
# <a name="automate-azure-stack-validation-with-powershell"></a>Automate Azure Stack validation with PowerShell 
...
## <a name="launch-the-test-pass-workflow"></a>Launch the test pass workflow
