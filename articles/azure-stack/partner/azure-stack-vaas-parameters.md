...
---
# <a name="workflow-common-parameters-for-azure-stack-validation-as-a-service"></a>Workflow common parameters for Azure Stack validation as a service
...
## <a name="environment-parameters"></a>Environment parameters
