...
---
# <a name="deploy-the-local-agent-and-test-virtual-machines"></a>Deploy the local agent and test virtual machines
...
## <a name="download-and-start-the-local-agent"></a>Download and start the local agent
...
### <a name="machine-prerequisites"></a>Machine prerequisites
...
## <a name="fault-injection"></a>Fault injection
...
## <a name="run-the-agent"></a>Run the agent
