...
---
# <a name="quickstart-use-the-validation-as-a-service-portal-to-schedule-your-first-test"></a>Quickstart: Use the validation as a service portal to schedule your first test
