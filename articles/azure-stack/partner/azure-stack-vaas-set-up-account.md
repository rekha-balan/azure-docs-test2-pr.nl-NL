...
---
# <a name="set-up-your-validation-as-a-service-account"></a>Set up your validation as a service account
...
## <a name="create-an-azure-active-directory-tenant-id"></a>Create an Azure Active Directory tenant ID
...
## <a name="set-up-your-tenant"></a>Set up your tenant
...
## <a name="create-an-azure-storage-blob-to-store-logs"></a>Create an Azure storage blob to store logs
...
### <a name="generate-a-sas-url-for-the-storage-account"></a>Generate a SAS URL for the storage account
