...
---
# <a name="test-parameters-for-validation-as-a-service-azure-stack"></a>Test parameters for validation as a service Azure Stack
...
## <a name="export-the-test-parameters-using-powershell"></a>Export the test parameters using PowerShell
...
## <a name="find-the-test-parameters-in-the-configuration-file"></a>Find the test parameters in the configuration file
...
## <a name="checks-before-starting-the-tests"></a>Checks before starting the tests
