...
---
# <a name="capacity-planning-for-azure-app-service-server-roles-in-azure-stack"></a>Capacity planning for Azure App Service server roles in Azure Stack
...
## <a name="controller-role"></a>Controller role
...
## <a name="management-role"></a>Management role
...
## <a name="publisher-role"></a>Publisher role
...
## <a name="web-worker-role"></a>Web worker role
...
## <a name="file-server-role"></a>File server role
