...
# <a name="manage-physical-memory-capacity-for-azure-stack"></a>Manage physical memory capacity for Azure Stack
...
## <a name="add-memory-to-an-existing-node"></a>Add memory to an existing node
...
## <a name="next-steps"></a>Next steps
 ...
 - To learn how to manage storage accounts in Azure Stack to find, recover, and reclaim storage capacity based on business needs, see [Manage storage accounts in Azure Stack](azure-stack-manage-storage-accounts.md).
