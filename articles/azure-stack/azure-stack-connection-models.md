...
---
# <a name="azure-stack-integrated-systems-connection-models"></a>Azure Stack integrated systems connection models
...
## <a name="choose-an-azure-stack-deployment-connection-model"></a>Choose an Azure Stack deployment connection model
