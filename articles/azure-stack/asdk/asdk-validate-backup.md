...
---
# <a name="use-the-asdk-to-validate-an-azure-stack-backup"></a>Use the ASDK to validate an Azure Stack backup
...
## <a name="cloud-recovery-deployment"></a>Cloud recovery deployment
...
### <a name="cloud-recovery-prerequisites"></a>Cloud recovery prerequisites
...
## <a name="deploy-the-asdk-in-cloud-recovery-mode"></a>Deploy the ASDK in cloud recovery mode
...
## <a name="restore-infrastructure-data-from-backup"></a>Restore infrastructure data from backup
