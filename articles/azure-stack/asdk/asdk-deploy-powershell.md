...
---
# <a name="deploy-the-asdk-from-the-command-line"></a>Deploy the ASDK from the command line
...
## <a name="prepare-the-development-kit-host-computer"></a>Prepare the development kit host computer
...
### <a name="prepare-the-development-kit-host-using-powershell"></a>Prepare the development kit host using PowerShell 
...
### <a name="deploy-azure-stack-using-azure-ad"></a>Deploy Azure Stack using Azure AD 
...
### <a name="deploy-azure-stack-using-ad-fs"></a>Deploy Azure Stack using AD FS 
...
#### <a name="azure-ad-deployment-script-examples"></a>Azure AD deployment script examples
