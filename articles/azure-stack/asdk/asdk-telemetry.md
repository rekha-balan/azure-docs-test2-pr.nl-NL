...
### <a name="set-telemetry-level-in-the-windows-registry"></a>Set telemetry level in the Windows registry
...
### <a name="enable-or-disable-telemetry-after-deployment"></a>Enable or disable telemetry after deployment
