...
---
# <a name="redeploy-the-asdk"></a>Redeploy the ASDK
...
## <a name="remove-azure-registration"></a>Remove Azure registration 
...
## <a name="deploy-the-asdk"></a>Deploy the ASDK
...
### <a name="redeploy-the-asdk-using-the-installer-script"></a>Redeploy the ASDK using the installer script
...
### <a name="redeploy-the-asdk-without-using-the-installer"></a>Redeploy the ASDK without using the installer
