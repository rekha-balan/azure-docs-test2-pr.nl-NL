...
---
# <a name="start-and-stop-the-azure-stack-development-kit-asdk"></a>Start and stop the Azure Stack Development Kit (ASDK)
...
## <a name="troubleshoot-startup-and-shutdown"></a>Troubleshoot startup and shutdown 
