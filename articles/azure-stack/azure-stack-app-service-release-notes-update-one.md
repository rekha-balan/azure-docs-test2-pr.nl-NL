...
---
# <a name="app-service-on-azure-stack-update-1-release-notes"></a>App Service on Azure Stack update 1 release notes
...
## <a name="build-reference"></a>Build reference
...
### <a name="new-features-and-fixes"></a>New features and fixes
...
### <a name="known-issues-with-the-deployment-process"></a>Known issues with the deployment process
...
### <a name="known-issues-with-the-update-process"></a>Known issues with the update process

- There are no known issues for the update of Azure App Service on Azure Stack Update 1.

### <a name="known-issues-post-installation"></a>Known issues (post-installation)
...
### <a name="known-issues-for-cloud-admins-operating-azure-app-service-on-azure-stack"></a>Known issues for Cloud Admins operating Azure App Service on Azure Stack
