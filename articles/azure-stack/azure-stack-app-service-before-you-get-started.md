...
## <a name="download-the-installer-and-helper-scripts"></a>Download the installer and helper scripts
...
## <a name="get-certificates"></a>Get certificates

### <a name="azure-resource-manager-root-certificate-for-azure-stack"></a>Azure Resource Manager root certificate for Azure Stack
...
### <a name="certificates-required-for-asdk-deployment-of-azure-app-service"></a>Certificates required for ASDK deployment of Azure App Service
...
### <a name="certificates-required-for-azure-stack-production-deployment-of-azure-app-service"></a>Certificates required for Azure Stack production deployment of Azure App Service
...
#### <a name="default-domain-certificate"></a>Default domain certificate
...
#### <a name="api-certificate"></a>API certificate
...
#### <a name="publishing-certificate"></a>Publishing certificate
...
#### <a name="identity-certificate"></a>Identity certificate
...
## <a name="prepare-the-file-server"></a>Prepare the file server
...
### <a name="provision-groups-and-accounts-in-active-directory"></a>Provision groups and accounts in Active Directory
...
### <a name="provision-groups-and-accounts-in-a-workgroup"></a>Provision groups and accounts in a workgroup
...
### <a name="provision-the-content-share"></a>Provision the content share
...
#### <a name="provision-the-content-share-on-a-single-file-server-active-directory-or-workgroup"></a>Provision the content share on a single file server (Active Directory or workgroup)
...
### <a name="configure-access-control-to-the-shares"></a>Configure access control to the shares
...
## <a name="prepare-the-sql-server-instance"></a>Prepare the SQL Server instance
...
## <a name="create-an-active-directory-federation-services-application"></a>Create an Active Directory Federation Services application
