...
---
# <a name="prepare-azure-stack-pki-certificates-for-deployment"></a>Prepare Azure Stack PKI certificates for deployment
...
## <a name="prepare-certificates-for-deployment"></a>Prepare certificates for deployment
Use these steps to prepare and validate the Azure Stack PKI certificates: 

### <a name="import-the-certificate"></a>Import the certificate
...
### <a name="export-the-certificate"></a>Export the certificate
