...
---
# <a name="update-the-mysql-resource-provider"></a>Update the MySQL resource provider 
...
## <a name="update-the-mysql-resource-provider-adapter-integrated-systems-only"></a>Update the MySQL resource provider adapter (integrated systems only)
