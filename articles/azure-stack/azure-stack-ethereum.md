...
---
# <a name="azure-stack-ethereum-blockchain-solution-templates"></a>Azure Stack Ethereum blockchain solution templates
...
## <a name="deployment-use-cases"></a>Deployment use cases
...
### <a name="standalone-and-consortium-leader-deployment"></a>Standalone and consortium leader deployment
...
### <a name="joining-consortium-member-deployment"></a>Joining consortium member deployment
...
### <a name="connect-member-and-leader"></a>Connect member and leader
