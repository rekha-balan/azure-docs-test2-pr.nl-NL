...
---
# <a name="azure-stack-datacenter-integration---identity"></a>Azure Stack datacenter integration - Identity
...
## <a name="setting-up-graph-integration"></a>Setting up Graph integration
...
### <a name="create-user-account-in-the-existing-active-directory-optional"></a>Create user account in the existing Active Directory (optional)
...
#### <a name="trigger-automation-to-configure-graph"></a>Trigger automation to configure graph
...
#### <a name="graph-protocols-and-ports"></a>Graph protocols and ports
...
## <a name="setting-up-ad-fs-integration-by-downloading-federation-metadata"></a>Setting up AD FS integration by downloading federation metadata
...
### <a name="trigger-automation-to-configure-claims-provider-trust-in-azure-stack"></a>Trigger automation to configure claims provider trust in Azure Stack
...
## <a name="setting-up-ad-fs-integration-by-providing-federation-metadata-file"></a>Setting up AD FS integration by providing federation metadata file
...
### <a name="create-federation-metadata-file"></a>Create federation metadata file
...
## <a name="configure-relying-party-on-existing-ad-fs-deployment-account-sts"></a>Configure relying party on existing AD FS deployment (account STS)
...
## <a name="spn-creation"></a>SPN creation
...
### <a name="collecting-additional-logs"></a>Collecting additional logs
