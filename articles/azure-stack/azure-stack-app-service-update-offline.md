...
---
# <a name="offline-update-of-azure-app-service-on-azure-stack"></a>Offline update of Azure App Service on Azure Stack
...
## <a name="run-the-app-service-resource-provider-installer"></a>Run the App Service resource provider installer
...
## <a name="create-an-offline-upgrade-package"></a>Create an offline upgrade package
...
## <a name="complete-the-upgrade-of-app-service-on-azure-stack"></a>Complete the upgrade of App Service on Azure Stack
