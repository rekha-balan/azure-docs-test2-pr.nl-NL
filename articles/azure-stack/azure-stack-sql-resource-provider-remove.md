...
---
# <a name="remove-the-sql-resource-provider"></a>Remove the SQL resource provider
...
## <a name="to-remove-the-sql-resource-provider"></a>To remove the SQL resource provider
