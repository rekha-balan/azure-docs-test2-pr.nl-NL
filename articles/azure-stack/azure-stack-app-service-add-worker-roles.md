...
---
# <a name="app-service-on-azure-stack-add-more-infrastructure-or-worker-roles"></a>App Service on Azure Stack: Add more infrastructure or worker roles
...
## <a name="add-additional-workers-with-powershell"></a>Add additional workers with PowerShell
