...
---
# <a name="manage-usage-and-billing-for-azure-stack-as-a-cloud-service-provider"></a>Manage usage and billing for Azure Stack as a Cloud Service Provider 
...
## <a name="create-a-csp-or-cspss-subscription"></a>Create a CSP or CSPSS subscription

### <a name="cloud-service-provider-subscription-types"></a>Cloud Service Provider subscription types
...
#### <a name="csp-subscriptions"></a>CSP subscriptions
...
## <a name="register-azure-stack"></a>Register Azure Stack
...
## <a name="add-end-customer"></a>Add end customer
...
## <a name="charge-the-right-subscriptions"></a>Charge the right subscriptions
