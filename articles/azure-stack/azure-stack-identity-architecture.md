...
---
# <a name="identity-architecture-for-azure-stack"></a>Identity architecture for Azure Stack
...
### <a name="azure-ad-single-tenant-topology"></a>Azure AD: single-tenant topology 
...
### <a name="azure-ad-multi-tenant-topology"></a>Azure AD: multi-tenant topology
