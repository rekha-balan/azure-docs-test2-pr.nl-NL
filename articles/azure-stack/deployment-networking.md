...
---
# <a name="about-deployment-network-traffic"></a>About deployment network traffic
...
### <a name="the-deployment-vm"></a>The Deployment VM
...
## <a name="deployment-network-traffic"></a>Deployment network traffic
