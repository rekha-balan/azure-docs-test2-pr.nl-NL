...
---
# <a name="manage-storage-capacity-for-azure-stack"></a>Manage storage capacity for Azure Stack
...
## <a name="understand-volumes-and-shares-containers-and-disks"></a>Understand volumes and shares, containers, and disks
### <a name="volumes-and-shares"></a>Volumes and shares
...
### <a name="use-the-administrator-portal"></a>Use the administrator portal
...
### <a name="storage-space-alerts"></a>Storage space alerts
...
**Warning**: When a file share is over 80% utilized, you receive a *Warning* alert in the admin portal: ![Example: Warning alert](media/azure-stack-manage-storage-shares/alert-warning.png)


**Critical**: When a file share is over 90% utilized, you receive a *Critical* alert in the admin portal: ![Example: Critical alert](media/azure-stack-manage-storage-shares/alert-critical.png)

**View details**: In the admin portal you can open the details for an alert to view mitigation options: ![Example: View alert details](media/azure-stack-manage-storage-shares/alert-details.png)


## <a name="manage-available-space"></a>Manage available space
...
### <a name="migrate-a-container-between-volumes"></a>Migrate a container between volumes
...
#### <a name="to-migrate-containers-using-powershell"></a>To migrate containers using PowerShell
...
### <a name="move-vm-disks"></a>Move VM disks
*This option applies only to multi-node deployments.*
