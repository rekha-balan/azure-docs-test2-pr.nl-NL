...
---
# <a name="provision-virtual-machine-disk-storage-in-azure-stack"></a>Provision virtual machine disk storage in Azure Stack
...
### <a name="best-practice-guidelines"></a>Best practice guidelines
...
### <a name="adding-new-disks"></a>Adding new disks
...
## <a name="use-the-portal-to-add-disks-to-a-vm"></a>Use the portal to add disks to a VM
...
### <a name="use-the-portal-to-create-and-attach-a-new-data-disk"></a>Use the portal to create and attach a new data disk
...
### <a name="attach-an-existing-data-disk-to-a-vm"></a>Attach an existing data disk to a VM
...
## <a name="use-powershell-to-add-multiple-unmanaged-disks-to-a-vm"></a>Use PowerShell to add multiple unmanaged disks to a VM
...
### <a name="add-data-disks-to-a-new-virtual-machine"></a>Add data disks to a new virtual machine
...
### <a name="add-data-disks-to-an-existing-virtual-machine"></a>Add data disks to an existing virtual machine
