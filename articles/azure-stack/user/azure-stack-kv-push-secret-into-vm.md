...
---
# <a name="create-a-virtual-machine-and-install-a-certificate-retrieved-from-an-azure-stack-key-vault"></a>Create a virtual machine and install a certificate retrieved from an Azure Stack key vault
...
### <a name="process-description"></a>Process description
