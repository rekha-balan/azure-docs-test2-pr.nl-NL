...
# <a name="use-the-azure-stack-api"></a>Use the Azure Stack API
...
## <a name="get-a-token-from-azure"></a>Get a token from Azure
...
## <a name="api-queries"></a>API queries
...
### <a name="url-structure-and-query-syntax"></a>URL structure and query syntax
...
## <a name="azure-stack-request-uri-construct"></a>Azure Stack request URI construct
...
### <a name="query-uri-example"></a>Query URI example
