...
---
# <a name="connect-storage-explorer-to-an-azure-stack-subscription-or-a-storage-account"></a>Connect storage explorer to an Azure Stack subscription or a storage account
...
## <a name="prepare-for-connecting-to-azure-stack"></a>Prepare for connecting to Azure Stack
...
### <a name="export-and-then-import-the-azure-stack-certificate"></a>Export and then import the Azure Stack certificate
...
## <a name="connect-to-an-azure-stack-subscription-with-azure-ad"></a>Connect to an Azure Stack subscription with Azure AD
...
## <a name="connect-to-an-azure-stack-subscription-with-ad-fs-account"></a>Connect to an Azure Stack subscription with AD FS account
...
## <a name="connect-to-an-azure-stack-storage-account"></a>Connect to an Azure Stack storage account
