...
### <a name="1802-update-or-newer-versions"></a>1802 update or newer versions
...
#### <a name="install-php-client-via-composer---current"></a>Install PHP client via Composer - current
...
#### <a name="install-php-client-via-composer---previous"></a>Install PHP client via Composer - previous
