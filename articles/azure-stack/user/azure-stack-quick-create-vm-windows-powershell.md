...
---
# <a name="quickstart-create-a-windows-server-virtual-machine-by-using-powershell-in-azure-stack"></a>Quickstart: create a Windows Server virtual machine by using PowerShell in Azure Stack
