...
---
# <a name="check-your-templates-for-azure-stack-with-the-template-validation-tool"></a>Check your templates for Azure Stack with the template validation tool
...
## <a name="build-the-cloud-capabilities-file"></a>Build the cloud capabilities file
