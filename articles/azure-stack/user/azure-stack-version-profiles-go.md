...
---
# <a name="use-api-version-profiles-with-go-in-azure-stack"></a>Use API version profiles with Go in Azure Stack

*Applies to: Azure Stack integrated systems and Azure Stack Development Kit*

## <a name="go-and-version-profiles"></a>Go and version profiles
...
## <a name="install-azure-sdk-for-go"></a>Install Azure SDK for Go
...
### <a name="go-autorest-dependencies"></a>Go-AutoRest dependencies
...
## <a name="how-to-use-go-sdk-profiles-on-azure-stack"></a>How to use GO SDK profiles on Azure Stack
