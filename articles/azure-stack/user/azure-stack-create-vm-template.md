...
---
# <a name="tutorial-create-a-vm-using-a-community-template"></a>Tutorial: create a VM using a community template
...
## <a name="learn-about-azure-stack-quickstart-templates"></a>Learn about Azure Stack quickstart templates
...
## <a name="create-a-vm-using-a-custom-github-template"></a>Create a VM using a custom GitHub template
...
## <a name="start-minikube-and-install-an-application"></a>Start minikube and install an application
