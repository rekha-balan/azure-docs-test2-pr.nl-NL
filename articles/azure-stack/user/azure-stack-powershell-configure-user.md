...
---
# <a name="connect-to-azure-stack-with-powershell-as-a-user"></a>Connect to Azure Stack with PowerShell as a user
...
## <a name="connect-with-azure-ad"></a>Connect with Azure AD
...
## <a name="connect-with-ad-fs"></a>Connect with AD FS
