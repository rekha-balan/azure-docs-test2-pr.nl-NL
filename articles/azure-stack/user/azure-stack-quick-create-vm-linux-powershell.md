...
---
# <a name="quickstart-create-a-linux-server-virtual-machine-by-using-powershell-in-azure-stack"></a>Quickstart: Create a Linux server virtual machine by using PowerShell in Azure Stack
...
## <a name="quick-create-virtual-machine---full-script"></a>Quick Create virtual machine - Full script
...
## <a name="install-the-nginx-web-server"></a>Install the NGINX web server
