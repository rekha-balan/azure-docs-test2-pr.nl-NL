...
---
# <a name="tutorial-deploy-apps-to-azure-and-azure-stack"></a>Tutorial: deploy apps to Azure and Azure Stack
...
## <a name="benefits-of-the-hybrid-delivery-build-pipe"></a>Benefits of the hybrid delivery build pipe
...
### <a name="azure-stack-requirements"></a>Azure Stack requirements
...
### <a name="developer-tool-requirements"></a>Developer tool requirements
...
## <a name="prepare-the-private-azure-pipelines-agent-for-azure-devops-services-integration"></a>Prepare the private Azure Pipelines agent for Azure DevOps Services integration
...
### <a name="get-the-tenant-id"></a>Get the tenant ID
...
### <a name="grant-the-service-principal-rights-to-deploy-resources-in-the-azure-stack-subscription"></a>Grant the service principal rights to deploy resources in the Azure Stack subscription
...
### <a name="add-a-personal-access-token-pat-for-azure-stack"></a>Add a Personal Access Token (PAT) for Azure Stack
...
### <a name="install-the-azure-devops-services-build-agent-on-the-azure-stack-hosted-build-server"></a>Install the Azure DevOps Services build agent on the Azure Stack hosted Build Server
...
## <a name="endpoint-creation-permissions"></a>Endpoint creation permissions
...
## <a name="develop-your-application-build"></a>Develop your application build
...
### <a name="add-code-to-an-azure-devops-services-project"></a>Add code to an Azure DevOps Services project
...
### <a name="create-self-contained-web-app-deployment-for-app-services-in-both-clouds"></a>Create self-contained web app deployment for App Services in both clouds
...
### <a name="create-the-build-pipeline"></a>Create the build pipeline
...
### <a name="use-an-azure-hosted-build-agent"></a>Use an Azure hosted build agent
...
### <a name="configure-the-continuous-deployment-cd-process"></a>Configure the continuous deployment (CD) process
...
### <a name="create-release-pipeline"></a>Create release pipeline
...
## <a name="create-a-release"></a>Create a release
...
### <a name="monitor-and-track-deployments"></a>Monitor and track deployments
