...
---
# <a name="give-applications-access-to-azure-stack-resources-by-creating-service-principals"></a>Give applications access to Azure Stack resources by creating service principals
...
## <a name="create-a-service-principal-for-azure-ad"></a>Create a service principal for Azure AD
...
## <a name="assign-the-service-principal-to-a-role"></a>Assign the service principal to a role
