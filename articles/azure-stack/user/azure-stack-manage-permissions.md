...
---
# <a name="manage-access-to-resources-with-azure-stack-role-based-access-control"></a>Manage access to resources with Azure Stack Role-Based Access Control
...
## <a name="basics-of-access-management"></a>Basics of access management
...
### <a name="resource-hierarchy-and-inheritance"></a>Resource hierarchy and inheritance
...
### <a name="assigning-roles"></a>Assigning roles
