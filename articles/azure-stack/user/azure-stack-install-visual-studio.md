...
## <a name="connect-to-azure-stack-with-azure-ad"></a>Connect to Azure Stack with Azure AD
...
## <a name="connect-to-azure-stack-with-ad-fs"></a>Connect to Azure Stack with AD FS
