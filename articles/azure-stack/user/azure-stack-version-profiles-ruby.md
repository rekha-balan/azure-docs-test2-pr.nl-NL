...
---
# <a name="use-api-version-profiles-with-ruby-in-azure-stack"></a>Use API version profiles with Ruby in Azure Stack

*Applies to: Azure Stack integrated systems and Azure Stack Development Kit*

## <a name="ruby-and-api-version-profiles"></a>Ruby and API version profiles
...
## <a name="install-the-azure-ruby-sdk"></a>Install the Azure Ruby SDK
...
## <a name="install-the-rubygem-packages"></a>Install the rubygem packages
...
## <a name="usage-of-the-azuresdk-gem"></a>Usage of the azure_sdk gem
...
### <a name="the-azure-stack-resource-manager-endpoint"></a>The Azure Stack resource manager endpoint
...
## <a name="existing-api-profiles"></a>Existing API profiles
...
## <a name="define-azurestack-environment-setting-functions"></a>Define AzureStack environment setting functions
...
## <a name="samples-using-api-profiles"></a>Samples using API profiles
...
### <a name="sample-resource-manager-and-groups"></a>Sample Resource Manager and groups
