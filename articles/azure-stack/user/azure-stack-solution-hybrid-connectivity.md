...
---
# <a name="tutorial-configure-hybrid-cloud-connectivity-with-azure-and-azure-stack"></a>Tutorial: configure hybrid cloud connectivity with Azure and Azure Stack
...
#### <a name="tutorial-example-values"></a>Tutorial example values
...
## <a name="create-a-virtual-network-in-global-azure-and-azure-stack"></a>Create a virtual network in global Azure and Azure Stack
...
## <a name="add-a-gateway-subnet"></a>Add a gateway subnet
...
## <a name="create-a-virtual-network-gateway-in-azure-and-azure-stack"></a>Create a Virtual Network Gateway in Azure and Azure Stack
...
## <a name="create-the-local-network-gateway-in-azure-and-azure-stack"></a>Create the local network gateway in Azure and Azure Stack
...
## <a name="configure-your-connection"></a>Configure your connection
