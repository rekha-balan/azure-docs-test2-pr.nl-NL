...
---
# <a name="use-api-version-profiles-with-azure-cli-20-in-azure-stack"></a>Use API version profiles with Azure CLI 2.0 in Azure Stack
...
### <a name="set-the-path-for-a-development-machine-inside-the-cloud"></a>Set the path for a development machine inside the cloud
...
### <a name="set-the-path-for-a-development-machine-outside-the-cloud"></a>Set the path for a development machine outside the cloud
...
## <a name="get-the-virtual-machine-aliases-endpoint"></a>Get the virtual machine aliases endpoint
