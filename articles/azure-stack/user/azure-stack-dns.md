...
---
# <a name="using-dns-in-azure-stack"></a>Using DNS in Azure Stack
...
To learn more about name resolution, refer to the [DNS resolution](https://docs.microsoft.com/azure/dns/dns-for-azure-services?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) article.
...
## <a name="create-and-manage-dns-zones-and-records-using-the-api"></a>Create and manage DNS zones and records using the API
