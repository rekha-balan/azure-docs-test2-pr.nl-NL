...
---
# <a name="quickstart-create-a-windows-server-virtual-machine-with-the-azure-stack-portal"></a>Quickstart: create a Windows server virtual machine with the Azure Stack portal
