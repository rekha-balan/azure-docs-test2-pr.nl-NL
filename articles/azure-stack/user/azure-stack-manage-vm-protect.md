...
---
# <a name="protect-virtual-machines-deployed-on-azure-stack"></a>Protect virtual machines deployed on Azure Stack
...
## <a name="azure-stack-infrastructure-recovery"></a>Azure Stack infrastructure recovery
...
## <a name="sourcetarget-combinations"></a>Source/target combinations
...
## <a name="application-recovery-objectives"></a>Application recovery objectives
...
#### <a name="planning-your-backup-strategy"></a>Planning your backup strategy
...
### <a name="replicationmanual-failover"></a>Replication/manual failover
...
### <a name="high-availabilityautomatic-failover"></a>High availability/automatic failover
...
### <a name="no-recovery"></a>No recovery
...
## <a name="recommended-topologies"></a>Recommended topologies
