...
---
# <a name="use-data-transfer-tools-for-azure-stack-storage"></a>Use data transfer tools for Azure Stack storage
...
### <a name="download-all-blobs-to-a-local-disk"></a>Download all blobs to a local disk
