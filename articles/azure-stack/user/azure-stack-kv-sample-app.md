...
---
# <a name="a-sample-application-that-uses-keys-and-secrets-stored-in-a-key-vault"></a>A sample application that uses keys and secrets stored in a key vault
...
## <a name="download-and-configure-the-sample-application"></a>Download and configure the sample application
