...
---
# <a name="quickstart-create-a-linux-server-virtual-machine-by-using-azure-cli-in-azure-stack"></a>Quickstart: create a Linux server virtual machine by using Azure CLI in Azure Stack
...
## <a name="use-ssh-to-connect-to-the-virtual-machine"></a>Use SSH to connect to the virtual machine
