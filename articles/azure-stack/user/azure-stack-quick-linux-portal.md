...
---
# <a name="quickstart-create-a-linux-server-virtual-machine-with-the-azure-stack-portal"></a>Quickstart: create a Linux server virtual machine with the Azure Stack portal
