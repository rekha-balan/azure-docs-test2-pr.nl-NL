...
## <a name="summary-of-api-profiles"></a>Summary of API profiles
...
- Three profile naming conventions are used:
    ...
    - **yyyy-mm-dd-profile** Sits between optimal stability and the latest features.

### <a name="azure-api-profiles-and-azure-stack-compatibility"></a>Azure API profiles and Azure Stack compatibility
...
## <a name="azure-resource-manager-api-profiles"></a>Azure Resource Manager API profiles
...
## <a name="api-profile-code-samples"></a>API profile code samples
