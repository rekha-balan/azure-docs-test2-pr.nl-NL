...
## <a name="enable-your-tenant-subscription-for-key-vault-operations"></a>Enable your tenant subscription for Key Vault operations
...
### <a name="active-directory-federation-services-ad-fs-deployment"></a>Active Directory Federation Services (AD FS) deployment
