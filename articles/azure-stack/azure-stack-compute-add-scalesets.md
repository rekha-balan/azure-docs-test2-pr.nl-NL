...
## <a name="use-the-azure-stack-portal"></a>Use the Azure Stack portal 
...
## <a name="add-the-virtual-machine-scale-set-prior-to-version-1808"></a>Add the Virtual Machine Scale Set (prior to version 1808)
>[!NOTE]  
...
## <a name="update-images-in-a-virtual-machine-scale-set"></a>Update images in a Virtual Machine Scale Set
...
## <a name="scale-a-virtual-machine-scale-set"></a>Scale a virtual machine scale set
