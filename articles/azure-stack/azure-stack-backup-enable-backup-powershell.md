...
---
# <a name="enable-backup-for-azure-stack-with-powershell"></a>Enable Backup for Azure Stack with PowerShell
...
## <a name="prepare-powershell-environment"></a>Prepare PowerShell environment
...
## <a name="provide-the-backup-share-credentials-and-encryption-key-to-enable-backup"></a>Provide the backup share, credentials, and encryption key to enable backup
...
##  <a name="confirm-backup-settings"></a>Confirm backup settings
...
## <a name="update-backup-settings"></a>Update backup settings
