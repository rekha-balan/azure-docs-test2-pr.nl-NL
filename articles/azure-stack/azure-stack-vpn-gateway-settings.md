...
---
# <a name="vpn-gateway-configuration-settings-for-azure-stack"></a>VPN gateway configuration settings for Azure Stack
...
### <a name="gateway-types"></a>Gateway types
...
### <a name="connection-types"></a>Connection types
...
### <a name="local-network-gateways"></a>Local network gateways
