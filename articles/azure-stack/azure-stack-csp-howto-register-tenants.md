...
---
# <a name="add-tenant-for-usage-and-billing-to-azure-stack"></a>Add tenant for usage and billing to Azure Stack
...
## <a name="create-a-new-customer-in-partner-center"></a>Create a new customer in Partner Center
...
##  <a name="create-an-azure-subscription-for-the-end-customer"></a>Create an Azure subscription for the end customer
...
## <a name="create-a-guest-user-in-the-end-customer-directory"></a>Create a guest user in the end customer directory
...
## <a name="update-the-registration-with-the-end-customer-subscription"></a>Update the registration with the end customer subscription
...
```
### <a name="new-azurermresource-powershell-parameters"></a>New-AzureRmResource PowerShell parameters
...
## <a name="onboard-tenant-to-azure-stack"></a>Onboard tenant to Azure Stack
...
## <a name="create-a-local-resource-in-the-end-customer-tenant-in-azure-stack"></a>Create a local resource in the end customer tenant in Azure Stack
