...
## <a name="rotating-external-and-internal-secrets"></a>Rotating external and internal secrets
...
## <a name="walkthrough-of-secret-rotation"></a>Walkthrough of secret rotation
...
## <a name="update-the-baseboard-management-controller-bmc-password"></a>Update the baseboard management controller (BMC) password
