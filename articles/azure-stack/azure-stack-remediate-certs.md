...
---
# <a name="remediate-common-issues-for-azure-stack-pki-certificates"></a>Remediate common issues for Azure Stack PKI certificates
...
4. After the tool completes, review the output for success: ![results](./media/azure-stack-remediate-certs/remediate-results.png)
