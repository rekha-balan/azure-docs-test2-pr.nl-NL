...
---
# <a name="overview-of-identity-for-azure-stack"></a>Overview of identity for Azure Stack
...
## <a name="common-concepts-for-identity"></a>Common concepts for identity
...
### <a name="directory-tenants-and-organizations"></a>Directory tenants and organizations
...
### <a name="guest-users"></a>Guest users
...
### <a name="identities-and-your-identity-system"></a>Identities and your identity system 
...
### <a name="authentication-by-applications-and-users"></a>Authentication by applications and users
...
### <a name="authenticate-to-azure-resource-manager"></a>Authenticate to Azure Resource Manager
...
### <a name="use-role-based-access-control"></a>Use Role-Based Access Control  
Role-Based Access Control (RBAC) in Azure Stack is consistent with the implementation in Microsoft Azure. You can manage access to resources by assigning the appropriate RBAC role to users, groups, and applications. For information about how to use RBAC with Azure Stack, see the following articles:
...
### <a name="authenticate-with-azure-powershell"></a>Authenticate with Azure PowerShell  
...
### <a name="authenticate-with-azure-cli"></a>Authenticate with Azure CLI
