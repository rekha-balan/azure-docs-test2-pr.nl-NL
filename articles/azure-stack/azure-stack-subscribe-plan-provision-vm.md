...
---
# <a name="create-subscriptions-to-offers-in-azure-stack"></a>Create subscriptions to offers in Azure Stack
...
## <a name="create-a-subscription-as-a-cloud-operator"></a>Create a subscription as a cloud operator
...
### <a name="to-create-a-subscription-for-a-user"></a>To create a subscription for a user
...
### <a name="to-make-an-add-on-plan-available"></a>To make an add-on plan available
...
## <a name="create-a-subscription-as-a-user"></a>Create a subscription as a user
...
### <a name="to-subscribe-to-an-offer"></a>To subscribe to an offer
...
### <a name="to-subscribe-to-an-add-on-plan"></a>To subscribe to an add-on plan
