...
## <a name="generate-usage-data-reporting"></a>Generate usage data reporting
...
## <a name="view-usage---csp-subscriptions"></a>View usage - CSP subscriptions
...
## <a name="view-usage--enterprise-agreement-subscriptions"></a>View usage – Enterprise Agreement subscriptions
...
## <a name="view-usage--other-subscriptions"></a>View usage – other subscriptions
...
## <a name="which-azure-stack-deployments-are-charged"></a>Which Azure Stack deployments are charged?
...
## <a name="i-have-a-windows-server-license-i-want-to-use-on-azure-stack-how-do-i-do-it"></a>I have a Windows Server license I want to use on Azure Stack, how do I do it?
