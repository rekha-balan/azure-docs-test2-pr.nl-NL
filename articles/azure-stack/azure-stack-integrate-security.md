...
---
# <a name="azure-stack-datacenter-integration---syslog-forwarding"></a>Azure Stack datacenter integration - syslog forwarding
...
## <a name="configuring-syslog-forwarding"></a>Configuring syslog forwarding
...
### <a name="cmdlets-to-configure-syslog-forwarding"></a>Cmdlets to configure syslog forwarding
...
### <a name="configuring-syslog-forwarding-with-tcp-mutual-authentication-and-tls-12-encryption"></a>Configuring syslog forwarding with TCP, mutual authentication, and TLS 1.2 encryption
...
### <a name="configuring-syslog-forwarding-with-tcp-server-authentication-and-tls-12-encryption"></a>Configuring syslog forwarding with TCP, Server authentication, and TLS 1.2 encryption
...
### <a name="configuring-syslog-forwarding-with-tcp-and-no-encryption"></a>Configuring syslog forwarding with TCP and no encryption
...
### <a name="configuring-syslog-forwarding-with-udp-and-no-encryption"></a>Configuring syslog forwarding with UDP and no encryption
...
## <a name="removing-syslog-forwarding-configuration"></a>Removing syslog forwarding configuration
...
## <a name="verifying-the-syslog-setup"></a>Verifying the syslog setup
...
## <a name="syslog-message-schema"></a>Syslog message schema
...
### <a name="cef-mapping-for-windows-events"></a>CEF mapping for Windows events
```
...
### <a name="cef-mapping-for-alerts-created"></a>CEF mapping for alerts created
```
...
### <a name="cef-mapping-for-alerts-closed"></a>CEF mapping for alerts closed
```
* Signature ID: Microsoft Azure Stack Alert Creation : FaultTypeId
* Name: FaultTypeId : AlertId
