...
---
# <a name="datacenter-integration-considerations-for-azure-stack-integrated-systems"></a>Datacenter integration considerations for Azure Stack integrated systems
...
## <a name="capacity-planning-considerations"></a>Capacity planning considerations
...
## <a name="identity-considerations"></a>Identity considerations

### <a name="choose-identity-provider"></a>Choose identity provider
...
### <a name="ad-fs-and-graph-integration"></a>AD FS and Graph integration
...
## <a name="licensing-model"></a>Licensing model
...
## <a name="naming-decisions"></a>Naming decisions
...
## <a name="certificate-requirements"></a>Certificate requirements
...
## <a name="connect-azure-stack-to-azure"></a>Connect Azure Stack to Azure
...
### <a name="hybrid-connectivity-options"></a>Hybrid connectivity options
...
### <a name="using-expressroute"></a>Using ExpressRoute
...
## <a name="external-monitoring"></a>External monitoring
...
### <a name="protect-infrastructure-components"></a>Protect infrastructure components
...
### <a name="protect-tenant-applications-on-iaas-virtual-machines"></a>Protect tenant applications on IaaS virtual machines
