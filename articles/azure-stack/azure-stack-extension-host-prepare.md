...
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Prepare for extension host for Azure Stack
...
## <a name="create-certificate-signing-request"></a>Create certificate signing request
...
## <a name="validate-new-certificates"></a>Validate new certificates
...
## <a name="import-extension-host-certificates"></a>Import extension host certificates
...
### <a name="update-dns-configuration"></a>Update DNS configuration
...
### <a name="publish-new-endpoints"></a>Publish new endpoints
...
### <a name="update-existing-publishing-rules-post-enablement-of-extension-host"></a>Update existing publishing Rules (Post enablement of extension host)
