...
---
# <a name="connect-azure-stack-to-azure-using-azure-expressroute"></a>Connect Azure Stack to Azure using Azure ExpressRoute
...
## <a name="overview-assumptions-and-prerequisites"></a>Overview, assumptions, and prerequisites
...
### <a name="expressroute-network-architecture"></a>ExpressRoute network architecture
...
1. Select **Public IP address**>**Choose public IP address**, and then select **Create new**.
...
### <a name="configure-the-azure-vnets"></a>Configure the Azure VNets
