...
---
# <a name="azure-stack-telemetry"></a>Azure Stack telemetry
...
## <a name="privacy-considerations"></a>Privacy considerations
...
## <a name="examples-of-how-microsoft-uses-the-telemetry-data"></a>Examples of how Microsoft uses the telemetry data
...
## <a name="manage-telemetry-collection"></a>Manage telemetry collection
...
### <a name="telemetry-levels-and-data-collection"></a>Telemetry levels and data collection
...
### <a name="asdk-set-the-telemetry-level-in-the-windows-registry"></a>ASDK: set the telemetry level in the Windows registry
...
### <a name="asdk-and-multi-node-enable-or-disable-telemetry-after-deployment"></a>ASDK and Multi-Node: enable or disable telemetry after deployment
