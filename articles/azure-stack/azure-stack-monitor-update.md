...
---
# <a name="monitor-updates-in-azure-stack-using-the-privileged-endpoint"></a>Monitor updates in Azure Stack using the privileged endpoint
...
## <a name="verify-the-cmdlets-are-available"></a>Verify the cmdlets are available
...
## <a name="use-the-update-management-cmdlets"></a>Use the update management cmdlets
...
### <a name="connect-to-the-privileged-endpoint-and-assign-session-variable"></a>Connect to the privileged endpoint and assign session variable
...
### <a name="get-high-level-status-of-the-current-update-run"></a>Get high-level status of the current update run 
...
### <a name="get-the-full-update-run-status-with-details"></a>Get the full update run status with details 
...
### <a name="resume-a-failed-update-operation"></a>Resume a failed update operation
