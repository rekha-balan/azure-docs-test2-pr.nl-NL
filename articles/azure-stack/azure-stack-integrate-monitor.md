...
---
# <a name="integrate-external-monitoring-solution-with-azure-stack"></a>Integrate external monitoring solution with Azure Stack
...
## <a name="integrate-with-operations-manager"></a>Integrate with Operations Manager
...
## <a name="integrate-with-nagios"></a>Integrate with Nagios
...
### <a name="plugin-parameters"></a>Plugin parameters
...
## <a name="use-powershell-to-monitor-health-and-alerts"></a>Use PowerShell to monitor health and alerts
