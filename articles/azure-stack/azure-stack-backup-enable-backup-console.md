...
---
# <a name="enable-backup-for-azure-stack-from-the-administration-portal"></a>Enable backup for Azure Stack from the administration portal
...
## <a name="enable-or-reconfigure-backup"></a>Enable or reconfigure backup
...
## <a name="start-backup"></a>Start backup
...
## <a name="enable-or-disable-automatic-backups"></a>Enable or disable automatic backups
