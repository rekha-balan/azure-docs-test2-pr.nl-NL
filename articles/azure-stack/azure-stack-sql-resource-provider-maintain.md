...
---
# <a name="sql-resource-provider-maintenance-operations"></a>SQL resource provider maintenance operations
...
## <a name="patching-and-updating"></a>Patching and updating
...
### <a name="provider-virtual-machine"></a>Provider virtual machine
...
## <a name="backuprestoredisaster-recovery"></a>Backup/Restore/Disaster Recovery
...
## <a name="updating-sql-credentials"></a>Updating SQL credentials
...
## <a name="secrets-rotation"></a>Secrets rotation
...
### <a name="powershell-examples-for-rotating-secrets"></a>PowerShell examples for rotating secrets
...
## <a name="update-the-virtual-machine-operating-system"></a>Update the virtual machine operating system
...
## <a name="update-the-virtual-machine-windows-defender-definitions"></a>Update the virtual machine Windows Defender definitions
...
## <a name="collect-diagnostic-logs"></a>Collect diagnostic logs
...
### <a name="endpoint-requirements-and-process"></a>Endpoint requirements and process
