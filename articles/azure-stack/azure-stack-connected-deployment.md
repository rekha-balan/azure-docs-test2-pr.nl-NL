...
---
# <a name="azure-connected-deployment-planning-decisions-for-azure-stack-integrated-systems"></a>Azure connected deployment planning decisions for Azure Stack integrated systems
...
## <a name="choose-an-identity-store"></a>Choose an identity store
...
## <a name="choose-a-billing-model"></a>Choose a billing model
...
### <a name="capacity-based-billing"></a>Capacity based billing
