...
## <a name="improvements-and-fixes"></a>Improvements and fixes

This update includes the following quality improvements and fixes for Azure Stack.
 
### <a name="windows-server-2016-improvements-and-fixes"></a>Windows Server 2016 improvements and fixes
...
### <a name="additional-quality-improvements-and-fixes"></a>Additional quality improvements and fixes
...
### <a name="health-and-monitoring"></a>Health and monitoring
...
### <a name="field-replaceable-unit-fru-procedures"></a>Field replaceable unit (FRU) procedures
...
## <a name="download-the-update"></a>Download the update
