...
---
# <a name="azure-stack-firewall-integration"></a>Azure Stack firewall integration
...
### <a name="ssl-decryption"></a>SSL decryption
...
## <a name="enterprise-intranet-or-perimeter-network-firewall-scenario"></a>Enterprise intranet or perimeter network firewall scenario
