...
---
# <a name="manage-tenant-registration-in-azure-stack"></a>Manage tenant registration in Azure Stack
...
## <a name="add-tenant-to-registration"></a>Add tenant to registration
...
### <a name="use-api-profiles"></a>Use API profiles
...
## <a name="list-all-registered-tenants"></a>List all registered tenants
...
## <a name="remove-a-tenant-mapping"></a>Remove a tenant mapping
