...
---
# <a name="build-workflows-with-the-iot-central-connector-in-microsoft-flow"></a>Build workflows with the IoT Central connector in Microsoft Flow
...
## <a name="trigger-a-workflow-when-a-rule-is-fired"></a>Trigger a workflow when a rule is fired
...
## <a name="create-a-device-in-a-workflow"></a>Create a device in a workflow
...
## <a name="update-a-device-in-a-workflow"></a>Update a device in a workflow
...
## <a name="delete-a-device-in-a-workflow"></a>Delete a device in a workflow
