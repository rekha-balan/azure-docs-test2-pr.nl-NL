...
---
# <a name="connect-a-generic-client-application-to-your-azure-iot-central-application-nodejs"></a>Connect a generic client application to your Azure IoT Central application (Node.js)
...
### <a name="state-measurements"></a>State measurements
...
### <a name="event-measurements"></a>Event measurements
...
## <a name="run-your-nodejs-application"></a>Run your Node.js application
