...
---
# <a name="connect-a-raspberry-pi-to-your-azure-iot-central-application-c"></a>Connect a Raspberry Pi to your Azure IoT Central application (C#)
...
### <a name="create-your-net-application"></a>Create your .NET application
...
## <a name="run-your-net-application"></a>Run your .NET application
...
## <a name="raspberry-pi-device-template-details"></a>Raspberry PI Device template details
