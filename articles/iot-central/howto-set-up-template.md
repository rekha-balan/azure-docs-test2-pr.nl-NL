...
---
# <a name="set-up-a-device-template"></a>Set up a device template
...
## <a name="create-a-device-template"></a>Create a device template
...
### <a name="create-a-telemetry-measurement"></a>Create a telemetry measurement
...
### <a name="create-an-event-measurement"></a>Create an event measurement
...
### <a name="create-a-state-measurement"></a>Create a state measurement
...
### <a name="create-a-location-property-through-azure-maps"></a>Create a location property through Azure Maps
...
#### <a name="add-location-as-an-application-property"></a>Add location as an application property 
...
#### <a name="add-location-as-a-device-property"></a>Add location as a device property 
...
### <a name="add-an-azure-maps-location-in-the-dashboard"></a>Add an Azure Maps location in the dashboard
