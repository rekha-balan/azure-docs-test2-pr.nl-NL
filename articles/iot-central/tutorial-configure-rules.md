...
---
# <a name="tutorial-configure-rules-and-actions-for-your-device-in-azure-iot-central"></a>Tutorial: Configure rules and actions for your device in Azure IoT Central
...
## <a name="create-a-telemetry-based-rule"></a>Create a telemetry-based rule
...
## <a name="test-the-rule"></a>Test the rule
