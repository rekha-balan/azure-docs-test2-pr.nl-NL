...
---
# <a name="prepare-and-upload-images-to-your-azure-iot-central-application"></a>Prepare and upload images to your Azure IoT Central application
...
## <a name="choose-where-to-use-custom-images"></a>Choose where to use custom images
...
## <a name="prepare-the-images"></a>Prepare the images
...
## <a name="upload-the-images"></a>Upload the images
...
### <a name="device-template"></a>Device template
...
### <a name="device-dashboard"></a>Device dashboard
...
### <a name="device-set-dashboard"></a>Device set dashboard
