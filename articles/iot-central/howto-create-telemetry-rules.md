...
---
# <a name="create-a-telemetry-rule-and-set-up-notifications-in-your-azure-iot-central-application"></a>Create a telemetry rule and set up notifications in your Azure IoT Central application
...
## <a name="create-a-telemetry-rule"></a>Create a telemetry rule
