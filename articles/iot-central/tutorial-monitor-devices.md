...
---
# <a name="tutorial-use-azure-iot-central-to-monitor-your-devices"></a>Tutorial: Use Azure IoT Central to monitor your devices
...
## <a name="receive-a-notification"></a>Receive a notification
...
## <a name="investigate-an-issue"></a>Investigate an issue
...
## <a name="remediate-an-issue"></a>Remediate an issue
