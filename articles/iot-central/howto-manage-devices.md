...
---
# <a name="manage-devices-in-your-azure-iot-central-application"></a>Manage devices in your Azure IoT Central application
...
## <a name="delete-a-device"></a>Delete a device
...
## <a name="change-a-device-setting"></a>Change a device setting
...
## <a name="change-a-property"></a>Change a property
