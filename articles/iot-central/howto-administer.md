...
---
# <a name="how-to-administer-your-application"></a>How to administer your application
...
## <a name="change-application-name"></a>Change application name
...
## <a name="change-the-application-url"></a>Change the application URL
...
## <a name="change-the-application-image"></a>Change the application image
...
## <a name="copy-an-application"></a>Copy an application
...
## <a name="delete-an-application"></a>Delete an application
...
## <a name="roles-in-azure-iot-central"></a>Roles in Azure IoT Central
...
### <a name="edit-the-roles-assigned-to-users"></a>Edit the roles assigned to users
...
## <a name="view-your-bill"></a>View your bill
...
## <a name="convert-your-trial-to-a-paid-application"></a>Convert your trial to a paid application
...
## <a name="extend-your-free-trial"></a>Extend your free trial
