...
---
# <a name="create-webhook-actions-on-rules-in-azure-iot-central"></a>Create webhook actions on rules in Azure IoT Central
...
## <a name="how-to-set-up-the-webhook"></a>How to set up the webhook
