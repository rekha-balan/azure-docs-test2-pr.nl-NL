...
---
# <a name="connect-a-raspberry-pi-to-your-azure-iot-central-application-python"></a>Connect a Raspberry Pi to your Azure IoT Central application (Python)
...
### <a name="configure-the-raspberry-pi"></a>Configure the Raspberry Pi
