...
---
# <a name="create-a-new-device-template-version"></a>Create a new device template version
...
## <a name="changes-that-prompt-a-version-change"></a>Changes that prompt a version change
...
## <a name="what-happens-on-version-change"></a>What happens on version change?
...
## <a name="migrate-a-device-across-device-template-versions"></a>Migrate a device across device template versions
