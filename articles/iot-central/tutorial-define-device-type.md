...
---
# <a name="tutorial-define-a-new-device-type-in-your-azure-iot-central-application"></a>Tutorial: Define a new device type in your Azure IoT Central application
...
## <a name="create-a-new-custom-device-template"></a>Create a new custom device template
...
## <a name="add-a-device-and-define-telemetry"></a>Add a device and define telemetry
...
## <a name="define-event-measurement"></a>Define Event measurement
...
## <a name="define-state-measurement"></a>Define State measurement
...
## <a name="settings-properties-and-commands"></a>Settings, properties, and commands
...
## <a name="use-settings"></a>Use settings
...
## <a name="use-properties--device-properties"></a>Use properties / device properties
...
## <a name="use-commands"></a>Use commands
...
## <a name="view-your-simulated-device"></a>View your simulated device
