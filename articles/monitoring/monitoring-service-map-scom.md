...
---
# <a name="service-map-integration-with-system-center-operations-manager"></a>Service Map integration with System Center Operations Manager
  > [!NOTE]
...
## <a name="install-the-service-map-management-pack"></a>Install the Service Map management pack
...
## <a name="configure-the-service-map-integration"></a>Configure the Service Map integration
...
## <a name="edit-or-delete-the-workspace"></a>Edit or delete the workspace
...
## <a name="configure-rules-and-overrides"></a>Configure rules and overrides
