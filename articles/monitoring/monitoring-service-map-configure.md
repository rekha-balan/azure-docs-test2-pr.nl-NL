...
---
# <a name="configure-service-map-in-azure"></a>Configure Service Map in Azure
...
## <a name="supported-azure-regions"></a>Supported Azure regions
...
### <a name="oracle-enterprise-linux-6-with-unbreakable-enterprise-kernel"></a>Oracle Enterprise Linux 6 with Unbreakable Enterprise Kernel
| OS version | Kernel version
|:--|:--|
...
### <a name="oracle-enterprise-linux-5-with-unbreakable-enterprise-kernel"></a>Oracle Enterprise Linux 5 with Unbreakable Enterprise Kernel
...
## <a name="azure-vm-extension"></a>Azure VM Extension
...
### <a name="install-the-dependency-agent-on-microsoft-windows"></a>Install the Dependency agent on Microsoft Windows
...
#### <a name="windows-command-line"></a>Windows command line
...
### <a name="install-the-dependency-agent-on-linux"></a>Install the Dependency agent on Linux
...
## <a name="installation-script-examples"></a>Installation script examples
...
### <a name="powershell-script-for-windows"></a>PowerShell script for Windows
```PowerShell
...
### <a name="shell-script-for-linux"></a>Shell script for Linux
```
...
## <a name="remove-the-dependency-agent"></a>Remove the Dependency agent
### <a name="uinstall-agent-on-windows"></a>Uinstall agent on Windows
...
### <a name="uninstall-agent-on-linux"></a>Uninstall agent on Linux
...
### <a name="dependency-agent-installation-problems"></a>Dependency agent installation problems
#### <a name="installer-prompts-for-a-reboot"></a>Installer prompts for a reboot
...
#### <a name="message-unable-to-install-dependency-agent-visual-studio-runtime-libraries-failed-to-install-code--codenumber-appears"></a>Message "Unable to install Dependency agent: Visual Studio Runtime libraries failed to install (code = [code_number])" appears
...
### <a name="post-installation-issues"></a>Post-installation issues
#### <a name="server-doesnt-appear-in-service-map"></a>Server doesn't appear in Service Map
...
#### <a name="server-appears-in-service-map-but-has-no-processes"></a>Server appears in Service Map but has no processes
