...
---
# <a name="office-365-management-solution-in-azure-preview"></a>Office 365 management solution in Azure (Preview)
...
### <a name="create-an-office-365-application-in-azure-active-directory"></a>Create an Office 365 application in Azure Active Directory
...
### <a name="configure-application-for-office-365"></a>Configure application for Office 365
...
### <a name="add-a-key-for-the-application"></a>Add a key for the application
...
### <a name="add-admin-consent"></a>Add admin consent
...
### <a name="subscribe-to-log-analytics-workspace"></a>Subscribe to Log Analytics workspace
...
### <a name="azure-active-directory-account-logon"></a>Azure Active Directory Account logon
...
### <a name="exchange-mailbox-audit"></a>Exchange Mailbox Audit
...
### <a name="exchange-mailbox-audit-group"></a>Exchange Mailbox Audit Group
...
### <a name="sharepoint-file-operations"></a>SharePoint File Operations
