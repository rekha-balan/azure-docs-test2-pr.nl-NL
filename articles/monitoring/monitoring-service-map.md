...
---
# <a name="using-service-map-solution-in-azure"></a>Using Service Map solution in Azure
...
## <a name="enable-service-map"></a>Enable Service Map
...
## <a name="process-groups"></a>Process Groups
...
## <a name="machine-groups"></a>Machine Groups
...
### <a name="creating-a-machine-group"></a>Creating a Machine Group
...
### <a name="viewing-a-group"></a>Viewing a Group
...
![Machine Group](media/monitoring-service-map/machine-group.png) The machines that belong to the group are outlined in white in the map.
...
### <a name="filter-by-processes"></a>Filter by processes
...
### <a name="adding-machines-to-a-group"></a>Adding machines to a group
...
### <a name="removing-machines-from-a-group"></a>Removing machines from a group
...
### <a name="removing-or-renaming-a-group"></a>Removing or renaming a group
...
### <a name="show-self-links"></a>Show self-links
...
## <a name="alerts-integration"></a>Alerts integration
...
## <a name="log-events-integration"></a>Log events integration
...
## <a name="service-desk-integration"></a>Service Desk integration
...
## <a name="change-tracking-integration"></a>Change Tracking integration
...
## <a name="performance-integration"></a>Performance integration
...
## <a name="security-integration"></a>Security integration
...
## <a name="updates-integration"></a>Updates integration
...
### <a name="list-all-known-processes-on-a-specified-machine"></a>List all known processes on a specified machine
...
### <a name="list-all-unique-product-versions-of-curl-in-my-datacenter"></a>List all unique product versions of curl in my datacenter
