...
---
# <a name="adding-log-analytics-saved-searches-and-alerts-to-management-solution-preview"></a>Adding Log Analytics saved searches and alerts to management solution (Preview)
...
### <a name="schedule-resource"></a>Schedule resource
...
#### <a name="azure-action-group"></a>Azure action group
...
#### <a name="actions-for-oms-legacy"></a>Actions for OMS (legacy)
