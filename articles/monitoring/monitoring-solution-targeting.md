...
---
# <a name="targeting-management-solutions-in-azure-preview"></a>Targeting Management Solutions in Azure (Preview)
...
## <a name="how-to-target-a-solution"></a>How to target a solution
There are three steps to targeting a solution as described in the following sections. 


### <a name="1-create-a-computer-group"></a>1. Create a computer group
...
Once you have the computer group created in your workspace, then you'll include it in a scope configuration that can be applied to one or more solutions.
 ...
 ### <a name="2-create-a-scope-configuration"></a>2. Create a scope configuration
 ...
 ### <a name="3-apply-the-scope-configuration-to-a-solution"></a>3. Apply the scope configuration to a solution.
...
## <a name="solutions-and-agents-that-cant-be-targeted"></a>Solutions and agents that can't be targeted
