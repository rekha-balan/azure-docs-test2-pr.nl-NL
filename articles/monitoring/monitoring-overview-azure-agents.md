...
---
# <a name="overview-of-the-azure-agents-to-monitor-azure-virtual-machines"></a>Overview of the Azure agents to monitor Azure Virtual Machines
...
## <a name="comparing-azure-diagnostic-and-log-analytics-agent"></a>Comparing Azure Diagnostic and Log Analytics agent
