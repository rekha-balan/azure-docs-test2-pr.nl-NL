...
---
# <a name="collect-data-in-log-analytics-with-an-azure-automation-runbook"></a>Collect data in Log Analytics with an Azure Automation runbook
...
## <a name="overview-of-scenario"></a>Overview of scenario
...
## <a name="1-install-data-collector-api-module"></a>1. Install Data Collector API module
...
## <a name="2-create-automation-variables"></a>2. Create Automation variables
...
## <a name="3-create-runbook"></a>3. Create runbook
...
## <a name="5-verify-records-in-log-analytics"></a>5. Verify records in Log Analytics
...
## <a name="6-publish-the-runbook"></a>6. Publish the runbook
...
## <a name="7-set-logging-options"></a>7. Set logging options 
...
## <a name="8-schedule-runbook"></a>8. Schedule runbook
...
## <a name="9-verify-runbook-starts-on-schedule"></a>9. Verify runbook starts on schedule
