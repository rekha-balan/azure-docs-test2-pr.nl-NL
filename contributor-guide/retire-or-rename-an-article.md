# <a name="steps-to-follow-when-you-want-to-delete-move-or-rename-an-azure-technical-article"></a>Steps to follow when you want to delete, move, or rename an Azure technical article
...
## <a name="automated-solution"></a>Automated solution
...
### <a name="step-1-set-the-article-to-noindex-and-republish-it-as-appropriate"></a>Step 1: Set the article to NOINDEX and republish it (as appropriate)
...
### <a name="step-2-turn-the-original-article-into-a-redirect-and-create-the-new-file-if-you-are-renaming-or-moving-a-file"></a>Step 2: Turn the original article into a redirect, and create the new file if you are renaming or moving a file. 
...
### <a name="step-3-remove-or-update-all-crosslinks-to-the-article-from-the-technical-content-repository"></a>Step 3: Remove or update all crosslinks to the article from the technical content repository
...
### <a name="step-4-request-acom-to-docs-redirection"></a>Step 4: Request ACOM-to-DOCS redirection
...
### <a name="step-6-publish"></a>Step 6: Publish  
...
### <a name="step-7-cleanup-tasks"></a>Step 7: Cleanup tasks

These cleanup tasks need to be performed immediately after the changes are published.

#### <a name="fix-acom-links"></a>Fix ACOM links
...
#### <a name="update-the-fwlink-tool"></a>Update the FWLink tool 
...
#### <a name="manage-inbound-links"></a>Manage inbound links
...
#### <a name="remove-cached-pages-from-search-engines-only-if-absolutely-necessary"></a>Remove cached pages from search engines (only if absolutely necessary)
...
#### <a name="redirect-cleanup"></a>Redirect cleanup
