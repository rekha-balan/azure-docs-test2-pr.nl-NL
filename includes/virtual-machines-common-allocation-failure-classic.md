...
## <a name="resize-a-vm-or-add-vms-or-role-instances-to-an-existing-cloud-service"></a>Resize a VM or add VMs or role instances to an existing cloud service
**Error**
...
## <a name="restart-partially-stopped-deallocated-vms"></a>Restart partially stopped (deallocated) VMs
**Error**
...
## <a name="restart-fully-stopped-deallocated-vms"></a>Restart fully stopped (deallocated) VMs
**Error**
...
## <a name="stagingproduction-deployments-platform-as-a-service-only"></a>Staging/production deployments (platform as a service only)
**Error**
...
## <a name="affinity-group-vmservice-proximity"></a>Affinity group (VM/service proximity)
**Error**
...
## <a name="affinity-group-based-virtual-network"></a>Affinity-group-based virtual network
**Error**
