...
## <a name="delete-the-original-vm"></a>Delete the original VM
...
## <a name="fix-issues-on-the-original-virtual-hard-disk"></a>Fix issues on the original virtual hard disk
...
## <a name="unmount-and-detach-the-original-virtual-hard-disk"></a>Unmount and detach the original virtual hard disk
...
## <a name="create-a-vm-from-the-original-hard-disk"></a>Create a VM from the original hard disk
