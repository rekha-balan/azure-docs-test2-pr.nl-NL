...
---
# <a name="backup-and-disaster-recovery-for-azure-iaas-disks"></a>Backup and disaster recovery for Azure IaaS disks
...
### <a name="azure-iaas-resiliency"></a>Azure IaaS resiliency
...
## <a name="backup-and-dr-scenarios"></a>Backup and DR scenarios
...
### <a name="scenario-1-major-database-solutions"></a>Scenario 1: Major database solutions
...
### <a name="scenario-2-a-cluster-of-redundant-vms"></a>Scenario 2: A cluster of redundant VMs
...
### <a name="scenario-3-iaas-application-workload"></a>Scenario 3: IaaS application workload
...
### <a name="scenario-4-iaas-application-data-issues"></a>Scenario 4: IaaS application data issues
...
## <a name="disaster-recovery-solution-azure-backup"></a>Disaster recovery solution: Azure Backup 
...
### <a name="steps-to-enable-a-backup"></a>Steps to enable a backup
...
### <a name="steps-for-recovery"></a>Steps for recovery
...
## <a name="alternative-solution-consistent-snapshots"></a>Alternative solution: Consistent snapshots
...
### <a name="create-snapshots-while-the-vm-is-running"></a>Create snapshots while the VM is running
...
### <a name="create-snapshots-while-the-vm-is-offline"></a>Create snapshots while the VM is offline
...
### <a name="copy-the-snapshots-to-another-region"></a>Copy the snapshots to another region
...
### <a name="recovery-from-snapshots"></a>Recovery from snapshots
...
## <a name="appendix-understanding-the-impact-of-data-redundancy"></a>Appendix: Understanding the impact of data redundancy
