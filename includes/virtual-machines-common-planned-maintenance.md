...
## <a name="memory-preserving-maintenance"></a>Memory preserving maintenance
...
### <a name="availability-considerations-during-scheduled-maintenance"></a>Availability Considerations during Scheduled Maintenance 
