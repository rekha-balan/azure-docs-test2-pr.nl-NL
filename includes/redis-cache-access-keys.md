...
### <a name="retrieve-host-name-ports-and-access-keys-using-the-azure-portal"></a>Retrieve host name, ports, and access keys using the Azure Portal
...
### <a name="retrieve-host-name-ports-and-access-keys-using-azure-cli"></a>Retrieve host name, ports, and access keys using Azure CLI
