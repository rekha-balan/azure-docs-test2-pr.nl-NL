...
## <a name="common-boot-errors"></a>Common boot errors
...
## <a name="enable-boot-diagnostics-on-existing-virtual-machine"></a>Enable Boot diagnostics on existing virtual machine 
