...
## <a name="managing-table-entities"></a>Managing table entities
...
### <a name="add-table-entities"></a>Add table entities
...
### <a name="query-the-table-entities"></a>Query the table entities

There are several different ways to query the entities in a table.

#### <a name="retrieve-all-entities"></a>Retrieve all entities
...
#### <a name="retrieve-entities-for-a-specific-partition"></a>Retrieve entities for a specific partition
...
#### <a name="retrieve-entities-for-a-specific-value-in-a-specific-column"></a>Retrieve entities for a specific value in a specific column
...
#### <a name="retrieve-entities-using-a-custom-filter"></a>Retrieve entities using a custom filter 
...
### <a name="deleting-table-entities"></a>Deleting table entities

You can delete one entity or all entities in the table.

#### <a name="deleting-one-entity"></a>Deleting one entity
...
#### <a name="delete-all-entities-in-the-table"></a>Delete all entities in the table 
