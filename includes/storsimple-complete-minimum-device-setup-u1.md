...
3. Click the arrow icon. ![StorSimple arrow icon](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/storsimple-complete-minimum-device-setup/HCS_ArrowIcon-include.png)
