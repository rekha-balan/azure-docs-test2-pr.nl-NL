...
---
# <a name="prepay-for-virtual-machines-with-azure-reserved-vm-instances"></a>Prepay for Virtual Machines with Azure Reserved VM Instances
...
## <a name="determine-the-right-vm-size-before-purchase"></a>Determine the right VM size before purchase
