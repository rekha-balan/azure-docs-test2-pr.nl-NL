...
### <a name="apply-literal-value-to-tag-name"></a>Apply literal value to tag name
...
### <a name="apply-object-to-tag-element"></a>Apply object to tag element
...
### <a name="apply-json-string-to-tag-name"></a>Apply JSON string to tag name
