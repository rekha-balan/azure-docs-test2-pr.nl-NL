...
#### <a name="major-vs-minor-agent-versions"></a>Major vs. minor agent versions
...
#### <a name="upgrade-paths"></a>Upgrade paths
...
#### <a name="agent-lifecycle-and-change-management-guarantees"></a>Agent lifecycle and change management guarantees
