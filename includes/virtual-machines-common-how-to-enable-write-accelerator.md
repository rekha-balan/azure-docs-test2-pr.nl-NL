...
---
# <a name="enable-write-accelerator"></a>Enable Write Accelerator
...
## <a name="planning-for-using-write-accelerator"></a>Planning for using Write Accelerator
...
### <a name="restrictions-when-using-write-accelerator"></a>Restrictions when using Write Accelerator
...
## <a name="enabling-write-accelerator-on-a-specific-disk"></a>Enabling Write Accelerator on a specific disk
...
## <a name="enabling-azure-write-accelerator-using-azure-powershell"></a>Enabling Azure Write Accelerator using Azure PowerShell
...
### <a name="adding-a-new-disk-supported-by-write-accelerator-using-powershell"></a>Adding a new disk supported by Write Accelerator using PowerShell
...
### <a name="enabling-write-accelerator-on-an-existing-azure-disk-using-powershell"></a>Enabling Write Accelerator on an existing Azure disk using PowerShell
...
## <a name="enabling-write-accelerator-using-the-azure-portal"></a>Enabling Write Accelerator using the Azure portal
...
## <a name="enabling-write-accelerator-using-the-azure-cli"></a>Enabling Write Accelerator using the Azure CLI
...
## <a name="enabling-write-accelerator-using-rest-apis"></a>Enabling Write Accelerator using Rest APIs

To deploy through Azure Rest API, you need to install the Azure armclient.

### <a name="install-armclient"></a>Install armclient
...
### <a name="getting-your-current-vm-configuration"></a>Getting your current VM configuration
