...
### <a name="unregister-a-process-server-that-is-in-a-connected-state"></a>Unregister a process server that is in a connected state
...
### <a name="unregister-a-process-server-that-is-in-a-disconnected-state"></a>Unregister a process server that is in a disconnected state
