...
1. Select **Add an action**.        
   ![SFTP action condition image 6](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-6.png)   
2. Select the **SFTP - Extract folder** action      
   ![SFTP action condition image 7](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-7.png)   
3. Select **Source archive file path**              
   ![SFTP action condition image 9](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-9.png)   
4. Select the **File path** token. This indicates that you will use the file path of the file that the trigger found as the source archive file path.           
   ![SFTP action condition image 10](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-10.png)   
5. Select **Destination folder path**           
   ![SFTP action condition image 11](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-11.png)   
...
7. Enter *\ExtractedFile* in the **Destination folder path** control. Do this just after the file path token in the Destination folder path control.         
   ![SFTP action condition image 12](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-12.png)   
8. Enter *True* in the **Overwrite?* control to indicate that existing files should be overwritten if they have the same name as the extracted files.      
   ![SFTP action condition image 13](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/connectors-create-api-sftp/condition-13.png)   
