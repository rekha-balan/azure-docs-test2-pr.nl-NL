...
---
# <a name="cost-effective-standard-storage-and-unmanaged-and-managed-azure-vm-disks"></a>Cost-effective Standard Storage and unmanaged and managed Azure VM disks
...
## <a name="disk-types"></a>Disk types
...
## <a name="standard-storage-features"></a>Standard Storage Features 

Let's take a look at some of the features of Standard Storage. For more details, please see [Introduction to Azure Storage](../articles/storage/common/storage-introduction.md).
...
### <a name="account-limits--does-not-apply-to-managed-disks"></a>Account limits – does not apply to managed disks
