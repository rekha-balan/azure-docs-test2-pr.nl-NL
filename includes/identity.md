...
![Azure Active Directory in Virtual Machine](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/identity/identity_03_AD.png)
...
![Azure Active Directory in Virtual Machine](https://docstestmedia1.blob.core.windows.net/azure-media/includes/media/identity/identity_04_IdentityProviders.png)
